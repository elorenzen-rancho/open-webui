import { c as Qe, g as No } from './BC4znSyB.js';
import { t as El } from './BT28bLwl.js';
var ht = function (a) {
...
var bi = function (a, e) {
	...
	dn = Bo.process,
	pn = Bo.Deno,
	yn = (dn && dn.versions) || (pn && pn.version),
	mn = yn && yn.v8,
	le,
	cr;
mn && ((le = mn.split('.')), (cr = le[0] > 0 && le[0] < 4 ? 1 : +(le[0] + le[1])));
!cr &&
	ta &&
	((le = ta.match(/Edge\/(\d+)/)),
	(!le || le[1] >= 74) && ((le = ta.match(/Chrome\/(\d+)/)), le && (cr = +le[1])));
var xi = cr,
	bn = xi,
	Hl = D,
	Yl = _,
	...
	jo =
		...
		!Hl(function () {
			...
			return !Xl(a) || !(Object(a) instanceof Symbol) || (!Symbol.sham && bn && bn < 41);
		}),
	Wl = jo,
	Fo = Wl && !Symbol.sham && typeof Symbol.iterator == 'symbol',
	ql = Fe,
	Ql = B,
	Kl = Tr,
	Zl = Fo,
	...
	Ti = function (a, e) {
		try {
			uh(xn, a, { value: e, configurable: !0, writable: !0 });
		} catch {
			xn[a] = e;
		}
		return e;
...
var Oi = Go.exports,
	...
	z = function (a) {
		return (En(na, a) || (na[a] = Sh && En(Ke, a) ? Ke[a] : $h('Symbol.' + a)), na[a]);
	},
	wh = Y,
	$n = ae,
	wn = Uo,
	...
	Nh = Ph('toPrimitive'),
	Ih = function (a, e) {
		if (!$n(a) || wn(a)) return a;
		var t = Ch(a, Nh),
			r;
		if (t) {
			if ((e === void 0 && (e = 'default'), (r = wh(t, a, e)), !$n(r) || wn(r))) return r;
	...
	? tv
		? function (e, t, r) {
				if (
					...
					(t = Pn(t)),
					Ut(r),
					typeof e == 'function' && t === 'prototype' && 'value' in r && la in r && !r[la])
				) {
					var i = av(e, t);
					i &&
						i[la] &&
...
var iv = he,
	...
	uv = Ya && Object.getOwnPropertyDescriptor,
	Qo = ov(qo, 'name'),
	lv = Qo && function () {}.name === 'something',
	hv = Qo && (!Ya || (Ya && uv(qo, 'name').configurable)),
...
var Ei = Xa.inspectSource,
	...
	dv = B,
	Rn = gv.WeakMap,
	pv = dv(Rn) && /native code/.test(String(Rn)),
	yv = Si,
	mv = zo,
	Nn = yv('keys'),
	$i = function (a) {
		return Nn[a] || (Nn[a] = mv(a));
	},
	wi = {},
	bv = pv,
	Ko = _,
...
var wr = { set: gr, get: Tt, has: dr, enforce: $v, getterFor: wv },
	...
	kv = (Wo.exports = function (a, e, t) {
		(Mv(Mn(e), 0, 7) === 'Symbol(' && (e = '[' + _v(Mn(e), /^Symbol\(([^)]*)\).*$/, '$1') + ']'),
			t && t.getter && (e = 'get ' + e),
			t && t.setter && (e = 'set ' + e),
			(!Gt(a, 'name') || (Pv && a.name !== e)) &&
				(qa ? or(a, 'name', { value: e, configurable: !0 }) : (a.name = e)),
...
var Jo = Wo.exports,
	...
	ru = function (a, e) {
		var t = sf(a),
			...
			i = [],
			n;
		for (n in t) !fa(uf, n) && fa(t, n) && _n(i, n);
		for (; e.length > r; ) fa(t, (n = e[r++])) && (~of(i, n) || _n(i, n));
		return i;
	},
	Pi = [
		'constructor',
...
var ff = Fe,
	...
	Dn = rc('toStringTag'),
	Pr = function (a, e, t) {
		(a && !t && (a = a.prototype), a && !tc(a, Dn) && ec(a, Dn, { configurable: !0, value: e }));
	},
	Ln = Jo,
	ac = Oe,
	ic = function (a, e, t) {
		return (
			t.get && Ln(t.get, e, { getter: !0 }),
			t.set && Ln(t.set, e, { setter: !0 }),
			ac.f(a, e, t)
		);
	},
	nc = Fe,
...
var Rc =
	...
	kc = Lc('species'),
	fu = function (a, e) {
		var t = Bn(a).constructor,
			r;
		return t === void 0 || Dc((r = Bn(t)[kc])) ? e : Vc(r);
	},
	Bc = br,
	...
	Hc = Fe,
	du = Hc('document', 'documentElement'),
	Yc = L,
	Xc = Yc([].slice),
	Wc = TypeError,
	qc = function (a, e) {
	...
	Qc = wt,
	pu = /(?:ipad|iphone|ipod).*applewebkit/i.test(Qc),
	ie = _,
	Kc = gu,
	Zc = Ii,
	Gn = B,
	...
	ag = Ar,
	Qa = ie.setImmediate,
	Yn = ie.clearImmediate,
	ig = ie.process,
	ca = ie.Dispatch,
	ng = ie.Function,
	Xn = ie.MessageChannel,
	sg = ie.String,
	ga = 0,
	bt = {},
	...
	ag
		...
		: ca && ca.now
			...
			: Xn && !rg
				? ((da = new Xn()),
					(pa = da.port2),
					(da.port1.onmessage = qn),
					(Ie = Zc(pa.postMessage, pa)))
				: ie.addEventListener &&
					  Gn(ie.postMessage) &&
					  !ie.importScripts &&
					  Ot &&
					  Ot.protocol !== 'file:' &&
					  !yu(Qn)
					? ((Ie = Qn), ie.addEventListener('message', qn, !1))
					: Wn in Hn('script')
						? (Ie = function (a) {
								zn.appendChild(Hn('script'))[Wn] = function () {
									(zn.removeChild(this), Mi(a));
								};
							})
						: (Ie = function (a) {
								setTimeout(ya(a), 0);
...
var xu = bu,
	...
	mg = cg,
	ba = Ar,
	Jn = at.MutationObserver || at.WebKitMutationObserver,
	es = at.document,
	ts = at.process,
	Yt = at.Promise,
	Ka = gg('queueMicrotask'),
	Xe,
	xa,
	Ta,
	Xt,
...
if (!Ka) {
	var Wt = new dg(),
		qt = function () {
			var a, e;
			for (ba && (a = ts.domain) && a.exit(); (e = Wt.get()); )
				try {
					e();
				} catch (t) {
					throw (Wt.head && Xe(), t);
	...
	(!pg && !ba && !mg && Jn && es
		? ((xa = !0),
			(Ta = es.createTextNode('')),
			new Jn(qt).observe(Ta, { characterData: !0 }),
			(Xe = function () {
				Ta.data = xa = !xa;
			}))
		: !yg && Yt && Yt.resolve
...
var Cg = wg('species'),
	Za = !1,
	Tu = Sg(Og.PromiseRejectionEvent),
	Ag = Eg('Promise', function () {
		...
		if (!Oa || Oa < 51 || !/native code/.test(a)) {
			var t = new xt(function (n) {
				...
				i = (t.constructor = {});
			if (((i[Cg] = r), (Za = t.then(function () {}) instanceof r), !Za)) return !0;
		}
		return !e && (as === 'BROWSER' || as === 'DENO') && !Tu;
	}),
	Pt = { CONSTRUCTOR: Ag, REJECTION_EVENT: Tu, SUBCLASSING: Za },
	ut = {},
	is = Te,
	Pg = TypeError,
	Rg = function (a) {
...
var Ng = ee,
	...
	ei = Eu.f,
	Hg = ei,
	Yg = !!(Ja && Ja.createEvent && we.dispatchEvent),
	...
	Iu = function (a, e) {
		...
		try {
			i
				? (r || (e.rejection === Pu && Qg(e), (e.rejection = ki)),
					i === !0 ? (u = t) : (s && s.enter(), (u = i(t)), s && (s.exit(), (h = !0))),
					u === a.promise ? o(new wu('Promise-chain cycle')) : (l = Nu(u)) ? it(l, u, n, o) : n(u))
				: o(t);
		} catch (f) {
			(s && !h && s.exit(), o(f));
		}
	...
	Mu = function (a, e) {
		a.notified ||
			((a.notified = !0),
			Vi(function () {
				for (var t = a.reactions, r; (r = t.get()); ) Iu(r, a);
	...
	_u = function (a, e, t) {
		...
		(Yg
			...
			!Ug && (i = we['on' + a]) ? i(r) : a === Cu && Bg('Unhandled promise rejection', t));
	},
	qg = function (a) {
		it(Ou, we, function () {
			var e = a.facade,
			...
			if (
				r &&
				((i = jg(function () {
					pr ? Li.emit('unhandledRejection', t, e) : _u(Cu, e, t);
				})),
				(a.rejection = pr || hs(a) ? Pu : ki),
				i.error)
			)
				throw i.value;
		});
	...
	Qg = function (a) {
		it(Ou, we, function () {
			var e = a.facade;
			pr ? Li.emit('rejectionHandled', e) : _u(Xg, e, a.value);
		});
	},
	Ze = function (a, e, t) {
		return function (r) {
	...
	et = function (a, e, t) {
		a.done || ((a.done = !0), t && (a = t), (a.value = e), (a.state = Wg), Mu(a, !0));
	},
	ti = function (a, e, t) {
		if (!a.done) {
			((a.done = !0), t && (a = t));
			try {
				...
				r
					? Vi(function () {
							var i = { done: !1 };
							try {
								it(r, e, Ze(ti, i, a), Ze(et, i, a));
							} catch (n) {
								et(i, n, a);
							}
						})
					: ((a.value = e), (a.state = Au), Mu(a, !1));
			} catch (i) {
				et({ done: !1 }, i, a);
			}
		}
...
if (
	...
	(Kt.prototype = ns(Qt, 'then', function (e, t) {
		var r = Sa(this),
			i = ei(kg(this, Le));
		return (
			(r.parent = !0),
	...
	(Eu.f = ei =
		function (a) {
			return a === Le || a === Ru ? new us(a) : Hg(a);
		}),
...
Ng({ global: !0, constructor: !0, wrap: !0, forced: $u }, { Promise: Le });
Ru = Ig.Promise;
Mg(Le, Ir, !1);
_g(Ir);
var Rt = {},
	...
	Du = function (a, e, t) {
		var r = t && t.that,
			...
			d,
			p = function (x) {
				return (l && gs(l, 'normal'), new hr(!0, x));
			},
			y = function (x) {
		...
		if (n) l = a.iterator;
			...
			if (Td(h)) {
				for (f = 0, c = Od(a); c > f; f++) if (((v = y(a[f])), v && cs(ds, v))) return v;
				return new hr(!1);
			}
			l = Sd(a, h);
		}
...
if (Ud(ri)) {
	var ms = Fd('Promise').prototype.catch;
	ys.catch !== ms && Gd(ys, 'catch', ms, { unsafe: !0 });
}
var zd = ee,
	Hd = Y,
	Yd = Te,
...
var fp =
	...
	Fu = { BROKEN_CARET: fp, UNSUPPORTED_Y: Fi },
	Uu = {},
	cp = ru,
	gp = Pi,
	dp =
...
var Op = J,
	...
	vr = function () {
		...
		vr = typeof document < 'u' ? (document.domain && Zt ? Ss(Zt) : Ap()) : Ss(Zt);
		for (var a = xs.length; a--; ) delete vr[ai][xs[a]];
		return vr();
	};
Ep[Gu] = !0;
var Ui =
		...
		function (e, t) {
			var r;
			return (
				e !== null ? ((Ea[ai] = Op(e)), (r = new Ea()), (Ea[ai] = null), (r[Gu] = e)) : (r = vr()),
				t === void 0 ? r : Sp.f(r, t)
			);
		},
	Pp = D,
...
qp &&
	(ni = function (e) {
		var t = this,
			...
			f,
			c;
		if (n) return ((n.lastIndex = t.lastIndex), (o = Je(ni, n, i)), (t.lastIndex = n.lastIndex), o);
		var v = r.groups,
			g = Hu && t.sticky,
			d = Je(kp, t),
			p = t.source,
...
var Gi = ni,
	Qp = ee,
	Es = Gi;
Qp({ target: 'RegExp', proto: !0, forced: /./.exec !== Es }, { exec: Es });
var $s = Y,
	ws = Ue,
	Kp = Gi,
	Cs = D,
	...
	zi = function (a, e, t, r) {
		...
		if (!n || !o || t) {
			...
			(ws(String.prototype, a, u[0]), ws(wa, i, u[1]));
		}
		r && Zp(wa[i], 'sham', !0);
	},
	Hi = L,
		...
		return function (e, t) {
			...
			return i < 0 || i >= n
				? a
					...
					: void 0
				: ((o = As(r, i)),
					o < 55296 || o > 56319 || i + 1 === n || (s = As(r, i + 1)) < 56320 || s > 57343
						? a
							? ay(r, i)
							: o
						: a
	...
	hy = !ly(function () {
		...
		var s = Object.getOwnPropertyDescriptor(Ps.prototype, 'flags').get.call(e);
		return s !== r || t !== r;
	}),
	vy = { correct: hy },
	fy = Y,
	...
	Xi = Rs.correct
		...
		: function (a) {
				return !Rs.correct && gy(py, a) && !cy(a, 'flags') ? fy(dy, a) : a.flags;
			},
	Ns = Y,
	yy = J,
	my = B,
	...
	Wi = function (a, e) {
		...
		if (by(a) === 'RegExp') return Ns(xy, a, e);
...
Ey('match', function (a, e, t) {
	return [
		...
		function (r) {
			...
			var s = Jt(Ny(i));
			if (Ms(s, 'g') === -1) return Is(i, n);
			var u = Ms(s, 'u') !== -1;
			i.lastIndex = 0;
			for (var l = [], h = 0, f; (f = Is(i, n)) !== null; ) {
				var c = Jt(f[0]);
...
By(
	...
	function (a, e, t) {
		...
		return [
			function (n, o) {
				var s = Yy(this),
					u = Gy(n) ? Wy(n, ui) : void 0;
				return u ? _s(u, n, s, o) : _s(e, Me(s), n, o);
			},
			function (i, n) {
				var o = Fy(this),
					s = Me(i);
				...
				for (var p = '', y = 0, x = 0; x < v.length; x++) {
					g = v[x];
					for (
						var b = Me(g[0]), T = Jy(em(zy(g.index), s.length), 0), $ = [], E, O = 1;
						O < g.length;
						O++
					)
						Pa($, rm(g[O]));
...
gm(
	{ target: 'String', proto: !0, forced: !Sm && !Xu },
	{
...
var Em = z,
	...
	li = Em('unscopables'),
	hi = Array.prototype;
hi[li] === void 0 && wm(hi, li, { configurable: !0, value: $m(null) });
var Cm = function (a) {
		hi[li][a] = !0;
	},
	Am = D,
	...
	Wu = _m
		...
		: function (a) {
				var e = Im(a);
				if (Rm(e, ks)) return e[ks];
				var t = e.constructor;
				return Nm(t) && e instanceof t ? t.prototype : e instanceof vi ? Vm : null;
			},
	Dm = D,
	Lm = B,
	km = ae,
...
[].keys &&
	((Na = [].keys()),
	'next' in Na ? ((Ra = Bs(Bs(Na))), Ra !== Object.prototype && (ke = Ra)) : (qu = !0));
var Fm =
	!km(ke) ||
	Dm(function () {
		var a = {};
...
var Qu = { IteratorPrototype: ke, BUGGY_SAFARI_ITERATORS: qu },
	Um = Qu.IteratorPrototype,
	Gm = Ui,
	zm = bi,
	Hm = Pr,
	Ym = Rt,
	...
	a0 = Ku.PROPER,
	i0 = Ku.CONFIGURABLE,
	Us = Zu.IteratorPrototype,
	tr = Zu.BUGGY_SAFARI_ITERATORS,
	ct = t0('iterator'),
	Gs = 'keys',
	gt = 'values',
	zs = 'entries',
	...
	s0 = function (a, e, t, r, i, n, o) {
		...
		if (
			(v &&
				...
				g !== Object.prototype &&
					g.next &&
					(js(g) !== Us && (Fs ? Fs(g, Us) : Km(g[ct]) || Ia(g, ct, n0)), Jm(g, u, !0))),
			a0 &&
				i === gt &&
				f &&
				f.name !== gt &&
			...
			if (((d = { values: s(gt), keys: n ? c : s(Gs), entries: s(zs) }), o))
	...
	g0 = h0(
		...
		'Array',
		function (a, e) {
			f0(this, { type: el, target: u0(a), index: 0, kind: e });
		},
		function () {
			var a = c0(this),
				e = a.target,
	...
	Ys = (Hs.Arguments = Hs.Array);
Zi('keys');
Zi('values');
Zi('entries');
if (v0 && Ys.name !== 'values')
	try {
		l0(Ys, 'name', { value: 'values' });
	} catch {}
var d0 = {
		CSSRuleList: 0,
	...
	Xs = Ma && Ma.constructor && Ma.constructor.prototype,
	y0 = Xs === Object.prototype ? void 0 : Xs,
	Ws = _,
	tl = d0,
	m0 = y0,
	pt = g0,
...
for (var Da in tl) rl(Ws[Da] && Ws[Da].prototype, Da);
rl(m0, 'DOMTokenList');
function Ji(a, e, t) {
	return (
		(e = El(e)) in a
...
var T0 = Te,
	...
	E0 = Ai,
	Qs = TypeError,
	Ks = 'Reduce of empty array with no initial value',
	$0 = function (a) {
		return function (e, t, r, i) {
			var n = O0(e),
				o = S0(n),
				s = E0(n);
			if ((T0(t), s === 0 && r < 2)) throw new Qs(Ks);
			var u = a ? s - 1 : 0,
				l = a ? -1 : 1;
			if (r < 2)
				for (;;) {
					...
					if (((u += l), a ? u < 0 : s <= u)) throw new Qs(Ks);
				}
	...
	M0 = I0 || !R0('reduce');
A0(
	{ target: 'Array', proto: !0, forced: M0 },
	{
		reduce: function (e) {
...
var _0 = ee,
	...
	G0 =
		!il &&
		!!(function () {
			var a = D0(String.prototype, 'endsWith');
			return a && !a.writable;
		})();
_0(
	{ target: 'String', proto: !0, forced: !G0 && !il },
	{
		endsWith: function (e) {
			var t = Js(B0(this));
			k0(e);
			var r = arguments.length > 1 ? arguments[1] : void 0,
				i = t.length,
				n = r === void 0 ? i : U0(L0(r), i),
				o = Js(e);
			return F0(t, n - o.length, n) === o;
		}
	}
);
var La = Y,
...
z0(
	...
	function (a, e, t) {
		...
		return [
			function (n, o) {
				var s = X0(this),
					u = Y0(n) ? K0(n, a) : void 0;
				return u ? La(u, n, s, o) : La(r, eo(s), n, o);
			},
			function (i, n) {
				var o = H0(this),
					s = eo(i);
				...
				for (var g = 0, d = 0, p = []; d < s.length; ) {
					c.lastIndex = We ? 0 : d;
					var y = to(c, We ? Ba(s, d) : s),
						x;
					if (y === null || (x = tb(Q0(c.lastIndex + (We ? d : 0)), s.length)) === g)
						d = q0(s, d, h);
					else {
...
for (var dt = 0; !nt && dt < ar.length; dt++)
	((nt = be[ar[dt] + 'Request' + tt]),
		(St = be[ar[dt] + 'Cancel' + tt] || be[ar[dt] + 'CancelRequest' + tt]));
if (!nt || !St) {
	var ja = 0,
		ao = 0,
		_e = [],
	...
	((nt = function (a) {
		...
		return (_e.push({ handle: ++ao, callback: a, cancelled: !1 }), ao);
	}),
		(St = function (a) {
...
\v\f\r                　\u2028\u2029\uFEFF`,
	...
	fb = function (a) {
		return function (e) {
			var t = lb(ub(e));
			return (a & 1 && (t = io(t, hb, '')), a & 2 && (t = io(t, vb, '$1')), t);
		};
	},
	cb = { trim: fb(3) },
	gb = $r.PROPER,
	...
	pb = function (a) {
		return db(function () {
			return !!no[a]() || so[a]() !== so || (gb && no[a].name !== a);
		});
	},
	yb = ee,
	mb = cb.trim,
...
Tb(
	{ target: 'Array', proto: !0, forced: $b },
	{
		indexOf: function (e) {
			...
			return ol ? di(this, e, t) || 0 : Sb(this, e, t);
		}
	}
);
var wb = ee,
...
wb(
	...
	{
		includes: function (e) {
			return !!~Nb(oo(Pb(this)), oo(Ab(e)), arguments.length > 1 ? arguments[1] : void 0);
		}
	}
);
var Ib = je,
...
_b(
	...
	{
		reverse: function () {
			return (Db(this) && (this.length = this.length), Lb(this));
		}
	}
);
/*! *****************************************************************************
...
function ue() {
	...
	for (var t = 0; t < a.length; t++)
		if (typeof a[t] != 'number')
			throw new Error(
				'assertNumbers arguments[' + t + '] is not a number. ' + typeof a[t] + ' == typeof ' + a[t]
			);
	return !0;
}
var Ee = Math.PI;
					...
					? (function (h, f, c) {
							...
							for (
								...
								var K = function (se, ge) {
									var Se = pi([se * h.rX, ge * h.rY], h.xRot),
										ze = Se[0],
										It = Se[1];
			...
			var s = function (c) {
				...
				f = i(function (c, v, g) {
					...
					if (
						...
						(p(d.x), y(d.y));
						for (var x = 0, b = fo(v, d.x1, d.x2, d.x); x < b.length; x++)
							0 < (N = b[x]) && 1 > N && p(co(v, d.x1, d.x2, d.x, N));
						for (var T = 0, $ = fo(g, d.y1, d.y2, d.y); T < $.length; T++)
							0 < (N = $[T]) && 1 > N && y(co(g, d.y1, d.y2, d.y, N));
					}
					if (d.type & m.ARC) {
						...
						for (
							...
							(N = q[G]) > R && N < X && p(vo(d.cX, O, P, N));
						for (var H = 0, Q = lo(V, -C, 0).map(W); H < Q.length; H++) {
							var N;
							(N = Q[H]) > R && N < X && y(vo(d.cY, C, V, N));
						}
					}
					return c;
				});
											...
											if (this.curArgs.length === 0 || this.curArgs.length === 1) {
												if (0 > h)
													throw new SyntaxError(
														'Expected positive number, got "' + h + '" at index "' + o + '"'
													);
											} else if (
												(this.curArgs.length === 3 || this.curArgs.length === 4) &&
												this.curNumber !== '0' &&
												...
												throw new SyntaxError(
													'Expected a flag, got "' + this.curNumber + '" at index "' + o + '"'
												);
										}
										(this.curArgs.push(h),
											this.curArgs.length === Fb[this.curCommandType] &&
...
function e1(a, e, t, r, i, n) {
	...
	for (var He = 0; He < r; He++) {
		...
		for (var fn = r, Xr = 0, Wr = 0, qr = 0, Qr = 0, Bt = 1; Bt <= n; Bt++) {
			b = (fn + He) << 2;
			var jt = h - Bt;
			((Vt += (v.r = Pe = o[b]) * jt),
				(Dt += (v.g = Re = o[b + 1]) * jt),
...
var d2 = Object.freeze({ __proto__: null, offscreen: t1, node: r1 });
function lt(a) {
...
var u1 = /(\[[^\]]+\])/g,
	l1 = /(#[^\s+>~.[:]+)/g,
	h1 = /(\.[^\s+>~.[:]+)/g,
	v1 = /(::[^\s+>~.[:]+|:first-line|:first-letter|:before|:after)/gi,
	f1 = /(:[\w-]+\([^)]*\))/gi,
	c1 = /(:[^\s+>~.[:]+)/g,
	g1 = /([^\s+>~.[:]+)/g;
function Ve(a, e) {
...
function yi(a, e) {
	return (a[0] * e[0] + a[1] * e[1]) / (mo(a) * mo(e));
}
function bo(a, e) {
...
class S {
	...
	getColor(e) {
		...
		return (
			this.isNormalizedColor || ((this.isNormalizedColor = !0), (t = o1(t)), (this.value = t)),
			t
		);
	}
	getDpi() {
...
var gl = typeof window < 'u' ? window : null,
	dl = typeof fetch < 'u' ? fetch.bind(void 0) : null;
class Dr {
	constructor(e) {
		var { fetch: t = dl, window: r = gl } =
		...
		((this.ctx = e),
			...
			(this.viewPort = new p1()),
			(this.mouse = new y1(this)),
			(this.animations = []),
			(this.waits = []),
			...
			var d = Date.now(),
				...
				x = () => {
					((d = Date.now()),
						...
						y >= g &&
							((p = d - (y % g)),
							this.shouldUpdate(i, s) && (this.render(e, n, o, u, l, h, f), v.runEvents())),
	...
	render(e, t, r, i, n, o, s) {
		...
		!t &&
			...
			(g.hasValue() &&
				((v.width = g.getPixels('x')), v.style && (v.style.width = ''.concat(v.width, 'px'))),
			d.hasValue() &&
				((v.height = d.getPixels('y')), v.style && (v.style.height = ''.concat(v.height, 'px'))));
...
Dr.defaultWindow = gl;
Dr.defaultFetch = dl;
var { defaultFetch: m1 } = Dr,
	b1 = typeof DOMParser < 'u' ? DOMParser : null;
class Ga {
	constructor() {
		var { fetch: e = m1, DOMParser: t = b1 } =
...
Be.transformTypes = { translate: x1, rotate: T1, scale: O1, matrix: pl, skewX: S1, skewY: E1 };
class I {
	constructor(e, t) {
			...
			if (!r.startsWith('@') && this.matchesSelector(r)) {
				...
				if (i)
					for (var o in i) {
						...
						(typeof s > 'u' && (s = '000'),
							n >= s && ((this.styles[o] = i[o]), (this.stylesSpecificity[o] = n)));
					}
			}
	}
	removeStyles(e, t) {
...
class ce {
	...
	bezierCurveAdd(e, t, r, i, n) {
		...
		if (s === 0) {
			...
			0 < l &&
				l < 1 &&
				(e ? this.addX(this.sumCubic(l, t, r, i, n)) : this.addY(this.sumCubic(l, t, r, i, n)));
			return;
		}
		...
		if (!(h < 0)) {
			...
			0 < f &&
				f < 1 &&
				(e ? this.addX(this.sumCubic(f, t, r, i, n)) : this.addY(this.sumCubic(f, t, r, i, n)));
			var c = (-o - Math.sqrt(h)) / (2 * s);
			0 < c &&
				c < 1 &&
				(e ? this.addX(this.sumCubic(c, t, r, i, n)) : this.addY(this.sumCubic(c, t, r, i, n)));
		}
	}
...
class Nt extends Ge {
	...
	setContext(e) {
		var t,
			...
			o = e.canvas;
		if (
			(i.setDefaults(e), o.style && typeof e.font < 'u' && n && typeof n.getComputedStyle < 'u')
		) {
		...
		(v && ((d = v[0]), (p = v[1])),
			...
			this.node &&
				(!this.parent ||
					((t = this.node.parentNode) === null || t === void 0 ? void 0 : t.nodeName) ===
						'foreignObject') &&
	...
	update(e) {
		...
		if (
			...
			if (
				...
				return (
					(this.removed = !0),
					r.setValue(t.animationFrozen ? t.animationFrozenValue : this.initialValue),
					!0
				);
			return !1;
		}
...
class q1 extends Ce {
	...
	renderChildren(e) {
		if (this.hasText) {
			...
			n.isWorking() &&
				n.checkBoundingBox(this, new ce(r, i - o.getPixels('y'), r + this.measureText(e), i));
...
class Q1 extends Ce {
	...
	findSegmentToFitChar(e, t, r, i, n, o, s, u, l) {
		...
		if (s) {
			var y = Math.cos(Math.PI / 2 + p) * s,
				x = Math.cos(-p) * s;
			((d.p0 = ir(ir({}, v), {}, { x: v.x + y, y: v.y + x })),
				(d.p1 = ir(ir({}, g), {}, { x: g.x + y, y: g.y + x })));
		}
		...
		if (!this.glyphInfo) {
			...
			((s === 'middle' || s === 'center') && (b = -p / 2),
				...
				r.forEach((T, $) => {
					...
					((b = E),
						!(!O.p0 || !O.p1) &&
							this.glyphInfo.push({ text: r[$], p0: O.p0, p1: O.p1, rotation: C }));
				}));
		}
	}
	parsePathData(e) {
	...
	calcLength(e, t, r, i) {
		...
		switch (r) {
			...
			case w.CURVE_TO:
				for (
					n = 0,
						o = this.getPointOnCubicBezier(0, e, t, i[0], i[1], i[2], i[3], i[4], i[5]),
						u = 0.01;
					u <= 1;
					u += 0.01
				)
			...
			case w.QUAD_TO:
				for (
					n = 0, o = this.getPointOnQuadraticBezier(0, e, t, i[0], i[1], i[2], i[3]), u = 0.01;
					u <= 1;
					u += 0.01
				)
	...
	getPointOnCubicBezier(e, t, r, i, n, o, s, u, l) {
		var h = u * xo(e) + o * To(e) + i * Oo(e) + t * So(e),
			f = l * xo(e) + s * To(e) + n * Oo(e) + r * So(e);
		return { x: h, y: f };
	}
	getPointOnQuadraticBezier(e, t, r, i, n, o, s) {
		var u = o * Eo(e) + i * $o(e) + t * wo(e),
			l = s * Eo(e) + n * $o(e) + r * wo(e);
		return { x: u, y: l };
	}
	...
	load(e, t) {
		...
		return xe(function* () {
			try {
				...
				'Error while loading font "'.concat(t, '":');
			}
			r.loaded = !0;
		})();
	}
...
class Sl extends I {
	...
	apply(e, t, r, i, n) {
		for (
			var { includeOpacity: o, matrix: s } = this, u = e.getImageData(0, 0, i, n), l = 0;
			l < n;
			l++
		)
			for (var h = 0; h < i; h++) {
...
class r2 extends I {
	...
	apply(e) {
		...
		(r && ((r.beginPath = Ao), (r.closePath = Ao)),
			Reflect.apply(i, e, []),
...
class $e {
	...
	setViewBox(e) {
		this.screen.setViewBox(h2({ document: this }, e));
	}
}
$e.createCanvas = v2;
$e.createImage = f2;
...
class mt {
	...
	render() {
		...
		return xe(function* () {
			...
			(t.start(De({ enableRedraw: !0, ignoreAnimation: !0, ignoreMouse: !0 }, r)),
				yield t.ready(),
				t.stop());
		})();
	}
...
export {
	q1 as AElement,
	G1 as AnimateColorElement,
	rn as AnimateElement,
	z1 as AnimateTransformElement,
	ce as BoundingBox,
	xo as CB1,
	To as CB2,
	Oo as CB3,
	...
	k as Point,
	D1 as PolygonElement,
	xl as PolylineElement,
	S as Property,
	Eo as QB1,
	$o as QB2,
	wo as QB3,
	F1 as RadialGradientElement,
	bl as RectElement,
...
//# sourceMappingURL=3DiFlQP-.js.map
