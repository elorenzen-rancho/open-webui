...
import { s as zt } from './BX5WB7ra.js';
import { l as ee } from './CrKpsNbG.js';
var Vt = (function () {
			...
			parse: o(function (r) {
				...
				function $t() {
					...
					return (
						(B = f.pop() || E.lex() || Jt),
						typeof B != 'number' &&
							(B instanceof Array && ((f = B), (B = f.pop())), (B = l.symbols_[B] || B)),
						B
					);
				}
				o($t, 'lex');
...
Expecting ` +
					...
					if (N[0] instanceof Array && N.length > 1)
						throw new Error(
							'Parse Error: multiple actions possible at state: ' + Z + ', token: ' + w
						);
					switch (N[0]) {
						case 1:
							(g.push(w),
						...
						case 2:
							if (
								...
								return Et;
							(M &&
								((g = g.slice(0, -1 * M * 2)), (_ = _.slice(0, -1 * M)), (e = e.slice(0, -1 * M))),
...
` +
				...
				next: o(function () {
					...
					for (var _ = this._currentRules(), e = 0; e < _.length; e++)
						if (
							((g = this._input.match(this.rules[_[e]])), g && (!l || g[0].length > l[0].length))
						) {
			...
			getDefaultConfig() {
				...
				return {
					...
					quadrantLabelFontSize:
						((d = D.quadrantChart) == null ? void 0 : d.quadrantLabelFontSize) || 16,
					quadrantTextTopPadding:
						((T = D.quadrantChart) == null ? void 0 : T.quadrantTextTopPadding) || 5,
...
` + t
		...
		let A;
		a === 'sandbox' && (A = zt('#i' + n));
		const T = (a === 'sandbox' ? zt(A.nodes()[0].contentDocument.body) : zt('body')).select(
				`[id="${n}"]`
			),
	...
	Re = { draw: Be },
	Qe = { parser: De, db: we, renderer: Re, styles: o(() => '', 'styles') };
export { Qe as diagram };
//# sourceMappingURL=AC6yNglM.js.map
