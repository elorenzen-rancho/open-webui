const e = 'Awal ɣef',
	...
	Oo = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 war talast, neɣ aɣerwaḍ ilaw i talast tusdidt',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' neɣ '-1' i wakud war tilas.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(amedya. `sh webui.sh --api --api-auth username_password`)',
		'(e.g. `sh webui.sh --api`)': '(amedya `sh webui.sh --api`)',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Lqem amaynut n (v{{LATEST_VERSION}}), yella akka tura.',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Tamudemt n temsekra tettuseqdec mi ara tgeḍ timsekra am usirew n yizwal i yidiwenniyen akked tuttriwin n unadi deg web',
		'a user': 'aseqdac',
		About: e,
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Xdem lameṛ-a s tira n "/{COMMAND}}" akken ad tqeṣṣreḍ asekcem.',
		Active: o,
		...
		'Add a short description about what this model does':
			'Rnu aglam wezzilen ɣef wayen i txeddem tmudemt-a',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Aswati n yiɣewwaren-a ad yessuter ibeddilen s wudem ameɣradan i yiseqdacen akk.',
		admin: d,
		Admin: u,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Inedbalen sɛan anekcum ɣer meṛṛa ifecka melmi i bɣan; iseqdacen ilaq ad asen-ttwamudden yifecka i yal tamudemt deg tallunt n umahil.',
		Advanced: m,
		...
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Tetḥeqqeḍ tebɣiḍ ad tekkseḍ akk aktayen? Tigawt-a ur tettwakkes ara.',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Tetḥeqqemt tebɣamt ad d-tekksemt akk iqecwalen iarkasen?',
		...
		'Base Model List Cache speeds up access by fetching base models only at startup or on settings save—faster, but may not show recent base model changes.':
			'Umuɣ n uzadur n tebdart Cache yessazzel anekcum s tmudmin tidusanin kan deg ubeddu neɣ deg yiɣewwaren i d-yettwasellken — amestir, maca yezmer lḥal ur d-yesskan ara ibeddilen ineggura n tmudemt azadur.',
		Bearer: F,
		before: W,
		...
		'Boosting or penalizing specific tokens for constrained responses. Bias values will be clamped between -100 and 100 (inclusive). (Default: none)':
			'Aserkem neɣ angal n yiqenṭaren ulmisen i tririt yettwaḥeṛsen. Azalen ibirusanen ad ttwakecfen gar 100 d 100 (asekcam). Lmut: ala',
		Brave: G,
		...
		'Call feature is not supported when using Web STT engine':
			'Tamahilt n usiwel ur tettwasefrak ara mi ara tesqedceḍ amsedday Web STT',
		Camera: H,
		Cancel: Q,
		...
		'Click here to download user import template file.':
			'Sit da akken ad d-tzedmeḍ afaylu n tmudemt n uketer n iseqdac.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Tekki da akken ad tissineḍ ugar ɣef wamek i tettɣawaleḍ ugar, twaliḍ timudmin yellan.',
		...
		"Click on the user role button to change a user's role.":
			'Tekki ɣef tqeffalt n temlilt n useqdac akken ad tbeddleḍ tamlilt n useqdac.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Yettwagdel unekcum ɣer tira. Ssefqed iɣewwaṛen-ik n yiminig ma ulac aɣilif akken ad tkecmeḍ ɣer wayen ilaqen.',
		Clone: le,
		...
		'Connect to your own OpenAI compatible API endpoints.':
			'Qqen ɣer wagazen-ik n taggara n API yemṣaban OpenAI.',
		'Connect to your own OpenAPI compatible external tool servers.':
			'Qqen ɣer yiqeddacen-ik n yifecka imeṛṛa yeldin.',
		'Connected ({{type}})': '',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			'Yessefk ad tḥeṛseḍ ussis ɣef ssebba n tmudmin n usseɣẓen. D ayen izemren kan ad yesseɣẓen timudmin seg yisaǧǧawen ulmisen i yettɛawanen ussisen n usseɣẓen.',
		...
		'Control the repetition of token sequences in the generated text. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 1.1) will be more lenient. At 1, it is disabled.':
			'Ssenqed amek ara tɛawdeḍ ad d-tɛawdeḍ tiseddarin n usekkil deg uḍris-nni i d-yettwalalen. Azal ɛlayen (amedya, 1.5) ad iɛawed ad iɛawed ad iɛawed ad iɛeddi s lǧehd, ma d azal n wadda (amedya, 1.1) ad yili d win yettɛeddin ugar. Ɣef 1, d ameɛdur.',
		Controls: Ce,
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			'Ssneqdet amnekni garkoerenza d tanḍa n tuffɣa. Azal n wadda ad d-yeglu s wugar n tmuɣli d uḍris udwis.',
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'CORS ilaq ad yeswel akken iwata sɣur usaǧǧaw akken ad yeǧǧ issutren seg WebUI yeldin.',
		'Could not read file.': '',
		CPU: Ee,
		Create: qe,
		...
		'Create your first note by clicking on the plus button below.':
			'Rnu tazmilt-ik⋅im tamezwarut s usiti ɣef tqeffalt ddaw.',
		...
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			'Ma nmuqel amek ara nɛawed ad nɛawed ad nɛawed ad nɛawed ad d-nekkes ayen yesɛan azal d wayen icudden ɣer ugbur, ilaq-as i tuget n tegnatin.',
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'Tuqqniwin tusridin ttaǧǧant iseqdacen ad qqnen ɣer wagazen-nsen n taggara API imṣadan OpenAI.',
		'Direct Message': '',
		...
		'Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.':
			'Kkes-d asufeɣ n tugna seg PDF. Ma yella aseqdec n LLM yermed, tugniwin ad ttwakelsent s wudem awurman. Imezwura ɣer False.',
		Disabled: je,
		'Disconnect OAuth': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			'Wali amek ara tesqedceḍ Open WebUI udiɣ amek ara ad tnadiḍ tallelt ar temɣiwant.',
		...
		'Discover, download, and explore custom prompts':
			'Af-d, zdem-d, tesnirmeḍ-d ineftaɣen udmawanen',
		...
		'Discover, download, and explore model presets':
			'Af-d, zdem-d, tesnirmeḍ-d iferdisen n tmudemt',
		...
		'Display the username instead of You in the Chat':
			'Sken isem n useqdac deg wadeg n "Kečč⋅Kemm" deg yidiwenniyen',
		...
		'Do not install functions from sources you do not fully trust.':
			'Ur sebdad ara tisɣunin seg iɣbula ur tettamneḍ ara akken iwata.',
		'Do not install tools from sources you do not fully trust.':
			'Ur srusuy ara ifecka seg iɣbula ur tettamneḍ ara akken iwata.',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'ur teqqen ara ɣer tuqqniwin tizɣarayin, akka isefka-k⋅m ad qqimen d iɣellsanen ɣef uqeddac-ik⋅im adigan.',
		'Domain Filter List': 'Tabdart n taɣulin ara yettwasizedgen',
		"don't fetch random pipelines from sources you don't trust.":
			'ur d-awi ara pipelines igacuranen seg yiɣbula ur tettamneḍ ara.',
		"Don't have an account?": 'Ur tesɛiḍ ara amiḍan?',
		"don't install random functions from sources you don't trust.":
			'ur sebdad ara timahilin tigacuranin i d-yekkan seg yiɣbula ur tettamneḍ ara.',
		"don't install random tools from sources you don't trust.":
			'ur srusuy ara ifecka igacuranen seg yiɣbula ur tettamneḍ ara.',
		...
		'e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)':
			'amedya, audio/wav,audio/mpeg,video/* (anef-as d ilem i yimezwura)',
		...
		'Enable autocomplete generation for chat messages':
			'Rmed tasuta tawurmant tummidt i udiwenni iznan',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Ssefqed afaylu-inek CSV deg-s 4 n tgejda deg uswir-a: Isem, Email, awal uffir, Role.',
		'Enter {{role}} message here': 'Sekcem izen n {{role}} dagi',
		'Enter a detail about yourself for your LLMs to recall':
			'Ssekcem-d ttfaṣil ɣef yiman-nnek akken ad d-temmektid LLMs-nnek akken ad d-temmektid',
		'Enter a title for the pending user info overlay. Leave empty for default.':
			'Sekcem azwel i ugrudem n useqdac la yettraǧun. Eǧǧ-it d ilem i umezwar.',
		'Enter a watermark for the response. Leave empty for none.':
			'Sekcem ticreḍt tafrawant i tririt. Eǧǧ-it d ilem i wulac.',
		...
		'Enter api auth string (e.g. username:password)':
			'Sekcem azrir n usesteb n api (amedya. isem n useqdac:awal n uɛeddi)',
		...
		'Enter content for the pending user info overlay. Leave empty for default.':
			'Sekcem agbur n telɣut n useqdac yettwaṛjan. Eǧǧ ilem i tazwara.',
		...
		'Enter JSON config (e.g., {"disable_links": true})':
			'Sekcem-d tawila JSON (amedya, {"disable_links": true})',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Sekcem URL apṛuksi (amedya. https://user:password@host:port)',
		...
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'Sekcem tansa URL tazayezt n WebUI-inek. Tansa-a URL ad tettwaseqdec i usuffeɣ n iseɣwan deg ilɣa.',
		...
		'Enter URL (e.g. http://127.0.0.1:7860/)':
			'Sekcem tansa URL (amedya. http://127.0.0.0.1:7860/)',
		...
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			'Sekcem tansa URL n Yacy (amedya. http://yacy.example.com:8090)',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Amedya: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Amedya: sAMAccountName neɣ uid neɣ userPrincipalName',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			'Ḍḍef-d amḍan n tesɣimin deg turagt-nnek. Ma ulac aɣilif, nnermes akken ad ternuḍ amḍan n yikersiyen.',
		Exclude: ha,
		'Execute code': '',
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'Ur yessaweḍ ara ad yeqqen ɣer {{URL}} n uqeddac n yifecka OpenAPI',
		...
		'Failed to extract content from the file: {{error}}':
			'Ur yessaweḍ ara ad d-yekkes agbur seg ufaylu: {{error}}',
		...
		'File size should not exceed {{maxSize}} MB.':
			'Tiddi n ufaylu ur ilaq ara ad tɛeddi nnig {{maxSize}} MB.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Tban-d tɣenǧawt n uskenjbir Ur yezmir yiwen ad yesseqdec inizjali d avatar. Ma nmuqel tugna n umaɣnu amezwer.',
		...
		'Forwards system user session credentials to authenticate':
			'Welleh inekcam n tɣimit n useqdac i usesteb',
		Fr_day_of_week: Na,
		...
		'Functions allow arbitrary code execution.':
			'Tiwuriwin ssirigent aselkem n tengalt tagacurant.',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Steɛṛfeɣ belli ɣriɣ yerna fehmeɣ d acu i d ssebba n tigawt-iw. Ẓriɣ timijwin ay yeqqnen ɣer usenger n tengalt tazurant yernu sfeqdeɣ tinfulin n uɣbalu-nni.',
		ID: mt,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Seddu annay `--api-auth` lawan n uselkem n stable-diffusion-webui',
		'Include `--api` flag when running stable-diffusion-webui':
			"Seddu takbabt ''-api' mi ara teslekmeḍ stable-diffusion-webui",
		...
		'Leave empty to include all models or select specific models':
			'Eǧǧ-it d ilem akken ad ternuḍ akk timudmiwin neɣ ad tferneḍ timudmiwin tulmisin',
		...
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Eǧǧ-it d ilem akken ad tesqedceḍ aneftaɣ-nni amezwaru, naɣ sekcem-d yiwen n uneftaɣ udmawan',
		'Leave model field empty to use the default model.':
			'Eǧǧ urti n tmudemt d ilem i useqdec n tmudemt-nni tamezwarut.',
		Legacy: Dt,
		lexical: xt,
		License: Ot,
		...
		'LLMs can make mistakes. Verify important information.':
			'LLMs yezmer ad yecceḍ. Senqed talɣut yesɛan azal.',
		Loader: Kt,
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Ur ttettumt ara ad tessiǧwemt aman n umahil. afaylu json d amasal API seg ComfyUI.',
		Male: Jt,
		Manage: Ht,
		'Manage Connections': '',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Maximum n 3 n tmudmin yezmer ad d-yettwasider seg-a ɣer da. Ttxil-k, ɛreḍ tikkelt niḍen ticki.',
		May: Xt,
		MBR: $t,
		MCP: en,
		...
		'Memories accessible by LLMs will be shown here.':
			'Da ara d-banent teḥkayin ara yaweḍ yiwen ɣer LLMs.',
		Memory: on,
		...
		'Message rating should be enabled to use this feature':
			'A win yufan, tazmilt n yizen ad tettwasireg i useqdec n tmahilt-a',
		messages: ln,
		Messages: dn,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Izen ara d-tazneḍ mi ara d-tesnulfuḍ aseɣwen-ik ur yettwabḍu ara. Iseqdacen yesɛan tansa URL ad izmiren ad walin adiwenni-nni yettwabḍan.',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Tettwasider-d tmudemt '{{modelName}}' akken iwata.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Tamudemt '{{modelTag}}' ha-t-an yakan deg tebdart n usader.",
		...
		'Model can execute code and perform calculations':
			'Mudell yezmer ad d-yesseḍru tangalt u ad yexdem leḥsabat',
		'Model can generate images based on text prompts':
			'Ammud yezmer ad d-yawi tugniwin yebnan ɣef teɣratin n yiḍrisen',
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Abrid n unagraw n wammud iban-d. Isem n umudil yettwasra i uleqqem, ur yezmir ara ad ikemmel.',
		...
		'Model name already exists, please choose a different one':
			'Yella yakan yisem n tmudemt, ma ulac aɣilif fren wayeḍ yemwalafen',
		...
		'No HTML, CSS, or JavaScript content found.':
			'Ulac agbur HTML, CSS neɣ JavaScript i d-yufraren.',
		'No inference engine with management support found':
			'Ulac amsedday n unalkam s tallelt n usefrek i yettwafen',
		'No kernel': '',
		...
		'Only alphanumeric characters and hyphens are allowed':
			'Ala iwudam ifenyanen d tfenṭazit i yettusirgen',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Ala iwudam ifenyanen d tfendiwin i yettusirgen deg uzrar n ukman.',
		'Only can be triggered when the chat input is in focus.': '',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Ala tigrummiwin i izemren ad ttwabeddlent, ad d-snulfunt azadur amaynut n tmussni i ubeddel/ad arraten.',
		...
		'Only select users and groups with permission can access':
			'Ala iseqdacen akked yegrawen yesɛan tisirag i izemren ad kecmen',
		...
		'Oops! There was an error in the previous response.':
			'Ayhuh! Teḍra-d tuccḍa deg tririt-nni yezrin.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Ayhuh! Aql-ik tesseqdaceḍ tarrayt ur yettwasefraken ara (mazwar kan). Ma ulac aɣilif, mudd-d WebUI seg uɛrur.',
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			'Open WebUI yezmer ad yesseqdec ifecka i d-yettak yal aqeddac OpenAPI.',
		...
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Ldi WebUI yesseqdac SpeechT5 akked CMU Arktik.',
		'Open WebUI version': '',
		...
		'Permission denied when accessing media devices':
			'Ttwagedlent tsirag lawan n unekcum ɣer yibenkan n yimidyaten',
		'Permission denied when accessing microphone': 'Yettwagdel unekcum ɣer usawaḍ',
		'Permission denied when accessing microphone: {{error}}':
			'Yettwagdel unekcum ɣer usawaḍ: {{error}}',
		Permissions: ei,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines d unagraw n izegrar s uselkem n tengalt awurman —',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'Asulay n uzwir yettusexdem i wakken ur d-yettili ara umennuɣ akked tuqqna-nniḍen s tmerna n usewgelhen i yimuhal n tmudemt - eǧǧ-iten d ilmawen i tukksa n tuqqna',
		...
		'Prompts Sharing': '',
		'Provider Type': 'Tawsit n usaǧǧaw',
		Public: wi,
		...
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Err iman-ik d "Aseqdac" (amedya, "Aseqdac ilemmed taspenyulit")',
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Ilɣa n tririt ur zmiren ara ad ttwasremden imi ugin ttesriḥat n usmel web. Ttxil-k, rzu ɣef yiɣewwaren-ik n yiminig akken ad tkecmeḍ ɣer wayen ilaqen.',
		...
		'Select how to split message text for TTS requests':
			'Fren amek ara tebḍuḍ aḍris n yiznan i usuter n TTS',
		...
		'Selected model(s) do not support image inputs':
			'Ammud(s) yettwafernen ur yessefrak ara inekcamen n tugniwin yettwafernen',
		'Selected Models': '',
		semantic: $i,
		Send: es,
		...
		'Set the number of worker threads used for computation. This option controls how many threads are used to process incoming requests concurrently. Increasing this value can improve performance under high concurrency workloads but may also consume more CPU resources.':
			'Sbadu amḍan n tnelli n yixeddamen yettwasqedcen i umṣada. Tifrat-a teḥkem acḥal n tnelli i yennumen ttḥerriken issutren i d-iteddun akka tura. Asenqes n wazal-a yezmer ad yesnerni aswir deg usali n yisali n umahil n uḥezzeb meqqren maca yezmer daɣen ad yečč ugar n teɣbula CPU.',
		...
		'Sets the size of the context window used to generate the next token.':
			'Sbadu tiddi n tzewwut tasatalant yellan zik tetteg-d asken ay d-yetteddun.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			'Sbadu tiseddarin n uḥbas i useqdec. Mi ara d-temlil temɛawdit-a, LLM ad teḥbes asegrew n uḍris d tuɣalin. Timɛayin n uḥbas yeggten zemrent ad ttwasbeddent s usbadu n waṭas n yizamulen n uḥbas yemgaraden deg tmudemt.',
		Setting: ns,
		Settings: is,
		...
		'Skip the cache and re-run the inference. Defaults to False.':
			'Seqcer aṭaksi-nni, tɛawdeḍ-as assefreg. Imezwura ɣer False.',
		...
		'Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.':
			'Sfeḍ aḍris OCR yellan yakan seg PDF akked OCR i d-yettuɣalen. Ur ttettu ara ma yella Force OCR tettwarmed. Imezwura ɣer False.',
		...
		'The format to return a response in. Format can be json or a JSON schema.':
			'Amasal ideg ilaq ad d-tettwarr tririt. Amasal yezmer ad yili d json neɣ d azenziɣ n JSON.',
		'The height in pixels to compress images to. Leave empty for no compression.':
			'Tiddi n yipiksilen akken ad ssedhun tugniwin. Eǧǧ ilem war aḥezzeb.',
		...
		'The LDAP attribute that maps to the mail that users use to sign in.':
			'Imyerr LDAP i d-ttawint tgertilin ɣer tebratin i sseqdacen yiseqdacen akken ad zemlen.',
		'The LDAP attribute that maps to the username that users use to sign in.':
			'Imyerr LDAP i d-yeqqaren tikarḍiwin i yisem n useqdac i sseqdacen yiseqdacen akken ad zemlen.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'Tafelwit n uɣella attan akka tura deg beta, dɣa nezmer ad neswati leḥsabat n ṭṭubba akken ara nessinef alguritm.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'Tiddi n ufaylu afellay deg MB. Ma yella teɣzi n ufaylu tɛedda i talast-a, afaylu ur yettali ara.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'Amḍan afellay n yifuyla i izemren ad ttwasqedcen ɣef tikkelt deg udiwenni. Ma yella amḍan n yifuyla iɛedda i talast-a, ifuyla ur ttalin ara.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			"Amasal n tuffɣa i uḍris. Tzemreḍ ad tiliḍ d 'json', d 'markdown' neɣ d 'html'. Imezwura ɣer 'markdown'.",
		"The passwords you entered don't quite match. Please double-check and try again.":
			'Awalen uffiren i teskecmeḍ ur mwatan ara mliḥ. Ttxil-k·m, ssefqed snat n tikkal yernu ɛreḍ tikkelt nniḍen.',
		...
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'Taẓɣelt n tmudemt. Asenqes n teẓɣelt ad yerr tamudemt d tiririt s tesɣent ugar.',
		...
		'The width in pixels to compress images to. Leave empty for no compression.':
			'Tehri s ipiksilen i tussda n tugniwin. Eǧǧ-it d ilem i war tussda.',
		Theme: Rs,
		'There was an error syncing your stats. Please try again.': '',
		'Thinking...': 'Yettxemmim…',
		'This action cannot be undone. Do you wish to continue?':
			'Tigawt-a ur tettwakkes ara. Tebɣiḍ ad tkemmleḍ?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'Abadu-a yettwasnulaf-d deg {{created} Ɣef}}. D ta i d tazwara maḍi n ubadu {{channelName}}.',
		"This chat won't appear in history and your messages will not be saved.":
			'Aqeṣṣer-a ur d-yettban deg umezruy yerna iznan-nnek ur ttwaselkamen.',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'D ayen ara yeǧǧen adiwenni-inek s wazal-is ad yettwasellek s tɣellist deg taffa n yisefka-inek n deffir. Tanemmirt!',
		...
		'This feature is experimental and may be modified or discontinued without notice.':
			'Tamahilt-a d tirmitant yerna tezmer ad tettwabeddel neɣ ad teḥbes war tamawt.',
		'This folder is empty': '',
		'This is a default user permission and will remain enabled.': '',
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Ta d taɣawsa tirmitant, yezmer lḥal ur tleḥḥu ara akken i tebɣiḍ, dɣa d asentel n ubeddel melmi tebɣiḍ.',
		'This model is not publicly available. Please select another model.':
			'Tamudemt-a ur telli d tazayezt akk i medden. Ttxil-k·m, fren tamudemt nniḍen.',
		...
		'This option enables or disables the use of the reasoning feature in Ollama, which allows the model to think before generating a response. When enabled, the model can take a moment to process the conversation context and generate a more thoughtful response.':
			'Tifrat-a ad teǧǧ neɣ ad tessenqes aseqdec n tmahilt n usseɣẓen deg Ollama, ayen yettaǧǧan tamudemt ad txemmem uqbel ad d-tawi tiririt. Ma yessaweḍ yiwen, tamudemt tezmer ad teṭṭef cwiṭ n wakud akken ad tseddu asatal n umeslay u ad d-tawi tiririt yettxemmimen ugar.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Aya ad yekkes <strong>{NAME}}</strong> akked <strong> akk ayen yellan deg-s</strong>.',
		'This will delete all models including custom models':
			'Aya ad yekkes akk timudmin yellan gar-asent timudmin n tannumi',
		'This will delete all models including custom models and cannot be undone.':
			'Aya ad yekkes akk timudmin gar-asent timudmin tudmawanin yerna ur yezmir yiwen ad tent-id-yerr.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Aya ad yales taffa n tmussni u ad yemtawi akk ifuyla. Tebɣiḍ ad tkemmleḍ?',
		...
		'To access the available model names for downloading,':
			'Akken ad tkecmeḍ ɣer yismawen n tmudmiwin yellan i uzdam,',
		'To access the GGUF models available for downloading,':
			'Akken ad tkecmeḍ ɣer tmudmin GGUF yellan i usader,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'Akken ad tkecmeḍ ɣer WebUI, ttxil-k, nermes anedbal. Imedminen zemren ad sselḥun addaden n useqdac seg ugalis Admin.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Akken ad teqqneḍ taffa n tmessunin da, rnu-tent ɣer "Timessunin" n temnaḍṭ n umahil, di tazwara.',
		'To learn more about available endpoints, visit our documentation.':
			'Akken ad tissineḍ ugar ɣef wagazen n taggara yellan, rzu ɣer warrat-nneɣ.',
		'To select skills here, add them to the "Skills" workspace first.': '',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Akken ad tferneḍ ifecka da, rnu-ten, di tazwara, ɣer tallunt n umahil "Ifecka".',
		...
		'Try adjusting your search or filter to find what you are looking for.':
			'Ɛreḍ ad tesgidiḍ anadi-inek·inem neɣ amsizdeg-ik·im akken ad tafeḍ ayen akken iɣef tettnadiḍ.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Lhu-d d uɣawas n turagt i tzemmar yesnernayen, gar-asent tannumi d ukunyak, d tallelt yemmugen i tallelt.',
		Upload: no,
		...
		'Upload Progress: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)':
			'Tikli n uɛebbi: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Seqdec '#' deg urti n usekcem n uneftaɣ i wakken ad tɛebbiḍ timessunin-inek·inem.",
		...
		'Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.':
			'Seqdec proxy i d-yesnulfa http_proxy akked https_proxy environment variables to fetch page contents.',
		user: ro,
		User: lo,
		'User Activity': '',
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Aseqdec n tmudemt n uzna amezwer s yal timudmin. Tekki ɣef tqeffalt-nni n tmerniwt akken ad ternuḍ timudmin tinsayanin.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Lqem {{s lqem yettwafernen}} n {{totalVersions}}',
		'Version deleted': '',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Ɣur-k: Asewḥel n waya ad yeǧǧ iseqdacen ad d-salin tangalt tazurant ɣef uqeddac.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			'Ɣur-k: Asselkem n Jupyter yettaǧǧa asselkem n tengalt tazurant, d tukksa n tmijwin n tɣellist qessiḥen — s leḥder meqqren.',
		We_day_of_week: bo,
		Web: So,
		'Web API': 'API Web',
		...
		'WebUI will make requests to "{{url}}/chat/completions"':
			'WebUI ad ssutreɣ i "{url}}/chat/completions"',
		Week: Io,
		Weekly: vo,
		...
		'Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.':
			'Ma tebɣiḍ ad d-tessugneḍ tuffɣa. Yal asebter ad yebḍu s ulugen igli d wuṭṭun n usebter. Imezwura ɣer False.',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Aru agzul s 50 n wawalen i yessewzalen [asefru neɣ tasarut].',
...
Amedya.) Kečč d Mario seg Super Mario Bros, txeddmeḍ amzun d amalal.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'Imir-a, aql-ik tesseqdaced turagt n ccṛeɛ. Ma ulac aɣilif, dduklet akken ad tesselhum turagt-nwen.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Tzemreḍ kan ad tqeṣṣreḍ s afellay n ufaylu(s) n {{maxCount}} ɣef tikelt.',
		...
		'Your account status is currently pending activation.':
			'Addad-nnem n umiḍan atan yettṛaju armad.',
...
//# sourceMappingURL=AKmSJ68X.js.map
