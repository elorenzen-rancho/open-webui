const pt = Symbol.for('yaml.alias'),
	at = Symbol.for('yaml.document'),
	W = Symbol.for('yaml.map'),
	Rt = Symbol.for('yaml.pair'),
	V = Symbol.for('yaml.scalar'),
	de = Symbol.for('yaml.seq'),
	j = Symbol.for('yaml.node.type'),
	X = (s) => !!s && typeof s == 'object' && s[j] === pt,
	te = (s) => !!s && typeof s == 'object' && s[j] === at,
	pe = (s) => !!s && typeof s == 'object' && s[j] === W,
	L = (s) => !!s && typeof s == 'object' && s[j] === Rt,
	I = (s) => !!s && typeof s == 'object' && s[j] === V,
	me = (s) => !!s && typeof s == 'object' && s[j] === de;
function $(s) {
...
const Ut = (s) => (I(s) || $(s)) && !!s.anchor,
	M = Symbol('break visit'),
	Ft = Symbol('skip children'),
	F = Symbol('remove node');
function se(s, e) {
	const t = Vt(e);
	te(s)
		? re(null, s.contents, t, Object.freeze([s])) === F && (s.contents = null)
		: re(null, s, t, Object.freeze([]));
}
se.BREAK = M;
se.SKIP = Ft;
se.REMOVE = F;
function re(s, e, t, n) {
	const i = Jt(s, e, t, n);
	if (_(i) || L(i)) return (Yt(s, n, i), re(s, i, t, n));
	if (typeof i != 'symbol') {
		if ($(e)) {
...
async function Ue(s, e) {
	const t = Vt(e);
	te(s)
		? (await oe(null, s.contents, t, Object.freeze([s]))) === F && (s.contents = null)
		: await oe(null, s, t, Object.freeze([]));
}
Ue.BREAK = M;
Ue.SKIP = Ft;
Ue.REMOVE = F;
async function oe(s, e, t, n) {
	const i = await Jt(s, e, t, n);
	if (_(i) || L(i)) return (Yt(s, n, i), oe(s, i, t, n));
	if (typeof i != 'symbol') {
		if ($(e)) {
			n = Object.freeze(n.concat(e));
			for (let r = 0; r < e.items.length; ++r) {
...
function Jt(s, e, t, n) {
	...
	if (pe(e)) return (i = t.Map) == null ? void 0 : i.call(t, s, e, n);
	if (me(e)) return (r = t.Seq) == null ? void 0 : r.call(t, s, e, n);
	if (L(e)) return (o = t.Pair) == null ? void 0 : o.call(t, s, e, n);
	if (I(e)) return (l = t.Scalar) == null ? void 0 : l.call(t, s, e, n);
	if (X(e)) return (a = t.Alias) == null ? void 0 : a.call(t, s, e, n);
}
function Yt(s, e, t) {
	const n = e[e.length - 1];
	if ($(n)) n.items[s] = t;
	else if (L(n)) s === 'key' ? (n.key = t) : (n.value = t);
	else if (te(n)) n.contents = t;
	else {
		const i = X(n) ? 'alias' : 'scalar';
		throw new Error(`Cannot replace node with ${i} parent`);
	}
}
const Ms = { '!': '%21', ',': '%2C', '[': '%5B', ']': '%5D', '{': '%7B', '}': '%7D' },
	Ks = (s) => s.replace(/[!,[\]{}]/g, (e) => Ms[e]);
class B {
	constructor(e, t) {
		((this.docStart = null),
			(this.docEnd = !1),
		...
		switch (this.yaml.version) {
			...
			case '1.2':
				((this.atNextDocument = !1),
					(this.yaml = { explicit: B.defaultYaml.explicit, version: '1.2' }),
	...
	tagString(e) {
		for (const [t, n] of Object.entries(this.tags))
			if (e.startsWith(n)) return t + Ks(e.substring(n.length));
		return e[0] === '!' ? e : `!<${e}>`;
	}
	toString(e) {
...
function Ps(s, e) {
	...
	return {
		...
		setAnchors: () => {
			for (const r of t) {
				const o = n.get(r);
				if (typeof o == 'object' && o.anchor && (I(o.node) || $(o.node))) o.node.anchor = o.anchor;
				else {
...
function P(s, e, t) {
	if (Array.isArray(s)) return s.map((n, i) => P(n, String(i), t));
	if (s && typeof s.toJSON == 'function') {
		if (!t || !Ut(s)) return s.toJSON(e, t);
...
class mt {
	...
	toJS(e, { mapAsMap: t, maxAliasCount: n, onAnchor: i, reviver: r } = {}) {
		if (!te(e)) throw new TypeError('A document argument is required');
		const o = {
				anchors: new Map(),
				doc: e,
				keep: !0,
...
class Fe extends mt {
	...
	toJSON(e, t) {
		...
		if (
			r >= 0 &&
			((l.count += 1),
			l.aliasCount === 0 && (l.aliasCount = Be(i, o, n)),
...
function Ne(s, e, t) {
	var f, d, h;
	if ((te(s) && (s = s.contents), _(s))) return s;
	if (L(s)) {
	...
	if (n && s && typeof s == 'object') {
		if (((a = l.get(s)), a)) return (a.anchor ?? (a.anchor = i(s)), new Fe(a.anchor));
	...
	const p =
		c != null && c.createNode
			...
			: typeof ((h = c == null ? void 0 : c.nodeClass) == null ? void 0 : h.from) == 'function'
...
class Xt extends mt {
	...
	clone(e) {
		...
		return (
			e && (t.schema = e),
			(t.items = t.items.map((n) => (_(n) || L(n) ? n.clone(e) : n))),
	...
	deleteIn(e) {
		...
		if ($(i)) return i.deleteIn(n);
		throw new Error(`Expected YAML collection at ${t}. Remaining path: ${n}`);
	}
	getIn(e, t) {
		const [n, ...i] = e,
			r = this.get(n, !0);
		return i.length === 0 ? (!t && I(r) ? r.value : r) : $(r) ? r.getIn(i, t) : void 0;
	}
	hasAllNullValues(e) {
...
function Ve(
	...
	let d,
		...
		m = -1,
		g = -1;
	t === ct && ((u = _t(s, u, e.length)), u !== -1 && (f = u + a));
	for (let k; (k = s[(u += 1)]); ) {
		if (t === Me && k === '\\') {
			switch (((m = u), s[u + 1])) {
				case 'x':
...
`
			...
			(t === ct && (u = _t(s, u, e.length)), (f = u + e.length + a), (d = void 0));
		else {
			if (
				k === ' ' &&
				h &&
...
` &&
			...
			if (u >= f)
				if (d) (c.push(d), (f = d + a), (d = void 0));
				else if (t === Me) {
					for (; h === ' ' || h === '	'; ) ((h = k), (k = s[(u += 1)]), (y = !0));
...
`),
	...
	return ((o = l ? o + t.slice(l) : t), n ? o : Ve(o, r, Me, Je(e, !1)));
}
function ft(s, e) {
	if (
...
${t}`
			...
			"'";
	return e.implicitKey ? n : Ve(n, t, zt, Je(e, !1));
}
function ae(s, e) {
...
function Ke({ comment: s, type: e, value: t }, n, i, r) {
	...
	if (!o || /\n[\t ]+$/.test(t)) return ae(t, n);
	const c = n.indent || (n.forceBlockIndent || Ye(t) ? '  ' : ''),
		p =
			o === 'literal'
				? !0
...
` &&
	...
	const y = h.indexOf(`
`);
	(y === -1 ? (f = '-') : t === h || y !== h.length - 1 ? ((f = '+'), r && r()) : (f = ''),
		h &&
...
function Us(s, e, t, n) {
	const { type: i, value: r } = s,
		{ actualString: o, implicitKey: l, indent: a, indentStep: c, inFlow: p } = e;
	if (
		(l &&
			r.includes(`
`)) ||
...
`)
		...
		return Ke(s, e, t, n);
	if (Ye(r)) {
		if (a === '') return ((e.forceBlockIndent = !0), Ke(s, e, t, n));
		if (l && a === c) return ae(r, e);
	}
	const f = r.replace(
		/\n+/g,
		`$&
${a}`
	...
	if (o) {
		const d = (u) => {
				...
				return (
					u.default &&
					u.tag !== 'tag:yaml.org,2002:str' &&
					((m = u.test) == null ? void 0 : m.test(f))
				);
			},
			{ compat: h, tags: y } = e.doc.schema;
		if (y.some(d) || (h != null && h.some(d))) return ae(r, e);
	}
	return l ? f : Ve(f, a, zt, Je(e, !1));
}
function Ee(s, e, t, n) {
	...
	if (c === null) {
		const { defaultKeyType: p, defaultStringType: f } = e.options,
			d = (i && p) || f;
		if (((c = a(d)), c === null)) throw new Error(`Unsupported default string type ${d}`);
	}
	return c;
}
function Zt(s, e) {
...
function Fs(s, e) {
	...
	if (e.tag) {
		...
		if (r.length > 0) return r.find((o) => o.format === e.format) ?? r[0];
	}
	let t, n;
	if (I(e)) {
		n = e.value;
	...
	} else ((n = e), (t = s.find((r) => r.nodeClass && n instanceof r.nodeClass)));
	if (!t) {
		const r =
			((i = n == null ? void 0 : n.constructor) == null ? void 0 : i.name) ??
...
function ue(s, e, t, n) {
	var a;
	if (L(s)) return s.toString(e, t, n);
	if (X(s)) {
...
function Js({ key: s, value: e }, t, n, i) {
	const {
		...
		indent: l,
		indentStep: a,
		options: { commentString: c, indentSeq: p, simpleKeys: f }
	} = t;
	...
	t = Object.assign({}, t, { allNullValues: !1, implicitKey: !h && (f || !r), indent: l + a });
	let y = !1,
		u = !1,
		m = ue(
			s,
	...
	if (t.inFlow) {
		if (r || e == null) return (y && n && n(), m === '' ? '?' : h ? `? ${m}` : m);
	} else if ((r && !f) || (e == null && h))
		return ((m = `? ${m}`), d && !y ? (m += z(m, t.indent, c(d))) : u && i && i(), m);
	(y && (d = null),
		h
			? (d && (m += z(m, t.indent, c(d))),
				(m = `? ${m}
${l}:`))
			: ((m = `${m}:`), d && (m += z(m, t.indent, c(d)))));
	let g, b, k;
	(_(e)
		? ((g = !!e.spaceBefore), (b = e.commentBefore), (k = e.comment))
		: ((g = !1), (b = null), (k = null), e && typeof e == 'object' && (e = o.createNode(e))),
		(t.implicitKey = !1),
		!h && !d && I(e) && (t.indentAtStart = m.length + 1),
		(u = !1),
		!p &&
			a.length >= 2 &&
			!t.inFlow &&
...
`),
			T = w !== -1,
			v = t.inFlow ?? e.flow ?? e.items.length === 0;
		if (T || !v) {
			let J = !1;
			if (T && (A === '&' || A === '!')) {
				let D = N.indexOf(' ');
				(A === '&' && D !== -1 && D < w && N[D + 1] === '!' && (D = N.indexOf(' ', D + 1)),
					(D === -1 || w < D) && (J = !0));
			}
			J ||
				(E = `
...
`) &&
	...
	return (
		(m += E + N),
		t.inFlow ? S && n && n() : k && !S ? (m += z(m, t.indent, c(k))) : u && i && i(),
		m
	);
}
function xt(s, e) {
...
const Le = '<<',
	G = {
		...
		test: /^<<$/,
		resolve: () => Object.assign(new O(Symbol(Le)), { addToJSMap: es }),
		stringify: () => Le
	},
	Ys = (s, e) =>
		(G.identify(e) || (I(e) && (!e.type || e.type === O.PLAIN) && G.identify(e.value))) &&
		(s == null ? void 0 : s.doc.schema.tags.some((t) => t.tag === G.tag && t.default));
function es(s, e, t) {
	if (((t = s && X(t) ? t.resolve(s.doc) : t), me(t))) for (const n of t.items) tt(s, e, n);
	else if (Array.isArray(t)) for (const n of t) tt(s, e, n);
	else tt(s, e, t);
}
function tt(s, e, t) {
	const n = s && X(t) ? t.resolve(s.doc) : t;
	if (!pe(n)) throw new Error('Merge sources must be maps or map aliases');
...
function ts(s, e, { key: t, value: n }) {
	if (_(t) && t.addToJSMap) t.addToJSMap(s, e, n);
	else if (Ys(s, t)) es(s, e, n);
	else {
		const i = P(t, '', s);
		if (e instanceof Map) e.set(i, P(n, i, s));
...
class C {
	...
	toJSON(e, t) {
		const n = t != null && t.mapAsMap ? new Map() : {};
		return ts(t, n, this);
	}
	toString(e, t, n) {
...
function ss(s, e, t) {
	return ((e.inFlow ?? s.flow) ? Ws : Qs)(s, e, t);
}
function Qs(
	{ comment: s, items: e },
	t,
	...
	for (let y = 0; y < e.length; ++y) {
		...
		if (_(u))
			(!f && u.spaceBefore && d.push(''),
				De(t, d, u.commentBefore, f),
				u.comment && (m = u.comment));
		else if (L(u)) {
		...
		(m && (g += z(g, r, c(m))), f && m && (f = !1), d.push(n + g));
	}
	let h;
	if (d.length === 0) h = i.start + i.end;
	else {
		h = d[0];
...
function Ws({ items: s }, e, { flowChars: t, itemIndent: n }) {
	const {
		indent: i,
		indentStep: r,
	...
	for (let y = 0; y < s.length; ++y) {
		...
		if (_(u))
			...
			k
				...
				: u.value == null && b != null && b.comment && (m = b.comment);
		}
		m && (c = !0);
		let g = ue(u, a, () => (m = null));
		(c ||
			...
			y < s.length - 1
				...
				: e.options.trailingComma &&
					(e.options.lineWidth > 0 &&
						(c ||
							(c = f.reduce((b, k) => b + k.length + 2, 2) + (g.length + 2) > e.options.lineWidth)),
					c && (g += ',')),
			m && (g += z(g, n, l(m))),
			f.push(g),
			(p = f.length));
...
function Z(s, e) {
	...
	for (const n of s)
		if (L(n) && (n.key === e || n.key === t || (I(n.key) && n.key.value === t))) return n;
}
class K extends Xt {
	static get tagName() {
	...
	static from(e, t, n) {
		const { keepUndefined: i, replacer: r } = n,
			...
			l = (a, c) => {
				...
				(c !== void 0 || i) && o.items.push(yt(a, c, n));
			};
	...
	add(e, t) {
		...
		L(e)
			...
			: !e || typeof e != 'object' || !('key' in e)
				? (n = new C(e, e == null ? void 0 : e.value))
				: (n = new C(e.key, e.value));
		const i = Z(this.items, n.key),
			r = (o = this.schema) == null ? void 0 : o.sortMapEntries;
		if (i) {
	...
	toJSON(e, t, n) {
		const i = n ? new n() : t != null && t.mapAsMap ? new Map() : {};
		t != null && t.onCreate && t.onCreate(i);
		for (const r of this.items) ts(t, i, r);
		return i;
	}
	toString(e, t, n) {
...
class H extends Xt {
	...
	toJSON(e, t) {
		...
		let i = 0;
		for (const r of this.items) n.push(P(r, String(i++), t));
		return n;
	}
	toString(e, t, n) {
		return e
...
const ge = {
	...
	Qe = {
		...
		stringify: ({ source: s }, e) =>
			typeof s == 'string' && Qe.test.test(s) ? s : e.options.nullStr
	},
	gt = {
...
const ns = {
	...
	bt = (s, e, t, { intAsBigInt: n }) => (n ? BigInt(s) : parseInt(s.substring(e), t));
function os(s, e, t) {
	const { value: n } = s;
...
const ls = {
	...
	Hs = [ye, ge, Ge, Qe, gt, ls, as, cs, ns, is, rs];
function Ct(s) {
	return typeof s == 'bigint' || Number.isInteger(s);
}
const _e = ({ value: s }) => JSON.stringify(s),
	Xs = [
		{
			identify: (s) => typeof s == 'string',
			default: !0,
		...
		stringify({ comment: s, type: e, value: t }, n, i, r) {
			...
			if ((e ?? (e = O.BLOCK_LITERAL), e !== O.QUOTE_DOUBLE)) {
				const a = Math.max(n.options.lineWidth - n.indent.length, n.options.minContentWidth),
					...
					p = new Array(c);
				for (let f = 0, d = 0; f < c; ++f, d += a) p[f] = l.substr(d, a);
				l = p.join(
					e === O.BLOCK_LITERAL
						? `
`
	...
	add(e) {
		...
		(L(e)
			...
			: e && typeof e == 'object' && 'key' in e && 'value' in e && e.value === null
				? (t = new C(e.key, null))
				: (t = new C(e, null)),
			Z(this.items, t.key) || this.items.push(t));
	}
	get(e, t) {
		const n = Z(this.items, e);
		return !t && L(n) ? (I(n.key) ? n.key.value : n.key) : n;
	}
	set(e, t) {
		if (typeof t != 'boolean')
...
const Ot = {
	...
	resolve(s, e) {
		if (pe(s)) {
			if (s.hasAllNullValues(!0)) return Object.assign(new fe(), s);
...
function ms(s) {
	...
	else if (isNaN(e) || !isFinite(e)) return U(s);
	let n = '';
	e < 0 && ((n = '-'), (e *= t(-1)));
	const i = t(60),
		r = [e % i];
...
const ys = {
	...
	Xe = {
		...
		stringify: ({ value: s }) =>
			(s == null ? void 0 : s.toISOString().replace(/(T00:00:00)?\.000Z$/, '')) ?? ''
	},
	vt = [ye, ge, Ge, Qe, ds, ps, sn, nn, rn, on, xs, en, tn, wt, G, kt, St, Ot, ys, gs, Xe],
	Bt = new Map([
		['core', Hs],
		['failsafe', [ye, ge, Ge]],
		['json', Zs],
	...
	ln = {
		...
		'tag:yaml.org,2002:set': Ot,
		'tag:yaml.org,2002:timestamp': Xe
	};
function st(s, e, t) {
	const n = Bt.get(e);
	if (n && !s) return t && !n.includes(G) ? n.concat(G) : n.slice();
	let i = n;
	if (!i)
		if (Array.isArray(s)) i = [];
		else {
			const r = Array.from(Bt.keys())
				.filter((o) => o !== 'yaml11')
	...
	return (
		t && (i = i.concat(G)),
		i.reduce((r, o) => {
			const l = typeof o == 'string' ? Mt[o] : o;
			if (!l) {
...
class ze {
	constructor({
		...
		((this.compat = Array.isArray(e) ? st(e, 'compat') : e ? st(null, e) : null),
			(this.name = (typeof r == 'string' && r) || 'core'),
			(this.knownTags = i ? ln : {}),
			(this.tags = st(t, this.name, n)),
			(this.toStringOptions = l ?? null),
			Object.defineProperty(this, W, { value: ye }),
			Object.defineProperty(this, V, { value: Ge }),
			Object.defineProperty(this, de, { value: ge }),
			(this.sortMapEntries = typeof o == 'function' ? o : o === !0 ? an : null));
	}
	clone() {
...
function cn(s, e) {
	...
	if (s.contents) {
		...
		(l && (p += z(p, '', r(l))),
			(p[0] === '|' || p[0] === '>') && t[t.length - 1] === '---'
				? (t[t.length - 1] = `--- ${p}`)
				: t.push(p));
	} else t.push(ue(s.contents, i));
...
class be {
	constructor(e, t, n) {
		((this.commentBefore = null),
			...
			(this.errors = []),
			(this.warnings = []),
			Object.defineProperty(this, j, { value: at }));
		let i = null;
	...
	clone() {
		...
		return (
			...
			(e.contents = _(this.contents) ? this.contents.clone(e.schema) : this.contents),
	...
	createNode(e, t, n) {
		...
		if (typeof t == 'function') ((e = t.call({ '': e }, '', e)), (i = t));
			...
			const m = (b) => typeof b == 'number' || b instanceof String || b instanceof Number,
		...
		const {
			...
			{ onAnchor: f, setAnchors: d, sourceObjects: h } = Ps(this, o || 'a'),
			y = {
	...
	set(e, t) {
		this.contents == null
			...
			: ne(this.contents) && this.contents.set(e, t);
	}
	setIn(e, t) {
		Se(e)
			? (this.contents = t)
			: this.contents == null
				...
				: ne(this.contents) && this.contents.setIn(e, t);
	}
	setSchema(e, t = {}) {
		...
		else if (n) this.schema = new ze(Object.assign(n, t));
	...
	toJS({ json: e, jsonArg: t, mapAsMap: n, maxAliasCount: i, onAnchor: r, reviver: o } = {}) {
		...
		if (typeof r == 'function') for (const { count: c, res: p } of l.anchors.values()) r(p, c);
...
`),
	...
	if (/[^ ]/.test(o)) {
		let l = 1;
		const a = t.linePos[1];
		(a == null ? void 0 : a.line) === n &&
			a.col > i &&
			(l = Math.max(1, Math.min(a.col - i, 80 - r)));
...
function he(
		...
		switch (
			...
			u &&
				(c &&
					w.type !== 'comment' &&
					w.type !== 'newline' &&
					r(u, 'TAB_AS_INDENT', 'Tabs are not allowed as indentation'),
				(u = null)),
			w.type)
		) {
			case 'space':
				(!e &&
					(t !== 'doc-start' || (n == null ? void 0 : n.type) !== 'flow-collection') &&
					w.source.includes('	') &&
					(u = w),
					(p = !0));
				break;
			case 'comment': {
				...
				const T = w.source.substring(1) || ' ';
				(f ? (f += d + T) : (f = T), (d = ''), (c = !1));
				break;
			}
			case 'newline':
				(c ? (f ? (f += w.source) : (!S || t !== 'seq-item-ind') && (a = !0)) : (d += w.source),
					(c = !0),
					(h = !0),
					(m || g) && (b = w),
					(p = !0));
				break;
			case 'anchor':
				(m && r(w, 'MULTIPLE_ANCHORS', 'A node can have at most one anchor'),
					w.source.endsWith(':') &&
				...
				break;
			case 'tag': {
				(g && r(w, 'MULTIPLE_TAGS', 'A node can have at most one tag'),
					(g = w),
					N ?? (N = w.offset),
					(c = !1),
					(p = !1),
			...
			case t:
				((m || g) &&
					...
					S && r(w, 'UNEXPECTED_TOKEN', `Unexpected ${w.source} in ${e ?? 'collection'}`),
					(S = w),
	...
	const E = s[s.length - 1],
		A = E ? E.offset + E.source.length : i;
	return (
		y &&
			n &&
			n.type !== 'space' &&
		...
		u &&
			((c && u.indent <= o) ||
				(n == null ? void 0 : n.type) === 'block-map' ||
				(n == null ? void 0 : n.type) === 'block-seq') &&
			r(u, 'TAB_AS_INDENT', 'Tabs are not allowed as indentation'),
		{
			comma: k,
			found: S,
...
function fn({ composeNode: s, composeEmptyNode: e }, t, n, i, r) {
	var p;
	const o = (r == null ? void 0 : r.nodeClass) ?? K,
		l = new o(t.schema);
	t.atRoot && (t.atRoot = !1);
	let a = n.offset,
		c = null;
			...
			if (
				(h &&
					(h.type === 'block-seq'
						...
						: 'indent' in h && h.indent !== n.indent && i(a, 'BAD_INDENT', Kt)),
				!m.anchor && !m.tag && !y)
			) {
				((c = m.end),
					m.comment &&
...
` + m.comment)
			...
			(m.newlineAfterProp || Oe(h)) &&
				i(
					h ?? d[d.length - 1],
					'MULTILINE_IMPLICIT_KEY',
					'Implicit keys need to be on a single line'
				);
		} else ((p = m.found) == null ? void 0 : p.indent) !== n.indent && i(a, 'BAD_INDENT', Kt);
		t.atKey = !0;
		const b = m.end,
			k = h ? s(t, h, m, i) : e(t, b, d, null, m, i);
		(t.schema.compat && ht(n.indent, h, i),
			(t.atKey = !1),
			ws(t, l.items, k) && i(b, 'DUPLICATE_KEY', 'Map keys must be unique'));
		const S = he(y ?? [], {
		...
		if (((a = S.end), S.found)) {
			...
			(t.schema.compat && ht(n.indent, u, i), (a = N.range[2]));
			const E = new C(k, N);
			(t.options.keepSourceTokens && (E.srcToken = f), l.items.push(E));
		} else {
			(g && i(k.range, 'MISSING_CHAR', 'Implicit map keys need to be followed by map values'),
				S.comment &&
					(k.comment
						? (k.comment +=
								`
...
function un({ composeNode: s, composeEmptyNode: e }, t, n, i, r) {
	const o = (r == null ? void 0 : r.nodeClass) ?? H,
		l = new o(t.schema);
	...
	for (const { start: p, value: f } of n.items) {
		...
		if (!d.found)
			if (d.anchor || d.tag || f)
				(f == null ? void 0 : f.type) === 'block-seq'
		...
		(t.schema.compat && ht(n.indent, f, i), (a = h.range[2]), l.items.push(h));
	}
...
const nt = 'Block collections are not allowed within flow collections',
	it = (s) => s && (s.type === 'block-map' || s.type === 'block-seq');
function hn({ composeNode: s, composeEmptyNode: e }, t, n, i, r) {
	var m;
	const o = n.start.source === '{',
		l = o ? 'flow map' : 'flow sequence',
		a = (r == null ? void 0 : r.nodeClass) ?? (o ? K : H),
		c = new a(t.schema);
	c.flow = !0;
	const p = t.atRoot;
...
` + A.comment)
		...
		if (g === 0) A.comma && i(A.comma, 'UNEXPECTED_TOKEN', `Unexpected , in ${l}`);
...
` + w)
						: (T.comment = w),
					(A.comment = A.comment.substring(w.length + 1)));
			}
		}
		if (!o && !N && !A.found) {
			const w = E ? s(t, E, A, i) : e(t, A.end, N, null, A, i);
			(c.items.push(w), (f = w.range[2]), it(E) && i(w.range, 'BLOCK_IN_FLOW', nt));
		} else {
			t.atKey = !0;
			const w = A.end,
				T = S ? s(t, S, A, i) : e(t, w, k, null, A, i);
			(it(S) && i(T.range, 'BLOCK_IN_FLOW', nt), (t.atKey = !1));
			const v = he(N ?? [], {
				flow: l,
				indicator: 'map-value-ind',
				next: E,
			...
			if (v.found) {
				...
				E &&
					('source' in E && ((m = E.source) == null ? void 0 : m[0]) === ':'
						? i(E, 'MISSING_CHAR', `Missing space after : in ${l}`)
						: i(v.start, 'MISSING_CHAR', `Missing , or : between ${l} items`));
			const J = E ? s(t, E, v, i) : v.found ? e(t, v.end, N, null, v, i) : null;
			J
				? it(E) && i(J.range, 'BLOCK_IN_FLOW', nt)
				: v.comment &&
					(T.comment
						? (T.comment +=
								`
` + v.comment)
			...
			if ((t.options.keepSourceTokens && (D.srcToken = b), o)) {
				const q = c;
				(ws(t, q.items, T) && i(w, 'DUPLICATE_KEY', 'Map keys must be unique'), q.items.push(D));
			} else {
				const q = new K(t.schema);
				((q.flow = !0), q.items.push(D));
				const $t = (J ?? T).range;
				((q.range = [T.range[0], $t[1], $t[2]]), c.items.push(q));
			}
			f = J ? J.range[2] : v.end;
		}
	}
	const d = o ? '}' : ']',
		[h, ...y] = n.end;
	let u = f;
	if ((h == null ? void 0 : h.source) === d) u = h.offset + h.source.length;
	else {
	...
	if (y.length > 0) {
		const g = Te(y, u, t.options.strict, i);
		(g.comment &&
			(c.comment
				? (c.comment +=
						`
` + g.comment)
				: (c.comment = g.comment)),
			(c.range = [n.offset, u, g.offset]));
	} else c.range = [n.offset, u, u];
	return c;
}
function rt(s, e, t, n, i, r) {
	const o =
			t.type === 'block-map'
				? fn(s, e, t, n, r)
				: t.type === 'block-seq'
...
function dn(s, e, t, n, i) {
	var d;
	const r = n.tag,
		o = r ? e.directives.tagName(r.source, (h) => i(r, 'TAG_RESOLVE_FAILED', h)) : null;
	if (t.type === 'block-seq') {
		const { anchor: h, newlineAfterProp: y } = n,
			u = h && r ? (h.offset > r.offset ? h : r) : (h ?? r);
		u &&
			(!y || y.offset < u.offset) &&
			i(u, 'MISSING_CHAR', 'Missing newline after block sequence props');
	}
	const l =
		t.type === 'block-map'
			? 'map'
			...
			return (
				h
					? i(
							r,
							'BAD_COLLECTION_TYPE',
							`${h.tag} used for ${l} collection, but expects ${h.collection ?? 'scalar'}`,
							!0
						)
...
`.repeat(Math.max(1, o.length - 1))
		...
		return (
			...
			{ value: u, type: r, comment: i.comment, range: [n, m, m] }
		);
	}
	...
	for (let u = 0; u < l; ++u) {
		const [m, g] = o[u];
		if (g === '' || g === '\r') i.indent === 0 && m.length > a && (a = m.length);
		else {
			(m.length < a &&
				t(
					c + m.length,
	...
	for (let u = o.length - 1; u >= l; --u) o[u][0].length > a && (l = u + 1);
	let f = '',
		d = '',
		h = !1;
	for (let u = 0; u < p; ++u)
...
function mn(s) {
	const e = s.split(/\n( *)/),
		t = e[0],
		n = t.match(/^( *)/),
		r = [n != null && n[1] ? [n[1], t.slice(n[1].length)] : ['', t]];
...
function ks(s, e, t) {
	...
	switch (i) {
		case 'scalar':
			...
			break;
		case 'single-quoted-scalar':
			((l = O.QUOTE_SINGLE), (a = gn(r, c)));
			break;
		case 'double-quoted-scalar':
			((l = O.QUOTE_DOUBLE), (a = bn(r, c)));
			break;
		default:
			return (
	...
	const p = n + r.length,
		f = Te(o, p, e, t);
	return { value: a, type: l, comment: f.comment, range: [n, p, f.offset] };
}
function yn(s, e) {
	let t = '';
	switch (s[0]) {
	...
	return (t && e(0, 'BAD_SCALAR_START', `Plain value cannot start with ${t}`), Ns(s));
}
function gn(s, e) {
	return (
		(s[s.length - 1] !== "'" || s.length === 1) &&
			e(s.length, 'MISSING_CHAR', "Missing closing 'quote"),
		Ns(s.slice(1, -1)).replace(/''/g, "'")
	);
}
function Ns(s) {
	let e, t;
...
function Nn(s, e, t, n, i) {
	...
	for (const a of s.tags)
		if (!a.collection && a.tag === t)
			if (a.default && a.test) r.push(a);
			else return a;
	for (const a of r) if ((l = a.test) != null && l.test(e)) return a;
	const o = s.knownTags[t];
	return o && !o.collection
		? (s.tags.push(Object.assign({}, o, { default: !1, test: void 0 })), o)
		: (i(n, 'TAG_RESOLVE_FAILED', `Unresolved tag: ${t}`, t !== 'tag:yaml.org,2002:str'), s[V]);
}
function On({ atKey: s, directives: e, schema: t }, n, i, r) {
	const o =
		t.tags.find((l) => {
			var a;
			return (
				(l.default === !0 || (s && l.default === 'key')) &&
				((a = l.test) == null ? void 0 : a.test(n))
			);
		}) || t[V];
	if (t.compat) {
		const l =
		...
		if (o.tag !== l.tag) {
			const a = e.tagString(o.tag),
				c = e.tagString(l.tag),
				p = `Value may be parsed as either ${a} or ${c}`;
...
const En = { composeNode: As, composeEmptyNode: It };
function As(s, e, t, n) {
	const i = s.atKey,
	...
	switch (e.type) {
		...
		case 'double-quoted-scalar':
		case 'block-scalar':
			((c = Os(s, e, a, n)), l && (c.anchor = l.source.substring(1)));
			break;
		case 'block-map':
		case 'block-seq':
		case 'flow-collection':
			try {
				((c = dn(En, s, e, t, n)), l && (c.anchor = l.source.substring(1)));
			} catch (f) {
				const d = f instanceof Error ? f.message : String(f);
	...
	return (
		c ?? (c = It(s, e.offset, void 0, null, t, n)),
		...
		s.options.keepSourceTokens && p && (c.srcToken = e),
		c
	);
}
function It(s, e, t, n, { spaceBefore: i, comment: r, anchor: o, tag: l, end: a }, c) {
	const p = { type: 'scalar', offset: An(e, t, n), indent: -1, source: '' },
		f = Os(s, p, l, c);
	return (
		o &&
...
function In({ options: s }, { offset: e, source: t, end: n }, i) {
...
function Tn(s, e, { offset: t, start: n, value: i, end: r }, o) {
	...
	(p.found &&
		...
		(a.contents = i ? As(c, i, p, o) : It(c, p.end, n, null, p, o)));
	...
	constructor(e = {}) {
		((this.doc = null),
			...
			(this.onError = (t, n, i, r) => {
				const o = we(t);
				r ? this.warnings.push(new bs(o, n, i)) : this.errors.push(new x(o, n, i));
			}),
			(this.directives = new B({ version: e.version || '1.2' })),
			(this.options = e));
	}
	decorate(e, t) {
		const { comment: n, afterEmptyLine: i } = Pt(this.prelude);
		if (n) {
			const r = e.contents;
			if (t)
				e.comment = e.comment
		...
		switch (e.type) {
			...
			case 'error': {
				const t = e.source ? `${e.message}: ${JSON.stringify(e.source)}` : e.message,
					n = new x(we(e), 'UNEXPECTED_TOKEN', t);
	...
	if (s) {
		...
		switch (s.type) {
			...
			case 'double-quoted-scalar':
				return ks(s, e, n);
			case 'block-scalar':
				return Ss({ options: { strict: e } }, s, n);
		}
	}
	return null;
}
...
`),
				...
				f =
					...
					`
`,
				d = [{ type: 'block-scalar-header', offset: r, indent: n, source: p }];
			return (
				Es(d, a) ||
					d.push({
						type: 'newline',
...
function _n(s, e, t = {}) {
	...
	switch (a[0]) {
		...
		case '>':
			...
			break;
		case '"':
			ot(s, a, 'double-quoted-scalar');
			break;
		case "'":
			ot(s, a, 'single-quoted-scalar');
			break;
		default:
			ot(s, a, 'scalar');
	}
...
const vn = (s) => ('type' in s ? Re(s) : Pe(s));
function Re(s) {
	switch (s.type) {
		case 'block-scalar': {
			let e = '';
			for (const t of s.props) e += Re(t);
			return e + s.source;
		}
		case 'block-map':
		case 'block-seq': {
			let e = '';
			for (const t of s.items) e += Pe(t);
			return e;
		}
		case 'flow-collection': {
...
function Pe({ start: s, key: e, sep: t, value: n }) {
	...
	if ((e && (i += Re(e)), t)) for (const r of t) i += r.source;
	return (n && (i += Re(n)), i);
}
const dt = Symbol('break visit'),
	Bn = Symbol('skip children'),
	Is = Symbol('remove item');
function ee(s, e) {
	('type' in s && s.type === 'document' && (s = { start: s.start, value: s.value }),
		Ts(Object.freeze([]), s, e));
}
ee.BREAK = dt;
ee.SKIP = Bn;
ee.REMOVE = Is;
...
ee.parentCollection = (s, e) => {
	const t = ee.itemAtPath(s, e.slice(0, -1)),
		n = e[e.length - 1][0],
		i = t == null ? void 0 : t[n];
	...
	for (const i of ['key', 'value']) {
		...
		if (r && 'items' in r) {
			for (let o = 0; o < r.items.length; ++o) {
				const l = Ts(Object.freeze(s.concat([[i, o]])), r.items[o], t);
...
const jt = new Set('0123456789ABCDEFabcdef'),
	Dn = new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),
	Ce = new Set(',[]{}'),
	qn = new Set(` ,[]{}
\r	`),
	lt = (s) => !s || qn.has(s);
...
` ||
		...
		if (t === '-' || t === '.') {
			...
			if ((n === '---' || n === '...') && R(this.buffer[e + 3])) return -1;
		}
		return e;
	}
	getLine() {
	...
	*parseFlowCollection() {
		...
		if (
			((n !== -1 && n < this.indentNext && i[0] !== '#') ||
				(n === 0 && (i.startsWith('---') || i.startsWith('...')) && R(i[3]))) &&
...
`
		...
		return !i && !this.atEnd
			...
			: (yield Ae, yield* this.pushToIndex(t + 1, !0), e ? 'flow' : 'doc');
	}
	*pushCount(e) {
...
function qt(s) {
	if (s.start.type === 'flow-seq-start')
		for (const e of s.items)
			e.sep &&
				!e.value &&
				!Q(e.start, 'explicit-key-ind') &&
				!Q(e.sep, 'map-value-ind') &&
				(e.key && (e.value = e.key),
				delete e.key,
				Cs(e.value)
					? e.value.end
...
`,
	...
	*blockMap(e) {
				...
				if (t.value) e.items.push({ start: [this.sourceToken] });
					...
					if (this.atIndentedComment(t.start, e.indent)) {
						const i = e.items[e.items.length - 2],
							r = (n = i == null ? void 0 : i.value) == null ? void 0 : n.end;
						if (Array.isArray(r)) {
		...
		if (this.indent >= e.indent) {
			const i = !this.onKeyLine && this.indent === e.indent,
				r = i && (t.sep || t.explicitKey) && this.type !== 'seq-item-ind';
			let o = [];
			if (r && t.sep && !t.value) {
				const l = [];
			...
			switch (this.type) {
				...
				case 'map-value-ind':
					if (t.explicitKey)
						if (t.sep)
							...
							else if (Cs(t.key) && !Q(t.sep, 'newline')) {
								const l = ie(t.start),
									a = t.key,
									c = t.sep;
				...
				case 'double-quoted-scalar': {
					...
					r || t.value
						? (e.items.push({ start: o, key: l, sep: [] }), (this.onKeyLine = !0))
						: t.sep
							? this.stack.push(l)
							: (Object.assign(t, { key: l, sep: [] }), (this.onKeyLine = !0));
					return;
				}
				default: {
	...
	*blockSequence(e) {
		...
		switch (this.type) {
			...
			case 'seq-item-ind':
				...
				t.value || Q(t.start, 'seq-item-ind')
					? e.items.push({ start: [this.sourceToken] })
					: t.start.push(this.sourceToken);
				return;
		}
...
function vs(s) {
	...
	return { lineCounter: s.lineCounter || (e && new _s()) || null, prettyErrors: e };
}
function Rn(s, e = {}) {
	const { lineCounter: t, prettyErrors: n } = vs(e),
		i = new Lt(t == null ? void 0 : t.addNewLine),
		r = new Tt(e),
		o = Array.from(r.compose(i.parse(s)));
	if (n && t) for (const l of o) (l.errors.forEach(qe(s, t)), l.warnings.forEach(qe(s, t)));
...
export {
	...
	me as isSeq,
	Un as parse,
	Rn as parseAllDocuments,
	Bs as parseDocument,
	Fn as stringify,
	se as visit,
	Ue as visitAsync
};
//# sourceMappingURL=B09doO8H.js.map
