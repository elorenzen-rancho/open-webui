import { b as m, c as d } from './BC4znSyB.js';
var H = { exports: {} };
(function (r, o) {
	(function (n, t) {
		r.exports = t(m);
...
(function (r, o) {
	(function (n, t) {
		...
		var a = t(n),
			e = 'يناير_فبراير_مارس_أبريل_مايو_يونيو_يوليو_أغسطس_سبتمبر_أكتوبر_نوفمبر_ديسمبر'.split('_'),
...
(function (r, o) {
	(function (n, t) {
		...
		var a = t(n),
			...
			s = 'студ_лют_сак_крас_трав_чэрв_ліп_жнів_вер_каст_ліст_снеж'.split('_'),
			u = /D[oD]?(\[[^[\]]*\]|\s)+MMMM?/;
		function M(p, L, y) {
			var h, c;
			return y === 'm'
				...
				: y === 'h'
					...
					: p +
						...
						((h = +p),
						(c = {
							ss: L ? 'секунда_секунды_секунд' : 'секунду_секунды_секунд',
							mm: L ? 'хвіліна_хвіліны_хвілін' : 'хвіліну_хвіліны_хвілін',
							hh: L ? 'гадзіна_гадзіны_гадзін' : 'гадзіну_гадзіны_гадзін',
							dd: 'дзень_дні_дзён',
		...
		var Y = function (p, L) {
			return u.test(L) ? e[p.month()] : _[p.month()];
		};
		((Y.s = _), (Y.f = e));
		var l = function (p, L) {
			return u.test(L) ? i[p.month()] : s[p.month()];
		};
		((l.s = s), (l.f = i));
		var f = {
			name: 'be',
			...
			meridiem: function (p) {
				return p < 4 ? 'ночы' : p < 12 ? 'раніцы' : p < 17 ? 'дня' : 'вечара';
			}
		};
	...
	(function (n, t) {
		...
		var a = t(n),
			...
			i = {
				...
				preparse: function (s) {
					return s.replace(/[১২৩৪৫৬৭৮৯০]/g, function (u) {
						return _[u];
					});
				},
				postformat: function (s) {
					return s.replace(/\d/g, function (u) {
						return e[u];
					});
				},
				ordinal: function (s) {
			...
			return (
				...
				(function (Y, l) {
					return l === 2
						...
						: Y;
				})({ mm: 'munutenn', MM: 'miz', dd: 'devezh' }[M], s)
			);
		}
		var i = {
			name: 'br',
	...
	(function (n, t) {
		...
		var a = t(n),
			e = {
				...
				ordinal: function (_) {
					return '' + _ + (_ === 1 || _ === 3 ? 'r' : _ === 2 ? 'n' : _ === 4 ? 't' : 'è');
				}
			};
		return (a.default.locale(e, null, !0), e);
	});
...
(function (r, o) {
	(function (n, t) {
		...
		function _(s, u, M, Y) {
			...
			switch (M) {
				case 's':
					return u || Y ? 'pár sekund' : 'pár sekundami';
				case 'm':
					return u ? 'minuta' : Y ? 'minutu' : 'minutou';
				case 'mm':
					return u || Y ? l + (e(s) ? 'minuty' : 'minut') : l + 'minutami';
				case 'h':
					return u ? 'hodina' : Y ? 'hodinu' : 'hodinou';
				case 'hh':
					return u || Y ? l + (e(s) ? 'hodiny' : 'hodin') : l + 'hodinami';
				case 'd':
					return u || Y ? 'den' : 'dnem';
				case 'dd':
					return u || Y ? l + (e(s) ? 'dny' : 'dní') : l + 'dny';
				case 'M':
					return u || Y ? 'měsíc' : 'měsícem';
				case 'MM':
					return u || Y ? l + (e(s) ? 'měsíce' : 'měsíců') : l + 'měsíci';
				case 'y':
					return u || Y ? 'rok' : 'rokem';
				case 'yy':
					return u || Y ? l + (e(s) ? 'roky' : 'let') : l + 'lety';
			}
		}
		var i = {
			name: 'cs',
...
(function (r, o) {
	(function (n, t) {
		...
		function _(s, u, M) {
			var Y = e[M];
			return (Array.isArray(Y) && (Y = Y[u ? 0 : 1]), Y.replace('%d', s));
		}
		var i = {
			name: 'de',
	...
	(function (n, t) {
		...
		function e(i, s, u, M) {
			var Y = {
				...
				f = M && !s ? l : Y,
				p = f[u];
			return i < 10 ? p.replace('%d', f.numbers[i]) : p.replace('%d', i);
		}
		var _ = {
			name: 'fi',
	...
	(function (n, t) {
		...
		var a = t(n),
			e = {
				name: 'ga',
				weekdays:
					'Dé Domhnaigh_Dé Luain_Dé Máirt_Dé Céadaoin_Déardaoin_Dé hAoine_Dé Sathairn'.split('_'),
				months:
...
(function (r, o) {
	(function (n, t) {
		...
		function _(s, u, M) {
			return (e[M + (s === 2 ? '2' : '')] || e[M]).replace('%d', s);
		}
		var i = {
			name: 'he',
...
(function (r, o) {
	(function (n, t) {
		...
		var a = t(n),
			...
			i = /D[oD]?(\[[^[\]]*\]|\s)+MMMM?/,
			s = function (M, Y) {
				return i.test(Y) ? e[M.month()] : _[M.month()];
			};
		((s.s = _), (s.f = e));
		var u = {
			name: 'hr',
		...
		var a = t(n),
			e = {
				...
				relativeTime: {
					...
					hh: function (_, i, s, u) {
						return _ + ' ' + (u || i ? 'óra' : 'órája');
					},
					d: function (_, i, s, u) {
						return 'egy ' + (u || i ? 'nap' : 'napja');
					},
					dd: function (_, i, s, u) {
						return _ + ' ' + (u || i ? 'nap' : 'napja');
					},
					M: function (_, i, s, u) {
						return 'egy ' + (u || i ? 'hónap' : 'hónapja');
					},
					MM: function (_, i, s, u) {
						return _ + ' ' + (u || i ? 'hónap' : 'hónapja');
					},
					y: function (_, i, s, u) {
...
(function (r, o) {
	(function (n, t) {
		...
		function _(s, u, M, Y) {
			var l = (function (f, p, L, y) {
				var h = y ? 0 : L ? 1 : 2,
					c = f.length === 2 && p % 10 == 1 ? f[0] : f,
					k = e[c][h];
				return f.length === 1 ? k : '%d ' + k;
			})(M, s, Y, u);
...
(function (r, o) {
	(function (n, t) {
		...
		(e.default.locale(u, null, !0),
			(n.default = u),
			(n.englishToArabicNumbersMap = _),
	...
	(function (n, t) {
		...
		var a = t(n),
			e = {
				...
				ordinal: function (_) {
					return ('' + _).replace(/\d/g, function (i) {
						return '०१२३४५६७८९'[i];
					});
				},
				formats: {
	...
	(function (n, t) {
		...
		function _(l, f, p) {
			...
			switch (p) {
				...
				case 'mm':
					return L + (e(l) ? 'minuty' : 'minut');
				case 'h':
					return f ? 'godzina' : 'godzinę';
				case 'hh':
					return L + (e(l) ? 'godziny' : 'godzin');
				case 'MM':
					return L + (e(l) ? 'miesiące' : 'miesięcy');
				case 'yy':
					return L + (e(l) ? 'lata' : 'lat');
			}
		}
		var i =
			...
			u = /D MMMM/,
			M = function (l, f) {
				return u.test(f) ? i[l.month()] : s[l.month()];
			};
		((M.s = s), (M.f = i));
		var Y = {
			name: 'pl',
...
(function (r, o) {
	(function (n, t) {
		...
		var a = t(n),
			e = 'января_февраля_марта_апреля_мая_июня_июля_августа_сентября_октября_ноября_декабря'.split(
				'_'
			),
			_ = 'январь_февраль_март_апрель_май_июнь_июль_август_сентябрь_октябрь_ноябрь_декабрь'.split(
				'_'
			),
		...
		function M(p, L, y) {
			...
			return y === 'm'
				...
				: p +
						...
						((h = +p),
						(c = {
							mm: L ? 'минута_минуты_минут' : 'минуту_минуты_минут',
							hh: 'час_часа_часов',
							dd: 'день_дня_дней',
	...
	(function (n, t) {
		...
		var a = t(n),
			e = {
				...
				monthsShort:
					'جنوري_فيبروري_مارچ_اپريل_مئي_جون_جولاءِ_آگسٽ_سيپٽمبر_آڪٽوبر_نومبر_ڊسمبر'.split('_'),
...
(function (r, o) {
	(function (n, t) {
		...
		function _(s, u, M, Y) {
			...
			switch (M) {
				case 's':
					return u || Y ? 'pár sekúnd' : 'pár sekundami';
				case 'm':
					return u ? 'minúta' : Y ? 'minútu' : 'minútou';
				case 'mm':
					return u || Y ? l + (e(s) ? 'minúty' : 'minút') : l + 'minútami';
				case 'h':
					return u ? 'hodina' : Y ? 'hodinu' : 'hodinou';
				case 'hh':
					return u || Y ? l + (e(s) ? 'hodiny' : 'hodín') : l + 'hodinami';
				case 'd':
					return u || Y ? 'deň' : 'dňom';
				case 'dd':
					return u || Y ? l + (e(s) ? 'dni' : 'dní') : l + 'dňami';
				case 'M':
					return u || Y ? 'mesiac' : 'mesiacom';
				case 'MM':
					return u || Y ? l + (e(s) ? 'mesiace' : 'mesiacov') : l + 'mesiacmi';
				case 'y':
					return u || Y ? 'rok' : 'rokom';
				case 'yy':
					return u || Y ? l + (e(s) ? 'roky' : 'rokov') : l + 'rokmi';
			}
		}
		var i = {
			name: 'sk',
...
(function (r, o) {
	(function (n, t) {
		...
		function i(u, M, Y, l) {
			...
			switch (Y) {
				case 's':
					return M || l ? 'nekaj sekund' : 'nekaj sekundami';
				case 'm':
					return M ? 'ena minuta' : 'eno minuto';
				case 'mm':
					return e(u)
						? f + (M || l ? 'minuti' : 'minutama')
						: _(u)
							? f + (M || l ? 'minute' : 'minutami')
							: f + (M || l ? 'minut' : 'minutami');
				case 'h':
				...
				case 'hh':
					return e(u)
						...
						: _(u)
							...
							: f + (M || l ? 'ur' : 'urami');
				case 'd':
					return M || l ? 'en dan' : 'enim dnem';
				case 'dd':
					return e(u) ? f + (M || l ? 'dneva' : 'dnevoma') : f + (M || l ? 'dni' : 'dnevi');
				case 'M':
					return M || l ? 'en mesec' : 'enim mesecem';
				case 'MM':
					return e(u)
						? f + (M || l ? 'meseca' : 'mesecema')
						: _(u)
							? f + (M || l ? 'mesece' : 'meseci')
							: f + (M || l ? 'mesecev' : 'meseci');
				case 'y':
					return M || l ? 'eno leto' : 'enim letom';
				case 'yy':
					return e(u)
						? f + (M || l ? 'leti' : 'letoma')
						: _(u)
	...
	(function (n, t) {
		...
		var a = t(n),
			e = {
				...
				correctGrammarCase: function (i, s) {
				...
				relativeTimeFormatter: function (i, s, u, M) {
					var Y = e.words[u];
					if (u.length === 1) return u === 'y' && s ? 'jedna godina' : M || s ? Y[0] : Y[1];
					var l = e.correctGrammarCase(i, Y);
					return u === 'yy' && s && l === '%d godinu' ? i + ' godina' : l.replace('%d', i);
				}
			},
			_ = {
				name: 'sr',
	...
	(function (n, t) {
		...
		var a = t(n),
			e = {
				...
				months:
					'Ýanwar_Fewral_Mart_Aprel_Maý_Iýun_Iýul_Awgust_Sentýabr_Oktýabr_Noýabr_Dekabr'.split('_'),
...
(function (r, o) {
	(function (n, t) {
			...
			return f === 'm'
				...
				: f === 'h'
					...
					: Y +
						...
						((p = +Y),
						(L = {
							ss: l ? 'секунда_секунди_секунд' : 'секунду_секунди_секунд',
							mm: l ? 'хвилина_хвилини_хвилин' : 'хвилину_хвилини_хвилин',
							hh: l ? 'година_години_годин' : 'годину_години_годин',
							dd: 'день_дні_днів',
		...
		var u = function (Y, l) {
			return i.test(l) ? e[Y.month()] : _[Y.month()];
		};
		((u.s = _), (u.f = e));
		var M = {
			name: 'uk',
...
(function (r, o) {
	(function (n, t) {
		...
		function e(i, s, u, M) {
			...
			return s
				? (Y[u][2] ? Y[u][2] : Y[u][1]).replace('%d', i)
				: (M ? Y[u][0] : Y[u][1]).replace('%d', i);
		}
		var _ = {
			name: 'et',
		...
		var a = t(n),
			e = {
				...
				ordinal: function (_) {
					var i = ['th', 'st', 'nd', 'rd'],
						s = _ % 100;
					return '[' + _ + (i[(s - 20) % 10] || i[s] || i[0]) + ']';
				}
			};
		return (a.default.locale(e, null, !0), e);
	});
})(Yt);
//# sourceMappingURL=B1_D1_CQ.js.map
