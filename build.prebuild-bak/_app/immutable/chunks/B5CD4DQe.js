...
const te = { element: 1, text: 3, progressingInstruction: 7, comment: 8, document: 9 },
	fn = function () {
...
function St() {
	...
	let h = _t();
	o.isSupported =
		typeof gt == 'function' && typeof ie == 'function' && ge && ge.createHTMLDocument !== void 0;
	const {
		MUSTACHE_EXPR: ae,
		ERB_EXPR: re,
		TMPLIT_EXPR: se,
		...
		ye = function () {
			...
			if (!(W && W === e)) {
				if (
					((!e || typeof e != 'object') && (e = {}),
					(e = M(e)),
					(K = zt.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? Gt : e.PARSER_MEDIA_TYPE),
					(p = K === 'application/xhtml+xml' ? Me : Ee),
					(T = C(e, 'ALLOWED_TAGS') ? r({}, e.ALLOWED_TAGS, p) : We),
					(d = C(e, 'ALLOWED_ATTR') ? r({}, e.ALLOWED_ATTR, p) : Be),
					(be = C(e, 'ALLOWED_NAMESPACES') ? r({}, e.ALLOWED_NAMESPACES, Me) : Ft),
					(De = C(e, 'ADD_URI_SAFE_ATTR') ? r(M(Ze), e.ADD_URI_SAFE_ATTR, p) : Ze),
					(qe = C(e, 'ADD_DATA_URI_TAGS') ? r(M(Ke), e.ADD_DATA_URI_TAGS, p) : Ke),
					...
					e.FORBID_CONTENTS && (I === Oe && (I = M(I)), r(I, e.FORBID_CONTENTS, p)),
					e.ADD_FORBID_CONTENTS && (I === Oe && (I = M(I)), r(I, e.ADD_FORBID_CONTENTS, p)),
					Re && (T['#text'] = !0),
					...
					: e.namespaceURI === ue
						? t.namespaceURI === N
							...
							: t.namespaceURI === me
								...
								: !!et[n]
						: e.namespaceURI === N
							? (t.namespaceURI === me && !Te[f]) || (t.namespaceURI === ue && !pe[f])
								? !1
								: !et[n] && (Ht[n] || !Qe[n])
	...
	const ot = function (e) {
			...
			if (
				...
				($ &&
					...
					A(/<[/\w!]/g, e.innerHTML) &&
					A(/<[/\w!]/g, e.textContent)) ||
					($ && e.namespaceURI === N && n === 'style' && Ie(e.firstElementChild)) ||
		...
		it = function (e, t, n) {
			if (le[t] || (Ve && (t === 'id' || t === 'name') && (n in l || n in Wt))) return !1;
			if (!(he && !le[t] && A(xt, t))) {
				if (!(Ye && A(Pt, t))) {
		...
		(o.sanitize = function (i) {
			...
			if ((Ae || ye(e), (o.removed = []), typeof i == 'string' && (q = !1), q)) {
				if (i.nodeName) {
					...
					if (!T[L] || V[L]) throw Q('root node is forbidden and cannot be sanitized in-place');
				}
			} else if (i instanceof _e)
				((t = tt('<!---->')),
					(n = t.ownerDocument.importNode(i, !0)),
					(n.nodeType === te.element && n.nodeName === 'BODY') || n.nodeName === 'HTML'
						? (t = n)
						: t.appendChild(n));
			else {
				if (!H && !k && !v && i.indexOf('<') === -1) return g && fe ? g.createHTML(i) : i;
				if (((t = tt(i)), !t)) return H ? null : fe ? j : '';
			}
			t && Se && y(t.firstChild);
			const m = nt(q ? i : t);
			for (; (f = m.nextNode()); ) (ot(f), rt(f), f.content instanceof O && st(f.content));
			if (q) return i;
			if (H) {
				if (k) {
					t.normalize();
				...
				if (ce) for (_ = Nt.call(t.ownerDocument); t.firstChild; ) _.appendChild(t.firstChild);
				else _ = t;
...
//# sourceMappingURL=B5CD4DQe.js.map
