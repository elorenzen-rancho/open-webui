 ...
 */ var se = [
	...
	G = function (e, t) {
		...
		var u =
			...
			l = u === '' || u === 'true',
			a =
				l || (t && e && (typeof e.closest == 'function' ? e.closest('[inert]') : G(e.parentNode)));
		return a;
	},
	ge = function (e) {
		var t,
	...
	V = function (e, t, r) {
		for (var u = [], l = Array.from(e); l.length; ) {
			...
			if (!G(a, !1))
				if (a.tagName === 'SLOT') {
					var v = a.assignedElements(),
						p = v.length ? v : a.children,
						g = V(p, !0, r);
					r.flatten ? u.push.apply(u, g) : u.push({ scopeParent: a, candidates: g });
				} else {
					var w = O.call(a, M);
					w && r.filter(a) && (t || !e.includes(a)) && u.push(a);
					var T = a.shadowRoot || (typeof r.getShadowRoot == 'function' && r.getShadowRoot(a)),
						I = !G(T, !1) && (!r.shadowRootFilter || r.shadowRootFilter(a));
					if (T && I) {
						var P = V(T === !0 ? a.children : T.children, !0, r);
						r.flatten ? u.push.apply(u, P) : u.push({ scopeParent: a, candidates: P });
	...
	D = function (e) {
		...
		return e.tabIndex < 0 && (/^(AUDIO|VIDEO|DETAILS)$/.test(e.tagName) || ge(e)) && !de(e)
			? 0
			: e.tabIndex;
	},
	we = function (e, t) {
	...
	Ie = function (e) {
		var t,
			r = e && _(e),
			u = (t = r) === null || t === void 0 ? void 0 : t.host,
			l = !1;
		if (r && r !== e) {
			var a, v, p;
			for (
				...
				var g, w, T;
				((r = _(u)),
					(u = (g = r) === null || g === void 0 ? void 0 : g.host),
					(l = !!(
						(w = u) !== null &&
						w !== void 0 &&
						(T = w.ownerDocument) !== null &&
						T !== void 0 &&
						T.contains(u)
					)));
			}
	...
	Re = function (e, t) {
		...
		var a = O.call(e, 'details>summary:first-of-type'),
			v = a ? e.parentElement : e;
		if (O.call(v, 'details:not([open]) *')) return !0;
		if (!r || r === 'full' || r === 'full-native' || r === 'legacy-full') {
			if (typeof u == 'function') {
				for (var p = e; e; ) {
					var g = e.parentElement,
						w = _(e);
					if (g && !g.shadowRoot && u(g) === !0) return ne(e);
					e.assignedSlot
						? (e = e.assignedSlot)
						: !g && w !== e.ownerDocument
							? (e = w.host)
		...
		} else if (r === 'non-zero-area') return ne(e);
		return !1;
	},
	De = function (e) {
	...
	q = function (e, t) {
		return !(t.disabled || Se(t) || Re(t, e) || Ne(t) || De(t));
	},
	H = function (e, t) {
		return !(Ae(t) || D(t) < 0 || !q(e, t));
	},
	Oe = function (e) {
		...
		return (
			e.forEach(function (u, l) {
				var a = !!u.scopeParent,
					v = a ? u.scopeParent : u,
					p = we(v, a),
					g = a ? be(u.candidates) : v;
				p === 0
					? a
						? t.push.apply(t, g)
						: t.push(v)
					: r.push({ documentOrder: l, tabIndex: p, item: u, isScope: a, content: g });
			}),
			r
				.sort(Te)
				.reduce(function (u, l) {
	...
	Pe = function (e, t) {
		...
		return (
			t.getShadowRoot
				? (r = V([e], t.includeContainer, {
						filter: H.bind(null, t),
						flatten: !1,
						getShadowRoot: t.getShadowRoot,
						shadowRootFilter: Oe
					}))
				: (r = fe(e, t.includeContainer, H.bind(null, t))),
			be(r)
		);
	},
	Ce = function (e, t) {
		...
		return (
			t.getShadowRoot
				...
				: (r = fe(e, t.includeContainer, q.bind(null, t))),
			r
		);
	},
	C = function (e, t) {
	...
	je = se.concat('iframe:not([inert]):not([inert] *)').join(','),
	z = function (e, t) {
		if (((t = t || {}), !e)) throw new Error('No node provided');
		return O.call(e, je) === !1 ? !1 : q(t, e);
	};
/*!
 * focus-trap 7.8.0
...
var F = {
	...
	ze = function (e, t) {
		var r = (t == null ? void 0 : t.document) || document,
			u = (t == null ? void 0 : t.trapStack) || Ye,
			l = ue(
				{
			...
			g = function (i, o) {
				var s =
					typeof (o == null ? void 0 : o.composedPath) == 'function' ? o.composedPath() : void 0;
				return a.containerGroups.findIndex(function (d) {
					var f = d.container,
						b = d.tabbableNodes;
					return (
						f.contains(i) ||
						(s == null ? void 0 : s.includes(f)) ||
						b.find(function (c) {
							return c === i;
						})
					);
			...
			w = function (i) {
				var o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
					...
					c = l[i];
				if (
					(typeof c == 'function' && (c = c.apply(void 0, Me(b))), c === !0 && (c = void 0), !c)
				) {
				...
				if (typeof c == 'string') {
					try {
						...
						throw new Error(
							'`'.concat(i, '` appears to be an invalid selector; error="').concat(y.message, '"')
						);
					}
					if (!h && !d) throw new Error('`'.concat(i, '` as selector refers to no known node'));
				}
				return h;
			},
			T = function () {
				var i = w('initialFocus', { hasFallback: !0 });
				if (i === !1) return !1;
				if (i === void 0 || (i && !z(i, l.tabbableOptions)))
					if (g(r.activeElement) >= 0) i = r.activeElement;
					else {
			...
			I = function () {
				if (
					((a.containerGroups = a.containers.map(function (i) {
						var o = Pe(i, l.tabbableOptions),
							s = Ce(i, l.tabbableOptions),
							d = o.length > 0 ? o[0] : void 0,
						...
						return {
							...
							nextTabbableNode: function (S) {
								...
								return N < 0
									? E
										? s.slice(s.indexOf(S) + 1).find(function (R) {
												return C(R);
											})
										: s
												.slice(0, s.indexOf(S))
			...
			P = function (i) {
				...
				if (o) return o.shadowRoot && o.shadowRoot.activeElement !== null ? P(o.shadowRoot) : o;
			},
			k = function (i) {
				if (i !== !1 && i !== P(document)) {
					if (!i || !i.focus) {
			...
			X = function (i) {
				var o = w('setReturnFocus', { params: [i] });
				return o || (o === !1 ? !1 : i);
			},
			$ = function (i) {
				var o = i.target,
				...
				if (a.tabbableGroups.length > 0) {
					...
					if (c < 0)
						f
							? (b = a.tabbableGroups[a.tabbableGroups.length - 1].lastTabbableNode)
							: (b = a.tabbableGroups[0].firstTabbableNode);
					else if (f) {
						var y = a.tabbableGroups.findIndex(function (W) {
						...
						if (
							(y < 0 &&
								(h.container === o ||
									(z(o, l.tabbableOptions) &&
										!C(o, l.tabbableOptions) &&
										!h.nextTabbableNode(o, !1))) &&
								(y = c),
							y >= 0)
						) {
							var S = y === 0 ? a.tabbableGroups.length - 1 : y - 1,
								E = a.tabbableGroups[S];
						...
						if (
							(N < 0 &&
								(h.container === o ||
									(z(o, l.tabbableOptions) &&
										!C(o, l.tabbableOptions) &&
										!h.nextTabbableNode(o))) &&
								(N = c),
							N >= 0)
						) {
							var R = N === a.tabbableGroups.length - 1 ? 0 : N + 1,
								A = a.tabbableGroups[R];
			...
			B = function (i) {
				...
				if (!(g(o, i) >= 0)) {
					if (L(l.clickOutsideDeactivates, i)) {
						v.deactivate({ returnFocus: l.returnFocusOnDeactivate });
						return;
					}
					...
					if (a.mostRecentlyFocusedNode)
						if (D(a.mostRecentlyFocusedNode) > 0) {
							var b = g(a.mostRecentlyFocusedNode),
								c = a.containerGroups[b].tabbableNodes;
							if (c.length > 0) {
								var h = c.findIndex(function (y) {
									return y === a.mostRecentlyFocusedNode;
								});
								h >= 0 &&
									(l.isKeyForward(a.recentNavEvent)
										? h + 1 < c.length && ((d = c[h + 1]), (f = !1))
										: h - 1 >= 0 && ((d = c[h - 1]), (f = !1)));
							}
						} else
			...
			Q = function (i) {
				(l.isKeyForward(i) || l.isKeyBackward(i)) && pe(i, l.isKeyBackward(i));
			},
			ee = function (i) {
				qe(i) && L(l.escapeDeactivates, i) !== !1 && (i.preventDefault(), v.deactivate());
			},
			te = function (i) {
				var o = K(i);
				g(o, i) >= 0 ||
					L(l.clickOutsideDeactivates, i) ||
					L(l.allowOutsideClick, i) ||
			...
			ae = function () {
				if (a.active)
					return (
						F.activateTrap(u, v),
						(a.delayInitialFocusTimer = l.delayInitialFocus
							? le(function () {
									k(T());
								})
							: k(T())),
						r.addEventListener('focusin', J, !0),
						r.addEventListener('mousedown', B, { capture: !0, passive: !1 }),
						r.addEventListener('touchstart', B, { capture: !0, passive: !1 }),
						r.addEventListener('click', te, { capture: !0, passive: !1 }),
						r.addEventListener('keydown', Q, { capture: !0, passive: !1 }),
						r.addEventListener('keydown', ee),
						v
					);
			},
			ye = function (i) {
				(a.active && !a.paused && v._setSubtreeIsolation(!1),
				...
				try {
					for (d.s(); !(f = d.n()).done; ) {
						...
						o.add(b);
						for (
							var c = typeof ShadowRoot < 'u' && b.getRootNode() instanceof ShadowRoot, h = b;
							h;
						) {
							o.add(h);
							var y = h.parentElement,
								S = [];
							y
								? (S = y.children)
								: !y &&
									c &&
									((S = h.getRootNode().children),
									(y = h.getRootNode().host),
									(c = typeof ShadowRoot < 'u' && y.getRootNode() instanceof ShadowRoot));
							var E = ie(S),
								N;
							try {
								for (E.s(); !(N = E.n()).done; ) {
			...
			U = typeof window < 'u' && 'MutationObserver' in window ? new MutationObserver(me) : void 0,
			j = function () {
				U &&
					(U.disconnect(),
					a.active &&
						...
						a.containers.map(function (i) {
							U.observe(i, { subtree: !0, childList: !0 });
						}));
			};
		return (
			(v = {
				...
				activate: function (i) {
					...
					var o = p(i, 'onActivate'),
						s = p(i, 'onPostActivate'),
						d = p(i, 'checkCanFocusTrap'),
						f = F.getActiveTrap(u),
						b = !1;
					if (f && !f.paused) {
						var c;
					...
					try {
						(d || I(),
							(a.active = !0),
							(a.paused = !1),
							(a.nodeFocusedBeforeActivation = P(r)),
							o == null || o());
						var h = function () {
							(d && I(),
								ae(),
								j(),
								l.isolateSubtrees && v._setSubtreeIsolation(!0),
								s == null || s());
						};
						if (d) return (d(a.containers.concat()).then(h, h), this);
						h();
					} catch (S) {
				...
				deactivate: function (i) {
					...
					(clearTimeout(a.delayInitialFocusTimer),
						...
						a.paused || v._setSubtreeIsolation(!1),
						a.alreadySilent.clear(),
						re(),
						(a.active = !1),
						(a.paused = !1),
						j(),
						F.deactivateTrap(u, v));
					var s = p(o, 'onDeactivate'),
						d = p(o, 'onPostDeactivate'),
						f = p(o, 'checkCanReturnFocus'),
						b = p(o, 'returnFocus', 'returnFocusOnDeactivate');
					s == null || s();
					var c = function () {
						le(function () {
				...
				updateContainerElements: function (i) {
					...
					return (
						...
						l.isolateSubtrees && ye(a.containers),
						a.active && (I(), l.isolateSubtrees && !a.paused && v._setSubtreeIsolation(!0)),
						j(),
						this
					);
				}
			...
			v.updateContainerElements(e),
			v
		);
	};
const He = Object.freeze(
	Object.defineProperty({ __proto__: null, createFocusTrap: ze }, Symbol.toStringTag, {
		value: 'Module'
	})
);
export { He as F, ze as c, Ce as f, z as i, Pe as t };
//# sourceMappingURL=B6VcIur7.js.map
