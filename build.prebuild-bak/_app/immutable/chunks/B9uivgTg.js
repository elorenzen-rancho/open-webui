...
function h(e) {
	...
	return {
		...
		token: function (i, a) {
			...
			if (
				(i.sol() &&
					(c.align == null && (c.align = !1), (a.indented = i.indentation()), (a.startOfLine = !0)),
				i.eatSpace())
			)
				return ($(i, a), null);
			p = E = null;
			...
			if (
				...
				p == c.type
					...
					: re &&
						(((c.type == '}' || c.type == 'top') && p != ';') ||
							(c.type == 'statement' && p == 'newstatement')) &&
			...
			return o.type == 'statement'
				...
				: o.align && (!t || o.type != ')')
					...
					: o.type == ')' && !v
						...
						: o.indented +
							(v ? 0 : c.unit) +
							(!v && se && !/^(?:case|default)\b/.test(a) ? c.unit : 0);
		},
		languageData: {
			indentOnInput: ie ? /^\s*(?:case .*?:|default:|\{\}?|\})$/ : /^\s*[{}]$/,
			commentTokens: { line: '//', block: { open: '/*', close: '*/' } },
			autocomplete: Object.keys(l)
...
const _e = h({
	...
	Ie = h({
		...
		builtin: r(Z),
		blockKeywords: r(
			N + ' @synthesize @try @catch @finally @autoreleasepool @synchronized class try catch'
		),
...
//# sourceMappingURL=B9uivgTg.js.map
