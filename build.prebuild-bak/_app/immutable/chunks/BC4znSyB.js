	...
	(function (y, p) {
		...
		var y = 1e3,
			...
			H = {
				...
				p: function (s) {
					return (
						{ M: l, y: b, w: D, d: c, D: _, h: j, m: x, s: T, ms: O, Q: N }[s] ||
						String(s || '')
							.toLowerCase()
							.replace(/s$/, '')
					);
		...
		var I = '$isDayjsObject',
			...
			B = function s(r, t, n) {
				...
				return (!n && e && (v = e), e || (!n && v));
			},
			d = function (s, r) {
				if (C(s)) return s.clone();
				var t = typeof r == 'object' ? r : {};
				return ((t.date = s), (t.args = arguments), new V(t));
			},
			a = H;
		((a.l = B),
			(a.i = C),
				...
				return (
						...
						((this.$d = (function (n) {
							...
							if (typeof e == 'string' && !/Z$/i.test(e)) {
								...
								if (u) {
									...
									return i
										? new Date(Date.UTC(u[1], o, u[3] || 1, u[4] || 0, u[5] || 0, u[6] || 0, f))
					...
					(r.startOf = function (t, n) {
						var e = this,
							...
							u = a.p(t),
							o = function (W, g) {
								var k = a.w(e.$u ? Date.UTC(e.$y, g, W) : new Date(e.$y, g, W), e);
								return i ? k : k.endOf(c);
							},
							f = function (W, g) {
								return a.w(
									e
										.toDate()
										[W].apply(e.toDate('s'), (i ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(g)),
									e
								);
							},
							h = this.$W,
					...
					(r.$set = function (t, n) {
						var e,
							...
							(e[O] = u + 'Milliseconds'),
							e)[i],
							f = i === c ? this.$D + (n - this.$W) : n;
						if (i === l || i === b) {
							var h = this.clone().set(_, 1);
							(h.$d[o](f), h.init(), (this.$d = h.set(_, Math.min(this.$D, h.daysInMonth())).$d));
						} else o && this.$d[o](f);
					...
					(r.add = function (t, n) {
						...
						var u = a.p(n),
							o = function (m) {
								var w = d(i);
								return a.w(w.date(w.date() + Math.round(m * t)), i);
							};
						if (u === l) return this.set(l, this.$M + t);
						if (u === b) return this.set(b, this.$y + t);
						if (u === c) return o(1);
						if (u === D) return o(7);
						var f = ((e = {}), (e[x] = p), (e[j] = S), (e[T] = y), e)[u] || 1,
					...
					(r.format = function (t) {
						...
						var i = t || 'YYYY-MM-DDTHH:mm:ssZ',
							...
							E = e.meridiem,
							L = function (g, k, z, q) {
								return (g && (g[k] || g(n, i))) || z[k].slice(0, q);
							},
							Z = function (g) {
								return a.s(o % 12 || 12, g, '0');
							},
							W =
								E ||
								function (g, k, z) {
						...
						return i.replace(P, function (g, k) {
							return (
								k ||
								(function (z) {
									switch (z) {
										...
										case 'd':
											return String(n.$W);
										case 'dd':
											return L(e.weekdaysMin, n.$W, m, 2);
										case 'ddd':
											return L(e.weekdaysShort, n.$W, m, 3);
										case 'dddd':
											return m[n.$W];
										case 'H':
											return String(o);
					...
					(r.diff = function (t, n, e) {
						var i,
							...
							o = a.p(n),
							f = d(t),
							h = (f.utcOffset() - this.utcOffset()) * p,
							m = this - f,
							w = function () {
								return a.m(u, f);
							};
...
(function ($, A) {
	(function (y, p) {
		...
		return function (y, p, S) {
			...
			function x(c, D, l, N) {
				return O.fromToBase(c, D, l, N);
			}
			((S.en.relativeTime = T),
				(O.fromToBase = function (c, D, l, N, b) {
					for (
						var _,
							Y,
							F,
							P = l.$locale().relativeTime || T,
							U = y.thresholds || [
								{ l: 's', r: 44, d: 'second' },
								{ l: 'm', r: 89 },
								{ l: 'mm', r: 44, d: 'minute' },
						...
						var v = U[H];
						v.d && (_ = N ? S(c).diff(l, v.d, !0) : l.diff(c, v.d, !0));
						var M = (y.rounding || Math.round)(Math.abs(_));
						if (((F = _ > 0), M <= v.r || !v.r)) {
							M <= 1 && H > 0 && (v = U[H - 1]);
							var I = P[v.l];
							(b && (M = b('' + M)),
								(Y = typeof I == 'string' ? I.replace('%d', M) : I(M, D, v.l, F)));
							break;
						}
					}
					if (D) return Y;
					var C = F ? P.future : P.past;
					return typeof C == 'function' ? C(Y) : C.replace('%s', Y);
				}),
				(O.to = function (c, D) {
					return x(c, D, this, !0);
				}),
			...
			((O.toNow = function (c) {
				return this.to(j(this), c);
			}),
				(O.fromNow = function (c) {
					return this.from(j(this), c);
				}));
		};
	});
})(X);
var et = X.exports;
const st = R(et);
export { rt as a, tt as b, Q as c, nt as d, R as g, st as r };
//# sourceMappingURL=BC4znSyB.js.map
