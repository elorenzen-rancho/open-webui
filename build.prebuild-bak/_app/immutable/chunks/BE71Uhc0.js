const e = 'O aplikaciji',
	...
	xi = {
		...
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Model zadatka koristi se pri izvođenju zadataka kao što su generiranje naslova za razgovore i upite za pretraživanje weba',
		'a user': 'korisnik',
		About: e,
		...
		'Add a short description about what this model does':
			'Dodajte kratak opis funkcija ovog modela',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Podešavanje će se primijeniti univerzalno na sve korisnike.',
		admin: c,
		Admin: d,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Admini imaju pristup svim alatima u svako doba; korisninicima je dat pristup alatima u zavisnosti od modela u radnoj povrsini',
		Advanced: u,
		...
		'Call feature is not supported when using Web STT engine':
			'Značajka poziva nije podržana kada se koristi Web STT mehanizam',
		Camera: J,
		Cancel: Z,
		...
		"Click on the user role button to change a user's role.":
			'Kliknite na gumb uloge korisnika za promjenu uloge korisnika.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		...
		'Display the username instead of You in the Chat':
			'Prikaži korisničko ime umjesto Vas u razgovoru',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'ne uspostavlja vanjske veze, a vaši podaci ostaju sigurno na vašem lokalno hostiranom poslužitelju.',
		'Domain Filter List': '',
		"don't fetch random pipelines from sources you don't trust.":
			'Ne preuzimajte nasumične pipelines iz izvora kojima ne vjerujete.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"npr. '30s','10m'. Važeće vremenske jedinice su 's', 'm', 'h'.",
		"e.g. 'low', 'medium', 'high'": '',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Provjerite da vaša CSV datoteka uključuje 4 stupca u ovom redoslijedu: Name, Email, Password, Role.',
		'Enter {{role}} message here': 'Unesite {{role}} poruku ovdje',
		'Enter a detail about yourself for your LLMs to recall':
			'Unesite pojedinosti o sebi da bi učitali memoriju u LLM',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Otkriveno krivotvorenje otisaka prstiju: Nemoguće je koristiti inicijale kao avatar. Postavljanje na zadanu profilnu sliku.',
		...
		'Include `--api` flag when running stable-diffusion-webui':
			'Uključite zastavicu `--api` prilikom pokretanja stable-diffusion-webui',
		...
		'Instant Auto-Send After Voice Transcription':
			'Trenutačno automatsko slanje nakon glasovne transkripcije',
		Instructions: At,
		Integration: St,
		Integrations: Pt,
		Interface: Ct,
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Maksimalno 3 modela se mogu preuzeti istovremeno. Pokušajte ponovo kasnije.',
		May: $t,
		MBR: ea,
		MCP: oa,
		...
		'Memories accessible by LLMs will be shown here.':
			'Ovdje će biti prikazana memorija kojoj mogu pristupiti LLM-ovi.',
		Memory: ia,
		...
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Poruke koje pošaljete nakon stvaranja veze neće se dijeliti. Korisnici s URL-om moći će vidjeti zajednički chat.',
		'Microsoft OneDrive': '',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Model '{{modelName}}' je uspješno preuzet.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Model '{{modelTag}}' je već u redu za preuzimanje.",
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Otkriven put datotečnog sustava modela. Kratko ime modela je potrebno za ažuriranje, nije moguće nastaviti.',
		'Model Filtering': '',
		'Model ID': 'ID modela',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Napomena: Ako postavite minimalnu ocjenu, pretraga će vratiti samo dokumente s ocjenom većom ili jednakom minimalnoj ocjeni.',
		Notes: ja,
		...
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Samo alfanumerički znakovi i crtice su dopušteni u naredbenom nizu.',
		...
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Ups! Izgleda da je URL nevažeći. Molimo provjerite ponovno i pokušajte ponovo.',
		...
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Ups! Koristite nepodržanu metodu (samo frontend). Molimo poslužite WebUI s backend-a.',
		'Open file': '',
		'Open in full screen': '',
		'Open in new tab': '',
		'Open link': '',
		...
		'Permission denied when accessing media devices':
			'Dopuštenje je odbijeno prilikom pristupa medijskim uređajima',
		'Permission denied when accessing microphone':
			'Dopuštenje je odbijeno prilikom pristupa mikrofonu',
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines je sustav dodataka s proizvoljnim izvršavanjem koda —',
		...
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Nazivajte se "Korisnik" (npr. "Korisnik uči španjolski")',
		'Reference Chats': '',
		Refresh: Sn,
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Spremanje zapisnika razgovora izravno u pohranu vašeg preglednika više nije podržano. Molimo vas da odvojite trenutak za preuzimanje i brisanje zapisnika razgovora klikom na gumb ispod. Ne brinite, možete lako ponovno uvesti zapisnike razgovora u backend putem',
		Schedule: Jn,
		...
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Ocjena treba biti vrijednost između 0,0 (0%) i 1,0 (100%).',
		...
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Ovo osigurava da su vaši vrijedni razgovori sigurno spremljeni u bazu podataka. Hvala vam!',
		...
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Ovo je eksperimentalna značajka, možda neće funkcionirati prema očekivanjima i podložna je promjenama u bilo kojem trenutku.',
		...
		'To access the available model names for downloading,':
			'Za pristup dostupnim nazivima modela za preuzimanje,',
		'To access the GGUF models available for downloading,':
			'Za pristup GGUF modelima dostupnim za preuzimanje,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'Za pristup WebUI-u obratite se administratoru. Administratori mogu upravljati statusima korisnika s Admin panela.',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Napišite sažetak u 50 riječi koji sažima [temu ili ključnu riječ].',
		'Write something...': '',
...
npr.: Vi ste Mario iz Super Mario Bros i djelujete kao asistent.`,
		...
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Možete personalizirati svoje interakcije s LLM-ima dodavanjem uspomena putem gumba 'Upravljanje' u nastavku, čineći ih korisnijima i prilagođenijima vama.",
		...
		'Your account status is currently pending activation.':
			'Status vašeg računa trenutno čeka aktivaciju.',
...
//# sourceMappingURL=BE71Uhc0.js.map
