import { g as Vo, c as qo } from './BC4znSyB.js';
function jo(Gt, Vt) {
		...
		if (typeof it != 'string' && !Array.isArray(it)) {
			for (const x in it)
				if (x !== 'default' && !(x in Gt)) {
					...
					ut && Object.defineProperty(Gt, x, ut.get ? ut : { enumerable: !0, get: () => it[x] });
				}
		}
	}
	...
	(function (l, it) {
		...
		function C(t, e) {
			Object.prototype.hasOwnProperty.call(t, 'options') ||
				(t.options = t.options ? ut(t.options) : {});
		...
		var me = window.requestAnimationFrame || _e('RequestAnimationFrame') || ii,
			ni =
		...
		function D(t, e, i) {
			if (i && me === ii) t.call(e);
			else return me.call(window, S(t, e));
		}
		function G(t) {
			t && ni.call(window, t);
		}
		...
		((nt.extend = function (t) {
			...
			return (
				...
				t.includes && (yn(t.includes), x.apply(null, [n].concat(t.includes))),
				x(n, t),
				delete n.statics,
				delete n.includes,
				n.options && ((n.options = i.options ? ut(i.options) : {}), x(n.options, t.options)),
				(n._initHooks = []),
		...
		var U = {
			...
			fire: function (t, e, i) {
				...
				var n = x({}, e, { type: t, target: this, sourceTarget: (e && e.sourceTarget) || this });
				if (this._events) {
		...
		z.prototype = {
			...
			equals: function (t) {
				return t
					? ((t = F(t)), this.min.equals(t.getTopLeft()) && this.max.equals(t.getBottomRight()))
					: !1;
			}
		};
		function F(t, e) {
		...
		var ye = document.documentElement.style,
			...
			Et = typeof orientation < 'u' || Q('mobile'),
			Sn = Et && we,
			Cn = Et && Pe,
			...
			Le = !!(document.createElementNS && ri('svg').createSVGRect),
			An =
				!!Le &&
				(function () {
		...
		var f = {
			...
			Te = { touchstart: wi, touchmove: xi, touchend: Pi, touchcancel: Li },
			Ti = { touchstart: Gn, touchmove: Kt, touchend: Kt, touchcancel: Kt },
			yt = {},
			bi = !1;
		function Dn(t, e, i) {
			return (
				e === 'touchstart' && Un(),
				Ti[e]
					? ((i = Ti[e].bind(this, i)), t.addEventListener(Te[e], i, !1), i)
		...
		function Un() {
			bi ||
				(document.addEventListener(wi, Hn, !0),
				document.addEventListener(xi, Wn, !0),
		...
		function I(t, e) {
			((t._leaflet_pos = e),
				f.any3d ? _t(t, e) : ((t.style.left = e.x + 'px'), (t.style.top = e.y + 'px')));
		}
		function mt(t) {
		...
		function Ze(t) {
			...
			t.style &&
				($t(),
				(Qt = t),
				(Ee = t.style.outlineStyle),
				(t.style.outlineStyle = 'none'),
				p(window, 'keydown', $t));
		}
		function $t() {
			Qt && ((Qt.style.outlineStyle = Ee), (Qt = void 0), (Ee = void 0), M(window, 'keydown', $t));
		}
		function zi(t) {
			do t = t.parentNode;
		...
		function p(t, e, i, n) {
			if (e && typeof e == 'object') for (var o in e) Ae(t, o, e[o], i);
			else {
				e = dt(e);
		...
		var $ = '_leaflet_events';
		function M(t, e, i, n) {
			if (arguments.length === 1) (ki(t), delete t[$]);
			else if (e && typeof e == 'object') for (var o in e) Be(t, o, e[o], i);
			else if (((e = dt(e)), arguments.length === 2))
				ki(t, function (a) {
					return de(e, a) !== -1;
				});
			else for (var s = 0, r = e.length; s < r; s++) Be(t, e[s], i, n);
			return this;
		}
		function ki(t, e) {
			for (var i in t[$]) {
				...
				: f.touch && e === 'dblclick'
					...
					: 'addEventListener' in t
						? e === 'touchstart' || e === 'touchmove' || e === 'wheel' || e === 'mousewheel'
							? t.addEventListener(Ie[e] || e, s, f.passiveEvents ? { passive: !1 } : !1)
							: e === 'mouseenter' || e === 'mouseleave'
								? ((s = function (a) {
										((a = a || window.event), Re(t, a) && r(a));
									}),
									t.addEventListener(Ie[e], s, !1))
			...
			(!f.touchNative && f.pointer && e.indexOf('touch') === 0
				...
				: f.touch && e === 'dblclick'
					...
					: 'removeEventListener' in t
						? t.removeEventListener(Ie[e] || e, s, !1)
		...
		function Nt(t) {
			return (
				p(t, 'mousedown touchstart dblclick contextmenu', pt),
			...
			w = zt.extend({
				...
				initialize: function (t, e) {
					((e = C(this, e)),
						...
						this.callInitHooks(),
						(this._zoomAnimated = Zt && f.any3d && !f.mobileOpera && this.options.zoomAnimation),
						this._zoomAnimated &&
				...
				flyTo: function (t, e, i) {
					...
					function g(A) {
						var ce = A ? -1 : 1,
							Ho = A ? h : a,
							Wo = h * h - a * a + ce * d * d * u * u,
							Uo = 2 * Ho * d * u,
							Ye = Wo / Uo,
							mn = Math.sqrt(Ye * Ye + 1) - Ye,
							Go = mn < 1e-9 ? -18 : Math.log(mn);
						return Go;
					}
					function R(A) {
					...
					var Do = Date.now(),
						dn = (g(1) - W) / c,
						Fo = i.duration ? 1e3 * i.duration : 1e3 * dn * 0.8;
					function _n() {
				...
				_findEventTargets: function (t, e) {
					for (
						...
						if (
							(n && n.listens(e, !0) && ((o && !Re(s, t)) || (i.push(n), o))) ||
							s === this._container
						)
							break;
						s = s.parentNode;
						...
						for (r = 0; r < o.length; r++)
							if (
								...
								h.originalEvent._stopped ||
									(o[r].options.bubblingMouseEvents === !1 && de(this._mouseEvents, e) !== -1))
							)
								return;
					}
				},
					...
					(this._panes.mapPane.appendChild(t),
						this.on(
							...
							function (e) {
								...
								(_t(this._proxy, this.project(e.center, e.zoom), this.getZoomScale(e.zoom, 1)),
		...
		var so = { Events: U },
			...
			ct = zt.extend({
				...
				disable: function () {
					this._enabled &&
						(ct._dragging === this && this.finishDrag(!0),
				...
				_onDown: function (t) {
					if (this._enabled && ((this._moved = !1), !Me(this._element, 'leaflet-zoom-anim'))) {
						...
						if (
							!(ct._dragging || t.shiftKey || (t.which !== 1 && t.button !== 1 && !t.touches)) &&
							((ct._dragging = this),
			...
			for (a = 0; a < 4; a++) {
				for (d = o[a], n = [], s = 0, c = t.length, r = c - 1; s < c; r = s++)
					((h = t[s]),
						(u = t[r]),
						h._code & d
							? u._code & d || ((g = te(u, h, d, e, i)), (g._code = gt(g, e)), n.push(g))
							: (u._code & d && ((g = te(u, h, d, e, i)), (g._code = gt(g, e)), n.push(g)),
								n.push(h)));
				t = n;
			}
		...
		var ro = { __proto__: null, clipPolygon: Ri, polygonCenter: Di, centroid: He };
		function Fi(t, e) {
		...
		var co = {
			...
			fo = { __proto__: null, LonLat: Ue, Mercator: Ge, SphericalMercator: pe },
			_o = x({}, lt, {
				code: 'EPSG:3395',
				projection: Ge,
				transformation: (function () {
				...
				addLayer: function (t) {
					return this.hasLayer(t)
						...
						: (t.addEventParent(this),
							Pt.prototype.addLayer.call(this, t),
				...
				removeLayer: function (t) {
					return this.hasLayer(t)
						? (t in this._layers && (t = this._layers[t]),
							...
							Pt.prototype.removeLayer.call(this, t),
		...
		var Ft = Lt.extend({
				...
				_getIconUrl: function (t) {
					return (
						typeof Ft.imagePath != 'string' && (Ft.imagePath = this._detectIconPath()),
						(this.options.imagePath || Ft.imagePath) + Lt.prototype._getIconUrl.call(this, t)
					);
				},
			...
			ji = tt.extend({
				...
				addHooks: function () {
					...
					(this._draggable || (this._draggable = new ct(t, t, !0)),
						this._draggable
							.on(
								{
		...
		var Tt = rt.extend({
			...
			_setLatLngs: function (t) {
				(rt.prototype._setLatLngs.call(this, t),
			...
			switch (i.type) {
				...
				case 'GeometryCollection':
					for (u = 0, c = i.geometries.length; u < c; u++) {
						var d = ne({ geometry: i.geometries[u], type: 'Feature', properties: t.properties }, e);
						d && o.push(d);
					}
					return new st(o);
		...
		var Ke = {
			toGeoJSON: function (t) {
				return bt(this, { type: 'Point', coordinates: je(this.getLatLng(), t) });
			}
		};
		(ee.include(Ke),
			Ve.include(Ke),
			...
			rt.include({
				toGeoJSON: function (t) {
					...
					return bt(this, { type: (e ? 'Multi' : '') + 'LineString', coordinates: i });
				}
			}),
			Tt.include({
				toGeoJSON: function (t) {
					...
					return (
						e || (n = [n]),
						bt(this, { type: (i ? 'Multi' : '') + 'Polygon', coordinates: n })
					);
				}
			}),
			Pt.include({
				toMultiPoint: function (t) {
					...
					return (
						...
						bt(this, { type: 'MultiPoint', coordinates: e })
					);
				},
				toGeoJSON: function (t) {
					...
					return (
						...
						i
							? bt(this, { geometries: n, type: 'GeometryCollection' })
				...
				onAdd: function (t) {
					(et.prototype.onAdd.call(this, t),
						...
						this._source &&
							...
							this._source instanceof ft || this._source.on('preclick', pt)));
				},
				onRemove: function (t) {
					(et.prototype.onRemove.call(this, t),
						...
						this._source &&
							...
							this._source instanceof ft || this._source.off('preclick', pt)));
				},
				getEvents: function () {
		...
		(w.mergeOptions({ closePopupOnClick: !0 }),
			...
			X.include({
				bindPopup: function (t, e) {
					return (
						(this._popup = this._initOverlay(he, this._popup, t, e)),
			...
			X.include({
				bindTooltip: function (t, e) {
					return (
						...
						(this._tooltip = this._initOverlay(ue, this._tooltip, t, e)),
			...
			_updateLevels: function () {
				...
				if (t !== void 0) {
					...
					return (
						n ||
							((n = this._levels[t] = {}),
							(n.el = T('div', 'leaflet-tile-container leaflet-zoom-animated', this._container)),
							(n.el.style.zIndex = e),
		...
		var Wt = (function () {
			...
			Ut = ht.extend({
				_initContainer: function () {
					((this._container = le('svg')),
						this._container.setAttribute('pointer-events', 'none'),
						(this._rootGroup = le('g')),
		...
		((Ut.create = le),
			(Ut.pointsToPath = ai),
			(at.geometryToLayer = ne),
			(at.coordsToLatLng = qe),
			(at.coordsToLatLngs = oe),
			(at.latLngToCoords = je),
			(at.latLngsToCoords = se),
			(at.getFeature = bt),
			(at.asFeature = re),
		...
		var hn = tt.extend({
			addHooks: function () {
				if (!this._draggable) {
					var t = this._map;
					((this._draggable = new ct(t._mapPane, t._container)),
						this._draggable.on(
...
var pn = Xe.exports;
const Ko = Vo(pn),
	Xo = jo({ __proto__: null, default: Ko }, [pn]);
export { Xo as l };
//# sourceMappingURL=BJWc3fTI.js.map
