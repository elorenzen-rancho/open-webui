const e = 'بارے میں',
	...
	Fr = {
		...
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' یا '1-' مستقل کے لیے",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(مثال کے طور پر: `sh webui.sh --api --api-auth username_password`)',
		...
		'*Prompt node ID(s) are required for image generation':
			'تصویر کی تخلیق کے لیے *پرومپٹ نوڈ آئی ڈی(ز) کی ضرورت ہے',
		'1 hour before': '',
		'1 Source': '',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'نیا ورژن (v{{LATEST_VERSION}}) اب دستیاب ہے',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'ٹاسک ماڈل اس وقت استعمال ہوتا ہے جب چیٹس کے عنوانات اور ویب سرچ سوالات تیار کیے جا رہے ہوں',
		'a user': 'ایک صارف',
		About: e,
		...
		'Add a short description about what this model does':
			'اس ماڈل کے کام کے بارے میں ایک مختصر وضاحت شامل کریں',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'ان سیٹنگز کو ایڈجسٹ کرنے سے تمام صارفین کے لئے تبدیلیاں یکساں طور پر نافذ ہوں گی',
		admin: c,
		Admin: d,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'ایڈمنز کو ہر وقت تمام ٹولز تک رسائی حاصل ہوتی ہے؛ صارفین کو ورک سپیس میں ماڈل کے حساب سے ٹولز تفویض کرنے کی ضرورت ہوتی ہے',
		Advanced: u,
		...
		'Call feature is not supported when using Web STT engine':
			'کال کی خصوصیت ویب STT انجن استعمال کرتے وقت معاونت یافتہ نہیں ہے',
		Camera: j,
		Cancel: Q,
		...
		'Click here to download user import template file.':
			'صارف امپورٹ ٹیمپلیٹ فائل ڈاؤن لوڈ کرنے کے لیے یہاں کلک کریں',
		'Click here to learn more about faster-whisper and see the available models.':
			'تیز ویسپر کے بارے میں مزید جاننے اور دستیاب ماڈلز دیکھنے کے لیے یہاں کلک کریں',
		...
		'Click here to upload a workflow.json file.':
			'یہاں کلک کریں تاکہ ورک فلو.json فائل اپ لوڈ کریں',
		'click here.': 'یہاں کلک کریں',
		"Click on the user role button to change a user's role.":
			'صارف کا کردار تبدیل کرنے کے لیے صارف کردار بٹن پر کلک کریں',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'کلپ بورڈ لکھنے کی اجازت نہیں دی گئی براہ کرم ضروری رسائی کی اجازت دینے کے لیے اپنے براؤزر کی سیٹنگز چیک کریں',
		Clone: le,
		'Clone Chat': '',
		'Clone of {{TITLE}}': '',
		Close: ce,
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"TTS درخواستوں کے لیے پیغام کے متن کی تقسیم کو کنٹرول کریں 'Punctuation' جملوں میں تقسیم کرتا ہے، 'paragraphs' پیراگراف میں تقسیم کرتا ہے، اور 'none' پیغام کو ایک ہی سٹرنگ کے طور پر رکھتا ہے",
		...
		'Discover, download, and explore custom functions':
			'دریافت کریں، ڈاؤن لوڈ کریں، اور کسٹم فنکشنز کو دریافت کریں',
		'Discover, download, and explore custom prompts':
			'دریافت کریں، ڈاؤن لوڈ کریں، اور حسب ضرورت پرامپٹس کو دریافت کریں',
		'Discover, download, and explore custom tools':
			'دریافت کریں، ڈاؤن لوڈ کریں، اور حسب ضرورت ٹولز کو دریافت کریں',
		'Discover, download, and explore model presets':
			'دریافت کریں، ڈاؤن لوڈ کریں، اور ماڈل پریسیٹس کو دریافت کریں',
		...
		'Do not install functions from sources you do not fully trust.':
			'ایسی جگہوں سے فنکشنز انسٹال نہ کریں جن پر آپ مکمل بھروسہ نہیں کرتے',
		'Do not install tools from sources you do not fully trust.':
			'جن ذرائع پر آپ مکمل بھروسہ نہیں کرتے، ان سے ٹولز انسٹال نہ کریں',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'آپ کا ڈیٹا مقامی طور پر میزبانی شدہ سرور پر محفوظ رہتا ہے اور کوئی بیرونی رابطے نہیں بناتا',
		'Domain Filter List': '',
		"don't fetch random pipelines from sources you don't trust.":
			'جن ذرائع پر آپ بھروسہ نہیں کرتے ان سے بے ترتیب پائپ لائنز نہ لیں۔',
		"Don't have an account?": 'کیا آپ کے پاس اکاؤنٹ نہیں ہے؟',
		"don't install random functions from sources you don't trust.":
			'غیر معتبر ذرائع سے بے ترتیب فنکشنز انسٹال نہ کریں',
		"don't install random tools from sources you don't trust.":
			'جو ذرائع آپ پر بھروسہ نہیں کرتے ان سے بے ترتیب ٹولز انسٹال نہ کریں',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"مثلاً '30s'، '10m' درست وقت کی اکائیاں ہیں 's'، 'm'، 'h'",
		"e.g. 'low', 'medium', 'high'": '',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'یقینی بنائیں کہ آپ کی CSV فائل میں 4 کالم اس ترتیب میں شامل ہوں: نام، ای میل، پاس ورڈ، کردار',
		'Enter {{role}} message here': 'یہاں {{کردار}} پیغام درج کریں',
		'Enter a detail about yourself for your LLMs to recall':
			'اپنی ذات کے بارے میں کوئی تفصیل درج کریں تاکہ آپ کے LLMs اسے یاد رکھ سکیں',
		...
		'Enter api auth string (e.g. username:password)':
			'اے پی آئی اتھ سٹرنگ درج کریں (مثال کے طور پر: صارف نام:پاس ورڈ)',
		...
		'Enter URL (e.g. http://127.0.0.1:7860/)':
			'یو آر ایل درج کریں (جیسے کہ http://127.0.0.1:7860/)',
		...
		'File size should not exceed {{maxSize}} MB.':
			'فائل کا سائز {{maxSize}} ایم بی سے زیادہ نہیں ہونا چاہیے',
		'File Upload': '',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'فنگر پرنٹ اسپورفنگ کا پتہ چلا: اوتار کے طور پر ابتدائی حروف استعمال کرنے سے قاصر ڈیفالٹ پروفائل تصویر منتخب کی جا رہی ہے',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'میں اقرار کرتا ہوں کہ میں نے پڑھ لیا ہے اور میں اپنی کارروائی کے مضمرات سمجھتا ہوں میں اس بات سے واقف ہوں کہ بلاوجہ کوڈ چلانے کے ساتھ منسلک خطرات ہوتے ہیں اور میں نے ماخذ کی اعتمادیت کی تصدیق کی ہے',
		ID: mo,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'`--api-auth` پرچم کو چلانے کے وقت شامل کریں stable-diffusion-webui',
		'Include `--api` flag when running stable-diffusion-webui':
			'اسٹیبل-ڈیفیوژن-ویب یو آئی چلانے کے دوران `--api` فلیگ شامل کریں',
		...
		'Leave empty to include all models or select specific models':
			'تمام ماڈلز کو شامل کرنے کے لئے خالی چھوڑ دیں یا مخصوص ماڈلز منتخب کریں',
		...
		'Leave empty to use the default prompt, or enter a custom prompt':
			'خالی چھوڑیں تاکہ ڈیفالٹ پرامپٹ استعمال ہو، یا ایک حسب ضرورت پرامپٹ درج کریں',
		...
		'LLMs can make mistakes. Verify important information.':
			'ایل ایل ایم غلطیاں کر سکتے ہیں اہم معلومات کی تصدیق کریں',
		Loader: Go,
		'Loading Kokoro.js...': '',
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'یقینی بنائیں کہ ComfyUI سے workflow.json فائل کو API فارمیٹ میں ایکسپورٹ کریں',
		Male: jo,
		Manage: Qo,
		'Manage Connections': '',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'بیک وقت زیادہ سے زیادہ 3 ماڈل ڈاؤن لوڈ کیے جا سکتے ہیں براہ کرم بعد میں دوبارہ کوشش کریں',
		May: $o,
		MBR: en,
		MCP: tn,
		...
		'Memories accessible by LLMs will be shown here.':
			'یہاں LLMs کے ذریعہ قابل رسائی یادیں دکھائی جائیں گی',
		Memory: rn,
		...
		'Message rating should be enabled to use this feature':
			'اس فیچر کو استعمال کرنے کے لئے پیغام کی درجہ بندی فعال کی جانی چاہئے',
		messages: cn,
		Messages: dn,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'آپ کے لنک بنانے کے بعد بھیجے گئے پیغامات شیئر نہیں کیے جائیں گے یو آر ایل والے صارفین شیئر کیا گیا چیٹ دیکھ سکیں گے',
		'Microsoft OneDrive': '',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"ماڈل '{{modelName}}' کامیابی سے ڈاؤن لوڈ ہو گیا ہے",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"ماڈل '{{modelTag}}' پہلے ہی ڈاؤن لوڈ کے لیے قطار میں ہے",
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'ماڈل فائل سسٹم کا راستہ مل گیا ماڈل کا مختصر نام اپڈیٹ کے لیے ضروری ہے، جاری نہیں رہ سکتا',
		'Model Filtering': '',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'نوٹ: اگر آپ کم از کم سکور سیٹ کرتے ہیں، تو تلاش صرف ان دستاویزات کو واپس کرے گی جن کا سکور کم از کم سکور کے برابر یا اس سے زیادہ ہوگا',
		Notes: kn,
		...
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'کمانڈ سٹرنگ میں صرف حروفی، عددی کردار اور ہائفن کی اجازت ہے',
		'Only can be triggered when the chat input is in focus.': '',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'صرف مجموعے ترمیم کیے جا سکتے ہیں، دستاویزات کو ترمیم یا شامل کرنے کے لیے نیا علمی بنیاد بنائیں',
		...
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'اوہ! لگتا ہے کہ یو آر ایل غلط ہے براۂ کرم دوبارہ چیک کریں اور دوبارہ کوشش کریں',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'اوہ! کچھ فائلیں ابھی بھی اپ لوڈ ہو رہی ہیں براہ کرم اپ لوڈ مکمل ہونے کا انتظار کریں',
		'Oops! There was an error in the previous response.': 'اوہ! پچھلے جواب میں ایک غلطی تھی',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'اوہ! آپ ایک غیر معاون طریقہ استعمال کر رہے ہیں (صرف فرنٹ اینڈ) براہ کرم ویب یو آئی کو بیک اینڈ سے پیش کریں',
		...
		'Open WebUI uses faster-whisper internally.':
			'اوپن ویب یو آئی اندرونی طور پر فاسٹر وِسپر استعمال کرتا ہے',
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.': '',
		'Open WebUI version': '',
		'Open WebUI version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})':
			'اوپن WebUI ورژن (v{{OPEN_WEBUI_VERSION}}) مطلوبہ ورژن (v{{REQUIRED_VERSION}}) سے کم ہے',
		OpenAI: Wn,
...
`,
		...
		'Permission denied when accessing media devices':
			'میڈیا آلات تک رسائی کے وقت اجازت مسترد کر دی گئی',
		'Permission denied when accessing microphone': 'مائیکروفون تک رسائی کی اجازت نہیں دی گئی',
		'Permission denied when accessing microphone: {{error}}':
			'مائیکروفون تک رسائی کے دوران اجازت مسترد: {{error}}',
		Permissions: ta,
		'Perplexity API Key': '',
		'Perplexity Model': '',
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines ایک پلگ اِن نظام ہے جس میں من مانی کوڈ چلایا جا سکتا ہے —',
		...
		'Please carefully review the following warnings:':
			'براہ کرم درج ذیل انتباہات کو احتیاط سے پڑھیں:',
		...
		'Redirecting you to Open WebUI Community':
			'آپ کو اوپن ویب یو آئی کمیونٹی کی طرف ری ڈائریکٹ کیا جا رہا ہے',
		'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative.':
			'',
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'خود کو "صارف" کے طور پر حوالہ دیں (جیسے، "صارف ہسپانوی سیکھ رہا ہے")',
		'Reference Chats': '',
		Refresh: Ca,
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'جواب کی اطلاعات کو فعال نہیں کیا جا سکتا کیونکہ ویب سائٹ کی اجازتیں مسترد کر دی گئی ہیں براہ کرم اپنے براؤزر کی سیٹنگز پر جائیں تاکہ ضروری رسائی کی اجازت دے سکیں',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'براہ کرم اپنے براؤزر کے اسٹوریج میں چیٹ لاگز کو محفوظ کرنا اب تعاون یافتہ نہیں ہے براہ کرم نیچے دیئے گئے بٹن پر کلک کرکے اپنے چیٹ لاگز کو ڈاؤن لوڈ اور حذف کریں فکر نہ کریں، آپ اپنے چیٹ لاگز کو بیک اینڈ میں دوبارہ آسانی سے درآمد کر سکتے ہیں',
		Schedule: ja,
		...
		'Selected model(s) do not support image inputs':
			'منتخب کردہ ماڈل(ز) تصویری ان پٹ کی حمایت نہیں کرتے',
		'Selected Models': '',
		semantic: es,
		Send: ts,
...
`,
		...
		'Show Admin Details in Account Pending Overlay':
			'اکاؤنٹ پینڈنگ اوورلے میں ایڈمن کی تفصیلات دکھائیں',
		'Show All': '',
		...
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'اس پلگ ان کے پیچھے موجود ڈویلپرز کمیونٹی کے پرجوش رضاکار ہیں اگر آپ کو یہ پلگ ان مددگار لگتا ہے تو برائے مہربانی اس کی ترقی میں اپنا حصہ ڈالنے پر غور کریں',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'تشخیصی لیڈربورڈ ایلو ریٹنگ سسٹم پر مبنی ہے اور یہ حقیقی وقت میں اپ ڈیٹ ہوتا ہے',
		...
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'لیڈر بورڈ اس وقت بیٹا مرحلے میں ہے، اور جیسے جیسے ہم الگورتھم کو بہتر بنائیں گے ہم ریٹنگ کیلکولیشن کو ایڈجسٹ کرسکتے ہیں',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'زیادہ سے زیادہ فائل سائز ایم بی میں اگر فائل سائز اس حد سے تجاوز کر جاتا ہے، تو فائل اپ لوڈ نہیں ہوگی',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'چیٹ میں ایک وقت میں استعمال ہونے والی فائلوں کی زیادہ سے زیادہ تعداد اگر فائلوں کی تعداد اس حد سے تجاوز کر جائے تو فائلیں اپلوڈ نہیں کی جائیں گی',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			'',
		"The passwords you entered don't quite match. Please double-check and try again.": '',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'سکور کی قیمت کو 0.0 (0%) اور 1.0 (100%) کے درمیان ہونا چاہیے',
		...
		'This action cannot be undone. Do you wish to continue?':
			'یہ عمل واپس نہیں کیا جا سکتا کیا آپ جاری رکھنا چاہتے ہیں؟',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'',
		"This chat won't appear in history and your messages will not be saved.": '',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'یہ یقینی بناتا ہے کہ آپ کی قیمتی گفتگو محفوظ طریقے سے آپ کے بیک اینڈ ڈیٹا بیس میں محفوظ کی گئی ہیں شکریہ!',
		...
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'یہ ایک تجرباتی خصوصیت ہے، یہ متوقع طور پر کام نہ کر سکتی ہو اور کسی بھی وقت تبدیل کی جا سکتی ہے',
		...
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'اس اختیار سے مجموعہ میں موجود تمام فائلز حذف ہو جائیں گی اور ان کی جگہ نئی اپ لوڈ کردہ فائلز لی جائیں گی',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'یہ <strong>{{NAME}}</strong> اور <strong>اس کے تمام مواد</strong> کو حذف کر دے گا',
		...
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'یہ علمی بنیاد کو دوبارہ ترتیب دے گا اور تمام فائلز کو متوازن کرے گا کیا آپ جاری رکھنا چاہتے ہیں؟',
		...
		'To access the available model names for downloading,':
			'ڈاؤن لوڈ کرنے کے لئے دستیاب ماڈل کے ناموں تک رسائی حاصل کرنے کے لئے،',
		'To access the GGUF models available for downloading,':
			'GGUF ماڈلز تک رسائی حاصل کرنے کے لئے جو ڈاؤنلوڈنگ کے لئے دستیاب ہیں،',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'ویب یو آئی تک رسائی حاصل کرنے کے لیے براہ کرم منتظم سے رابطہ کریں ایڈمنز صارف کی حالت کو ایڈمن پینل سے منظم کر سکتے ہیں',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'یہاں معلوماتی بنیاد منسلک کرنے کے لیے، پہلے انہیں "معلومات" ورک اسپیس میں شامل کریں',
		...
		'To select toolkits here, add them to the "Tools" workspace first.':
			'یہاں ٹول کٹس منتخب کرنے کے لیے، پہلے انہیں "ٹولز" ورک اسپیس میں شامل کریں',
		...
		'Tools have a function calling system that allows arbitrary code execution.':
			'ٹولز کے پاس ایک فنکشن کالنگ سسٹم ہے جو اختیاری کوڈ کی عمل درآمد کی اجازت دیتا ہے',
		...
		'Update for the latest features and improvements.':
			'تازہ ترین خصوصیات اور بہتریوں کے لیے اپ ڈیٹ کریں',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"پرامپٹ ان پٹ میں '#' استعمال کریں تاکہ اپنی معلومات کو لوڈ اور شامل کریں",
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'تمام ماڈلز کے ساتھ ڈیفالٹ ارینا ماڈل استعمال کریں حسب ضرورت ماڈلز شامل کرنے کے لیے پلس بٹن پر کلک کریں',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'ورژن {{selectedVersion}} کا {{totalVersions}} میں سے',
		'Version deleted': '',
		'View Replies': '',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'موضوع یا کلیدی لفظ کا خلاصہ 50 الفاظ میں لکھیں',
...
مثال: آپ سپر ماریو بروز کے ماریو ہیں اور مددگار کے طور پر کام کر رہے ہیں۔`,
		...
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'آپ ایک وقت میں زیادہ سے زیادہ {{maxCount}} فائل(وں) کے ساتھ صرف چیٹ کر سکتے ہیں',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"آپ نیچے موجود 'Manage' بٹن کے ذریعے LLMs کے ساتھ اپنی بات چیت کو یادداشتیں شامل کرکے ذاتی بنا سکتے ہیں، جو انہیں آپ کے لیے زیادہ مددگار اور آپ کے متعلق بنائے گی",
		...
		'Your account status is currently pending activation.':
			'آپ کے اکاؤنٹ کی حالت فی الحال فعال ہونے کے منتظر ہے',
		'Your browser does not support the audio tag.': '',
		'Your browser does not support the video tag.': '',
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			'آپ کی پوری شراکت براہ راست پلگ ان ڈیولپر کو جائے گی؛ اوپن ویب یو آئی کوئی فیصد نہیں لیتی تاہم، منتخب کردہ فنڈنگ پلیٹ فارم کی اپنی فیس ہو سکتی ہیں',
...
//# sourceMappingURL=BNrzIdBQ.js.map
