...
import { html as j } from './DDyF20IL.js';
import { L as V, E as c } from './COV9u0MG.js';
const W = 1,
	k = 2,
	w = 3,
	v = 180,
...
const C = u('endcomment', z, E),
	...
	N = new c((O) => {
		if (O.next == 35) {
			for (
				O.advance();
				!(O.next == 10 || O.next < 0 || ((O.next == 37 || O.next == 125) && O.peek(1) == 125));
			)
				O.advance();
			O.acceptToken(U);
		}
...
function K(O, a, r, n) {
	...
	for (;;) {
		...
		if (i.name == 'VariableName' || i.name == 'forloop' || i.name == 'tablerowloop') {
			...
			($.unshift(
				(e == null ? void 0 : e.name) == 'StringLiteral' ? O.sliceDoc(e.from + 1, e.to - 1) : '[]'
			),
				(a = i));
		} else return [];
	}
			...
			props: [
				...
				b.add({
					'UnlessDirective ForDirective TablerowDirective CaptureDirective IfDirective CaseDirective RawDirective Comment'(
						...
						return !a || a.name != 'Tag'
							? null
							: { from: a.to, to: r.name == 'EndTag' ? r.from : O.to };
					}
				})
			]
		}),
	...
	return $O.configure(
		{
			wrap: X((a) =>
				a.type.isTop
					? { parser: O.parser, overlay: (r) => r.name == 'Text' || r.name == 'RawText' }
					: null
			)
		},
		'liquid'
...
export { OO as closePercentBrace, nO as liquid, J as liquidCompletionSource, aO as liquidLanguage };
//# sourceMappingURL=BOv8Km52.js.map
