...
var _o = !0,
	...
	Ve = function (e) {
		hv() && (Uc ? console.warn(e) : Kc && console.trace());
	},
	Xc = function (e) {
		return be({}, e);
	},
...
/*! Bezier curve function generator. Copyright Gaetan Renaudeau. MIT License: http://en.wikipedia.org/wiki/MIT_License */ function yp(
	r,
	e,
	t,
	a
...
/*! Runge-Kutta spring physics function generator. Adapted from Framer.js, copyright Koen Bok. MIT License: http://en.wikipedia.org/wiki/MIT_License */ var mp =
		(function () {
			function r(a) {
...
function Of(r, e, t) {
	...
	if (r.webglDebug) {
		...
		if (h) 'WebGL ('.concat(t.name, ') - time ').concat(d, 'ms, ').concat(g);
		else {
			('WebGL ('.concat(t.name, ') - frame time ').concat(d, 'ms'), '  '.concat(g));
			var p = y.atlasInfo,
				m = kr(p),
				b;
			try {
...
export { ea as c };
//# sourceMappingURL=BTOT7Bb_.js.map
