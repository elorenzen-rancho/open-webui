const e = 'Acerca de',
	...
	Fs = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 para ilimitado, o un número entero positivo para un límite específico.',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' o '-1' para evitar expiración.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(p.ej. `sh webui.sh --api --api-auth username_password`)',
		...
		'*Prompt node ID(s) are required for image generation':
			'Los ID de nodo son requeridos para la generación de imágenes',
		'1 hour before': '',
		'1 Source': '1 Fuente',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A collaboration channel where people join as members':
			'Canal colaborativo donde la gente se une como miembro',
		'A discussion channel where access is controlled by groups and permissions':
			'Un canal de discusión con el acceso controlado mediante grupos y permisos',
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Nueva versión (v{{LATEST_VERSION}}) disponible.',
		'A private conversation between you and selected users':
			'conversación privada entre el usuario seleccionado y tu',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'El modelo de tareas realiza tareas como la generación de títulos para chats y consultas de búsqueda web',
		'a user': 'un usuario',
		About: e,
...
Ir a la Configuración de este Indicador`,
		...
		'Action Required for Chat Log Storage':
			'Se requiere acción para almacenar el registro del chat',
		Actions: n,
		Activate: t,
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Activar este comando escribiendo "/{{COMMAND}}" en el chat',
		Active: s,
		...
		'Add a short description about what this model does':
			'Añadir una breve descripción sobre lo que hace este modelo',
		...
		'Add your Open Terminal URL and API key in Settings → Integrations.':
			'Añadir la URL y la clave API de OpenTerminal en Configuración → Integraciones',
		...
		'Adds filenames, titles, sections, and snippets into the BM25 text to improve lexical recall.':
			'Añade nombres de archivos, títulos, secciones o fragmentos para mejorar la búsqueda léxica con BM25.',
		'Adjusting these settings will apply changes universally to all users.':
			'El ajuste de estas opciones se aplicará globalmente a todos los usuarios.',
		admin: d,
		Admin: c,
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Los administradores tienen acceso a todas las herramientas en todo momento; los usuarios necesitan que los modelos tengan asignadas las herramientas en el area de trabajo.',
		Advanced: u,
		'Advanced Parameters': 'Parámetros Avanzados',
		'Advanced parameters for MinerU parsing (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)':
			'Parámetros avanzados para MinerU (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)',
		...
		'After updating or changing the embedding model, you must reindex the knowledge base for the changes to take effect. You can do this using the "Reindex" button below.':
			'Después de actualizar o cambiar el modelo de incrustación, debe reindexar la base de datos para que los cambios surtan efecto. Puede hacerlo usando el botón "Reindexar" a continuación.',
		AI: m,
		All: p,
		...
		'API Base URL for Datalab Marker service. Defaults to: https://www.datalab.to/api/v1/marker':
			'URL Base de la API de Datalab Marker service. La Predeterminada es: https://www.datalab.to/api/v1/marker',
		'API Key': 'Clave API',
		...
		'applies to all users with the "user" role':
			'se aplica a todos los usuarios con el rol "user" ',
		April: C,
		Archive: A,
		...
		'Are you sure you want to archive all chats? This action cannot be undone.':
			'¿Estás seguro que quieres archivar todos los chats? (¡esta acción NO se puede deshacer!)',
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'¿Estás seguro de que quieres borrar todas las memorias? (¡esta acción NO se puede deshacer!)',
		'Are you sure you want to delete "{{NAME}}"?':
			'¿Estás seguro de que quieres eliminar "{{NAME}}"?',
		'Are you sure you want to delete **{{modelName}}**?':
			'¿Estás seguro de que quieres eliminar **{{modelName}}**?',
		'Are you sure you want to delete all chats? This action cannot be undone.':
			'¿Estás seguro que quieres borrar todos los chats? (¡esta acción NO se puede deshacer!)',
		'Are you sure you want to delete this channel?':
			'¿Estás seguro de que quieres eliminar este canal?',
		'Are you sure you want to delete this connection? This action cannot be undone.':
			'¿Estás seguro que desea eliminar esta conexión? (¡esta acción NO se puede deshacer!)',
		'Are you sure you want to delete this memory? This action cannot be undone.':
			'¿Estás seguro que desea eliminar esta memoria? (¡esta acción NO se puede deshacer!)',
		'Are you sure you want to delete this message?':
			'¿Estás seguro de que quieres eliminar este mensaje? ',
		"Are you sure you want to delete this version? Child versions will be relinked to this version's parent.":
			'¿Estás seguro que desea eliminar esta versión? (las versiones derivadas se vincularán a la versión principal de esta)',
		...
		'Are you sure you want to unarchive all archived chats?':
			'¿Estás seguro de que quieres desarchivar todos los chats archivados?',
		...
		'Autocomplete Generation Input Max Length':
			'Max. Longitud de Entrada en Generación de Autocompletado',
		Automatic1111: x,
		...
		'Automatically inject system tools in native function calling mode (e.g., timestamps, memory, chat history, notes, etc.)':
			'Inyectar automáticamente herramientas del sistema en el modo de llamada de función nativa (ej.: marcas de tiempo, memoria, historial de chat, notas, etc.)',
		Automation: N,
		...
		'Base Model List Cache speeds up access by fetching base models only at startup or on settings save—faster, but may not show recent base model changes.':
			'La caché de la lista de modelos base acelera el acceso recuperando los modelos base sólo al inicio o en el autoguardado rápido de la configuración, si se activa hay que tener en cuenta que los cambios más recientes en las listas de modelos podrían no reflejarse de manera inmediata.',
		Bearer: z,
		before: q,
		'Being lazy': 'Vaguear',
		Beta: B,
		...
		'Boosting or penalizing specific tokens for constrained responses. Bias values will be clamped between -100 and 100 (inclusive). (Default: none)':
			'Impulsando o penalizando tokens específicos para respuestas restringidas. Los valores de sesgo se limitarán entre -100 y 100 (inclusive). (Por defecto: ninguno)',
		Brave: H,
		'Brave Search API Key': 'Clave de la API de Brave Search',
		'Break down complex requests into trackable steps':
			'Desglosar las peticiones complejas en pasos rastreables',
		...
		'Call feature is not supported when using Web STT engine':
			'La funcionalidad de Llamada no está soportada cuando se usa el motor Web STT',
		Camera: J,
		Cancel: Q,
		...
		'Channel name must be less than 128 characters':
			'El nombre del Canal debe ser menor de 128 caracteres.',
		...
		'Character limit for autocomplete generation input':
			'Límite de caracteres de entrada de la generación de autocompletado',
		...
		'Chunks smaller than this threshold will be merged with neighboring chunks when possible. Set to 0 to disable merging.':
			'Los fragmentos menores a este umbral se fusionarán con los fragmentos vecinos cuando sea posible. Establézcalo en 0 para deshabilitar la fusión.',
		Ciphers: te,
		Citation: se,
		Citations: ie,
		...
		'Click here to download user import template file.':
			'Pulsa aquí para descargar la plantilla para importar usuarios.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Pulsa aquí para saber más sobre faster-whisper y ver los modelos disponibles.',
		...
		'Click here to select a csv file.':
			'Pulsa aquí para seleccionar un archivo de Valores Separados por Comas (.csv)',
		...
		"Click on the user role button to change a user's role.":
			'Pulsa en el botón rol de usuario para cambiar su rol.',
		...
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Permisos de escritura del portapapeles denegado. Por favor, comprueba la configuración de tu navegador para otorgar el permiso necesario.',
		Clone: le,
		...
		'Collaboration channel where people join as members':
			'Canal de colaboración donde la gente se une como miembro',
		Collapse: ue,
		Collection: me,
		Collections: pe,
		Color: he,
		...
		'Connect to an AI provider to start chatting':
			'Conectar a un proveedor de AI para comenzar a chatear',
		'Connect to Open Terminal instances to browse files and use them as always-on tools. Only one can be active at a time.':
			'Conéctate a instancias de Open Terminal para tener navegadores de archivos y usarlos como herramientas siempre activas. Solo una puede estar activa a la vez.',
		'Connect to Open Terminal instances. All users will have access to file browsing and terminal tools through these servers.':
			'Conéctate a instancias de Open Terminal. Todos los usuarios tendrán acceso a la navegación de archivos y a las utilidades del terminal a través de estos servidores.',
		'Connect to your own OpenAI compatible API endpoints.':
			'Conectar a tus propios API endpoints compatibles con OpenAI.',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			'Limita el esfuerzo de razonamiento para los modelos de razonamiento. Solo aplicable a modelos de razonamiento de proveedores específicos que soportan el esfuerzo de razonamiento.',
		...
		'Content lengths (character counts only)':
			'Longitud del contenido (solo recuento de caracteres)',
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Controlar como se divide el texto del mensaje para las solicitudes de locución (TTS). 'Punctuation' divide oraciones, 'paragraphs' divide párrafos y 'none' mantiene el mensaje como una sola cadena.",
		'Control the repetition of token sequences in the generated text. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 1.1) will be more lenient. At 1, it is disabled.':
			'Controla la repetición de secuencias de tokens en el texto generado. Un valor más alto (p.ej., 1.5) penalizá más las repeticiones, mientras que un valor más bajo (p.ej., 1.1) sería más permisivo. En 1, el control está desactivado.',
		Controls: we,
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			'Controles del equilibrio entre coherencia y diversidad de la salida. Un valor más bajo produce un texto más centrado y coherente.',
		...
		'Copying to clipboard was successful!':
			'¡La copia al portapapeles se ha realizado correctamente!',
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'El protocolo CORS debe estar configurado correctamente por el proveedor para permitir solicitudes desde Open WebUI.',
		...
		'Create scheduled prompts that run automatically on a recurring basis.':
			'Crea indicadores programados para que se ejecuten automáticamente de forma recurrente.',
		'Create your first note by clicking on the plus button below.':
			'Crea tu primera nota pulsando el botón + de abajo',
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			'El modo predeterminado trabaja con un amplio rango de modelos, llamando a las herramientas una vez antes de la ejecución. El modo nativo aprovecha las capacidades de llamada de herramientas integradas del modelo, pero requiere que el modelo admita inherentemente esta función.',
		...
		'Default permissions updated successfully':
			'Permisos predeterminados actualizados correctamente',
		...
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			'Por defecto está predeterminada una segmentación de la recuperación para una extracción de contenido centrado y relevante, recomendado para la mayoría de los casos.',
		...
		'Deployment names are required for Azure OpenAI':
			'Azure OpenAI requiere nombres de implementación',
		Desc: We,
		...
		'Describe your knowledge base and objectives':
			'Describe tu Base de Conocimientos y sus objetivos',
		Description: Ge,
		Deselect: _e,
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'Las Conexiones Directas permiten a los usuarios conectar a sus propios endpoints compatibles API OpenAI.',
		...
		'Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.':
			'Desabilita la extracción de imágenes del pdf. Si está habilitado Usar LLM las imágenes se capturan automáticamente. Por defecto el valor es Falso (las imágenes se extraen).',
		Disabled: Ke,
		'Disconnect OAuth': '',
		...
		'Discover, download, and explore custom functions':
			'Descubre, descarga y explora funciones personalizadas',
		'Discover, download, and explore custom prompts':
			'Descubre, descarga, y explora indicadores personalizados',
		'Discover, download, and explore custom tools':
			'Descubre, descarga y explora herramientas personalizadas',
		'Discover, download, and explore model presets':
			'Descubre, descarga y explora modelos con preajustados',
		'Discussion channel where access is based on groups and permissions':
			'Canal de debate cuyo acceso está basado en grupos y permisos',
		Display: Ye,
		...
		'Display the username instead of You in the Chat':
			'Mostrar en el chat el nombre de usuario en lugar del genérico Tu',
		...
		'Displays status updates (e.g., web search progress) in the response':
			'Muestra actualizaciones de estado (p.ej., progreso de la búsqueda web) en la respuesta',
		'Dive into knowledge': 'Sumérgete en el conocimiento',
		'Do not install functions from sources you do not fully trust.':
			'¡No instalar funciones de fuentes en las que que no se confíe totalmente!',
		'Do not install tools from sources you do not fully trust.':
			'¡No instalar herramientas de fuentes en las que no se confíe totalmente!',
		'Do you want to sync your usage stats with Open WebUI Community?':
			'¿Quieres sincronizar tus estadísticas de uso con Open WebUI Community?',
		Docling: Je,
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'no se realiza ninguna conexión externa y tus datos permanecen seguros alojados localmente en tu servidor.',
		'Domain Filter List': 'Lista de Filtrado de Dominio',
		"don't fetch random pipelines from sources you don't trust.":
			'No obtengas pipelines aleatorias de fuentes no confiables.',
		"Don't have an account?": '¿No tienes una cuenta?',
		"don't install random functions from sources you don't trust.":
			'¡no instalar funciones desconocidas de fuentes en las que no se confíe!',
		"don't install random tools from sources you don't trust.":
			'¡no instalar herramientas desconocidas de fuentes en las que no se confíe!',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"p.ej. '30s','10m'. Unidades de tiempo válidas son 's', 'm', 'h'.",
		...
		'e.g. A filter to remove profanity from text':
			'p.ej. Un filtro para eliminar malas palabras del texto',
		...
		'e.g. Step-by-step instructions for code reviews':
			'p.ej. Unstruciones paso a paso para revisión de código',
		'e.g. Tell me a fun fact': 'p.ej. Dime algo divertido',
		'e.g. Tell me a fun fact about the Roman Empire':
			'p.ej. Dime algo divertido sobre el imperio romano',
		'e.g. Tools for performing various operations':
			'p.ej. Herramientas para realizar diversas operaciones',
		'e.g., 3, 4, 5 (leave blank for default)': 'p.ej. , 3, 4, 5 ...',
		'e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)':
			'e.g., audio/wav,audio/mpeg,video/* (dejar en blanco para predeterminados)',
		'e.g., en-US,ja-JP (leave blank for auto-detect)':
			'p.ej., en-US,ja-JP (dejar en blanco para detectar automáticamente)',
		...
		'Enable autocomplete generation for chat messages':
			'Habilitar generación de autocompletado para mensajes de chat',
		...
		"Enable Memory Locking (mlock) to prevent model data from being swapped out of RAM. This option locks the model's working set of pages into RAM, ensuring that they will not be swapped out to disk. This can help maintain performance by avoiding page faults and ensuring fast data access.":
			'Habilitar bloqueo de memoria (mlock) para prevenir que los datos del modelo se intercambien fuera de la RAM. Esta opción bloquea el conjunto de páginas de trabajo del modelo en RAM, asegurando que no se intercambiarán fuera a disco. Esto puede ayudar a mantener el rendimiento evitando fallos de página y asegurando un acceso rápido a los datos.',
		'Enable Memory Mapping (mmap) to load model data. This option allows the system to use disk storage as an extension of RAM by treating disk files as if they were in RAM. This can improve model performance by allowing for faster data access. However, it may not work correctly with all systems and can consume a significant amount of disk space.':
			'Habilitar Mapeado de Memoria (mmap) para cargar datos del modelo. Esta opción permite al sistema usar el almacenamiento del disco como una extensión de la RAM al tratar los archivos en disco como si estuvieran en la RAM. Esto puede mejorar el rendimiento del modelo al permitir un acceso más rápido a los datos. Sin embargo, puede no funcionar correctamente con todos los sistemas y puede consumir una cantidad significativa de espacio en disco.',
		'Enable Message Queue': 'Habilitar Cola de Mensajes',
		'Enable Message Rating': 'Habilitar Calificación de los Mensajes',
		'Enable Mirostat sampling for controlling perplexity.':
			'Algoritmo de decodificación de texto neuronal que controla activamente el proceso generativo para mantener la perplejidad del texto generado en un valor deseado. Previene las trampas de aburrimiento (por excesivas repeticiones) y de incoherencia (por generación de excesivo texto).',
		...
		'Enable, disable, or customize the reasoning tags used by the model. "Enabled" uses default tags, "Disabled" turns off reasoning tags, and "Custom" lets you specify your own start and end tags.':
			'Habilite, deshabilite o personalice las etiquetas de razonamiento utilizadas por el modelo. "HAbilitado" usa etiquetas predeterminadas, "Deshabilitado" desactiva las etiquetas de razonamiento y "Personalizado" le permite especificar sus propias etiquetas de inicio y fin.',
		Enabled: ma,
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Asegúrese de que su archivo CSV incluya 4 columnas en este orden: Nombre, Correo Electrónico, Contraseña, Rol.',
		'Enter {{role}} message here': 'Ingresar mensaje {{role}} aquí',
		'Enter a detail about yourself for your LLMs to recall':
			'Ingresar detalles sobre ti para que los recuerden sus LLMs',
		'Enter a title for the pending user info overlay. Leave empty for default.':
			'Ingresar un título para la sobrecapa informativa de usuario pendiente. Dejar vacío para usar el predeterminado.',
		'Enter a watermark for the response. Leave empty for none.':
			'Ingresar una marca de agua para la respuesta. Dejalo vacío para ninguna',
		'Enter additional headers in JSON format': 'Ingresar encabezados adicionales en formato JSON',
		'Enter additional headers in JSON format (e.g. {"X-Custom-Header": "value"}':
			'Ingresar encabezados adicionales en formato JSON (ej. {"X-Custom-Header": "value"})',
		...
		'Enter api auth string (e.g. username:password)':
			'Ingresar campo de autorización de la api (p.ej. nombre:contraseña)',
		...
		'Enter content for the pending user info overlay. Leave empty for default.':
			'Ingresar contenido para la sobrecapa informativa de usuario pendiente. Dejar vacío para usar el predeterminado.',
		...
		'Enter domains separated by commas (e.g., example.com,site.org,!excludedsite.com)':
			'Ingresar dominios separados por comas (ej. ejemplocom, site,org, !excludedsite.com)',
		'Enter Exa API Key': 'Ingresar Clave API de Exa',
		'Enter External Document Loader API Key':
			'Ingresar Clave API del Cargador Externo de Documentos',
		...
		'Enter function name filter list (e.g. func1, !func2)':
			'Ingresar lista para el filtro de nombres de función (p.ej.: func1, !func2)',
		...
		'Enter JSON config (e.g., {"disable_links": true})':
			'Ingresar config JSON (ej., {"disable_links": true})',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Ingresar URL del proxy (p.ej. https://user:password@host:port)',
		...
		'Enter skill instructions in markdown...':
			'Ingresar instrucciones de la habilidad en markdown...',
		...
		'Enter the prompt instructions for this automation...':
			'Ingresar las instrucciones del indicador para la automatización...',
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'Ingresar URL pública de WebUI. Esta URL se usará para generar enlaces en las notificaciones.',
		...
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			'Ingresar URL de Yacy (p.ej. http://yacy.ejemplo.com:8090)',
		...
		"Error: A model with the ID '{{modelId}}' already exists. Please select a different ID to proceed.":
			"Error: Ya existe un modelo con el ID '{{modelId}}'. Seleccione otro ID para continuar.",
		'Error: Model ID cannot be empty. Please enter a valid ID to proceed.':
			'Error: El ID del modelo no puede estar vacío. Ingrese un ID válido para continuar.',
		Evaluations: ba,
		'Event created': '',
		'Event deleted': '',
		'Event title': '',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Ejemplo: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Ejemplo: sAMNombreCuenta o uid o userNombrePrincipal',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			'Excedido el número de clientes de tu licencia. Por favor, contacta con soporte para aumentar el número de clientes.',
		Exclude: va,
		...
		'External Document Loader URL required.':
			'LA URL del Cargador Externo de Documentos es requerida.',
		...
		'Fade Effect for Streaming Text':
			'Efecto de desvanecimiento para texto transmitido (streaming)',
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'Fallo al conectar al servidor de herramientas: {{URL}}',
		'Failed to connect to {{URL}} terminal server':
			'Fallo al conectar al servidor de terminal: {{URL}}',
		...
		'Failed to extract content from the file: {{error}}':
			'Fallo al extraer el contenido del archivo: {{error}}',
		...
		'Failed to load DOCX file. Please try downloading it instead.':
			'Fallo al cargar el archivo DOCX. Por favor, en su lugar intente descargarlo',
		'Failed to load Excel/CSV file. Please try downloading it instead.':
			'Fallo al cargar el archivo Excel/CSV. Por favor, en su lugar intente descargarlo.',
		...
		'Failed to load PPTX file. Please try downloading it instead.':
			'Fallo al cargar el archivo PPTX. Por favor, en su lugar intente descargarlo',
		...
		'File size should not exceed {{maxSize}} MB.':
			'Tamaño del archivo no debe exceder {{maxSize}} MB.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Se detectó suplantación de huellas: No se pueden usar las iniciales como avatar. Se establece la imagen de perfil predeterminada.',
		...
		'Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.':
			'Forzar OCR en todas las páginas del PDF. Puede empeorar el resultado en PDFs que ya tengan una buena capa de texto. El valor predeterminado es desactivado (no forzar)',
		...
		'Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.':
			"Formatear las lineas en la salida. Por defecto, False. Si la opción es True, las líneas se formatearán detectando estilos e 'inline math'",
		'Formatting may be inconsistent from source.':
			'El formato puede ser inconsistente con el original',
		Forward: Fa,
		'Forwards system user OAuth access token to authenticate':
			'Reenvía el token de acceso OAuth del usuario del sistema para autenticarse',
		'Forwards system user session credentials to authenticate':
			'Reenvío de las credenciales de la sesión del usuario del sistema para autenticación',
		Fr_day_of_week: ja,
		...
		'Functions allow arbitrary code execution.':
			'Las Funciones habilitan la ejecución de código arbitrario.',
		...
		'Get current time and perform date/time calculations':
			'Obtener la hora actual y realizar cálculos de fecha y hora',
		...
		'Hex Color - Leave empty for default color':
			'Color Hex - Deja vacío para el color predeterminado',
		Hidden: ro,
		Hide: no,
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Aseguro que he leído y entiendo las implicaciones de mi acción. Soy consciente de los riesgos asociados con la ejecución de código arbitrario y he verificado la confiabilidad de la fuente.',
		ID: mo,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Incluir el señalizador `--api-auth` al ejecutar stable-diffusion-webui',
		'Include `--api` flag when running stable-diffusion-webui':
			'Incluir el señalizador `--api` al ejecutar stable-diffusion-webui',
		...
		'Influences how quickly the algorithm responds to feedback from the generated text. A lower learning rate will result in slower adjustments, while a higher learning rate will make the algorithm more responsive.':
			'Influye en la rápidez de respuesta a la realimentación desde el texto generado. Una tasa de aprendizaje más baja resulta en un ajustado más lento, mientras que una tasa de aprendizaje más alta hará que el algoritmo sea más reactivo.',
		Info: fo,
		Initials: yo,
		'Inject file content into conversation context':
			'Inyectar el contenido del archivo en el contexto de la conversación',
		'Inject the entire content as context for comprehensive processing, this is recommended for complex queries.':
			'Inyecta el contenido completo como contexto para un procesado comprensivo, recomendado para consultas complejas.',
		Input: Co,
		...
		'Instant Auto-Send After Voice Transcription':
			'AutoEnvio Instantaneo tras la Transcripción de Voz',
		Instructions: Io,
		Integration: So,
		Integrations: Po,
		Interface: Eo,
		...
		'Invalid JSON format for ComfyUI Edit Workflow.':
			'Formato JSON Inválido para Editar el Flujo de Trabajo de ComfyUI',
		'Invalid JSON format for ComfyUI Workflow.':
			'Formato JSON Inválido para el Flujo de Trabajo de ComfyUI',
		...
		'Learn more about OpenAPI tool servers.':
			'Saber más sobre los servidores de herramientas OpenAPI',
		...
		'Leave empty to include all models from "{{url}}" endpoint':
			'Dejar vacío para incluir todos los modelos desde el endpoint "{{url}}"',
		'Leave empty to include all models from "{{url}}/api/tags" endpoint':
			'Dejar vacío para incluir todos los modelos desde el endpoint "{{url}}/api/tags"',
		'Leave empty to include all models from "{{url}}/models" endpoint':
			'Dejar vacío para incluir todos los modelos desde el endpoint "{{url}}/models"',
		'Leave empty to include all models or select specific models':
			'Dejar vacío para incluir todos los modelos o Seleccionar modelos específicos',
		'Leave empty to use first admin user':
			'Dejar vacío para utilizar el primer usuario administrador',
		'Leave empty to use the default config, or enter a valid json (see https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)':
			'Déjelo vacío para usar la configuración predeterminada o ingresa un json válido (consulta https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)',
		'Leave empty to use the default model (voxtral-mini-latest).':
			'Dejar vacío para usar el modo predeterminado (voxtral-mini-latest).',
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Dejar vacío para usar el indicador predeterminado, o Ingresar un indicador personalizado',
		'Leave model field empty to use the default model.':
			'Dejar vacío el campo modelo para usar el modelo predeterminado.',
		Legacy: Oo,
		lexical: Fo,
		License: jo,
		...
		'Limit concurrent search queries. 0 = unlimited (default). Set to 1 for sequential execution (recommended for APIs with strict rate limits like Brave free tier).':
			'Limitar consultas de búsqueda simultáneas. 0 = ilimitado (predeterminado). Establécerlo en 1 para ejecución secuencial (recomendado para API con límites de velocidad estrictos, como la versión gratuita de Brave).',
		'Limits the number of concurrent embedding requests. Set to 0 for unlimited.':
			'Limita el número de peticiones concurrentes al incrustrar. Ajusta a 0 para ilimitadas',
		List: qo,
		...
		'LLMs can make mistakes. Verify important information.':
			'Los LLMs pueden cometer errores. Verifica la información importante.',
		Loader: Wo,
		...
		'Make password visible in the user interface':
			'Hacer visible la contraseña en la interfaz del usuario.',
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Asegúrate de exportar un archivo workflow.json en formato API desde ComfyUI.',
		Male: Jo,
		Manage: Qo,
		...
		'Maximum characters to return from fetched URLs. Leave empty for no limit.':
			'Límite máximo de caracteres a retornar al extraer URLs. Dejar vacío para ilimitados',
		'Maximum number of files allowed per folder.':
			'Número máximo de archivos permitidos por carpeta',
		'Maximum number of files per folder is {{max}}.':
			'El número máximo de archivos permitidos por carpeta es {{max}}.',
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Se puede descargar un máximo de 3 modelos simultáneamente. Por favor, reinténtelo más tarde.',
		May: $o,
		MBR: er,
		MCP: ar,
		'MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Open WebUI team, making it the more reliable option for compatibility.':
			'El soporte de MCP es experimental y su especificación cambia con frecuencia, lo que puede generar incompatibilidades. El equipo de Open WebUI mantiene directamente la compatibilidad con la especificación OpenAPI, lo que la convierte en la opción más fiable para la compatibilidad.',
		Medium: or,
		...
		'Memories accessible by LLMs will be shown here.':
			'Las memorias accesibles por los LLMs se mostrarán aquí.',
		Memory: sr,
		...
		'Message counts and response timestamps':
			'Recuento de mensajes y marcas de tiempo de la respuesta',
		'Message counts are based on assistant responses.':
			'El recuento de mensajes está basado en las respuestas del asistente',
		'Message rating should be enabled to use this feature':
			'Para usar esta función debe estar habilitada la calificación de mensajes',
		messages: lr,
		Messages: dr,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Los mensajes que envíe después de la creación del enlace no se compartirán. Los usuarios con la URL del enlace podrán ver el chat compartido.',
		...
		'MinerU API Key required for Cloud API mode.':
			'La clave API de MinerU es necesaria para el modo Cloud API',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Modelo '{{modelName}}' se ha descargado correctamente.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Modelo '{{modelTag}}' ya está en cola para descargar.",
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': 'Modelo {{modelName}} borrado correctamente',
		'Model {{modelName}} is not vision capable':
			'Modelo {{modelName}} no esta capacitado para visión',
		...
		'Model can execute code and perform calculations':
			'Modelo puedo ejecutar código y realizar cálculos',
		'Model can generate images based on text prompts':
			'Modelo puede generar imágenes basadas en indicadores de texto',
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Detectada ruta del sistema al modelo. Para actualizar se requiere el nombre corto del modelo, no se puede continuar.',
		...
		'Model name already exists, please choose a different one':
			'Ese nombre de modelo ya existe, por favor elige otro diferente',
		...
		'Name and ID are required, please fill them out':
			'Nombre e ID requeridos, por favor introducelos',
		...
		'No files yet. Upload files or run Python code to create them.':
			'Todavía no hay ficheros. Sube archivos o ejecuta código Python para crearlos.',
		...
		'No HTML, CSS, or JavaScript content found.':
			'No se encontró contenido HTML, CSS, o JavaScript.',
		'No inference engine with management support found':
			'No se encontró un motor de inferencia que soporte gestión',
		...
		'No tool server connections configured.':
			'No hay conexiones a servidores de herramientas configuradas',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Nota: Si estableces una puntuación mínima, la búsqueda sólo devolverá documentos con una puntuación mayor o igual a la puntuación mínima establecida.',
		Notes: Tr,
		...
		'Only active when "Paste Large Text as File" setting is toggled on.':
			'Solo activo cuando "Pegar el Texto Largo como Archivo" está activado',
		'Only active when the chat input is in focus and an LLM is generating a response.':
			'Solo activo con el foco en la entrada del chat y se está generando una respuesta',
		'Only active when the chat input is in focus.':
			'Solo activo con el foco en la entrada del chat',
		'Only alphanumeric characters and hyphens are allowed':
			'Sólo están permitidos caracteres alfanuméricos y guiones',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Sólo están permitidos en la cadena de comandos caracteres alfanuméricos y guiones.',
		'Only can be triggered when the chat input is in focus.':
			'Solo se puede activar cuando el foco está en la entrada del chat.',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Solo se pueden editar las colecciones, para añadir/editar documentos hay que crear una nueva base de conocimientos',
		...
		'Only select users and groups with permission can access':
			'Solo pueden acceder los usuarios y grupos con permiso',
		'Only sync new/updated chats': 'Sincronizar solo chats nuevos o actualizados',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'¡vaya! Parece que la URL es inválida. Por favor, revisala y reintenta de nuevo.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'¡vaya! Todavía hay archivos subiendose. Por favor, espera a que se complete la subida.',
		'Oops! There was an error in the previous response.':
			'¡vaya! Hubo un error en la respuesta previa.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'¡vaya! Estás usando un método no soportado (solo interfaz frontal-frontend). Por favor sirve WebUI desde el interfaz trasero (servidor backend).',
		...
		'Open Modal To Manage Floating Quick Actions':
			'Abrir Modal para Gestionar Acciones Rápidas Flotantes',
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			'Open-WebUI puede usar herramientas proporcionadas por cualquier servidor OpenAPI',
		...
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open-WebUI usa SpeechT5 y la incrustración de locutores de CMU Arctic.',
		'Open WebUI version': 'versión de Open-WebUI',
		'Open WebUI version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})':
			'La versión de Open-WebUI (v{{OPEN_WEBUI_VERSION}}) es inferior a la versión  (v{{REQUIRED_VERSION}}) requerida',
		OpenAI: Fr,
		...
		'Page mode creates one document per page. Single mode combines all pages into one document for better chunking across page boundaries.':
			'El modo Página crea un documento por página. El modo Individual combina todas las páginas en un solo documento para una mejor segmentación entre páginas.',
		Paginate: Yr,
		Parameters: Jr,
		...
		'Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Open WebUI. Your privacy is paramount: no message content is ever shared.':
			'¡Participa en las clasificaciones y evaluaciones de la comunidad! La sincronización agregada de estadísticas de uso ayuda a impulsar la investigación y las mejoras de Open-WebUI. Tu privacidad es primordial: nunca se comparte el contenido de los mensajes.',
		Password: Qr,
		...
		'Please carefully review the following warnings:':
			'Por favor revisar cuidadosamente los siguientes avisos:',
		'Please connect all required integrations before sending a message':
			'Por favor, conecta todas las integraciones necesarias antes de enviar un mensaje.',
		'Please do not close the settings page while loading the model.':
			'Por favor no cerrar la página de ajustes mientras se está descargando el modelo.',
		'Please enter a message or attach a file.':
			'Por favor, ingresa un mensaje o adjunta un archivo.',
		...
		'Please enter Client ID and Client Secret':
			'Por favor, ingresa el ID y la contraseña del Cliente',
		...
		'Please save the connection to persist the OAuth client information and do not change the ID':
			'Por favor, guarde la conexión para conservar la información del cliente OAuth y no cambie el ID',
		...
		'Please select at least one user for Direct Message channel.':
			'Por favor selecciona al menos un usuario para el canal de Mensajes Directos',
		'Please wait until all files are uploaded.':
			'Por favor, espera a que todos los archivos se acaben de subir',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'El prefijo ID se utiliza para evitar conflictos con otras conexiones al añadir un prefijo a los IDs de modelo, dejar vacío para deshabilitarlo',
		...
		'Private conversation between selected users':
			'Conversación privada entre l@s usuari@s seleccionados',
		...
		'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative.':
			'Reduce la probabilidad de generación sin sentido. Un valor más alto (p.ej. 100) dará respuestas más diversas, mientras que un valor más bajo (p.ej. 10) será más conservador.',
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Referir a ti mismo como "Usuario" (p.ej. "Usuario está aprendiendo Español")',
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Las notificaciones de respuesta no pueden activarse ya que los permisos del sitio web han sido denegados. Por favor, comprueba la configuración de tu navegador para otorgar el permiso necesario.',
		...
		'Runs embedding tasks concurrently to speed up processing. Turn off if rate limits become an issue.':
			'Ejecuta tareas de incrustración concurrentes para acelerar el procesado. Desactivar si se generan problemas (por limitaciones de los motores de incrustracción en uso)',
		Sa_day_of_week: Vn,
		Save: Kn,
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Ya no está soportado guardar registros de chat directamente en el almacenamiento del navegador. Por favor, dedica un momento a descargar y eliminar tus registros de chat pulsando en el botón de abajo. No te preocupes, puedes re-importar fácilmente tus registros desde las opciones de configuración',
		Schedule: Jn,
		...
		'Searxng search language (all, en, es, de, fr, etc.)':
			'Idioma de la busqueda Searxng (all, en, es, de, fr, etc.)',
		...
		'Select how to split message text for TTS requests':
			'Seleccionar como dividir los mensajes de texto para las peticiones TTS',
		...
		'Selected model(s) do not support image inputs':
			'Modelo(s) seleccionado(s) no admiten entradas de imagen',
		...
		'Set reranking model (e.g. {{model}})':
			'Establecer Modelo para Reclasificación (p.ej. {{model}})',
		'Set the default models that are automatically selected for all users when a new chat is created.':
			'Establer los modelos predeterminados que se seleccionan automáticamente para todos los usuarios cuando se crea un nuevo chat.',
		'Set the models that are automatically pinned to the sidebar for all users.':
			'Establecer los modelos que se fijarán automáticamente en la barra lateral para todos los usuarios.',
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			'Establece el número de capas, que deben cargarse en la GPU. Aumentar este valor puede mejorar significativamente el rendimiento de los modelos optimizados para aceleración en GPU, pero también puede consumir más energía y recursos de la GPU.',
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Establece un sesgo plano contra los tokens que han aparecido al menos una vez. Un valor más alto (p.ej. 1.5) penalizará las repeticiones más fuertemente, mientras que un valor más bajo (p.ej. 0.9) será más indulgente. En 0, está deshabilitado.',
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Establece un sesgo escalado contra los tokens para penalizar las repeticiones, basado en cuántas veces han aparecido. Un valor más alto (por ejemplo, 1.5) penalizará las repeticiones más fuertemente, mientras que un valor más bajo (por ejemplo, 0.9) será más indulgente. En 0, está deshabilitado.',
		'Sets how far back for the model to look back to prevent repetition.':
			'Establece cuántos tokens debe mirar atrás el modelo para prevenir la repetición. ',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			'Establece la semilla de números aleatorios a usar para la generación. Establecer esto en un número específico hará que el modelo genere el mismo texto para el mismo indicador(prompt).',
		'Sets the size of the context window used to generate the next token.':
			'Establece el tamaño de la ventana del contexto utilizada para generar el siguiente token.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			'Establece las secuencias de parada a usar. Cuando se encuentre este patrón, el LLM dejará de generar texto y retornará. Se pueden establecer varios patrones de parada especificando separadamente múltiples parámetros de parada en un archivo de modelo.',
		Setting: nt,
		Settings: tt,
		...
		'Show Admin Details in Account Pending Overlay':
			"Mostrar Detalles Admin en la sobrecapa de 'Cuenta Pendiente'",
		...
		'Showing all messages (user + assistant) per user.':
			'Mostrando todos los mensajes (usuario y asistente) del usuario.',
		...
		'Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.':
			'Mejora significativamente la precisión al usar un LLM para optimizar tablas, formularios, cálculos en línea y la detección de diseño. Aumentará la latencia. El valor predeterminado es Falso.',
		...
		'Skip the cache and re-run the inference. Defaults to False.':
			'Evitar caché y reiniciar la interfaz. Valor predeterminado Falso',
		...
		'Split documents by markdown headers before applying character/token splitting.':
			'Dividir los documentos por encabezados markdown antes de aplicar la división de caracteres/tokens.',
		...
		'Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.':
			'Descartar OCR existente del PDF y repetirlo. Se ignora si está habilitado Forzar OCR. Valor Predeterminado: Falso',
		...
		'Successfully imported {{userCount}} users.':
			'{{userCount}} usuarios importados correctamente.',
		...
		'Syncs only chats with updates after your last sync timestamp. Disable to re-sync all chats.':
			'Sincroniza solo los chats con actualizaciones posteriores a la última sincronización. Desactiva esta opción para volver a sincronizar todos los chats.',
		System: Et,
		...
		'Tail free sampling is used to reduce the impact of less probable tokens from the output. A higher value (e.g., 2.0) will reduce the impact more, while a value of 1.0 disables this setting.':
			'El Muestreo de cola libre(TFS_Z) es usado para reducir el impacto de los tokens menos probables en la salida. Un valor más alto (p.ej. 2.0) reduce más fuertemente el impacto, mientras que un valor de 1.0 deshabilita este ajuste.',
		...
		'The Application Account DN you bind with for search':
			'Cuenta DN de la aplicación vinculada para búsqueda',
		...
		'The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.':
			'El tamaño de lote determina cuántas solicitudes de texto se procesan juntas de una vez. Un tamaño de lote más alto puede aumentar el rendimiento y la velocidad del modelo, pero también requiere más memoria.',
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Quienes desarollaron este complemento son apasionados voluntarios/as de la comunidad. Si este complemento te es útil, por favor considera contribuir a su desarrollo.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'La tabla clasificatoria de evaluación se basa en el sistema de clasificación Elo y se actualiza en tiempo real.',
		'The format to return a response in. Format can be json or a JSON schema.':
			'El formato en que se devuelve la respuesta. Puede ser JSON o un esqueema JSON.',
		'The height in pixels to compress images to. Leave empty for no compression.':
			'El alto en pixeles al comprimir imágenes. Dejar vacío para no compresión',
		'The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.':
			'El idioma de la entrada de audio. Proporcionando la entrada de idioma en formato ISO-639-1 (e.g. es) mejora la precisión y la latencia. Lejar en blanco para la autodetección del idioma.',
		'The LDAP attribute that maps to the mail that users use to sign in.':
			'El atributo LDAP que mapea el correo que los usuarios utilizan para iniciar sesión.',
		'The LDAP attribute that maps to the username that users use to sign in.':
			'El atributo LDAP que mapea el nombre de usuario que los usuarios utilizan para iniciar sesión.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'La tabla clasificatoria está actualmente en beta, por lo que los cálculos de clasificación pueden reajustarse a medida que se refina el algoritmo.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'El tamaño máximo del archivo en MB. Si el tamaño del archivo supera este límite, el archivo no se subirá.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'El número máximo de archivos que se pueden utilizar a la vez en el chat. Si se supera este límite, los archivos no se subirán.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			"El formato de salida para el texto. Puede ser 'json', 'markdown' o 'html'. Valor predeterminado: 'markdown'",
		"The passwords you entered don't quite match. Please double-check and try again.":
			'Las contraseñas que ingresó no coinciden. Por favor, verifique y vuelva a intentarlo.',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'La puntuación debe ser un valor entre 0.0 (0%) y 1.0 (100%).',
		'The stream delta chunk size for the model. Increasing the chunk size will make the model respond with larger pieces of text at once.':
			'El tamaño del fragmentado incremental para el modelo. Aumentar el tamaño del fragmentado hará que el modelo responda con fragmentos de texto más grandes cada vez.',
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'La temperatura del modelo. Aumentar la temperatura hará que el modelo responda de forma más creativa.',
		'The Weight of BM25 Hybrid Search. 0 more semantic, 1 more lexical. Default 0.5':
			'La Ponderación de BM25 en la Búsqueda Híbrida. 0 más semántica, 1 más léxica. Por defecto, 0.5',
		'The width in pixels to compress images to. Leave empty for no compression.':
			'El ancho en pixeles al comprimir imágenes. Dejar vacío para no compresión',
		Theme: xt,
		...
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'Este canal fue creado el {{createdAt}}. Este es el comienzo del canal {{channelName}}.',
		"This chat won't appear in history and your messages will not be saved.":
			'Este chat no aparecerá en el historial y los mensajes no se guardarán.',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Esto garantiza que sus valiosas conversaciones se guardan de forma segura en tu base de datos del servidor trasero (backend). ¡Gracias!',
		'This feature is currently experimental and may not work as expected.':
			'Acualmente esta característica es experimental y puede no funcionar como se espera.',
		'This feature is experimental and may be modified or discontinued without notice.':
			'Esta característica es experimental y podría ser modificada o discontinuada sin previo aviso.',
		'This folder is empty': 'Esta carpeta está vacía',
		'This is a default user permission and will remain enabled.':
			'Este es un permiso predeterminado y se mantentrá activo ',
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Esta es una característica experimental, por lo que puede no funcionar como se esperaba y está sujeta a cambios en cualquier momento.',
		'This model is not publicly available. Please select another model.':
			'Este modelo no está disponible publicamente. Por favor, selecciona otro modelo.',
		'This option controls how long the model will stay loaded into memory following the request (default: 5m)':
			'Esta opción controla cuanto tiempo permanece cargado en memoria el modelo tras la petición (por defecto 5m).',
		'This option controls how many tokens are preserved when refreshing the context. For example, if set to 2, the last 2 tokens of the conversation context will be retained. Preserving context can help maintain the continuity of a conversation, but it may reduce the ability to respond to new topics.':
			'Esta opción controla cuántos tokens se conservan cuando se actualiza el contexto. Por ejemplo, si se establece en 2, se conservarán los primeros 2 tokens del contexto de la conversación. Conservar el contexto puede ayudar a mantener la continuidad de una conversación, pero puede reducir la habilidad para responder a nuevos temas.',
		'This option enables or disables the use of the reasoning feature in Ollama, which allows the model to think before generating a response. When enabled, the model can take a moment to process the conversation context and generate a more thoughtful response.':
			'Esta opción activa o desactiva el uso de la característica de razonamiento en Ollama, la cuál permite al modelo pensar antes de generar una respuesta. Cuando está activa el modelo se toma un tiempo para procesar el contexto de la conversación y generar una respuesta más razonada.',
		'This option sets the maximum number of tokens the model can generate in its response. Increasing this limit allows the model to provide longer answers, but it may also increase the likelihood of unhelpful or irrelevant content being generated.':
			'Esta opción establece el número máximo de tokens que el modelo puede generar en sus respuestas. Aumentar este límite permite al modelo proporcionar respuestas más largas, pero también puede aumentar la probabilidad de que se genere contenido inútil o irrelevante.',
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Esta opción eliminará todos los archivos existentes en la colección y los reemplazará con los nuevos archivos subidos.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Esto eliminará <strong>{{NAME}}</strong> y <strong>todo su contenido</strong>.',
		'This will delete all models including custom models':
			'Esto eliminará todos los modelos, incluidos los modelos personalizados',
		'This will delete all models including custom models and cannot be undone.':
			'Esto eliminará todos los modelos, incluidos los modelos personalizados y no se puede deshacer.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Esto reinicializará la base de conocimientos y sincronizará todos los archivos. ¿Desea continuar?',
		...
		'Thumbs up/down ratings from users on model responses':
			'Calificación (pulgares arriba/abajo) de los usuarios en las respuestas del modelo',
		Tika: kt,
		...
		'To access the available model names for downloading,':
			'Para acceder a los nombres de modelos disponibles para descargar,',
		'To access the GGUF models available for downloading,':
			'Para acceder a los modelos GGUF disponibles para descargar,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'Para acceder a WebUI, por favor contacte con Admins. Los administradores pueden gestionar los estados de los usuarios esde el panel de administración.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Para adjuntar la base de conocimientos aquí, primero añadirla a "Conocimiento" en el área de trabajo.',
		'To learn more about available endpoints, visit our documentation.':
			'Para aprender más sobre los endpoints disponibles, visite nuestra documentación.',
		'To select skills here, add them to the "Skills" workspace first.':
			'Para seleccionar habilidades aquí, primero añadelas a "Habilidades" en el áreas de trabajo.',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Para seleccionar herramientas aquí, primero añadelas a "Herramientas" en el área de trabajo.',
		...
		'Token counts are estimates and may not reflect actual API usage':
			'El recuento de tokens es estimado y puede diferir del uso real de la API',
		tokens: Gt,
		Tokens: _t,
		...
		'Tools are a function calling system with arbitrary code execution':
			'Las herramientas son un sistema de llamada de funciones con ejecución de código arbitrario',
		'Tools Function Calling Prompt': 'Indicador para la Función de Llamada a las Herramientas',
		'Tools have a function calling system that allows arbitrary code execution.':
			'Las herramientas tienen un sistema de llamada de funciones que permite la ejecución de código arbitrario.',
		...
		'Try adjusting your search or filter to find what you are looking for.':
			'Prueba ajustando tu búsqueda o filtro para encontrar lo que estás buscando',
		...
		'Type Hugging Face Resolve (Download) URL':
			'Escribir la URL de Hugging Face Resolve (Descarga)',
		...
		'Update for the latest features and improvements.':
			'Actualizar para las últimas características y mejoras.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Mejore a un plan con licencia para tener capacidades mejoradas, incluyendo personalización de marca e interfaz, y soporte dedicado.',
		Upload: ns,
		...
		'Upload Progress: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)':
			'Progreso de la Subida: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Utilizar '#' en el indicador para cargar e incluir tu conocimiento.",
		'Use /v1/chat/completions endpoint instead of /v1/audio/transcriptions for potentially better accuracy.':
			'Usar el endpoint /v1/chat/completions en vez de /v1/audio/transcriptions para una (posible) mayor precisión.',
		'Use Chat Completions API': 'Usar Chat Completions',
		'Use groups to organize your users and assign permissions.':
			'Usar grupos para organizar tus usuarios y asignar permisos',
		'Use LLM': 'Usar LLM',
		'Use no proxy to fetch page contents.': 'No usar proxy para extraer contenidos',
		'Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.':
			'Usar el proxy asignado en las variables del entorno http_proxy y/o https_proxy para extraer contenido',
		user: ls,
		User: ds,
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Usando el modelo de arena predeterminado con todos los modelos. Pulsar en el botón + para agregar modelos personalizados.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Versión {{selectedVersion}} de {{totalVersions}}',
		...
		'Voice Mode Custom Prompt': 'Indicador ersonalizado pala el Modo Voz',
		...
		'Warning: Enabling this will allow users to run scheduled prompts automatically.':
			'Aviso: Habilitar esto permitirá a los usuarios ejecutar automáticamente indicadores programados.',
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Aviso: Habilitar esto permitirá a los usuarios subir código arbitrario al servidor.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			'Aviso: La ejecución Jupyter habilita la ejecución de código arbitrario, planteando graves riesgos de seguridad; Proceder con extrema precaución.',
		We_day_of_week: As,
		Web: Is,
		'Web API': 'API Web',
		...
		'WebUI will make requests to "{{url}}/chat/completions"':
			'WebUI hará solicitudes a "{{url}}/chat/completions"',
		Week: Ps,
		Weekly: Es,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			'Cuando está habilitado, el modelo responderá a cada mensaje de chat en tiempo real, generando una respuesta tan pronto como se envíe un mensaje. Este modo es útil para aplicaciones de chat en vivo, pero puede afectar al rendimiento en equipos más lentos.',
		...
		'Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.':
			'Al paginar la salida. Cada página será separada por una línea horizontal y número de página. Por defecto: Falso',
		...
		'Works together with top-k. A higher value (e.g., 0.95) will lead to more diverse text, while a lower value (e.g., 0.5) will generate more focused and conservative text.':
			'Trabaja conjuntamente con top-k. Un valor más alto (p.ej. 0.95) dará lugar a un texto más diverso, mientras que un valor más bajo (p.ej. 0.5) generará un texto más centrado y conservador.',
		Workspace: Us,
		'Workspace Permissions': 'Permisos del Espacio de Trabajo',
		Write: Rs,
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Escribe un resumen en 50 palabras que resuma [tema o palabra clave].',
...
p. ej.: Eres Mario de Super Mario Bros y actúas como asistente.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'Actualmente estás utilizando una licencia de prueba. Por favor, para actualizar su licencia contacta con soporte.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Solo puedes chatear con un máximo de {{maxCount}} archivo(s) a la vez.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Puedes personalizar tus interacciones con los LLMs añadiendo memorias a través del botón 'Gestionar' debajo, haciendo que te sean más útiles y personalizados.",
		...
		'You do not have permission to edit this prompt.':
			'No tienes permiso para editar este indicador',
		'You do not have permission to edit this skill.':
			'No tienes permiso para editar esta habilidad',
		'You do not have permission to edit this tool':
			'No tienes permiso para editar esta herramienta',
		...
		'You do not have permission to send messages in this thread.':
			'No tienes permiso para enviar mensajes en este hilo',
		'You do not have permission to upload files to this knowledge base.':
			'No tienes permiso para subir archivos a esta base de conocimiento.',
		...
		'You do not have permission to upload web content.':
			'No tienes permiso para subir contenido web',
		...
		'Your browser does not support the audio tag.':
			'Tu navegador no soporta la etiqueta del audio.',
		'Your browser does not support the video tag.':
			'Tu navegador no soporta la etiqueta del video.',
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			'Tu entera contribución irá directamente al desarrollador del complemento; Open-WebUI no recibe ningún porcentaje. Sin embargo, la plataforma de financiación elegida podría tener sus propias tarifas.',
...
//# sourceMappingURL=BWysL8ea.js.map
