const e = 'О нама',
	...
	Fr = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 за бесконачно или позитивни број за одређено ограничење',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			'„s“, „m“, „h“, „d“, „w“ или „-1“ за без истека.',
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(нпр. `sh webui.sh --api --api-auth username_password`)',
		...
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Модел задатка се користи приликом извршавања задатака као што су генерисање наслова за ћаскања и упите за Веб претрагу',
		'a user': 'корисник',
		About: e,
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Покрените ову наредбу куцањем "/{{COMMAND}}" у ћаскање.',
		Active: r,
		...
		'Add a short description about what this model does':
			'Додавање кратког описа о томе шта овај модел ради',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Прилагођавање ових подешавања ће применити промене на све кориснике.',
		admin: c,
		Admin: d,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Админи имају приступ свим алатима у сваком тренутку, корисницима је потребно доделити алате по моделу у радном простору',
		Advanced: u,
		...
		'Are you sure you want to unarchive all archived chats?':
			'Да ли сигурно желите деархивирати све архиве?',
		...
		"Click on the user role button to change a user's role.":
			'Кликните на дугме за улогу корисника да промените улогу корисника.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		...
		'Discover, download, and explore custom functions':
			'Откријте, преузмите и истражите прилагођене функције',
		...
		'Discover, download, and explore custom tools':
			'Откријте, преузмите и истражите прилагођене алате',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'не отвара никакве спољне везе и ваши подаци остају сигурно на вашем локално хостованом серверу.',
		'Domain Filter List': '',
		"don't fetch random pipelines from sources you don't trust.":
			'Не преузимајте насумичне pipelines са извора којима не верујете.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"нпр. '30s', '10m'. Важеће временске јединице су 's', 'm', 'h'.",
		"e.g. 'low', 'medium', 'high'": '',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Уверите се да ваша CSV датотека укључује 4 колоне у овом редоследу: Име, Е-пошта, Лозинка, Улога.',
		'Enter {{role}} message here': 'Унесите {{role}} поруку овде',
		'Enter a detail about yourself for your LLMs to recall':
			'Унесите детаље за себе да ће LLMs преузимати',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Откривено лажно представљање отиска прста: Немогуће је користити иницијале као аватар. Прелазак на подразумевану профилну слику.',
		...
		'Include `--api` flag when running stable-diffusion-webui':
			'Укључи `--api` заставицу при покретању stable-diffusion-webui',
		...
		'LLMs can make mistakes. Verify important information.':
			'ВЈМ-ови (LLM-ови) могу правити грешке. Проверите важне податке.',
		Loader: Bo,
		'Loading Kokoro.js...': '',
		'Loading...': 'Учитавање...',
		local: Vo,
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Највише 3 модела могу бити преузета истовремено. Покушајте поново касније.',
		May: $o,
		MBR: en,
		MCP: tn,
		...
		'Memories accessible by LLMs will be shown here.':
			'Памћења које ће бити појављена од овог LLM-а ће бити приказана овде.',
		Memory: rn,
		...
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Поруке које пошаљете након стварања ваше везе неће бити подељене. Корисници са URL-ом ће моћи да виде дељено ћаскање.',
		'Microsoft OneDrive': '',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			'Модел „{{modelName}}“ је успешно преузет.',
		"Model '{{modelTag}}' is already in queue for downloading.":
			'Модел „{{modelTag}}“ је већ у реду за преузимање.',
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Откривена путања система датотека модела. За ажурирање је потребан кратак назив модела, не може се наставити.',
		'Model Filtering': '',
		'Model ID': 'ИД модела',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Напомена: ако подесите најмањи резултат, претрага ће вратити само документе са резултатом већим или једнаким најмањем резултату.',
		Notes: kn,
		...
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Само алфанумерички знакови и цртице су дозвољени у низу наредби.',
		...
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Упс! Изгледа да је адреса неважећа. Молимо вас да проверите и покушате поново.',
		...
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Упс! Користите неподржани метод (само фронтенд). Молимо вас да покренете WebUI са бекенда.',
		'Open file': '',
		'Open in full screen': '',
		'Open in new tab': '',
		'Open link': '',
		...
		'Permission denied when accessing microphone: {{error}}':
			'Приступ микрофону је одбијен: {{error}}',
		Permissions: ta,
		'Perplexity API Key': '',
		'Perplexity Model': '',
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines је систем прикључака са произвољним извршавањем кода —',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Чување ћаскања директно у складиште вашег прегледача више није подржано. Одвојите тренутак да преузмете и избришете ваша ћаскања кликом на дугме испод. Не брините, можете лако поново увезти ваша ћаскања у бекенд кроз',
		Schedule: ja,
		...
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Резултат треба да буде вредност између 0.0 (0%) и 1.0 (100%).',
		...
		'This action cannot be undone. Do you wish to continue?':
			'Ова радња се не може опозвати. Да ли желите наставити?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'',
		"This chat won't appear in history and your messages will not be saved.": '',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Ово осигурава да су ваши вредни разговори безбедно сачувани у вашој бекенд бази података. Хвала вам!',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Ово ће обрисати <strong>{{NAME}}</strong> и <strong>сав садржај унутар</strong>.',
		'This will delete all models including custom models':
			'Ово ће обрисати све моделе укључујући прилагођене моделе',
		'This will delete all models including custom models and cannot be undone.':
			'Ово ће обрисати све моделе укључујући прилагођене моделе и не може се опозвати.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Ово ће обрисати базу знања и ускладити све датотеке. Да ли желите наставити?',
		...
		'To access the available model names for downloading,':
			'Да бисте приступили доступним именима модела за преузимање,',
		'To access the GGUF models available for downloading,':
			'Да бисте приступили GGUF моделима доступним за преузимање,',
		...
		'Update for the latest features and improvements.':
			'Ажурирајте за најновије могућности и побољшања.',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Напишите сажетак у 50 речи који резимира [тему или кључну реч].',
...
npr.: Vi ste Mario iz Super Mario Bros i delujete kao asistent.`,
		...
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			'Можете учинити разговор са ВЈМ-овима приснијим додавањем сећања користећи „Управљај“ думе испод и тиме их учинити приснијим и кориснијим.',
...
//# sourceMappingURL=Be4rPFKX.js.map
