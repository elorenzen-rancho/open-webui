const e = 'Über',
	...
	xo = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 für kein Limit oder eine positive ganze Zahl für ein spezifisches Limit',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' oder '-1' für kein Ablaufdatum.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(z. B. `sh webui.sh --api --api-auth username_password`)',
		'(e.g. `sh webui.sh --api`)': '(z. B. `sh webui.sh --api`)',
		'(latest)': '(neueste)',
		'(leave blank for to use commercial endpoint)':
			'(leer lassen, um kommerziellen Endpunkt zu verwenden)',
		...
		'*Prompt node ID(s) are required for image generation':
			'*Prompt-Node-ID(s) sind für die Bildgenerierung erforderlich',
		'1 hour before': '',
		'1 Source': '1 Quelle',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A collaboration channel where people join as members':
			'Ein Kanal zur Zusammenarbeit, dem Mitglieder beitreten können',
		'A discussion channel where access is controlled by groups and permissions':
			'Ein Diskussionskanal, dessen Zugriff durch Gruppen und Berechtigungen gesteuert wird',
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Eine neue Version (v{{LATEST_VERSION}}) ist jetzt verfügbar.',
		'A private conversation between you and selected users':
			'Eine private Unterhaltung zwischen Ihnen und ausgewählten Benutzern',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Ein Aufgabenmodell wird für Tätigkeiten wie das Generieren von Chat-Titeln oder Websuchanfragen verwendet',
		'a user': 'ein Benutzer',
		About: e,
...
Zur Prompt-Variable springen`,
		...
		'Action Required for Chat Log Storage':
			'Handlung erforderlich: Speicherung des Chat-Protokolls',
		Actions: r,
		Activate: a,
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Aktivieren Sie diesen Befehl, indem Sie "/{{COMMAND}}" in die Chat-Eingabe tippen.',
		Active: o,
		...
		'Add a short description about what this model does':
			'Fügen Sie eine kurze Beschreibung der Funktion dieses Modells hinzu',
		...
		'Add your Open Terminal URL and API key in Settings → Integrations.':
			'Füge deine Open Terminal URL und API Key in den Einstellungen → Integrationen hinzu.',
		...
		'Adds filenames, titles, sections, and snippets into the BM25 text to improve lexical recall.':
			'Fügt Dateinamen, Titel, Abschnitte und Textausschnitte in den BM25-Text ein, um den lexikalischen Recall zu verbessern.',
		'Adjusting these settings will apply changes universally to all users.':
			'Das Anpassen dieser Einstellungen wendet Änderungen universell auf alle Benutzer an.',
		admin: d,
		Admin: u,
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Administratoren haben jederzeit Zugriff auf alle Werkzeuge; Benutzern müssen Werkzeuge pro Modell im Arbeitsbereich zugewiesen werden.',
		Advanced: c,
		'Advanced Parameters': 'Erweiterte Parameter',
		'Advanced parameters for MinerU parsing (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)':
			'Erweiterte Parameter für das MinerU-Parsing (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)',
		...
		'After updating or changing the embedding model, you must reindex the knowledge base for the changes to take effect. You can do this using the "Reindex" button below.':
			'Nach Aktualisierung oder Änderung des Embedding-Modells müssen Sie den Wissensspeicher neu indizieren, damit die Änderungen wirksam werden. Nutzen Sie dazu die Schaltfläche "Neu indizieren".',
		AI: h,
		All: g,
		...
		'API Base URL for Datalab Marker service. Defaults to: https://www.datalab.to/api/v1/marker':
			'API-Basis-URL für den Datalab Marker-Dienst. Standardwert: https://www.datalab.to/api/v1/marker',
		...
		'Are you sure you want to archive all chats? This action cannot be undone.':
			'Sind Sie sicher, dass Sie alle Chats archivieren wollen? Dieser Vorgang kann nicht rückgängig gemacht werden.',
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Sind Sie sicher, dass Sie alle Erinnerungen löschen möchten? Dieser Vorgang kann nicht rückgängig gemacht werden.',
		'Are you sure you want to delete "{{NAME}}"?':
			'Sind Sie sicher, dass Sie "{{NAME}}" löschen möchten?',
		'Are you sure you want to delete **{{modelName}}**?':
			'Sind Sie sicher, dass Sie **{{modelName}}** löschen möchten?',
		'Are you sure you want to delete all chats? This action cannot be undone.':
			'Sind Sie sicher, dass Sie alle Chats löschen wollen? Dieser Vorgang kann nicht rückgängig gemacht werden.',
		'Are you sure you want to delete this channel?':
			'Sind Sie sicher, dass Sie diesen Kanal löschen möchten?',
		'Are you sure you want to delete this connection? This action cannot be undone.':
			'Möchten Sie diese Verbindung wirklich löschen? Dieser Vorgang kann nicht rückgängig gemacht werden.',
		'Are you sure you want to delete this memory? This action cannot be undone.':
			'Möchten Sie diese Erinnerung wirklich löschen? Dieser Vorgang kann nicht rückgängig gemacht werden.',
		...
		"Are you sure you want to delete this version? Child versions will be relinked to this version's parent.":
			'Sind Sie sicher, dass Sie diese Version löschen wollen? Child-Versionen werden zu dem Parent dieser Version verlinkt.',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Sind Sie sicher, dass Sie alle archivierten Chats wiederherstellen möchten?',
		...
		'Automatically inject system tools in native function calling mode (e.g., timestamps, memory, chat history, notes, etc.)':
			'Automatische Injektion von System-Werkzeugen bei nativen Funktionsaufrufen (z. B. Zeitstempel, Erinnerungen, Chatverlauf, Notizen etc.)',
		Automation: L,
		...
		'Base Model List Cache speeds up access by fetching base models only at startup or on settings save—faster, but may not show recent base model changes.':
			'Der Cache für die Basismodell-Liste beschleunigt den Zugriff, indem Basismodelle nur beim Start oder Speichern abgerufen werden – schneller, zeigt aber evtl. keine aktuellen Änderungen an.',
		Bearer: O,
		before: W,
		'Being lazy': 'Faulheit',
		Beta: K,
		...
		'Boosting or penalizing specific tokens for constrained responses. Bias values will be clamped between -100 and 100 (inclusive). (Default: none)':
			'Bevorzugung oder Benachteiligung spezifischer Token für die Antwortsteuerung. Bias-Werte werden zwischen -100 und 100 (inklusive) begrenzt. (Standard: keine)',
		Brave: H,
		'Brave Search API Key': 'Brave Search API-Schlüssel',
		'Break down complex requests into trackable steps':
			'Zerlege komplexe Anfragen in einfache, nachverfolgbare Schritte',
		...
		'Call feature is not supported when using Web STT engine':
			'Die Anruffunktion wird bei Verwendung der Web-STT-Engine nicht unterstützt.',
		Camera: j,
		Cancel: q,
		...
		'Character limit for autocomplete generation input':
			'Zeichenlimit für Eingabe der Autovervollständigung',
		...
		'Chunks smaller than this threshold will be merged with neighboring chunks when possible. Set to 0 to disable merging.':
			'Chunks unterhalb dieser Grenze werden, sofern möglich, mit angrenzenden Chunks verschmolzen. Zum Deaktivieren den Wert 0 wählen.',
		Ciphers: ae,
		Citation: oe,
		Citations: se,
		...
		'Click here to download user import template file.':
			'Klicken Sie hier, um die Vorlage für den Benutzerimport herunterzuladen.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Klicken Sie hier, um mehr über faster-whisper zu erfahren und verfügbare Modelle zu sehen.',
		...
		'Click here to upload a workflow.json file.':
			'Klicken Sie hier, um eine workflow.json hochzuladen.',
		'click here.': 'hier klicken.',
		"Click on the user role button to change a user's role.":
			'Klicken Sie auf die Benutzerrolle, um sie zu ändern.',
		'Click to connect': 'Klicke zum Verbinden',
		'Click to copy ID': 'Klicke um ID zu kopieren',
		'Client ID': 'Client ID',
		'Client Secret': 'Client Secret',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Schreibzugriff auf Zwischenablage verweigert. Bitte prüfen Sie Ihre Browsereinstellungen.',
		Clone: le,
		...
		'Collaboration channel where people join as members':
			'Kollaborationskanal, dem Benutzer beitreten können',
		Collapse: ce,
		Collection: he,
		Collections: ge,
		Color: me,
		...
		'Connect to Open Terminal instances to browse files and use them as always-on tools. Only one can be active at a time.':
			'Verbinde zu Open Terminal Instanzen um Dateien zu lesen und sie als immer verfügbare Werkzeuge zu nutzen. Nur eines kaann gleichzeitig aktiv sein.',
		'Connect to Open Terminal instances. All users will have access to file browsing and terminal tools through these servers.':
			'Verbinde zu Open Terminal Instanzen. AAlle Nutzer werden Zugriff auf die Dateien und Terminal Werkzeige durch diese Server bekommen.',
		'Connect to your own OpenAI compatible API endpoints.':
			'Verbinden Sie Ihre eigenen OpenAI-kompatiblen API-Endpunkte.',
		'Connect to your own OpenAPI compatible external tool servers.':
			'Verbinden Sie Ihre eigenen OpenAPI-kompatiblen externen Tool-Server.',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			"Beschränkt den Aufwand für Reasoning-Modelle. Nur anwendbar auf Modelle bestimmter Anbieter, die 'Reasoning Effort' unterstützen.",
		'Contact Admin for WebUI Access': 'Kontaktieren Sie den Administrator für WebUI-Zugriff',
		Content: Ie,
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Steuert, wie Nachrichtentext für TTS-Anfragen geteilt wird. 'Punctuation' teilt nach Sätzen, 'paragraphs' nach Absätzen und 'none' behält die Nachricht als Ganzes.",
		'Control the repetition of token sequences in the generated text. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 1.1) will be more lenient. At 1, it is disabled.':
			'Steuert die Wiederholung von Token-Sequenzen im generierten Text. Ein höherer Wert (z. B. 1.5) bestraft Wiederholungen stärker, während ein niedrigerer Wert (z. B. 1.1) toleranter ist. Bei 1 ist die Funktion deaktiviert.',
		Controls: Pe,
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			'Steuert das Gleichgewicht zwischen Kohärenz und Vielfalt der Ausgabe. Ein niedrigerer Wert führt zu fokussierterem und kohärenterem Text.',
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'CORS muss vom Anbieter korrekt konfiguriert sein, um Anfragen von Open WebUI zuzulassen.',
		...
		'Create scheduled prompts that run automatically on a recurring basis.':
			'Erstelle geplante Prompts, die automatisch in regelmäßigen Abständen ausgeführt werden.',
		'Create your first note by clicking on the plus button below.':
			'Erstellen Sie Ihre erste Notiz durch Klick auf das Plus-Symbol unten.',
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			'Der Standardmodus funktioniert mit mehr Modellen, indem Werkzeuge vor der Ausführung aufgerufen werden. Der native Modus nutzt die integrierte Tool-Calling-Fähigkeit des Modells, setzt diese aber voraus.',
		...
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			'Standardmäßig segmentierter Abruf für fokussierte Inhaltsextraktion (empfohlen).',
		...
		'Deployment names are required for Azure OpenAI':
			'Deployment-Namen sind für Azure OpenAI erforderlich',
		Desc: Ve,
		...
		'Describe your knowledge base and objectives':
			'Beschreiben Sie Ihren Wissensspeicher und Ziele',
		Description: Ge,
		Deselect: _e,
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'Direktverbindungen erlauben Benutzern die Verbindung zu eigenen OpenAI-kompatiblen API-Endpunkten.',
		...
		'Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.':
			"Deaktiviert Bildextraktion aus PDFs. Wenn 'LLM verwenden' aktiv ist, werden Bilder automatisch beschriftet. Standard: False.",
		Disabled: Je,
		'Disconnect OAuth': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			'Entdecken Sie Open WebUI und finden Sie Unterstützung in der Community.',
		'Discover wonders': 'Wunder entdecken',
		'Discover, download, and explore custom functions':
			'Benutzerdefinierte Funktionen entdecken und herunterladen',
		'Discover, download, and explore custom prompts':
			'Benutzerdefinierte Prompts entdecken und herunterladen',
		'Discover, download, and explore custom tools':
			'Benutzerdefinierte Werkzeuge entdecken und herunterladen',
		...
		'Discussion channel where access is based on groups and permissions':
			'Diskussionskanal mit gruppenbasiertem Zugriff',
		Display: Ye,
		...
		'Displays status updates (e.g., web search progress) in the response':
			'Zeigt Status-Updates (z. B. Websuche) in der Antwort an',
		'Dive into knowledge': 'In Wissen eintauchen',
		'Do not install functions from sources you do not fully trust.':
			'Installieren Sie keine Funktionen aus nicht vertrauenswürdigen Quellen.',
		'Do not install tools from sources you do not fully trust.':
			'Installieren Sie keine Werkzeuge aus nicht vertrauenswürdigen Quellen.',
		'Do you want to sync your usage stats with Open WebUI Community?':
			'Möchten Sie Ihre Nutzungsstatistiken mit der Open WebUI Community synchronisieren?',
		Docling: je,
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'stellt keine externen Verbindungen her; Ihre Daten bleiben sicher auf Ihrem lokalen Server.',
		'Domain Filter List': 'Domain-Filterliste',
		"don't fetch random pipelines from sources you don't trust.":
			'Laden Sie keine Pipelines aus Quellen, denen Sie nicht vertrauen.',
		"Don't have an account?": 'Noch kein Konto?',
		"don't install random functions from sources you don't trust.":
			'Installieren Sie keine Funktionen aus Quellen, denen Sie nicht vertrauen.',
		"don't install random tools from sources you don't trust.":
			'Installieren Sie keine Werkzeuge aus Quellen, denen Sie nicht vertrauen.',
		...
		'e.g. A filter to remove profanity from text':
			'z. B. Ein Filter zum Entfernen von Schimpfwörtern',
		...
		'e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)':
			'z. B. audio/wav,audio/mpeg,video/* (leer für Standard)',
		'e.g., en-US,ja-JP (leave blank for auto-detect)':
			'z. B. de-DE,en-US (leer für Auto-Erkennung)',
		...
		'Enable autocomplete generation for chat messages':
			'Autovervollständigung für Chat-Nachrichten aktivieren',
		...
		"Enable Memory Locking (mlock) to prevent model data from being swapped out of RAM. This option locks the model's working set of pages into RAM, ensuring that they will not be swapped out to disk. This can help maintain performance by avoiding page faults and ensuring fast data access.":
			'Aktiviert Memory Locking (mlock), um das Auslagern von Modelldaten aus dem RAM zu verhindern. Dies sperrt den Arbeitsspeicherbereich des Modells und sichert schnellen Datenzugriff sowie konstante Leistung.',
		'Enable Memory Mapping (mmap) to load model data. This option allows the system to use disk storage as an extension of RAM by treating disk files as if they were in RAM. This can improve model performance by allowing for faster data access. However, it may not work correctly with all systems and can consume a significant amount of disk space.':
			'Aktiviert Memory Mapping (mmap) zum Laden von Modelldaten. Dies nutzt Festplattenspeicher als RAM-Erweiterung, was die Leistung durch schnelleren Datenzugriff verbessern kann, jedoch viel Speicherplatz benötigt und systemabhängig ist.',
		'Enable Message Queue': 'Nachrichten Queue aktivieren',
		'Enable Message Rating': 'Nachrichtenbewertung aktivieren',
		'Enable Mirostat sampling for controlling perplexity.':
			'Mirostat-Sampling zur Perplexitätskontrolle aktivieren.',
		...
		'Enable, disable, or customize the reasoning tags used by the model. "Enabled" uses default tags, "Disabled" turns off reasoning tags, and "Custom" lets you specify your own start and end tags.':
			'Aktivieren, deaktivieren oder passen Sie Reasoning-Tags an. "Aktiviert" nutzt Standard-Tags, "Deaktiviert" schaltet sie aus, "Benutzerdefiniert" erlaubt eigene Start/End-Tags.',
		Enabled: gn,
		'End Tag': 'End-Tag',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Die CSV-Datei muss 4 Spalten in dieser Reihenfolge enthalten: Name, E-Mail, Passwort, Rolle.',
		'Enter {{role}} message here': '{{role}}-Nachricht hier eingeben',
		'Enter a detail about yourself for your LLMs to recall':
			'Geben Sie ein Detail über sich an, an das sich LLMs erinnern sollen',
		'Enter a title for the pending user info overlay. Leave empty for default.':
			"Titel für das Overlay 'Ausstehende Aktivierung'. Leer lassen für Standard.",
		'Enter a watermark for the response. Leave empty for none.':
			'Wasserzeichen für die Antwort. Leer lassen für keines.',
		'Enter additional headers in JSON format': 'Zusätzliche Header im JSON-Format eingeben',
		'Enter additional headers in JSON format (e.g. {"X-Custom-Header": "value"}':
			'Zusätzliche Header im JSON-Format eingeben (z. B. {"X-Custom-Header": "value"})',
		...
		'Enter api auth string (e.g. username:password)':
			'API-Auth-String eingeben (z. B. username:password)',
		...
		'Enter comma-separated "token:bias_value" pairs (example: 5432:100, 413:-100)':
			'Kommagetrennte "token:bias_value"-Paare eingeben (Bsp: 5432:100, 413:-100)',
		'Enter content for the pending user info overlay. Leave empty for default.':
			"Inhalt für das Overlay 'Ausstehende Aktivierung'. Leer lassen für Standard.",
		...
		'Enter domains separated by commas (e.g., example.com,site.org,!excludedsite.com)':
			'Domains kommagetrennt eingeben (z. B. example.com,!blockiert.com)',
		...
		'Enter function name filter list (e.g. func1, !func2)':
			'Funktionsnamen-Filterliste eingeben (z. B. func1, !func2)',
		...
		'Enter JSON config (e.g., {"disable_links": true})':
			'JSON-Konfig eingeben (z. B. {"disable_links": true})',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Proxy-URL eingeben (z. B. https://user:password@host:port)',
		...
		'Enter the prompt instructions for this automation...':
			'Gib die Prompt-Anweisungen für diese Automatisierung ein...',
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'Öffentliche URL Ihrer WebUI eingeben. Diese wird für Links in Benachrichtigungen verwendet.',
		...
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			'Yacy-URL eingeben (z. B. http://yacy.example.com:8090)',
		...
		"Error: A model with the ID '{{modelId}}' already exists. Please select a different ID to proceed.":
			"Fehler: Ein Modell mit der ID '{{modelId}}' existiert bereits. Bitte wählen Sie eine andere ID.",
		'Error: Model ID cannot be empty. Please enter a valid ID to proceed.':
			'Fehler: Die Modell-ID darf nicht leer sein. Bitte geben Sie eine gültige ID ein.',
		Evaluations: bn,
		'Event created': '',
		'Event deleted': '',
		'Event title': '',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Bsp: (&(objectClass=inetOrgPerson)(uid=%s))',
		'Example: ALL': 'Bsp: ALL',
		'Example: mail': 'Bsp: mail',
		'Example: ou=users,dc=foo,dc=example': 'Bsp: ou=users,dc=foo,dc=example',
		'Example: sAMAccountName or uid or userPrincipalName':
			'Bsp: sAMAccountName oder uid oder userPrincipalName',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			'Die Benutzeranzahl Ihrer Lizenz wurde überschritten. Bitte kontaktieren Sie den Support für eine Erweiterung.',
		Exclude: Sn,
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'Verbindung zum OpenAPI-Toolserver {{URL}} fehlgeschlagen',
		'Failed to connect to {{URL}} terminal server':
			'Fehler beim Verbinden zum Terminal Server {{URL}}',
		...
		'Failed to extract content from the file: {{error}}':
			'Inhaltsextraktion fehlgeschlagen: {{error}}',
		...
		'Failed to load DOCX file. Please try downloading it instead.':
			'DOCX Datei konnte nicht geladen werden. Versuche die Datei stattdessen herunterzuladen.',
		'Failed to load Excel/CSV file. Please try downloading it instead.':
			'Excel/CSV-Datei konnte nicht geladen werden. Bitte versuchen Sie stattdessen, sie herunterzuladen.',
		...
		'Failed to load PPTX file. Please try downloading it instead.':
			'PPTX Datei konnte nicht geladen werden. Versuche die Datei stattdessen herunterzuladen.',
		...
		'File size should not exceed {{maxSize}} MB.':
			'Dateigröße darf {{maxSize}} MB nicht überschreiten.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Fingerabdruck-Spoofing erkannt: Initialen können nicht verwendet werden. Nutze Standard-Profilbild.',
		...
		'Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.':
			'Erzwingt OCR auf allen PDF-Seiten. Kann Ergebnisse verschlechtern, wenn bereits guter Text vorhanden ist. Standard: False.',
		...
		'Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.':
			'Formatiert Zeilen in der Ausgabe (z. B. Mathe, Stile). Standard: False.',
		...
		'Forwards system user OAuth access token to authenticate':
			'Leitet OAuth-Zugriffstoken des Systembenutzers zur Authentifizierung weiter',
		'Forwards system user session credentials to authenticate':
			'Leitet Sitzungsdaten des Systembenutzers zur Authentifizierung weiter',
		Fr_day_of_week: On,
		...
		'Functions allow arbitrary code execution.':
			'Funktionen erlauben die Ausführung beliebigen Codes.',
		...
		'Get current time and perform date/time calculations':
			'Aktuelle Uhrzeit abrufen und Datums-/Zeitberechnungen durchführen',
		...
		'Help the community discover great models':
			'Hilf der Community dabei großartige Modelle zu entdecken',
		'Hex Color': 'Hex-Farbe',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Ich bestätige, dass ich die Auswirkungen meiner Handlung verstanden habe. Ich bin mir der Risiken bei der Ausführung von beliebigem Code bewusst und habe die Vertrauenswürdigkeit der Quelle überprüft.',
		ID: ht,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Fügen Sie beim Ausführen von stable-diffusion-webui das Flag `--api-auth` hinzu',
		'Include `--api` flag when running stable-diffusion-webui':
			'Fügen Sie beim Ausführen von stable-diffusion-webui das Flag `--api` hinzu',
		'Includes SharePoint': 'Enthält SharePoint',
		'Increase UI Scale': 'UI-Skalierung erhöhen',
		'Influences how quickly the algorithm responds to feedback from the generated text. A lower learning rate will result in slower adjustments, while a higher learning rate will make the algorithm more responsive.':
			'Beeinflusst, wie schnell der Algorithmus auf Feedback aus dem generierten Text reagiert. Eine niedrigere Lernrate führt zu langsameren Anpassungen, während eine höhere Lernrate den Algorithmus reaktionsschneller macht.',
		Info: St,
		Initials: kt,
		'Inject file content into conversation context':
			'Injiziere den Datei-Kontext in den Konversations-Kontext',
		'Inject the entire content as context for comprehensive processing, this is recommended for complex queries.':
			'Gesamten Inhalt als Kontext für umfassende Verarbeitung einfügen; dies wird für komplexe Abfragen empfohlen.',
		Input: wt,
		...
		'Invalid JSON format for ComfyUI Edit Workflow.':
			'Ungültiges JSON-Format für ComfyUI-Bearbeitungsworkflow.',
		...
		'Invalid JSON format in Additional Config':
			'Ungültiges JSON-Format in der zusätzlichen Konfiguration',
		...
		'Leave a public review for {{modelName}}':
			'Hinterlasse eine öffentliche Bewertung für {{modelName}}',
		...
		'Leave empty to include all models from "{{url}}" endpoint':
			'Leer lassen, um alle Modelle vom Endpunkt "{{url}}" einzuschließen',
		'Leave empty to include all models from "{{url}}/api/tags" endpoint':
			'Leer lassen, um alle Modelle vom Endpunkt "{{url}}/api/tags" einzuschließen',
		'Leave empty to include all models from "{{url}}/models" endpoint':
			'Leer lassen, um alle Modelle vom Endpunkt "{{url}}/models" einzuschließen',
		'Leave empty to include all models or select specific models':
			'Leer lassen, um alle Modelle einzuschließen oder spezifische Modelle auszuwählen',
		...
		'Leave empty to use the default config, or enter a valid json (see https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)':
			'Leer lassen, um die Standardkonfiguration zu verwenden, oder gültiges JSON eingeben (siehe https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest).',
		'Leave empty to use the default model (voxtral-mini-latest).':
			'Leer lassen, um das Standardmodell zu nutzen (voxtral-mini-latest).',
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Leer lassen, um den Standard-Prompt zu verwenden, oder geben Sie einen eigenen Prompt ein',
		'Leave model field empty to use the default model.':
			'Leer lassen, um das Standardmodell zu verwenden.',
		Legacy: Rt,
		lexical: xt,
		License: Ft,
		...
		'Limit concurrent search queries. 0 = unlimited (default). Set to 1 for sequential execution (recommended for APIs with strict rate limits like Brave free tier).':
			'Gleichzeitige Suchanfragen begrenzen. 0 = unbegrenzt (Standard). Auf 1 setzen für sequentielle Ausführung (empfohlen für APIs mit strengen Ratenbegrenzungen wie dem kostenlosen Brave-Tarif).',
		'Limits the number of concurrent embedding requests. Set to 0 for unlimited.':
			'Limitiert die Anzahl gleichzeitiger embedding Anfragen. Auf 0 setzen für unlimitiert.',
		List: Wt,
		...
		'LLMs can make mistakes. Verify important information.':
			'KI-Modelle können Fehler machen. Überprüfen Sie wichtige Informationen.',
		Loader: Vt,
		...
		Low: Jt,
		LTR: Yt,
		'Made by Open WebUI Community': 'Von der Open WebUI Community',
		'Make password visible in the user interface':
			'Passwort in der Benutzeroberfläche sichtbar machen',
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Stellen Sie sicher, dass Sie eine workflow.json-Datei im API-Format aus ComfyUI exportieren.',
		Male: jt,
		Manage: qt,
		...
		'Maximum characters to return from fetched URLs. Leave empty for no limit.':
			'Maximale Zeichenanzahl für Fetch URL-Inhalte. Leer lassen für unbegrenzt.',
		'Maximum number of files allowed per folder.':
			'Maximale Anzahl der pro Ordner erlaubten Dateien.',
		'Maximum number of files per folder is {{max}}.':
			'Die maximale Anzahl der Dateien pro Ordner ist {{max}}.',
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Es können maximal 3 Modelle gleichzeitig heruntergeladen werden. Bitte versuchen Sie es später erneut.',
		May: $t,
		MBR: ei,
		MCP: ni,
		'MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Open WebUI team, making it the more reliable option for compatibility.':
			'Die MCP-Unterstützung ist experimentell und ihre Spezifikation ändert sich häufig, was zu Inkompatibilitäten führen kann. Die Unterstützung der OpenAPI-Spezifikation wird direkt vom Open WebUI-Team gepflegt und ist daher die verlässlichere Option.',
		Medium: ti,
		...
		'Memories accessible by LLMs will be shown here.':
			'Erinnerungen, auf die LLMs zugreifen können, werden hier angezeigt.',
		Memory: oi,
		...
		'Message counts are based on assistant responses.':
			'Die Nachrichtenanzahl basiert auf den Antworten des Assistenten.',
		'Message rating should be enabled to use this feature':
			'Nachrichtenbewertung muss aktiviert sein, um diese Funktion zu nutzen',
		messages: li,
		Messages: di,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Nachrichten, die Sie nach dem Erstellen des Links senden, werden nicht geteilt. Benutzer mit der URL können nur den bis dahin geteilten Chat sehen.',
		...
		'MinerU API Key required for Cloud API mode.':
			'MinerU-API-Schlüssel für den Cloud-API-Modus erforderlich.',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Modell '{{modelName}}' wurde erfolgreich heruntergeladen.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Modell '{{modelTag}}' befindet sich bereits in der Warteschlange.",
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': 'Modell {{modelName}} erfolgreich gelöscht',
		'Model {{modelName}} is not vision capable':
			'Das Modell {{modelName}} unterstützt keine Bilderkennung',
		...
		'Model can execute code and perform calculations':
			'Modell kann Code ausführen und Berechnungen durchführen',
		'Model can generate images based on text prompts':
			'Modell kann Bilder basierend auf Text-Prompts generieren',
		'Model can search the web for information':
			'Modell kann das Web nach Informationen durchsuchen',
		'Model Capabilities': 'Modell Fähigkeiten',
		'Model created successfully!': 'Modell erfolgreich erstellt!',
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Modell-Dateisystempfad erkannt. Modellkurzname ist für das Update erforderlich; Vorgang kann nicht fortgesetzt werden.',
		...
		'Model name already exists, please choose a different one':
			'Modellname existiert bereits, bitte wählen Sie einen anderen',
		...
		'Name and ID are required, please fill them out':
			'Name und ID sind erforderlich, bitte füllen Sie diese aus',
		...
		'No expiration can pose security risks.':
			'Ein fehlendes Ablaufdatum kann Sicherheitsrisiken bergen.',
		...
		'No files yet. Upload files or run Python code to create them.':
			'Noch keine Dateien. Lad Dateien hoch oder lass Python code laufen um welche zu erstellen.',
		...
		'No HTML, CSS, or JavaScript content found.':
			'Keine HTML-, CSS- oder JavaScript-Inhalte gefunden.',
		'No inference engine with management support found':
			'Keine Inferenz-Engine mit Verwaltungsunterstützung gefunden',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Hinweis: Wenn Sie eine Mindestpunktzahl festlegen, liefert die Suche nur Dokumente zurück, deren Punktzahl größer oder gleich diesem Wert ist.',
		Notes: Ci,
		...
		'Only active when "Paste Large Text as File" setting is toggled on.':
			'Nur aktiv, wenn die Einstellung „Großen Text als Datei einfügen“ aktiviert ist.',
		'Only active when the chat input is in focus and an LLM is generating a response.':
			'Nur aktiv, wenn das Chat-Eingabefeld fokussiert ist und ein LLM eine Antwort generiert.',
		'Only active when the chat input is in focus.':
			'Nur aktiv, wenn das Chat-Eingabefeld fokussiert ist.',
		'Only alphanumeric characters and hyphens are allowed':
			'Nur alphanumerische Zeichen und Bindestriche sind erlaubt',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'In der Befehlszeichenfolge sind nur alphanumerische Zeichen und Bindestriche erlaubt.',
		'Only can be triggered when the chat input is in focus.':
			'Kann nur ausgelöst werden, wenn das Chat-Eingabefeld fokussiert ist.',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Nur Sammlungen können bearbeitet werden. Erstellen Sie einen neuen Wissensspeicher, um Dokumente zu bearbeiten oder hinzuzufügen.',
		...
		'Only select users and groups with permission can access':
			'Nur ausgewählte Benutzer und Gruppen mit Berechtigung haben Zugriff',
		'Only sync new/updated chats': 'Nur neue/aktualisierte Chats synchronisieren',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Ups! Die URL scheint ungültig zu sein. Bitte überprüfen Sie diese und versuchen Sie es erneut.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Ups! Es werden noch Dateien hochgeladen. Bitte warten Sie, bis der Upload abgeschlossen ist.',
		'Oops! There was an error in the previous response.':
			'Ups! Es gab einen Fehler in der vorherigen Antwort.',
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			'Open WebUI kann Werkzeuge verwenden, die von jedem OpenAPI-Server bereitgestellt werden.',
		...
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open WebUI verwendet SpeechT5 und CMU Arctic Speaker-Embeddings.',
		'Open WebUI version': 'Open WebUI Version',
		'Open WebUI version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})':
			'Die installierte Open-WebUI-Version (v{{OPEN_WEBUI_VERSION}}) ist niedriger als die erforderliche Version (v{{REQUIRED_VERSION}})',
		OpenAI: xi,
		...
		'Page mode creates one document per page. Single mode combines all pages into one document for better chunking across page boundaries.':
			'Der Seitenmodus erstellt ein Dokument pro Seite. Der Einzelmodus fasst alle Seiten zu einem Dokument zusammen, um besser über Seitenumbrüche hinweg zu chunking/segmentieren.',
		Paginate: Yi,
		Parameters: ji,
		...
		'Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Open WebUI. Your privacy is paramount: no message content is ever shared.':
			'Nehmen Sie an Community-Bestenlisten und Evaluationen teil! Das Synchronisieren aggregierter Nutzungsstatistiken hilft dabei, die Forschung und Verbesserungen von Open WebUI voranzutreiben. Ihre Privatsphäre steht an erster Stelle: Es werden niemals Nachrichteninhalte geteilt.',
		Password: qi,
		...
		'Permission denied when accessing microphone: {{error}}':
			'Zugriff auf Mikrofon verweigert: {{error}}',
		Permissions: er,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines sind ein Plugin-System mit beliebiger Codeausführung —',
		...
		'Please carefully review the following warnings:':
			'Bitte lesen Sie die folgenden Warnungen sorgfältig durch:',
		'Please connect all required integrations before sending a message':
			'Bitte verbinde alle erforderlichen Integrationen, bevor du eine Nachricht sendest',
		'Please do not close the settings page while loading the model.':
			'Bitte schließen Sie die Einstellungsseite nicht, während das Modell lädt.',
		'Please enter a message or attach a file.':
			'Bitte geben Sie eine Nachricht ein oder hängen Sie eine Datei an.',
		...
		'Please save the connection to persist the OAuth client information and do not change the ID':
			'Bitte speichern Sie die Verbindung, um die OAuth-Client-Informationen zu sichern, und ändern Sie die ID nicht.',
		...
		'Please select at least one user for Direct Message channel.':
			'Bitte wählen Sie mindestens einen Benutzer für den Direktnachrichten-Kanal aus.',
		'Please wait until all files are uploaded.':
			'Bitte warten Sie, bis alle Dateien hochgeladen sind.',
		'Policy ID': 'Policy-ID',
		Port: lr,
		Ports: dr,
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'Die Präfix-ID wird verwendet, um Konflikte mit anderen Verbindungen zu vermeiden, indem ein Präfix zu den Modell-IDs hinzugefügt wird - zum Deaktivieren leer lassen.',
		...
		'Private conversation between selected users':
			'Private Unterhaltung zwischen ausgewählten Benutzern',
		...
		'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative.':
			'Verringert die Wahrscheinlichkeit von unsinnigen Ausgaben. Ein höherer Wert (z. B. 100) führt zu vielfältigeren Antworten, während ein niedrigerer Wert (z. B. 10) konservativer ist.',
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Beziehen Sie sich auf sich selbst als "User" (z. B. "User lernt Spanisch")',
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Antwortbenachrichtigungen können nicht aktiviert werden, da die Website-Berechtigungen verweigert wurden. Bitte erteilen Sie in Ihren Browser-Einstellungen den erforderlichen Zugriff.',
		...
		'Runs embedding tasks concurrently to speed up processing. Turn off if rate limits become an issue.':
			'Führt Embedding-Aufgaben parallel aus, um die Verarbeitung zu beschleunigen. Deaktivieren Sie dies, falls Rate-Limits oder Ressourcenprobleme auftreten.',
		Sa_day_of_week: Hr,
		Save: Zr,
		...
		'Searxng search language (all, en, es, de, fr, etc.)':
			'SearxNG-Suchsprache (all, en, es, de, fr, etc.)',
		...
		'Select a base model (e.g. llama3, gpt-4o)':
			'Wählen Sie ein Basismodell (z. B. llama3, gpt-4o)',
		...
		'Select how to split message text for TTS requests':
			'Wählen Sie, wie der Nachrichtentext für TTS-Anfragen aufgeteilt werden soll',
		...
		'Selected model(s) do not support image inputs':
			'Die ausgewählten Modelle unterstützen keine Bildeingaben',
		...
		'Set the default models that are automatically selected for all users when a new chat is created.':
			'Wähle Standardmodelle die automatisch für alle Nutzer bei neuen Chats vorausgewählt sind.',
		'Set the models that are automatically pinned to the sidebar for all users.':
			'Wähle die Modelle die automatisch für alle Nutzer an die Seitenleiste angepinnt sind.',
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			'Legen Sie die Anzahl der Schichten fest, die auf die GPU ausgelagert werden. Eine Erhöhung dieses Wertes kann die Leistung für GPU-optimierte Modelle erheblich verbessern, verbraucht aber möglicherweise mehr Strom und GPU-Ressourcen.',
		'Set the number of worker threads used for computation. This option controls how many threads are used to process incoming requests concurrently. Increasing this value can improve performance under high concurrency workloads but may also consume more CPU resources.':
			'Legt die Anzahl der Worker-Threads für Berechnungen fest. Diese Option steuert, wie viele Threads gleichzeitig für eingehende Anfragen verwendet werden. Ein höherer Wert kann die Leistung bei hoher Last verbessern, verbraucht aber mehr CPU-Ressourcen.',
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Legt einen festen Bias gegen Token fest, die mindestens einmal erschienen sind. Ein höherer Wert (z. B. 1.5) bestraft Wiederholungen stärker, während ein niedrigerer Wert (z. B. 0.9) toleranter ist. Bei 0 ist die Funktion deaktiviert.',
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Legt einen skalierenden Bias gegen Token fest, um Wiederholungen basierend auf ihrer Häufigkeit zu bestrafen. Ein höherer Wert (z. B. 1.5) bestraft Wiederholungen stärker, während ein niedrigerer Wert (z. B. 0.9) toleranter ist. Bei 0 ist die Funktion deaktiviert.',
		'Sets how far back for the model to look back to prevent repetition.':
			'Legt fest, wie weit das Modell zurückblickt, um Wiederholungen zu verhindern.',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			'Legt den Startwert (Seed) für die Zufallszahlengenerierung fest. Mit einem festen Wert erzeugt das Modell für denselben Prompt immer denselben Text.',
		'Sets the size of the context window used to generate the next token.':
			'Legt die Größe des Kontextfensters fest, das zur Generierung des nächsten Tokens verwendet wird.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			'Legt die zu verwendenden Stoppsequenzen fest. Wenn dieses Muster erkannt wird, stoppt das LLM die Textgenerierung. Mehrere Stoppmuster können durch separate Stopp-Parameter in einer Modelldatei angegeben werden.',
		Setting: ia,
		Settings: ra,
		...
		'Share to Open WebUI Community': 'Mit der Open WebUI Community teilen',
		...
		'Show Admin Details in Account Pending Overlay':
			"Admin-Details im 'Konto ausstehend'-Overlay anzeigen",
		...
		'Showing all messages (user + assistant) per user.':
			'Zeige alle Nachrichten (Benutzer + Assistent) pro Nutzer.',
		'Sign in': 'Anmelden',
		...
		'Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.':
			'Verbessert die Genauigkeit erheblich, indem ein LLM zur Optimierung von Tabellen, Formularen, mathematischen Formeln und Layout-Erkennung genutzt wird. Erhöht die Latenz. Standardmäßig deaktiviert.',
		...
		'Skip the cache and re-run the inference. Defaults to False.':
			'Cache überspringen und die Inferenz erneut ausführen. Standardmäßig deaktiviert.',
		...
		'Split documents by markdown headers before applying character/token splitting.':
			'Dokumente nach Markdown-Überschriften trennen, bevor die Segmentierung nach Zeichen oder Tokens angewendet wird.',
		...
		'Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.':
			"Vorhandenen OCR-Text aus der PDF entfernen und OCR erneut ausführen. Wird ignoriert, wenn 'OCR erzwingen' aktiviert ist. Standardmäßig deaktiviert.",
		...
		'Syncs only chats with updates after your last sync timestamp. Disable to re-sync all chats.':
			'Synchronisiert nur Chats mit Änderungen seit dem letzten Abgleich. Deaktivieren, um alle Chats neu zu synchronisieren.',
		System: za,
		...
		'Tail free sampling is used to reduce the impact of less probable tokens from the output. A higher value (e.g., 2.0) will reduce the impact more, while a value of 1.0 disables this setting.':
			'Tail-Free Sampling reduziert den Einfluss weniger wahrscheinlicher Token in der Ausgabe. Ein höherer Wert (z. B. 2.0) reduziert den Einfluss stärker, während ein Wert von 1.0 diese Einstellung deaktiviert.',
		...
		'The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.':
			'Die Batch-Größe bestimmt, wie viele Textanfragen gleichzeitig verarbeitet werden. Eine höhere Batch-Größe kann Leistung und Geschwindigkeit des Modells erhöhen, erfordert jedoch mehr Speicher.',
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Die Entwickler dieses Plugins sind engagierte Freiwillige aus der Community. Wenn Sie dieses Plugin hilfreich finden, erwägen Sie bitte, die Entwicklung zu unterstützen.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Die Bewertungs-Bestenliste basiert auf dem Elo-System und wird in Echtzeit aktualisiert.',
		'The format to return a response in. Format can be json or a JSON schema.':
			"Das Rückgabeformat für die Antwort. Format kann 'json' oder ein JSON-Schema sein.",
		'The height in pixels to compress images to. Leave empty for no compression.':
			'Die Höhe in Pixeln, auf die Bilder komprimiert werden sollen. Leer lassen für keine Kompression.',
		'The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.':
			'Die Sprache des Eingangsaudios. Die Angabe im ISO-639-1-Format (z. B. en) verbessert Genauigkeit und Latenz. Leer lassen für automatische Erkennung.',
		'The LDAP attribute that maps to the mail that users use to sign in.':
			'Das LDAP-Attribut, das der E-Mail zugeordnet ist, mit der sich Benutzer anmelden.',
		'The LDAP attribute that maps to the username that users use to sign in.':
			'Das LDAP-Attribut, das dem Benutzernamen zugeordnet ist, mit dem sich Benutzer anmelden.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'Die Bestenliste ist derzeit im Beta-Stadium. Wir passen die Bewertungsberechnungen möglicherweise an, während wir den Algorithmus verfeinern.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'Die maximale Dateigröße in MB. Dateien, die dieses Limit überschreiten, werden nicht hochgeladen.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'Die maximale Anzahl von Dateien, die gleichzeitig im Chat verwendet werden können. Überzählige Dateien werden nicht hochgeladen.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			"Das Ausgabeformat für den Text. Kann 'json', 'markdown' oder 'html' sein. Standard ist 'markdown'.",
		"The passwords you entered don't quite match. Please double-check and try again.":
			'Die eingegebenen Passwörter stimmen nicht überein. Bitte überprüfen Sie sie und versuchen Sie es erneut.',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Die Punktzahl sollte ein Wert zwischen 0.0 (0 %) und 1.0 (100 %) sein.',
		'The stream delta chunk size for the model. Increasing the chunk size will make the model respond with larger pieces of text at once.':
			'Die Stream-Delta-Chunk-Größe für das Modell. Eine Erhöhung bewirkt, dass das Modell mit größeren Textabschnitten auf einmal antwortet.',
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'Die Temperatur des Modells. Eine Erhöhung führt zu kreativeren Antworten.',
		'The Weight of BM25 Hybrid Search. 0 more semantic, 1 more lexical. Default 0.5':
			'Die Gewichtung der BM25-Hybridsuche. 0 ist semantischer, 1 ist lexikalischer. Standard ist 0.5.',
		'The width in pixels to compress images to. Leave empty for no compression.':
			'Die Breite in Pixeln, auf die Bilder komprimiert werden sollen. Leer lassen für keine Kompression.',
		Theme: Ta,
		'There was an error syncing your stats. Please try again.':
			'Beim Synchronisieren Ihrer Statistiken ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.',
		'Thinking...': 'Denke nach...',
		'This action cannot be undone. Do you wish to continue?':
			'Diese Aktion kann nicht rückgängig gemacht werden. Möchten Sie fortfahren?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'Dieser Kanal wurde am {{createdAt}} erstellt. Dies ist der Anfang des Kanals {{channelName}}.',
		"This chat won't appear in history and your messages will not be saved.":
			'Dieser Chat erscheint nicht im Verlauf und Ihre Nachrichten werden nicht gespeichert.',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Dies stellt sicher, dass Ihre wertvollen Unterhaltungen sicher in Ihrer Backend-Datenbank gespeichert werden. Vielen Dank!',
		'This feature is currently experimental and may not work as expected.':
			'Dieses Feature ist aktuell experimentell und funktioniert möglicherweise nicht wie erwartet.',
		'This feature is experimental and may be modified or discontinued without notice.':
			'Diese Funktion ist experimentell und kann ohne Vorankündigung geändert oder eingestellt werden.',
		'This folder is empty': 'Dieser Ordner ist leer',
		'This is a default user permission and will remain enabled.':
			'Dies ist eine Standardberechtigung und bleibt aktiviert.',
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Dies ist eine experimentelle Funktion. Sie funktioniert möglicherweise nicht wie erwartet und kann jederzeit geändert werden.',
		'This model is not publicly available. Please select another model.':
			'Dieses Modell ist nicht öffentlich verfügbar. Bitte wählen Sie ein anderes Modell.',
		'This option controls how long the model will stay loaded into memory following the request (default: 5m)':
			'Diese Option steuert, wie lange das Modell nach der Anfrage im Speicher bleibt (Standard: 5m).',
		'This option controls how many tokens are preserved when refreshing the context. For example, if set to 2, the last 2 tokens of the conversation context will be retained. Preserving context can help maintain the continuity of a conversation, but it may reduce the ability to respond to new topics.':
			'Diese Option steuert, wie viele Token beim Aktualisieren des Kontexts behalten werden. Bei 2 werden z. B. die letzten 2 Token des Gesprächskontexts beibehalten. Dies hilft, die Kontinuität zu wahren, kann aber die Reaktion auf neue Themen einschränken.',
		'This option enables or disables the use of the reasoning feature in Ollama, which allows the model to think before generating a response. When enabled, the model can take a moment to process the conversation context and generate a more thoughtful response.':
			'Diese Option aktiviert die Reasoning-Funktion in Ollama, wodurch das Modell vor der Antwort nachdenken kann. Wenn aktiviert, nimmt sich das Modell einen Moment Zeit, um den Kontext zu verarbeiten und eine durchdachtere Antwort zu generieren.',
		'This option sets the maximum number of tokens the model can generate in its response. Increasing this limit allows the model to provide longer answers, but it may also increase the likelihood of unhelpful or irrelevant content being generated.':
			'Diese Option legt die maximale Anzahl von Token fest, die das Modell generieren darf. Ein höheres Limit ermöglicht längere Antworten, kann aber auch die Wahrscheinlichkeit für irrelevante Inhalte erhöhen.',
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Diese Option löscht alle vorhandenen Dateien in der Sammlung und ersetzt sie durch die neu hochgeladenen Dateien.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Dies löscht <strong>{{NAME}}</strong> und <strong>alle Inhalte</strong>.',
		'This will delete all models including custom models':
			'Dies löscht alle Modelle, einschließlich benutzerdefinierter Modelle',
		'This will delete all models including custom models and cannot be undone.':
			'Dies löscht alle Modelle, einschließlich benutzerdefinierter Modelle, und kann nicht rückgängig gemacht werden.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Dadurch wird der Wissensspeicher zurückgesetzt und alle Dateien werden synchronisiert. Möchten Sie fortfahren?',
		...
		'Thumbs up/down ratings from users on model responses':
			'Daumen hoch/runter von Benutzer für Modell Antworten',
		Tika: Na,
		...
		'To access the available model names for downloading,':
			'Um die verfügbaren Modellnamen für den Download anzuzeigen,',
		'To access the GGUF models available for downloading,':
			'Um die verfügbaren GGUF-Modelle für den Download anzuzeigen,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'Für Zugriff auf die WebUI wenden Sie sich bitte an den Administrator. Administratoren können den Benutzerstatus im Admin-Panel verwalten.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Um einen Wissensspeicher hier anzuhängen, fügen Sie sie zuerst dem Arbeitsbereich "Wissen" hinzu.',
		'To learn more about available endpoints, visit our documentation.':
			'Um mehr über verfügbare Endpunkte zu erfahren, besuchen Sie unsere Dokumentation.',
		'To select skills here, add them to the "Skills" workspace first.':
			'Um hier Skills auszuwählen, füge sie zuerst dem Workspace "Skills" hinzu.',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Um Toolkits auszuwählen, fügen Sie sie zuerst dem Arbeitsbereich "Werkzeuge" hinzu.',
		...
		'Toggle whether current connection is active.':
			'Umschalten, ob die aktuelle Verbindung aktiv ist.',
		Token: Ka,
		'Token counts are estimates and may not reflect actual API usage':
			'Token-Anzahlen sind Schätzwerte und entsprechen möglicherweise nicht der tatsächlichen API-Nutzung.',
		tokens: Va,
		Tokens: Ga,
		...
		'Tools are a function calling system with arbitrary code execution':
			'Werkzeuge sind ein System für Funktionsaufrufe mit beliebiger Codeausführung',
		...
		'Try adjusting your search or filter to find what you are looking for.':
			'Versuchen Sie, Ihre Suche oder Filter anzupassen, um zu finden, was Sie suchen.',
		...
		'Uh-oh! There was an issue with the response.':
			'Es ist ein Problem mit der Antwort aufgetreten.',
		UI: ja,
		...
		'Update for the latest features and improvements.':
			'Führen Sie ein Update für die neuesten Funktionen und Verbesserungen durch.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Upgraden Sie auf einen lizenzierten Plan für erweiterte Funktionen, einschließlich individuellem Design, Branding und dediziertem Support.',
		Upload: io,
		...
		'Upload Progress: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)':
			'Fortschritt: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Verwenden Sie '#' in der Prompt-Eingabe, um Ihr Wissen zu laden und einzubeziehen.",
		'Use /v1/chat/completions endpoint instead of /v1/audio/transcriptions for potentially better accuracy.':
			'Verwenden Sie den Endpunkt /v1/chat/completions statt /v1/audio/transcriptions für potenziell bessere Genauigkeit.',
		'Use Chat Completions API': 'Chat Completions API verwenden',
		'Use groups to organize your users and assign permissions.':
			'Nutze Gruppen um deine Nutzer zu organisieren und Berechtigungen zu vergeben',
		'Use LLM': 'LLM verwenden',
		'Use no proxy to fetch page contents.':
			'Keinen Proxy zum Abrufen von Seiteninhalten verwenden.',
		'Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.':
			'Den durch die Umgebungsvariablen http_proxy und https_proxy festgelegten Proxy verwenden.',
		user: so,
		User: lo,
		...
		'Uses DefaultAzureCredential to authenticate':
			'Verwendet DefaultAzureCredential zur Authentifizierung',
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Verwendet das Standard-Arena-Modell mit allen Modellen. Klicken Sie auf das Plus-Symbol, um benutzerdefinierte Modelle hinzuzufügen.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Version {{selectedVersion}} von {{totalVersions}}',
		...
		'Voice Mode Custom Prompt': 'Anruf-Modus Benutzerdefinierter Prompt',
		...
		'Warning: Enabling this will allow users to run scheduled prompts automatically.':
			'Warnung: Wenn Sie dies aktivieren, können Nutzer geplante Prompts automatisch ausführen.',
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Warnung: Wenn Sie dies aktivieren, können Benutzer beliebigen Code auf den Server hochladen.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			'Warnung: Die Jupyter-Ausführung ermöglicht beliebige Codeausführung und birgt erhebliche Sicherheitsrisiken – gehen Sie mit äußerster Vorsicht vor.',
		We_day_of_week: Ao,
		Web: yo,
		'Web API': 'Web-API',
		...
		'WebUI will make requests to "{{url}}/api/chat"':
			'WebUI wird Anfragen an "{{url}}/api/chat" senden',
		'WebUI will make requests to "{{url}}/chat/completions"':
			'WebUI wird Anfragen an "{{url}}/chat/completions" senden',
		Week: zo,
		Weekly: Io,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			'Wenn aktiviert, antwortet das Modell in Echtzeit auf jede Chat-Nachricht. Dieser Modus ist nützlich für Live-Chats, kann jedoch die Leistung auf langsamerer Hardware beeinträchtigen.',
		...
		'Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.':
			'Ob die Ausgabe paginiert werden soll. Jede Seite wird durch eine horizontale Linie und Seitennummer getrennt. Standard ist False.',
		...
		'Works together with top-k. A higher value (e.g., 0.95) will lead to more diverse text, while a lower value (e.g., 0.5) will generate more focused and conservative text.':
			'Funktioniert zusammen mit Top-K. Ein höherer Wert (z. B. 0.95) führt zu vielfältigerem Text, während ein niedrigerer Wert (z. B. 0.5) fokussierteren und konservativeren Text erzeugt.',
		Workspace: Mo,
		'Workspace Permissions': 'Arbeitsbereichsberechtigungen',
		Write: To,
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Schreiben Sie eine Zusammenfassung in 50 Wörtern über {{topic}}.',
...
z. B.: Sie sind Mario aus Super Mario Bros und agieren als Assistent.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'Sie nutzen derzeit eine Testlizenz. Bitte kontaktieren Sie den Support für ein Upgrade.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Sie können mit maximal {{maxCount}} Datei(en) gleichzeitig chatten.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			'Sie können Interaktionen mit LLMs personalisieren, indem Sie über die Schaltfläche "Verwalten" Erinnerungen hinzufügen.',
		'You cannot upload an empty file.': 'Sie können keine leere Datei hochladen.',
		'You do not have permission to edit this model':
			'Sie haben keine Berechtigung, dieses Modell zu bearbeiten.',
		'You do not have permission to edit this prompt.':
			'Sie haben keine Berechtigung, diesen Prompt zu bearbeiten.',
		'You do not have permission to edit this skill.':
			'Sie haben keine Berechtigung, diesen Skill zu bearbeiten.',
		'You do not have permission to edit this tool':
			'Sie haben keine Berechtigung, dieses Werkzeug zu bearbeiten.',
		'You do not have permission to make this public':
			'Sie haben keine Berechtigung, das zu veröffentlichen.',
		'You do not have permission to send messages in this channel.':
			'Sie haben keine Berechtigung, Nachrichten in diesem Kanal zu senden.',
		'You do not have permission to send messages in this thread.':
			'Sie haben keine Berechtigung, Nachrichten in diesem Thread zu senden.',
		'You do not have permission to upload files to this knowledge base.':
			'Sie haben keine Berechtigung, Dateien in diese Wissensspeicher hochzuladen.',
		'You do not have permission to upload files.':
			'Sie haben keine Berechtigung, Dateien hochzuladen.',
		'You do not have permission to upload web content.':
			'Sie haben keine Berechtigung Webseiten hochzuladen.',
		...
		'Your account status is currently pending activation.':
			'Ihr Kontostatus wartet derzeit auf Aktivierung.',
		...
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			'Ihr gesamter Beitrag geht direkt an den Plugin-Entwickler; Open WebUI behält keinen Anteil ein. Die gewählte Plattform kann jedoch eigene Gebühren erheben.',
		'Your message text or inputs': 'Ihre Nachrichtentexte oder Eingaben',
		'Your usage stats have been successfully synced.':
			'Ihre Nutzungsstatistiken wurden erfolgreich synchronisiert.',
		YouTube: Ro,
...
//# sourceMappingURL=BeYemO3C.js.map
