const e = 'შესახებ',
	...
	ra = 'ფაიფი',
	ia = '',
	la = 'საცდელი ფუნქციები',
	ca = 'პორტი',
	da = '',
	ua = 'მინიატურა',
	ma = 'პირადი',
	pa = 'პროფილი',
	ha = 'ბრძანების შეყვანის შეხსენება',
	ga = 'მოთხოვნები',
	ya = 'საჯარო',
	fa = 'მოთხოვნა',
	Aa = 'ხმის მიცემა',
	...
	Fr = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 ლიმიტის გამოსართავად, ან დადებითი მთელი რიცხვი კონკრეტული ლიმიტისთვის',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' ან '-1' - უვადოსთვის.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(მაგ: `sh webui.sh --api --api-auth username_password`)',
		'(e.g. `sh webui.sh --api`)': '(მაგ: `sh webui.sh --api`)',
		'(latest)': '(უახლესი)',
		'(leave blank for to use commercial endpoint)':
			'(დატოვეთ ცარიელი ფასიანი ბოლოწერტილის გამოსაყენებლად)',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'ხელმისაწვდომია ახალი ვერსია (v{{LATEST_VERSION}}).',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'დავალების მოდელი გამოიყენება ისეთი ამოცანების შესრულებისას, როგორიცაა ჩეთების სათაურების გენერირება და ვებ – ძიების მოთხოვნები',
		'a user': 'მომხმარებელი',
		About: e,
		...
		'Add a short description about what this model does':
			'დაამატეთ მოკლე აღწერა იმის შესახებ, თუ რას აკეთებს ეს მოდელი',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'ამ პარამეტრების რეგულირება ცვლილებებს უნივერსალურად გამოიყენებს ყველა მომხმარებლისთვის.',
		admin: c,
		Admin: d,
		'Admin Contact Email': '',
		...
		"Click on the user role button to change a user's role.":
			'მომხმარებლის როლის შესაცვლელად დააწკაპუნეთ მომხმარებლის როლზე.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		...
		'Discover, download, and explore custom prompts':
			'აღმოაჩინეთ, გადმოწერეთ და შეისწავლეთ მორგებული მოთხოვნები',
		'Discover, download, and explore custom tools': '',
		'Discover, download, and explore model presets':
			'აღმოაჩინეთ, გადმოწერეთ და შეისწავლეთ მოდელის პარამეტრები',
		...
		'Display the username instead of You in the Chat':
			'ჩატში თქვენს მაგიერ მომხმარებლის სახელის ჩვენება',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'არ ამყარებს გარე კავშირებს და თქვენი მონაცემები უსაფრთხოდ რჩება თქვენს ლოკალურ სერვერზე.',
		'Domain Filter List': 'დომენის ფილტრების სია',
		"don't fetch random pipelines from sources you don't trust.":
			'არ ჩამოტვირთოთ შემთხვევითი pipelines არასანდო წყაროებიდან.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"მაგ: '30წ', '10მ'. მოქმედი დროის ერთეულები: 'წ', 'წთ', 'სთ'.",
		"e.g. 'low', 'medium', 'high'": '',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'დარწმუნდით, რომ თქვენი CSV-ფაილი შეიცავს 4 ველს ამ მიმდევრობით: სახელი, ელფოსტა, პაროლი, როლი.',
		'Enter {{role}} message here': 'შეიყვანე {{role}} შეტყობინება აქ',
		'Enter a detail about yourself for your LLMs to recall':
			'შეიყვანეთ რამე თქვენს შესახებ, რომ თქვენმა LLM-მა გაიხსენოს',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'შეიყვანეთ პროქსის URL (მაგ: https://user:password@host:port)',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'მაგალითი: sAMAccountName ან uid ან userPrincipalName',
		...
		'File size should not exceed {{maxSize}} MB.':
			'ფაილის ზომა {{maxSize}} მბ-ს არ უნდა აღემატებოდეს.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'აღმოჩენილია ანაბეჭდის გაყალბება: ინიციალების გამოყენება ავატარად შეუძლებელია. გამოყენებული იქნეა ნაგულისხმევი პროფილის სურათი.',
		...
		'Include `--api` flag when running stable-diffusion-webui':
			'`--api` ალმის ჩასმა stable-diffusion-webui-ის გამოყენებისას',
		...
		'Knowledge reset successfully.': 'ცოდნის ჩამოყრა წარმატებულია.',
		'Knowledge Sharing': '',
		...
		'LLMs can make mistakes. Verify important information.':
			'LLM-ებმა, შეიძლება, შეცდომები დაუშვან. გადაამოწმეთ მნიშვნელოვანი ინფორმაცია.',
		Loader: Bo,
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'ერთდროულად მაქსიმუმ 3 მოდელის ჩამოტვირთვაა შესაძლებელია. მოგვიანებით სცადეთ.',
		May: $o,
		MBR: en,
		MCP: tn,
		...
		'Memories accessible by LLMs will be shown here.':
			'LLM-ებისთვის ხელმისაწვდომი მეხსიერებები აქ გამოჩნდება.',
		Memory: rn,
		...
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'შეტყობინებები, რომელსაც თქვენ აგზავნით თქვენი ბმულის შექმნის შემდეგ, არ იქნება გაზიარებული. URL– ის მქონე მომხმარებლებს შეეძლებათ ნახონ საერთო ჩატი.',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			'მოდელის „{{modelName}}“ გადმოწერა წარმატებით დასრულდა.',
		"Model '{{modelTag}}' is already in queue for downloading.":
			'მოდელი „{{modelTag}}“ უკვე გადმოწერის რიგშია.',
		...
		'Model can execute code and perform calculations':
			'მოდელს შეუძლია კოდის გაშვება და გამოთვლების შესრულება',
		'Model can generate images based on text prompts':
			'მოდელს შეუძლია ტექსტის მიხედვით გამოსახულებების გენერაცია',
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'აღმოჩენილია მოდელის ფაილური სისტემის ბილიკი. განახლებისთვის საჭიროა მოდელის მოკლე სახელი, გაგრძელება შეუძლებელია.',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'შენიშვნა: თუ თქვენ დააყენებთ მინიმალურ ქულას, ძებნა დააბრუნებს მხოლოდ დოკუმენტებს მინიმალური ქულის მეტი ან ტოლი ქულით.',
		Notes: kn,
		...
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'ბრძანების სტრიქონში დაშვებულია, მხოლოდ, ალფარიცხვითი სიმბოლოები და ტირეები.',
		...
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'უი! როგორც ჩანს, მისამართი არასწორია. გთხოვთ, გადაამოწმოთ და ისევ სცადოთ.',
		...
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'ვაი! იყენებთ მხარდაუჭერელ მეთოდს (მხოლოდ წინაბოლო). შედით WebUI-ზე უკანაბოლოდან.',
		...
		'Permission denied when accessing microphone: {{error}}':
			'ნებართვა უარყოფილია მიკროფონზე წვდომისას: {{error}}',
		Permissions: ta,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines არის პლაგინების სისტემა თვითნებური კოდის გაშვებით —',
		...
		'Prompts Sharing': '',
		'Provider Type': 'მომწოდებლის წიპი',
		Public: ya,
		...
		'Redirecting you to Open WebUI Community':
			'მიმდინარეობს გადამისამართება OpenWebUI-ის საზოგადოების საიტზე',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'ჩეთის ისტორიის შენახვა პირდაპირ თქვენი ბრაუზერის საცავში აღარ არის მხარდაჭერილი. გთხოვთ, დაუთმოთ და წაშალოთ თქვენი ჩატის ჟურნალები ქვემოთ მოცემულ ღილაკზე დაწკაპუნებით. არ ინერვიულოთ, თქვენ შეგიძლიათ მარტივად ხელახლა შემოიტანოთ თქვენი ჩეთის ისტორია ბექენდში',
		Schedule: ja,
		...
		'Selected model(s) do not support image inputs':
			'მონიშნულ მოდელებს გამოსახულების შეყვანის მხარდაჭერა არ გააჩნიათ',
		'Selected Models': '',
		semantic: es,
		Send: ts,
		...
		'Sign Out': 'გასვლა',
		'Sign up': 'რეგისტრაცია',
		'Sign up to {{WEBUI_NAME}}': 'რეგისტრაცია {{WEBUI_NAME}}-ზე',
		'Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.':
			'',
		'Signing in to {{WEBUI_NAME}}': 'მიმდინარეობს შესვლა {{WEBUI_NAME}}-ში',
		Single: ls,
		'Sink List': '',
		'sk-1234': 'sk-1234',
		...
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'რეიტინგი უნდა იყოს მნიშვნელობ შუალედიდან 0.0 (0%) - 1.0 (100%).',
		...
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'მოდელის ტემპერატურა. ტემპერატურის გაზრდა მოდელს აიძულებს, უფრო მეტი შემოქმედებით გიპასუხოთ.',
		...
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'ეს უზრუნველყოფს, რომ თქვენი ღირებული საუბრები უსაფრთხოდ შეინახება თქვენს უკანაბოლო მონაცემთა ბაზაში. მადლობა!',
		...
		'To access the available model names for downloading,':
			'ხელმისაწვდომი მოდელის სახელებთან წვდომისთვის, რომ გადმოწეროთ,',
		'To access the GGUF models available for downloading,':
			'გადმოსაწერად ხელმისაწვდომი GGUF მოდელებზე წვდომისთვის,',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'დაწერეთ რეზიუმე 50 სიტყვით, რომელიც აჯამებს [თემას ან საკვანძო სიტყვას].',
...
მაგ.: თქვენ ხართ მარიო თამაშიდან Super Mario Bros და მოქმედებთ ასისტენტის როლში.`,
		...
		'You do not have permission to send messages in this channel.':
			'ამ არხზე შეტყობინების გაგზავნის უფლება არ გაქვთ.',
		'You do not have permission to send messages in this thread.':
			'ამ ნაკადში შეტყობინების გაგზავნის უფლება არ გაქვთ.',
		...
		'Your account status is currently pending activation.':
			'თქვენი ანგარიშის სტატუსი ამჟამად ელოდება აქტივაციას.',
...
//# sourceMappingURL=BguwIw9-.js.map
