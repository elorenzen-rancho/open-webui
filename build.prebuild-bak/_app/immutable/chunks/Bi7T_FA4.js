...
function S(n, e) {
	let i = -1;
	for (const r of this) n.call(e, r, ++i, this);
	return this;
}
function T(n, e) {
	for (var i = this, r = [i], a, o, u = -1; (i = r.pop()); )
		if ((n.call(e, i, ++u, this), (a = i.children)))
			for (o = a.length - 1; o >= 0; --o) r.push(a[o]);
	return this;
}
function V(n, e) {
	for (var i = this, r = [i], a = [], o, u, c, s = -1; (i = r.pop()); )
		if ((a.push(i), (o = i.children))) for (u = 0, c = o.length; u < c; ++u) r.push(o[u]);
	for (; (i = a.pop()); ) n.call(e, i, ++s, this);
	return this;
}
function C(n, e) {
	let i = -1;
	for (const r of this) if (n.call(e, r, ++i, this)) return r;
}
function L(n) {
	return this.eachAfter(function (e) {
		for (var i = +n(e.data) || 0, r = e.children, a = r && r.length; --a >= 0; ) i += r[a].value;
		e.value = i;
	});
}
function b(n) {
...
function D(n) {
	for (var e = this, i = O(e, n), r = [e]; e !== i; ) ((e = e.parent), r.push(e));
...
function O(n, e) {
	...
	var i = n.ancestors(),
		r = e.ancestors(),
		a = null;
	for (n = i.pop(), e = r.pop(); n === e; ) ((a = n), (n = i.pop()), (e = r.pop()));
	return a;
}
function j() {
...
function H() {
	...
	return (
		n.each(function (i) {
			i !== n && e.push({ source: i.parent, target: i });
		}),
		e
	);
}
function* Z() {
	...
	do
		for (e = i.reverse(), i = []; (n = e.pop()); )
			if ((yield n, (r = n.children))) for (a = 0, o = r.length; a < o; ++a) i.push(r[a]);
	while (i.length);
}
function R(n, e) {
	n instanceof Map ? ((n = [void 0, n]), e === void 0 && (e = J)) : e === void 0 && (e = G);
	for (var i = new A(n), r, a = [i], o, u, c, s; (r = a.pop()); )
...
function U(n, e, i, r, a) {
	for (var o = n.children, u, c = -1, s = o.length, v = n.value && (r - e) / n.value; ++c < s; )
		((u = o[c]), (u.y0 = i), (u.y1 = a), (u.x0 = e), (u.x1 = e += u.value * v));
}
function W(n, e, i, r, a) {
	for (var o = n.children, u, c = -1, s = o.length, v = n.value && (a - i) / n.value; ++c < s; )
		((u = o[c]), (u.x0 = e), (u.x1 = r), (u.y0 = i), (u.y1 = i += u.value * v));
}
var X = (1 + Math.sqrt(5)) / 2;
function Y(n, e, i, r, a, o) {
	for (
		var u = [],
			c = e.children,
			s,
		...
		while (!f && m < t);
		for (
			g = w = f, N = Math.max(p / d, d / p) / (l * n), y = f * f * N, k = Math.max(w / y, y / g);
			m < t;
			++m
		) {
			if (
		...
		(u.push((s = { value: f, dice: d < p, children: c.slice(h, m) })),
			s.dice
				? U(s, i, r, a, l ? (r += (p * f) / l) : o)
				: W(s, i, r, l ? (i += (d * f) / l) : a, o),
			(l -= f),
			(h = m));
	}
	return u;
...
function en() {
	...
	return (
		...
		(h.tile = function (t) {
			return arguments.length ? ((n = q(t)), h) : n;
		}),
		...
		(h.paddingOuter = function (t) {
			return arguments.length
				? h.paddingTop(t).paddingRight(t).paddingBottom(t).paddingLeft(t)
				: h.paddingTop();
		}),
...
//# sourceMappingURL=Bi7T_FA4.js.map
