import { d as l } from './CHheSG1Y.js';
import { b1 as F } from './CD8kWLvT.js';
const _ = {
		2049: 'interrobang',
		2122: 'tm',
	...
	w = F('system'),
	b = F(
		Object.entries(_).reduce((a, [n, e]) => {
			if (typeof e == 'string') a[e] = n;
			else for (const o of e) a[o] = n;
			return a;
		}, {})
	),
	A = F(null),
...
//# sourceMappingURL=Bumd5cCN.js.map
