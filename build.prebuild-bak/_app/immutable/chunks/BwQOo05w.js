	...
	x = {
		start: [
			...
			{ token: 'atom', regex: '(?:true|false|yes|no|on|off|null|void|undefined)' + r },
			{
				token: 'invalid',
				regex:
					'(?:p(?:ackage|r(?:ivate|otected)|ublic)|i(?:mplements|nterface)|enum|static|yield)' + r
			},
			{
			...
			},
			{
				...
				regex:
					'(?:is(?:NaN|Finite)|parse(?:Int|Float)|Math|JSON|(?:en|de)codeURI(?:Component)?)' + r
			},
			{
...
const y = {
	...
	token: function (e, n) {
		...
		return (
			(n.lastToken = { style: g, indent: e.indentation(), content: e.current() }),
			g.replace(/\./g, ' ')
		);
	},
	indent: function (e) {
...
//# sourceMappingURL=BwQOo05w.js.map
