const e = 'Tentang',
	...
	Ni = {
		...
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' atau '-1' untuk tidak ada kedaluwarsa.",
		...
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Model tugas digunakan saat melakukan tugas seperti membuat judul untuk obrolan dan kueri penelusuran web',
		...
		'Add a short description about what this model does':
			'Tambahkan deskripsi singkat tentang apa yang dilakukan model ini',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Menyesuaikan pengaturan ini akan menerapkan perubahan secara universal ke semua pengguna.',
		admin: d,
		Admin: c,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Admin memiliki akses ke semua alat setiap saat; pengguna memerlukan alat yang ditetapkan per model di ruang kerja.',
		Advanced: u,
		...
		'Call feature is not supported when using Web STT engine':
			'Fitur panggilan tidak didukung saat menggunakan mesin Web STT',
		Camera: z,
		Cancel: Q,
		...
		'Click here to download user import template file.':
			'Klik di sini untuk mengunduh file templat impor pengguna.',
		...
		"Click on the user role button to change a user's role.":
			'Klik tombol peran pengguna untuk mengubah peran pengguna.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Izin menulis papan klip ditolak. Periksa pengaturan peramban Anda untuk memberikan akses yang diperlukan.',
		Clone: le,
		'Clone Chat': '',
		'Clone of {{TITLE}}': '',
		Close: de,
		...
		'Discover, download, and explore custom functions':
			'Menemukan, mengunduh, dan menjelajahi fungsi khusus',
		...
		'Discover, download, and explore custom tools':
			'Menemukan, mengunduh, dan menjelajahi alat khusus',
		'Discover, download, and explore model presets':
			'Menemukan, mengunduh, dan menjelajahi preset model',
		...
		'Display the username instead of You in the Chat':
			'Menampilkan nama pengguna, bukan Anda di Obrolan',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'tidak membuat koneksi eksternal apa pun, dan data Anda tetap aman di server yang dihosting secara lokal.',
		'Domain Filter List': '',
		"don't fetch random pipelines from sources you don't trust.":
			'Jangan mengambil pipeline acak dari sumber yang tidak Anda percayai.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"misalnya '30-an', '10m'. Satuan waktu yang valid adalah 's', 'm', 'h'.",
		"e.g. 'low', 'medium', 'high'": '',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Pastikan file CSV Anda menyertakan 4 kolom dengan urutan sebagai berikut: Nama, Email, Kata Sandi, Peran.',
		'Enter {{role}} message here': 'Masukkan pesan {{role}} di sini',
		'Enter a detail about yourself for your LLMs to recall':
			'Masukkan detail tentang diri Anda untuk diingat oleh LLM Anda',
		...
		'Enter api auth string (e.g. username:password)':
			'Masukkan string pengesahan API (misalnya nama pengguna: kata sandi)',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Pemalsuan sidik jari terdeteksi: Tidak dapat menggunakan inisial sebagai avatar. Default ke gambar profil default.',
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Sertakan bendera `--api-auth` saat menjalankan stable-diffusion-webui',
		'Include `--api` flag when running stable-diffusion-webui':
			'Sertakan bendera `--api` saat menjalankan stable-diffusion-webui',
		...
		'Instant Auto-Send After Voice Transcription':
			'Kirim Otomatis Instan Setelah Transkripsi Suara',
		Instructions: wt,
		Integration: St,
		Integrations: Pt,
		Interface: vt,
		...
		'LLMs can make mistakes. Verify important information.':
			'LLM dapat membuat kesalahan. Verifikasi informasi penting.',
		Loader: Gt,
		'Loading Kokoro.js...': '',
		'Loading...': 'Memuat...',
		local: _t,
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Maksimal 3 model dapat diunduh secara bersamaan. Silakan coba lagi nanti.',
		May: Xt,
		MBR: $t,
		MCP: en,
		...
		'Memories accessible by LLMs will be shown here.':
			'Memori yang dapat diakses oleh LLM akan ditampilkan di sini.',
		Memory: sn,
		...
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Pesan yang Anda kirim setelah membuat tautan tidak akan dibagikan. Pengguna yang memiliki URL tersebut akan dapat melihat obrolan yang dibagikan.',
		'Microsoft OneDrive': '',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Model '{{modelName}}' telah berhasil diunduh.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Model '{{modelTag}}' sudah berada dalam antrean untuk diunduh.",
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Jalur sistem berkas model terdeteksi. Nama pendek model diperlukan untuk pembaruan, tidak dapat dilanjutkan.',
		'Model Filtering': '',
		'Model ID': 'ID Model',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Catatan: Jika Anda menetapkan skor minimum, pencarian hanya akan mengembalikan dokumen dengan skor yang lebih besar atau sama dengan skor minimum.',
		Notes: Mn,
		...
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Hanya karakter alfanumerik dan tanda hubung yang diizinkan dalam string perintah.',
		...
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Ups! Sepertinya URL tidak valid. Mohon periksa ulang dan coba lagi.',
		...
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Ups! Anda menggunakan metode yang tidak didukung (hanya untuk frontend). Silakan sajikan WebUI dari backend.',
		'Open file': '',
		'Open in full screen': '',
		'Open in new tab': '',
		'Open link': '',
		...
		'Permission denied when accessing microphone: {{error}}':
			'Izin ditolak saat mengakses mikrofon: {{error}}',
		Permissions: eo,
		'Perplexity API Key': '',
		'Perplexity Model': '',
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines adalah sistem plugin dengan eksekusi kode sewenang‑wenang —',
		...
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Merujuk diri Anda sebagai "Pengguna" (misalnya, "Pengguna sedang belajar bahasa Spanyol")',
		'Reference Chats': '',
		Refresh: Po,
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Notifikasi respons tidak dapat diaktifkan karena izin situs web telah ditolak. Silakan kunjungi pengaturan browser Anda untuk memberikan akses yang diperlukan.',
		'Response splitting': '',
		'Response Watermark': '',
		Responses: No,
		Restart: Ko,
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Menyimpan log obrolan secara langsung ke penyimpanan browser Anda tidak lagi didukung. Mohon luangkan waktu sejenak untuk mengunduh dan menghapus log obrolan Anda dengan mengeklik tombol di bawah ini. Jangan khawatir, Anda dapat dengan mudah mengimpor kembali log obrolan Anda ke backend melalui',
		Schedule: zo,
		...
		'Show Admin Details in Account Pending Overlay':
			'Tampilkan Detail Admin di Hamparan Akun Tertunda',
		'Show All': '',
		...
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Nilai yang diberikan haruslah nilai antara 0,0 (0%) dan 1,0 (100%).',
		...
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Ini akan memastikan bahwa percakapan Anda yang berharga disimpan dengan aman ke basis data backend. Terima kasih!',
		...
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Ini adalah fitur eksperimental, mungkin tidak berfungsi seperti yang diharapkan dan dapat berubah sewaktu-waktu.',
		...
		'To access the available model names for downloading,':
			'Untuk mengakses nama model yang tersedia untuk diunduh,',
		'To access the GGUF models available for downloading,':
			'Untuk mengakses model GGUF yang tersedia untuk diunduh,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'Untuk mengakses WebUI, hubungi administrator. Admin dapat mengelola status pengguna dari Panel Admin.',
		...
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Untuk memilih perangkat di sini, tambahkan ke ruang kerja "Alat" terlebih dahulu.',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Tulis ringkasan dalam 50 kata yang merangkum [topik atau kata kunci].',
		'Write something...': '',
...
mis.: Anda adalah Mario dari Super Mario Bros dan bertindak sebagai asisten.`,
		...
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Anda dapat mempersonalisasi interaksi Anda dengan LLM dengan menambahkan kenangan melalui tombol 'Kelola' di bawah ini, sehingga lebih bermanfaat dan disesuaikan untuk Anda.",
		...
		'Your account status is currently pending activation.':
			'Status akun Anda saat ini sedang menunggu aktivasi.',
...
//# sourceMappingURL=C12gGGoR.js.map
