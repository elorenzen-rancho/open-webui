const e = 'אודות',
	...
	Fr = {
		...
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			"מודל משימה משמש בעת ביצוע משימות כגון יצירת כותרות עבור צ'אטים ושאילתות חיפוש באינטרנט",
		'a user': 'משתמש',
		About: e,
		...
		'Add a short description about what this model does':
			'הוסף תיאור קצר אודות אופן הפעולה של מודל זה',
		'Add a tag': 'הוסף תג',
		'Add a tag...': '',
		'Add Access': '',
		'Add Arena Model': '',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'התאמת הגדרות אלו תחול על כל המשתמשים.',
		admin: c,
		Admin: d,
		'Admin Contact Email': '',
		...
		'Click here to learn more about faster-whisper and see the available models.':
			'לחץ כאן כדי ללמוד עוד על faster-whisper ולראות מודלים זמינים',
		...
		"Click on the user role button to change a user's role.":
			'לחץ על כפתור תפקיד המשתמש כדי לשנות את תפקיד המשתמש.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'לא מבצע חיבורים חיצוניים, והנתונים שלך נשמרים באופן מאובטח בשרת המקומי שלך.',
		'Domain Filter List': '',
		"don't fetch random pipelines from sources you don't trust.":
			'אל תמשוך pipelines אקראיים ממקורות שאינך סומך עליהם.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"למשל '30s', '10m'. יחידות זמן חוקיות הן 's', 'm', 'h'.",
		"e.g. 'low', 'medium', 'high'": '',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'ודא שקובץ ה-CSV שלך כולל 4 עמודות בסדר הבא: שם, דוא"ל, סיסמה, תפקיד.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'התגלתה הזיית טביעת אצבע: לא ניתן להשתמש בראשי תיבות כאווטאר. משתמש בתמונת פרופיל ברירת מחדל.',
		...
		'Include `--api` flag when running stable-diffusion-webui':
			'כלול את הדגל `--api` בעת הרצת stable-diffusion-webui',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'ניתן להוריד מקסימום 3 מודלים בו זמנית. אנא נסה שוב מאוחר יותר.',
		May: $o,
		MBR: en,
		MCP: tn,
		...
		'Message rating should be enabled to use this feature':
			"דירוג הודעות צריך להיות מאופשר כדי להשתמש בפיצ'ר הזה",
		messages: cn,
		Messages: dn,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			"הודעות שתשלח לאחר יצירת הקישור לא ישותפו. משתמשים עם כתובת האתר יוכלו לצפות בצ'אט המשותף.",
		'Microsoft OneDrive': '',
		...
		"Model '{{modelTag}}' is already in queue for downloading.":
			"המודל '{{modelTag}}' כבר בתור להורדה.",
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'נתיב מערכת הקבצים של המודל זוהה. נדרש שם קצר של המודל לעדכון, לא ניתן להמשיך.',
		'Model Filtering': '',
		'Model ID': 'מזהה דגם',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'הערה: אם תקבע ציון מינימלי, החיפוש יחזיר רק מסמכים עם ציון שגבוה או שווה לציון המינימלי.',
		Notes: kn,
		...
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'רק תווים אלפאנומריים ומקפים מותרים במחרוזת הפקודה.',
		...
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'אופס! נראה שהכתובת URL אינה תקינה. אנא בדוק שוב ונסה שנית.',
		...
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'אופס! אתה משתמש בשיטה לא נתמכת (רק חזית). אנא שרת את ממשק המשתמש האינטרנטי מהשרת האחורי.',
		'Open file': '',
		'Open in full screen': '',
		'Open in new tab': '',
		'Open link': '',
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines הוא מערכת תוספים עם יכולת להריץ קוד שרירותי —',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			"שמירת יומני צ'אט ישירות באחסון הדפדפן שלך אינה נתמכת יותר. אנא הקדש רגע להוריד ולמחוק את יומני הצ'אט שלך על ידי לחיצה על הכפתור למטה. אל דאגה, באפשרותך לייבא מחדש בקלות את יומני הצ'אט שלך לשרת האחורי דרך",
		Schedule: ja,
		...
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'ציון צריך להיות ערך בין 0.0 (0%) ל-1.0 (100%)',
		...
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'פעולה זו מבטיחה שהשיחות בעלות הערך שלך יישמרו באופן מאובטח במסד הנתונים העורפי שלך. תודה!',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'כתוב סיכום ב-50 מילים שמסכם [נושא או מילת מפתח].',
		'Write something...': '',
...
//# sourceMappingURL=C2LS6QuA.js.map
