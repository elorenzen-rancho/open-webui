			...
			default:
				...
				if (r == '"') ((n.mode = 'string'), (i = g));
					...
					(d.length > 0 && q.propertyIsEnumerable(d)
						? s(n, f + S, r)
						: (e.eatSpace(),
							e.eol() || e.peek() == ';' ? s(n, f + 1, r) : s(n, f + e.current().length, r)),
					...
					r == ')' || r == ']'
						? ((i = v),
							n.indentStack != null &&
								...
								(N(n),
								typeof n.sExprComment == 'number' &&
									--n.sExprComment == 0 &&
									((i = a), (n.sExprComment = !1)),
								typeof n.sExprQuote == 'number' &&
									--n.sExprQuote == 0 &&
									((i = c), (n.sExprQuote = !1))))
						: (e.eatWhile(/[\w_\-!$%&*+\.\/:<=>?@\^~]/),
...
export { U as scheme };
//# sourceMappingURL=C41bIUwD.js.map
