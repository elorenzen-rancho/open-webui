function A(i) {
	...
	function _(e, n) {
		...
		if (e.eatWhile(/[\w\$_]/)) {
			var l = e.current();
			return h[l]
				? (f[l] && (d = 'newblock'), R[l] && (d = 'newstatement'), (v = l), 'keyword')
				: 'variable';
		}
		return (e.next(), null);
	}
	...
	return {
		...
		token: function (e, n) {
			...
			if (
				(e.sol() &&
					(t.align == null && (t.align = !1), (n.indented = e.indentation()), (n.startOfLine = !0)),
				a.token)
			) {
				var r = a.token(e, n);
			...
			if ((t.align == null && (t.align = !0), d == t.type)) C(n);
				...
				d == 'newblock' &&
				!(v == 'function' && t && (t.type == 'statement' || t.type == 'endgroup'))
			) {
...
const Q = A({
	hooks: {
		...
		token: function (i, o) {
			...
			if (i.sol() && !o.tlvInBlockComment) {
				(i.peek() == '\\' &&
					...
					i.string.match(/\\SV/)
						? (o.tlvCodeActive = !1)
						: i.string.match(/\\TLV/) && (o.tlvCodeActive = !0)),
					o.tlvCodeActive &&
						i.pos == 0 &&
						o.indented == 0 &&
						(c = i.match(F, !1)) &&
						(o.indented = c[0].length));
				var s = o.indented,
					a = s / S;
			...
			if (o.tlvCodeActive) {
				...
				if (u === void 0)
					if (o.tlvInBlockComment)
						...
						var b = c[1],
							I = c[2];
						z.hasOwnProperty(b) && (I.length > 0 || i.eol())
							? (u = z[b])
							: i.backUp(i.current().length - 1);
					} else
						i.match(/^\t+/)
							? (u = 'invalid')
							: i.match(/^[\[\]{}\(\);\:]+/)
		...
		startState: function (i) {
			((i.tlvIndentationStyle = []),
				(i.tlvCodeActive = !0),
				(i.tlvNextIndent = -1),
				(i.tlvInBlockComment = !1));
		}
	}
});
export { Q as tlv, J as verilog };
//# sourceMappingURL=C6RDOZhf.js.map
