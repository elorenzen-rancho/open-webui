import { L as G, E as z, C as N } from './COV9u0MG.js';
import {
	s as I,
	t as p,
	E as Y,
...
function ge(e, t) {
	...
	for (
		;
		O.parent && O.to == t && !(!((o = O.lastChild) === null || o === void 0) && o.type.isError);
	)
		O = O.parent;
...
class ue {
	constructor(t, o, O) {
		((this.attrs = o),
			...
			(this.children = []),
			(this.name = t.name),
			(this.completion = Object.assign(Object.assign({ type: 'type' }, t.completion || {}), {
				label: this.name
			})),
...
function pe(e, t) {
	...
	return (n) => {
		...
		if (l == 'openTag') {
			...
			let v = g.concat(
				((m == null ? void 0 : m.children) || (S ? a : s)).map((x) => x.openCompletion)
			);
			...
			D.add({
				Element(e) {
					...
					return !t || t.name != 'OpenTag'
						? null
						: { from: t.to, to: o.name == 'CloseTag' ? o.from : e.to };
				}
			}),
...
const fe = Y.inputHandler.of((e, t, o, O, r) => {
	...
	let a = r(),
		...
		f = s.changeByRange((n) => {
			...
			let { head: l } = n,
				...
				S = A(s).resolveInner(l, -1),
				i;
			if (d && O == '>' && S.name == 'EndTag') {
				let m = S.parent;
				if (
					((c = ($ = m.parent) === null || $ === void 0 ? void 0 : $.lastChild) === null ||
					c === void 0
						? void 0
						: c.name) != 'CloseTag' &&
					(i = k(s.doc, m.parent, l))
				) {
	...
	return f.changes.empty
		? !1
		: (e.dispatch([a, s.update(f, { userEvent: 'input.complete', scrollIntoView: !0 })]), !0);
});
export { fe as autoCloseTags, pe as completeFromSchema, xe as xml, w as xmlLanguage };
//# sourceMappingURL=CCagcWwd.js.map
