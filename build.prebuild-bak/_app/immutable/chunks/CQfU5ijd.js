...
function u(e, n) {
	...
	if (t == '<') {
		...
		return (
			...
			D(n)
				? (c(n), 'variable')
				: ((f == 'element' || f == 'attribute' || a.type == 'axis_specifier') &&
						s(n, { type: 'xmlconstructor' }),
					a ? a.style : 'variable')
		);
	}
}
...
function N(e, n) {
	for (var t; (t = e.next()); )
		if (t == '-' && e.match('->', !0)) return ((n.tokenize = u), 'comment');
}
function E(e, n) {
	for (var t; (t = e.next()); )
		if (t == ']' && e.match(']', !0)) return ((n.tokenize = u), 'comment');
...
function A(e, n) {
	for (var t; (t = e.next()); )
		if (t == '?' && e.match('>', !0)) return ((n.tokenize = u), 'processingInstruction');
}
function b(e) {
	return k(e, 'tag');
}
...
export { C as xQuery };
//# sourceMappingURL=CQfU5ijd.js.map
