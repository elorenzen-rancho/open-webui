const e = 'À propos',
	...
	Mr = 'Thème',
	Ur = '',
	kr = 'Fil de discussion',
	Or = 'Tika',
	zr = 'Tiktoken',
	Nr = '',
	qr = "Délai d'expiration",
	Fr = 'Titre',
	jr = 'TLS',
	Vr = "Aujourd'hui",
	Wr = 'Token',
	...
	na = 'Téléverser',
	ra = 'URL',
	aa = 'Consommation de tokens',
	ia = 'Utilisez',
	la = 'utilisateur',
	ua = 'Utilisateur',
	ca = "Nom d'utilisateur",
	da = 'utilisateurs',
	pa = 'Utilisateurs',
	ma = 'Vannes',
	ha = 'variable',
	...
	Na = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 pour aucune limite, ou un entier positif pour une limite spécifique',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			" 's', 'm', 'h', 'd', 'w' ou '-1' pour une durée illimitée.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(par ex. `sh webui.sh --api --api-auth username_password`)',
		'(e.g. `sh webui.sh --api`)': '(par exemple `sh webui.sh --api`)',
		'(latest)': '(dernière version)',
		'(leave blank for to use commercial endpoint)':
			"laisser vide pour l'utilisation d'un point d'extension commercial",
		...
		'*Prompt node ID(s) are required for image generation':
			"*Les ID de noeud du prompt sont nécessaires pour la génération d'image",
		'1 hour before': '',
		'1 Source': '1 Source',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A collaboration channel where people join as members':
			'Un canal collaboratif où les membres rejoignent librement',
		'A discussion channel where access is controlled by groups and permissions':
			"Un canal de discussion où l'accès est contrôlé par les groupes et les permissions",
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Une nouvelle version (v{{LATEST_VERSION}}) est disponible.',
		'A private conversation between you and selected users':
			'Une conversation privée entre vous et les utilisateurs sélectionnés',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			"Un modèle de tâche est utilisé lors de l'exécution de tâches telles que la génération de titres pour les conversations et les requêtes de recherche sur le web.",
...
Renseigner les variables du prompt`,
		...
		'Action Required for Chat Log Storage':
			'Action requise pour l’enregistrement du journal de discussion',
		Actions: n,
		Activate: r,
		...
		'Add a short description about what this model does':
			'Ajoutez une brève description de ce que fait ce modèle.',
		...
		'Add your Open Terminal URL and API key in Settings → Integrations.':
			'Ajoutez votre URL Open Terminal et votre clé API dans Réglages → Intégrations.',
		...
		'Adds filenames, titles, sections, and snippets into the BM25 text to improve lexical recall.':
			'Ajoute les noms de fichiers, titres, sections et extraits dans le texte BM25 pour améliorer le rappel lexical.',
		'Adjusting these settings will apply changes universally to all users.':
			"L'ajustement de ces réglages appliquera universellement les changements à tous les utilisateurs.",
		admin: u,
		Admin: c,
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			"Les administrateurs ont accès à tous les outils en permanence ; les utilisateurs doivent se voir attribuer des outils pour chaque modèle dans l'espace de travail.",
		Advanced: d,
		...
		'Advanced parameters for MinerU parsing (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)':
			"Paramètres avancés pour l'analyse MinerU (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)",
		...
		'After updating or changing the embedding model, you must reindex the knowledge base for the changes to take effect. You can do this using the "Reindex" button below.':
			"Après avoir mis à jour ou modifié le modèle d'embedding, vous devez réindexer la base de connaissances pour que les changements prennent effet. Vous pouvez le faire en utilisant le bouton « Réindexer » ci-dessous.",
		AI: p,
		All: m,
		...
		'Allowed file extensions for upload. Separate multiple extensions with commas. Leave empty for all file types.':
			'Autoriser les extensions de fichier pour le téléversement. Séparez plusieurs extensions par des virgules. Laissez vide pour tous les types de fichiers.',
		'Already have an account?': 'Avez-vous déjà un compte ?',
		'Alternative to the top_p, and aims to ensure a balance of quality and variety. The parameter p represents the minimum probability for a token to be considered, relative to the probability of the most likely token. For example, with p=0.05 and the most likely token having a probability of 0.9, logits with a value less than 0.045 are filtered out.':
			"Alternative à top_p, et vise à assurer un équilibre entre qualité et variété. Le paramètre p représente la probabilité minimale pour qu'un token soit considéré, par rapport à la probabilité du token le plus probable. Par exemple, avec p=0.05 et le token le plus probable ayant une probabilité de 0.9, les logits d'une valeur inférieure à 0.045 sont filtrés.",
		Always: h,
		...
		'API Base URL for Datalab Marker service. Defaults to: https://www.datalab.to/api/v1/marker':
			"URL de base de l'API pour le service Datalab Marker. Par défaut : https://www.datalab.to/api/v1/marker",
		'API Key': 'Clé API',
		...
		'applies to all users with the "user" role':
			"s'applique à tous les utilisateurs ayant le rôle « utilisateur »",
		April: y,
		Archive: C,
		...
		'Are you sure you want to archive all chats? This action cannot be undone.':
			'Êtes-vous sûr de vouloir archiver toutes les conversations ? Cette action est irréversible.',
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Êtes-vous certain de vouloir supprimer toutes les mémoires ? Cette action est irréversible.',
		...
		"Are you sure you want to delete this version? Child versions will be relinked to this version's parent.":
			'Êtes-vous sûr de vouloir supprimer cette version ? Les versions enfants seront rattachées à la version parente.',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Êtes-vous sûr de vouloir désarchiver toutes les conversations ?',
		...
		'Autocomplete Generation Input Max Length':
			'Longueur maximale pour la génération des suggestions',
		Automatic1111: M,
		...
		'Automatically inject system tools in native function calling mode (e.g., timestamps, memory, chat history, notes, etc.)':
			"Injecte automatiquement les outils système en mode d'appel de fonctions natif (par ex. horodatage, mémoire, historique des conversations, notes, etc.)",
		Automation: U,
		'Automation created': '',
		'Automation Name': '',
		'Automation title': '',
		...
		'Boosting or penalizing specific tokens for constrained responses. Bias values will be clamped between -100 and 100 (inclusive). (Default: none)':
			'Renforcer ou pénaliser des éléments spécifiques pour les réponses contraintes. Les valeurs du biais seront comprises entre -100 et 100 (inclus). (Par défaut : aucun)',
		Brave: B,
		...
		'Call feature is not supported when using Web STT engine':
			"La fonction d'appel n'est pas prise en charge lors de l'utilisation du moteur Web STT",
		Camera: H,
		Cancel: Q,
		...
		'Channel name must be less than 128 characters':
			'Le nom du canal doit faire moins de 128 caractères',
		...
		'Character limit for autocomplete generation input':
			'Limite de caractères pour la génération des suggestions',
		...
		'Chunks smaller than this threshold will be merged with neighboring chunks when possible. Set to 0 to disable merging.':
			'Les chunks plus petits que ce seuil seront fusionnés avec les chunks voisins si possible. Définir à 0 pour désactiver la fusion.',
		Ciphers: re,
		Citation: ae,
		Citations: ie,
		...
		'Click here to download user import template file.':
			"Cliquez ici pour télécharger le fichier modèle d'importation des utilisateurs.",
		'Click here to learn more about faster-whisper and see the available models.':
			'Cliquez ici pour en savoir plus sur faster-whisper et voir les modèles disponibles.',
		...
		'Click here to upload a workflow.json file.':
			'Cliquez ici pour téléverser un fichier workflow.json.',
		'click here.': 'cliquez ici.',
		"Click on the user role button to change a user's role.":
			"Cliquez sur le bouton de rôle d'utilisateur pour modifier son rôle.",
		'Click to connect': '',
		'Click to copy ID': "Cliquez pour copier l'ID",
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			"L'autorisation d'écriture du presse-papier a été refusée. Veuillez vérifier les réglages de votre navigateur pour accorder l'accès nécessaire.",
		Clone: le,
		...
		'Collaboration channel where people join as members':
			'Canal collaboratif où les membres rejoignent librement',
		Collapse: de,
		Collection: pe,
		Collections: me,
		Color: he,
		...
		'Comma separated Node Ids (e.g. 1 or 1,2)':
			'ID de nœud séparés par des virgules (Ex : 1 ou 1,2)',
		command: ve,
		Command: fe,
		Comment: be,
		...
		'Connect to an AI provider to start chatting':
			"Connectez-vous à un fournisseur d'IA pour commencer à discuter",
		'Connect to Open Terminal instances to browse files and use them as always-on tools. Only one can be active at a time.':
			'Connectez-vous à des instances Open Terminal pour parcourir les fichiers et les utiliser comme outils permanents. Une seule peut être active à la fois.',
		'Connect to Open Terminal instances. All users will have access to file browsing and terminal tools through these servers.':
			'Connectez-vous à des instances Open Terminal. Tous les utilisateurs auront accès à la navigation de fichiers et aux outils de terminal via ces serveurs.',
		'Connect to your own OpenAI compatible API endpoints.':
			"Connectez-vous à vos points d'extension API compatibles OpenAI.",
		'Connect to your own OpenAPI compatible external tool servers.':
			"Connectez-vous à vos serveurs d'outils externes.",
		'Connected ({{type}})': '',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			"Contraint l'effort de raisonnement pour les modèles de raisonnement. Applicable uniquement aux modèles de raisonnement de certains fournisseurs qui prennent en charge l'effort de raisonnement.",
		...
		'Content lengths (character counts only)':
			'Longueur du contenu (nombre de caractères uniquement)',
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			'Contrôle la façon dont le texte des messages est divisé pour les demandes de Text-to-Speech. « ponctuation » divise en phrases, « paragraphes » divise en paragraphes et « aucun » garde le message en tant que chaîne de texte unique.',
		'Control the repetition of token sequences in the generated text. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 1.1) will be more lenient. At 1, it is disabled.':
			"Contrôle la répétition des séquences de tokens dans le texte généré. Une valeur plus élevée (par exemple, 1.5) pénalisera les répétitions plus fortement, tandis qu'une valeur plus basse (par exemple, 1.1) sera plus indulgente. À 1, elle est désactivée.",
		Controls: Pe,
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			"Contrôle l'équilibre entre la cohérence et la diversité du résultat. Une valeur plus faible se traduira par un texte plus ciblé et plus cohérent.",
		...
		'Copied shared chat URL to clipboard!':
			'URL de la conversation partagée copiée dans le presse-papiers !',
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			"Le réglage CORS doit être correctement configuré par le fournisseur pour autoriser les requêtes provenant de l'Open WebUI.",
		...
		'Create your first note by clicking on the plus button below.':
			'Créer votre première note en cliquant sur le boutton ci-dessous',
		'Created at': 'Créé le',
		'Created At': 'Créé le',
		'Created by': 'Créé par',
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			"Le mode par défaut fonctionne avec une plus large gamme de modèles en appelant les outils une fois avant l'exécution. Le mode natif exploite les capacités d'appel d'outils intégrées du modèle, mais nécessite que le modèle prenne en charge cette fonctionnalité.",
		...
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			"La recherche segmentée par défaut permet d'extraire un contenu ciblé et pertinent, ce qui est recommandé dans la plupart des cas.",
		...
		'Deployment names are required for Azure OpenAI':
			'Les noms de déploiement sont requis pour Azure OpenAI',
		Desc: We,
		...
		'Describe your knowledge base and objectives':
			'Décrivez votre base de connaissances et vos objectifs',
		Description: _e,
		Deselect: Ge,
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			"Les connexions directes permettent aux utilisateurs de se connecter à leurs propres points d'extension API compatibles OpenAI.",
		...
		'Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.':
			"Désactive l'extraction d'images du PDF. Si l'option Utiliser le LLM est activée, les images seront automatiquement légendées. La valeur par défaut est False.",
		Disabled: Ye,
		'Disconnect OAuth': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			"Découvrez comment utiliser Open WebUI et obtenir de l'aide de la communauté.",
		'Discover wonders': 'Découvrir des merveilles',
		'Discover, download, and explore custom functions':
			'Découvrez, téléchargez et explorez des fonctions personnalisées',
		'Discover, download, and explore custom prompts':
			'Découvrez, téléchargez et explorez des prompts personnalisés',
		'Discover, download, and explore custom tools':
			'Découvrez, téléchargez et explorez des outils personnalisés',
		'Discover, download, and explore model presets':
			'Découvrir, télécharger et explorer des préréglages de modèles',
		'Discussion channel where access is based on groups and permissions':
			"Canal de discussion où l'accès est basé sur les groupes et les permissions",
		Display: Je,
		...
		'Displays status updates (e.g., web search progress) in the response':
			'Affiche les mises à jour du statut dans la réponse (par ex : la progression de la recherche sur le Web)',
		'Dive into knowledge': 'Plonger dans les connaissances',
		'Do not install functions from sources you do not fully trust.':
			"N'installez pas de fonctions provenant de sources auxquelles vous ne faites pas entièrement confiance.",
		'Do not install tools from sources you do not fully trust.':
			"N'installez pas d'outils provenant de sources auxquelles vous ne faites pas entièrement confiance.",
		'Do you want to sync your usage stats with Open WebUI Community?':
			"Souhaitez-vous synchroniser vos statistiques d'utilisation avec la communauté Open WebUI ?",
		Docling: He,
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			"n'établit aucune connexion externe et garde vos données en sécurité sur votre serveur local.",
		'Domain Filter List': 'Liste des domaines à filtrés',
		"don't fetch random pipelines from sources you don't trust.":
			'Ne récupérez pas des pipelines aléatoires depuis des sources non fiables.',
		"Don't have an account?": "Vous n'avez pas de compte ?",
		"don't install random functions from sources you don't trust.":
			"n'installez pas de fonctions aléatoires provenant de sources auxquelles vous ne faites pas confiance.",
		"don't install random tools from sources you don't trust.":
			"n'installez pas d'outils aléatoires provenant de sources auxquelles vous ne faites pas confiance.",
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"par ex. '30s', '10 min'. Les unités de temps valides sont 's', 'm', 'h'.",
		...
		'e.g. A filter to remove profanity from text':
			'par ex. un filtre pour retirer les vulgarités du texte',
		...
		'e.g. Step-by-step instructions for code reviews':
			'par ex. Instructions détaillées pour les revues de code',
		'e.g. Tell me a fun fact': 'par ex. Partage-moi un fait amusant',
		'e.g. Tell me a fun fact about the Roman Empire':
			"par ex. Partage-moi un fait amusant sur l'Empire romain",
		'e.g. Tools for performing various operations':
			'par ex. Outils pour effectuer diverses opérations',
		...
		'e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)':
			'Ex : audio/wav,audio/mpeg,video/* (laisser vide pour les valeurs par défaut)',
		'e.g., en-US,ja-JP (leave blank for auto-detect)':
			'par ex., en-US, ja-JP (laisser vide pour détection automatique)',
		...
		'Enable autocomplete generation for chat messages':
			'Activer la génération des suggestions pour les messages',
		...
		'Enable Mirostat sampling for controlling perplexity.':
			"Activer l'échantillonnage Mirostat pour contrôler Perplexité.",
		...
		'Enable, disable, or customize the reasoning tags used by the model. "Enabled" uses default tags, "Disabled" turns off reasoning tags, and "Custom" lets you specify your own start and end tags.':
			'Activer, désactiver ou personnaliser les balises de raisonnement utilisées par le modèle. « Activé » utilise les balises par défaut, « Désactivé » désactive les balises de raisonnement, et « Sur mesure » permet de spécifier vos propres balises de début et de fin.',
		Enabled: pt,
		'End Tag': 'Tag de fin',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Vérifiez que votre fichier CSV comprenne les 4 colonnes dans cet ordre : Name, Email, Password, Role.',
		...
		'Enter a title for the pending user info overlay. Leave empty for default.':
			"Entrez un titre pour l'interface utilisateur en attente. Laissez vide pour le défaut.",
		'Enter a watermark for the response. Leave empty for none.':
			'Entrez un filigrane pour la réponse. Laissez vide pour aucun.',
		'Enter additional headers in JSON format': 'Entrez les en-têtes supplémentaires au format JSON',
		'Enter additional headers in JSON format (e.g. {"X-Custom-Header": "value"}':
			'Entrez les en-têtes supplémentaires au format JSON (par ex. {"X-Custom-Header": "value"}',
		'Enter additional parameters in JSON format':
			'Entrez les paramètres supplémentaires au format JSON',
		'Enter api auth string (e.g. username:password)':
			"Entrez la chaîne d'authentification de l'API (par ex. nom d'utilisateur:mot de passe)",
		...
		'Enter comma-separated "token:bias_value" pairs (example: 5432:100, 413:-100)':
			'Entrez des paires "token:valeur_biais" séparées par des virgules (exemple : 5432:100, 413:-100)',
		'Enter content for the pending user info overlay. Leave empty for default.':
			"Entrez le contenu pour l'interface utilisateur en attente. Laissez vide pour le défaut.",
		...
		'Enter domains separated by commas (e.g., example.com,site.org,!excludedsite.com)':
			'Entrez les domaines séparés par des virgules (par ex. example.com,site.org,!excludedsite.com)',
		...
		'Enter function name filter list (e.g. func1, !func2)':
			'Entrez la liste de filtres de fonctions (par ex. func1, !func2)',
		...
		'Enter JSON config (e.g., {"disable_links": true})':
			'Entrez la configuration JSON (par ex. {"disable_links": true})',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			"Entrez l'URL du proxy (par ex. https://user:password@host:port)",
		...
		'Enter skill instructions in markdown...':
			'Entrez les instructions du skill au format markdown...',
		...
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			"Entrez l'URL publique de votre WebUI. Cette URL sera utilisée pour générer des liens dans les notifications.",
		...
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			"Entrez l'URL Yacy (par ex. http://yacy.example.com:8090)",
		...
		"Error: A model with the ID '{{modelId}}' already exists. Please select a different ID to proceed.":
			"Erreur : Un modèle avec l'ID '{{modelId}}' existe déjà. Veuillez sélectionner un ID différent pour continuer.",
		'Error: Model ID cannot be empty. Please enter a valid ID to proceed.':
			"Erreur : l'ID du modèle ne peut pas être vide. Veuillez saisir un ID valide pour continuer.",
		Evaluations: vt,
		'Event created': '',
		'Event deleted': '',
		'Event title': '',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Exemple: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Exemple: sAMAccountName ou uid ou userPrincipalName',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			'Le nombre de sièges de votre licence est dépassé. Veuillez contacter le support pour augmenter le nombre de sièges.',
		Exclude: ft,
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			"Échec de la connexion au serveur d'outils OpenAPI {{URL}}",
		'Failed to connect to {{URL}} terminal server':
			'Échec de la connexion au serveur de terminal {{URL}}',
		...
		'Failed to extract content from the file: {{error}}':
			"Échec de l'extraction du contenu du fichier : {{error}}",
		...
		'Failed to load DOCX file. Please try downloading it instead.':
			'Échec du chargement du fichier DOCX. Essayez plutôt de le télécharger.',
		'Failed to load Excel/CSV file. Please try downloading it instead.':
			'Échec du chargement du fichier Excel/CSV. Essayez plutôt de le télécharger.',
		...
		'Failed to load PPTX file. Please try downloading it instead.':
			'Échec du chargement du fichier PPTX. Essayez plutôt de le télécharger.',
		...
		'File size should not exceed {{maxSize}} MB.':
			'La taille du fichier ne doit pas dépasser {{maxSize}} Mo.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			"Spoofing détecté : impossible d'utiliser les initiales comme avatar. Retour à l'image de profil par défaut.",
		...
		'Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.':
			"Forcer l'OCR sur toutes les pages du PDF. Cela peut entraîner de moins bons résultats si vous avez du texte de bonne qualité dans vos PDF. La valeur par défaut est False.",
		...
		'Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.':
			'Formate les lignes dans la sortie. Désactivé par défaut. Si activé, les lignes seront formatées pour détecter les formules mathématiques et les styles.',
		'Formatting may be inconsistent from source.':
			'Le formatage peut être incohérent par rapport à la source.',
		Forward: Nt,
		'Forwards system user OAuth access token to authenticate':
			"Transfère le jeton d'accès OAuth de l'utilisateur système pour l'authentification",
		'Forwards system user session credentials to authenticate':
			"Transmet les identifiants de session de l'utilisateur pour l'authentification",
		Fr_day_of_week: qt,
		...
		'Get current time and perform date/time calculations':
			'Récupérer la date/heure actuelle et effectuer des calculs associés',
		'Get information on {{name}} in the UI':
			"Obtenir des informations sur {{name}} dans l'interface utilisateur",
		...
		'Help the community discover great models':
			'Aidez la communauté à découvrir les meilleurs modèles',
		'Hex Color': 'Couleur Hex',
		'Hex Color - Leave empty for default color':
			'Couleur Hex - Laissez vide pour la couleur par défaut',
		Hidden: so,
		Hide: no,
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			"Je reconnais avoir lu et compris les implications de mes actions. Je suis conscient des risques associés à l'exécution d'un code arbitraire et j'ai vérifié la fiabilité de la source.",
		ID: po,
		'ID cannot contain ":" or "|" characters':
			"L'ID ne peut pas contenir les caractères « : » ou « | »",
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			"Inclure le flag `--api-auth` lors de l'exécution de stable-diffusion-webui",
		'Include `--api` flag when running stable-diffusion-webui':
			"Inclure le flag `--api` lors de l'exécution de stable-diffusion-webui",
		...
		'Influences how quickly the algorithm responds to feedback from the generated text. A lower learning rate will result in slower adjustments, while a higher learning rate will make the algorithm more responsive.':
			"Influe sur la rapidité avec laquelle l'algorithme répond aux retours d'information du texte généré. Un taux d'apprentissage plus bas entraînera des ajustements plus lents, tandis qu'un taux d'apprentissage plus élevé rendra l'algorithme plus réactif.",
		Info: bo,
		Initials: Ao,
		'Inject file content into conversation context':
			'Injecte le contenu du fichier dans le contexte de la conversation',
		'Inject the entire content as context for comprehensive processing, this is recommended for complex queries.':
			"Injecter l'ensemble du contenu comme contexte pour un traitement complet, recommandé pour les requêtes complexes.",
		Input: yo,
		'Input Key (e.g. text, unet_name, steps)':
			"Clé de la variable d'entrée (par ex. text, unet_name, steps)",
		...
		'Invalid JSON format for ComfyUI Edit Workflow.':
			"Format JSON non valide pour le workflow ComfyUI de modification d'image.",
		...
		'Invalid JSON format in Additional Config':
			'Format JSON non valide dans la configuration supplémentaire',
		...
		'Keep Follow-Up Prompts in Chat':
			'Conserver les questions de suivi précédentes dans la conversation',
		...
		'Leave empty to include all models or select specific models':
			'Laissez vide pour inclure tous les modèles ou sélectionnez des modèles spécifiques',
		'Leave empty to use first admin user':
			"Laissez vide pour utiliser l'email du premier administrateur",
		'Leave empty to use the default config, or enter a valid json (see https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)':
			'Laissez vide pour utiliser la configuration par défaut, ou entrez un JSON valide (voir https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)',
		'Leave empty to use the default model (voxtral-mini-latest).':
			'Laissez vide pour utiliser le modèle par défaut (voxtral-mini-latest).',
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Laissez vide pour utiliser le prompt par défaut, ou entrez un prompt personnalisé',
		'Leave model field empty to use the default model.':
			'Laisser le champ du modèle vide pour utiliser le modèle par défaut.',
		Legacy: zo,
		lexical: No,
		License: qo,
		...
		'Limit concurrent search queries. 0 = unlimited (default). Set to 1 for sequential execution (recommended for APIs with strict rate limits like Brave free tier).':
			'Limite les requêtes de recherche simultanées. 0 = illimité (par défaut). Définir à 1 pour une exécution séquentielle (recommandé pour les API avec des limites de débit strictes comme Brave gratuit).',
		'Limits the number of concurrent embedding requests. Set to 0 for unlimited.':
			"Limite le nombre de requêtes d'embedding simultanées. Définir à 0 pour illimité.",
		List: jo,
		...
		'LLMs can make mistakes. Verify important information.':
			'Les LLM peuvent faire des erreurs. Vérifiez les informations importantes.',
		Loader: Wo,
		...
		'Make password visible in the user interface':
			"Rendre visible les mots de passe dans l'interface",
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Veillez à exporter un fichier workflow.json au format API depuis ComfyUI.',
		Male: Ho,
		Manage: Qo,
		...
		'Maximum number of files allowed per folder.':
			'Nombre maximum de fichiers autorisés par dossier.',
		'Maximum number of files per folder is {{max}}.':
			'Le nombre maximum de fichiers par dossier est de {{max}}.',
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Un maximum de 3 modèles peut être téléchargé en même temps. Veuillez réessayer ultérieurement.',
		May: $o,
		MBR: es,
		MCP: ts,
		'MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Open WebUI team, making it the more reliable option for compatibility.':
			"Le support du MCP est expérimental et sa spécification évolue fréquemment, ce qui peut entraîner des incompatibilités. Le support de la spécification OpenAPI est directement maintenu par l'équipe Open WebUI, ce qui en fait l'option la plus fiable en termes de compatibilité.",
		Medium: os,
		...
		'Memories accessible by LLMs will be shown here.':
			'Les souvenirs accessibles par les LLMs seront affichées ici.',
		Memory: as,
		...
		'Message counts are based on assistant responses.':
			"Le nombre de messages est basé sur le nombre de réponses de l'assistant.",
		'Message rating should be enabled to use this feature':
			"L'évaluation des messages doit être activée pour pouvoir utiliser cette fonctionnalité",
		messages: ls,
		Messages: us,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			"Les messages que vous envoyez après avoir créé votre lien ne seront pas partagés. Les utilisateurs disposant de l'URL pourront voir la conversation partagée.",
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Le modèle '{{modelName}}' a été téléchargé avec succès.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Le modèle '{{modelTag}}' est déjà dans la file d'attente pour le téléchargement.",
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': '',
		'Model {{modelName}} is not vision capable':
			"Le modèle {{modelName}} n'a pas de fonctionnalité de vision",
		...
		'Model can execute code and perform calculations':
			'Le modèle peut exécuter du code et faire des calculs',
		'Model can generate images based on text prompts':
			'Le modèle peut générer des images à partir de prompts',
		'Model can search the web for information':
			'Le modèle peut faire des recherches sur internet pour trouver des informations',
		'Model Capabilities': 'Capacités du modèle',
		'Model created successfully!': 'Modèle créé avec succès !',
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			"Chemin du système de fichiers de modèle détecté. Le nom court du modèle est requis pour la mise à jour, l'opération ne peut pas être poursuivie.",
		...
		'Model name already exists, please choose a different one':
			'Le nom du modèle existe déjà, veuillez en choisir un autre',
		...
		'Model(s) do not support file upload':
			'Le(s) modèle(s) ne supportent pas le téléversement de fichiers',
		...
		'Models imported successfully': 'Modèle importé avec succès',
		...
		'Name and ID are required, please fill them out':
			"Le nom et l'ID sont obligatoires, veuillez les remplir",
		...
		'No expiration can pose security risks.':
			"L'absence d'expiration peut présenter des risques de sécurité.",
		...
		'No files yet. Upload files or run Python code to create them.':
			'Aucun fichier pour le moment. Téléversez des fichiers ou exécutez du code Python pour en créer.',
		...
		'No inference engine with management support found':
			"Aucun moteur d'inférence avec support trouvé",
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Note : Si vous définissez un score minimum, seuls les documents ayant un score supérieur ou égal à ce score minimum seront retournés par la recherche.',
		Notes: xs,
		...
		'Only active when "Paste Large Text as File" setting is toggled on.':
			'Uniquement lorsque le paramètre "Coller un texte volumineux comme fichier" est activé.',
		'Only active when the chat input is in focus and an LLM is generating a response.':
			"Uniquement lorsque la zone de saisie de la conversation est active et qu'un LLM génère une réponse.",
		'Only active when the chat input is in focus.':
			'Uniquement lorsque la zone de saisie de la conversation est active.',
		...
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Seuls les caractères alphanumériques et les tirets sont autorisés dans la chaîne de commande.',
		'Only can be triggered when the chat input is in focus.':
			'Ne peut être déclenché que lorsque le champ de saisie est actif.',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Seules les collections peuvent être modifiées, créez une nouvelle base de connaissances pour modifier/ajouter des documents.',
		...
		'Only select users and groups with permission can access':
			'Seuls les utilisateurs et groupes autorisés peuvent accéder',
		...
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			"Oups ! Des fichiers sont encore en cours de téléversement. Veuillez patienter jusqu'à la fin du téléversement.",
		'Oops! There was an error in the previous response.':
			'Oups ! Il y a eu une erreur dans la réponse précédente.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			"Oups ! Vous utilisez une méthode non prise en charge (frontend uniquement). Veuillez servir l'interface Web à partir du backend.",
		...
		'Open Modal To Manage Floating Quick Actions':
			'Ouvrir la fenêtre de gestion des actions rapides flottantes',
		'Open Modal To Manage Image Compression':
			"Ouvrir la fenêtre de gestion de la compression d'images",
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			"Open WebUI peut utiliser les outils fournis par n'importe quel serveur OpenAPI.",
		...
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open WebUI utilise SpeechT5 et les embeddings de locuteur CMU Arctic.',
		'Open WebUI version': "Version d'Open WebUI",
		...
		'Page mode creates one document per page. Single mode combines all pages into one document for better chunking across page boundaries.':
			'Le mode Page crée un document par page. Le mode Unique combine toutes les pages en un seul document pour une meilleure segmentation à travers les limites de page.',
		Paginate: Js,
		Parameters: Hs,
		...
		'Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Open WebUI. Your privacy is paramount: no message content is ever shared.':
			"Participez aux classements et évaluations de la communauté ! La synchronisation des statistiques d'utilisation agrégées contribue à l'amélioration d'Open WebUI. Votre vie privée est primordiale : aucun contenu de message n'est jamais partagé.",
		Password: Qs,
		...
		'Permission denied when accessing microphone: {{error}}':
			'Accès au microphone refusé : {{error}}',
		Permissions: en,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines est un système de plug‑ins permettant l’exécution arbitraire de code —',
		...
		'Please do not close the settings page while loading the model.':
			'Veuillez ne pas fermer les réglages pendant le chargement du modèle.',
		...
		'Please save the connection to persist the OAuth client information and do not change the ID':
			"Veuillez enregistrer la connexion pour conserver les informations du client OAuth et ne modifiez pas l'ID",
		...
		'Please select at least one user for Direct Message channel.':
			'Veuillez sélectionner au moins un utilisateur pour un canal de message direct.',
		'Please wait until all files are uploaded.':
			"Veuillez patienter jusqu'à ce que tous les fichiers soient téléchargés.",
		'Policy ID': '',
		Port: un,
		Ports: cn,
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			"Le préfixe ID est utilisé pour éviter les conflits avec d'autres connexions en ajoutant un préfixe aux ID de modèle - laissez vide pour désactiver",
		...
		'Private conversation between selected users':
			'Conversation privée entre les utilisateurs sélectionnés',
		...
		'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative.':
			"Réduit la probabilité de générer du contenu incohérent. Une valeur plus élevée (ex. : 100) produira des réponses plus variées, tandis qu'une valeur plus faible (ex. : 10) sera plus conservatrice.",
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			"Désignez-vous comme « Utilisateur » (par ex. « L'utilisateur apprend l'espagnol »)",
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			"Les notifications de réponse ne peuvent pas être activées car les autorisations du site web ont été refusées. Veuillez vérifier les réglages de votre navigateur pour accorder l'accès nécessaire.",
		...
		'Runs embedding tasks concurrently to speed up processing. Turn off if rate limits become an issue.':
			"Exécute les tâches d'embedding en parallèle pour accélérer le traitement. Désactivez si les limites de débit posent problème.",
		Sa_day_of_week: Kn,
		Save: Yn,
		...
		'Search and manage user memories':
			"Rechercher et gérer les éléments mémorisés de l'utilisateur",
		'Search and view user chat history':
			"Rechercher et afficher l'historique des conversations de l'utilisateur",
		'Search Automations': '',
		...
		'Search the web and fetch URLs':
			"Rechercher sur le web et récupérer le contenu de sites web à partir d'une URL",
		'Search Tools': 'Rechercher des outils',
		'Search, view, and manage user notes':
			"Rechercher, afficher et gérer les notes de l'utilisateur",
		...
		'Searching Knowledge for "{{searchQuery}}"':
			'Recherche des connaissances pour « {{searchQuery}} »',
		...
		'Searxng search language (all, en, es, de, fr, etc.)':
			'Langue de recherche SearXNG (all, en, es, de, fr, etc.)',
		...
		'Select how to split message text for TTS requests':
			'Sélectionnez comment diviser le texte du message pour les requêtes TTS',
		...
		'Selected model(s) do not support image inputs':
			"Les modèle(s) sélectionné(s) ne prennent pas en charge les entrées d'images",
		...
		'Set the default models that are automatically selected for all users when a new chat is created.':
			"Définit les modèles sélectionnés par défaut pour tous les utilisateurs lorsqu'une nouvelle conversation est créée.",
		'Set the models that are automatically pinned to the sidebar for all users.':
			'Définit les modèles qui sont automatiquement épinglés à la barre latérale pour tous les utilisateurs.',
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			"Définir le nombre de couches qui seront déchargées sur le GPU. Augmenter cette valeur peut améliorer considérablement les performances pour les modèles optimisés pour l'accélération GPU, mais peut également consommer plus d'énergie et de ressources GPU.",
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Applique un biais uniforme contre les tokens déjà apparus. Une valeur élevée (ex. : 1,5) pénalise fortement les répétitions, une valeur faible (ex. : 0,9) les tolère davantage. À 0, ce réglage est désactivé.',
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			"Applique un biais progressif contre les tokens en fonction de leur fréquence d'apparition. Une valeur plus élevée les pénalise davantage ; une valeur plus faible est plus indulgente. À 0, ce réglage est désactivé.",
		'Sets how far back for the model to look back to prevent repetition.':
			'Définit la profondeur de rétrospection du modèle pour éviter les répétitions.',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			'Définit la graine du générateur aléatoire pour produire un résultat déterministe. Une même graine produira toujours la même sortie pour une invite donnée.',
		'Sets the size of the context window used to generate the next token.':
			'Définit la taille de la fenêtre de contexte utilisée pour générer le prochain token.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			"Définit les séquences d'arrêt à utiliser. Lorsque ce motif est rencontré, le LLM cessera de générer du texte et retournera. Plusieurs motifs d'arrêt peuvent être définis en spécifiant plusieurs réglages d'arrêt distincts dans un fichier modèle.",
		Setting: nr,
		Settings: rr,
		...
		'Show "What\'s New" modal on login':
			'Afficher la fenêtre modale "Quoi de neuf" lors de la connexion',
		'Show Admin Details in Account Pending Overlay':
			"Afficher les coordonnées de l'administrateur aux comptes en attente",
		...
		'Showing all messages (user + assistant) per user.':
			'Affichage de tous les messages (utilisateur + assistant) par utilisateur.',
		'Sign in': 'Connexion',
		...
		'Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.':
			'Améliore significativement la précision en utilisant un LLM pour enrichir les tableaux, formulaires, formules mathématiques et la détection de mise en page. Augmente la latence. Désactivé par défaut.',
		...
		'Skip the cache and re-run the inference. Defaults to False.':
			"Ne pas utiliser le cache et re executer l'inférence. Par defaut à False",
		...
		'Split documents by markdown headers before applying character/token splitting.':
			"Découper les documents par en-têtes markdown avant d'appliquer le découpage par caractères/tokens.",
		...
		'Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.':
			"Supprimer le texte OCR existant du PDF et réexécuter l'OCR. Ignoré si la fonction Force OCR est activée. Par défaut à False.",
		...
		'Successfully imported {{userCount}} users.':
			'{{userCount}} utilisateurs importés avec succès.',
		...
		'Syncs only chats with updates after your last sync timestamp. Disable to re-sync all chats.':
			'Synchronise uniquement les conversations mises à jour depuis la dernière synchronisation. Désactivez pour re-synchroniser toutes les conversations.',
		System: Ir,
		...
		'Tail free sampling is used to reduce the impact of less probable tokens from the output. A higher value (e.g., 2.0) will reduce the impact more, while a value of 1.0 disables this setting.':
			"Le sampling sans queue est utilisé pour réduire l'impact des tokens moins probables dans la sortie. Une valeur plus élevée (par exemple, 2.0) réduira davantage l'impact, tandis qu'une valeur de 1.0 désactive ce réglage.",
		...
		'The Application Account DN you bind with for search':
			"Le DN du compte de l'application avec lequel vous vous liez pour la recherche",
		...
		'The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.':
			'La taille du lot détermine combien de requêtes texte sont traitées simultanément. Une taille plus grande améliore les performances mais consomme plus de mémoire.',
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Les développeurs de ce plugin sont des bénévoles passionnés issus de la communauté. Si vous trouvez ce plugin utile, merci de contribuer à son développement.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Le classement est basé sur le système de notation Elo et est mis à jour en temps réel.',
		'The format to return a response in. Format can be json or a JSON schema.':
			'Le format dans lequel la réponse doit être renvoyée. Le format peut être json ou un schéma JSON.',
		'The height in pixels to compress images to. Leave empty for no compression.':
			'Hauteur en pixels à laquelle les images doivent être compressées. Laisser vide pour ne pas compresser.',
		'The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.':
			"La langue de l'audio d'entrée. Fournir la langue d'entrée au format ISO-639-1 (par ex. en) améliorera la précision et la latence. Laisser vide pour détecter automatiquement la langue.",
		'The LDAP attribute that maps to the mail that users use to sign in.':
			"L'attribut LDAP qui correspond à l'adresse e-mail que les utilisateurs utilisent pour se connecter.",
		'The LDAP attribute that maps to the username that users use to sign in.':
			"L'attribut LDAP qui correspond au nom d'utilisateur que les utilisateurs utilisent pour se connecter.",
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			"Le classement est actuellement en version bêta et nous pouvons ajuster les calculs de notation à mesure que nous peaufinons l'algorithme.",
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'La taille maximale du fichier en Mo. Si la taille du fichier dépasse cette limite, le fichier ne sera pas téléchargé.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'Le nombre maximal de fichiers pouvant être utilisés en même temps dans la conversation. Si le nombre de fichiers dépasse cette limite, les fichiers ne seront pas téléchargés.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			"Le format de sortie du texte. Il peut s'agir de « json », “markdown” ou « html ». La valeur par défaut est « markdown ».",
		"The passwords you entered don't quite match. Please double-check and try again.":
			'Les mots de passe saisis ne correspondent pas exactement. Veuillez vérifier et réessayer.',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Le score doit être une valeur comprise entre 0,0 (0%) et 1,0 (100%).',
		'The stream delta chunk size for the model. Increasing the chunk size will make the model respond with larger pieces of text at once.':
			'La taille des blocs delta du streaming pour le modèle. Augmenter la taille des blocs fera répondre le modèle avec de plus grands morceaux de texte à la fois.',
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'La température du modèle. Une température plus élevée rend les réponses plus créatives.',
		'The Weight of BM25 Hybrid Search. 0 more semantic, 1 more lexical. Default 0.5':
			'Poids de la recherche hybride BM25. 0 = plus sémantique, 1 = plus lexical. Par défaut : 0.5',
		'The width in pixels to compress images to. Leave empty for no compression.':
			'Largeur en pixels à laquelle les images doivent être compressées. Laisser vide pour ne pas compresser.',
		Theme: Mr,
		'There was an error syncing your stats. Please try again.':
			'Une erreur est survenue lors de la synchronisation de vos statistiques. Veuillez réessayer.',
		'Thinking...': 'En train de réfléchir...',
		'This action cannot be undone. Do you wish to continue?':
			'Cette action ne peut pas être annulée. Souhaitez-vous continuer ?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'Ce canal a été créé le {{createdAt}}. Voici le tout début du canal {{channelName}}.',
		"This chat won't appear in history and your messages will not be saved.":
			"Cette conversation n'apparaîtra pas dans l'historique et vos messages ne seront pas enregistrés.",
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Cela garantit que vos conversations précieuses soient sauvegardées en toute sécurité dans votre base de données backend. Merci !',
		'This feature is currently experimental and may not work as expected.':
			'Cette fonctionnalité est actuellement expérimentale et peut ne pas fonctionner comme prévu.',
		'This feature is experimental and may be modified or discontinued without notice.':
			'Cette fonctionnalité est expérimentale et peut être modifiée ou interrompue sans préavis.',
		'This folder is empty': 'Ce dossier est vide',
		'This is a default user permission and will remain enabled.':
			'Ceci est une permission utilisateur par défaut et restera activée.',
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			"Il s'agit d'une fonctionnalité expérimentale, elle peut ne pas fonctionner comme prévu et est sujette à modification à tout moment.",
		'This model is not publicly available. Please select another model.':
			"Ce modèle n'est pas disponible au public. Veuillez sélectionner un autre modèle.",
		'This option controls how long the model will stay loaded into memory following the request (default: 5m)':
			'Cette option détermine la durée pendant laquelle le modèle restera chargé en mémoire après la demande (par défaut : 5m).',
		'This option controls how many tokens are preserved when refreshing the context. For example, if set to 2, the last 2 tokens of the conversation context will be retained. Preserving context can help maintain the continuity of a conversation, but it may reduce the ability to respond to new topics.':
			'Cette option détermine combien de Token sont conservés lors du rafraîchissement du contexte. Par exemple, avec une valeur de 2, les 2 derniers Token seront conservés. Cela aide à maintenir la continuité de la conversation, mais peut limiter la capacité à traiter de nouveaux sujets.',
		'This option enables or disables the use of the reasoning feature in Ollama, which allows the model to think before generating a response. When enabled, the model can take a moment to process the conversation context and generate a more thoughtful response.':
			"Cette option active ou désactive l'utilisation de la fonctionnalité de raisonnement dans Ollama, qui permet au modèle de réfléchir avant de générer une réponse. Lorsqu'elle est activée, le modèle peut prendre un moment pour traiter le contexte de la conversation et générer une réponse plus réfléchie.",
		'This option sets the maximum number of tokens the model can generate in its response. Increasing this limit allows the model to provide longer answers, but it may also increase the likelihood of unhelpful or irrelevant content being generated.':
			'Cette option définit le nombre maximal de tokens que le modèle peut générer dans sa réponse. Une valeur plus élevée permet des réponses plus longues, mais peut aussi générer du contenu moins pertinent.',
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Cette option supprimera tous les fichiers existants dans la collection et les remplacera par les fichiers nouvellement téléchargés.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Cela supprimera <strong>{{NAME}}</strong> et <strong>tout son contenu</strong>.',
		'This will delete all models including custom models':
			'Cela supprimera tous les modèles, y compris les modèles personnalisés',
		'This will delete all models including custom models and cannot be undone.':
			'Cela supprimera tous les modèles, y compris les modèles personnalisés, et ne peut pas être annulé.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Cela réinitialisera la base de connaissances et synchronisera tous les fichiers. Souhaitez-vous continuer ?',
		...
		'Thumbs up/down ratings from users on model responses':
			'Évaluations des utilisateurs (pouces vers le haut/bas) sur les réponses du modèle',
		Tika: Or,
		...
		'To access the available model names for downloading,':
			'Pour accéder aux noms des modèles disponibles,',
		'To access the GGUF models available for downloading,':
			'Pour accéder aux modèles GGUF disponibles,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			"Pour accéder à l'interface Web, veuillez contacter l'administrateur. Les administrateurs peuvent gérer les statuts des utilisateurs depuis le panneau d'administration.",
		...
		'To learn more about available endpoints, visit our documentation.':
			'Pour en savoir plus sur les points de terminaison disponibles, consultez notre documentation.',
		...
		'Toggle whether current connection is active.':
			'Afficher/masquer si la connection courante est active',
		Token: Wr,
		'Token counts are estimates and may not reflect actual API usage':
			"Le nombre de tokens est une estimation et peut ne pas refléter l'utilisation réelle de l'API",
		tokens: _r,
		Tokens: Gr,
		...
		'Type Hugging Face Resolve (Download) URL':
			"Entrez l'URL de Téléchargement Hugging Face Resolve",
		...
		'Update for the latest features and improvements.':
			'Mettez à jour pour bénéficier des dernières fonctionnalités et améliorations.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			"Effectuez la mise à niveau vers le plan payant pour bénéficier de fonctionnalités améliorées, notamment les thèmes et le branding personnalisé, ainsi qu'un support dédié.",
		Upload: na,
		...
		'Upload Progress: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)':
			'Progression du téléchargement : {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Utilisez '#' dans la zone de saisie du prompt pour charger et inclure vos connaissances.",
		'Use /v1/chat/completions endpoint instead of /v1/audio/transcriptions for potentially better accuracy.':
			'Utilise le endpoint /v1/chat/completions au lieu de /v1/audio/transcriptions pour une meilleure précision potentielle.',
		'Use Chat Completions API': "Utiliser l'API Chat Completions",
		'Use groups to organize your users and assign permissions.':
			'Utilisez les groupes pour organiser vos utilisateurs et attribuer des permissions.',
		'Use LLM': 'Utiliser le LLM',
		'Use no proxy to fetch page contents.':
			'Ne pas utiliser de proxy pour récupérer le contenu des pages.',
		'Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.':
			"Utiliser le proxy défini par les variables d'environnement http_proxy et https_proxy pour récupérer le contenu des pages.",
		user: la,
		User: ua,
		...
		'Uses DefaultAzureCredential to authenticate':
			"Utilise DefaultAzureCredential pour s'authentifier",
		'Uses OAuth 2.1 Dynamic Client Registration':
			"Utilise l'enregistrement dynamique de client OAuth 2.1",
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			"Utilisation du modèle d'arène par défaut avec tous les modèles. Cliquez sur le bouton plus pour ajouter des modèles personnalisés.",
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Version {{selectedVersion}} de {{totalVersions}}',
		...
		'Voice Mode Custom Prompt': 'Personnaliser le prompt du mode vocal',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Avertissement : Activer cette option permettra aux utilisateurs de télécharger du code arbitraire sur le serveur.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			"Avertissement : L'exécution Jupyter permet l'exécution de code arbitraire, ce qui présente des risques de sécurité importants. Procédez avec une extrême prudence.",
		We_day_of_week: Ca,
		Web: Sa,
		'Web API': 'API Web',
		...
		'WebUI will make requests to "{{url}}/api/chat"':
			'WebUI fera des requêtes à "{{url}}/api/chat"',
		'WebUI will make requests to "{{url}}/chat/completions"':
			'WebUI fera des requêtes à "{{url}}/chat/completions"',
		Week: wa,
		Weekly: Ia,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			"Lorsqu'il est activé, le modèle répondra à chaque message de la conversation en temps réel, générant une réponse dès que l'utilisateur envoie un message. Ce mode est utile pour les applications de conversation en direct, mais peut affecter les performances sur un matériel plus lent.",
		...
		'Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.':
			'Indique si la sortie doit être paginée. Chaque page sera séparée par une règle horizontale et un numéro de page. La valeur par défaut est False.',
		...
		'Works together with top-k. A higher value (e.g., 0.95) will lead to more diverse text, while a lower value (e.g., 0.5) will generate more focused and conservative text.':
			"Fonctionne avec top-k. Une valeur élevée (par exemple, 0,95) conduira à un texte plus diversifié, tandis qu'une valeur plus faible (par exemple, 0,5) générera un texte plus ciblé et conservateur.",
		Workspace: Ra,
		'Workspace Permissions': "Autorisations de l'espace de travail",
		Write: Da,
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Rédigez un résumé de 50 mots qui résume [sujet ou mot-clé].',
...
par. ex. : Vous êtes Mario de Super Mario Bros et vous agissez comme assistant.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			"Vous utilisez actuellement une licence d'essai. Veuillez contacter le support pour mettre à niveau votre licence.",
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			"Vous ne pouvez discuter qu'avec un maximum de {{maxCount}} fichier(s) à la fois.",
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Vous pouvez personnaliser vos interactions avec les LLM en ajoutant des mémoires à l'aide du bouton « Gérer » ci-dessous, ce qui les rendra plus utiles et mieux adaptées à vos besoins.",
		...
		'You do not have permission to edit this prompt.':
			"Vous n'êtes pas autorisé à modifier ce prompt.",
		'You do not have permission to edit this skill.':
			"Vous n'êtes pas autorisé à modifier ce skill.",
		...
		'You do not have permission to make this public':
			"Vous n'êtes pas autorisé à rendre ceci public",
		'You do not have permission to send messages in this channel.':
			"Vous n'êtes pas autorisé à envoyer des messages dans ce canal.",
		'You do not have permission to send messages in this thread.':
			"Vous n'êtes pas autorisé à envoyer des messages dans ce fil de discussion.",
		'You do not have permission to upload files to this knowledge base.':
			"Vous n'êtes pas autorisé à téléverser des fichiers dans cette base de connaissances.",
		'You do not have permission to upload files.':
			"Vous n'êtes pas autorisé à téléverser des fichiers.",
		'You do not have permission to upload web content.':
			"Vous n'êtes pas autorisé à joindre une page web.",
		...
		'Your account status is currently pending activation.':
			"Votre statut de compte est actuellement en attente d'activation.",
		...
		'Your usage stats have been successfully synced.':
			"Vos statistiques d'utilisation ont été synchronisées avec succès.",
		YouTube: za,
...
//# sourceMappingURL=CS2Yzp7m.js.map
