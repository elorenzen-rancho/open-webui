import { g as ze } from './BPRsW9hX.js';
import { s as Xe } from './Dc-KqKSo.js';
import {
	_ as d,
	D as Be,
	b as Je,
			...
			parse: d(function (i) {
				...
				function Ue() {
					...
					return (
						(T = s.pop() || S.lex() || Pe),
						typeof T != 'number' &&
							(T instanceof Array && ((s = T), (T = s.pop())), (T = n.symbols_[T] || T)),
						T
					);
				}
				d(Ue, 'lex');
...
Expecting ` +
					...
					if (q[0] instanceof Array && q.length > 1)
						throw new Error(
							'Parse Error: multiple actions possible at state: ' + z + ', token: ' + I
						);
					switch (q[0]) {
						case 1:
							(l.push(I),
						...
						case 2:
							if (
								...
								return Te;
							(F &&
								((l = l.slice(0, -1 * F * 2)), (R = R.slice(0, -1 * F)), (t = t.slice(0, -1 * F))),
...
` +
				...
				next: d(function () {
					...
					for (var R = this._currentRules(), t = 0; t < R.length; t++)
						if (
							((l = this._input.match(this.rules[R[t]])), l && (!n || l[0].length > n[0].length))
						) {
		...
		((Z = class {
			...
			setCssStyle(r, u) {
				for (const h of r) {
					...
					if (!u || !o) return;
					for (const c of u)
						c.includes(',') ? o.cssStyles.push(...c.split(',')) : o.cssStyles.push(c);
				}
			}
			setClass(r, u) {
				var h;
...
//# sourceMappingURL=CS3vxleS.js.map
