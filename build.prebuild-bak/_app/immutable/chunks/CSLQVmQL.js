const e = 'Mahitungod sa',
	...
	Fi = {
		...
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' o '-1' para walay expiration.",
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Ang pag-adjust niini nga mga setting magamit ang mga pagbag-o sa tanan nga tiggamit.',
		admin: c,
		Admin: d,
		'Admin Contact Email': '',
		...
		"Click on the user role button to change a user's role.":
			'I-klik ang User Role button aron usbon ang role sa user.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'wala maghimo ug eksternal nga koneksyon, ug ang imong data nagpabiling luwas sa imong lokal nga host server.',
		'Domain Filter List': '',
		"don't fetch random pipelines from sources you don't trust.":
			'Ayaw kuhaa og random nga pipelines gikan sa dili kasaligan nga mga tinubdan.',
		...
		'Include `--api` flag when running stable-diffusion-webui':
			'Iapil ang `--api` nga bandila kung nagdagan nga stable-diffusion-webui',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Ang labing taas nga 3 nga mga disenyo mahimong ma-download nga dungan. ',
		May: $o,
		MBR: ea,
		MCP: ta,
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Ang modelo'{{modelName}}' malampuson nga na-download.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Ang modelo'{{modelTag}}' naa na sa pila para ma-download.",
		...
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Ang alphanumeric nga mga karakter ug hyphen lang ang gitugotan sa command string.',
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Ang Pipelines usa ka plugin system nga makapadagan og bisan unsang kodigo —',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Ang pag-save sa mga chat log direkta sa imong browser storage dili na suportado. ',
		Schedule: jn,
		...
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Kini nagsiguro nga ang imong bililhon nga mga panag-istoryahanay luwas nga natipig sa imong backend database. ',
		...
		'To access the available model names for downloading,':
			'Aron ma-access ang mga ngalan sa modelo nga ma-download,',
		'To access the GGUF models available for downloading,':
			'Aron ma-access ang mga modelo sa GGUF nga magamit alang sa pag-download,',
		...
		'Type Hugging Face Resolve (Download) URL':
			'Pagsulod sa resolusyon (pag-download) URL Hugging Face',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Pagsulat og 50 ka pulong nga summary nga nagsumaryo [topic o keyword].',
		'Write something...': '',
...
//# sourceMappingURL=CSLQVmQL.js.map
