const e = 'Teave',
	...
	Nn = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 piirangu puudumisel või positiivne täisarv konkreetse piirangu jaoks',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' või '-1' aegumiseta.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(nt `sh webui.sh --api --api-auth kasutajanimi_parool`)',
		'(e.g. `sh webui.sh --api`)': '(nt `sh webui.sh --api`)',
		'(latest)': '(uusim)',
		'(leave blank for to use commercial endpoint)':
			'(jäta tühjaks, et kasutada kommertslõpp-punkti)',
		...
		'*Prompt node ID(s) are required for image generation':
			'*Sisendi sõlme ID(d) on piltide genereerimiseks vajalikud',
		'1 hour before': '',
		'1 Source': '1 allikas',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A collaboration channel where people join as members':
			'Koostöökanal, kuhu inimesed liituvad liikmetena',
		'A discussion channel where access is controlled by groups and permissions':
			'Arutelukanal, kus juurdepääsu kontrollivad grupid ja õigused',
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Uus versioon (v{{LATEST_VERSION}}) on saadaval.',
		'A private conversation between you and selected users':
			'Privaatne vestlus teie ja valitud kasutajate vahel',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Ülesande mudelit kasutatakse selliste toimingute jaoks nagu vestluste pealkirjade ja veebiotsingu päringute genereerimine',
		'a user': 'kasutaja',
		About: e,
...
Hüppa sisendi muutujale`,
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Aktiveeri see käsk, trükkides "/{{COMMAND}}" vestluse sisendritta.',
		Active: n,
		...
		'Add a short description about what this model does':
			'Lisa lühike kirjeldus, mida see mudel teeb',
		'Add a tag': 'Lisa silt',
		'Add a tag...': 'Lisa silt...',
		...
		'Add your Open Terminal URL and API key in Settings → Integrations.':
			'Lisage oma Open Terminali URL ja API võti menüüs Seaded → Integratsioonid.',
		...
		'Adds filenames, titles, sections, and snippets into the BM25 text to improve lexical recall.':
			'Lisab failinimed, pealkirjad, jaotised ja katkendid BM25 teksti, et parandada leksikaalset meenutamist.',
		'Adjusting these settings will apply changes universally to all users.':
			'Nende seadete kohandamine rakendab muudatused universaalselt kõigile kasutajatele.',
		admin: r,
		Admin: d,
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Administraatoritel on alati juurdepääs kõigile tööriistadele; kasutajatele tuleb tööriistad määrata mudeli põhiselt tööruumis.',
		Advanced: m,
		...
		'Advanced parameters for MinerU parsing (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)':
			'Täiustatud parameetrid MinerU parsijale (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)',
		...
		'After updating or changing the embedding model, you must reindex the knowledge base for the changes to take effect. You can do this using the "Reindex" button below.':
			'Pärast manustamise mudeli uuendamist või muutmist peate teadmiste baasi uuesti indekseerima, et muudatused jõustuksid. Saate seda teha alloleva "Reindex" nupu abil.',
		AI: c,
		All: k,
		...
		'Allowed file extensions for upload. Separate multiple extensions with commas. Leave empty for all file types.':
			'Üleslaadimiseks lubatud faililaiendid. Eralda mitu laiendit komadega. Kõigi failitüüpide jaoks jäta tühjaks.',
		'Already have an account?': 'Kas teil on juba konto?',
		'Alternative to the top_p, and aims to ensure a balance of quality and variety. The parameter p represents the minimum probability for a token to be considered, relative to the probability of the most likely token. For example, with p=0.05 and the most likely token having a probability of 0.9, logits with a value less than 0.045 are filtered out.':
			'Alternatiiv top_p-le ja eesmärk on tagada kvaliteedi ja mitmekesisuse tasakaal. Parameeter p esindab minimaalset tõenäosust tokeni arvesse võtmiseks, võrreldes kõige tõenäolisema tokeni tõenäosusega. Näiteks p=0.05 korral, kui kõige tõenäolisema tokeni tõenäosus on 0.9, filtreeritakse välja logitid väärtusega alla 0.045.',
		Always: p,
		...
		'API Base URL for Datalab Marker service. Defaults to: https://www.datalab.to/api/v1/marker':
			'Datalab Marker teenuse API baas-URL. Vaikimisi: https://www.datalab.to/api/v1/marker',
		'API Key': 'API võti',
		...
		'Are you sure you want to archive all chats? This action cannot be undone.':
			'Kas olete kindel, et soovite arhiveerida kõik vestlused? Seda toimingut ei saa tagasi võtta.',
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Kas olete kindel, et soovite kustutada kõik mälestused? Seda toimingut ei saa tagasi võtta.',
		'Are you sure you want to delete "{{NAME}}"?':
			'Kas olete kindel, et soovite kustutada "{{NAME}}"?',
		'Are you sure you want to delete **{{modelName}}**?': '',
		'Are you sure you want to delete all chats? This action cannot be undone.':
			'Kas olete kindel, et soovite kustutada kõik vestlused? Seda toimingut ei saa tagasi võtta.',
		'Are you sure you want to delete this channel?':
			'Kas olete kindel, et soovite selle kanali kustutada?',
		...
		"Are you sure you want to delete this version? Child versions will be relinked to this version's parent.":
			'Kas olete kindel, et soovite selle versiooni kustutada? Alamversioonid seotakse uuesti selle versiooni vanemaga.',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Kas olete kindel, et soovite kõik arhiveeritud vestlused arhiivist eemaldada?',
		...
		'Autocomplete Generation Input Max Length':
			'Automaattäitmise genereerimise sisendi maksimaalne pikkus',
		Automatic1111: U,
		...
		'Automatically inject system tools in native function calling mode (e.g., timestamps, memory, chat history, notes, etc.)':
			'Sisesta automaatselt süsteemitööriistad omases funktsioonide kutsumise režiimis (nt ajatemplid, mälu, vestluse ajalugu, märkmed jne)',
		Automation: O,
		'Automation created': '',
		'Automation Name': '',
		'Automation title': '',
		...
		'Boosting or penalizing specific tokens for constrained responses. Bias values will be clamped between -100 and 100 (inclusive). (Default: none)':
			'Konkreetsete tokenite võimendamine või karistamine piiratud vastuste jaoks. Kallutatuse väärtused piiratakse vahemikku -100 kuni 100 (kaasa arvatud). (Vaikimisi: puudub)',
		Brave: B,
		...
		'Call feature is not supported when using Web STT engine':
			'Kõnefunktsioon ei ole Web STT mootorit kasutades toetatud',
		Camera: z,
		Cancel: Q,
		...
		'Character limit for autocomplete generation input':
			'Märkide piirang automaattäitmise genereerimise sisendile',
		...
		'Chunks smaller than this threshold will be merged with neighboring chunks when possible. Set to 0 to disable merging.':
			'Tükid, mis on väiksemad kui see lävi, liidetakse võimalusel naabertükkidega. Määrake 0, et keelata liitmine.',
		Ciphers: oe,
		Citation: ne,
		Citations: le,
		...
		'Click here to download user import template file.':
			'Klõpsake siia kasutajate importimise mallifaili allalaadimiseks.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Klõpsake siia, et teada saada rohkem faster-whisper kohta ja näha saadaolevaid mudeleid.',
		...
		'Click here to upload a workflow.json file.':
			'Klõpsake siia workflow.json faili üleslaadimiseks.',
		'click here.': 'klõpsake siia.',
		"Click on the user role button to change a user's role.":
			'Kasutaja rolli muutmiseks klõpsake kasutaja rolli nuppu.',
		'Click to connect': '',
		'Click to copy ID': 'Klõpsa ID kopeerimiseks',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Lõikelaua kirjutamisõigust ei antud. Kontrollige oma brauseri seadeid, et anda vajalik juurdepääs.',
		Clone: ue,
		...
		'Connect to Open Terminal instances to browse files and use them as always-on tools. Only one can be active at a time.':
			'Ühenduge Open Terminali instantsidega failide sirvimiseks ja alati-saadaolevate tööriistadena kasutamiseks. Korraga saab aktiivne olla ainult üks.',
		'Connect to Open Terminal instances. All users will have access to file browsing and terminal tools through these servers.':
			'Ühenduge Open Terminali instantsidega. Kõigil kasutajatel on juurdepääs failide sirvimisele ja terminali tööriistadele nende serverite kaudu.',
		'Connect to your own OpenAI compatible API endpoints.':
			'Ühendu oma OpenAI-ga ühilduvate API lõpp-punktidega.',
		'Connect to your own OpenAPI compatible external tool servers.':
			'Ühendu oma OpenAPI-ga ühilduvate väliste tööriistaserveritega.',
		'Connected ({{type}})': '',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			'Piirab arutluse pingutust arutlusvõimelistele mudelitele. Kohaldatav ainult konkreetsete pakkujate arutlusmudelitele, mis toetavad arutluspingutust.',
		'Contact Admin for WebUI Access':
			'Võtke WebUI juurdepääsu saamiseks ühendust administraatoriga',
		Content: je,
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Kontrolli, kuidas sõnumitekst on jagatud TTS-päringute jaoks. 'Kirjavahemärgid' jagab lauseteks, 'lõigud' jagab lõikudeks ja 'puudub' hoiab sõnumi ühe stringina.",
		'Control the repetition of token sequences in the generated text. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 1.1) will be more lenient. At 1, it is disabled.':
			'Kontrollige tokeni järjestuste kordumist genereeritud tekstis. Kõrgem väärtus (nt 1,5) karistab kordusi tugevamalt, samas kui madalam väärtus (nt 1,1) on leebem. Väärtuse 1 korral on see keelatud.',
		Controls: Ie,
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			'Kontrollib väljundi sidususe ja mitmekesisuse vahelist tasakaalu. Madalam väärtus annab tulemuseks fokuseerituma ja sidusama teksti.',
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'Teenusepakkuja peab nõuetekohaselt konfigureerima CORS-i, et lubada päringuid Open WebUI-lt.',
		...
		'Create your first note by clicking on the plus button below.':
			'Loo oma esimene märge, klõpsates all olevat plussnuppu.',
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			'Vaikimisi režiim töötab laiema mudelite valikuga, kutsudes tööriistu kord enne täitmist. Omane režiim kasutab mudeli sisseehitatud tööriistade kutsumise võimalusi, kuid nõuab, et mudel toetaks seda funktsiooni olemuslikult.',
		...
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			'Vaikimisi kasutada segmenteeritud päringut keskendunud ja asjakohase sisu eraldamiseks; soovitatav enamikel juhtudel.',
		...
		'Deployment names are required for Azure OpenAI':
			'Azure OpenAI jaoks on nõutavad juurutuse nimed',
		Desc: _e,
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'Otsesed ühendused võimaldavad kasutajatel ühenduda oma OpenAI-ga ühilduvate API lõpp-punktidega.',
		...
		'Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.':
			"Keela piltide eraldamine PDF-ist. Kui 'Kasuta LLM-i' on lubatud, lisatakse piltidele automaatselt pealdised. Vaikimisi välja lülitatud.",
		Disabled: Ye,
		'Disconnect OAuth': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			'Avastage, kuidas kasutada Open WebUI-d ja otsige tuge kogukonnalt.',
		'Discover wonders': 'Avasta imesid',
		'Discover, download, and explore custom functions':
			'Avasta, laadi alla ja uuri kohandatud funktsioone',
		'Discover, download, and explore custom prompts':
			'Avasta, laadi alla ja uuri kohandatud sisendeid',
		'Discover, download, and explore custom tools':
			'Avasta, laadi alla ja uuri kohandatud tööriistu',
		'Discover, download, and explore model presets':
			'Avasta, laadi alla ja uuri mudeli eelseadistusi',
		'Discussion channel where access is based on groups and permissions':
			'Arutelukanal, kus juurdepääs põhineb gruppidel ja õigustel',
		Display: qe,
		...
		'Displays status updates (e.g., web search progress) in the response':
			'Kuvab vastuses olekuuendusi (nt veebiotsingu edenemine)',
		'Dive into knowledge': 'Sukeldu teadmistesse',
		'Do not install functions from sources you do not fully trust.':
			'Ärge installige funktsioone allikatest, mida te täielikult ei usalda.',
		'Do not install tools from sources you do not fully trust.':
			'Ärge installige tööriistu allikatest, mida te täielikult ei usalda.',
		'Do you want to sync your usage stats with Open WebUI Community?':
			'Kas soovite sünkroniseerida oma kasutusstatistikat Open WebUI kogukonnaga?',
		Docling: ze,
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'ei loo väliseid ühendusi ja teie andmed jäävad turvaliselt teie kohalikult majutatud serverisse.',
		'Domain Filter List': 'Domeeni filtri nimekiri',
		"don't fetch random pipelines from sources you don't trust.":
			'Ära tõmba juhuslikke pipelines allikatest, mida sa ei usalda.',
		"Don't have an account?": 'Pole kontot?',
		"don't install random functions from sources you don't trust.":
			'ärge installige juhuslikke funktsioone allikatest, mida te ei usalda.',
		"don't install random tools from sources you don't trust.":
			'ärge installige juhuslikke tööriistu allikatest, mida te ei usalda.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"nt '30s', '10m'. Kehtivad ajaühikud on 's', 'm', 'h'.",
		...
		'e.g. Step-by-step instructions for code reviews':
			'nt Samm-sammult juhised koodiülevaatuste jaoks',
		'e.g. Tell me a fun fact': 'nt Räägi mulle huvitav fakt',
		'e.g. Tell me a fun fact about the Roman Empire':
			'nt Räägi mulle huvitav fakt Rooma impeeriumi kohta',
		'e.g. Tools for performing various operations':
			'nt tööriistad mitmesuguste operatsioonide teostamiseks',
		...
		'e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)':
			'nt audio/wav,audio/mpeg,video/* (vaikeväärtuste jaoks jäta tühjaks)',
		'e.g., en-US,ja-JP (leave blank for auto-detect)':
			'nt en-US,ja-JP (automaatse tuvastuse jaoks jäta tühjaks)',
		...
		'Enable autocomplete generation for chat messages':
			'Luba automaattäitmise genereerimine vestlussõnumitele',
		...
		"Enable Memory Locking (mlock) to prevent model data from being swapped out of RAM. This option locks the model's working set of pages into RAM, ensuring that they will not be swapped out to disk. This can help maintain performance by avoiding page faults and ensuring fast data access.":
			'Luba mälu lukustamine (mlock), et vältida mudeli andmete vahetamist RAM-ist välja. See valik lukustab mudeli töökomplekti lehed RAM-i, tagades, et neid ei vahetata kettale. See aitab säilitada jõudlust, vältides lehevigu ja tagades kiire andmete juurdepääsu.',
		'Enable Memory Mapping (mmap) to load model data. This option allows the system to use disk storage as an extension of RAM by treating disk files as if they were in RAM. This can improve model performance by allowing for faster data access. However, it may not work correctly with all systems and can consume a significant amount of disk space.':
			'Luba mälu kaardistamine (mmap) mudeli andmete laadimiseks. See valik võimaldab süsteemil kasutada kettamahtu RAM-i laiendusena, koheldes kettafaile nii, nagu need oleksid RAM-is. See võib parandada mudeli jõudlust, võimaldades kiiremat andmete juurdepääsu. See ei pruugi siiski kõigi süsteemidega õigesti töötada ja võib tarbida märkimisväärse koguse kettaruumi.',
		'Enable Message Queue': 'Luba sõnumite järjekord',
		'Enable Message Rating': 'Luba sõnumite hindamine',
		'Enable Mirostat sampling for controlling perplexity.':
			"Luba Mirostat'i valim perplekssuse juhtimiseks.",
		...
		'Enable, disable, or customize the reasoning tags used by the model. "Enabled" uses default tags, "Disabled" turns off reasoning tags, and "Custom" lets you specify your own start and end tags.':
			'Luba, keela või kohanda mudeli kasutatavaid arutlussilte. "Lubatud" kasutab vaikimisi silte, "Keelatud" lülitab arutlussildid välja ja "Kohandatud" võimaldab määrata oma algus- ja lõpusildid.',
		Enabled: ca,
		'End Tag': 'Lõpusilt',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Veenduge, et teie CSV-fail sisaldab 4 veergu selles järjekorras: Nimi, E-post, Parool, Roll.',
		'Enter {{role}} message here': 'Sisestage {{role}} sõnum siia',
		'Enter a detail about yourself for your LLMs to recall':
			'Sisestage detail enda kohta, mida teie LLM-id saavad meenutada',
		'Enter a title for the pending user info overlay. Leave empty for default.':
			'Sisestage pealkiri ootava kasutaja info kattekihi jaoks. Jätke tühjaks vaikimisi jaoks.',
		'Enter a watermark for the response. Leave empty for none.':
			'Sisestage vastusele vesimärk. Jätke tühjaks, kui vesimärki pole vaja.',
		'Enter additional headers in JSON format': 'Sisestage lisapäised JSON-vormingus',
		'Enter additional headers in JSON format (e.g. {"X-Custom-Header": "value"}':
			'Sisestage lisapäised JSON-vormingus (nt {"X-Custom-Header": "value"}',
		...
		'Enter api auth string (e.g. username:password)':
			'Sisestage api autentimisstring (nt kasutajanimi:parool)',
		...
		'Enter content for the pending user info overlay. Leave empty for default.':
			'Sisestage sisu ootava kasutaja info kattekihi jaoks. Jätke tühjaks vaikimisi jaoks.',
		...
		'Enter domains separated by commas (e.g., example.com,site.org,!excludedsite.com)':
			'Sisestage domeenid komadega eraldatult (nt example.com,site.org,!excludedsite.com)',
		...
		'Enter function name filter list (e.g. func1, !func2)':
			'Sisestage funktsiooni nime filtrite nimekiri (nt func1, !func2)',
		...
		'Enter JSON config (e.g., {"disable_links": true})':
			'Sisestage JSON-seadistus (nt {"disable_links": true})',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Sisestage puhverserveri URL (nt https://kasutaja:parool@host:port)',
		...
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'Sisestage oma WebUI avalik URL. Seda URL-i kasutatakse teadaannetes linkide genereerimiseks.',
		...
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			'Sisestage Yacy URL (nt http://yacy.example.com:8090)',
		...
		"Error: A model with the ID '{{modelId}}' already exists. Please select a different ID to proceed.":
			"Viga: mudel ID-ga '{{modelId}}' on juba olemas. Palun valige jätkamiseks erinev ID.",
		'Error: Model ID cannot be empty. Please enter a valid ID to proceed.':
			'Viga: mudeli ID ei saa olla tühi. Palun sisestage jätkamiseks kehtiv ID.',
		Evaluations: ha,
		'Event created': '',
		'Event deleted': '',
		'Event title': '',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Näide: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Näide: sAMAccountName või uid või userPrincipalName',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			'Ületasite litsentsis määratud istekohtade arvu. Palun võtke ühendust toega, et suurendada istekohtade arvu.',
		Exclude: va,
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'Ühendamine {{URL}} OpenAPI tööriistaserveriga ebaõnnestus',
		'Failed to connect to {{URL}} terminal server':
			'Ühendamine {{URL}} terminali serveriga ebaõnnestus',
		...
		'Failed to extract content from the file: {{error}}':
			'Failist sisu eraldamine ebaõnnestus: {{error}}',
		...
		'Failed to load DOCX file. Please try downloading it instead.':
			'DOCX-faili laadimine ebaõnnestus. Palun proovige selle asemel alla laadida.',
		'Failed to load Excel/CSV file. Please try downloading it instead.':
			'Excel/CSV-faili laadimine ebaõnnestus. Palun proovige selle asemel alla laadida.',
		...
		'Failed to load PPTX file. Please try downloading it instead.':
			'PPTX-faili laadimine ebaõnnestus. Palun proovige selle asemel alla laadida.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Tuvastati sõrmejälje võltsimine: initsiaalide kasutamine avatarina pole võimalik. Kasutatakse vaikimisi profiilikujutist.',
		...
		'Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.':
			'Sunni OCR kõigil PDF-i lehtedel. See võib anda halvemaid tulemusi, kui teie PDF-idel on hea tekstikvaliteet. Vaikimisi välja lülitatud.',
		...
		'Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.':
			'Vorminda read väljundis. Vaikimisi välja lülitatud. Kui seatud väärtusele True, vormindatakse read, et tuvastada tekstisisest matemaatikat ja stiile.',
		...
		'Forwards system user OAuth access token to authenticate':
			'Edastab süsteemikasutaja OAuthi juurdepääsumärgi autentimiseks',
		'Forwards system user session credentials to authenticate':
			'Edastab süsteemikasutaja seansi mandaadid autentimiseks',
		Fr_day_of_week: xa,
		...
		'Functions allow arbitrary code execution.':
			'Funktsioonid võimaldavad suvalise koodi käivitamist.',
		...
		'Get current time and perform date/time calculations':
			'Hangi praegune aeg ja teosta kuupäeva/kellaaja arvutusi',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Kinnitan, et olen lugenud ja mõistan oma tegevuse tagajärgi. Olen teadlik suvalise koodi käivitamisega seotud riskidest ja olen kontrollinud allika usaldusväärsust.',
		ID: mt,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Lisage `--api-auth` lipp stable-diffusion-webui käivitamisel',
		'Include `--api` flag when running stable-diffusion-webui':
			'Lisage `--api` lipp stable-diffusion-webui käivitamisel',
		...
		'Influences how quickly the algorithm responds to feedback from the generated text. A lower learning rate will result in slower adjustments, while a higher learning rate will make the algorithm more responsive.':
			'Mõjutab, kui kiiresti algoritm reageerib genereeritud teksti tagasisidele. Madalam õppimiskiirus annab tulemuseks aeglasemad kohandused, samas kui kõrgem õppimiskiirus muudab algoritmi tundlikumaks.',
		Info: vt,
		Initials: bt,
		'Inject file content into conversation context': 'Sisesta faili sisu vestluse konteksti',
		'Inject the entire content as context for comprehensive processing, this is recommended for complex queries.':
			'Sisesta kogu sisu kontekstina põhjaliku töötlemise jaoks, seda soovitatakse keerukate päringute puhul.',
		Input: ft,
		...
		'Instant Auto-Send After Voice Transcription':
			'Kohene automaatne saatmine pärast hääle transkriptsiooni',
		Instructions: yt,
		Integration: At,
		Integrations: Pt,
		Interface: wt,
		...
		'Invalid JSON format for ComfyUI Edit Workflow.':
			'Vigane JSON-formaat ComfyUI muutmise töövoo jaoks.',
		...
		'Leave empty to include all models from "{{url}}" endpoint':
			'Jätke tühjaks, et kaasata kõik mudelid "{{url}}" lõpp-punktist',
		'Leave empty to include all models from "{{url}}/api/tags" endpoint':
			'Jätke tühjaks, et kaasata kõik mudelid "{{url}}/api/tags" lõpp-punktist',
		'Leave empty to include all models from "{{url}}/models" endpoint':
			'Jätke tühjaks, et kaasata kõik mudelid "{{url}}/models" lõpp-punktist',
		'Leave empty to include all models or select specific models':
			'Jäta tühjaks, et kaasata kõik mudelid või vali konkreetsed mudelid',
		...
		'Leave empty to use the default config, or enter a valid json (see https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)':
			'Jätke tühjaks vaikimisi seadistuse kasutamiseks või sisestage kehtiv JSON (vt https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)',
		'Leave empty to use the default model (voxtral-mini-latest).':
			'Jätke tühjaks vaikimisi mudeli kasutamiseks (voxtral-mini-latest).',
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Jäta tühjaks, et kasutada vaikimisi sisendit, või sisesta kohandatud sisend',
		'Leave model field empty to use the default model.':
			'Jäta mudeli väli tühjaks, et kasutada vaikimisi mudelit.',
		Legacy: Rt,
		lexical: Dt,
		License: Nt,
		...
		'Limit concurrent search queries. 0 = unlimited (default). Set to 1 for sequential execution (recommended for APIs with strict rate limits like Brave free tier).':
			'Piira samaaegseid otsingupäringuid. 0 = piiramatu (vaikimisi). Määrake 1 järjestikuse täitmise jaoks (soovitatav API-de puhul, millel on ranged piirangud, nagu Brave tasuta tase).',
		'Limits the number of concurrent embedding requests. Set to 0 for unlimited.':
			'Piirab samaaegsete manustamispäringute arvu. Määrake 0 piirangu puudumiseks.',
		List: Ft,
		...
		'LLMs can make mistakes. Verify important information.':
			'LLM-id võivad teha vigu. Kontrollige olulist teavet.',
		Loader: Wt,
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Veenduge, et ekspordite workflow.json faili API formaadis ComfyUI-st.',
		Male: qt,
		Manage: zt,
		...
		'Maximum number of files per folder is {{max}}.':
			'Maksimaalne failide arv kausta kohta on {{max}}.',
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Korraga saab alla laadida maksimaalselt 3 mudelit. Palun proovige hiljem uuesti.',
		May: Xt,
		MBR: $t,
		MCP: ei,
		'MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Open WebUI team, making it the more reliable option for compatibility.':
			'MCP tugi on eksperimentaalne ja selle spetsifikatsioon muutub sageli, mis võib põhjustada ühildumatusi. OpenAPI spetsifikatsiooni tuge hooldab otseselt Open WebUI meeskond, muutes selle ühilduvuse jaoks usaldusväärsemaks valikuks.',
		Medium: ai,
		...
		'Memories accessible by LLMs will be shown here.':
			'LLM-idele ligipääsetavad mälestused kuvatakse siin.',
		Memory: oi,
		...
		'Message counts are based on assistant responses.':
			'Sõnumite arv põhineb assistendi vastustel.',
		'Message rating should be enabled to use this feature':
			'Selle funktsiooni kasutamiseks peaks sõnumite hindamine olema lubatud',
		messages: li,
		Messages: ui,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Teie saadetud sõnumeid pärast lingi loomist ei jagata. Kasutajad, kellel on URL, saavad vaadata jagatud vestlust.',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Mudel '{{modelName}}' on edukalt alla laaditud.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Mudel '{{modelTag}}' on juba allalaadimise järjekorras.",
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': '',
		'Model {{modelName}} is not vision capable':
			'Mudel {{modelName}} ei ole võimeline visuaalseid sisendeid töötlema',
		...
		'Model can execute code and perform calculations':
			'Mudel saab käivitada koodi ja teha arvutusi',
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Tuvastati mudeli failisüsteemi tee. Uuendamiseks on vajalik mudeli lühinimi, ei saa jätkata.',
		...
		'Model name already exists, please choose a different one':
			'Mudeli nimi on juba olemas, palun valige erinev',
		...
		'No files yet. Upload files or run Python code to create them.':
			'Faile pole veel. Laadige failid üles või käivitage Pythoni kood nende loomiseks.',
		...
		'No inference engine with management support found':
			'Järeldusmootorit haldamise toega ei leitud',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Märkus: kui määrate minimaalse skoori, tagastab otsing ainult dokumendid, mille skoor on suurem või võrdne minimaalse skooriga.',
		Notes: Ii,
		...
		'Only active when "Paste Large Text as File" setting is toggled on.':
			'Aktiivne ainult siis, kui seade "Kleebi suur tekst failina" on sisse lülitatud.',
		'Only active when the chat input is in focus and an LLM is generating a response.':
			'Aktiivne ainult siis, kui vestluse sisend on fookuses ja LLM genereerib vastust.',
		'Only active when the chat input is in focus.':
			'Aktiivne ainult siis, kui vestluse sisend on fookuses.',
		'Only alphanumeric characters and hyphens are allowed':
			'Lubatud on ainult tähtede-numbrite kombinatsioonid ja sidekriipsud',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Käsustringis on lubatud ainult tähtede-numbrite kombinatsioonid ja sidekriipsud.',
		'Only can be triggered when the chat input is in focus.':
			'Käivitatav ainult siis, kui vestluse sisend on fookuses.',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Muuta saab ainult kogusid, dokumentide muutmiseks/lisamiseks looge uus teadmiste baas.',
		...
		'Only select users and groups with permission can access':
			'Juurdepääs on ainult valitud õigustega kasutajatel ja gruppidel',
		...
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Oih! Failide üleslaadimine on veel pooleli. Palun oodake, kuni üleslaadimine lõpeb.',
		'Oops! There was an error in the previous response.': 'Oih! Eelmises vastuses oli viga.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Oih! Kasutate toetamatut meetodit (ainult kasutajaliides). Palun serveerige WebUI tagarakendusest.',
		'Open file': 'Ava fail',
		...
		'Open Modal To Manage Floating Quick Actions':
			'Ava modaal hõljuvate kiirtoimingute haldamiseks',
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			'Open WebUI saab kasutada iga OpenAPI serveri pakutavaid tööriistu.',
		'Open WebUI uses faster-whisper internally.':
			"Open WebUI kasutab sisemiselt faster-whisper'it.",
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open WebUI kasutab SpeechT5 ja CMU Arctic kõneleja manustamisi.',
		'Open WebUI version': 'Open WebUI versioon',
		...
		'Page mode creates one document per page. Single mode combines all pages into one document for better chunking across page boundaries.':
			'Lehe režiim loob ühe dokumendi lehe kohta. Üksikrežiim ühendab kõik lehed üheks dokumendiks parema tükeldamise jaoks üle lehepiiride.',
		Paginate: Yi,
		Parameters: qi,
		...
		'Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Open WebUI. Your privacy is paramount: no message content is ever shared.':
			'Osalege kogukonna edetabelites ja hindamistes! Koondatud kasutusstatistika sünkroonimine aitab edendada uuringuid ja Open WebUI täiustamist. Teie privaatsus on ülimalt oluline: sõnumite sisu ei jagata kunagi.',
		Password: zi,
		...
		'Permission denied when accessing microphone: {{error}}':
			'Juurdepääs mikrofonile keelatud: {{error}}',
		Permissions: $i,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines on pluginate süsteem, mis võimaldab suvalise koodi käivitamist —',
		...
		'Please carefully review the following warnings:':
			'Palun vaadake hoolikalt läbi järgmised hoiatused:',
		...
		'Please do not close the settings page while loading the model.':
			'Palun ärge sulgege seadete lehte mudeli laadimise ajal.',
		...
		'Please save the connection to persist the OAuth client information and do not change the ID':
			'Palun salvestage ühendus, et säilitada OAuth kliendi teave, ja ärge muutke ID-d',
		...
		'Please select at least one user for Direct Message channel.':
			'Palun valige otsesõnumi kanali jaoks vähemalt üks kasutaja.',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'Prefiksi ID-d kasutatakse teiste ühendustega konfliktide vältimiseks, lisades mudeli ID-dele prefiksi - jätke tühjaks keelamiseks',
		...
		'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative.':
			'Vähendab mõttetuste genereerimise tõenäosust. Kõrgem väärtus (nt 100) annab mitmekesisemaid vastuseid, samas kui madalam väärtus (nt 10) on konservatiivsem.',
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Viita endale kui "Kasutaja" (nt "Kasutaja õpib hispaania keelt")',
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Vastuste teavitusi ei saa aktiveerida, kuna veebisaidi õigused on keelatud. Vajalike juurdepääsude andmiseks külastage oma brauseri seadeid.',
		...
		'Runs embedding tasks concurrently to speed up processing. Turn off if rate limits become an issue.':
			'Käitab manustamisülesandeid samaaegselt töötlemise kiirendamiseks. Lülitage välja, kui piirangud muutuvad probleemiks.',
		Sa_day_of_week: Gs,
		Save: Bs,
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Vestluslogi salvestamine otse teie brauseri mällu pole enam toetatud. Palun võtke hetk, et alla laadida ja kustutada oma vestluslogi, klõpsates allpool olevat nuppu. Ärge muretsege, saate hõlpsasti oma vestluslogi tagarakendusse uuesti importida, kasutades',
		Schedule: Ys,
		...
		'Searxng search language (all, en, es, de, fr, etc.)':
			'Searxng otsingu keel (all, en, es, de, fr jne)',
		...
		'Select how to split message text for TTS requests':
			'Valige, kuidas jagada sõnumiteksti TTS-päringute jaoks',
		...
		'Set the default models that are automatically selected for all users when a new chat is created.':
			'Määrake vaikemudelid, mis valitakse automaatselt kõigile kasutajatele uue vestluse loomisel.',
		'Set the models that are automatically pinned to the sidebar for all users.':
			'Määrake mudelid, mis kinnitatakse automaatselt külgribale kõigile kasutajatele.',
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			'Määrake kihtide arv, mis laaditakse GPU-le. Selle väärtuse suurendamine võib oluliselt parandada jõudlust mudelite puhul, mis on optimeeritud GPU kiirenduse jaoks, kuid võib tarbida rohkem energiat ja GPU ressursse.',
		'Set the number of worker threads used for computation. This option controls how many threads are used to process incoming requests concurrently. Increasing this value can improve performance under high concurrency workloads but may also consume more CPU resources.':
			'Määrake arvutusteks kasutatavate töölõimede arv. See valik kontrollib, mitu lõime kasutatakse saabuvate päringute samaaegseks töötlemiseks. Selle väärtuse suurendamine võib parandada jõudlust suure samaaegsusega töökoormuste korral, kuid võib tarbida rohkem CPU ressursse.',
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Seab tasase kallutatuse tokenite vastu, mis on esinenud vähemalt üks kord. Kõrgem väärtus (nt 1,5) karistab kordusi tugevamalt, samas kui madalam väärtus (nt 0,9) on leebem. Väärtuse 0 korral on see keelatud.',
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Seab skaleeritava kallutatuse tokenite vastu korduste karistamiseks, põhinedes sellel, mitu korda need on esinenud. Kõrgem väärtus (nt 1,5) karistab kordusi tugevamalt, samas kui madalam väärtus (nt 0,9) on leebem. Väärtuse 0 korral on see keelatud.',
		'Sets how far back for the model to look back to prevent repetition.':
			'Määrab, kui kaugele mudel tagasi vaatab, et vältida kordusi.',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			'Määrab genereerimiseks kasutatava juhusliku arvu seemne. Selle määramine kindlale numbrile paneb mudeli genereerima sama teksti sama sisendi korral.',
		'Sets the size of the context window used to generate the next token.':
			'Määrab järgmise tokeni genereerimiseks kasutatava konteksti akna suuruse.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			"Määrab kasutatavad lõpetamise järjestused. Kui see muster kohatakse, lõpetab LLM teksti genereerimise ja tagastab. Mitme lõpetamise mustri saab määrata, täpsustades modelfile'is mitu eraldi lõpetamise parameetrit.",
		Setting: to,
		Settings: io,
		...
		'Show Admin Details in Account Pending Overlay':
			'Näita administraatori üksikasju konto ootel kattekihil',
		'Show All': 'Näita kõik',
		...
		'Showing all messages (user + assistant) per user.':
			'Kuvatakse kõik sõnumid (kasutaja + assistent) kasutaja kohta.',
		'Sign in': 'Logi sisse',
		...
		'Sign Out': 'Logi välja',
		'Sign up': 'Registreeru',
		'Sign up to {{WEBUI_NAME}}': 'Registreeru rakendusse {{WEBUI_NAME}}',
		'Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.':
			'Parandab oluliselt täpsust, kasutades LLM-i tabelite, vormide, tekstisisese matemaatika ja kujunduse tuvastamise täiustamiseks. Suurendab latentsust. Vaikimisi välja lülitatud.',
		'Signing in to {{WEBUI_NAME}}': 'Sisselogimine rakendusse {{WEBUI_NAME}}',
		Single: no,
		...
		'Skip the cache and re-run the inference. Defaults to False.':
			'Jäta vahemälu vahele ja käivita järeldamine uuesti. Vaikimisi välja lülitatud.',
		...
		'Split documents by markdown headers before applying character/token splitting.':
			'Jagage dokumendid markdown-päiste järgi enne tähemärkide/tokenite tükeldamist.',
		...
		'Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.':
			"Eemalda olemasolev OCR-tekst PDF-ist ja käivita OCR uuesti. Ignoreeritakse, kui 'Sunni OCR' on lubatud. Vaikimisi välja lülitatud.",
		'STT Model': 'STT mudel',
		...
		'Syncs only chats with updates after your last sync timestamp. Disable to re-sync all chats.':
			'Sünkroonib ainult vestlused, mis on uuendatud pärast teie viimast sünkroonimist. Keelake kõigi vestluste uuesti sünkroonimiseks.',
		System: wo,
		...
		'Tail free sampling is used to reduce the impact of less probable tokens from the output. A higher value (e.g., 2.0) will reduce the impact more, while a value of 1.0 disables this setting.':
			'Saba vaba valimit kasutatakse väljundis vähem tõenäoliste tokenite mõju vähendamiseks. Kõrgem väärtus (nt 2,0) vähendab mõju rohkem, samas kui väärtus 1,0 keelab selle seade.',
		...
		'The Application Account DN you bind with for search':
			'Rakenduse konto DN, millega seote otsingu jaoks',
		...
		'The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.':
			'Partii suurus määrab, mitu tekstipäringut töödeldakse korraga. Suurem partii suurus võib suurendada mudeli jõudlust ja kiirust, kuid see nõuab ka rohkem mälu.',
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Selle pistikprogrammi taga olevad arendajad on kogukonna pühendunud vabatahtlikud. Kui leiate, et see pistikprogramm on kasulik, palun kaaluge selle arendamise toetamist.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Hindamise edetabel põhineb Elo hindamissüsteemil ja seda uuendatakse reaalajas.',
		'The format to return a response in. Format can be json or a JSON schema.':
			'Vorming, milles vastus tagastada. Vorming võib olla JSON või JSON-skeem.',
		'The height in pixels to compress images to. Leave empty for no compression.':
			'Kõrgus pikslites, millesse pilte tihendada. Jätke tühjaks tihendamise välistamiseks.',
		'The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.':
			'Sisend-heli keel. Sisendkeele esitamine ISO-639-1 (nt en) formaadis parandab täpsust ja latentsust. Jätke tühjaks keele automaatseks tuvastamiseks.',
		'The LDAP attribute that maps to the mail that users use to sign in.':
			'LDAP atribuut, mis kaardistab e-posti, mida kasutajad kasutavad sisselogimiseks.',
		'The LDAP attribute that maps to the username that users use to sign in.':
			'LDAP atribuut, mis kaardistab kasutajanime, mida kasutajad kasutavad sisselogimiseks.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'Edetabel on praegu beetaversioonina ja me võime kohandada hindamisarvutusi algoritmi täiustamisel.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'Maksimaalne failisuurus MB-des. Kui failisuurus ületab seda piiri, faili ei laadita üles.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'Maksimaalne failide arv, mida saab korraga vestluses kasutada. Kui failide arv ületab selle piiri, faile ei laadita üles.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			"Teksti väljundformaat. Võib olla 'json', 'markdown' või 'html'. Vaikimisi 'markdown'.",
		"The passwords you entered don't quite match. Please double-check and try again.":
			'Sisestatud paroolid ei ühti. Palun kontrollige ja proovige uuesti.',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Skoor peaks olema väärtus vahemikus 0,0 (0%) kuni 1,0 (100%).',
		'The stream delta chunk size for the model. Increasing the chunk size will make the model respond with larger pieces of text at once.':
			'Mudeli voo delta tüki suurus. Tüki suuruse suurendamine paneb mudeli vastama suuremate tekstiosadega korraga.',
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'Mudeli temperatuur. Temperatuuri suurendamine paneb mudeli vastama loovamalt.',
		'The Weight of BM25 Hybrid Search. 0 more semantic, 1 more lexical. Default 0.5':
			'BM25 hübriidotsingu kaal. 0 rohkem semantiline, 1 rohkem leksikaalne. Vaikimisi 0,5',
		'The width in pixels to compress images to. Leave empty for no compression.':
			'Laius pikslites, millesse pilte tihendada. Jätke tühjaks tihendamise välistamiseks.',
		Theme: Eo,
		'There was an error syncing your stats. Please try again.':
			'Statistika sünkroonimisel tekkis viga. Palun proovige uuesti.',
		'Thinking...': 'Mõtleb...',
		'This action cannot be undone. Do you wish to continue?':
			'Seda toimingut ei saa tagasi võtta. Kas soovite jätkata?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'See kanal loodi {{createdAt}}. See on {{channelName}} kanali algus.',
		"This chat won't appear in history and your messages will not be saved.":
			'See vestlus ei ilmu ajaloos ja teie sõnumeid ei salvestata.',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'See tagab, et teie väärtuslikud vestlused salvestatakse turvaliselt teie tagarakenduse andmebaasi. Täname!',
		'This feature is currently experimental and may not work as expected.':
			'See funktsioon on praegu eksperimentaalne ja ei pruugi toimida ootuspäraselt.',
		'This feature is experimental and may be modified or discontinued without notice.':
			'See funktsioon on eksperimentaalne ja võib muutuda või lõppeda etteteatamata.',
		'This folder is empty': 'See kaust on tühi',
		'This is a default user permission and will remain enabled.':
			'See on vaikimisi kasutajaõigus ja jääb lubatuks.',
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'See on katsetuslik funktsioon, see ei pruugi toimida ootuspäraselt ja võib igal ajal muutuda.',
		'This model is not publicly available. Please select another model.':
			'See mudel pole avalikult saadaval. Palun valige teine mudel.',
		'This option controls how long the model will stay loaded into memory following the request (default: 5m)':
			'See valik kontrollib, kui kaua mudel jääb pärast päringut mällu laadituna (vaikimisi: 5m)',
		'This option controls how many tokens are preserved when refreshing the context. For example, if set to 2, the last 2 tokens of the conversation context will be retained. Preserving context can help maintain the continuity of a conversation, but it may reduce the ability to respond to new topics.':
			'See valik kontrollib, mitu tokenit säilitatakse konteksti värskendamisel. Näiteks kui see on määratud 2-le, säilitatakse vestluse konteksti viimased 2 tokenit. Konteksti säilitamine võib aidata säilitada vestluse järjepidevust, kuid võib vähendada võimet reageerida uutele teemadele.',
		'This option enables or disables the use of the reasoning feature in Ollama, which allows the model to think before generating a response. When enabled, the model can take a moment to process the conversation context and generate a more thoughtful response.':
			'See valik lubab või keelab Ollama arutlusfunktsiooni kasutamise, mis võimaldab mudelil enne vastuse genereerimist mõelda. Kui see on lubatud, võib mudel võtta hetke vestluse konteksti töötlemiseks ja läbimõeldum vastuse genereerimiseks.',
		'This option sets the maximum number of tokens the model can generate in its response. Increasing this limit allows the model to provide longer answers, but it may also increase the likelihood of unhelpful or irrelevant content being generated.':
			'See valik määrab maksimaalse tokenite arvu, mida mudel saab oma vastuses genereerida. Selle piirmäära suurendamine võimaldab mudelil anda pikemaid vastuseid, kuid võib suurendada ka ebavajaliku või ebaolulise sisu genereerimise tõenäosust.',
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'See valik kustutab kõik olemasolevad failid kogust ja asendab need äsja üleslaaditud failidega.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'See kustutab <strong>{{NAME}}</strong> ja <strong>kogu selle sisu</strong>.',
		'This will delete all models including custom models':
			'See kustutab kõik mudelid, sealhulgas kohandatud mudelid',
		'This will delete all models including custom models and cannot be undone.':
			'See kustutab kõik mudelid, sealhulgas kohandatud mudelid, ja seda ei saa tagasi võtta.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'See lähtestab teadmiste baasi ja sünkroniseerib kõik failid. Kas soovite jätkata?',
		...
		'Thumbs up/down ratings from users on model responses':
			'Kasutajate pöidla üles/alla hinnangud mudeli vastustele',
		Tika: Ko,
		...
		'To access the available model names for downloading,':
			'Juurdepääsuks saadaolevatele mudelinimedele allalaadimiseks,',
		'To access the GGUF models available for downloading,':
			'Juurdepääsuks allalaadimiseks saadaolevatele GGUF mudelitele,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'WebUI-le juurdepääsuks võtke ühendust administraatoriga. Administraatorid saavad hallata kasutajate staatuseid administraatori paneelist.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Teadmiste baasi siia lisamiseks lisage need esmalt "Teadmiste" tööalale.',
		'To learn more about available endpoints, visit our documentation.':
			'Saadaolevate lõpp-punktide kohta rohkem teada saamiseks külastage meie dokumentatsiooni.',
		'To select skills here, add them to the "Skills" workspace first.':
			'Oskuste siit valimiseks lisage need esmalt "Oskuste" tööalale.',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Tööriistakomplektide siit valimiseks lisage need esmalt "Tööriistade" tööalale.',
		...
		'Token counts are estimates and may not reflect actual API usage':
			'Tokenite arvud on hinnangulised ega pruugi kajastada tegelikku API kasutust',
		tokens: _o,
		Tokens: Jo,
		...
		'Try adjusting your search or filter to find what you are looking for.':
			'Proovige kohandada otsingut või filtrit, et leida otsitav.',
		...
		'Type Hugging Face Resolve (Download) URL':
			'Sisestage Hugging Face Resolve (Allalaadimise) URL',
		...
		'Update for the latest features and improvements.':
			'Uuendage, et saada uusimad funktsioonid ja täiustused.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Uuendage litsentseeritud plaanile täiustatud võimaluste jaoks, sealhulgas kohandatud teemad ja bränding ning pühendatud tugi.',
		Upload: sn,
		...
		'Upload Progress: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)':
			'Üleslaadimise edenemine: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Kasutage '#' sisendi väljal, et laadida ja kaasata oma teadmised.",
		'Use /v1/chat/completions endpoint instead of /v1/audio/transcriptions for potentially better accuracy.':
			'Kasuta /v1/chat/completions lõpp-punkti /v1/audio/transcriptions asemel potentsiaalselt parema täpsuse saavutamiseks.',
		'Use Chat Completions API': 'Kasuta Chat Completions API-t',
		'Use groups to organize your users and assign permissions.':
			'Kasutage gruppe oma kasutajate korraldamiseks ja õiguste määramiseks.',
		...
		'Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.':
			'Kasutage http_proxy ja https_proxy keskkonnamuutujates määratud puhverserverit lehe sisu hankimiseks.',
		user: un,
		User: rn,
		...
		'Uses OAuth 2.1 Dynamic Client Registration':
			'Kasutab OAuth 2.1 dünaamilist kliendi registreerimist',
		'Using Entire Document': 'Kasutab tervet dokumenti',
		'Using Focused Retrieval': 'Kasutab fokusseeritud päringut',
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Kasutatakse vaikimisi areena mudelit kõigi mudelitega. Kohandatud mudelite lisamiseks klõpsake plussmärgiga nuppu.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Versioon {{selectedVersion}} / {{totalVersions}}',
		...
		'Voice Mode Custom Prompt': 'Häälrežiimi kohandatud sisend',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Hoiatus: Selle lubamine võimaldab kasutajatel üles laadida suvalist koodi serverisse.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			'Hoiatus: Jupyter täitmine võimaldab suvalise koodi käivitamist, mis kujutab endast tõsist turvariski - jätkake äärmise ettevaatusega.',
		We_day_of_week: yn,
		Web: An,
		'Web API': 'Veebi API',
		...
		'WebUI will make requests to "{{url}}/api/chat"':
			'WebUI teeb päringuid aadressile "{{url}}/api/chat"',
		'WebUI will make requests to "{{url}}/chat/completions"':
			'WebUI teeb päringuid aadressile "{{url}}/chat/completions"',
		Week: wn,
		Weekly: jn,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			'Kui see on lubatud, vastab mudel igale vestlussõnumile reaalajas, genereerides vastuse niipea, kui kasutaja sõnumi saadab. See režiim on kasulik reaalajas vestlusrakendustes, kuid võib mõjutada jõudlust aeglasema riistvara puhul.',
		...
		'Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.':
			'Kas lehekülgedele jagada. Iga leht eraldatakse horisontaalse joonega ja leheküljenumbriga. Vaikimisi välja lülitatud.',
		...
		'Works together with top-k. A higher value (e.g., 0.95) will lead to more diverse text, while a lower value (e.g., 0.5) will generate more focused and conservative text.':
			'Töötab koos top-k-ga. Kõrgem väärtus (nt 0,95) annab tulemuseks mitmekesisema teksti, samas kui madalam väärtus (nt 0,5) genereerib keskendunuma ja konservatiivsema teksti.',
		Workspace: Cn,
		'Workspace Permissions': 'Tööala õigused',
		Write: En,
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Kirjutage 50-sõnaline kokkuvõte, mis võtab kokku {{topic}}.',
...
nt: Sa oled Mario mängust Super Mario Bros ja tegutsed assistendina.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'Kasutate praegu proovilitsentsi. Palun võtke ühendust toega, et oma litsentsi uuendada.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Saate korraga vestelda maksimaalselt {{maxCount}} faili(ga).',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Saate isikupärastada oma suhtlust LLM-idega, lisades mälestusi alumise 'Halda' nupu kaudu, muutes need kasulikumaks ja teile kohandatumaks.",
		...
		'You do not have permission to send messages in this channel.':
			'Teil pole õigust sellesse kanalisse sõnumeid saata.',
		'You do not have permission to send messages in this thread.':
			'Teil pole õigust sellesse lõime sõnumeid saata.',
		'You do not have permission to upload files to this knowledge base.':
			'Teil pole õigust failide üleslaadimiseks sellesse teadmiste baasi.',
		...
		'Your account status is currently pending activation.':
			'Teie konto staatus on praegu ootel aktiveerimist.',
		...
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			'Kogu teie toetus läheb otse pistikprogrammi arendajale; Open WebUI ei võta mingit protsenti. Kuid valitud rahastamisplatvormil võivad olla oma tasud.',
		'Your message text or inputs': 'Teie sõnumi tekst või sisendid',
		'Your usage stats have been successfully synced.':
			'Teie kasutusstatistika on edukalt sünkroonitud.',
		YouTube: Dn,
...
//# sourceMappingURL=C_ksY1Hb.js.map
