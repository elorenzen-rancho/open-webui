...
import { i as x, G as B } from './Dzc2gp-m.js';
import { l as I } from './sdfSrbjZ.js';
import { c as L } from './f9y8NCnX.js';
import { m as A } from './BR8gqkH1.js';
function p(e) {
	var t = {
...
var f = new Map(),
			...
			c.forEach((a) => {
				if (t.children(a).length > 0) G(a, t, n, o);
					...
					(i.info('cp ', a, ' to ', o, ' with parent ', e),
						n.setNode(a, r),
						o !== t.parent(a) &&
							(i.warn('Setting parent', a, t.parent(a)), n.setParent(a, t.parent(a))),
						e !== o && a !== e
	...
	k = X(
		(e) => (!f.has(e) || !f.get(e).externalConnections ? e : f.has(e) ? f.get(e).id : e),
		'getAnchorId'
	),
	re = X((e, t) => {
		if (!e || t > 10) {
...
Parent cluster`,
				...
				if (
					(i.info('(Insert) Node XXX' + d + ': ' + JSON.stringify(t.node(d))),
					...
					t.children(d).length > 0
						...
						: (i.trace('Node - the non recursive path XAX', d, g, t.node(d), r),
							await q(g, t.node(d), { config: a, dir: r }));
			})
		),
			await X(async () => {
		...
		let E = 0,
			{ subGraphTitleTotalMargin: y } = z(a);
		return (
			await Promise.all(
				oe(t).map(async function (d) {
					...
					if (
						...
						const m = (s == null ? void 0 : s.padding) / 2 || 0,
							...
							S = N - m || 0;
						(i.debug('OffsetY', S, 'labelHeight', N, 'halfPadding', m),
							await K(l, s),
							(f.get(s.id).node = s));
					} else {
			...
			t.edges().forEach(function (d) {
				const s = t.edge(d);
				(i.info('Edge ' + d.v + ' -> ' + d.w + ': ' + JSON.stringify(s), s),
					s.points.forEach((S) => (S.y += y / 2)));
				const w = t.node(d.v);
				var m = t.node(d.w);
		...
		const n = new B({ multigraph: !0, compound: !0 })
				.setGraph({
					...
					nodesep:
						...
						((u = (r = e.config) == null ? void 0 : r.flowchart) == null
							? void 0
							: u.nodeSpacing) ||
						e.nodeSpacing,
					ranksep:
						((l = e.config) == null ? void 0 : l.rankSpacing) ||
						((C = (v = e.config) == null ? void 0 : v.flowchart) == null
							? void 0
							: C.rankSpacing) ||
						e.rankSpacing,
					marginx: 8,
...
export { ue as render };
//# sourceMappingURL=CeSjJUEy.js.map
