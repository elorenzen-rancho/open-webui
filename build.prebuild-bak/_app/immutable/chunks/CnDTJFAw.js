...
var r = {
	...
	tableCell: function (i, e) {
		return (
			i.match(l('tableHeading')) ? (e.tableHeading = !0) : i.eat('|'),
			(e.mode = r.tableCellAttributes),
			u(e)
		);
	},
	...
	tableText: function (i, e) {
		return i.match(l('tableText'))
			? u(e)
			: i.peek() === '|'
				? ((e.mode = r.tableCell), u(e))
				: s(i, e, i.next());
	}
};
const k = {
...
export { k as textile };
//# sourceMappingURL=CnDTJFAw.js.map
