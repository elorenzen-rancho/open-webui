import { c as F, i as p, a as w, b as k, d as z } from './CGEFt5-M.js';
import { i as B } from './Dmth1JHB.js';
import { e as g, a as I, b as P, f as V } from './CzDG__Ur.js';
function R(n, r) {
	r || (r = []);
...
function* mn(n, r) {
	if (r === void 0) for (let t of n) t != null && (t = +t) >= t && (yield t);
	else {
		let t = -1;
		for (let e of n) (e = r(e, ++t, n)) != null && (e = +e) >= e && (yield e);
	}
}
const x = q(M),
	G = x.right,
...
function nn(n, r, t) {
	var e = n[0],
		...
		a = r[1];
	return (
		u < e ? ((e = y(u, e)), (f = t(a, f))) : ((e = y(e, u)), (f = t(f, a))),
		function (o) {
			return f(e(o));
		}
	);
...
function rn(n, r, t) {
	...
	for (n[e] < n[0] && ((n = n.slice().reverse()), (r = r.slice().reverse())); ++a < e; )
		((u[a] = y(n[a], n[a + 1])), (f[a] = t(r[a], r[a + 1])));
	return function (o) {
		var c = G(n, o, 1, e) - 1;
		return f[c](u[c](o));
	};
...
function on(n) {
	...
	return (
		(n.ticks = function (t) {
			var e = r();
			return Q(e[0], e[e.length - 1], t ?? 10);
		}),
		...
		(n.nice = function (t) {
			...
			for (o < a && ((i = a), (a = o), (o = i), (i = u), (u = f), (f = i)); h-- > 0; ) {
				if (((i = v(a, o, t)), i === c)) return ((e[u] = a), (e[f] = o), r(e));
...
//# sourceMappingURL=CrKpsNbG.js.map
