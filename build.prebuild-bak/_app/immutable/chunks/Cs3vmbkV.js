...
var z = (t, r, s) =>
	r in t ? k(t, r, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (t[r] = s);
var g = (t, r, s) => z(t, typeof r != 'symbol' ? r + '' : r, s),
...
import { X as _, z as M } from './CD8kWLvT.js';
var o, a, v, h, x;
const f = class f {
	constructor(r) {
		b(this, h);
	...
	observe(r, s) {
		...
		return (
			e.add(s),
			i(this, o).set(r, e),
			p(this, h, x).call(this).observe(r, i(this, v)),
			() => {
...
let d = f;
var W = new d({ box: 'border-box' });
function q(t, r, s) {
	var e = W.observe(t, () => s(t[r]));
	_(() => (M(() => s(t[r])), e));
}
export { q as b };
//# sourceMappingURL=Cs3vmbkV.js.map
