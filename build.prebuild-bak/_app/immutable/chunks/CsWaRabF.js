import { c, g as b } from './BC4znSyB.js';
var E = { exports: {} };
(function (h, R) {
	(function (p, i) {
		i();
		...
		var a =
			...
			u =
				...
				(typeof window != 'object' || window !== a
					? function () {}
					: 'download' in HTMLAnchorElement.prototype && !m
						? function (e, t, r) {
						...
						: 'msSaveOrOpenBlob' in navigator
							...
							: function (e, t, r, o) {
									...
									if ((w || (n && j) || m) && typeof FileReader < 'u') {
										var f = new FileReader();
										((f.onloadend = function () {
											var s = f.result;
											((s = w ? s : s.replace(/^data:[^;]*;/, 'data:attachment/file;')),
												o ? (o.location.href = s) : (location = s),
												(o = null));
										}),
											f.readAsDataURL(e));
									} else {
										var y = a.URL || a.webkitURL,
											d = y.createObjectURL(e);
...
var L = E.exports;
const A = b(L);
export { L as F, A as f };
//# sourceMappingURL=CsWaRabF.js.map
