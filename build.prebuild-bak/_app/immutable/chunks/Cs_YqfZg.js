const e = 'Относно',
	...
	Fr = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 за липса на ограничение или положително цяло число за определено ограничение.',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' или '-1' за неограничен срок.",
		...
		'*Prompt node ID(s) are required for image generation':
			'*Идентификатор(ите) на възел-а се изисква(т) за генериране на изображения',
		'1 hour before': '',
		'1 Source': '',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Вече е налична нова версия (v{{LATEST_VERSION}}).',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Моделът на задачите се използва при изпълнението на задачите като генериране на заглавия за чатове и заявки за търсене в мрежата',
		'a user': 'потребител',
		About: e,
		...
		'Action Required for Chat Log Storage':
			'Изисква се действие за съхраняване на дневника на чата',
		Actions: a,
		Activate: s,
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Активирайте тази команда, като въведете "/{{COMMAND}}" в полето за чат.',
		Active: r,
		...
		'Add a short description about what this model does':
			'Добавете кратко описание за това какво прави този модел',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'При промяна на тези настройки промените се прилагат за всички потребители.',
		admin: c,
		Admin: d,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Администраторите имат достъп до всички инструменти по всяко време; потребителите се нуждаят от инструменти, присвоени за всеки модел в работното пространство.',
		Advanced: u,
		...
		'applies to all users with the "user" role':
			'прилага се за всички потребители с роля "потребител"',
		April: w,
		Archive: S,
		'Archive All': '',
		...
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Сигурни ли сте, че исткате да изчистите всички спомени? Това е необратимо.',
		'Are you sure you want to delete "{{NAME}}"?': '',
		'Are you sure you want to delete **{{modelName}}**?': '',
		'Are you sure you want to delete all chats? This action cannot be undone.': '',
		'Are you sure you want to delete this channel?':
			'Сигурни ли сте, че искате да изтриете този канал?',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Сигурни ли сте, че искате да разархивирате всички архивирани чатове?',
		...
		'Autocomplete Generation Input Max Length':
			'Максимална дължина на входа за генериране на автоматично довършване',
		Automatic1111: R,
		...
		'Call feature is not supported when using Web STT engine':
			'Функцията за обаждане не се поддържа при използването на Web STT двигател',
		Camera: j,
		Cancel: Q,
		...
		'Character limit for autocomplete generation input':
			'Ограничение на символите за входа на генериране на автоматично довършване',
		...
		'Click here to download user import template file.':
			'Натиснете тук, за да изтеглите шаблонния файл за импортиране на потребители.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Натиснете тук, за да научите повече за по-бърз шепот и да видите наличните модели.',
		...
		"Click on the user role button to change a user's role.":
			'Натиснете върху бутона за промяна на ролята на потребителя.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Разрешението за запис в клипборда е отказано. Моля, проверете настройките на браузъра си, за да предоставите необходимия достъп.',
		Clone: le,
		...
		'Connect to your own OpenAI compatible API endpoints.':
			'Свържете се със собствени крайни точки на API, съвместими с OpenAI.',
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Контролирайте как текстът на съобщението се разделя за TTS заявки. 'Пунктуация' разделя на изречения, 'параграфи' разделя на параграфи, а 'нищо' запазва съобщението като един низ.",
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'CORS трябва да бъде правилно конфигуриран от доставчика, за да позволи заявки от Open WebUI.',
		'Could not read file.': '',
		CPU: Ue,
		Create: De,
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			'Режимът по подразбиране работи с по-широк набор от модели, като извиква инструменти веднъж преди изпълнение. Нативният режим използва вградените възможности за извикване на инструменти на модела, но изисква моделът да поддържа тази функция по същество.',
		...
		'Default permissions updated successfully':
			'Разрешенията по подразбиране са успешно актуализирани',
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'Директните връзки позволяват на потребителите да се свързват със собствени OpenAI съвместими API крайни точки.',
		'Direct Message': '',
		'Direct Tool Servers': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			'Открийте как да използвате Open WebUI и потърсете подкрепа от общността.',
		'Discover wonders': 'Открийте чудеса',
		'Discover, download, and explore custom functions':
			'Открийте, изтеглете и разгледайте персонализирани функции',
		...
		'Discover, download, and explore custom tools':
			'Открийте, изтеглете и разгледайте персонализирани инструменти',
		...
		'Do not install functions from sources you do not fully trust.':
			'Не инсталирайте функции от източници, на които не се доверявате напълно.',
		'Do not install tools from sources you do not fully trust.':
			'Не инсталирайте инструменти от източници, на които не се доверявате напълно.',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'няма външни връзки, а вашите данни остават сигурни на локално назначен сървър.',
		'Domain Filter List': 'Списък с филтри за домейни',
		"don't fetch random pipelines from sources you don't trust.":
			'Не извличайте произволни pipelines от източници, на които не вярвате.',
		"Don't have an account?": 'Нямате акаунт?',
		"don't install random functions from sources you don't trust.":
			'не инсталирайте случайни функции от източници, на които не се доверявате.',
		"don't install random tools from sources you don't trust.":
			'не инсталирайте случайни инструменти от източници, на които не се доверявате.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"напр. '30с','10м'. Валидни единици са 'с', 'м', 'ч'.",
		"e.g. 'low', 'medium', 'high'": '',
		'e.g. "json" or a JSON schema': '',
		'e.g. 60': '',
		'e.g. A filter to remove profanity from text':
			'напр. Филтър за премахване на нецензурни думи от текста',
		...
		'e.g. Tools for performing various operations':
			'напр. Инструменти за извършване на различни операции',
		...
		'Enable autocomplete generation for chat messages':
			'Активиране на автоматично довършване на съобщения в чата',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Уверете се, че вашият CSV файл включва 4 колони в следния ред: Име, Имейл, Парола, Роля.',
		'Enter {{role}} message here': 'Въведете съобщение за {{role}} тук',
		'Enter a detail about yourself for your LLMs to recall':
			'Въведете подробности за себе си, за да ги запомнят вашите LLMs',
		...
		'Enter api auth string (e.g. username:password)':
			'Въведете низ за удостоверяване на API (напр. потребителско_име:парола)',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Въведете URL адрес на прокси (напр. https://user:password@host:port)',
		...
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'Въведете публичния URL адрес на вашия WebUI. Този URL адрес ще бъде използван за генериране на връзки в известията.',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Пример: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Пример: sAMAccountName или uid или userPrincipalName',
		...
		'File size should not exceed {{maxSize}} MB.':
			'Размерът на файла не трябва да надвишава {{maxSize}} MB.',
		'File Upload': '',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Потвърждаване на отпечатък: Не може да се използва инициализационна буква като аватар. Потребителят се връща към стандартна аватарка.',
		...
		'Functions allow arbitrary code execution.':
			'Функциите позволяват произволно изпълнение на кода.',
		...
		'Hex Color - Leave empty for default color':
			'Hex цвят - Оставете празно за цвят по подразбиране',
		Hidden: no,
		Hide: ao,
		'Hide All': '',
		'Hide from Sidebar': '',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Потвърждавам, че съм прочел и разбирам последствията от моето действие. Наясно съм с рисковете, свързани с изпълнението на произволен код, и съм проверил надеждността на източника.',
		ID: mo,
		...
		'Instant Auto-Send After Voice Transcription':
			'Незабавно автоматично изпращане след гласова транскрипция',
		Instructions: vo,
		Integration: Co,
		Integrations: Io,
		Interface: Po,
		...
		'Leave empty to include all models or select specific models':
			'Оставете празно, за да включите всички модели или изберете конкретни модели',
		...
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Оставете празно, за да използвате промпта по подразбиране, или въведете персонализиран промпт',
		'Leave model field empty to use the default model.':
			'Оставете полето за модел празно, за да използвате модела по подразбиране.',
		Legacy: No,
		lexical: Fo,
		License: Wo,
		'Lift List': '',
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Уверете се, че експортирате файл workflow.json като API формат от ComfyUI.',
		Male: jo,
		Manage: Qo,
		'Manage Connections': '',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Максимум 3 модела могат да бъдат сваляни едновременно. Моля, опитайте отново по-късно.',
		May: $o,
		MBR: en,
		MCP: tn,
		...
		'Memories accessible by LLMs will be shown here.':
			'Мемории достъпни от LLMs ще бъдат показани тук.',
		Memory: rn,
		...
		'Message rating should be enabled to use this feature':
			'Оценяването на съобщения трябва да бъде активирано, за да използвате тази функция',
		messages: cn,
		Messages: dn,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Съобщенията, които изпращате след създаването на връзката, няма да бъдат споделяни. Потребителите с URL адреса ще могат да видят споделения чат.',
		'Microsoft OneDrive': '',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Моделът '{{modelName}}' беше успешно свален.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Моделът '{{modelTag}}' е вече в очакване за сваляне.",
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': '',
		'Model {{modelName}} is not vision capable':
			'Моделът {{modelName}} не поддържа визуални възможности',
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Открит е път до файловата система на модела. За актуализацията се изисква съкратено име на модела, не може да продължи.',
		...
		'No HTML, CSS, or JavaScript content found.':
			'Не е намерено HTML, CSS или JavaScript съдържание.',
		'No inference engine with management support found':
			'Не е намерен механизъм за извод с поддръжка на управлението',
		'No kernel': '',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Забележка: Ако зададете минимален резултат, търсенето ще върне само документи с резултат, по-голям или равен на минималния резултат.',
		Notes: kn,
		...
		'Only alphanumeric characters and hyphens are allowed':
			'Разрешени са само буквено-цифрови знаци и тирета',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Само алфанумерични знаци и тире са разрешени в командния низ.',
		'Only can be triggered when the chat input is in focus.': '',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Само колекциите могат да бъдат редактирани, създайте нова база от знания, за да редактирате/добавяте документи.',
		'Only invited users can access': '',
		'Only markdown files are allowed': '',
		'Only select users and groups with permission can access':
			'Само избрани потребители и групи с разрешение могат да имат достъп',
		'Only sync new/updated chats': '',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Упс! Изглежда URL адресът е невалиден. Моля, проверете отново и опитайте пак.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Упс! Все още има файлове, които се качват. Моля, изчакайте качването да приключи.',
		'Oops! There was an error in the previous response.': 'Упс! Имаше грешка в предишния отговор.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Упс! Използвате неподдържан метод (само фронтенд). Моля, сервирайте WebUI от бекенда.',
		...
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open WebUI използва SpeechT5 и CMU Arctic говорителни вграждания.',
		'Open WebUI version': '',
		...
		'Permission denied when accessing media devices':
			'Отказан достъп при опит за достъп до медийни устройства',
		'Permission denied when accessing microphone': 'Отказан достъп при опит за достъп до микрофона',
		'Permission denied when accessing microphone: {{error}}':
			'Отказан достъп при опит за достъп до микрофона: {{error}}',
		Permissions: ta,
		'Perplexity API Key': '',
		'Perplexity Model': '',
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines е система от приставки с възможност за произволно изпълнение на код —',
		...
		'Please carefully review the following warnings:':
			'Моля, внимателно прегледайте следните предупреждения:',
		...
		'Please do not close the settings page while loading the model.':
			'Моля, не затваряйте страницата с настройки, докато моделът се зарежда.',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'Префикс ID се използва за избягване на конфликти с други връзки чрез добавяне на префикс към ID-тата на моделите - оставете празно, за да деактивирате',
		...
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Отнасяйте се към себе си като "Потребител" (напр. "Потребителят учи испански")',
		'Reference Chats': '',
		Refresh: Ca,
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Известията за отговори не могат да бъдат активирани, тъй като разрешенията за уебсайта са отказани. Моля, посетете настройките на вашия браузър, за да дадете необходимия достъп.',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Запазването на чат логове директно в хранилището на вашия браузър вече не се поддържа. Моля, отделете малко време, за да изтеглите и изтриете чат логовете си, като щракнете върху бутона по-долу. Не се притеснявайте, можете лесно да импортирате отново чат логовете си в бекенда чрез',
		Schedule: ja,
		...
		'Selected model(s) do not support image inputs':
			'Избраният(те) модел(и) не поддържа въвеждане на изображения',
		'Selected Models': '',
		semantic: es,
		Send: ts,
		...
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			'Задайте броя слоеве, които ще бъдат прехвърлени към GPU. Увеличаването на тази стойност може значително да подобри производителността за модели, оптимизирани за GPU ускорение, но може също да консумира повече енергия и GPU ресурси.',
		'Set the number of worker threads used for computation. This option controls how many threads are used to process incoming requests concurrently. Increasing this value can improve performance under high concurrency workloads but may also consume more CPU resources.':
			'Задайте броя работни нишки, използвани за изчисления. Тази опция контролира колко нишки се използват за едновременна обработка на входящи заявки. Увеличаването на тази стойност може да подобри производителността при високи натоварвания с паралелизъм, но може също така да консумира повече ресурси на CPU.',
		...
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			'Задава последователностите за спиране, които да се използват. Когато се срещне този модел, LLM ще спре да генерира текст и ще се върне. Множество модели за спиране могат да бъдат зададени чрез определяне на множество отделни параметри за спиране в моделния файл.',
		Setting: as,
		Settings: ss,
		...
		'Show Admin Details in Account Pending Overlay':
			'Покажи детайлите на администратора в наслагването на изчакващ акаунт',
		'Show All': '',
		...
		'The Application Account DN you bind with for search':
			'DN на акаунта на приложението, с който се свързвате за търсене',
		...
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Разработчиците зад този плъгин са страстни доброволци от общността. Ако намирате този плъгин полезен, моля, обмислете да допринесете за неговото развитие.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Класацията за оценка се базира на рейтинговата система Elo и се обновява в реално време.',
		...
		'The LDAP attribute that maps to the mail that users use to sign in.':
			'LDAP атрибутът, който съответства на имейла, който потребителите използват за вписване.',
		'The LDAP attribute that maps to the username that users use to sign in.':
			'LDAP атрибутът, който съответства на потребителското име, което потребителите използват за вписване.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'Класацията в момента е в бета версия и може да коригираме изчисленията на рейтинга, докато усъвършенстваме алгоритъма.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'Максималният размер на файла в MB. Ако размерът на файла надвишава този лимит, файлът няма да бъде качен.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'Максималният брой файлове, които могат да се използват едновременно в чата. Ако броят на файловете надвишава този лимит, файловете няма да бъдат качени.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			'',
		"The passwords you entered don't quite match. Please double-check and try again.": '',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Резултатът трябва да бъде стойност между 0,0 (0%) и 1,0 (100%).',
		...
		'This action cannot be undone. Do you wish to continue?':
			'Това действие не може да бъде отменено. Желаете ли да продължите?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'',
		"This chat won't appear in history and your messages will not be saved.": '',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Това гарантира, че ценните ви разговори се запазват сигурно във вашата бекенд база данни. Благодарим ви!',
		...
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Това е експериментална функция, може да не работи според очакванията и подлежи на промяна по всяко време.',
		...
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Тази опция ще изтрие всички съществуващи файлове в колекцията и ще ги замени с новокачени файлове.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Това ще изтрие <strong>{{NAME}}</strong> и <strong>цялото му съдържание</strong>.',
		'This will delete all models including custom models':
			'Това ще изтрие всички модели, включително персонализираните модели',
		'This will delete all models including custom models and cannot be undone.':
			'Това ще изтрие всички модели, включително персонализираните модели, и не може да бъде отменено.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Това ще нулира базата знания и ще синхронизира всички файлове. Желаете ли да продължите?',
		...
		'To access the available model names for downloading,':
			'За достъп до наличните имена на моделите за изтегляне,',
		'To access the GGUF models available for downloading,':
			'За достъп до наличните GGUF модели за изтегляне,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'За достъп до уеб интерфейса, моля, свържете се с администратора. Администраторите могат да управляват статусите на потребителите от Административния панел.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'За да прикачите база знания тук, първо ги добавете към работното пространство "Знания".',
		'To learn more about available endpoints, visit our documentation.':
			'За да научите повече за наличните крайни точки, посетете нашата документация.',
		'To select skills here, add them to the "Skills" workspace first.': '',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'За да изберете инструменти тук, първо ги добавете към работното пространство "Инструменти".',
		...
		'Tools are a function calling system with arbitrary code execution':
			'Инструментите са система за извикване на функции с произволно изпълнение на код',
		'Tools Function Calling Prompt': 'Промпт за извикване на функциите на инструментите',
		'Tools have a function calling system that allows arbitrary code execution.':
			'Инструментите имат система за извикване на функции, която позволява произволно изпълнение на код.',
		...
		'Update for the latest features and improvements.':
			'Актуализирайте за най-новите функции и подобрения.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Надградете до лицензиран план за разширени възможности, включително персонализирани теми и брандиране, и специализирана поддръжка.',
		Upload: ar,
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Използвайте '#' в полето за въвеждане, за да заредите и включите вашите знания.",
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Използване на стандартния арена модел с всички модели. Кликнете бутона плюс, за да добавите персонализирани модели.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Версия {{selectedVersion}} от {{totalVersions}}',
		'Version deleted': '',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Предупреждение: Активирането на това ще позволи на потребителите да качват произволен код на сървъра.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			'Предупреждение: Изпълнението на Jupyter позволява произволно изпълнение на код, което представлява сериозни рискове за сигурността-продължете с изключително внимание.',
		We_day_of_week: Sr,
		Web: vr,
		'Web API': 'Уеб API',
		'Web Loader Engine': '',
		...
		'WebUI will make requests to "{{url}}/api/chat"':
			'WebUI ще прави заявки към "{{url}}/api/chat"',
		'WebUI will make requests to "{{url}}/chat/completions"':
			'WebUI ще прави заявки към "{{url}}/chat/completions"',
		Week: Ir,
		Weekly: Pr,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			'Когато е активирано, моделът ще отговаря на всяко съобщение в чата в реално време, генерирайки отговор веднага щом потребителят изпрати съобщение. Този режим е полезен за приложения за чат на живо, но може да повлияе на производителността на по-бавен хардуер.',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Напиши описание в 50 думи, което обобщава [тема или ключова дума].',
...
напр.: Вие сте Марио от Super Mario Bros и действате като асистент.`,
		...
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Можете да чатите с максимум {{maxCount}} файл(а) наведнъж.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Можете да персонализирате взаимодействията си с LLM-и, като добавите спомени чрез бутона 'Управление' по-долу, правейки ги по-полезни и съобразени с вас.",
		...
		'Your account status is currently pending activation.':
			'Статусът на вашия акаунт в момента очаква активиране.',
...
//# sourceMappingURL=Cs_YqfZg.js.map
