const e = 'Tietoja',
	...
	Nn = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 rajoituksetta tai positiivinen kokonaisluku enimmäismääräksi',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' tai '-1' jottei vanhene.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(esim. `sh webui.sh --api --api-auth username_password`)',
		'(e.g. `sh webui.sh --api`)': '(esim. `sh webui.sh --api`)',
		'(latest)': '(uusin)',
		'(leave blank for to use commercial endpoint)':
			'(Jätä tyhjäksi, jos haluat käyttää kaupallista päätettä)',
		...
		'*Prompt node ID(s) are required for image generation':
			'Kuvan luomiseen vaaditaan kehote-solmun ID(t)',
		...
		'A collaboration channel where people join as members':
			'Yhteistyökanava, johon ihmiset liittyvät jäseninä',
		'A discussion channel where access is controlled by groups and permissions':
			'Keskustelukanava, johon pääsyä rajoitetaan ryhmillä ja käyttöoikeuksilla',
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Uusi versio (v{{LATEST_VERSION}}) on nyt saatavilla.',
		'A private conversation between you and selected users':
			'Yksityinen keskustelu sinun ja valittujen käyttäjien välillä',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Tehtävämallia käytetään tehtävien suorittamiseen, kuten otsikoiden luomiseen keskusteluille ja verkkohakukyselyille',
		'a user': 'käyttäjä',
		About: e,
		'Accept Autocomplete Generation\nJump to Prompt Variable': `Hyväksy automaattiset täydennykset
 Siirry kehoitteen muuttujaan`,
		Access: t,
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Aktivoi tämä komento kirjoittamalla "/{{COMMAND}}" chat-syötteeseen.',
		Active: n,
		...
		'Add a short description about what this model does':
			'Lisää lyhyt kuvaus siitä, mitä tämä malli tekee',
		...
		'Add your Open Terminal URL and API key in Settings → Integrations.':
			'Lisää Open Terminal verkko-osoite ja API-avain Asetukset → Integraatiot',
		...
		'Adds filenames, titles, sections, and snippets into the BM25 text to improve lexical recall.':
			'Lisää tiedostonimiä, otsikoita, osioita ja katkelmia BM25-tekstiin leksikaalisen muistamisen parantamiseksi.',
		'Adjusting these settings will apply changes universally to all users.':
			'Näiden asetusten muokkaaminen vaikuttaa kaikkiin käyttäjiin.',
		admin: u,
		Admin: k,
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Ylläpitäjillä on pääsy kaikkiin työkaluihin koko ajan; käyttäjät tarvitsevat työkaluja mallille määritettynä työtilassa.',
		Advanced: m,
		...
		'Advanced parameters for MinerU parsing (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)':
			'Edistyneet parametrit MinerU-jäsennykseen (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)',
		...
		'After updating or changing the embedding model, you must reindex the knowledge base for the changes to take effect. You can do this using the "Reindex" button below.':
			'Upotusmallin päivittämisen, tai vaihtamisen jälkeen sinun tulee indeksoida tietämys uudelleen ottaaksesi muutokset käyttöön. Voit tehdä tämän alla olevasta "Indeksoi uudelleen" napista.',
		AI: d,
		All: c,
		...
		'API Base URL for Datalab Marker service. Defaults to: https://www.datalab.to/api/v1/marker':
			'API verkko-osoite Datalabb Marker palveluun. Oletuksena: https://www.datalab.to/api/v1/marker',
		'API Key': 'API-avain',
		...
		'applies to all users with the "user" role':
			'koskee kaikkia käyttäjiä, joilla on "käyttäjä"-rooli',
		April: f,
		Archive: A,
		...
		'Are you sure you want to archive all chats? This action cannot be undone.':
			'Haluatko varmasti arkistoida kaikki keskustelut? Tätä toimintoa ei voi peruuttaa.',
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Haluatko varmasti tyhjentää kaikki muistot? Tätä toimintoa ei voi peruuttaa.',
		'Are you sure you want to delete "{{NAME}}"?': 'Haluatko varmasti poistaa "{{NAME}}"?',
		'Are you sure you want to delete **{{modelName}}**?':
			'Haluatko varmasti poistaa **{{modelName}}**?',
		'Are you sure you want to delete all chats? This action cannot be undone.':
			'Haluatko varmasti poistaa kaikki keskustelut? Tätä toimintoa ei voi peruuttaa.',
		'Are you sure you want to delete this channel?': 'Haluatko varmasti poistaa tämän kanavan?',
		'Are you sure you want to delete this connection? This action cannot be undone.':
			'Haluatko varmasti poistaa yhteyden? Tätä toimintoa ei voi peruuttaa.',
		'Are you sure you want to delete this memory? This action cannot be undone.':
			'Haluatko varmasti poistaa muiston? Tätä toimintoa ei voi peruuttaa.',
		...
		"Are you sure you want to delete this version? Child versions will be relinked to this version's parent.":
			'Haluatko varmasti poistaa tämän version? Alaversiot linkitetään uudelleen tämän version ylätason versioon.',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Haluatko varmasti purkaa kaikkien arkistoitujen keskustelujen arkistoinnin?',
		...
		'Autocomplete Generation Input Max Length':
			'Automaattisen täydennyksen syötteen enimmäispituus',
		Automatic1111: L,
		...
		'Automatically inject system tools in native function calling mode (e.g., timestamps, memory, chat history, notes, etc.)':
			'Lisää järjestelmätyökaluja automaattisesti natiivissa toimintokutsutilassa (esim. aikaleimat, muisti, keskusteluhistoria, muistiinpanot jne.)',
		Automation: O,
		...
		'Base Model List Cache speeds up access by fetching base models only at startup or on settings save—faster, but may not show recent base model changes.':
			'Malliluettelon välimuisti nopeuttaa käyttöä hakemalla mallit vain käynnistyksen yhteydessä, tai asetusten tallentamisen yhteydessä - nopeampaa, mutta ei välttämättä näytä viimeisimpiä malli muutoksia.',
		Bearer: V,
		before: F,
		...
		'Boosting or penalizing specific tokens for constrained responses. Bias values will be clamped between -100 and 100 (inclusive). (Default: none)':
			'Tiettyjen tokeneiden tehostaminen tai rankaiseminen rajoitetuista vastauksista. Poikkeaman arvot rajoitetaan välille -100 ja 100 (mukaan lukien). (Oletus: ei mitään)',
		Brave: Y,
		'Brave Search API Key': 'Brave Search API -avain',
		'Break down complex requests into trackable steps':
			'Pilko monimutkaiset pyynnöt seurattaviin vaiheisiin',
		...
		'Call feature is not supported when using Web STT engine':
			'Puhelutoimintoa ei tueta käytettäessä web-puheentunnistusmoottoria',
		Camera: z,
		Cancel: Q,
		...
		'Character limit for autocomplete generation input':
			'Automaattisen täydennyksen syötteen merkkiraja',
		...
		'Chunks smaller than this threshold will be merged with neighboring chunks when possible. Set to 0 to disable merging.':
			'Kynnysarvoa pienemmät osat yhdistetään viereisiin osiin mahdollisuuksien mukaan. Aseta arvoksi 0 poistaaksesi yhdistämisen käytöstä.',
		Ciphers: se,
		Citation: ne,
		Citations: le,
		...
		'Click here to download user import template file.':
			'Lataa käyttäjien tuontipohjatiedosto klikkaamalla tästä.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Klikkaa tästä oppiaksesi lisää faster-whisperista ja nähdäksesi saatavilla olevat mallit.',
		...
		'Click here to upload a workflow.json file.':
			'Klikkaa tästä ladataksesi workflow.json-tiedosto.',
		'click here.': 'klikkaa tästä.',
		"Click on the user role button to change a user's role.":
			'Klikkaa käyttäjän roolipainiketta vaihtaaksesi käyttäjän roolia.',
		'Click to connect': 'Klikkaa yhdistääksesi',
		'Click to copy ID': 'Klikkaa kopioidaksesi ID',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Leikepöydälle kirjoitusoikeus evätty. Tarkista selaimesi asetukset ja myönnä tarvittavat käyttöoikeudet.',
		Clone: re,
		...
		'Connect to an AI provider to start chatting':
			'Yhdistä tekoälypalveluntarjoajaan aloittaaksesi keskustelut',
		'Connect to Open Terminal instances to browse files and use them as always-on tools. Only one can be active at a time.':
			'Yhdistä Open Terminal -instansseihin selataksesi tiedostoja ja käyttääksesi niitä aina päällä olevina työkaluina. Vain yksi voi olla aktiivinen kerrallaan.',
		'Connect to Open Terminal instances. All users will have access to file browsing and terminal tools through these servers.':
			'Yhdistä Open Terminal -instansseihin. Kaikilla käyttäjillä on pääsy tiedostojen selaamiseen ja päätetyökaluihin näiden palvelimien kautta.',
		'Connect to your own OpenAI compatible API endpoints.':
			'Yhdistä omat OpenAI yhteensopivat API päätepisteet.',
		'Connect to your own OpenAPI compatible external tool servers.':
			'Yhdistä omat ulkopuoliset OpenAPI yhteensopivat työkalu palvelimet.',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			'Rajoittaa päättelyn määrää päättelymalleissa. Tämä soveltuu vain tarjoajiin jotka tukevat päättelyn määrä asetusta.',
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Muokkaa, miten viestin teksti jaetaan puhesynteesipyyntöjä varten. 'Välimerkit' jakaa lauseisiin, 'kappaleet' jakaa kappaleisiin ja 'ei mitään' pitää viestin yhtenä merkkijonona.",
		...
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			'Kontrolloi yhtenäisyyden ja monimuotoisuuden tasapainoa tuloksessa. Pienempi arvo tuottaa kohdennetumman ja johdonmukaisemman tekstin.',
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'CORS täytyy olla konfiguroitu palveluntarjoajan toimesta pyyntöjen hyväksymiseksi Open WebUI:sta.',
		...
		'Create scheduled prompts that run automatically on a recurring basis.':
			'Luo aikataulutettuja kehotteita, jotka suoritetaan automaattisesti toistuvasti.',
		'Create your first note by clicking on the plus button below.':
			'Luo ensimmäinen muistiinpanosi painamalla alla olevaa plus painiketta.',
		'Created at': 'Luotu',
		'Created At': 'Luotu',
		'Created by': 'Luonut',
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			'Oletustila toimii laajemman mallivalikoiman kanssa kutsumalla työkaluja kerran ennen suorittamista. Natiivitila hyödyntää mallin sisäänrakennettuja työkalujen kutsumisominaisuuksia, mutta edellyttää, että malli tukee tätä ominaisuutta.',
		...
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			'Segmentoitu haku on oletuksena kohdennettua ja relevanttia sisällön poimimista varten. Tätä suositellaan useimmissa tapauksissa.',
		...
		'Deployment names are required for Azure OpenAI':
			'Azure OpenAI:lle vaaditaan käyttöönottojen nimet',
		Desc: _e,
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'Suorat yhteydet mahdollistavat käyttäjien yhdistää omia OpenAI-yhteensopivia API-päätepisteitä.',
		...
		'Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.':
			'Poista kuvien poiminta käytöstä PDF tiedostoista. Jos LLM on käytössä, kuvat tekstitetään automaattisesti. Oletuksena ei käytössä.',
		Disabled: Ge,
		'Disconnect OAuth': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			'Tutustu Open WebUI:n käyttöön ja pyydä tukea yhteisöltä.',
		'Discover wonders': 'Löydä ihmeellisiä asioita',
		'Discover, download, and explore custom functions':
			'Etsi, lataa ja tutki mukautettuja toimintoja',
		...
		'Discussion channel where access is based on groups and permissions':
			'Keskustelukanava, jonka käyttöoikeus perustuu ryhmiin ja käyttöoikeuksiin',
		Display: qe,
		...
		'Display the username instead of You in the Chat':
			'Näytä käyttäjänimi keskustelussa "Sinä" -tekstin sijaan',
		...
		'Displays status updates (e.g., web search progress) in the response':
			'Näyttä tilapäivityksiä (esim. verkkohaku) vastauksissa',
		'Dive into knowledge': 'Uppoudu tietoon',
		'Do not install functions from sources you do not fully trust.':
			'Älä asenna toimintoja lähteistä, joihin et luota täysin.',
		'Do not install tools from sources you do not fully trust.':
			'Älä asenna työkaluja lähteistä, joihin et luota täysin.',
		'Do you want to sync your usage stats with Open WebUI Community?':
			'Haluatko jakaa käyttötilastosi Open WebUI yhteisön kanssa?',
		Docling: ze,
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'ei tee ulkoisia yhteyksiä, ja tietosi pysyvät turvallisesti paikallisesti isännöidyllä palvelimellasi.',
		'Domain Filter List': 'Verkko-osoitteiden suodatuslista',
		"don't fetch random pipelines from sources you don't trust.":
			'Älä hae satunnaisia pipelineja epäluotettavista lähteistä.',
		"Don't have an account?": 'Eikö sinulla ole tiliä?',
		"don't install random functions from sources you don't trust.":
			'älä asenna satunnaisia toimintoja lähteistä, joihin et luota.',
		"don't install random tools from sources you don't trust.":
			'älä asenna satunnaisia työkaluja lähteistä, joihin et luota.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"esim. '30s', '10m'. Kelpoiset aikayksiköt ovat 's', 'm', 'h'.",
		...
		'e.g. A filter to remove profanity from text':
			'esim. suodatin, joka poistaa kirosanoja tekstistä',
		...
		'e.g. Step-by-step instructions for code reviews':
			'esim. vaiheittaiset ohjeet koodikatselmuksiin',
		'e.g. Tell me a fun fact': 'esim. Kerro minulle hauska fakta',
		'e.g. Tell me a fun fact about the Roman Empire':
			'esim. Kerro minulle hauska fakta Rooman valtakunnasta',
		'e.g. Tools for performing various operations':
			'esim. työkaluja erilaisten toimenpiteiden suorittamiseen',
		'e.g., 3, 4, 5 (leave blank for default)':
			'esim. 3, 4, 5 (jätä tyhjäksi, jos haluat oletusarvon)',
		'e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)':
			'esim. audio/wav,audio/mpeg,video/* (oletusarvot tyhjänä)',
		'e.g., en-US,ja-JP (leave blank for auto-detect)':
			'esim. en-US,ja-JP (Tyhjäksi jättämällä, automaattinen tunnistus)',
		...
		'Enable autocomplete generation for chat messages':
			'Ota automaattinen täydennys käyttöön keskusteluviesteissä',
		...
		"Enable Memory Locking (mlock) to prevent model data from being swapped out of RAM. This option locks the model's working set of pages into RAM, ensuring that they will not be swapped out to disk. This can help maintain performance by avoiding page faults and ensuring fast data access.":
			'Ota Memory Locking (mlock) käyttöön estääksesi mallidatan vaihtamisen pois RAM-muistista. Tämä lukitsee mallin työsivut RAM-muistiin, varmistaen että niitä ei vaihdeta levylle. Tämä voi parantaa suorituskykyä välttämällä sivuvikoja ja varmistamalla nopean tietojen käytön.',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Varmista, että CSV-tiedostossasi on 4 saraketta tässä järjestyksessä: Nimi, Sähköposti, Salasana, Rooli.',
		'Enter {{role}} message here': 'Kirjoita {{role}}-viesti tähän',
		'Enter a detail about yourself for your LLMs to recall':
			'Kirjoita yksityiskohta itsestäsi, jonka LLM-ohjelmat voivat muistaa',
		'Enter a title for the pending user info overlay. Leave empty for default.':
			'Kirjoita infon otsikko odottaville käyttäjille. Käytä oletusta jättämällä tyhjäksi.',
		'Enter a watermark for the response. Leave empty for none.':
			'Kirjoita vastauksen vesileima. Jätä tyhjäksi, jos et halua mitään.',
		'Enter additional headers in JSON format': 'Kirjoita lisä ylätunnisteita JSON muodossa',
		'Enter additional headers in JSON format (e.g. {"X-Custom-Header": "value"}':
			'Kirjoita lisäotsikot JSON-muodossa (esim. {"X-Custom-Header": "value"}',
		...
		'Enter api auth string (e.g. username:password)':
			'Kirjoita API-todennusmerkkijono (esim. käyttäjätunnus:salasana)',
		...
		'Enter comma-separated "token:bias_value" pairs (example: 5432:100, 413:-100)':
			'Syötä pilkulla erottaen "token:bias_value" parit (esim. 5432:100, 413:-100)',
		'Enter content for the pending user info overlay. Leave empty for default.':
			'Kirjoita odottavien käyttäjien infon tekstisisältö. Käytä oletusta jättämällä tyhjäksi.',
		...
		'Enter domains separated by commas (e.g., example.com,site.org,!excludedsite.com)':
			'Kirjoita verkkotunnukset pilkulla erottaen (esim., example.com,site.org,!excludedsite.com)',
		...
		'Enter function name filter list (e.g. func1, !func2)':
			'Kirjoita funktion nimen suodatinluettelo (esim. func1, !func2)',
		...
		'Enter JSON config (e.g., {"disable_links": true})':
			'Kirjoita JSON asetus (esim. {"disable_links": true})',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Kirjoita välityspalvelimen verkko-osoite (esim. https://käyttäjä:salasana@host:portti)',
		...
		'Enter the prompt instructions for this automation...':
			'Kirjoita kehotteen ohjeet tälle automaatiolle...',
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'Kirjoita julkinen WebUI verkko-osoitteesi. Verkko-osoitetta käytetään osoitteiden luontiin ilmoituksissa.',
		...
		'Enter URL (e.g. http://127.0.0.1:7860/)':
			'Kirjoita verkko-osoite (esim. http://127.0.0.1:7860/)',
		'Enter URL (e.g. http://localhost:11434)':
			'Kirjoita verkko-osoite (esim. http://localhost:11434)',
		...
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			'Kirjoita Yacy verkko-osoite (esim. http://yacy.example.com:8090)',
		...
		"Error: A model with the ID '{{modelId}}' already exists. Please select a different ID to proceed.":
			"Virhe: Malli '{{modelId}}' on jo käytössä. Valitse toinen ID jatkaaksesi.",
		'Error: Model ID cannot be empty. Please enter a valid ID to proceed.':
			'Virhe: Mallin ID ei voi olla tyhjä. Kirjoita ID jatkaaksesi.',
		Evaluations: ht,
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Esimerkki: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Esimerkki: sAMAccountName tai uid tai userPrincipalName',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			'Lisenssiisi kuuluva paikkamäärä on ylittynyt. Ota yhteyttä tukeen, jos haluat lisätä paikkoja.',
		Exclude: vt,
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'Yhdistäminen {{URL}} OpenAPI työkalu palvelimeen epäonnistui',
		'Failed to connect to {{URL}} terminal server':
			'Yhdistäminen {{URL}} päätepalvelimeen epäonnistui',
		...
		'Failed to extract content from the file: {{error}}':
			'Tiedoston sisällön pomiminen epäonnistui: {{error}}',
		...
		'Failed to load DOCX file. Please try downloading it instead.':
			'DOCX-tiedoston avaaminen epäonnistui. Yritä ladata se sen sijaan.',
		'Failed to load Excel/CSV file. Please try downloading it instead.':
			'Excel/CSV tiedoston lataaminen epäonnistui. Yritä ladata se sen sijaan.',
		...
		'Failed to load PPTX file. Please try downloading it instead.':
			'PPTX-tiedoston lataaminen epäonnistui. Yritä ladata se sen sijaan.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Sormenjäljen väärentäminen havaittu: Alkukirjaimia ei voi käyttää avatarina. Käytetään oletusprofiilikuvaa.',
		...
		'Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.':
			'Pakota OCR:n käyttö kaikilla PDF-sivuilla. Tämä voi johtaa huonompiin tuloksiin jos PDF:n tekstisisältö on laadukasta. Oletusarvo, ei käytöstä.',
		...
		'Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.':
			'Muotoile rivit. Oletusarvo on False. Jos arvo on True, rivit muotoillaan siten, että ne havaitsevat riviin liitetyn matematiikan ja tyylit.',
		...
		'Forwards system user OAuth access token to authenticate':
			'Välittää järjestelmä käyttäjän OAuth tunniste todennuksessa',
		'Forwards system user session credentials to authenticate':
			'Välittää järjestelmän käyttäjän istunnon tunnistetiedot todennusta varten',
		Fr_day_of_week: xt,
		...
		'Functions allow arbitrary code execution.':
			'Toiminnot sallivat mielivaltaisen koodin suorittamisen.',
		...
		'Get current time and perform date/time calculations':
			'Hanki nykyinen aika ja suorita päivämäärä-/aikalaskelmia',
		...
		'Hex Color - Leave empty for default color':
			'Heksadesimaaliväri - Jätä tyhjäksi, jos haluat oletusvärin',
		Hidden: ia,
		Hide: oa,
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Vahvistan, että olen lukenut ja ymmärrän toimintani seuraukset. Olen tietoinen mielivaltaisen koodin suorittamiseen liittyvistä riskeistä ja olen varmistanut lähteen luotettavuuden.',
		ID: ma,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Sisällytä `--api-auth`-lippu ajettaessa stable-diffusion-webui',
		'Include `--api` flag when running stable-diffusion-webui':
			'Sisällytä `--api`-lippu ajettaessa stable-diffusion-webui',
		...
		'Influences how quickly the algorithm responds to feedback from the generated text. A lower learning rate will result in slower adjustments, while a higher learning rate will make the algorithm more responsive.':
			'Kuinka nopeasti algoritmi mukautuu generoidun tekstin palautteeseen. Alempi oppimisnopeus hidastaa mukautumista, kun taas nopeampi oppimisnopeus tekee algoritmistä reagoivamman.',
		Info: va,
		Initials: ga,
		'Inject file content into conversation context':
			'Upota tiedostosisältö keskustelun kontekstiin',
		'Inject the entire content as context for comprehensive processing, this is recommended for complex queries.':
			'Upota koko sisältö kontekstiin kattavaa käsittelyä varten. Tätä suositellaan monimutkaisille kyselyille.',
		Input: ja,
		...
		'Instant Auto-Send After Voice Transcription':
			'Heti automaattinen lähetys äänitunnistuksen jälkeen',
		Instructions: Aa,
		Integration: Sa,
		Integrations: Pa,
		Interface: Ta,
		...
		'Invalid JSON format for ComfyUI Edit Workflow.':
			'Virheellinen JSON muotoilu ComfyUI Edit työnkululle',
		...
		'Leave empty to include all models from "{{url}}" endpoint':
			'Jätä tyhjäksi sisällyttääksesi "{{url}}" päätepisteen mallit',
		'Leave empty to include all models from "{{url}}/api/tags" endpoint':
			'Jätä tyhjäksi sisällyttääksesi "{{url}}/api/tags" päätepisteen mallit',
		'Leave empty to include all models from "{{url}}/models" endpoint':
			'Jätä tyhjäksi sisällyttääksesi "{{url}}/models" päätepisteen mallit',
		'Leave empty to include all models or select specific models':
			'Jätä tyhjäksi, jos haluat sisällyttää kaikki mallit tai valitse tietyt mallit',
		...
		'Leave empty to use the default config, or enter a valid json (see https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)':
			'Jätä tyhjäksi käyttääksesi oletuskokoonpanoa tai anna kelvollinen JSON-tiedosto (katso https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)',
		'Leave empty to use the default model (voxtral-mini-latest).':
			'Jätä tyhjäks käyttääksesi oletusmallia (voxtral-mini-latest)',
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Jätä tyhjäksi käyttääksesi oletuskehotetta tai kirjoita mukautettu kehote',
		'Leave model field empty to use the default model.':
			'Jätä malli kenttä tyhjäksi käyttääksesi oletus mallia.',
		Legacy: Da,
		lexical: Ra,
		License: Na,
		...
		'Limit concurrent search queries. 0 = unlimited (default). Set to 1 for sequential execution (recommended for APIs with strict rate limits like Brave free tier).':
			'Rajoita samanaikaisia hakukyselyitä. 0 = rajoittamaton (oletus). Aseta arvoon 1 peräkkäistä suoritusta varten (suositellaan API-rajapinnoille, joilla on tiukat nopeusrajoitukset, kuten Brave-ilmaistaso).',
		'Limits the number of concurrent embedding requests. Set to 0 for unlimited.':
			'Rajoittaa samanaikaisten upotuspyyntöjen määrää. Arvolla 0 ei rajoituksia.',
		List: Va,
		'List calendars, search, create, update, and delete calendar events':
			'Listaa kalenterit, hae, luo, päivitä ja poista kalenteritapahtumia',
		'Listening...': 'Kuuntelee...',
		Live: Fa,
		'Llama.cpp': 'Llama.cpp',
		'LLMs can make mistakes. Verify important information.':
			'Kielimallit voivat tehdä virheitä. Tarkista tärkeät tiedot.',
		Loader: Wa,
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Muista viedä workflow.json-tiedosto API-muodossa ComfyUI:sta.',
		Male: qa,
		Manage: za,
		...
		'Maximum characters to return from fetched URLs. Leave empty for no limit.':
			'Maksimimerkkimäärä haetuista URL-osoitteista. Jätä tyhjäksi, jos et halua rajoitusta.',
		'Maximum number of files allowed per folder.':
			'Kansiota kohden sallittujen tiedostojen enimmäismäärä.',
		'Maximum number of files per folder is {{max}}.':
			'Tiedostojen enimmäismäärä kansiossa on {{max}}.',
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Enintään 3 mallia voidaan ladata samanaikaisesti. Yritä myöhemmin uudelleen.',
		May: Xa,
		MBR: $a,
		MCP: ei,
		'MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Open WebUI team, making it the more reliable option for compatibility.':
			'MCP-tuki on kokeellinen ja sen määritykset muuttuvat usein, mikä voi johtaa yhteensopivuus ongelmiin. OpenAPI-määritysten tuesta vastaa suoraan Open WebUI -tiimi, joten se on luotettavampi vaihtoehto yhteensopivuuden kannalta.',
		Medium: ti,
		...
		'Memories accessible by LLMs will be shown here.':
			'Muistitiedostot, joita LLM-ohjelmat käyttävät, näkyvät tässä.',
		Memory: si,
		...
		'Message counts are based on assistant responses.':
			'Viestien määrä perustuu avustajan vastauksiin.',
		'Message rating should be enabled to use this feature':
			'Tämän toiminnon käyttämiseksi viestiarviointi on otettava käyttöön',
		messages: li,
		Messages: ri,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Linkin luomisen jälkeen lähettämäsi viestit eivät ole jaettuja. Käyttäjät, joilla on verkko-osoite, voivat tarkastella jaettua keskustelua.',
		'Microsoft OneDrive': '',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Malli '{{modelName}}' ladattiin onnistuneesti.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Malli '{{modelTag}}' on jo jonossa ladattavaksi.",
		...
		'Model can access Open Terminal for command execution and file management':
			'Malli voi käyttää Open Terminal-toimintoa komentojen suorittamiseen ja tiedostojen hallintaan.',
		...
		'Model can generate images based on text prompts':
			'Malli voi luoda kuvia tekstikehotteiden perusteella',
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Mallin tiedostojärjestelmäpolku havaittu. Mallin lyhytnimi vaaditaan päivitykseen, ei voida jatkaa.',
		...
		'Model name already exists, please choose a different one':
			'Mallin nimi on jo olemassa, valitse toinen nimi.',
		...
		'Name and ID are required, please fill them out':
			'Nimi ja ID vaaditaan, täytä puuttuvat kentät',
		...
		'No expiration can pose security risks.':
			'Vanhenemisen laittamatta jättäminen voi altistaa tietoturvariskeille.',
		...
		'No files yet. Upload files or run Python code to create them.':
			'Ei vielä tiedostoja. Lataa tiedostoja tai suorita Python-koodia niiden luomiseksi.',
		...
		'No HTML, CSS, or JavaScript content found.':
			'HTML-, CSS- tai JavaScript-sisältöä ei löytynyt.',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Huomautus: Jos asetat vähimmäispistemäärän, haku palauttaa vain sellaiset asiakirjat, joiden pistemäärä on vähintään vähimmäismäärä.',
		Notes: wi,
		...
		'Only active when "Paste Large Text as File" setting is toggled on.':
			'Aktiivinen vain, kun "Liitä suuri teksti tiedostona" -asetus on käytössä.',
		'Only active when the chat input is in focus and an LLM is generating a response.':
			'Aktiivinen vain, kun tekstikenttä on kohdistettuna ja LLM luo vastausta.',
		'Only active when the chat input is in focus.':
			'Aktiivinen vain, kun tekstikenttä on valittuna.',
		'Only alphanumeric characters and hyphens are allowed':
			'Vain kirjaimet, numerot ja väliviivat ovat sallittuja',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Vain kirjaimet, numerot ja väliviivat ovat sallittuja komentosarjassa.',
		'Only can be triggered when the chat input is in focus.':
			'Voidaan laukaista vain, kun tekstikenttä on kohdistettuna.',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Vain kokoelmia voi muokata, luo uusi tietokanta muokataksesi/lisätäksesi asiakirjoja.',
		...
		'Only select users and groups with permission can access':
			'Vain valitut käyttäjät ja ryhmät, joilla on käyttöoikeus, pääsevät käyttämään',
		'Only sync new/updated chats': 'Synkronoi vain uudet/päivitetyt keskustelut',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Hups! Näyttää siltä, että verkko-osoite on virheellinen. Tarkista se ja yritä uudelleen.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Hups! Tiedostoja on vielä ladattavana. Odota, että lataus on valmis.',
		'Oops! There was an error in the previous response.':
			'Hups! Edellisessä vastauksessa oli virhe.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Hups! Käytät ei-tuettua menetelmää (vain frontend). Palvele WebUI:ta backendistä.',
		...
		'Open Modal To Manage Floating Quick Actions':
			'Avaa modaali kelluvien pikatoimintojen hallitsemiseksi',
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			'Open WebUI voi käyttää minkä tahansa OpenAPI-palvelimen tarjoamia työkaluja.',
		...
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open WebUI käyttää SpeechT5:tä ja CMU Arctic -kaiuttimen upotuksia.',
		'Open WebUI version': 'Open WebUI versio',
		...
		'Page mode creates one document per page. Single mode combines all pages into one document for better chunking across page boundaries.':
			'Sivutila luo yhden dokumentin sivua kohden. Yksittäistila yhdistää kaikki sivut yhdeksi dokumentiksi, mikä parantaa paloittelua sivurajojen yli.',
		Paginate: Gi,
		Parameters: qi,
		...
		'Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Open WebUI. Your privacy is paramount: no message content is ever shared.':
			'Osallistu yhteisön tulostaulukoihin ja arviointeihin! Koottujen käyttötilastojen synkronointi auttaa edistämään Open WebUI:n tutkimuksia ja parannuksia. Tietosuojasi on ensiarvoisen tärkeää: viestien sisältöä ei koskaan jaeta.',
		Password: zi,
		...
		'Permission denied when accessing microphone: {{error}}':
			'Käyttöoikeus evätty mikrofonille: {{error}}',
		Permissions: $i,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines on liitännäisjärjestelmä, jossa voidaan suorittaa mielivaltaista koodia —',
		...
		'Please carefully review the following warnings:':
			'Tarkista huolellisesti seuraavat varoitukset:',
		'Please connect all required integrations before sending a message':
			'Yhdistä kaikki vaaditut integraatiot ennen viestin lähettämistä.',
		'Please do not close the settings page while loading the model.':
			'Älä sulje asetussivua mallin latautuessa.',
		...
		'Please save the connection to persist the OAuth client information and do not change the ID':
			'Tallenna yhteys, jotta OAuth-asiakastiedot säilyvät, äläkä muuta tunnusta.',
		...
		'Please select at least one user for Direct Message channel.':
			'Valitse vähintään yksi käyttäjä suoraviestikanavalle.',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'Etuliite-ID:tä käytetään välttämään ristiriidat muiden yhteyksien kanssa lisäämällä etuliite mallitunnuksiin - jätä tyhjäksi, jos haluat ottaa sen pois käytöstä',
		...
		'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative.':
			'Vähentää hölynpölyn tuottamisen todennäköisyyttä. Korkeampi arvo (esim. 100) antaa monipuolisempia vastauksia, kun taas matalampi arvo (esim. 10) on varovaisempi.',
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Viittaa itseen "Käyttäjänä" (esim. "Käyttäjä opiskelee espanjaa")',
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Vastausilmoituksia ei voida ottaa käyttöön, koska verkkosivuston käyttöoikeudet on evätty. Myönnä tarvittavat käyttöoikeudet selaimesi asetuksista.',
		...
		'Runs embedding tasks concurrently to speed up processing. Turn off if rate limits become an issue.':
			'Suorittaa upotustehtäviä samanaikaisesti käsittelyn nopeuttamiseksi. Poista käytöstä, jos kutsurajoituksesta tulee ongelma.',
		Sa_day_of_week: Yo,
		Save: Bo,
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Keskustelulokien tallentaminen suoraan selaimen tallennustilaan ei ole enää tuettu. Lataa ja poista keskustelulokit napsauttamalla alla olevaa painiketta. Älä huoli, voit helposti tuoda keskustelulokit takaisin backendiin',
		Schedule: qo,
		...
		'Select how to split message text for TTS requests':
			'Valitse, miten viestit jaetaan TTS-pyyntöjä varten',
		...
		'Set the default models that are automatically selected for all users when a new chat is created.':
			'Aseta oletusmallit, jotka valitaan automaattisesti kaikille käyttäjille, kun uusi keskustelu luodaan.',
		'Set the models that are automatically pinned to the sidebar for all users.':
			'Aseta mallit, jotka kiinnitetään automaattisesti sivupalkkiin kaikille käyttäjille.',
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			'Aseta näytönohjaimelle ladattavien tasojen määrä. Tämän arvon kasvattaminen voi parantaa merkittävästi näytönohjaimelle optimoitujen mallien suorituskykyä, mutta se voi myös lisätä näytönohjaimen virrankulutusta ja resurssien käyttöä.',
		'Set the number of worker threads used for computation. This option controls how many threads are used to process incoming requests concurrently. Increasing this value can improve performance under high concurrency workloads but may also consume more CPU resources.':
			'Aseta työntekijäsäikeiden määrä laskentaa varten. Tämä asetus kontrolloi, kuinka monta säiettä käytetään saapuvien pyyntöjen rinnakkaiseen käsittelyyn. Arvon kasvattaminen voi parantaa suorituskykyä suurissa samanaikaisissa työkuormissa, mutta voi myös kuluttaa enemmän keskussuorittimen resursseja.',
		...
		'Sets how far back for the model to look back to prevent repetition.':
			'Määrittää kuinka kauas taaksepäin malli katsoo toistumisen estämiseksi.',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			'Määrittä satunnainen siemenluku luomista varten. Jos asetat siemenluvun, malli tuottaa saman vastauksen samalle kehotteelle.',
		'Sets the size of the context window used to generate the next token.':
			'Määrittää konteksti-ikkunan koon seuraavaksi luotavalle tokenille.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			'Määrittää käytettävät lopetussekvenssit. Kun tämä kuvio havaitaan, LLM lopettaa tekstin tuottamisen ja palauttaa. Useita lopetuskuvioita voidaan asettaa määrittämällä useita erillisiä lopetusparametreja mallitiedostoon.',
		Setting: is,
		Settings: os,
		...
		'Show Admin Details in Account Pending Overlay':
			'Näytä ylläpitäjän tiedot odottavan tilin päällä',
		...
		'Showing all messages (user + assistant) per user.':
			'Näytetään kaikki viestit (käyttäjä + avustaja) käyttäjää kohden.',
		...
		'Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.':
			'Parantaa merkittävästi tarkkuutta käyttämällä LLM mallia taulukoiden, lomakkeiden, rivikohtaisen matematiikan ja asettelun tunnistuksen parantamiseen. Lisää viivettä. Oletusarvo on False.',
		...
		'Skip the cache and re-run the inference. Defaults to False.':
			'Ohita välimuisti ja suorita päätelmä uudelleen. Oletusarvo ei käytössä.',
		...
		'Split documents by markdown headers before applying character/token splitting.':
			'Jaa dokumentit Markdown-otsikoiden mukaan ennen merkki-/tunnusjaon käyttöä',
		...
		'Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.':
			'Poista olemassa oleva OCR-teksti PDF-tiedostosta ja suorita OCR uudelleen. Ohitetaan, jos pakota OCR -asetus on käytössä. Oletusarvo ei käytössä.',
		...
		'Syncs only chats with updates after your last sync timestamp. Disable to re-sync all chats.':
			'Synkronoi vain keskustelut, joihin on tehty päivityksiä viimeisen synkronoinnin aikaleiman jälkeen. Poista käytöstä synkronoidaksesi kaikki keskustelut uudelleen.',
		System: Ts,
		...
		'The Application Account DN you bind with for search':
			'Hakua varten sidottu sovelluksen käyttäjätilin DN',
		...
		'The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.':
			'Eräkoko määrittää, kuinka monta tekstipyyntöä käsitellään kerralla. Suurempi eräkoko voi parantaa mallin suorituskykyä ja nopeutta, mutta se vaatii myös enemmän muistia.',
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Tämän lisäosan takana olevat kehittäjät ovat intohimoisia vapaaehtoisyhteisöstä. Jos koet tämän lisäosan hyödylliseksi, harkitse sen kehittämisen tukemista.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Arviointitulosluettelo perustuu Elo-luokitusjärjestelmään ja päivittyy reaaliajassa.',
		'The format to return a response in. Format can be json or a JSON schema.':
			'Muoto, jolla vastaus palautetaan. Muoto voi olla json- tai JSON-skeema.',
		'The height in pixels to compress images to. Leave empty for no compression.':
			'Kuvien pakkauskorkeus pikseleinä. Jätä tyhjäksi, jos et halua pakata kuvia.',
		'The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.':
			'Syöteäänen kieli. Syöttökielen antaminen ISO-639-1-muodossa (esim. en) parantaa tarkkuutta ja viivettä. Jätä tyhjäksi, jos haluat kielen automaattisen tunnistuksen.',
		'The LDAP attribute that maps to the mail that users use to sign in.':
			'LDAP-määrite, joka yhdistää käyttäjien kirjautumiseen käyttämään sähköpostiin.',
		'The LDAP attribute that maps to the username that users use to sign in.':
			'LDAP-määrite, joka vastaa käyttäjien kirjautumiskäyttäjänimeä.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'Tulosluettelo on tällä hetkellä beta-vaiheessa, ja voimme säätää pisteytyksen laskentaa hienostaessamme algoritmia.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'Enimmäistiedostokoko megatavuissa. Jos tiedoston koko ylittää tämän rajan, tiedostoa ei ladata.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'Suurin sallittu tiedostojen määrä käytettäväksi kerralla chatissa. Jos tiedostojen määrä ylittää tämän rajan, niitä ei ladata.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			"Tekstin tulostusmuoto. Voi olla 'json', 'markdown' tai 'html'. Oletusarvo on 'markdown'.",
		"The passwords you entered don't quite match. Please double-check and try again.":
			'Antamasi salasanat eivät täysin täsmää. Tarkista ne ja yritä uudelleen.',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Pisteytyksen tulee olla arvo välillä 0,0 (0 %) ja 1,0 (100 %).',
		'The stream delta chunk size for the model. Increasing the chunk size will make the model respond with larger pieces of text at once.':
			'Mallin striimin delta-lohkon koko. Lohkon koon kasvattaminen saa mallin vastaamaan kerralla suuremmilla tekstipaloilla.',
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'Mallin lämpötila. Lisäämällä lämpötilaa mallin vastaukset ovat luovempia.',
		'The Weight of BM25 Hybrid Search. 0 more semantic, 1 more lexical. Default 0.5':
			'BM25-hybridihaun painoarvo. 0 semanttista, 1 leksikaalista. Oletusarvo 0,5',
		'The width in pixels to compress images to. Leave empty for no compression.':
			'Leveys pikseleinä, johon kuvat pakataan. Jätä tyhjäksi, jos et halua pakkausta.',
		Theme: Ms,
		'There was an error syncing your stats. Please try again.':
			'Tilastojen synkronoinnissa tapahtui virhe. Yritä uudelleen.',
		'Thinking...': 'Ajattelee...',
		'This action cannot be undone. Do you wish to continue?':
			'Tätä toimintoa ei voi peruuttaa. Haluatko jatkaa?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'Tämä kanava on luotiin {{createdAt}}. Tämä on {{channelName}} kanavan alku.',
		"This chat won't appear in history and your messages will not be saved.":
			'Tämä keskustelu ei näy historiassa, eikä viestejäsi tallenneta.',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Tämä varmistaa, että arvokkaat keskustelusi tallennetaan turvallisesti backend-tietokantaasi. Kiitos!',
		'This feature is currently experimental and may not work as expected.':
			'Tämä ominaisuus on tällä hetkellä kokeellinen eikä välttämättä toimi odotetulla tavalla.',
		'This feature is experimental and may be modified or discontinued without notice.':
			'Tämä ominaisuus on kokeellinen ja sitä voidaan muokata tai se voidaan lopettaa ilman erillistä ilmoitusta.',
		'This folder is empty': 'Tämä kansio on tyhjä',
		'This is a default user permission and will remain enabled.':
			'Tämä on oletusarvoinen käyttäjäoikeus ja pysyy käytössä.',
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Tämä on kokeellinen ominaisuus, se ei välttämättä toimi odotetulla tavalla ja se voi muuttua milloin tahansa.',
		'This model is not publicly available. Please select another model.':
			'Tämä malli ei ole julkisesti saatavilla. Valitse toinen malli.',
		'This option controls how long the model will stay loaded into memory following the request (default: 5m)':
			'Tämä asetus määrittää kuinka kauan malli pysyy ladattuna muistissa pyynnön jälkeen (oletusarvo: 5m)',
		'This option controls how many tokens are preserved when refreshing the context. For example, if set to 2, the last 2 tokens of the conversation context will be retained. Preserving context can help maintain the continuity of a conversation, but it may reduce the ability to respond to new topics.':
			'Tämä asetus määrittää, kuinka monta tokenia säilytetään kontekstia päivitettäessä. Jos arvoksi on asetettu esimerkiksi 2, keskustelukontekstin kaksi viimeistä tokenia säilytetään. Kontekstin säilyttäminen voi auttaa ylläpitämään keskustelun jatkuvuutta, mutta se voi heikentää kykyä vastata uusiin aiheisiin.',
		'This option enables or disables the use of the reasoning feature in Ollama, which allows the model to think before generating a response. When enabled, the model can take a moment to process the conversation context and generate a more thoughtful response.':
			'Tämä vaihtoehto mahdollistaa tai estää päättelyominaisuuden käytön Ollama:ssa, mikä antaa mallille mahdollisuuden miettiä ennen vastauksen tuottamista. Kun se on käytössä, malli voi ottaa hetken aikaa käsitellä keskustelun kontekstia ja tuottaa ajatellumman vastauksen.',
		'This option sets the maximum number of tokens the model can generate in its response. Increasing this limit allows the model to provide longer answers, but it may also increase the likelihood of unhelpful or irrelevant content being generated.':
			'Tämä vaihtoehto asettaa mallin vastauksessaan luomien tokenien enimmäismäärän. Tämän rajan nostaminen antaa mallille mahdollisuuden tarjota pidempiä vastauksia, mutta se voi myös lisätä hyödyttömän tai epäolennaisen sisällön luomisen todennäköisyyttä.',
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Tämä vaihtoehto poistaa kaikki kokoelman nykyiset tiedostot ja korvaa ne uusilla ladatuilla tiedostoilla.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Tämä poistaa <strong>{{NAME}}</strong> ja <strong>kaikki sen sisällöt</strong>.',
		'This will delete all models including custom models':
			'Tämä poistaa kaikki mallit mukaan lukien mukautetut mallit',
		'This will delete all models including custom models and cannot be undone.':
			'Tämä poistaa kaikki mallit, mukaan lukien mukautetut mallit, eikä sitä voi peruuttaa.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'Tämä poistaa pysyvästi kalenterin "{{name}}" ja kaikki sen tapahtumat. Tätä toimintoa ei voi peruuttaa.',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Tämä nollaa tietokannan ja synkronoi kaikki tiedostot. Haluatko jatkaa?',
		...
		'Thumbs up/down ratings from users on model responses':
			'Käyttäjien peukku-/alas-arviot mallien vastauksista',
		Tika: Us,
		...
		'To access the available model names for downloading,':
			'Päästäksesi käsiksi ladattavissa oleviin mallinimiin,',
		'To access the GGUF models available for downloading,':
			'Päästäksesi käsiksi ladattavissa oleviin GGUF-malleihin,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'Päästäksesi käyttämään WebUI:ta, ota yhteyttä ylläpitäjään. Ylläpitäjät voivat hallita käyttäjien tiloja Ylläpitopaneelista.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Liittääksesi tietokantasi tähän, lisää ne ensin "Tietämys"-työtilaan.',
		'To learn more about available endpoints, visit our documentation.':
			'Jos haluat lisätietoja käytettävissä olevista päätepisteistä, tutustu dokumentaatioomme.',
		'To select skills here, add them to the "Skills" workspace first.':
			'Jos haluat valita taitoja tässä, lisää ne ensin "Taidot"-työtilaan.',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Valitaksesi työkalusettejä tässä, lisää ne ensin "Työkalut"-työtilaan.',
		...
		'Token counts are estimates and may not reflect actual API usage':
			'Tokenmäärät ovat arvioita eivätkä välttämättä vastaa todellista API-käyttöä',
		tokens: _s,
		Tokens: Hs,
		...
		'Tools are a function calling system with arbitrary code execution':
			'Työkalut ovat toimintokutsuihin perustuva järjestelmä, joka sallii mielivaltaisen koodin suorittamisen',
		...
		'Try adjusting your search or filter to find what you are looking for.':
			'Kokeile muokata hakuasi tai suodatintasi löytääksesi etsimäsi.',
		...
		'Update for the latest features and improvements.':
			'Päivitä uusimpiin ominaisuuksiin ja parannuksiin.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Päivitä lisenssi saadaksesi parempia ominaisuuksia, mukaan lukien mukautetun teeman ja brändäyksen sekä yksilöllistä tukea.',
		Upload: on,
		...
		'Upload Progress: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)':
			'Latauksen edistyminen: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Käytä '#' -merkkiä kehotekenttään ladataksesi ja sisällyttääksesi tietämystäsi.",
		'Use /v1/chat/completions endpoint instead of /v1/audio/transcriptions for potentially better accuracy.':
			'Käytä /v1/chat/completions-päätteitä/v1/audio/transcriptions-pääteen sijaan mahdollisesti paremman tarkkuuden saavuttamiseksi.',
		'Use Chat Completions API': 'Käytä Chat Completions API:a',
		'Use groups to organize your users and assign permissions.':
			'Käytä ryhmiä käyttäjien järjestämiseen ja käyttöoikeuksien määrittämiseen.',
		...
		'Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.':
			'Käytä http_proxy- ja https_proxy-ympäristömuuttujien määrittämää välityspalvelinta sivun sisällön hakemiseen.',
		user: rn,
		User: un,
		...
		'Uses OAuth 2.1 Dynamic Client Registration':
			'Käyttää OAuth 2.1 -dynaamista asiakasrekisteröintiä',
		'Using Entire Document': 'Koko asiakirjan käyttäminen',
		'Using Focused Retrieval': 'Kohdennetun haun käyttäminen',
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Käytetään oletusarena-mallia kaikkien mallien kanssa. Napsauta plus-painiketta lisätäksesi mukautettuja malleja.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Versio {{selectedVersion}} / {{totalVersions}}',
		...
		'Voice mode': 'Puhetila',
		'Voice Mode Custom Prompt': 'Puhetilan mukautettu kehote',
		...
		'Warning: Enabling this will allow users to run scheduled prompts automatically.':
			'Varoitus: Tämän käyttöönotto sallii käyttäjien suorittaa aikataulutettuja kehotteita automaattisesti.',
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Varoitus: Tämän käyttöönotto sallii käyttäjien ladata mielivaltaista koodia palvelimelle.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			'Varoitus: Jupyter käyttö voi mahdollistaa mielivaltaiseen koodin suorittamiseen, mikä voi aiheuttaa tietoturvariskejä - käytä äärimmäisen varoen.',
		We_day_of_week: An,
		Web: Sn,
		'Web API': 'Web-API',
		...
		'WebUI will make requests to "{{url}}/api/chat"':
			'WebUI lähettää pyyntöjä osoitteeseen "{{url}}/api/chat"',
		'WebUI will make requests to "{{url}}/chat/completions"':
			'WebUI lähettää pyyntöjä osoitteeseen "{{url}}/chat/completions"',
		Week: Tn,
		Weekly: bn,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			'Kun käytössä, malli vastaa jokaiseen chatviestiin reaaliajassa, tuottaen vastauksen heti kun käyttäjä lähettää viestin. Tämä tila on hyödyllinen reaaliaikaisissa chat-sovelluksissa, mutta voi vaikuttaa suorituskykyyn hitaammilla laitteistoilla.',
		...
		'Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.':
			'Sivutetaanko tuloste. Jokainen sivu erotetaan toisistaan vaakasuoralla viivalla ja sivunumerolla. Oletusarvo ei käytössä.',
		...
		'Works together with top-k. A higher value (e.g., 0.95) will lead to more diverse text, while a lower value (e.g., 0.5) will generate more focused and conservative text.':
			'Toimii top-k:n kanssa. Korkeampi arvo (esim. 0.95) johtaa monipuolisempaan tekstiin, kun taas matalampi arvo (esim. 0.5) tuottaa kohdennetumpaa ja konservatiivisempaa teksti.',
		Workspace: En,
		'Workspace Permissions': 'Työtilan käyttöoikeudet',
		Write: Mn,
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Kirjoita 50 sanan yhteenveto, joka tiivistää [aihe tai avainsana].',
...
esim.: Olet Mario pelistä Super Mario Bros ja toimit assistenttina.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'Käytät tällä hetkellä kokeiluversiota. Ota yhteyttä tukeen lisenssin päivittämiseksi.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Voit keskustella enintään {{maxCount}} tiedoston kanssa kerralla.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Voit personoida vuorovaikutustasi LLM-ohjelmien kanssa lisäämällä muistoja 'Hallitse'-painikkeen kautta, jolloin ne ovat hyödyllisempiä ja räätälöityjä sinua varten.",
		'You cannot upload an empty file.': 'Et voi ladata tyhjää tiedostoa.',
		'You do not have permission to edit this model':
			'Sinulla ei ole oikeuksia muokata tätä mallinetta',
		'You do not have permission to edit this prompt.':
			'Sinulla ei ole oikeuksia muokata tätä kehotetta.',
		'You do not have permission to edit this skill.':
			'Sinulla ei ole oikeutta muokata tätä taitoa.',
		...
		'You do not have permission to send messages in this channel.':
			'Sinulla ei ole oikeuksia lähettää viestejä tähän kanavaan.',
		'You do not have permission to send messages in this thread.':
			'Sinulla ei ole oikeuksia lähettää viestejä tähän ketjuun.',
		'You do not have permission to upload files to this knowledge base.':
			'Sinulla ei ole oikeuksia ladata tiedostoja tähän tietokantaan.',
		...
		'You do not have permission to upload web content.':
			'Sinulla ei ole lupaa ladata verkkosisältöä.',
		...
		'Your account status is currently pending activation.':
			'Tilisi tila on tällä hetkellä odottaa aktivointia.',
		...
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			'Koko panoksesi menee suoraan lisäosan kehittäjälle; Open WebUI ei pidätä prosenttiosuutta. Valittu rahoitusalusta voi kuitenkin periä omia maksujaan.',
		'Your message text or inputs': 'Viestisi teksti tai syöteet',
		'Your usage stats have been successfully synced.':
			'Käyttötilastosi on synkronoitu onnistuneesti.',
		YouTube: Rn,
...
//# sourceMappingURL=CuLngqMT.js.map
