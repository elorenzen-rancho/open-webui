function s(a) {
	...
	function g(t, i) {
		...
		if (
			((o.nCharCast && (r == 'n' || r == 'N')) ||
				(o.charsetCast && r == '_' && t.match(/[a-z][a-z0-9]*/i))) &&
			(t.peek() == "'" || t.peek() == '"')
		)
			return 'keyword';
		if (
		...
		if (
			(o.commentHash && r == '#') ||
			(r == '-' && t.eat('-') && (!o.commentSpaceRequired || t.eat(' ')))
		)
	...
	return {
		...
		token: function (t, i) {
			if (
				(t.sol() && i.context && i.context.align == null && (i.context.align = !1),
				i.tokenize == g && t.eatSpace())
			)
				return null;
			...
			return (
				n == '('
					...
					: n == '['
						? w(t, i, ']')
						: i.context && i.context.type == n && L(i),
				r
			);
		},
...
//# sourceMappingURL=D0XecflT.js.map
