...
import { a as d, s as h, c as p } from './BfA5TzUS.js';
import { p as o } from './DbBXQmQ3.js';
var L = l(
...
function g(r, e) {
	let s = o(e, 'className', 8, 'size-4'),
		a = o(e, 'strokeWidth', 8, '1.5');
	var t = L();
	(i(() => {
		(d(t, 'stroke-width', a()), h(t, 0, p(s())));
	}),
		n(r, t));
}
var k = l(
...
export { f as P, g as a };
//# sourceMappingURL=D7NatCpb.js.map
