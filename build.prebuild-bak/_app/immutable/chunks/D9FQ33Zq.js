import { javascript as e } from './qCveANmP.js';
var f = { '{': '}', '(': ')', '[': ']' };
function p(i) {
...
function h(i, n) {
	if (
		(i.sol() && ((n.javaScriptLine = !1), (n.javaScriptLineExcludesColon = !1)), n.javaScriptLine)
	) {
...
function d(i, n) {
	if (n.javaScriptArguments) {
		...
		if (
			(i.peek() === '('
				? n.javaScriptArgumentsDepth++
				: i.peek() === ')' && n.javaScriptArgumentsDepth--,
...
function I(i, n) {
	if (i.match(/^\+([-\w]+)/))
		return (
			i.match(/^\( *[-\w]+ *=/, !1) ||
				((n.javaScriptArguments = !0), (n.javaScriptArgumentsDepth = 0)),
			'variable'
		);
...
function a(i, n) {
	if (n.isAttrs) {
		if (
			(f[i.peek()] && n.attrsNest.push(f[i.peek()]),
			n.attrsNest[n.attrsNest.length - 1] === i.peek())
		)
			n.attrsNest.pop();
...
export { X as pug };
//# sourceMappingURL=D9FQ33Zq.js.map
