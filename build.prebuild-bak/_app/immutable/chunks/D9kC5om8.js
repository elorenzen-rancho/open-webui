import { i as p } from './Dmth1JHB.js';
class a extends Map {
	constructor(e, n = h) {
		if (
			(super(),
			...
			for (const [r, s] of e) this.set(r, s);
	}
	get(e) {
...
function d() {
	...
	return (
		(s.domain = function (u) {
			...
			((e = []), (t = new a()));
			for (const i of u) t.has(i) || t.set(i, e.push(i) - 1);
			return s;
		}),
		(s.range = function (u) {
...
export { m as I, c as i, d as o };
//# sourceMappingURL=D9kC5om8.js.map
