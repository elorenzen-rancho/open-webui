...
import { p as hr } from './BCLU6njT.js';
import { p as lr } from './BqlCGYRq.js';
import { c as Se } from './BTOT7Bb_.js';
import { c as me, g as fr } from './BC4znSyB.js';
import { s as cr } from './BX5WB7ra.js';
var Fe = { exports: {} },
	ue = { exports: {} },
	de = { exports: {} },
	Me;
				...
				(function (P, L) {
					...
					return (function (A) {
						...
						return (
							...
							(L.d = function (g, l, a) {
								L.o(g, l) ||
									Object.defineProperty(g, l, { configurable: !1, enumerable: !0, get: a });
							}),
							(L.n = function (g) {
								var l =
									g && g.__esModule
						...
						function (A, P, L) {
							...
							((i.prototype.getEdges = function () {
								...
								(i.prototype.scatter = function () {
									...
									((s = e.WORLD_CENTER_Y + r.nextDouble() * (T - h) + h),
										(this.rect.x = t),
										(this.rect.y = s));
								}),
							...
							((s.prototype.getNodes = function () {
								...
								(s.prototype.updateBounds = function (c) {
									...
									(h == l.MAX_VALUE &&
										...
										X[0].getParent().paddingLeft != null
											? (Z = X[0].getParent().paddingLeft)
											: (Z = this.margin),
										(this.left = n.x - Z),
							...
							((l.calcSeparationAmount = function (a, e, r, f) {
								...
								(l.getIntersection = function (a, e, r, f) {
									...
									return (
										...
										K === 0
											? null
											: ((d = (C * X - G * Z) / K), (v = (F * Z - N * X) / K), new g(d, v))
									);
								}),
								(l.angleOfVector = function (a, e, r, f) {
									...
									return (
										a !== r
											? ((i = Math.atan((f - e) / (r - a))),
												r < a ? (i += Math.PI) : f < e && (i += this.TWO_PI))
											: f < e
							...
							((l.lastID = 0),
								(l.createID = function (a) {
									return l.isPrimitive(a)
										? a
										: (a.uniqueID != null || ((a.uniqueID = l.getString()), l.lastID++),
											a.uniqueID);
								}),
						...
						function (A, P, L) {
							...
							((s.RANDOM_SEED = 1),
								...
								(s.prototype.getFlatForest = function () {
									for (
										var o = [], c = !0, h = this.graphManager.getRoot().getNodes(), T = !0, d = 0;
										d < h.length;
										d++
									)
								...
								(s.prototype.createDummyNodesForBendpoints = function (o) {
									for (
										var c = [],
											h = o.source,
											T = this.graphManager.calcLowestCommonAncestor(o.source, o.target),
											d = 0;
						...
						function (A, P, L) {
							...
							((i.prototype.initParameters = function () {
								...
								(i.prototype.calcIdealEdgeLengths = function () {
									for (
										var t, s, o, c, h, T, d, v = this.getGraphManager().getAllEdges(), N = 0;
										N < v.length;
										N++
									)
										((t = v[N]),
								...
								(i.prototype.calcRepulsionForce = function (t, s) {
									var o = t.getRect(),
										...
										Z;
									if (o.intersects(c)) {
										(r.calcSeparationAmount(o, c, h, a.DEFAULT_EDGE_LENGTH / 2),
											(G = 2 * h[0]),
											(Z = 2 * h[1]));
									...
									((s = t.getOwner()),
										...
										t.getOwner() == this.graphManager.getRoot()
											...
											: ((N = s.getEstimatedSize() * this.compoundGravityRangeFactor),
												(d > N || v > N) &&
													((t.gravitationForceX =
														-this.gravityConstant * h * this.compoundGravityConstant),
													(t.gravitationForceY =
								...
								(i.prototype.addNodeToGrid = function (t, s, o) {
									...
									((c = parseInt(Math.floor((t.getRect().x - s) / this.repulsionRange))),
										(h = parseInt(
											Math.floor((t.getRect().width + t.getRect().x - s) / this.repulsionRange)
										)),
										(T = parseInt(Math.floor((t.getRect().y - o) / this.repulsionRange))),
										(d = parseInt(
											Math.floor((t.getRect().height + t.getRect().y - o) / this.repulsionRange)
										)));
									for (var v = c; v <= h; v++)
										for (var N = T; N <= d; N++)
											(this.grid[v][N].push(t), t.setGridCoordinates(c, h, T, d));
								}),
											...
											for (var N = t.startY - 1; N < t.finishY + 2; N++)
												if (!(v < 0 || N < 0 || v >= d.length || N >= d[0].length)) {
													for (var F = 0; F < d[v][N].length; F++)
														if (
															((T = d[v][N][F]),
															!(t.getOwner() != T.getOwner() || t == T) && !s.has(T) && !h.has(T))
														) {
															var C =
									...
									if (t < u) {
										...
										if (
											...
											for (var G = t + 1; G < this.n; G++)
												for (var Z = t + 1; Z < this.m; Z++) r[Z] += e[G] * l[Z][G];
										...
										case 1:
											{
												...
												for (var gt = n - 2; gt >= Q; gt--) {
													var mt = g.hypot(this.s[gt], it),
														...
														Ot = it / mt;
													((this.s[gt] = mt),
														gt !== Q && ((it = -Ot * e[gt - 1]), (e[gt - 1] = At * e[gt - 1])));
										...
										(D.prototype.positionNodesRadially = function (n) {
											for (
												...
												S % p == 0 &&
													((I = 0),
													(y = E),
													S != 0 && (y += o.DEFAULT_COMPONENT_SEPERATION),
													(E = 0));
												var W = n[S],
									...
									((u.prototype.calculateDisplacement = function () {
										...
										(this.getChild() != null && this.fixedNodeWeight
											...
											Math.abs(this.displacementX) > s.coolingFactor * s.maxNodeDisplacement &&
												(this.displacementX =
													s.coolingFactor * s.maxNodeDisplacement * i.sign(this.displacementX)),
											Math.abs(this.displacementY) > s.coolingFactor * s.maxNodeDisplacement &&
												(this.displacementY =
													s.coolingFactor * s.maxNodeDisplacement * i.sign(this.displacementY)),
											this.child &&
																...
																(ot.forEach(function (st) {
																	B == 'horizontal'
																		? (tt.set(st, d.has(st) ? v[d.get(st)] : k.get(st)),
																			(Lt += tt.get(st)))
																		: (tt.set(st, d.has(st) ? N[d.get(st)] : k.get(st)),
																			(Lt += tt.get(st)));
																}),
																	(Lt = Lt / ot.length),
																	lt.forEach(function (st) {
										...
										if (
												...
												(h.relativePlacementConstraint.forEach(function (b) {
													b.left
														? (W.has(b.left)
																...
																: W.set(b.left, [
																		{ id: b.right, gap: b.gap, direction: 'horizontal' }
																	]),
														...
														: (W.has(b.top)
																...
																: W.set(b.top, [
																		{ id: b.bottom, gap: b.gap, direction: 'vertical' }
																	]),
											...
											if (h.fixedNodeConstraint && h.fixedNodeConstraint.length > 1)
												(h.fixedNodeConstraint.forEach(function (b, U) {
													((E[U] = [b.position.x, b.position.y]),
														(y[U] = [v[d.get(b.nodeId)], N[d.get(b.nodeId)]]));
												}),
													(I = !0));
										...
										if (i.ENFORCE_CONSTRAINTS) {
											if (h.fixedNodeConstraint && h.fixedNodeConstraint.length > 0) {
												...
												(h.fixedNodeConstraint.forEach(function (b, U) {
													...
													h.fixedNodeConstraint.forEach(function (b) {
														((v[d.get(b.nodeId)] = b.position.x),
															(N[d.get(b.nodeId)] = b.position.y));
													}));
											}
											...
											h.relativePlacementConstraint &&
												(function () {
													...
													try {
														for (
															var le = _t.keys()[Symbol.iterator](), Le;
															!(te = (Le = le.next()).done);
															te = !0
														) {
															var fe = Le.value;
													...
													try {
														for (
															var ge = Jt.keys()[Symbol.iterator](), we;
															!(ce = (we = ge.next()).done);
															ce = !0
														) {
															var fe = we.value;
										...
										for (
											var p = function () {
												...
												for (var w = 0; w < I.length; w++) {
													var S = I[w];
													if (
														((v = o.intersection(S.union(S.ancestors()))),
														v != null && !T.has(v[0]))
													) {
						...
						var f = r(548),
							...
							T = function (v, N) {
								...
								(v.nestingFactor != null &&
									(h.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = c.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
										v.nestingFactor),
									v.gravity != null &&
										(h.DEFAULT_GRAVITY_STRENGTH = c.DEFAULT_GRAVITY_STRENGTH = v.gravity),
									v.numIter != null && (h.MAX_ITERATIONS = c.MAX_ITERATIONS = v.numIter),
									v.gravityRange != null &&
										(h.DEFAULT_GRAVITY_RANGE_FACTOR = c.DEFAULT_GRAVITY_RANGE_FACTOR =
											v.gravityRange),
								...
								var w = new i(),
									S = w.newGraphManager();
								return (
									E(S.addRoot(), f.getTopMostNodes(G), w, v),
									y(w, S, Z),
									I(w, v),
									w.runLayout(),
									rt
													...
													if (p) {
														...
														if (
															...
															if (C.tile) {
																...
																if (
																	...
																	(rt.push({ x: et.x1 + et.w / 2, y: et.y1 + et.h / 2 }),
																		D.push(w),
																		X.push(V));
															...
															D.forEach(function (vt, it) {
																((C.eles = vt),
																	K.push(h(C, X[it])),
																	t.relocateComponent(rt[it], K[it], C));
															});
														} else
															D.forEach(function (vt, it) {
														...
														if (D.length > 1) {
															...
															D.forEach(function (vt, it) {
																var gt = void 0;
																if (
																	(C.quality == 'draft' && (gt = X[it].nodeIndexes),
																			...
																			if (
																				...
																				if (C.quality == 'draft') {
																					...
																					if (Et.isParent()) {
																						...
																						(Ut.push(X[it].xCoords[Rt]),
																							Ut.push(X[it].yCoords[Rt]));
																					if (Dt.isParent()) {
																						...
																						(Pt.push(X[it].xCoords[Ht]),
																							Pt.push(X[it].yCoords[Ht]));
																					mt.edges.push({
																						startX: Ut[0],
																						startY: Ut[1],
																						endX: Pt[0],
								...
								var c = o.cy,
									...
									q = function (U) {
										...
										for (var ct = 0; ct < m; ct++)
											for (var nt = 0; nt < S; nt++) D[ct][nt] *= D[ct][nt];
										for (var tt = 0; tt < S; tt++) rt[tt] = [];
										for (var j = 0; j < S; j++)
											for (var ut = 0; ut < S; ut++) rt[j][ut] = D[X[ut]][j];
									},
									V = function () {
										for (
											var U = u.svd(rt),
...
var De = { L: 'left', R: 'right', T: 'top', B: 'bottom' },
	...
	Pe =
		((ae = class {
			...
			addJunction({ id: M, in: A }) {
				...
				((this.registeredIds[M] = 'node'),
					(this.nodes[M] = { id: M, type: 'junction', edges: [], in: A }));
			}
			getJunctions() {
						...
						A = Object.entries(this.nodes).reduce(
							(e, [r, f]) => (
								(e[r] = f.edges.reduce((i, u) => {
									...
									if (t && s && t !== s) {
										const h = Nr(u.lhsDir, u.rhsDir);
										h !== 'bend' &&
											(M[t] ?? (M[t] = {}), (M[t][s] = h), M[s] ?? (M[s] = {}), (M[s][t] = h));
									}
									if (u.lhsId === r) {
										const h = pe(u.lhsDir, u.rhsDir);
										h && (i[h] = u.rhsId);
									} else {
										const h = pe(u.rhsDir, u.lhsDir);
										h && (i[h] = u.lhsId);
									}
									return i;
								}, {})),
	...
	Ge = {
		...
		parse: dt(async (R) => {
			var P;
			const M = await lr('architecture', R);
			Re.debug(M);
...
`,
	...
	Or = Mr,
	re = dt(
		(R) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${R}</g>`,
		'wrapIcon'
	),
	ne = {
					...
					if (T) {
						...
						if (
							(await Ee(
								m,
								T,
								{ useHtmlLabels: !1, width: n, classes: 'architecture-service-label' },
								ye()
							),
							m
								.attr('dy', '1em')
			...
			M.nodes().map(async (r) => {
				...
				if (f.type === 'group') {
					...
					if (f.icon) {
						const d = c.append('g');
						(d.html(
							`<g>${await ve(f.icon, { height: g, width: g, fallbackPrefix: ne.prefix })}</g>`
						),
					...
					if (f.label) {
						...
						(await Ee(
							d,
							f.label,
							{ useHtmlLabels: !1, width: u, classes: 'architecture-service-label' },
							ye()
						),
							d
								.attr('dy', '1em')
		...
		for (const g of A) {
			...
			if (g.title) {
				...
				(await Ee(
					i,
					g.title,
					{ useHtmlLabels: !1, width: a * 1.5, classes: 'architecture-service-label' },
					L
				),
					i
						.attr('dy', '1em')
			...
			const e = l.append('g');
			if (g.icon)
				e.html(`<g>${await ve(g.icon, { height: a, width: a, fallbackPrefix: ne.prefix })}</g>`);
			else if (g.iconText) {
				e.html(`<g>${await ve('blank', { height: a, width: a, fallbackPrefix: ne.prefix })}</g>`);
				const t = e
						.append('g')
					...
					if (i) {
						...
						Object.entries(r).forEach(([t, s]) => {
							...
							c &&
								!e[o] &&
								(a.push(o),
								A.push({ [De[t]]: c, [De[pr(t)]]: i, gap: 1.5 * M.getConfigField('iconSize') }));
						});
					}
				}
			}
...
function $e(R, M, A, P, L, { spatialMaps: g, groupAlignments: l }) {
	return new Promise((a) => {
		const e = cr('body').append('div').attr('id', 'cy').attr('style', 'display:none'),
			r = Se({
		...
		(u.one('layoutstop', () => {
			...
			function t(o, c, h, T) {
				...
				const { x: N, y: F } = o,
					{ x: C, y: G } = c;
				((v =
					(T - F + ((N - h) * (F - G)) / (N - C)) / Math.sqrt(1 + Math.pow((F - G) / (N - C), 2))),
...
var Sr = dt(async (R, M, A, P) => {
		...
		const t = f.append('g');
		(t.attr('class', 'architecture-groups'), await Ir(L, u, g, M), Rr(L, u, l, M));
...
export { Hr as diagram };
//# sourceMappingURL=DF6YIFoa.js.map
