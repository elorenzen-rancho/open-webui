...
function L(e) {
	...
	if (e == 'closePlugin') {
		var t = !1;
		return (
			i.context ? ((t = i.context.pluginName != g), x()) : (t = !0),
			t && (l = 'error'),
			u(P(t))
		);
	} else
		return (
			e == 'string' &&
				((!i.context || i.context.name != '!cdata') && b('!cdata'), i.tokenize == o && x()),
			u()
		);
}
function N(e) {
	return function (t) {
		return (
			t == 'selfclosePlugin' || t == 'endPlugin' || (t == 'endPlugin' && b(i.pluginName, e)),
			u()
		);
	};
}
...
export { S as tiki };
//# sourceMappingURL=DGYXhP31.js.map
