const e = 'O programe',
	...
	ja = '',
	xa =
		'OpenAI je výskumná organizácia zameraná na umelú inteligenciu, ktorá je známa vývojom pokročilých jazykových modelov, ako je napríklad GPT. Tieto modely sa využívajú v rôznych aplikáciách, vrátane konverzačných agentov a jazykových nástrojov.',
	La = '',
	Fa = '',
	Va = '',
	Wa = 'alebo',
	...
	xr = {
		...
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' alebo '-1' pre žiadne vypršanie platnosti.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(napr. `sh webui.sh --api --api-auth username_password`)',
		...
		'*Prompt node ID(s) are required for image generation':
			'*Sú potrebné IDs pre prompt node na generovanie obrázkov',
		'1 hour before': '',
		'1 Source': '',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Nová verzia (v{{LATEST_VERSION}}) je teraz k dispozícii.',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Model úloh sa používa pri vykonávaní úloh, ako je generovanie názvov pre chaty a vyhľadávacie dotazy na webe.',
		'a user': 'užívateľ',
		About: e,
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Aktivujte tento príkaz napísaním "/{{COMMAND}}" do chatového vstupu',
		Active: r,
		...
		'Add a short description about what this model does':
			'Pridajte krátky popis toho, čo tento model robí.',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Úprava týchto nastavení sa prejaví univerzálne u všetkých užívateľov.',
		admin: d,
		Admin: c,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Administrátori majú prístup ku všetkým nástrojom kedykoľvek; užívatelia potrebujú mať nástroje priradené podľa modelu v workspace.',
		Advanced: u,
		...
		'Call feature is not supported when using Web STT engine':
			'Funkcia volania nie je podporovaná pri použití Web STT engine.',
		Camera: q,
		Cancel: J,
		...
		'Click here to download user import template file.':
			'Kliknite tu pre stiahnutie šablóny súboru na import užívateľov.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Kliknite sem a dozviete sa viac o faster-whisper a pozrite si dostupné modely.',
		...
		"Click on the user role button to change a user's role.":
			'Kliknite na tlačidlo role užívateľa, aby ste zmenili rolu užívateľa.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Prístup na zápis do schránky bol zamietnutý. Skontrolujte nastavenia prehliadača a udeľte potrebný prístup.',
		Clone: le,
		'Clone Chat': '',
		'Clone of {{TITLE}}': '',
		Close: de,
		...
		'Contact Admin for WebUI Access':
			'Kontaktujte administrátora pre prístup k webovému rozhraniu.',
		Content: Ce,
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Kontrola, ako sa text správy rozdeľuje pre požiadavky TTS. 'Punctuation' rozdeľuje text na vety, 'paragraphs' rozdeľuje text na odseky a 'none' ponecháva správu ako jeden celý reťazec.",
		...
		'Discover, download, and explore custom functions':
			'Objavujte, sťahujte a preskúmajte vlastné funkcie',
		'Discover, download, and explore custom prompts':
			'Objavte, stiahnite a preskúmajte vlastné prompty.',
		'Discover, download, and explore custom tools':
			'Objavujte, sťahujte a preskúmajte vlastné nástroje',
		'Discover, download, and explore model presets':
			'Objavte, stiahnite a preskúmajte prednastavenia modelov',
		...
		'Display the username instead of You in the Chat':
			'Zobraziť užívateľské meno namiesto "Vás" v chate',
		'Displays citations in the response': '',
		'Displays status updates (e.g., web search progress) in the response': '',
		'Dive into knowledge': '',
		'Do not install functions from sources you do not fully trust.':
			'Neinštalujte funkcie zo zdrojov, ktorým plne nedôverujete.',
		'Do not install tools from sources you do not fully trust.':
			'Neinštalujte nástroje zo zdrojov, ktorým plne nedôverujete.',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'nevytvára žiadne externé pripojenia a vaše dáta zostávajú bezpečne na vašom lokálnom serveri.',
		'Domain Filter List': '',
		"don't fetch random pipelines from sources you don't trust.":
			'Nestahujte náhodné pipelines zo zdrojov, ktorým nedôverujete.',
		"Don't have an account?": 'Nemáte účet?',
		"don't install random functions from sources you don't trust.":
			'Neinštalujte náhodné funkcie zo zdrojov, ktorým nedôverujete.',
		"don't install random tools from sources you don't trust.":
			'Neinštalujte náhodné nástroje zo zdrojov, ktorým nedôverujete.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"napr. '30s','10m'. Platné časové jednotky sú 's', 'm', 'h'.",
		"e.g. 'low', 'medium', 'high'": '',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Uistite sa, že váš CSV súbor obsahuje 4 stĺpce v tomto poradí: Name, Email, Password, Role.',
		'Enter {{role}} message here': 'Zadajte správu {{role}} sem',
		'Enter a detail about yourself for your LLMs to recall':
			'Zadajte podrobnosť o sebe, ktorú si vaše LLM majú zapamätať.',
		...
		'Enter api auth string (e.g. username:password)':
			'Zadajte autentifikačný reťazec API (napr. užívateľské_meno:heslo)',
		...
		'File size should not exceed {{maxSize}} MB.':
			'Veľkosť súboru by nemala presiahnuť {{maxSize}} MB.',
		'File Upload': '',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Zistené falšovanie odtlačkov prstov: Nie je možné použiť iniciály ako avatar. Používa sa predvolený profilový obrázok.',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Beriem na vedomie, že som si prečítal a chápem dôsledky svojich činov. Som si vedomý rizík spojených s vykonávaním ľubovoľného kódu a overil som dôveryhodnosť zdroja.',
		ID: pt,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Zahrňte prepínač `--api-auth` pri spustení stable-diffusion-webui.',
		'Include `--api` flag when running stable-diffusion-webui':
			'Pri spustení stable-diffusion-webui zahrňte príznak `--api`.',
		...
		'Instant Auto-Send After Voice Transcription':
			'Okamžité automatické odoslanie po prepisu hlasu',
		Instructions: At,
		Integration: St,
		Integrations: Pt,
		Interface: Ct,
		...
		'Leave empty to include all models or select specific models':
			'Nechajte prázdne pre zahrnutie všetkých modelov alebo vyberte konkrétne modely.',
		...
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Nechajte prázdne pre použitie predvoleného podnetu, alebo zadajte vlastný podnet.',
		...
		'LLMs can make mistakes. Verify important information.':
			'LLM môžu robiť chyby. Overte si dôležité informácie.',
		Loader: Kt,
		'Loading Kokoro.js...': '',
		'Loading...': 'Načítava sa...',
		local: _t,
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Uistite sa, že exportujete súbor workflow.json vo formáte API z ComfyUI.',
		Male: qt,
		Manage: Jt,
		'Manage Connections': '',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Maximálne 3 modely môžu byť stiahnuté súčasne. Prosím skúste to znova neskôr.',
		May: $t,
		MBR: ea,
		MCP: oa,
		...
		'Message rating should be enabled to use this feature':
			'Hodnotenie správ musí byť povolené, aby bolo možné túto funkciu používať.',
		messages: la,
		Messages: da,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Správy, ktoré odošlete po vytvorení odkazu, nebudú zdieľané. Používatelia s URL budú môcť zobraziť zdieľaný chat.',
		'Microsoft OneDrive': '',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			'Model „{{modelName}}“ bol úspešne stiahnutý.',
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Model '{{modelTag}}' je už zaradený do fronty na sťahovanie.",
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': '',
		'Model {{modelName}} is not vision capable':
			'Model {{modelName}} nie je schopný spracovávať vizuálne údaje.',
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Zistená cesta v súborovom systéme. Je vyžadovaný krátky názov modelu pre aktualizáciu, nemožno pokračovať.',
		'Model Filtering': '',
		'Model ID': 'ID modelu',
		...
		'No HTML, CSS, or JavaScript content found.':
			'Nebola nájdená žiadny obsah HTML, CSS ani JavaScript.',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Poznámka: Ak nastavíte minimálne skóre, vyhľadávanie vráti iba dokumenty s hodnotením, ktoré je väčšie alebo rovné zadanému minimálnemu skóre.',
		Notes: Ta,
		...
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Príkazový reťazec môže obsahovať iba alfanumerické znaky a pomlčky.',
		'Only can be triggered when the chat input is in focus.': '',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Iba kolekcie môžu byť upravované, na úpravu/pridanie dokumentov vytvorte novú znalostnú databázu.',
		...
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Jejda! Vyzerá to, že URL adresa je neplatná. Prosím, skontrolujte ju a skúste to znova.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Jejda! Niektoré súbory sa stále nahrávajú. Prosím, počkajte, kým sa nahrávanie dokončí.',
		'Oops! There was an error in the previous response.':
			'Jejda! V predchádzajúcej odpovedi došlo k chybe.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Jejda! Používate nepodporovanú metódu (iba frontend). Prosím, spustite WebUI zo serverovej časti (backendu).',
		...
		OpenAI: xa,
		'OpenAI API':
			'OpenAI API je rozhranie aplikačného programovania, ktoré umožňuje vývojárom integrovať pokročilé jazykové modely do svojich aplikácií.',
		'OpenAI API Base URL': '',
		'OpenAI API Key': '',
		...
		'Permission denied when accessing media devices':
			'Odmietnutie povolenia pri prístupe k mediálnym zariadeniam',
		'Permission denied when accessing microphone': 'Prístup k mikrofónu bol zamietnutý',
		'Permission denied when accessing microphone: {{error}}':
			'Oprávnenie zamietnuté pri prístupe k mikrofónu: {{error}}',
		Permissions: en,
		'Perplexity API Key': '',
		'Perplexity Model': '',
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines je systém zásuvných modulov s ľubovoľným spúšťaním kódu —',
		...
		'Please carefully review the following warnings:':
			'Prosím, pozorne si prečítajte nasledujúce upozornenia:',
		...
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Odkazujte na seba ako na "užívateľa" (napr. "Užívateľ sa učí španielsky").',
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Oznámenia o odpovediach nie je možné aktivovať, pretože povolenia webu boli zamietnuté. Navštívte nastavenia svojho prehliadača a povoľte potrebný prístup.',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Ukladanie záznamov chatu priamo do úložiska vášho prehliadača už nie je podporované. Venujte prosím chvíľu stiahnutiu a vymazaniu svojich záznamov chatu kliknutím na tlačidlo nižšie. Nemajte obavy, môžete ľahko znovu importovať svoje záznamy chatu na backend prostredníctvom',
		Schedule: qn,
		...
		'Selected model(s) do not support image inputs':
			'Vybraný(é) model(y) nepodporujú vstupy v podobe obrázkov.',
		'Selected Models': '',
		semantic: es,
		Send: os,
		...
		'Sends `stream_options: { include_usage: true }` in the request.\nSupported providers will return token usage information in the response when set.':
			'Odošle `stream_options: { include_usage: true }` v žiadosti. Podporovaní poskytovatelia vrátia informácie o využití tokenov v odpovedi, keď je táto možnosť nastavená.',
		September: ts,
		'SerpApi API Key': '',
		'SerpApi Engine': '',
		...
		'Show Admin Details in Account Pending Overlay':
			'Zobraziť podrobnosti administrátora v prekryvnom okne s čakajúcim účtom',
		'Show All': '',
		...
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Vývojári stojaci za týmto pluginom sú zapálení dobrovoľníci z komunity. Ak považujete tento plugin za užitočný, zvážte príspevok na jeho vývoj.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Hodnotiaca tabuľka je založená na systéme hodnotenia Elo a aktualizuje sa v reálnom čase.',
		...
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'Hodnotiaca tabuľka je momentálne v beta verzii a môžeme upraviť výpočty hodnotenia, ako budeme zdokonaľovať algoritmus.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'Maximálna veľkosť súboru v MB. Ak veľkosť súboru presiahne tento limit, súbor nebude nahraný.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'Maximálny počet súborov, ktoré je možné použiť naraz v chate. Ak počet súborov presiahne tento limit, súbory nebudú nahrané.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			'',
		"The passwords you entered don't quite match. Please double-check and try again.": '',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Skóre by malo byť hodnotou medzi 0,0 (0%) a 1,0 (100%).',
		...
		'This action cannot be undone. Do you wish to continue?':
			'Túto akciu nie je možné vrátiť späť. Prajete si pokračovať?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'',
		"This chat won't appear in history and your messages will not be saved.": '',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Týmto je zaistené, že vaše cenné konverzácie sú bezpečne uložené vo vašej backendovej databáze. Ďakujeme!',
		...
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Toto je experimentálna funkcia, nemusí fungovať podľa očakávania a môže byť kedykoľvek zmenená.',
		...
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Táto voľba odstráni všetky existujúce súbory v kolekcii a nahradí ich novo nahranými súbormi.',
		'This response was generated by "{{model}}"':
			'Táto odpoveď bola vygenerovaná pomocou "{{model}}"',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Týmto dôjde k odstráneniu <strong>{{NAME}}</strong> a <strong>všetkých jeho obsahov</strong>.',
		...
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Toto obnoví znalostnú databázu a synchronizuje všetky súbory. Prajete si pokračovať?',
		...
		'To access the available model names for downloading,':
			'Pre získanie dostupných názvov modelov na stiahnutie,',
		'To access the GGUF models available for downloading,':
			'Pre prístup k modelom GGUF dostupným na stiahnutie,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'Pre prístup k WebUI sa prosím obráťte na administrátora. Administrátori môžu spravovať stavy používateľov z Admin Panelu.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Ak chcete tu pripojiť znalostnú databázu, najprv ju pridajte do pracovného priestoru "Knowledge".',
		...
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Ak chcete tu vybrať nástroje, pridajte ich najprv do pracovného priestoru "Tools".',
		...
		'Tools are a function calling system with arbitrary code execution':
			'Nástroje sú systémom na volanie funkcií s vykonávaním ľubovoľného kódu.',
		'Tools Function Calling Prompt': '',
		'Tools have a function calling system that allows arbitrary code execution.':
			'Nástroje majú systém volania funkcií, ktorý umožňuje spúšťanie ľubovoľného kódu.',
		...
		'Update for the latest features and improvements.':
			'Aktualizácia pre najnovšie funkcie a vylepšenia.',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Použite '#' vo vstupe promptu na načítanie a zahrnutie vašich vedomostí.",
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Používanie predvoleného modelu arény so všetkými modelmi. Kliknutím na tlačidlo plus pridajte vlastné modely.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Verzia {{selectedVersion}} z {{totalVersions}}',
		'Version deleted': '',
		'View Replies': '',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Napíšte zhrnutie na 50 slov, ktoré zhrňuje [tému alebo kľúčové slovo].',
...
napr.: Ste Mario zo Super Mario Bros a vystupujete ako asistent.`,
		...
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Môžete komunikovať len s maximálne {{maxCount}} súbor(ami) naraz.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Môžete personalizovať svoje interakcie s LLM pridaním spomienok prostredníctvom tlačidla 'Spravovať' nižšie, čo ich urobí pre vás užitočnejšími a lepšie prispôsobenými.",
		...
		'Your account status is currently pending activation.':
			'Stav vášho účtu je aktuálne čakajúci na aktiváciu.',
		'Your browser does not support the audio tag.': '',
		'Your browser does not support the video tag.': '',
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			'Celý váš príspevok pôjde priamo vývojárovi pluginu; Open WebUI si neberie žiadne percento. Zvolená platforma na financovanie však môže mať vlastné poplatky.',
...
//# sourceMappingURL=DJh4yO3z.js.map
