...
import { l as F } from './DIeogL5L.js';
const H = {
	get(e, r) {
...
function k(e, r, s) {
	return new Proxy({ props: e, exclude: r }, H);
}
const J = {
	get(e, r) {
...
function ee(e, r) {
	return new Proxy({ props: e, exclude: r, special: {}, version: K(0), parent_effect: w }, J);
}
const Q = {
	get(e, r) {
...
function V(e, r, s, n) {
	...
	if (t) {
		var L = D in e || E in e;
		l = ((x = h(e, r)) == null ? void 0 : x.set) ?? (L && r in e ? (u) => (e[r] = u) : void 0);
	}
	var o,
		b = !1;
	(t ? ([o, b] = y(() => e[r])) : (o = e[r]),
		o === void 0 && n !== void 0 && ((o = S()), l && (i && B(), l(o))));
	var a;
	if (
		(i
			? (a = () => {
					var u = e[r];
					return u === void 0 ? S() : ((v = !0), u);
				})
			: (a = () => {
					var u = e[r];
	...
	if (l) {
		var T = e.$$legacy;
		return function (u, d) {
			return arguments.length > 0 ? ((!i || !d || T || b) && l(d ? a() : u), u) : a();
		};
	}
	var P = !1,
		c = (s & $ ? q : C)(() => ((P = !1), a()));
	...
	return function (u, d) {
		if (arguments.length > 0) {
			...
			return (j(c, O), (P = !0), f !== void 0 && (f = O), u);
		}
		return (M && P) || g.f & N ? c.v : _(c);
	};
}
export { ee as l, V as p, k as r, re as s };
//# sourceMappingURL=DbBXQmQ3.js.map
