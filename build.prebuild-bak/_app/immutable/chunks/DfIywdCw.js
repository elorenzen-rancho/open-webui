import { c as T, g as I } from './BC4znSyB.js';
var x = { exports: {} };
(function (j, z) {
	(function (y, a) {
		j.exports = a();
		...
		var y,
			...
			d = function (n) {
				return k(n) ? Math.ceil(n) : Math.floor(n);
			},
			F = function (n) {
				return Math.abs(n);
			},
			...
			w = (function () {
				function n(s, i, r) {
					...
					if (
						((this.$d = {}),
						(this.$l = r),
						s === void 0 && ((this.$ms = 0), this.parseFromMilliseconds()),
						i)
					)
						return m(s * f[l(i)], this);
				...
				return (
					...
					(t.parseFromMilliseconds = function () {
						...
						((this.$d.years = d(s / S)),
							...
							(this.$d.hours = d(s / g)),
							(s %= g),
							(this.$d.minutes = d(s / p)),
							(s %= p),
							(this.$d.seconds = d(s / v)),
							(s %= v),
							(this.$d.milliseconds = s));
					}),
					(t.toISOString = function () {
						...
						var e = c(r, 'D'),
							o = c(this.$d.hours, 'H'),
							u = c(this.$d.minutes, 'M'),
							h = this.$d.seconds || 0;
						this.$d.milliseconds &&
							((h += this.$d.milliseconds / 1e3), (h = Math.round(1e3 * h) / 1e3));
						var D = c(h, 'S'),
							E = s.negative || i.negative || e.negative || o.negative || u.negative || D.negative,
							N = o.format || u.format || D.format ? 'T' : '',
							b =
								(E ? '-' : '') +
								'P' +
								s.format +
					...
					(t.format = function (s) {
						...
						return i.replace(O, function (e, o) {
							return o || String(r[e]);
						});
					}),
					(t.as = function (s) {
						return this.$ms / f[l(s)];
					}),
					(t.get = function (s) {
						var i = this.$ms,
							r = l(s);
						return (
							r === 'milliseconds' ? (i %= 1e3) : (i = r === 'weeks' ? d(i / f[r]) : this.$d[r]),
							i || 0
						);
					}),
					(t.add = function (s, i, r) {
						var e;
						return (
							(e = i ? s * f[l(i)] : $(s) ? s.$ms : m(s, this).$ms),
							m(this.$ms + e * (r ? -1 : 1), this)
						);
					}),
					...
					(t.humanize = function (s) {
						return y().add(this.$ms, 'ms').locale(this.$l).fromNow(!s);
					}),
					(t.valueOf = function () {
		...
		return function (n, t, s) {
			...
			((t.prototype.add = function (e, o) {
				return $(e) ? H(this, e, 1) : i.bind(this)(e, o);
			}),
				(t.prototype.subtract = function (e, o) {
					return $(e) ? H(this, e, -1) : r.bind(this)(e, o);
				}));
		};
	});
})(x);
...
const C = I(W);
export { C as d };
//# sourceMappingURL=DfIywdCw.js.map
