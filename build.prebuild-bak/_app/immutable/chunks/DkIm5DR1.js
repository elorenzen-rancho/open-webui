const e = 'Sobre nos',
	...
	Fr = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 para ilimitado, ou un número enteiro positivo para un límite específico.',
		...
		'*Prompt node ID(s) are required for image generation':
			'Os ID do nodo son requeridos para a xeneración de imáxes',
		'1 hour before': '',
		'1 Source': '',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Unha nova versión (v{{LATEST_VERSION}}) está disponible.',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'o modelo de tarefas utilizase realizando tarefas como a xeneración de títulos para chats e consultas da búsqueda web',
		'a user': 'un usuario',
		About: e,
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Active este comando escribindo "/{{COMMAND}}" no chat',
		Active: r,
		...
		'Add a short description about what this model does':
			'Agregue unha breve descripción sobre o que fai este modelo',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Axustar estas opcions aplicará os cambios universalmente a todos os usuarios.',
		admin: c,
		Admin: d,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Os administradores teñen acceso a todas as ferramentas en todo momento; os usuarios necesitan ferramentas asignadas por modelo no espacio de trabajo.',
		Advanced: u,
		...
		'Are you sure you want to unarchive all archived chats?':
			'¿Estás seguro de que quieres desArquivar todos os chats arquivados?',
		...
		'Autocomplete Generation Input Max Length':
			'Longitud máxima de entrada da xeneración de autocompletado',
		Automatic1111: M,
		...
		'Call feature is not supported when using Web STT engine':
			'A funcionalidade da chamada non pode usarse xunto co motor da STT Web',
		Camera: J,
		Cancel: X,
		...
		'Character limit for autocomplete generation input':
			'Limite de caracteres para a entrada de xeneración do autocompletado',
		...
		'Click here to download user import template file.':
			'Pica aquí para descargar o arquivo de plantilla de importación de usuario.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Clic aquí para aprender mais sobre faster-whisper y ver os modelos disponibles.',
		...
		"Click on the user role button to change a user's role.":
			'Pica no botón de roles do usuario para cambiar su rol.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Permisos de escritura do portapapeles denegados. Por favor, comprueba as configuracions de tu navegador para otorgar o acceso necesario.',
		Clone: le,
		...
		'Connect to your own OpenAI compatible API endpoints.':
			'Conecta os teus propios Api compatibles con OpenAI.',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			'Define o esforzo do modelo de razonamento, so aplicable a modelos de razonamento de provedores específicos que soportan o esforzo de razonamento.',
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Controlar como o texto do mensaxe se divide para as solicitudes de TTS. 'Puntuation' divide en oracions, 'paragraphs' divide en párrafos e 'none' manten o mensaxe como unha sola cadea.",
		'Control the repetition of token sequences in the generated text. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 1.1) will be more lenient. At 1, it is disabled.':
			'Controla a repetición de secuencias de tokens no texto xerado. Un valor máis alto (por exemplo, 1,5) penalizará as repeticións con máis forza, mentres que un valor máis baixo (por exemplo, 1,1) será mais tolerante. Cando é 1, está desactivado.',
		Controls: Ee,
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			'Controla o equilibrio entre a coherencia e a diversidade da saída. Un valor máis baixo dará como resultado un texto máis centrado e coherente.',
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'O CORS debe estar debidamente configurado polo provedor para permitir solicitudes desde Open WebUI.',
		'Could not read file.': '',
		CPU: De,
		Create: Ue,
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			'O modo predeterminado funciona con unha gama mais ampla de modelos chamando as ferramentas unha vez antes da execución. o modo nativo aproveita as capacidades integradas de chamada de ferramentas do modelo, pero requiere que o modelo soporte esta función de manera inherente.',
		...
		'Describe your knowledge base and objectives':
			'Describe a tua base de coñecementos e obxetivos',
		Description: Ge,
		Deselect: Ke,
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'Conexións directas permiten aos usuarios conectar cos seus propios puntos finais de API compatibles con OpenAI.',
		'Direct Message': '',
		'Direct Tool Servers': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			'Descubra como usar Open WebUI e busque apoio na comunidade.',
		'Discover wonders': 'Descubre maravillas',
		'Discover, download, and explore custom functions':
			'Descubre, descarga y explora funcións personalizadas',
		'Discover, download, and explore custom prompts':
			'Descubre, descarga, y explora Prompts personalizados',
		'Discover, download, and explore custom tools':
			'Descubre, descarga y explora ferramentas personalizadas',
		'Discover, download, and explore model presets':
			'Descubre, descarga y explora ajustes preestablecidos de modelos',
		...
		'Display the username instead of You in the Chat':
			'Mostrar o nombre de usuario en lugar de Vostede no chat',
		...
		'Do not install functions from sources you do not fully trust.':
			'Non instale funcións desde fontes nas que no confíe totalmente.',
		'Do not install tools from sources you do not fully trust.':
			'Non instale ferramentas desde fontes nas que no confíe totalmente.',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'non realiza ninguna conexión externa y sus datos permanecen seguros en su servidor alojado localmente.',
		'Domain Filter List': '',
		"don't fetch random pipelines from sources you don't trust.":
			'Non obteñas pipelines aleatorias de fontes non fiables.',
		"Don't have an account?": '¿Non tes unha conta?',
		"don't install random functions from sources you don't trust.":
			'Non instale funcións aleatorias desde fontes nas que non confíe.',
		"don't install random tools from sources you don't trust.":
			'Non instale ferramentas aleatorias desde fontes nas que non confíe.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"p.ej. '30s','10m'. Unidades válidas detempo son 's', 'm', 'h'.",
		"e.g. 'low', 'medium', 'high'": '',
		'e.g. "json" or a JSON schema': '',
		'e.g. 60': 'e.g. 60',
		'e.g. A filter to remove profanity from text':
			'p.ej. Un filtro para eliminar a profanidade do texto',
		...
		'e.g. Tools for performing various operations':
			'p.ej. ferramentas para realizar diversas operacions',
		...
		'Enable autocomplete generation for chat messages':
			'Habilitar xeneración de autocompletado para mensaxes de chat',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'asegurese de o teu arquivo CSV inclúe 4 columnas nesta orde: Nome, Email, Contrasinal, Rol.',
		'Enter {{role}} message here': 'Ingrese o mensaxe {{role}} aquí',
		'Enter a detail about yourself for your LLMs to recall':
			'Ingrese un detalle sobre vostede para que as suas LLMs recorden',
		...
		'Enter api auth string (e.g. username:password)':
			'Ingrese a cadena de autorización de api (p.ej., nombre:contrasinal )',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Ingrese a URL do proxy (p.ej. https://user:password@host:port)',
		...
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'Ingrese a URL pública da sua WebUI. Esta URL utilizaráse para generar enlaces en as notificacions.',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Exemplo: sAMAccountName o uid o userPrincipalName',
		...
		'File size should not exceed {{maxSize}} MB.':
			'Tamaño do Arquivo non debe exceder {{maxSize}} MB.',
		'File Upload': '',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Destectouse suplantación de pegadas: Non puderon usarse as iniciais como avatar. Por defecto utilizase a imaxen de perfil predeterminada.',
		...
		'Functions allow arbitrary code execution.':
			'Funcions habilitan aexecución de código arbitrario.',
		...
		'Hex Color - Leave empty for default color':
			'Cor Hex - deixa vacío para o color predeterminado',
		Hidden: na,
		Hide: sa,
		'Hide All': '',
		'Hide from Sidebar': '',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Asegurou que leu e entendo as implicacions da miña acción. Estou consciente dos riscos asociados con a execución de código arbitrario e verificou a confianza da fonte.',
		ID: ma,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Incluir o indicador `--api-auth` al ejecutar stable-diffusion-webui',
		'Include `--api` flag when running stable-diffusion-webui':
			'Incluir o indicador `--api` al ejecutar stable-diffusion-webui',
		...
		'Leave empty to include all models or select specific models':
			'Deixa vacío para incluir todos os modelos o seleccione modelos específicos',
		...
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Deixa vacío para usar o prompt predeterminado, o ingrese un prompt personalizado',
		'Leave model field empty to use the default model.':
			'Deixa o campo do modelo vacío para usar o modelo predeterminado.',
		Legacy: Oa,
		lexical: Fa,
		License: qa,
		'Lift List': '',
		...
		'LLMs can make mistakes. Verify important information.':
			'Os LLM poden cometer erros. Verifica a información importante.',
		Loader: _a,
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Asegúrese de exportar un Arquivo workflow.json en formato API desde ComfyUI.',
		Male: Ja,
		Manage: Xa,
		'Manage Connections': '',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Podense descargar un máximo de 3 modelos simultáneamente. Por favor, intenteo de novo mais tarde.',
		May: $a,
		MBR: et,
		MCP: ot,
		...
		'Memories accessible by LLMs will be shown here.':
			'As memorias accesibles por os LLMs mostraránse aquí.',
		Memory: rt,
		...
		'Message rating should be enabled to use this feature':
			'a calificación de mensaxes debe estar habilitada para usar esta función',
		messages: lt,
		Messages: ct,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Os mensaxes que envíe despois de xerar su enlace no compartiránse. os usuarios co enlace podrán ver o chat compartido.',
		'Microsoft OneDrive': '',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"0 modelo '{{modelName}}' se ha descargado correctamente.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"0 modelo '{{modelTag}}' ya está en cola para descargar.",
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Destectouse a ruta do sistema de ficheiros do modelo. É necesario o nome curto do modelo para a actualización, non se pode continuar.',
		...
		'No inference engine with management support found':
			'No se encontró un motor de inferencia con soporte de gestión',
		'No kernel': '',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Nota: Se estableces unha puntuación mínima, a búsqueda sólo devolverá documentos con unha puntuación mayor o igual a a puntuación mínima.',
		Notes: xt,
		...
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Sólo se permiten caracteres alfanuméricos y guiones en a cadena de comando.',
		'Only can be triggered when the chat input is in focus.': '',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Solo se pueden editar as coleccions, xerar unha nova base de coñecementos para editar / añadir documentos',
		'Only invited users can access': '',
		'Only markdown files are allowed': '',
		'Only select users and groups with permission can access':
			'Solo os usuarios y grupos con permiso pueden acceder',
		'Only sync new/updated chats': '',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'¡Ups! Parece que a URL no es válida. Vuelva a verificar e inténtelo novamente.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'¡Ups! Todavía hay arquivos subiendo. Por favor, espere a que a subida se complete.',
		'Oops! There was an error in the previous response.':
			'¡Ups! Hubo un error en a resposta anterior.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'¡Ups! Estás utilizando un método no compatible (solo frontend). Por favor ejecute a WebUI desde o backend.',
		...
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open WebUI usa SpeechT5 y embeddings de locutores CMU Arctic.',
		'Open WebUI version': '',
		...
		'Permission denied when accessing media devices':
			'Permiso denegado al acceder a os dispositivos',
		...
		'Please carefully review the following warnings:':
			'Por favor revise con cuidado os siguientes avisos:',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'O ID de prefixo se utiliza para evitar conflictos con outras conexiones añadiendo un prefijo a os IDs de os modelos - deje vacío para deshabilitar',
		...
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Referirse a vostede mismo como "Usuario" (por Exemplo, "O usuario está aprendiendo Español")',
		'Reference Chats': '',
		Refresh: Sn,
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'As notificacions de resposta non poden activarse debido a que os permisos do sitio web han sido denegados. Por favor, visite as configuracions da sua navegador para otorgar o acceso necesario.',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Xa non se admite gardar registros de chat directamente no almacenamiento da sua navegador. Tómese un momento para descargar y eliminar sus registros de chat haciendo clic no botón a continuación. No te preocupes, puedes volver a importar fácilmente tus registros de chat al backend a través de',
		Schedule: Jn,
		...
		'Selected model(s) do not support image inputs':
			'Os modelos seleccionados no admiten entradas de imaxen',
		'Selected Models': '',
		semantic: es,
		Send: os,
		...
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			'Establece o número de capas que se descargarán na  GPU. Aumentar este valor puede mejorar significativamente o rendimiento de os modelos optimizados para la aceleración de GPU, pero también puede consumir mais energía y recursos de GPU.',
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Establece un sesgo plano contra os tokens que han aparecido al menos una vez. Un valor más alto (por Exemplo, 1.5) penalizará más fuertemente las repeticiones, mientras que un valor más bajo (por Exemplo, 0.9) será más indulgente. En 0, está deshabilitado.',
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Establece un sesgo de escala contra os tokens para penalizar las repeticiones, basado en cuántas veces han aparecido. Un valor más alto (por Exemplo, 1.5) penalizará más fuertemente las repeticiones, mientras que un valor más bajo (por Exemplo, 0.9) será más indulgente. En 0, está deshabilitado.',
		'Sets how far back for the model to look back to prevent repetition.':
			'Establece canto tempo debe retroceder o modelo para evitar a repetición.',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			'Establece a semente de número aleatorio a usar para xeneración. Establecer esto a un número específico hará que el modelo genere el mismo texto para el mismo prompt.',
		'Sets the size of the context window used to generate the next token.':
			'Establece o tamaño da ventana de contexto utilizada para xenerar o seguinte token.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			'Establece as secuencias de parada a usar. Cuando se encuentre este patrón, o LLM dejará de generar texto y devolverá. Se pueden establecer varios patrones de parada especificando múltiples parámetros de parada separados en un arquivo de modelo.',
		Setting: ns,
		Settings: ss,
		...
		'Show Admin Details in Account Pending Overlay':
			'Mostrar detalles de administración na  capa de espera da conta',
		'Show All': '',
		...
		'The Application Account DN you bind with for search':
			'A conta de aplicación DN que vincula para a búsqueda',
		...
		'The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.':
			'O tamaño do lote determina canto texto se procesa xunto de unha vez. Un tamaño de lote maior pode aumentar o rendimiento y a velocidade do modelo, pero también requiere mais memoria.',
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Os desarrolladores de este plugin son apasionados voluntarios da comunidade. Se encontras este plugin útil, por favor considere contribuir a seu desarrollo.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'O tableiro de líderes de evaluación basase no sistema de clasificación Elo e actualizase entempo real.',
		...
		'The LDAP attribute that maps to the mail that users use to sign in.':
			'O atributo LDAP que se asigna al correo que os usuarios utilizan para iniciar sesión.',
		'The LDAP attribute that maps to the username that users use to sign in.':
			'O atributo LDAP que se asigna al nombre de usuario que os usuarios utilizan para iniciar sesión.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'O tablero de líderes está actualmente en beta y podemos axustar os cálculos de clasificación a medida que refinamos o algoritmo.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'O tamaño máximo do arquivo en MB. Si o tamaño do arquivo supera este límite, o arquivo no se subirá.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'O número máximo de arquivos que se pueden utilizar a la vez en chat. Si este límite es superado, os arquivos no se subirán.',
		...
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Esto garantiza que sus valiosas conversacions se guarden de forma segura en su base de datos no backend. ¡Gracias!',
		...
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Esta es unha característica experimental que puede no funcionar como se esperaba y está sujeto a cambios en cualquier momento.',
		...
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Esta opción eliminará todos os arquivos existentes na  colección y os reemplazará con novos arquivos subidos.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Esto eliminará <strong>{{NAME}}</strong> y <strong>todo su contido</strong>.',
		'This will delete all models including custom models':
			'Esto eliminará todos os modelos, incluidos os modelos personalizados',
		'This will delete all models including custom models and cannot be undone.':
			'Esto eliminará todos os modelos, incluidos os modelos personalizados y no se puede deshacer.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Esto reseteará la base de coñecementos y sincronizará todos os arquivos. ¿Desea continuar?',
		...
		'To access the available model names for downloading,':
			'Para acceder os nomes de modelos dispoñibles para descargar,',
		'To access the GGUF models available for downloading,':
			'Para acceder os modelos GGUF dispoñibles para descargar,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'Para acceder al interfaz de usuario web, por favor contacte al administrador. os administradores pueden administrar os estados de os usuarios desde o panel de administración.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Para adjuntar la base de coñecementos aquí, agreguelas al área de trabajo "coñecemento" primeiro.',
		'To learn more about available endpoints, visit our documentation.':
			'Para obter mais información sobre os endpoints disponibles, visite nuestra documentación.',
		'To select skills here, add them to the "Skills" workspace first.': '',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Para seleccionar ferramentas aquí, agreguelas al área de trabajo "Ferramentas" primeiro.',
		...
		'Tools are a function calling system with arbitrary code execution':
			'As ferramentas son un sistema de chamada de funcións con código arbitrario',
		'Tools Function Calling Prompt': 'Prompt de chamada de funcións de ferramentas',
		'Tools have a function calling system that allows arbitrary code execution.':
			'As ferramentas tienen un sistema de chamada de funcións que permite la execución de código arbitrario.',
		...
		'Update for the latest features and improvements.':
			'Actualize para as últimas características e mejoras.',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Utilice '#' no prompt para cargar y incluir su coñecemento.",
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Usando o modelo de arena predeterminado con todos os modelos. Haga clic no botón mais para agregar modelos personalizados.',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Advertencia: Habilitar esto permitirá a os usuarios subir código arbitrario no servidor.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			'Aviso: A execución de Jupyter permite a execución de código arbitrario, o que supón riscos de seguridade graves - procede con extrema precaución.',
		We_day_of_week: wr,
		Web: Cr,
		'Web API': 'API Web',
		'Web Loader Engine': '',
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			'Cando está habilitado, o modelo responderá a cada mensaxe de chat en tempo real, generando unha resposta tan pronto como o usuario envíe un mensaxe. Este modo es útil para aplicacions de chat en vivo, pero puede afectar o rendimiento en hardware mais lento.',
		...
		'Works together with top-k. A higher value (e.g., 0.95) will lead to more diverse text, while a lower value (e.g., 0.5) will generate more focused and conservative text.':
			'Funciona xunto con top-k. Un valor máis alto (por exemplo, 0,95) dará lugar a un texto máis diverso, mentres que un valor máis baixo (por exemplo, 0,5) xerará un texto máis centrado e conservador.',
		Workspace: Ur,
		'Workspace Permissions': 'Permisos do espacio de traballo',
		Write: kr,
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Escribe un resumen en 50 palabras que resuma [tema ou palabra principal].',
...
p. ex.: Es Mario de Super Mario Bros e actúas como asistente.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'Estás utilizando actualmente unha licenza de proba. Por favor, contacta co soporte para actualizar a túa licenza.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Solo puede chatear con un máximo de {{maxCount}} arquivo(s) a la vez.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Puede personalizar as suas interaccions con LLMs añadiendo memorias a través do botón 'Xestionar' debajo, haciendo que sean mais útiles y personalizados para vostede.",
		...
		'Your account status is currently pending activation.':
			'O estado da sua conta actualmente encontrase pendente de activación.',
...
//# sourceMappingURL=DkIm5DR1.js.map
