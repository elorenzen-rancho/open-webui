...
function ie(i) {
	return xt(ve(i * 2.55), 0, 255);
}
function kt(i) {
	return xt(ve(i * 255), 0, 255);
}
function ft(i) {
	return xt(ve(i / 2.55) / 100, 0, 1);
}
function Qi(i) {
	return xt(ve(i * 100), 0, 100);
}
const it = {
		0: 0,
		1: 1,
	...
	vi = [...'0123456789ABCDEF'],
	Mo = (i) => vi[i & 15],
	ko = (i) => vi[(i & 240) >> 4] + vi[i & 15],
	we = (i) => (i & 240) >> 4 === (i & 15),
	So = (i) => we(i.r) && we(i.g) && we(i.b) && we(i.a);
function wo(i) {
	var t = i.length,
		e;
	return (
...
function Eo(i) {
	...
	const n = kn(+t[2]),
		...
		a = +t[4] / 100;
	return (
		t[1] === 'hwb' ? (s = Lo(n, o, a)) : t[1] === 'hsv' ? (s = Ro(n, o, a)) : (s = Vi(n, o, a)),
		{ r: s[0], g: s[1], b: s[2], a: e }
	);
}
function Fo(i, t) {
	var e = zi(i);
	((e[0] = kn(e[0] + t)), (e = Vi(e)), (i.r = e[0]), (i.g = e[1]), (i.b = e[2]));
}
function Io(i) {
	if (!i) return;
	const t = zi(i),
...
function zo() {
	...
	for (s = 0; s < t.length; s++) {
		for (a = r = t[s], n = 0; n < e.length; n++) ((o = e[n]), (r = r.replace(o, ts[o])));
...
let Pe;
function Bo(i) {
	Pe || ((Pe = zo()), (Pe.transparent = [0, 0, 0, 0]));
...
function Wo(i) {
	...
	if (t) {
		...
		return (
			...
			(n = +t[3]),
			(o = +t[5]),
			(s = 255 & (t[2] ? ie(s) : xt(s, 0, 255))),
			(n = 255 & (t[4] ? ie(n) : xt(n, 0, 255))),
			(o = 255 & (t[6] ? ie(o) : xt(o, 0, 255))),
			{ r: s, g: n, b: o, a: e }
		);
	}
}
function No(i) {
	return (
		i && (i.a < 255 ? `rgba(${i.r}, ${i.g}, ${i.b}, ${ft(i.a)})` : `rgb(${i.r}, ${i.g}, ${i.b})`)
	);
}
const ri = (i) => (i <= 0.0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - 0.055),
	jt = (i) => (i <= 0.04045 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4));
function Ho(i, t, e) {
	const s = jt(ft(i.r)),
		n = jt(ft(i.g)),
		o = jt(ft(i.b));
	return {
		r: kt(ri(s + e * (jt(ft(t.r)) - s))),
		g: kt(ri(n + e * (jt(ft(t.g)) - n))),
		b: kt(ri(o + e * (jt(ft(t.b)) - o))),
		a: i.a + e * (t.a - i.a)
	};
}
function De(i, t, e) {
...
function is(i) {
	...
	return (
		Array.isArray(i)
			? i.length >= 3 &&
				((t = { r: i[0], g: i[1], b: i[2], a: 255 }), i.length > 3 && (t.a = kt(i[3])))
			: ((t = Sn(i, { r: 0, g: 0, b: 0, a: 1 })), (t.a = kt(t.a))),
		t
	);
}
function jo(i) {
...
class fe {
	constructor(t) {
		...
		const e = typeof t;
		let s;
		(e === 'object' ? (s = is(t)) : e === 'string' && (s = wo(t) || Bo(t) || jo(t)),
			(this._rgb = s),
			(this._valid = !!s));
	}
	get valid() {
...
const Yo = (i, t) => (typeof i == 'string' && i.endsWith('%') ? parseFloat(i) / 100 : +i / t),
	wn = (i, t) => (typeof i == 'string' && i.endsWith('%') ? (parseFloat(i) / 100) * t : +i);
function I(i, t, e) {
...
function On(i, t) {
	...
	return (o < -0.5 * R && (o += z), { angle: o, distance: n });
}
function Mi(i, t) {
...
const An = ['push', 'pop', 'shift', 'splice', 'unshift'];
function aa(i, t) {
	if (i._chartjs) {
...
const ji = (i) => (i === 'start' ? 'left' : i === 'end' ? 'right' : 'center'),
	...
	la = (i, t, e, s) => (i === (s ? 'left' : 'right') ? e : i === 'center' ? (t + e) / 2 : t);
function Rn(i, t, e) {
	const s = t.length;
	let n = 0,
		o = s;
	if (i._sorted) {
		...
		if (f) {
			if (((n = Math.min(pt(l, h, d).lo, e ? s : pt(t, h, a.getPixelForValue(d)).lo)), c)) {
				const p = l
					.slice(0, n + 1)
					.reverse()
		...
		if (g) {
			let p = Math.max(
				pt(l, a.axis, u, !0).hi + 1,
				e ? 0 : pt(t, h, a.getPixelForValue(u), !0).hi + 1
			);
			if (c) {
				const m = l.slice(p - 1).findIndex((b) => !C(b[r.axis]));
				p += Math.max(0, m);
			}
			o = Y(p, n, s) - n;
		} else o = s - n;
...
const Oe = (i) => i === 0 || i === 1,
	cs = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * z) / e)),
	...
	he = {
		...
		easeInElastic: (i) => (Oe(i) ? i : cs(i, 0.075, 0.3)),
		easeOutElastic: (i) => (Oe(i) ? i : hs(i, 0.075, 0.3)),
		easeInOutElastic(i) {
			return Oe(i)
				? i
				: i < 0.5
		...
		easeInOutBounce: (i) =>
			i < 0.5 ? he.easeInBounce(i * 2) * 0.5 : he.easeOutBounce(i * 2 - 1) * 0.5 + 0.5
	};
function $i(i) {
...
function ds(i) {
	return $i(i) ? i : new fe(i);
}
function li(i) {
	return $i(i) ? i : new fe(i).saturate(0.5).darken(0.1).hexString();
}
...
const Fn = {
	...
	numeric(i, t, e) {
		...
		return (Object.assign(l, this.options.ticks.format), Me(i, s, l));
	},
	logarithmic(i, t, e) {
		if (i === 0) return '0';
...
class ma {
	constructor(t, e) {
		((this.animation = void 0),
			...
			(this.hover = {}),
			(this.hoverBackgroundColor = (s, n) => li(n.backgroundColor)),
			(this.hoverBorderColor = (s, n) => li(n.borderColor)),
			(this.hoverColor = (s, n) => li(n.color)),
			(this.indexAxis = 'x'),
...
function xa(i, t, e, s) {
	...
	let l, c, h, d, u;
	for (l = 0; l < r; l++)
		if (((d = e[l]), d != null && !V(d))) a = Ge(i, n, o, a, d);
		else if (V(d))
		...
		switch ((i.beginPath(), f)) {
			...
			case 'rectRounded':
				((c = p * 0.516),
					(l = p - c),
					(a = Math.cos(m + At) * l),
					(d = Math.cos(m + At) * (n ? n / 2 - c : l)),
					(r = Math.sin(m + At) * l),
					(u = Math.sin(m + At) * (n ? n / 2 - c : l)),
					i.arc(e - d, s - r, c, m - R, m - j),
					i.arc(e + u, s - a, c, m - j, m),
					i.arc(e + d, s + r, c, m, m + j),
					i.arc(e - u, s + a, c, m + j, m + R),
					i.closePath());
				break;
			case 'rect':
				if (!g) {
...
function be(i, t) {
	...
	(i.arc(e + a.topLeft, s + a.topLeft, a.topLeft, 1.5 * R, R, !0),
		...
		i.arc(e + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, R, j, !0),
...
function Yi(i, t) {
	...
	for (const a of n) e[a] = Da(o(a));
	return e;
}
function zn(i) {
	return Yi(i, { top: 'y', right: 'x', bottom: 'y', left: 'x' });
}
function It(i) {
	return Yi(i, ['topLeft', 'topRight', 'bottomLeft', 'bottomRight']);
}
function Z(i) {
	const t = zn(i);
...
function se(i, t, e, s) {
	let n, o, a;
	for (n = 0, o = i.length; n < o; ++n) if (((a = i[n]), a !== void 0 && a !== void 0)) return a;
}
function Oa(i, t, e) {
	const { min: s, max: n } = i,
		o = wn(t, (n - s) / 2),
...
function Ca(i, t, e) {
	...
	let r = s[t];
	return (
		wt(r) && a.isScriptable(t) && (r = Ta(t, r, i, e)),
		V(r) && r.length && (r = La(t, r, i, a.isIndexable)),
		Ui(t, r) && (r = Ut(r, n, o && o[t], a)),
		r
	);
}
function Ta(i, t, e, s) {
	...
	r.add(i);
	let l = t(o, a || s);
	return (r.delete(i), Ui(i, l) && (l = Ki(n._scopes, n, i, l)), l);
}
function La(i, t, e, s) {
...
const Ra = (i, t) => (i === !0 ? t : typeof i == 'string' ? St(t, i) : void 0);
function Ea(i, t, e, s, n) {
	for (const o of t) {
		const a = Ra(e, o);
		if (a) {
			i.add(a);
			const r = Wn(a._fallback, e, n);
...
function Ki(i, t, e, s) {
	const n = t._rootScopes,
		o = Wn(t._fallback, e, s),
		a = [...i, ...n],
		r = new Set();
	r.add(s);
	let l = gs(r, a, e, o || e, s);
	return l === null || (typeof o < 'u' && o !== e && ((l = gs(r, a, o, l, s)), l === null))
		? !1
		: Xi(Array.from(r), [''], n, o, () => Fa(t, e, s));
}
function gs(i, t, e, s, n) {
	for (; e; ) e = Ea(i, t, e, s, n);
	return e;
}
function Fa(i, t, e) {
...
function Ia(i, t, e, s) {
	let n;
	for (const o of t)
		if (((n = Nn(Aa(o, i), e)), typeof n < 'u')) return Ui(i, n) ? Ki(e, s, i, n) : n;
}
function Nn(i, t) {
	for (const e of t) {
		if (!e) continue;
...
function Hn(i, t, e, s) {
	const { iScale: n } = i,
		...
		a = new Array(s);
	let r, l, c, h;
	for (r = 0, l = s; r < l; ++r) ((c = r + e), (h = t[c]), (a[r] = { r: n.parse(St(h, o), c) }));
	return a;
}
const Ba = Number.EPSILON || 1e-14,
	Kt = (i, t) => t < i.length && !i[t].skip && i[t],
	jn = (i) => (i === 'x' ? 'y' : 'x');
function Va(i, t, e, s) {
	const n = i.skip ? t : i,
		o = t,
...
function Na(i, t, e = 'x') {
	...
	let o,
		...
		l = Kt(i, 0);
	for (let c = 0; c < n; ++c) {
		if (((a = r), (r = l), (l = Kt(i, c + 1)), !r)) continue;
		const h = r[e],
			d = r[s];
...
function ja(i, t) {
	...
	for (e = 0, s = i.length; e < s; ++e)
		((a = o),
			...
			o &&
				((n = i[e]),
				a && ((n.cp1x = Ae(n.cp1x, t.left, t.right)), (n.cp1y = Ae(n.cp1y, t.top, t.bottom))),
				r && ((n.cp2x = Ae(n.cp2x, t.left, t.right)), (n.cp2y = Ae(n.cp2y, t.top, t.bottom)))));
}
function $a(i, t, e, s, n) {
	...
	if ((t.spanGaps && (i = i.filter((c) => !c.skip)), t.cubicInterpolationMode === 'monotone'))
		...
		for (o = 0, a = i.length; o < a; ++o)
			((r = i[o]),
				(l = Va(c, r, i[Math.min(o + 1, a - (s ? 0 : 1)) % a], t.tension)),
				(r.cp1x = l.previous.x),
				(r.cp1y = l.previous.y),
				(r.cp2x = l.next.x),
				(r.cp2y = l.next.y),
...
const Xa = ['top', 'right', 'bottom', 'left'];
function zt(i, t, e) {
	const s = {};
	e = e ? '-' + e : '';
	for (let n = 0; n < 4; n++) {
...
function Ga(i, t, e, s) {
	...
	return (
		...
		(c = yt(Math.min(c, a, l.maxWidth))),
		(h = yt(Math.min(h, r, l.maxHeight))),
		c && !h && (h = yt(c / 2)),
		(t !== void 0 || e !== void 0) &&
			s &&
			l.height &&
			h > l.height &&
			((h = l.height), (c = yt(Math.floor(h * s)))),
		{ width: c, height: h }
	);
}
function ms(i, t, e) {
...
function Xn(i) {
	return i === 'angle'
		? { between: me, compare: ia, normalize: q }
...
function Un(i, t, e) {
	...
	const { property: s, start: n, end: o } = e,
		a = t.length,
		{ compare: r, between: l, normalize: c } = Xn(s),
		{ start: h, end: d, loop: u, style: f } = ir(i, t, e),
		g = [];
	let p = !1,
		m = null,
		b,
	...
	for (let w = h, P = h; w <= d; ++w)
		((x = t[w % a]),
			!x.skip &&
				...
				b !== v &&
					((p = l(b, n, o)),
					m === null && k() && (m = r(b, n) === 0 ? w : P),
					m !== null &&
						S() &&
						(g.push(xs({ start: m, end: w, loop: u, count: a, style: f })), (m = null)),
					(P = w),
					(v = b))));
	return (m !== null && g.push(xs({ start: m, end: d, loop: u, count: a, style: f })), g);
}
function Kn(i, t) {
	const e = [],
		s = i.segments;
	for (let n = 0; n < s.length; n++) {
		const o = Un(s[n], i.points, t);
		o.length && e.push(...o);
	}
	return e;
}
...
function or(i, t) {
	...
	if (!n) return [];
	const o = !!i._loop,
		{ start: a, end: r } = sr(e, n, o, s);
	if (s === !0) return _s(i, [{ start: a, end: r, loop: o }], e, t);
	const l = r < a ? r + n : r,
		c = !!i._fullLoop && a === 0 && r === n - 1;
	return _s(i, nr(e, a, l, c), e, t);
}
function _s(i, t, e, s) {
...
class dr {
	constructor(t, e, s, n) {
		...
		const a = se([t.from, o, n]);
		((this._active = !0),
			(this._fn = t.fn || hr[t.type || typeof a]),
			(this._easing = he[t.easing] || he.linear),
...
class Gn {
	...
	_animateOptions(t, e) {
		...
		return (
			s.$shared &&
				ur(t.options.$animations, s).then(
					() => {
						t.options = s;
					},
					() => {}
...
function ws(i, t) {
	...
	for (let f = 0; f < d; ++f) {
		...
		((u = b[c] = _r(n, h, p)),
			(u[r] = m),
			(u._top = Ss(u, a, !0, s.type)),
			(u._bottom = Ss(u, a, !1, s.type)));
...
const ui = (i) => i === 'reset' || i === 'none',
	Ps = (i, t) => (t ? i : Object.assign({}, i)),
	Mr = (i, t, e) => i && !t.hidden && t._stacked && { keys: Zn(e, !0), values: null };
class ot {
	constructor(t, e) {
		((this.chart = t),
			(this._ctx = t.ctx),
	...
	linkScales() {
		const t = this.chart,
			...
			o = (e.xAxisID = D(s.xAxisID, di(t, 'x'))),
			a = (e.yAxisID = D(s.yAxisID, di(t, 'y'))),
			r = (e.rAxisID = D(s.rAxisID, di(t, 'r'))),
			l = e.indexAxis,
	...
	_destroy() {
		const t = this._cachedMeta;
		(this._data && ls(this._data, this), t._stacked && Zt(t));
	}
	_dataCheck() {
	...
	buildOrUpdateElements(t) {
		...
		((e._stacked = hi(e.vScale, e)),
			...
			(n || o !== e._stacked) && (ws(this, e._parsed), (e._stacked = hi(e.vScale, e))));
	}
	configure() {
	...
	parseObjectData(t, e, s, n) {
		...
		let h, d, u, f;
		for (h = 0, d = n; h < d; ++h)
			((u = h + s), (f = e[u]), (c[h] = { x: o.parse(St(f, r), u), y: a.parse(St(f, l), u) }));
		return c;
	}
	getParsed(t) {
	...
	_update(t) {
		...
		(this.update(t || 'default'),
			(e._clip = pr(D(this.options.clip, gr(e.xScale, e.yScale, this.getMaxOverflow())))));
	}
	update(t) {}
	draw() {
		const t = this._ctx,
	...
	getContext(t, e, s) {
		...
		if (t >= 0 && t < this._cachedMeta.data.length) {
			...
			((o = a.$context || (a.$context = vr(this.getContext(), t, a))),
				(o.parsed = this.getParsed(t)),
				(o.raw = n.data[t]),
				(o.index = o.dataIndex = t));
		} else
			((o = this.$context || (this.$context = yr(this.chart.getContext(), this.index))),
				(o.dataset = n),
	...
	_resolveElementOptions(t, e = 'default', s) {
		const n = e === 'active',
			...
			a = t + '-' + e,
			r = o[a],
			l = this.enableOptionSharing && pe(s);
		if (r) return Ps(r, l);
		...
		return (p.$shared && ((p.$shared = l), (o[a] = Object.freeze(Ps(p, l)))), p);
	}
	...
	updateElement(t, e, s, n) {
		ui(n) ? Object.assign(t, s) : this._resolveAnimations(e, n).update(t, s);
	}
	updateSharedOptions(t, e, s) {
		t && !ui(e) && this._resolveAnimations(void 0, e).update(t, s);
	}
	_setStyle(t, e, s, n) {
		t.active = n;
...
function Ds(i, t, e, s) {
	...
	let c, h, d, u;
	for (c = e, h = e + s; c < h; ++c)
		((u = t[c]), (d = {}), (d[n.axis] = r || n.parse(a[c], c)), l.push(Jn(u, d, o, c)));
	return l;
}
function fi(i) {
...
function Os(i, t, e, s) {
	return (s ? ((i = Tr(i, t, e)), (i = As(i, e, t))) : (i = As(i, t, e)), i);
}
function Tr(i, t, e) {
...
class Be extends ot {
	...
	parseObjectData(t, e, s, n) {
		...
		let u, f, g, p;
		for (u = s, f = s + n; u < f; ++u)
			((p = e[u]), (g = {}), (g[o.axis] = o.parse(St(p, c), u)), d.push(Jn(St(p, h), g, a, u)));
		return d;
	}
	updateRangeFromParsed(t, e, s, n) {
	...
	getLabelAndValue(t) {
		const e = this._cachedMeta,
			...
			o = this.getParsed(t),
			a = o._custom,
			r = fi(a) ? '[' + a.start + ', ' + a.end + ']' : '' + n.getLabelForValue(o[n.axis]);
		...
		for (let f = e; f < e + s; f++) {
			const g = this.getParsed(f),
				...
				x = {
					horizontal: c,
					base: p.base,
					enableBorderRadius: !b || fi(g._custom) || a === b._top || a === b._bottom,
					x: c ? p.head : m.center,
					y: c ? m.center : p.head,
			...
			(Cr(x, v, b, a), Lr(x, v, h.ratio), this.updateElement(t[f], f, x, n));
		}
	}
	_getStacks(t, e) {
	...
	_calculateBarIndexPixels(t, e) {
		...
		if (e.grouped) {
			const h = o ? this._getStackCount(t) : e.stackCount,
				d = n.barThickness === 'flex' ? Pr(t, e, n, h * c) : wr(t, e, n, h * c),
				u =
...
(M(Ve, 'id', 'bubble'),
	...
	M(Ve, 'overrides', { scales: { x: { type: 'linear' }, y: { type: 'linear' } } }));
function Rr(i, t, e) {
	let s = 1,
		n = 1,
		o = 0,
	...
	if (t < z) {
		const r = i,
			...
			d = Math.cos(l),
			u = Math.sin(l),
			f = (v, y, _) => (me(v, r, l, !0) ? 1 : Math.max(y, y * e, _, _ * e)),
			g = (v, y, _) => (me(v, r, l, !0) ? -1 : Math.min(y, y * e, _, _ * e)),
			p = f(0, c, d),
			m = f(j, h, u),
			b = g(R, c, d),
			x = g(R + j, h, u);
...
class Ft extends ot {
	...
	update(t) {
		const e = this.chart,
			...
			l = Math.min(Yo(this.options.cutout, r), 1),
			c = this._getRingWeight(this.index),
			{ circumference: h, rotation: d } = this._getRotationExtents(),
			{ ratioX: u, ratioY: f, offsetX: g, offsetY: p } = Rr(d, h, l),
			m = (s.width - a) / u,
			b = (s.height - a) / f,
	...
	getLabelAndValue(t) {
		const e = this._cachedMeta,
			s = this.chart,
			n = s.data.labels || [],
			o = Me(e._parsed[t], s.options.locale);
...
class We extends ot {
	...
	updateElements(t, e, s, n) {
		const o = n === 'reset',
			...
			m = Xt(g) ? g : Number.POSITIVE_INFINITY,
		...
		for (let _ = 0; _ < v; ++_) {
			...
			const w = this.getParsed(_),
				P = C(w[f]),
				O = (S[u] = a.getPixelForValue(w[u], _)),
				A = (S[f] =
					o || P ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, w, l) : w[f], _));
			((S.skip = isNaN(O) || isNaN(A) || P),
				(S.stop = _ > 0 && Math.abs(w[u] - y[u]) > m),
				p && ((S.parsed = w), (S.raw = c.data[_])),
				d && (S.options = h || this.resolveDataElementOptions(_, k.active ? 'active' : n)),
				b || this.updateElement(k, _, S, n),
				(y = w));
		}
	}
	getMaxOverflow() {
...
(M(We, 'id', 'line'),
	...
	M(We, 'overrides', { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } }));
class ue extends ot {
	constructor(t, e) {
	...
	getLabelAndValue(t) {
		const e = this._cachedMeta,
			s = this.chart,
			n = s.data.labels || [],
			o = Me(e._parsed[t].r, s.options.locale);
		return { label: n[t] || '', value: o };
	}
	parseObjectData(t, e, s, n) {
		return Hn.bind(this)(t, e, s, n);
	}
	update(t) {
		const e = this._cachedMeta.data;
...
class wi extends Ft {}
(M(wi, 'id', 'pie'),
	M(wi, 'defaults', { cutout: 0, rotation: 0, circumference: 360, radius: '100%' }));
class Ne extends ot {
	getLabelAndValue(t) {
...
(M(Ne, 'id', 'radar'),
	...
	M(Ne, 'overrides', { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } }));
class He extends ot {
	getLabelAndValue(t) {
		const e = this._cachedMeta,
			s = this.chart.data.labels || [],
	...
	updateElements(t, e, s, n) {
		const o = n === 'reset',
			...
			b = Xt(p) ? p : Number.POSITIVE_INFINITY,
		...
		for (let y = e; y < e + s; ++y) {
			const _ = t[y],
				...
				S = x ? _ : {},
				w = C(k[g]),
				P = (S[f] = a.getPixelForValue(k[f], y)),
				O = (S[g] =
					o || w ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, k, l) : k[g], y));
			((S.skip = isNaN(P) || isNaN(O) || w),
				(S.stop = y > 0 && Math.abs(k[f] - v[f]) > b),
				m && ((S.parsed = k), (S.raw = c.data[y])),
				u && (S.options = d || this.resolveDataElementOptions(y, _.active ? 'active' : n)),
				x || this.updateElement(_, y, S, n),
				(v = k));
		}
...
(M(He, 'id', 'scatter'),
	M(He, 'defaults', { datasetElementType: !1, dataElementType: 'point', showLine: !1, fill: !1 }),
	M(He, 'overrides', {
...
function Ir(i, t, e, s) {
	...
	if (r && t === r.axis && t !== 'r' && a && o.length) {
		const c = r._reversePixels ? na : pt;
		if (s) {
			if (n._sharedOptions) {
				const h = o[0],
	...
	modes: {
		index(i, t, e, s) {
			const n = Rt(t, i),
				...
				r = e.intersect ? gi(i, n, o, s, a) : pi(i, n, o, !1, s, a),
				l = [];
			return r.length
		...
		dataset(i, t, e, s) {
			const n = Rt(t, i),
				o = e.axis || 'xy',
				a = e.includeInvisible || !1;
			let r = e.intersect ? gi(i, n, o, s, a) : pi(i, n, o, !1, s, a);
			if (r.length > 0) {
		...
		nearest(i, t, e, s) {
			const n = Rt(t, i),
				o = e.axis || 'xy',
				a = e.includeInvisible || !1;
			return pi(i, n, o, e.intersect, s, a);
		},
		x(i, t, e, s) {
			const n = Rt(t, i);
...
const Qn = ['left', 'top', 'right', 'bottom'];
function Jt(i, t) {
...
function Yr(i, t, e, s) {
	...
	o.getPadding && to(a, o.getPadding());
	const r = Math.max(0, t.outerWidth - Ls(a, i, 'left', 'right')),
		l = Math.max(0, t.outerHeight - Ls(a, i, 'top', 'bottom')),
		c = r !== i.w,
		h = l !== i.h;
	...
	for (const r of i) {
		...
		if (r.horizontal) {
			...
			(pe(c.start) && (a = c.start),
				l.fullSize
					? Te(l, n.left, a, e.outerWidth - n.right - n.left, u)
					: Te(l, t.left + c.placed, a, d, u),
				(c.start = a),
				(c.placed += d),
				(a = l.bottom));
		} else {
			...
			(pe(c.start) && (o = c.start),
				l.fullSize
					? Te(l, o, n.top, u, e.outerHeight - n.bottom - n.top)
					: Te(l, o, t.top + c.placed, u, d),
				(c.start = o),
				(c.placed += d),
				(o = l.right));
		}
...
var G = {
	...
	update(i, t, e, s) {
		...
		(ne(r.fullSize, f, d, g),
			ne(l, f, d, g),
			ne(c, f, d, g) && ne(l, f, d, g),
			Xr(f),
			Rs(r.leftAndTop, f, d, g),
			(f.x += f.w),
			(f.y += f.h),
			Rs(r.rightAndBottom, f, d, g),
			(i.chartArea = {
				left: f.left,
				top: f.top,
				right: f.left + f.w,
...
const io = Za ? { passive: !0 } : !1;
function Zr(i, t, e) {
	i && i.addEventListener(t, e, io);
}
function Jr(i, t, e) {
	i && i.canvas && i.canvas.removeEventListener(t, e, io);
}
function Qr(i, t) {
	const e = qr[i.type] || i.type,
		{ x: s, y: n } = Rt(i, t);
...
function tl(i, t, e) {
	const s = i.canvas,
		n = new MutationObserver((o) => {
			let a = !1;
			for (const r of o) ((a = a || Je(r.addedNodes, s)), (a = a && !Je(r.removedNodes, s)));
			a && e();
		});
...
function el(i, t, e) {
	const s = i.canvas,
		n = new MutationObserver((o) => {
			let a = !1;
			for (const r of o) ((a = a || Je(r.removedNodes, s)), (a = a && !Je(r.addedNodes, s)));
			a && e();
		});
	return (n.observe(document, { childList: !0, subtree: !0 }), n);
}
...
function il(i, t) {
	(xe.size || window.addEventListener('resize', so), xe.set(i, t));
}
function sl(i) {
	(xe.delete(i), xe.size || window.removeEventListener('resize', so));
}
function nl(i, t, e) {
	const s = i.canvas,
		n = s && Gi(s);
...
class al extends eo {
	...
	addEventListener(t, e, s) {
		...
		const n = t.$proxies || (t.$proxies = {}),
			a = { attach: tl, detach: el, resize: nl }[e] || ol;
		n[e] = a(t, e, s);
	}
	removeEventListener(t, e) {
		const s = t.$proxies || (t.$proxies = {}),
			n = s[e];
		if (!n) return;
		((({ attach: mi, detach: mi, resize: mi })[e] || Jr)(t, e, n), (s[e] = void 0));
	}
	getDevicePixelRatio() {
...
function rl(i) {
	return !qi() || (typeof OffscreenCanvas < 'u' && i instanceof OffscreenCanvas) ? Kr : al;
}
class at {
	constructor() {
		M(this, 'x');
...
function ll(i, t) {
	const e = i.options.ticks,
		...
		o = e.major.enabled ? dl(t) : [],
		a = o.length,
		r = o[0],
		l = o[a - 1],
		c = [];
	if (a > n) return (ul(t, c, o, a / n), c);
	const h = hl(o, t, n);
	if (a > 0) {
		let d, u;
		const f = a > 1 ? Math.round((l - r) / (a - 1)) : null;
		for (Le(t, c, h, C(f) ? 0 : r - f, r), d = 0, u = a - 1; d < u; d++)
			Le(t, c, h, o[d], o[d + 1]);
		return (Le(t, c, h, l, C(f) ? t.length : l + f), c);
	}
	return (Le(t, c, h), c);
}
function cl(i) {
...
function yl(i, t, e, s) {
	...
	if (i.isHorizontal()) {
		...
		} else e === 'center' ? (f = (c.left + c.right) / 2 - m + t) : (f = Is(i, e, t));
...
class Wt extends at {
	...
	getUserBounds() {
		...
		return (
			...
			{ min: et(t, s), max: et(e, n), minDefined: N(t), maxDefined: N(e) }
		);
	}
	getMinMax(t) {
	...
	update(t, e, s) {
		...
		(this.beforeUpdate(),
			...
			this._dataLimitsCached ||
				...
				(this._range = Oa(this, o, n)),
				(this._dataLimitsCached = !0)),
			this.beforeBuildTicks(),
			(this.ticks = this.buildTicks() || []),
			this.afterBuildTicks());
		const l = r < this.ticks.length;
		(this._convertTicksToLabels(l ? Bs(this.ticks, r) : this.ticks),
			this.configure(),
	...
	calculateLabelRotation() {
		const t = this.options,
			e = t.ticks,
			s = zs(this.ticks.length, t.ticks.maxTicksLimit),
			n = e.minRotation || 0,
			o = e.maxRotation;
		let a = n,
			r,
		...
		((r = t.offset ? this.maxWidth / s : f / (s - 1)),
			d + 6 > r &&
				...
				(l = this.maxHeight - te(t.grid) - e.padding - Vs(t.title, this.chart.options.font)),
				(c = Math.sqrt(d * d + u * u)),
				(a = Ni(
					Math.min(
		...
		for (d = 0; d < e; d += l) {
			if (
				...
				for (u = 0, f = g.length; u < f; ++u)
					((_ = g[u]), !C(_) && !V(_) && ((v = Ge(n, b.data, b.gc, v, _)), (y += x)));
			(a.push(v), r.push(y), (c = Math.max(v, c)), (h = Math.max(y, h)));
		}
		ml(o, e);
		const k = a.indexOf(c),
			S = r.indexOf(h),
			w = (P) => ({ width: a[P] || 0, height: r[P] || 0 });
		return { first: w(0), last: w(e - 1), widest: w(k), highest: w(S), widths: a, heights: r };
	}
	getLabelForValue(t) {
		return t;
	}
	...
	_computeGridLineItems(t) {
		...
		if (a === 'top')
			...
			((x = b(this.top)), (A = t.top), (X = b(t.bottom) - m), (S = x + m), (P = this.top + u));
		else if (a === 'left')
			((x = b(this.right)), (k = this.right - u), (w = x - m), (O = b(t.left) + m), (L = t.right));
		else if (a === 'right')
			((x = b(this.left)), (O = t.left), (L = b(t.right) - m), (k = x + m), (w = this.left + u));
		else if (e === 'x') {
			...
			((A = t.top), (X = t.bottom), (S = x + m), (P = S + u));
		} else if (e === 'y') {
			...
			((k = x - m), (w = k - u), (O = t.left), (L = t.right));
		}
	...
	_computeLabelItems(t) {
		...
		let b,
			...
			L,
			X = 'middle';
		if (n === 'top') ((k = this.bottom - g), (S = this._getXAxisLabelAlignment()));
		else if (n === 'bottom') ((k = this.top + g), (S = this._getXAxisLabelAlignment()));
		else if (n === 'left') {
			...
			if (n === 'center') k = (t.top + t.bottom) / 2 + f;
				...
				const F = Object.keys(n)[0],
					B = n[F];
				k = this.chart.scales[F].getPixelForValue(B) + f;
			}
		...
		for (b = 0, x = r.length; b < x; ++b) {
			...
			a
				? ((_ = w),
					S === 'inner' &&
						(b === x - 1
							? (Nt = this.options.reverse ? 'left' : 'right')
							: b === 0
								? (Nt = this.options.reverse ? 'right' : 'left')
								: (Nt = 'center')),
					n === 'top'
						? c === 'near' || p !== 0
							? (L = -A * O + O / 2)
							: c === 'center'
								? (L = -tt.highest.height / 2 - B * O + O)
								: (L = -tt.highest.height + O / 2)
						: c === 'near' || p !== 0
							? (L = O / 2)
							: c === 'center'
								? (L = tt.highest.height / 2 - B * O)
								: (L = tt.highest.height - A * O),
					d && (L *= -1),
					p !== 0 && !F.showLabelBackdrop && (_ += (O / 2) * Math.sin(p)))
				: ((k = w), (L = ((1 - A) * O) / 2));
			let Se;
			if (F.showLabelBackdrop) {
				const Ht = Z(F.backdropPadding),
					qt = tt.heights[b],
					Dt = tt.widths[b];
				let Gt = L - Ht.top,
					Ot = 0 - Ht.left;
	...
	drawBorder() {
		...
		let c, h, d, u;
		(this.isHorizontal()
			? ((c = Ct(t, this.left, a) - a / 2), (h = Ct(t, this.right, r) + r / 2), (d = u = l))
			: ((d = Ct(t, this.top, a) - a / 2), (u = Ct(t, this.bottom, r) + r / 2), (c = h = l)),
			e.save(),
			(e.lineWidth = o.width),
	...
	drawTitle() {
		...
		e === 'bottom' || e === 'center' || T(e)
			? ((l += a.bottom), V(s.text) && (l += o.lineHeight * (s.text.length - 1)))
			: (l += a.top);
...
function vl(i, t, e) {
	const s = ge(Object.create(null), [e ? W.get(e) : {}, W.get(t), i.defaults]);
	(W.set(t, s),
		i.defaultRoutes && Ml(t, i.defaultRoutes),
...
class Sl {
	constructor() {
		((this.controllers = new Re(ot, 'datasets', !0)),
			(this.elements = new Re(at, 'elements')),
			(this.plugins = new Re(Object, 'plugins')),
			(this.scales = new Re(Wt, 'scales')),
...
function Ol(i, { plugins: t, localIds: e }, s, n) {
	...
	for (const r of t) {
		const l = r.id,
			c = Dl(s[l], n);
		c !== null && o.push({ plugin: r, options: Al(i.config, { plugin: r, local: e[l] }, c, a) });
	}
	return o;
}
...
function Di(i, ...t) {
	if (Ws(i)) return i;
	for (const e of t) {
		const s = e.axis || Ll(e.position) || (i.length > 1 && Ws(i[0].toLowerCase()));
		if (s) return s;
	}
	throw new Error(
...
function Rl(i, t) {
	if (t.data && t.data.datasets) {
		...
		if (e.length) return Ns(i, 'x', e[0]) || Ns(i, 'y', e[0]);
	}
	return {};
}
function El(i, t) {
	const e = Bt[i.type] || { scales: {} },
		s = t.scales || {},
		n = Pi(i.type, t),
	...
	return (
		Object.keys(s).forEach((a) => {
			...
			const l = Di(a, r, Rl(a, i), W.scales[r.type]),
				c = Tl(l, n),
				h = e.scales || {};
			o[a] = le(Object.create(null), [{ axis: l }, r, h[l], h[c]]);
		}),
		i.data.datasets.forEach((a) => {
			const r = a.type || i.type,
				l = a.indexAxis || Pi(r, t),
				h = (Bt[r] || {}).scales || {};
			Object.keys(h).forEach((d) => {
				const u = Cl(d, l),
					f = a[u + 'AxisID'] || u;
				((o[f] = o[f] || Object.create(null)), le(o[f], [{ axis: u }, s[f], h[d]]));
			});
		}),
		Object.keys(o).forEach((a) => {
			const r = o[a];
			le(r, [W.scales[r.type], W.scale]);
		}),
		o
	);
}
...
function Ee(i, t) {
	let e = Hs.get(i);
	return (e || ((e = t()), Hs.set(i, e), ao.add(e)), e);
}
const ee = (i, t, e) => {
	const s = St(t, e);
	s !== void 0 && i.add(s);
...
class Il {
	...
	pluginScopeKeys(t) {
		const e = t.id,
			s = this.type;
		return Ee(`${s}-plugin-${e}`, () => [[`plugins.${e}`, ...(t.additionalOptionScopes || [])]]);
	}
	_cachedScopes(t, e) {
	...
	getOptionScopes(t, e, s) {
		...
		const l = new Set();
		e.forEach((h) => {
			(t && (l.add(t), h.forEach((d) => ee(l, t, d))),
				h.forEach((d) => ee(l, n, d)),
				h.forEach((d) => ee(l, Bt[o] || {}, d)),
				h.forEach((d) => ee(l, W, d)),
				h.forEach((d) => ee(l, ki, d)));
		});
	...
	chartOptionScopes() {
		...
		return [t, Bt[e] || {}, W.datasets[e] || {}, { type: e }, W, ki];
	}
	resolveNamedOptions(t, e, s, n = ['']) {
		const o = { $shared: !0 },
			{ resolver: a, subPrefixes: r } = js(this._resolverCache, t, n);
		let l = a;
		if (Bl(a, e)) {
	...
	createResolver(t, e, s = [''], n) {
		const { resolver: o } = js(this._resolverCache, t, s);
...
class bt {
	...
	constructor(t, e) {
		...
		((this.id = $o()),
			...
			($e[this.id] = this),
			!(!r || !l) &&
				(dt.listen(this, 'complete', Xs),
				dt.listen(this, 'progress', Nl),
				this._initialize(),
	...
	_initialize() {
		return (
			...
			this.options.responsive ? this.resize() : ms(this, this.options.devicePixelRatio),
			this.bindEvents(),
	...
	resize(t, e) {
		dt.running(this) ? (this._resizeBeforeDraw = { width: t, height: e }) : this._resize(t, e);
	}
	_resize(t, e) {
		const s = this.options,
			n = this.canvas,
		...
		(e &&
			...
			E(o, (a) => {
				const r = a.options,
					...
					c = Di(l, r),
					h = D(r.type, a.dtype);
				((r.position === void 0 || $s(r.position, c) !== $s(a.dposition)) &&
	...
	buildOrUpdateControllers() {
		...
		for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
			...
			if (
				...
				(a.type = r),
				(a.indexAxis = o.indexAxis || Pi(r, this.options)),
				(a.order = o.order || 0),
				(a.index = s),
				(a.label = '' + o.label),
...
(M(bt, 'defaults', W),
	...
	M(bt, 'getChart', Us));
function Ks() {
	return E(bt.instances, (i) => i._plugins.invalidate());
}
function $l(i, t, e) {
	const { startAngle: s, x: n, y: o, outerRadius: a, innerRadius: r, options: l } = t,
		{ borderWidth: c, borderJoinStyle: h } = l,
		d = Math.min(c / a, q(s - e));
...
function Yl(i, t, e) {
	...
	(i.beginPath(),
		i.arc(o, a, r, s - c, e + c),
		l > n ? ((c = n / l), i.arc(o, a, l, e + c, s - c, !0)) : i.arc(o, a, n, e + j, s - j),
		i.closePath(),
		i.clip());
}
function Xl(i) {
	return Yi(i, ['outerStart', 'outerEnd', 'innerStart', 'innerEnd']);
}
function Ul(i, t, e, s) {
...
function Qe(i, t, e, s, n, o) {
	...
	const p = Math.max(0.001, g * d - e / R) / d,
		...
		b = l + m + f,
		x = n - m - f,
		{ outerStart: v, outerEnd: y, innerStart: _, innerEnd: k } = Ul(t, u, d, x - b),
		S = d - v,
		w = d - y,
		P = b + v / S,
		O = x - y / w,
	...
	if ((i.beginPath(), o)) {
		const F = (P + O) / 2;
		if ((i.arc(a, r, d, P, F), i.arc(a, r, d, F, O), y > 0)) {
			const U = $t(w, O, a, r);
...
function ql(i, t, e, s, n) {
	...
	(g && Yl(i, t, p),
		l.selfJoin && p - a >= R && f === 0 && h !== 'miter' && $l(i, t, p),
		o || (Qe(i, t, e, s, p, n), i.stroke()));
}
class oe extends at {
	constructor(e) {
		super();
	...
	inRange(e, s, n) {
		const o = this.getProps(['x', 'y'], n),
			{ angle: a, distance: r } = On(o, { x: e, y: s }),
			{
				startAngle: l,
				endAngle: c,
				innerRadius: h,
...
(M(oe, 'id', 'arc'),
	...
	M(oe, 'defaultRoutes', { backgroundColor: 'backgroundColor' }),
	M(oe, 'descriptors', { _scriptable: !0, _indexable: (e) => e !== 'borderDash' }));
function lo(i, t, e = t) {
...
function Jl(i, t, e, s) {
	const { points: n, options: o } = t,
		{ count: a, start: r, loop: l, ilen: c } = co(n, e, s),
		h = Zl(o);
...
function Ql(i, t, e, s) {
	const n = t.points,
		{ count: o, start: a, ilen: r } = co(n, e, s),
...
function tc(i) {
	return i.stepped ? Ja : i.tension || i.cubicInterpolationMode === 'monotone' ? Qa : Et;
}
function ec(i, t, e, s) {
	let n = t._path;
...
class vt extends at {
	...
	interpolate(t, e) {
		const s = this.options,
			n = t[e],
			o = this.points,
			a = Kn(this, { property: e, start: n, end: n });
		if (!a.length) return;
		const r = [],
			l = tc(s);
		let c, h;
	...
	draw(t, e, s, n) {
		...
		((this.points || []).length && o.borderWidth && (t.save(), nc(t, this, s, n), t.restore()),
...
(M(vt, 'id', 'line'),
	...
	M(vt, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }),
	M(vt, 'descriptors', { _scriptable: !0, _indexable: (t) => t !== 'borderDash' && t !== 'fill' }));
function qs(i, t, e, s) {
	const n = i.options,
		{ [e]: o } = i.getProps([e], s);
...
(M(Xe, 'id', 'bar'),
	...
	M(Xe, 'defaultRoutes', { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }));
...
const Ai = [
	...
	Gs = Ai.map((i) => i.replace('rgb(', 'rgba(').replace(')', ', 0.5)'));
function uo(i) {
...
function gc(i) {
	...
	return (e, s) => {
		...
		n instanceof Ft ? (t = uc(e, t)) : n instanceof ue ? (t = fc(e, t)) : n && (t = dc(e, t));
	};
}
function Zs(i) {
	let t;
...
function xc(i, t, e, s, n) {
	...
	for (a[l++] = i[h], d = 0; d < o - 2; d++) {
		...
		const k = Math.floor(d * r) + 1 + t,
			S = Math.min(Math.floor((d + 1) * r) + 1, e) + t,
			{ x: w, y: P } = i[h];
		for (f = g = -1, x = k; x < S; x++)
			((g = 0.5 * Math.abs((w - m) * (i[x].y - P) - (w - i[x].x) * (b - P))),
				g > f && ((f = g), (u = i[x]), (p = x)));
		((a[l++] = u), (h = p));
	}
	return ((a[l++] = i[c]), a);
...
function yc(i, t) {
	...
	return (
		l && (s = Y(pt(t, o.axis, a).lo, 0, e - 1)),
		c ? (n = Y(pt(t, o.axis, r).hi + 1, s, e) - s) : (n = e - s),
		{ start: s, count: n }
	);
}
var vc = {
	...
	beforeElementsUpdate: (i, t, e) => {
		...
		i.data.datasets.forEach((n, o) => {
			const { _data: a, indexAxis: r } = n,
				...
				c = a || n.data;
			if (se([r, i.options.indexAxis]) === 'y' || !l.controller.supportsDecimation) return;
			const h = i.scales[l.xAxisID];
			if ((h.type !== 'linear' && h.type !== 'time') || i.options.parsing) return;
			let { start: d, count: u } = yc(l, c);
		...
		for (const u of d) {
			...
			for (const p of g)
				a.push({
					source: p,
					target: u,
					start: { [e]: Qs(h, f, 'start', Math.max) },
					end: { [e]: Qs(h, f, 'end', Math.min) }
				});
		}
	}
	return a;
...
function Ci(i, t, e, s) {
	...
	let n = t[i],
		o = e[i];
	return (i === 'angle' && ((n = q(n)), (o = q(o))), { property: i, start: n, end: o });
}
function kc(i, t) {
...
function po(i, t) {
	let e = [],
		s = !1;
	return (
		V(i) ? ((s = !0), (e = i)) : (e = kc(i, t)),
		e.length ? new vt({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null
	);
}
function tn(i) {
	return i && i.fill !== !1;
...
function Cc(i) {
	const { scale: t, index: e, line: s } = i,
		...
		a = s.points,
		r = Tc(t, e);
	r.push(po({ x: null, y: t.bottom }, s));
	for (let l = 0; l < o.length; l++) {
		const c = o[l];
		for (let h = c.start; h <= c.end; h++) Lc(n, a[h], r);
	}
...
function Lc(i, t, e) {
	...
	for (let n = 0; n < e.length; n++) {
		const o = e[n],
			{ first: a, last: r, point: l } = Rc(o, t, 'x');
		if (!(!l || (a && r))) {
			if (a) s.unshift(l);
...
class mo {
	...
	pathSegment(t, e, s) {
		...
		return ((e = e || { start: 0, end: z }), t.arc(n, o, a, e.end, e.start, !0), !s.bounds);
	}
	interpolate(t) {
...
function Ec(i) {
	...
	if (N(e)) return Fc(t, e);
	if (e === 'stack') return Cc(i);
	if (e === 'shape') return !0;
	const n = Ic(i);
	return n instanceof mo ? n : po(n, s);
}
function Fc(i, t) {
...
function Ic(i) {
	return (i.scale || {}).getPointPositionForValue ? Bc(i) : zc(i);
}
function zc(i) {
...
function Bc(i) {
	...
	if (s.grid.circular) {
		...
		return new mo({ x: l.x, y: l.y, radius: t.getDistanceFromCenterForValue(a) });
	}
...
function _i(i, t, e) {
	...
	s &&
		a.points.length &&
		(ii(i, e),
		Vc(i, { line: a, target: s, above: u, below: f, area: e, scale: r, axis: l, clip: p }),
		si(i));
}
function Vc(i, t) {
	const { line: e, target: s, above: n, below: o, area: a, scale: r, clip: l } = t,
	...
	(o !== n &&
		(c === 'x'
			? (en(i, s, a.top),
				yi(i, { line: e, target: s, color: n, scale: r, property: c, clip: l }),
				i.restore(),
				i.save(),
				en(i, s, a.bottom))
			: c === 'y' &&
				(sn(i, s, a.left),
				yi(i, { line: e, target: s, color: o, scale: r, property: c, clip: l }),
				i.restore(),
				i.save(),
				sn(i, s, a.right),
				(h = n))),
		yi(i, { line: e, target: s, color: h, scale: r, property: c, clip: l }),
		i.restore());
}
function en(i, t, e) {
...
function yi(i, t) {
	...
	for (const { source: c, target: h, start: d, end: u } of l) {
		const { style: { backgroundColor: f = o } = {} } = c,
			g = s !== !0;
		(i.save(), (i.fillStyle = f), Wc(i, a, r, g && Ci(n, d, u)), i.beginPath());
		const p = !!e.pathSegment(i, c);
		let m;
		if (g) {
			p ? i.closePath() : nn(i, s, u, n);
...
var Nc = {
	...
	afterDatasetsUpdate(i, t, e) {
		...
		for (a = 0; a < s; ++a)
			((o = i.getDatasetMeta(a)),
				...
				n.push(l));
		for (a = 0; a < s; ++a)
			((l = n[a]), !(!l || l.fill === !1) && (l.fill = Sc(n, a, e.propagate)));
	},
	beforeDraw(i, t, e) {
		...
		for (let a = n.length - 1; a >= 0; --a) {
			const r = n[a].$filler;
			r && (r.line.updateControlPoints(o, r.axis), s && r.fill && _i(i.ctx, r, o));
		}
	},
	beforeDatasetsDraw(i, t, e) {
		...
		for (let n = s.length - 1; n >= 0; --n) {
			const o = s[n].$filler;
			tn(o) && _i(i.ctx, o, i.chartArea);
		}
	},
	beforeDatasetDraw(i, t, e) {
		const s = t.meta.$filler;
		!tn(s) || e.drawTime !== 'beforeDatasetDraw' || _i(i.ctx, s, i.chartArea);
	},
...
class an extends at {
	...
	fit() {
		...
		const s = t.labels,
			...
			{ boxWidth: r, itemHeight: l } = on(s, o);
		let c, h;
		((e.font = n.string),
			this.isHorizontal()
	...
	_fitCols(t, e, s, n) {
		...
		return (
			this.legendItems.forEach((m, b) => {
				const { itemWidth: x, itemHeight: v } = jc(s, e, o, m, n);
				(b > 0 &&
					f + v + 2 * r > h &&
	...
	_draw() {
		const { options: t, columnSizes: e, lineWidths: s, ctx: n } = this,
			{ align: o, labels: a } = t,
			r = W.color,
			l = Yt(t.rtl, this.left, this.width),
			c = $(a.font),
			{ padding: h } = a,
			d = c.size,
			u = d / 2;
		...
		(this.drawTitle(),
			...
			(n.lineWidth = 0.5),
			(n.font = c.string));
		const { boxWidth: g, boxHeight: p, itemHeight: m } = on(a, d),
			b = function (k, S, w) {
				if (isNaN(g) || g <= 0 || isNaN(p) || p < 0) return;
				n.save();
				const P = D(w.lineWidth, 1);
				if (
					((n.fillStyle = D(w.fillStyle, r)),
					(n.lineCap = D(w.lineCap, 'butt')),
					(n.lineDashOffset = D(w.lineDashOffset, 0)),
					(n.lineJoin = D(w.lineJoin, 'miter')),
					(n.lineWidth = P),
					(n.strokeStyle = D(w.strokeStyle, r)),
					n.setLineDash(D(w.lineDash, [])),
					a.usePointStyle)
				) {
					const O = {
						...
						A = l.xPlus(k, g / 2),
						L = S + u;
					In(n, O, A, L, a.pointStyleWidth && g);
				} else {
					const O = S + Math.max((d - p) / 2, 0),
						A = l.leftForLtr(k, g),
						L = It(w.borderRadius);
					(n.beginPath(),
						Object.values(L).some((X) => X !== 0)
							? be(n, { x: A, y: O, w: g, h: p, radius: L })
							: n.rect(A, O, g, p),
						n.fill(),
						P !== 0 && n.stroke());
				}
		...
		(this.legendItems.forEach((k, S) => {
			...
			const X = l.x(A);
			if ((b(X, L, k), (A = la(P, A + g + u, v ? A + O : this.right, t.rtl)), x(l.x(A), L, k), v))
				f.x += O + h;
	...
	drawTitle() {
		const t = this.options,
			...
			n = Z(e.padding);
		if (!e.display) return;
		const o = Yt(t.rtl, this.left, this.width),
			a = this.ctx,
			r = e.position,
			l = s.size / 2,
			c = n.top + l;
...
var Uc = {
	...
	_element: an,
	start(i, t, e) {
		const s = (i.legend = new an({ ctx: i.ctx, options: e, chart: i }));
...
function Kc(i, t) {
	const e = new Ji({ ctx: i.ctx, options: t, chart: i });
...
var Gc = {
	id: 'subtitle',
	start(i, t, e) {
		const s = new Ji({ ctx: i.ctx, options: e, chart: i });
		(G.configure(i, s, e), G.addBox(i, s), Fe.set(i, s));
	},
	stop(i) {
		(G.removeBox(i, Fe.get(i)), Fe.delete(i));
	},
	beforeUpdate(i, t, e) {
		const s = Fe.get(i);
		(G.configure(i, s, e), (s.options = e));
...
function ln(i, t, e) {
	...
	return { xAlign: e.xAlign || t.xAlign || th(i, t, e, s), yAlign: s };
}
function eh(i, t) {
	let { x: e, width: s } = i;
...
function cn(i, t, e, s) {
	const { caretSize: n, caretPadding: o, cornerRadius: a } = i,
		{ xAlign: r, yAlign: l } = e,
		c = n + o,
		{ topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = It(a);
	let g = eh(t, r);
	const p = ih(t, l, c);
	return (
		l === 'center'
...
function J(i, t, e, s) {
	...
	return typeof n > 'u' ? xo[t].call(e, s) : n;
}
class Ti extends at {
	constructor(t) {
		(super(),
	...
	getBeforeBody(t, e) {
		return hn(J(e.callbacks, 'beforeBody', this, t));
	}
	getBody(t, e) {
		const { callbacks: s } = e,
			n = [];
		return (
			E(t, (o) => {
				const a = { before: [], lines: [], after: [] },
					r = dn(s, o);
				(rt(a.before, ut(J(r, 'beforeLabel', this, o))),
					rt(a.lines, J(r, 'label', this, o)),
					rt(a.after, ut(J(r, 'afterLabel', this, o))),
					n.push(a));
			}),
			n
		);
	...
	getAfterBody(t, e) {
		return hn(J(e.callbacks, 'afterBody', this, t));
	}
	getFooter(t, e) {
		const { callbacks: s } = e,
	...
	update(t, e) {
		...
		if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
			...
			const l = (this._size = rn(this, s)),
				c = Object.assign({}, r, l),
				h = ln(this.chart, s, c),
				d = cn(s, c, h, this.chart);
	...
	getCaretPosition(t, e, s) {
		const { xAlign: n, yAlign: o } = this,
			...
			{ topLeft: l, topRight: c, bottomLeft: h, bottomRight: d } = It(r),
			{ x: u, y: f } = t,
			{ width: g, height: p } = e;
		let m, b, x, v, y, _;
		return (
	...
	_drawColorBox(t, e, s, n, o) {
		...
		if (o.usePointStyle) {
			...
			Object.values(b).some((x) => x !== 0)
				? (t.beginPath(),
					(t.fillStyle = o.multiKeyBackground),
					be(t, { x: p, y: g, w: c, h: l, radius: b }),
					t.fill(),
					t.stroke(),
					(t.fillStyle = a.backgroundColor),
					t.beginPath(),
					be(t, { x: m, y: g + 1, w: c - 2, h: l - 2, radius: b }),
					t.fill())
				: ((t.fillStyle = o.multiKeyBackground),
					t.fillRect(p, g, c, l),
	...
	drawBody(t, e, s) {
		...
		let u = d.lineHeight,
			f = 0;
		const g = Yt(s.rtl, this.x, this.width),
			p = function (w) {
	...
	drawBackground(t, e, s, n) {
		const { xAlign: o, yAlign: a } = this,
			{ x: r, y: l } = t,
			{ width: c, height: h } = s,
			{ topLeft: d, topRight: u, bottomLeft: f, bottomRight: g } = It(n.cornerRadius);
		((e.fillStyle = n.backgroundColor),
			(e.strokeStyle = n.borderColor),
			(e.lineWidth = n.borderWidth),
			e.beginPath(),
...
class Li extends Wt {
	...
	parse(t, e) {
		...
		const s = this.getLabels();
		return (
			(e = isFinite(e) && s[e] === t ? e : rh(s, t, D(e, t), this._addedLabels)),
			lh(e, s.length - 1)
		);
	}
	determineDataLimits() {
...
(M(Li, 'id', 'category'), M(Li, 'defaults', { ticks: { callback: un } }));
function ch(i, t) {
	const e = [],
		{
			bounds: n,
	...
	((P = Math.ceil(m / _) - Math.floor(p / _)),
		...
		n === 'ticks' ? ((S = Math.floor(p / _) * _), (w = Math.ceil(m / _) * _)) : ((S = p), (w = m)),
		b && x && o && ea((r - a) / o, _ / 1e3)
			? ((P = Math.round(Math.min((r - a) / _, h))), (_ = (r - a) / P), (S = a), (w = r))
			: v
				? ((S = b ? a : S), (w = x ? r : w), (P = c - 1), (_ = (w - S) / P))
				: ((P = (w - S) / _),
					ce(P, Math.round(P), _ / 1e3) ? (P = Math.round(P)) : (P = Math.ceil(P))));
	const O = Math.max(rs(_), rs(S));
	((k = Math.pow(10, C(l) ? O : l)), (S = Math.round(S * k) / k), (w = Math.round(w * k) / k));
	let A = 0;
	for (
		b &&
		(u && S !== a
			? (e.push({ value: a }),
				S < a && A++,
				ce(Math.round((S + A * _) * k) / k, a, fn(a, y, i)) && A++)
			: S < a && A++);
		A < P;
		++A
	) {
		const L = Math.round((S + A * _) * k) / k;
		if (x && L > r) break;
		e.push({ value: L });
	}
	return (
		x && u && w !== r
			? e.length && ce(e[e.length - 1].value, r, fn(r, y, i))
				? (e[e.length - 1].value = r)
				: e.push({ value: r })
			: (!x || w === r) && e.push({ value: w }),
		e
	);
}
...
class ti extends Wt {
	...
	buildTicks() {
		...
		const n = {
			...
			a = ch(n, o);
		return (
			t.bounds === 'ticks' && Dn(a, this, 'value'),
			t.reverse
	...
	getLabelForValue(t) {
		return Me(t, this.chart.options.locale, this.options.ticks.format);
	}
}
class Ri extends ti {
	determineDataLimits() {
...
(M(Ri, 'id', 'linear'), M(Ri, 'defaults', { ticks: { callback: ei.formatters.numeric } }));
const _e = (i) => Math.floor(_t(i)),
	Lt = (i, t) => Math.pow(10, _e(i) + t);
function gn(i) {
...
function dh(i, { min: t, max: e }) {
	...
	let d = Math.floor((c - h) / Math.pow(10, o)),
		u = et(i.min, Math.round((l + h + d * Math.pow(10, o)) * a) / a);
	for (; u < e; )
		(s.push({ value: u, major: gn(u), significand: d }),
			d >= 10 ? (d = d < 15 ? 15 : 20) : d++,
			d >= 20 && (o++, (d = 2), (a = o >= 0 ? 1 : a)),
			(u = Math.round((l + h + d * Math.pow(10, o)) * a) / a));
	const f = et(i.max, u);
	return (s.push({ value: f, major: gn(f), significand: d }), s);
}
class Ei extends Wt {
	constructor(t) {
		(super(t),
	...
	determineDataLimits() {
		...
		((this.min = N(t) ? Math.max(0, t) : null),
			...
			this._zero &&
				...
				!N(this._userMin) &&
				(this.min = t === Lt(this.min, 0) ? Lt(this.min, -1) : Lt(this.min, 0)),
	...
	getLabelForValue(t) {
		return t === void 0 ? '0' : Me(t, this.chart.options.locale, this.options.ticks.format);
	}
	configure() {
		const t = this.min;
...
(M(Ei, 'id', 'logarithmic'),
	M(Ei, 'defaults', { ticks: { callback: ei.formatters.logarithmic, major: { enabled: !0 } } }));
function Fi(i) {
	const t = i.ticks;
...
function uh(i, t, e) {
	return ((e = V(e) ? e : [e]), { w: xa(i, t.string, e), h: e.length * t.lineHeight });
}
...
function fh(i) {
	...
	for (let l = 0; l < o; l++) {
		...
		const h = i.getPointPosition(l, i.drawingArea + n[l], r),
			d = $(c.font),
			u = uh(i.ctx, d, i._pointLabels[l]);
		s[l] = u;
		const f = q(i.getIndexAngle(l) + r),
			g = Math.round(Ni(f)),
			p = mn(g, h.x, u.w, 0, 180),
			m = mn(g, h.y, u.h, 90, 270);
		gh(e, t, f, p, m);
	}
	(i.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b),
		(i._pointLabelItems = bh(i, s, n)));
}
...
function bh(i, t, e) {
	const s = [],
		...
		l = { extra: Fi(o) / 2, additionalAngle: a ? R / n : 0 };
	let c;
	for (let h = 0; h < n; h++) {
...
function vh(i, t, e) {
	...
	if (!C(r)) {
		...
		Object.values(l).some((g) => g !== 0)
			? (i.beginPath(), be(i, { x: h, y: d, w: u, h: f, radius: l }), i.fill())
			: i.fillRect(h, d, u, f);
	}
}
function Mh(i, t) {
...
class re extends ti {
	...
	setDimensions() {
		const t = (this._padding = Z(Fi(this.options) / 2)),
	...
	fit() {
		const t = this.options;
		t.display && t.pointLabels.display ? fh(this) : this.setCenterPoint(0, 0, 0, 0);
	}
	...
	drawGrid() {
		...
		let r, l, c;
		if (
			(e.pointLabels.display && Mh(this, a),
			n.display &&
...
(M(re, 'id', 'radialLinear'),
	...
	M(re, 'descriptors', { angleLines: { _fallback: 'grid' } }));
const ai = {
...
function xn(i, t) {
	...
	return (
		...
		a === null
			? null
			: (n &&
					(a = n === 'week' && (Xt(o) || o === !0) ? e.startOf(a, 'isoWeek', o) : e.startOf(a, n)),
				+a)
	);
}
function _n(i, t, e, s) {
...
function wh(i, t, e, s, n) {
	for (let o = Q.length - 1; o >= Q.indexOf(e); o--) {
		const a = Q[o];
		if (ai[a].common && i._adapter.diff(n, s, a) >= t - 1) return a;
	}
	return Q[e ? Q.indexOf(e) : 0];
}
function Ph(i) {
	for (let t = Q.indexOf(i) + 1, e = Q.length; t < e; ++t) if (ai[Q[t]].common) return Q[t];
}
function yn(i, t, e) {
	if (!e) i[t] = !0;
	else if (e.length) {
...
class ye extends Wt {
	...
	parse(t, e) {
		return t === void 0 ? null : xn(this, t);
	}
	beforeLayout() {
	...
	buildTicks() {
		...
		return (
			(this._unit =
				e.unit ||
				(s.autoSkip
					? _n(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
					: wh(this, r.length, e.minUnit, this.min, this.max))),
			(this._majorUnit = !s.major.enabled || this._unit === 'year' ? void 0 : Ph(this._unit)),
			this.initOffsets(n),
			t.reverse && r.reverse(),
			vn(this, r, this._majorUnit)
		);
	}
	afterAutoSkip() {
	...
	_generate() {
		const t = this._adapter,
			...
			n = this.options,
			o = n.time,
			a = o.unit || _n(o.minUnit, e, s, this._getLabelCapacity(e)),
		...
		for (u = d, f = 0; u < s; u = +t.add(u, r, a), f++) yn(h, u, g);
		return (
			(u === s || n.bounds === 'ticks' || f === 1) && yn(h, u, g),
			Object.keys(h)
				.sort(bn)
				.map((p) => +p)
		);
	...
	getLabelTimestamps() {
		...
		for (e = 0, s = n.length; e < s; ++e) t.push(xn(this, n[e]));
...
function ze(i, t, e) {
	...
	e
		? (t >= i[s].pos && t <= i[n].pos && ({ lo: s, hi: n } = pt(i, 'pos', t)),
			({ pos: o, time: r } = i[s]),
			({ pos: a, time: l } = i[n]))
		: (t >= i[s].time && t <= i[n].time && ({ lo: s, hi: n } = pt(i, 'time', t)),
			({ time: o, pos: r } = i[s]),
			({ time: a, pos: l } = i[n]));
	const c = a - o;
...
(M(Ii, 'id', 'timeseries'), M(Ii, 'defaults', ye.defaults));
...
export {
	...
	eo as BasePlatform,
	Kr as BasicPlatform,
	Ve as BubbleController,
	Li as CategoryScale,
	bt as Chart,
	bc as Colors,
	ot as DatasetController,
	vc as Decimation,
	al as DomPlatform,
	...
	Wr as Interaction,
	Uc as Legend,
	We as LineController,
	vt as LineElement,
	Ri as LinearScale,
	Ei as LogarithmicScale,
	wi as PieController,
	Ye as PointElement,
	ue as PolarAreaController,
	Ne as RadarController,
	...
	ei as Ticks,
	ye as TimeScale,
	Ii as TimeSeriesScale,
	qc as Title,
	nh as Tooltip,
	Fr as _adapters,
	rl as _detectPlatform,
	dt as animator,
	Er as controllers,
	bt as default,
	W as defaults,
...
//# sourceMappingURL=DrVXMMBu.js.map
