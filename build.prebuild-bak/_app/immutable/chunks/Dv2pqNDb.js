const e = 'Barada',
	...
	Fr = {
		...
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Çatlar we web gözleg soraglary üçin başlyk döretmek ýaly wezipeleri ýerine ýetirýän wagty ulanylýar',
		'a user': 'ulanyjy',
		About: e,
		...
		'Add a short description about what this model does':
			'Bu modeliň näme edýändigi barada gysgaça düşündiriş goşuň',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Bu sazlamalary düzetmek ähli ulanyjylara birmeňzeş üýtgeşmeler girizer.',
		admin: c,
		Admin: d,
		'Admin Contact Email': '',
		...
		"Click on the user role button to change a user's role.":
			'Ulanyjynyň roluny üýtgetmek üçin ulanyjy roly düwmesine basyň.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		...
		"don't fetch random pipelines from sources you don't trust.":
			'Ynamdar bolmadyk çeşmelerden tötänleýin pipelines almaň.',
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines — islendik kody işletmäge mümkinçilik berýän plagin ulgamy —',
...
//# sourceMappingURL=Dv2pqNDb.js.map
