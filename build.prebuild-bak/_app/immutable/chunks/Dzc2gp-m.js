...
var I = v ? v.prototype : void 0,
	D = I ? I.valueOf : void 0;
function ve(t) {
	return D ? Object(D.call(t)) : {};
}
var Se = '[object Boolean]',
	$e = '[object Date]',
	Ie = '[object Map]',
	De = '[object Number]',
	Me = '[object RegExp]',
...
class z {
	...
	neighbors(e) {
		...
		if (r) return vt(r, this.successors(e));
	}
	isLeaf(e) {
		var r;
	...
	edge(e, r, s) {
		var n =
			arguments.length === 1 ? E(this._isDirected, arguments[0]) : p(this._isDirected, e, r, s);
...
export { z as G, O as b, b as i, A as v };
//# sourceMappingURL=Dzc2gp-m.js.map
