...
import { g as Ne } from './CjlqM2S6.js';
var $ = (function () {
			...
			parse: c(function (s) {
				...
				function ae() {
					...
					return (
						(S = o.pop() || m.lex() || re),
						typeof S != 'number' &&
							(S instanceof Array && ((o = S), (S = o.pop())), (S = n.symbols_[S] || S)),
						S
					);
				}
				c(ae, 'lex');
				for (var E, R, v, Q, G = {}, X, I, oe, Y; ; ) {
					if (
						((R = a[a.length - 1]),
						...
						var Z = '';
						Y = [];
						for (X in B[R]) this.terminals_[X] && X > ue && Y.push("'" + this.terminals_[X] + "'");
						(m.showPosition
							? (Z =
									'Parse error on line ' +
									(z + 1) +
...
Expecting ` +
					...
					if (v[0] instanceof Array && v.length > 1)
						throw new Error(
							'Parse Error: multiple actions possible at state: ' + R + ', token: ' + E
						);
					switch (v[0]) {
						case 1:
							(a.push(E),
						...
						case 2:
							if (
								...
								return Q;
							(I &&
								((a = a.slice(0, -1 * I * 2)), (u = u.slice(0, -1 * I)), (e = e.slice(0, -1 * I))),
...
` +
				...
				next: c(function () {
					...
					for (var u = this._currentRules(), e = 0; e < u.length; e++)
						if (
							((a = this._input.match(this.rules[u[e]])), a && (!n || a[0].length > n[0].length))
						) {
...
var xe = $,
	...
	Oe = c((t, g, d, r, p) => {
		var C, w;
		const k = W();
		let f = ((C = k.mindmap) == null ? void 0 : C.padding) ?? K.mindmap.padding;
		switch (r) {
			case b.ROUNDED_RECT:
			case b.RECT:
			case b.HEXAGON:
		...
		const h = {
			...
			level: t,
			label: F(d, k),
			width: ((w = k.mindmap) == null ? void 0 : w.maxNodeWidth) ?? K.mindmap.maxNodeWidth,
			padding: f,
			isGroup: !1
		};
		if (p !== void 0) {
...
` + t
		...
		for (const y of w) {
			...
			((x = Math.max(x, (j = _ == null ? void 0 : _.labelBBox) == null ? void 0 : j.height)),
				M.push(_));
		}
		let P = 0;
		for (const y of w) {
...
`,
	...
	Ue = Me,
	We = { db: Ve, renderer: Ge, parser: xe, styles: Ue };
export { We as diagram };
//# sourceMappingURL=E4pnMYE-.js.map
