import './CWj6FrbW.js';
import './69_IOA4Y.js';
import { t as n, a as i, F as p } from './CD8kWLvT.js';
import { a as d, s as l, c as h } from './BfA5TzUS.js';
...
function g(r, o) {
	let a = e(o, 'className', 8, 'size-4'),
		s = e(o, 'strokeWidth', 8, '1.5');
	var t = u();
	(n(() => {
		(d(t, 'stroke-width', s()), l(t, 0, h(a())));
	}),
		i(r, t));
}
export { g as D };
//# sourceMappingURL=FsbvYLPp.js.map
