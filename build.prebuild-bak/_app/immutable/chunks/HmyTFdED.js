...
var R1 = /([A-Z])/g,
	zt = (r) => r.replace(R1, '-$1').toLowerCase(),
	I1 = { '&': '&amp;', '>': '&gt;', '<': '&lt;', '"': '&quot;', "'": '&#x27;' },
	N1 = /[&><"']/g,
...
var At = 0,
	...
	L1 = [oe, v0, oe, v0, _0, s0, _0, s0],
	P1 = [v0, v0, v0, v0, s0, s0, s0, s0],
	G1 = [Q0, T0, oe, v0, _0, s0, _0, s0],
	U1 = [T0, T0, v0, v0, s0, s0, s0, s0],
	V1 = [De, De, T0, T0, v0, v0, s0, s0],
	X1 = [At, De, Q0, T0, Q0, T0, Q0, T0],
	N = { DISPLAY: x0[At], TEXT: x0[Q0], SCRIPT: x0[oe], SCRIPTSCRIPT: x0[_0] },
	mt = [
		{
			name: 'latin',
			blocks: [
...
var Be = [];
mt.forEach((r) => r.blocks.forEach((e) => Be.push(...e)));
function Dr(r) {
...
var ct = {
	...
	ra = { ex: !0, em: !0, mu: !0 },
	Cr = function (e) {
		return (typeof e != 'string' && (e = e.unit), e in ct || e in ra || e === 'ex');
	},
	K = function (e, t) {
		var a;
	...
	Rr = function (e) {
		...
		var a = '';
		for (var n of Object.keys(this.style)) a += zt(n) + ':' + this.style[n] + ';';
		a && (t += ' style="' + a0(a) + '"');
		for (var l of Object.keys(this.attributes)) {
			if (aa.test(l)) throw new k("Invalid attribute name '" + l + "'");
...
class na {
	...
	toMarkup() {
		var e = '<img src="' + a0(this.src) + '"' + (' alt="' + a0(this.alt) + '"'),
			t = '';
		for (var a of Object.keys(this.style)) t += zt(a) + ':' + this.style[a] + ';';
...
function ha(r) {
	...
	if ((r >= 5 ? (e = 0) : r >= 3 ? (e = 1) : (e = 2), !je[e])) {
		var t = (je[e] = { cssEmPerMu: be.quad[e] / 18 });
		for (var a in be) be.hasOwnProperty(a) && (t[a] = be[a][e]);
	}
	return je[e];
}
...
var we = [
	...
	l0 = function (e, t, a, n, l) {
		...
		if (h) {
			...
			((a === 'text' || (n && n.font === 'mathit')) && (p = 0),
				(c = new d0(e, h.height, h.depth, p, h.skew, h.width, l)));
		} else
			(typeof console < 'u' &&
				console.warn(
	...
	Oe = function (e, t, a) {
		var n = e.mode,
			...
			p = '',
			g = '';
		if ((l.charCodeAt(0) === 55349 && ([p, g] = da(l, n)), p.length > 0))
		...
		if (c) {
			...
			if (He(l, b, n).metrics) return l0(l, b, n, t, u.concat(y));
			if (Ir.hasOwnProperty(l) && b.slice(0, 10) === 'Typewriter') {
	...
	te = function (e, t) {
		return e instanceof re ? S([], [e], t) : e;
	},
	ga = function (e) {
	...
	G = function (e, t) {
		...
		if (b < 0) {
			var L = S([], []),
				P = S(['vlist'], [L]);
			P.style.height = M(-b);
			var W = S(['vlist-s'], [new d0('​')]);
			V = [S(['vlist-r'], [F, W]), S(['vlist-r'], [P])];
		} else V = [S(['vlist-r'], [F])];
		var X = S(['vlist-t'], V);
...
var Re = function (e) {
	...
	r0 = function (e, t, a, n) {
		...
		if (e.length === 1) {
			...
			g.type === 'sizing'
				...
				: g.type === 'styling' && (p = t.havingStyle(Sa[g.style]));
		}
		var b = S([n[0] || 'leftmost'], [], t),
			y = S([n[1] || 'rightmost'], [], t),
			x = a === 'root';
		return (
			vt(
	...
	vt = function (e, t, a, n, l) {
		n && e.push(n);
		for (var u = 0; u < e.length; u++) {
			var h = e[u],
				c = Pr(h);
			if (c) {
				vt(c.children, t, a, null, l);
				continue;
			}
			...
			(p ? (a.node = h) : l && h.hasClass('newline') && (a.node = S(['leftmost'])),
				(a.insertAfter = ((b) => (y) => {
					(e.splice(b + 1, 0, y), u++);
				})(u)));
		}
	...
	gt = function (e, t) {
		...
		if (a) {
			var n = a.children;
			if (n.length) {
				if (t === 'right') return gt(n[n.length - 1], 'right');
				if (t === 'left') return gt(n[0], 'left');
			}
		}
		return e;
	},
	...
	for (var l = [], u = [], h = 0; h < a.length; h++)
		if (
			...
			a[h].hasClass('newline') &&
				(u.pop(), u.length > 0 && (l.push(ke(u, e)), (u = [])), l.push(a[h]));
	u.length > 0 && l.push(ke(u, e));
	var p;
	t ? ((p = ke(r0(t, e, !0), e)), (p.classes = ['tag']), l.push(p)) : n && l.push(n);
	var g = S(['katex-html'], l);
...
var za = new Set(['\\imath', '\\jmath']),
	...
	qt = function (e, t) {
		...
		var h = pt[a].fontName;
		return Tt(l, h, n) ? pt[a].variant : null;
	};
function _e(r) {
	if (!r) return !1;
		...
		for (var l = [], u, h = 0; h < e.length; h++) {
			...
			if (c instanceof z && u instanceof z) {
				if (
					...
					u.children.push(...c.children);
					continue;
				} else if (_e(c) && u.type === 'mn') {
					u.children.push(...c.children);
					continue;
				} else if (c.type === 'mn' && _e(u))
					...
					p instanceof z &&
						p.type === 'mn' &&
						((p.children = [...u.children, ...p.children]), l.pop());
...
var Vr = function (e) {
	...
	Le = function (e, t) {
		function a() {
			...
			if (qa.has(c)) {
				...
				return { span: S(['stretchy'], q, t), minWidth: F, height: L };
			}
		}
	...
	Ea = function (e, t, a, n, l) {
		...
		if (/fbox|color|angl/.test(t)) {
			...
			var p = [];
			(/^[bx]cancel$/.test(t) &&
				p.push(new dt({ x1: '0', y1: '0', x2: '100%', y2: '100%', 'stroke-width': '0.046em' })),
				/^x?cancel$/.test(t) &&
					p.push(new dt({ x1: '0', y1: '100%', x2: '100%', y2: '0', 'stroke-width': '0.046em' })));
...
var Yr = (r) => {
	...
	Et = (r, e) => {
		var t, a, n;
		r && r.type === 'supsub'
			? ((a = O(r.base, 'accent')), (t = a.base), (r.base = t), (n = sa(U(r, e))), (r.base = a))
		...
		if (u) {
			var c, p;
			h = (c = (p = Yr(l)) == null ? void 0 : p.skew) != null ? c : 0;
		}
		var g = a.label === '\\c',
...
B({
	...
	mathmlBuilder(r, e) {
		...
		if (r.body) {
			var n = ze(Y(r.body, e));
			if (r.below) {
				var l = ze(Y(r.below, e));
				a = new z('munderover', [t, l, n]);
			} else a = new z('mover', [t, n]);
		} else if (r.below) {
			var u = ze(Y(r.below, e));
			a = new z('munder', [t, u]);
		} else ((a = ze()), (a = new z('mover', [t, a])));
		return a;
	}
});
function $r(r, e) {
...
B({
	...
	handler(r, e) {
		var { parser: t } = r;
		return { type: 'pmb', mode: t.mode, mclass: Ue(e[0]), body: Q(e[0]) };
	},
	htmlBuilder(r, e) {
		var t = r0(r.body, e, !0),
			a = S([r.mclass], t, e);
...
var Ia = {
	...
	Na = (r, e) => (r.type === 'mathord' || r.type === 'atom') && r.text === e;
function Ha(r, e, t) {
	var a = Ia[r];
	switch (a) {
		case '\\\\cdrightarrow':
...
function Oa(r) {
	...
	for (
		...
		if (t === '&' || t === '\\\\') r.consume();
			...
			break;
		} else throw new k('Expected \\\\ or \\cr or \\end', r.nextToken);
	}
				...
				if (
					...
					if ('<>AV'.includes(p))
						for (var b = 0; b < 2; b++) {
							...
							if (y) throw new k('Missing a ' + p + ' character to complete a CD arrow.', u[c]);
						}
					else throw new k('Expected one of "<>AV=|." after @', u[c]);
				var A = Ha(p, g, r),
...
B({
	...
	handler(r, e) {
		...
		var c = parseInt(l),
			p;
		if (isNaN(c)) throw new k('\\@char has non-numeric argument ' + l);
		if (c < 0 || c >= 1114111) throw new k('\\@char with invalid code point ' + l);
		return (
			c <= 65535
...
var xt = {
	...
	Jr = (r) => {
		var e = r.text;
		if (/^(?:[\\{}$&#^_]|EOF)$/.test(e)) throw new k('Expected a control sequence', r);
		return e;
	},
	Fa = (r) => {
...
B({
	...
	handler(r) {
		...
		if (xt[a.text])
			return (
				(t === '\\global' || t === '\\\\globallong') && (a.text = xt[a.text]),
...
B({
	...
	handler(r) {
		var { parser: e, funcName: t } = r,
			a = e.gullet.popToken(),
			n = a.text;
		if (/^(?:[\\{}$&#^_]|EOF)$/.test(n)) throw new k('Expected a control sequence', a);
		for (var l = 0, u, h = [[]]; e.gullet.future().text !== '{'; )
			if (((a = e.gullet.popToken()), a.text === '#')) {
				...
				if (a.text === 'EOF') throw new k('Expected a macro definition');
				h[l].push(a.text);
			}
		...
		return (
			...
			e.gullet.macros.set(n, { tokens: c, numArgs: l, delimiters: h }, t === xt[t]),
...
var se = function (e, t, a) {
	...
	Rt = function (e, t, a, n) {
		var l = a.havingBaseStyle(t),
			u = S(n.concat(l.sizingClasses(a)), [e], a),
	...
	e1 = function (e, t, a, n, l, u) {
		var h = Pa(e, t, l, n),
			c = Rt(S(['delimsizing', 'size' + t], [h], n), N.TEXT, n, u);
		return (a && _r(c, n, N.TEXT), c);
	},
	et = function (e, t, a) {
		var n;
		t === 'Size1-Regular' ? (n = 'delim-size1') : (n = 'delim-size4');
		var l = S(['delimsizinginner', n], [S([], [l0(e, t, a)])]);
	...
	t1 = function (e, t, a, n, l, u) {
		...
		if (b.length > 0) {
			var V0 = X - T - H,
				h0 = Math.round(X * 1e3),
				b0 = ta(b, Math.round(V0 * 1e3)),
				E0 = new L0(b, b0),
				$0 = (y / 1e3).toFixed(3) + 'em',
				j0 = (h0 / 1e3).toFixed(3) + 'em',
				We = new B0([E0], { width: $0, height: j0, viewBox: '0 0 ' + y + ' ' + h0 }),
				R0 = P0([], [We], n);
			((R0.height = h0 / 1e3),
				(R0.style.width = $0),
				(R0.style.height = j0),
			...
			if ((t0.push(et(g, x, l)), t0.push(Me), c === null)) {
				var I0 = X - T - H + 2 * wt;
				t0.push(tt(p, I0, n));
			} else {
				var le = (X - T - H - F) / 2 + 2 * wt;
				(t0.push(tt(p, le, n)),
					t0.push(Me),
					t0.push(et(c, x, l)),
					t0.push(Me),
			...
			(t0.push(Me), t0.push(et(h, x, l)));
		}
		var y0 = n.havingBaseStyle(N.TEXT),
			ce = G({ positionType: 'bottom', positionData: n0, children: t0 });
		return Rt(S(['delimsizing', 'mult'], [ce], y0), N.TEXT, n, u);
	},
	rt = 80,
	at = 0.08,
	nt = function (e, t, a, n, l) {
		var u = _1(e, n, a),
			h = new L0(e, u),
			c = new B0([h], {
				width: '400em',
			...
			n.type === 'small'
				...
				: n.type === 'large'
					? ((g = (1e3 + rt) * ue[n.size]),
						(p = (ue[n.size] + u) / l),
						(c = (ue[n.size] + u + at) / l),
						(h = nt('sqrtSize' + n.size, c, g, u, t)),
						(h.style.minWidth = '1.02em'),
						(b = 1 / l))
					: ((c = e + u + at),
						(p = e + u),
						(g = Math.floor(1e3 * e + u) + rt),
						(h = nt('sqrtTall', c, g, u, t)),
...
function Ve(r, e) {
	...
	throw t
		? new k("Invalid delimiter '" + t.text + "' after '" + e.funcName + "'", r)
		: new k("Invalid delimiter type '" + r.type + "'", r);
}
B({
	type: 'delimsizing',
	names: [
	...
	htmlBuilder: (r, e) =>
		r.delim === '.' ? S([r.mclass]) : n1(r.delim, r.size, e, r.mode, [r.mclass]),
	mathmlBuilder: (r) => {
		var e = [];
...
B({
	...
	handler: (r, e) => {
		...
		if (t && typeof t != 'string') throw new k('\\current@color set to non-string in \\right');
		return { type: 'leftright-right', mode: r.parser.mode, delim: Ve(e[0], r).text, color: t };
	}
});
B({
	type: 'leftright',
	...
	htmlBuilder: (r, e) => {
		...
		var h;
		if (
			(r.left === '.' ? (h = he(e, ['mopen'])) : (h = it(r.left, a, n, e, r.mode, ['mopen'])),
			t.unshift(h),
			l)
		)
			for (var c = 1; c < t.length; c++) {
				var p = t[c],
					g = p.isMiddle;
				g && (t[c] = it(g.delim, a, n, g.options, r.mode, []));
			}
		var b;
		if (r.right === '.') b = he(e, ['mclose']);
		else {
			var y = r.rightColor ? e.withColor(r.rightColor) : e;
			b = it(r.right, a, n, y, r.mode, ['mclose']);
		}
...
B({
	...
	handler: (r, e) => {
		var t = Ve(e[0], r);
		if (!r.parser.leftrightDepth) throw new k('\\middle without preceding \\left', t);
...
var It = (r, e) => {
		...
		if (a === 'sout')
			...
			((l = P0(['hide-tail'], [A], e)), (l.style.height = M(b)), (u = t.depth + c + p));
		} else {
			/cancel/.test(a)
		...
		return (
			...
			/cancel/.test(a) && !h ? S(['mord', 'cancel-lap'], [I], e) : S(['mord'], [I], e)
		);
	},
	Nt = (r, e) => {
		var t = 0,
...
var Xe = (r) => {
		...
		if (!e.displayMode) throw new k('{' + r.envName + '} can be used only in display mode.');
	},
...
function U0(r, e, t) {
	...
	if ((r.gullet.beginGroup(), p || r.gullet.macros.set('\\cr', '\\\\\\relax'), !u)) {
		...
		if (x == null) u = 1;
		else if (((u = parseFloat(x)), !u || u < 0)) throw new k('Invalid \\arraystretch: ' + x);
	}
	r.gullet.beginGroup();
	var A = [],
		T = [A],
	...
	for (H(), q.push(mr(r)); ; ) {
		...
		if (P === '&') {
			if (b && A.length === b) {
				if (p || h) throw new k('Too many tab characters: &', r.nextToken);
			...
			(r.gullet.future().text !== ' ' && (W = r.parseSizeGroup(!0)),
				...
				T.push(A),
				H());
		} else throw new k('Expected & or \\\\ or \\cr or \\end', r.nextToken);
	}
	return (
		r.gullet.endGroup(),
		r.gullet.endGroup(),
...
var k0 = function (e, t) {
		...
		function F(ve) {
			for (var ge = 0; ge < ve.length; ++ge)
				(ge > 0 && (H += 0.25), p.push({ pos: H, isDashed: ve[ge] }));
		}
		for (F(u[0]), a = 0; a < e.body.length; ++a) {
			...
			var o0 = e.rowGaps[a],
				n0 = 0;
			(o0 && ((n0 = K(o0, t)), n0 > 0 && ((n0 += I), P < n0 && (P = n0), (n0 = 0))),
				e.addJot && (P += T),
				(W.height = L),
				(W.depth = P),
				(H += L),
		...
		if (e.tags && e.tags.some((ve) => ve))
			for (a = 0; a < l; ++a) {
				...
				(R0 === !0
					...
					(I0.depth = j0.depth),
					(I0.height = j0.height),
					$0.push({ type: 'elem', elem: I0, shift: We }));
			}
		for (n = 0, E0 = 0; n < h || E0 < V0.length; ++n, ++E0) {
			for (var le, y0 = V0[E0], ce = !0; ((Ut = y0) == null ? void 0 : Ut.type) === 'separator'; ) {
				var Ut;
				if (
					(ce ||
						((b0 = S(['arraycolsep'], [])),
				...
				} else throw new k('Invalid separator type: ' + y0.separator);
				(E0++, (y0 = V0[E0]), (ce = !1));
			}
			if (!(n >= h)) {
				var K0 = void 0;
				if (n > 0 || e.hskipBeforeAndAfter) {
					...
					((K0 = (Xt = (Yt = y0) == null ? void 0 : Yt.pregap) != null ? Xt : y),
						K0 !== 0 && ((b0 = S(['arraycolsep'], [])), (b0.style.width = M(K0)), h0.push(b0)));
				}
				var Wt = [];
				for (a = 0; a < l; ++a) {
					var de = c[a],
					...
					if (fe) {
						...
						((fe.depth = de.depth),
							(fe.height = de.height),
							Wt.push({ type: 'elem', elem: fe, shift: A1 }));
					}
				}
				var T1 = G({ positionType: 'individualShift', children: Wt }),
					B1 = S(['col-align-' + (((le = y0) == null ? void 0 : le.align) || 'c')], [T1]);
		...
		if (p.length > 0) {
			for (
				var D1 = ee('hline', t, g),
					C1 = ee('hdashline', t, g),
					$e = [{ type: 'elem', elem: pe, shift: 0 }];
				p.length > 0;
			) {
				var Zt = p.pop(),
					Kt = Zt.pos - t0;
				Zt.isDashed
					? $e.push({ type: 'elem', elem: C1, shift: Kt })
					: $e.push({ type: 'elem', elem: D1, shift: Kt });
			}
			pe = G({ positionType: 'individualShift', children: $e });
		}
		if ($0.length === 0) return S(['mord'], [pe], t);
...
S0({
	...
	handler(r, e) {
		...
		return U0(r.parser, l, Ot(r.envName));
	},
	htmlBuilder: k0,
	mathmlBuilder: z0
});
S0({
	...
	handler(r) {
		...
		var l = U0(r.parser, a, Ot(r.envName)),
...
B({
	...
	handler(r, e) {
		var { parser: t, funcName: a } = r,
			n = e[0];
		if (n.type !== 'ordgroup') throw new k('Invalid environment name', n);
		for (var l = '', u = 0; u < n.body.length; ++u) l += O(n.body[u], 'textord').text;
		if (a === '\\begin') {
			if (!cr.hasOwnProperty(l)) throw new k('No such environment: ' + l, n);
			var h = cr[l],
...
var Ja = (r, e) => {
		...
		return (
			r.leftDelim == null
				? (V = he(e, ['mopen']))
				: (V = St(r.leftDelim, F, !0, e.havingStyle(t), r.mode, ['mopen'])),
			r.continued
				? (L = S([]))
				: r.rightDelim == null
					? (L = he(e, ['mclose']))
					: (L = St(r.rightDelim, F, !0, e.havingStyle(t), r.mode, ['mclose'])),
			S(['mord'].concat(l.sizingClasses(e)), [V, S(['mfrac'], [C]), L], e)
		);
	},
	Qa = (r, e) => {
...
var d1 = (r, e) => {
		...
		if (
			...
			var c = S(['mord', n.isOver ? 'mover' : 'munder'], [h], e);
			n.isOver
				? (h = G({
						positionType: 'firstBaseline',
						children: [
		...
		return S(['mord', n.isOver ? 'mover' : 'munder'], [h], e);
	},
	_a = (r, e) => {
		var t = Fe(r.label);
		...
		switch (a) {
			...
			case '\\htmlData': {
				for (var p = l.split(','), g = 0; g < p.length; g++) {
					var b = p[g],
						y = b.indexOf('=');
					if (y < 0) throw new k("\\htmlData key/value '" + b + "' missing equals sign");
					var x = b.slice(0, y),
						A = b.slice(y + 1);
					c['data-' + x.trim()] = A;
				}
...
var lt = function (e) {
	...
	if (!Cr(a)) throw new k("Invalid unit: '" + a.unit + "' in \\includegraphics.");
	return a;
};
B({
...
B({
	...
	htmlBuilder: (r, e) => {
		var t;
		r.alignment === 'clap'
			? ((t = S([], [U(r.body, e)])), (t = S(['inner'], [t], e)))
			: (t = S(['inner'], [U(r.body, e)]));
		var a = S(['fix'], []),
			n = S([r.alignment], [t, a], e),
			l = S(['strut']);
		return (
	...
	me = (r, e) => {
		...
		if (r.symbol)
			((t = new z('mo', [g0(r.name, r.mode)])),
				p1.has(r.name) && t.setAttribute('largeop', 'false'));
...
var v1 = (r, e) => {
	...
	r4 = (r, e) => {
		...
		return r.parentIsSupSub ? new z('mrow', [c, p]) : Gr([c, p]);
	};
B({
	type: 'operatorname',
...
W0({
	type: 'ordgroup',
	htmlBuilder(r, e) {
		return r.semisimple ? q0(r0(r.body, e, !1)) : S(['mord'], r0(r.body, e, !0), e);
	},
	mathmlBuilder(r, e) {
...
B({
	...
	htmlBuilder: (r, e) => {
		var t = S(['inner'], [U(r.body, e.withPhantom())]),
			a = S(['fix'], []);
...
B({
	...
	htmlBuilder(r, e) {
		...
		var u = n + l / 4,
			...
			{ span: c, ruleWidth: p, advanceWidth: g } = Va(h, e),
			b = c.height - p;
		...
		if (r.index) {
			var A = e.havingStyle(N.SCRIPTSCRIPT),
				...
				I = S(['root'], [q]);
			return S(['mord', 'sqrt'], [I, x], e);
		} else return S(['mord', 'sqrt'], [x], e);
	},
	mathmlBuilder(r, e) {
...
var br = { display: N.DISPLAY, text: N.TEXT, script: N.SCRIPT, scriptscript: N.SCRIPTSCRIPT };
B({
	type: 'styling',
...
W0({
	...
	htmlBuilder(r, e) {
		...
		var o0 = bt(u, 'right') || 'mord';
		return S([o0], [u, S(['msupsub'], [F])], e);
	},
	mathmlBuilder(r, e) {
		var t = !1,
			a,
...
W0({
	...
	htmlBuilder(r, e) {
		if (ut.hasOwnProperty(r.text)) {
			...
			} else return S(['mspace', t], [Bt(r.text, r.mode, e)], e);
		} else {
			if (st.hasOwnProperty(r.text)) return S(['mspace', st[r.text]], [], e);
			throw new k('Unknown type of space "' + r.text + '"');
		}
	},
	mathmlBuilder(r, e) {
		var t;
		if (ut.hasOwnProperty(r.text)) t = new z('mtext', [new _(' ')]);
		else {
...
B({
	...
	htmlBuilder(r, e) {
		for (var t = kr(r), a = [], n = e.havingStyle(e.style.text()), l = 0; l < t.length; l++) {
			var u = t[l];
			(u === '~' && (u = '\\textasciitilde'),
				a.push(l0(u, 'Typewriter-Regular', r.mode, n, ['mord', 'texttt'])));
		}
		return S(['mord', 'text'].concat(n.sizingClasses(e)), Nr(a), n);
	},
	mathmlBuilder(r, e) {
		var t = new _(kr(r)),
			a = new z('mtext', [t]);
...
var kr = (r) => r.body.replace(/ /g, r.star ? '␣' : ' '),
	O0 = Lr,
	y1 = `[ \r
	]`,
	l4 = '\\\\[a-zA-Z@]+',
...
m('\\char', function (r) {
	...
	if (e.text === "'") ((t = 8), (e = r.popToken()));
		...
		if (((e = r.popToken()), e.text[0] === '\\')) a = e.text.charCodeAt(1);
			...
			if (e.text === 'EOF') throw new k('\\char` missing argument');
...
var Ft = (r, e, t, a) => {
	...
	if (((n = r.consumeArg().tokens), n.length === 1 && n[0].text === '[')) {
		...
		if (!c.match(/^\s*[0-9]+\s*$/)) throw new k('Invalid number of arguments: ' + c);
...
m('\\show', (r) => {
	var e = r.popToken(),
		t = e.text;
	return (r.macros.get(t), O0[t], $.math[t], $.text[t], '');
});
m('\\bgroup', '{');
m('\\egroup', '}');
m('~', '\\nobreakspace');
...
m('\\tag@literal', (r) => {
	if (r.macros.get('\\df@tag')) throw new k('Multiple \\tag');
...
class p4 {
	...
	consumeArgs(e, t) {
		if (t) {
			...
			for (var a = t[0], n = 0; n < a.length; n++) {
				var l = this.popToken();
				if (a[n] !== l.text) throw new k("Use of the macro doesn't match its definition", l);
			}
		}
	...
	expandOnce(e) {
		...
		if (n.numArgs) {
			...
			for (var h = l.length - 1; h >= 0; --h) {
				var c = l[h];
				if (c.text === '#') {
					if (h === 0) throw new k('Incomplete placeholder at end of macro body', c);
					if (((c = l[--h]), c.text === '#')) l.splice(h + 1, 1);
					else if (/^[1-9]$/.test(c.text)) l.splice(h, 2, ...u[+c.text - 1]);
					else throw new k('Not a valid argument number', c);
				}
			}
		}
	...
	_getExpansion(e) {
		...
		if (typeof n == 'string') {
			...
			for (var h = new zr(n, this.settings), c = [], p = h.lex(); p.text !== 'EOF'; )
				(c.push(p), (p = h.lex()));
			c.reverse();
...
class Ye {
	...
	handleInfixNodes(e) {
		for (var t = -1, a, n = 0; n < e.length; n++) {
			var l = e[n];
			if (l.type === 'infix') {
				if (t !== -1) throw new k('only one infix operator per group', l.token);
				((t = n), (a = l.replaceWith));
			}
		}
		if (t !== -1 && a) {
			...
			(c.length === 1 && c[0].type === 'ordgroup'
				...
				p.length === 1 && p[0].type === 'ordgroup'
					? (h = p[0])
					: (h = { type: 'ordgroup', mode: this.mode, body: p }));
			var g;
			return (
				a === '\\\\abovefrac'
	...
	handleSupSubscript(e) {
		...
		if (!n) throw new k("Expected group after '" + a + "'", t);
		return n;
	}
	...
	parseAtom(e) {
		...
		for (var a, n; ; ) {
			...
			if (l.text === '\\limits' || l.text === '\\nolimits') {
				...
				else throw new k('Limit controls must follow a math operator', l);
				this.consume();
			} else if (l.text === '^') {
				if (a) throw new k('Double superscript', l);
				a = this.handleSupSubscript('superscript');
			} else if (l.text === '_') {
				if (n) throw new k('Double subscript', l);
	...
	parseGroupOfType(e, t, a) {
		switch (t) {
			...
			case 'primitive': {
				if (a) throw new k('A primitive argument cannot be optional');
				var u = this.parseGroup(e);
				if (u == null) throw new k('Expected group as ' + e, this.fetch());
				return u;
			}
			case 'original':
			case null:
	...
	parseRegexGroup(e, t) {
		...
		if (l === '') throw new k('Invalid ' + t + ": '" + a.text + "'", a);
		return a.range(n, l);
	}
	parseColorGroup(e) {
		...
		if (!a) throw new k("Invalid color: '" + t.text + "'", t);
		var n = a[0];
		return (
	...
	parseSizeGroup(e) {
		...
		if (!n) throw new k("Invalid size: '" + t.text + "'", t);
		var l = { number: +(n[1] + n[2]), unit: n[3] };
		if (!Cr(l)) throw new k("Invalid unit: '" + l.unit + "'", t);
	...
	parseGroup(e, t) {
		...
		if (n === '{' || n === '\\begingroup') {
			...
			l == null && n[0] === '\\' && !S1.hasOwnProperty(n))
		) {
			if (this.settings.throwOnError) throw new k('Undefined control sequence: ' + n, a);
	...
	parseSymbol() {
		...
		if ((this.consume(), l))
			for (var b = 0; b < l[0].length; b++) {
				var y = l[0][b];
				if (!ot[y]) throw new k("Unknown accent ' " + y + "'", e);
				var x = ot[y][this.mode] || ot[y].text;
				if (!x) throw new k('Accent ' + y + ' unsupported in ' + this.mode + ' mode', e);
				u = {
					type: 'accent',
					mode: this.mode,
					loc: m0.range(e),
...
Ye.endOfExpression = new Set(['}', '\\endgroup', '\\end', '\\right', '&']);
var Pt = function (e, t) {
		...
		if (
			...
			if (!t.displayMode) throw new k('\\tag works only in display equations');
...
var v4 = function (e, t) {
	...
	z1 = function (e, t, a) {
		if (a.throwOnError || !(e instanceof k)) throw e;
		var n = S(['katex-error'], [new d0(t)]);
		return (
	...
	y4 = '0.16.38',
	x4 = { Span: ae, Anchor: Ie, SymbolNode: d0, SvgNode: B0, PathNode: L0, LineNode: dt },
	w4 = {
		version: y4,
		render: k1,
		renderToString: v4,
...
export {
	...
	w4 as default,
	k1 as render,
	v4 as renderToString,
	y4 as version
};
//# sourceMappingURL=HmyTFdED.js.map
