const e = 'Informazioni',
	...
	xs = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 per nessun limite, o un numero intero positivo per un limite specifico',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' o '-1' per nessuna scadenza.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(p.e. `sh webui.sh --api --api-auth username_password`)',
		'(e.g. `sh webui.sh --api`)': '(p.e. `sh webui.sh --api`)',
		'(latest)': '(ultima)',
		'(leave blank for to use commercial endpoint)':
			"(lascia vuoto per utilizzare l'endpoint commerciale)",
		'[Last] dddd [at] h:mm A': '',
		'[Today at] h:mm A': '',
		'[Yesterday at] h:mm A': '',
		'{{ models }}': '{{ modelli }}',
		...
		'*Prompt node ID(s) are required for image generation':
			'*ID nodo prompt sono necessari per la generazione di immagini',
		'1 hour before': '',
		'1 Source': '',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Una nuova versione (v{{LATEST_VERSION}}) è ora disponibile.',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			"Un task model viene utilizzato durante l'esecuzione di attività come la generazione di titoli per chat e query di ricerca Web",
		'a user': 'un utente',
		About: e,
		...
		'Add a short description about what this model does':
			'Aggiungi una breve descrizione di quello che fa questo modello',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'La modifica di queste impostazioni applicherà le modifiche universalmente a tutti gli utenti.',
		admin: c,
		Admin: d,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Gli amministratori hanno accesso a tutti gli strumenti in qualsiasi momento; gli utenti necessitano di strumenti assegnati per ogni modello nello spazio di lavoro.',
		Advanced: u,
		...
		'Allowed file extensions for upload. Separate multiple extensions with commas. Leave empty for all file types.':
			'Le estensioni file permesse per il caricamento. Separa le varie estensioni con una virgola. Lascia vuoto per tutti i tipi di file.',
		'Already have an account?': 'Hai già un account?',
		'Alternative to the top_p, and aims to ensure a balance of quality and variety. The parameter p represents the minimum probability for a token to be considered, relative to the probability of the most likely token. For example, with p=0.05 and the most likely token having a probability of 0.9, logits with a value less than 0.045 are filtered out.':
			'Alternativa al top_p e mira a garantire un equilibrio tra qualità e varietà. Il parametro p rappresenta la probabilità minima affinché un token venga considerato, rispetto alla probabilità del token più probabile. Ad esempio, con p=0.05 e il token più probabile con una probabilità di 0.9, i logits con un valore inferiore a 0.045 vengono filtrati.',
		Always: g,
		...
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Sei sicuro di voler cancellare tutte le memorie? Questa operazione non può essere annullata.',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Sei sicuro di voler disarchiviare tutte le chat archiviate?',
		...
		'Autocomplete Generation Input Max Length':
			"Lunghezza massima input generazione dell'autocompletamento",
		Automatic1111: M,
		...
		'Boosting or penalizing specific tokens for constrained responses. Bias values will be clamped between -100 and 100 (inclusive). (Default: none)':
			'Potenziare o penalizzare token specifici per risposte vincolate. I valori di bias saranno limitati tra -100 e 100 (incluso). (Predefinito: nessuno)',
		Brave: V,
		...
		'Call feature is not supported when using Web STT engine':
			'La funzione di chiamata non è supportata quando si utilizza il motore Web STT',
		Camera: j,
		Cancel: Q,
		...
		'Character limit for autocomplete generation input':
			"Limite di caratteri per l'input di generazione dell'autocompletamento",
		...
		'Click here to download user import template file.':
			'Clicca qui per scaricare il file modello di importazione utente.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Clicca qui per saperne di più su faster-whisper e vedere i modelli disponibili.',
		...
		"Click on the user role button to change a user's role.":
			'Clicca sul pulsante del ruolo utente per modificare il ruolo di un utente.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			"Autorizzazione di scrittura negli appunti negata. Controlla le impostazioni del browser per concedere l'accesso necessario.",
		Clone: le,
		...
		'Connect to your own OpenAI compatible API endpoints.':
			'Connettiti ai tuoi endpoint API compatibili con OpenAI.',
		'Connect to your own OpenAPI compatible external tool servers.':
			'Connettiti ai tuoi server di tool esterni compatibili con OpenAPI.',
		'Connected ({{type}})': '',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			'Limita lo sforzo di ragionamento per i modelli di ragionamento. Applicabile solo a modelli di ragionamento di fornitori specifici che supportano lo sforzo di ragionamento.',
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Controlla come il testo del messaggio viene suddiviso per le richieste TTS. 'Punteggiatura' divide in frasi, 'paragrafi' divide in paragrafi e 'nessuno' mantiene il messaggio come una singola stringa.",
		'Control the repetition of token sequences in the generated text. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 1.1) will be more lenient. At 1, it is disabled.':
			'Controlla la ripetizione delle sequenze di token nel testo generato. Un valore più alto (ad esempio, 1.5) penalizzerà le ripetizioni in modo più forte, mentre un valore più basso (ad esempio, 1.1) sarà più indulgente. A 1, è disabilitato.',
		Controls: ze,
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			"Controlla l'equilibrio tra coerenza e diversità dell'output. Un valore più basso risulterà in un testo più focalizzato e coerente.",
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'CORS deve essere configurato correttamente dal fornitore per consentire le richieste da Open WebUI.',
		'Could not read file.': '',
		CPU: Ue,
		Create: Re,
		...
		'Create your first note by clicking on the plus button below.':
			'Crea la tua prima nota cliccando sul pulsante + sotto.',
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			"Il modello predefinito funziona con un'ampia gamma di modelli chiamando gli strumenti una volta prima dell'esecuzione. La modalità nativa sfrutta le capacità di chiamata degli strumenti integrate nel modello, ma richiede che il modello supporti intrinsecamente questa funzionalità.",
		...
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			"Predefinito per il recupero segmentato per un'estrazione di contenuti mirata e pertinente, questo è raccomandato per la maggior parte dei casi.",
		...
		'Deployment names are required for Azure OpenAI':
			'I nomi dei deployment sono obbligatori per Azure OpenAI',
		Desc: _e,
		'Describe the edit...': '',
		'Describe the image...': '',
		'Describe what changed...': '',
		'Describe your knowledge base and objectives':
			'Descrivi la tua base di conoscenza e gli obiettivi',
		Description: Ke,
		Deselect: Be,
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'Le Connessioni Dirette consentono agli utenti di connettersi ai propri endpoint API compatibili con OpenAI.',
		'Direct Message': '',
		...
		'Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.':
			"Disattiva l'estrazione immagini dai PDF. Se LLM è attivo le immagini saranno didascalizzate. Predefinito a Falso.",
		Disabled: He,
		'Disconnect OAuth': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			'Scopri come utilizzare Open WebUI e cerca supporto dalla community.',
		'Discover wonders': 'Scopri meraviglie',
		'Discover, download, and explore custom functions':
			'Scopri, scarica ed esplora funzioni personalizzate',
		'Discover, download, and explore custom prompts':
			'Scopri, scarica ed esplora prompt personalizzati',
		'Discover, download, and explore custom tools':
			'Scopri, scarica ed esplora strumenti personalizzati',
		'Discover, download, and explore model presets':
			'Scopri, scarica ed esplora i preset dei modello',
		...
		'Display the username instead of You in the Chat':
			'Visualizza il nome utente invece di Tu nella chat',
		...
		'Do not install functions from sources you do not fully trust.':
			'Non installare funzioni da fonti di cui non ti fidi completamente.',
		'Do not install tools from sources you do not fully trust.':
			'Non installare strumenti da fonti di cui non ti fidi completamente.',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'non effettua connessioni esterne e i tuoi dati rimangono al sicuro sul tuo server ospitato localmente.',
		'Domain Filter List': 'Elenco filtri dominio',
		"don't fetch random pipelines from sources you don't trust.":
			'Non recuperare pipeline casuali da fonti non affidabili.',
		"Don't have an account?": 'Non hai un account?',
		"don't install random functions from sources you don't trust.":
			'non installare funzioni da fonti di cui non ti fidi.',
		"don't install random tools from sources you don't trust.":
			'non installare strumenti da fonti di cui non ti fidi.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"ad esempio '30s','10m'. Le unità di tempo valide sono 's', 'm', 'h'.",
		"e.g. 'low', 'medium', 'high'": '',
		...
		'e.g. A filter to remove profanity from text':
			'ad esempio un filtro per rimuovere le parolacce dal testo',
		...
		'e.g. Tools for performing various operations':
			'ad esempio strumenti per eseguire varie operazioni',
		...
		'e.g., en-US,ja-JP (leave blank for auto-detect)':
			'ad esempio, en-US,ja-JP (lascia vuoto per auto-rilevamento)',
		...
		'Enable autocomplete generation for chat messages':
			'Abilita generazione autocompletamento per i messaggi di chat',
		...
		"Enable Memory Locking (mlock) to prevent model data from being swapped out of RAM. This option locks the model's working set of pages into RAM, ensuring that they will not be swapped out to disk. This can help maintain performance by avoiding page faults and ensuring fast data access.":
			"Abilita il blocco della memoria (mlock) per impedire che i dati del modello vengano scambiati dalla RAM. Questa opzione blocca l'insieme di pagine di lavoro del modello nella RAM, assicurando che non vengano scambiate su disco. Questo può aiutare a mantenere le prestazioni evitando errori di pagina e garantendo un accesso rapido ai dati.",
		'Enable Memory Mapping (mmap) to load model data. This option allows the system to use disk storage as an extension of RAM by treating disk files as if they were in RAM. This can improve model performance by allowing for faster data access. However, it may not work correctly with all systems and can consume a significant amount of disk space.':
			'Abilita il mapping della memoria (mmap) per caricare i dati del modello. Questa opzione consente al sistema di utilizzare lo spazio di archiviazione su disco come estensione della RAM trattando i file su disco come se fossero nella RAM. Questo può migliorare le prestazioni del modello consentendo un accesso più rapido ai dati. Tuttavia, potrebbe non funzionare correttamente con tutti i sistemi e può consumare una quantità significativa di spazio su disco.',
		'Enable Message Queue': '',
		'Enable Message Rating': 'Abilita valutazione messaggio',
		'Enable Mirostat sampling for controlling perplexity.':
			'Abilita il campionamento Mirostat per controllare la perplessità.',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Assicurati che il tuo file CSV includa 4 colonne in questo ordine: Nome, Email, Password, Ruolo.',
		'Enter {{role}} message here': 'Inserisci il messaggio per {{role}} qui',
		'Enter a detail about yourself for your LLMs to recall':
			'Inserisci un dettaglio su di te per che i LLM possano ricordare',
		'Enter a title for the pending user info overlay. Leave empty for default.':
			'Inserisci un titolo per gli utente in attesa nella schermata informazioni. LAscia vuoto per il predefinito.',
		'Enter a watermark for the response. Leave empty for none.':
			'Inserisci un watermark per le risposte. Lascia vuoto per nessuno.',
		...
		'Enter api auth string (e.g. username:password)':
			'Inserisci la stringa di autenticazione API (ad es. nome utente:password)',
		...
		'Enter content for the pending user info overlay. Leave empty for default.':
			"Inserisci contenuto per l'overlay di info per utenti in attesa. Lascia vuoto per predefinito.",
		...
		'Enter External Document Loader API Key':
			'Inserisci Chiave API del Caricatore Documenti Esterno',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			"Inserisci l'URL del proxy (ad es. https://user:password@host:port)",
		...
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			"Inserisci l'URL pubblico del tuo WebUI. Questo URL verrà utilizzato per generare collegamenti nelle notifiche.",
		...
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			"Inserisci l'URL Yacy (ad esempio http://yacy.example.com:8090)",
		...
		'Error unloading model: {{error}}':
			'Errore durante lo scaricamento della memoria del modello: {{error}}',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Esempio: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Esempio: sAMAccountName o uid o userPrincipalName',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			'Superato il numero di posti nella tua licenza. Contatta il supporto per aumentare il numero di posti.',
		Exclude: bo,
		'Execute code': '',
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'Impossibile connettersi al server dello strumento OpenAPI {{URL}}',
		...
		'File size should not exceed {{maxSize}} MB.':
			'La dimensione del file non deve superare {{maxSize}} MB.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			"Rilevato spoofing delle impronte digitali: impossibile utilizzare le iniziali come avatar. Ripristino all'immagine del profilo predefinita.",
		...
		'Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.':
			"Forza OCR su tutte le pagine dei PDF. Questo porterebbe ai peggiori risultati se hai dell'ottimo testo nei PDF. Predefinito a Falso.",
		...
		'Forwards system user session credentials to authenticate':
			'Inoltra le credenziali della sessione utente di sistema per autenticare',
		Fr_day_of_week: Wo,
		...
		'Functions allow arbitrary code execution.':
			"Le funzioni consentono l'esecuzione di codice arbitrario.",
		...
		'Hex Color - Leave empty for default color':
			'Colore esadecimale - Lascia vuoto per il colore predefinito',
		Hidden: ai,
		Hide: ni,
		'Hide All': '',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			"Riconosco di aver letto e compreso le implicazioni della mia azione. Sono consapevole dei rischi associati all'esecuzione di codice arbitrario e ho verificato l'affidabilità della fonte.",
		ID: mi,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Includi il flag `--api-auth` quando esegui stable-diffusion-webui',
		'Include `--api` flag when running stable-diffusion-webui':
			'Includi il flag `--api` quando esegui stable-diffusion-webui',
		'Includes SharePoint': 'Include SharePoint',
		'Increase UI Scale': '',
		'Influences how quickly the algorithm responds to feedback from the generated text. A lower learning rate will result in slower adjustments, while a higher learning rate will make the algorithm more responsive.':
			"Influenza la velocità con cui l'algoritmo risponde al feedback del testo generato. Un tasso di apprendimento più basso comporterà aggiustamenti più lenti, mentre un tasso di apprendimento più alto renderà l'algoritmo più reattivo.",
		Info: bi,
		Initials: yi,
		'Inject file content into conversation context': '',
		'Inject the entire content as context for comprehensive processing, this is recommended for complex queries.':
			"Inietta l'intero contenuto come contesto per un'elaborazione completa, questo è consigliato per query complesse.",
		Input: Ai,
		...
		'Instant Auto-Send After Voice Transcription':
			'Invio automatico istantaneo dopo la trascrizione vocale',
		Instructions: Ii,
		Integration: Si,
		Integrations: wi,
		Interface: Pi,
		...
		'Leave empty to include all models from "{{url}}" endpoint':
			'Lascia vuoto per includere tutti i modelli dagli endpoint "{{url}}"',
		...
		'Leave empty to include all models or select specific models':
			'Lascia vuoto per includere tutti i modelli o seleziona modelli specifici',
		...
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Lascia vuoto per utilizzare il prompt predefinito o inserisci un prompt personalizzato',
		'Leave model field empty to use the default model.':
			'Lascia vuoto il campo modello per utilizzare il modello predefinito.',
		Legacy: Oi,
		lexical: xi,
		License: Fi,
		'Lift List': '',
		...
		'Make password visible in the user interface':
			'Rendi la password visibile nella interfaccia utente',
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Assicurati di esportare un file workflow.json come formato API da ComfyUI.',
		Male: ji,
		Manage: Qi,
		'Manage Connections': '',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'È possibile scaricare un massimo di 3 modelli contemporaneamente. Riprova più tardi.',
		May: $i,
		MBR: et,
		MCP: ot,
		...
		'Memories accessible by LLMs will be shown here.':
			'I memori accessibili ai LLM saranno mostrati qui.',
		Memory: st,
		...
		'Message rating should be enabled to use this feature':
			'La valutazione dei messaggi deve essere abilitata per utilizzare questa funzionalità',
		messages: lt,
		Messages: ct,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			"I messaggi inviati dopo la creazione del link non verranno condivisi. Gli utenti con l'URL saranno in grado di visualizzare la chat condivisa.",
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Il modello '{{modelName}}' è stato scaricato con successo.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Il modello '{{modelTag}}' è già in coda per il download.",
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': '',
		'Model {{modelName}} is not vision capable':
			'Il modello {{modelName}} non è in grado di vedere',
		...
		'Model can execute code and perform calculations':
			'Il modello può eseguire del codice e fare calcoli',
		'Model can generate images based on text prompts':
			'Il modello può generare delle immagini basate sui prompt testuali',
		'Model can search the web for information':
			'Il modello può cercare nella rete per informazioni',
		'Model Capabilities': '',
		'Model created successfully!': 'Modello creato con successo!',
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			"Percorso del filesystem del modello rilevato. Il nome breve del modello è richiesto per l'aggiornamento, impossibile continuare.",
		...
		'No HTML, CSS, or JavaScript content found.':
			'Nessun contenuto HTML, CSS o JavaScript trovato.',
		'No inference engine with management support found':
			'Nessun motore di inferenza con supporto per la gestione trovato',
		'No kernel': '',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Nota: se imposti un punteggio minimo, la ricerca restituirà solo i documenti con un punteggio maggiore o uguale al punteggio minimo.',
		Notes: Et,
		...
		'Only alphanumeric characters and hyphens are allowed':
			'Nella stringa di comando sono consentiti solo caratteri alfanumerici e trattini',
		...
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Solo le collezioni possono essere modificate, crea una nuova base di conoscenza per modificare/aggiungere documenti.',
		...
		'Only select users and groups with permission can access':
			'Solo gli utenti e i gruppi selezionati con autorizzazione possono accedere',
		'Only sync new/updated chats': '',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			"Ops! Sembra che l'URL non sia valido. Si prega di ricontrollare e riprovare.",
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Ops! Ci sono file ancora in fase di caricamento. Si prega di attendere il completamento del caricamento.',
		'Oops! There was an error in the previous response.':
			'Ops! Si è verificato un errore nella risposta precedente.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Ops! Stai utilizzando un metodo non supportato (solo frontend). Si prega di servire la WebUI dal backend.',
		'Open file': 'Apri file',
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			'Open WebUI può utilizzare tool forniti da qualsiasi server OpenAPI.',
		'Open WebUI uses faster-whisper internally.':
			'Open WebUI utilizza faster-whisper internamente.',
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open WebUI utilizza le incorporazioni vocali di SpeechT5 e CMU Arctic.',
		'Open WebUI version': '',
		'Open WebUI version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})':
			'La versione di Open WebUI (v{{OPEN_WEBUI_VERSION}}) è inferiore alla versione richiesta (v{{REQUIRED_VERSION}})',
		OpenAI: xt,
		...
		'Permission denied when accessing media devices':
			"Autorizzazione negata durante l'accesso ai dispositivi multimediali",
		'Permission denied when accessing microphone':
			"Autorizzazione negata durante l'accesso al microfono",
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines è un sistema di plugin con esecuzione arbitraria di codice —',
		...
		'Please carefully review the following warnings:':
			'Si prega di esaminare attentamente i seguenti avvisi:',
		...
		'Please do not close the settings page while loading the model.':
			'Si prega di non chiudere la pagina delle impostazioni durante il caricamento del modello.',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			"L'ID prefisso viene utilizzato per evitare conflitti con altre connessioni aggiungendo un prefisso agli ID dei modelli - lasciare vuoto per disabilitare",
		...
		'Re-rank models by topic similarity':
			'Riordina i modelli in base alla somiglianza degli argomenti',
		Read: ba,
		...
		'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative.':
			'Riduce la probabilità di generare sciocchezze. Un valore più alto (ad esempio 100) darà risposte più varie, mentre un valore più basso (ad esempio 10) sarà più conservativo.',
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			"Le notifiche di risposta non possono essere attivate poiché i permessi del sito web sono stati negati. Si prega di visitare le impostazioni del browser per concedere l'accesso necessario.",
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			"Il salvataggio dei registri della chat direttamente nell'archivio del browser non è più supportato. Si prega di dedicare un momento per scaricare ed eliminare i registri della chat facendo clic sul pulsante in basso. Non preoccuparti, puoi facilmente reimportare i registri della chat nel backend tramite",
		Schedule: Ja,
		...
		'Selected model(s) do not support image inputs':
			"I modelli selezionati non supportano l'input di immagini",
		'Selected Models': '',
		semantic: $a,
		Send: en,
		...
		'Set reranking model (e.g. {{model}})':
			'Imposta modello di riclassificazione (ad esempio {{model}})',
		...
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			"Set il numero di strati, che verranno scaricati su GPU. Aumentare questo valore può migliorare significativamente le prestazioni per i modelli ottimizzati per l'accelerazione GPU, ma può anche consumare più energia e risorse GPU.",
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Imposta un bias piatto contro i token che sono apparsi almeno una volta. Un valore più alto (ad esempio, 1,5) penalizzerà le ripetizioni in modo più forte, mentre un valore più basso (ad esempio, 0,9) sarà più indulgente. A 0, è disabilitato.',
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Imposta un bias di scaling contro i token per penalizzare le ripetizioni, in base a quante volte sono apparsi. Un valore più alto (ad esempio, 1,5) penalizzerà le ripetizioni in modo più forte, mentre un valore più basso (ad esempio, 0,9) sarà più indulgente. A 0, è disabilitato.',
		'Sets how far back for the model to look back to prevent repetition.':
			'Imposta quanto lontano il modello deve guardare indietro per prevenire la ripetizione.',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			'Imposta il seme del numero casuale da utilizzare per la generazione. Impostando questo su un numero specifico, il modello genererà lo stesso testo per lo stesso prompt.',
		'Sets the size of the context window used to generate the next token.':
			'Imposta la dimensione della finestra di contesto utilizzata per generare il token successivo.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			"Imposta le sequenze di arresto da utilizzare. Quando questo modello viene incontrato, l'LLM smetterà di generare testo e restituirà. Più modelli di arresto possono essere impostati specificando più parametri di arresto separati in un file modello.",
		Setting: an,
		Settings: nn,
		...
		'Show Admin Details in Account Pending Overlay':
			"Mostra i dettagli dell'amministratore nella sovrapposizione dell'account in attesa",
		'Show All': '',
		...
		'Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.':
			'Rimuovi il testo OCR esistente dal PDF e rilancia OCR. Ignorato se Forza OCR è attivo. Predefinito a Falso',
		...
		'Tail free sampling is used to reduce the impact of less probable tokens from the output. A higher value (e.g., 2.0) will reduce the impact more, while a value of 1.0 disables this setting.':
			"Il campionamento tail free viene utilizzato per ridurre l'impatto di token meno probabili dall'output. Un valore più alto (ad esempio, 2.0) ridurrà maggiormente l'impatto, mentre un valore di 1.0 disabilita questa impostazione.",
		'Talk to Model': '',
		...
		'The Application Account DN you bind with for search':
			"L'account dell'applicazione DN con cui ti colleghi per la ricerca",
		...
		'The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.':
			'La dimensione del batch determina quanti richieste di testo vengono elaborate insieme in una sola volta. Una dimensione del batch più alta può aumentare le prestazioni e la velocità del modello, ma richiede anche più memoria.',
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Gli sviluppatori dietro questo plugin sono volontari appassionati della comunità. Se trovi utile questo plugin, ti preghiamo di considerare di contribuire al suo sviluppo.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'La classifica di valutazione è basata sul sistema di rating Elo ed è aggiornata in tempo reale.',
		'The format to return a response in. Format can be json or a JSON schema.':
			'Il formato per ritornare una risposta. Il formato può essere un JSON o uno schema JSON.',
		'The height in pixels to compress images to. Leave empty for no compression.':
			"L'altezza in pixel per comprimere le immagini. Lascia vuoto per nessuna compressione.",
		'The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.':
			'Il linguaggio degli input audio. Fornire la lingua in formato ISO-639-1 (es: en) migliorerà la accuratezza e la latenza. Lascia vuoto per per riconoscere il linguaggio in automatico.',
		'The LDAP attribute that maps to the mail that users use to sign in.':
			"L'attributo LDAP che mappa alla mail che gli utenti usano per accedere.",
		'The LDAP attribute that maps to the username that users use to sign in.':
			"L'attributo LDAP che mappa al nome utente che gli utenti usano per accedere.",
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			"La classifica è attualmente in beta e potremmo regolare i calcoli dei punteggi mentre perfezioniamo l'algoritmo.",
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'La dimensione massima del file in MB. Se la dimensione del file supera questo limite, il file non verrà caricato.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'La dimensione massima del numero di file che possono essere utilizzati contemporaneamente nella chat. Se il numero di file supera questo limite, i file non verranno caricati.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			"Il formato di output per il testo. Può essere 'json', 'markdown', o 'html'. Predefinito 'markdown'.",
		"The passwords you entered don't quite match. Please double-check and try again.": '',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Il punteggio dovrebbe essere un valore compreso tra 0.0 (0%) e 1.0 (100%).',
		...
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'La temperatura del modello. Aumentare la temperatura farà sì che il modello risponda in modo più creativo.',
		...
		'The width in pixels to compress images to. Leave empty for no compression.':
			'La larghezza in pixel per comprimere le immagini. Lascia vuoto per nessuna compressione.',
		Theme: Mn,
		...
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			"Questo canale è stato creato il {{createdAt}}. Questo è l'inizio del canale {{channelName}}.",
		"This chat won't appear in history and your messages will not be saved.":
			'Questa chat non apparirà nella cronologia e i tuoi messaggi non verranno salvati.',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Ciò garantisce che le tue preziose conversazioni siano salvate in modo sicuro nel tuo database backend. Grazie!',
		...
		'This option sets the maximum number of tokens the model can generate in its response. Increasing this limit allows the model to provide longer answers, but it may also increase the likelihood of unhelpful or irrelevant content being generated.':
			'Questa opzione imposta il numero massimo di token che il modello può generare nella sua risposta. Aumentare questo limite consente al modello di fornire risposte più lunghe, ma potrebbe anche aumentare la probabilità che vengano generati contenuti non utili o irrilevanti.',
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Questa opzione eliminerà tutti i file esistenti nella collezione e li sostituirà con i file appena caricati.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Questa opzione eliminerà <strong>{{NAME}}</strong> e <strong>tutti i suoi contenuti</strong>.',
		'This will delete all models including custom models':
			'Questa opzione eliminerà tutti i modelli, compresi i modelli personalizzati',
		'This will delete all models including custom models and cannot be undone.':
			'Questa opzione eliminerà tutti i modelli, compresi i modelli personalizzati e non può essere annullata.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Questa opzione ripristinerà la base di conoscenza e sincronizzerà tutti i file. Vuoi continuare?',
		...
		'To access the available model names for downloading,':
			'Per accedere ai nomi dei modelli disponibili per il download,',
		'To access the GGUF models available for downloading,':
			'Per accedere ai modelli GGUF disponibili per il download,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			"Per accedere a WebUI, contatta l'amministratore. Gli amministratori possono gestire gli stati degli utenti dal pannello di amministrazione.",
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Per allegare la base di conoscenza qui, aggiungili prima allo spazio di lavoro "Conoscenza".',
		'To learn more about available endpoints, visit our documentation.':
			'Per saperne di più sugli endpoint disponibili, visita la nostra documentazione.',
		'To select skills here, add them to the "Skills" workspace first.': '',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Per selezionare i toolkit qui, aggiungili prima allo spazio di lavoro "Strumenti".',
		...
		'Toggle whether current connection is active.':
			'Attiva/disattiva la connessione attuale quando è attiva',
		Token: _n,
		...
		'Tools are a function calling system with arbitrary code execution':
			'Gli strumenti sono un sistema di chiamata di funzioni con esecuzione di codice arbitrario',
		...
		'Type Hugging Face Resolve (Download) URL':
			'Digita URL di Risoluzione (Download) di Hugging Face',
		...
		'Update for the latest features and improvements.':
			'Aggiorna per le ultime funzionalità e miglioramenti.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Aggiorna a un piano con licenza per funzionalità avanzate, tra cui personalizzazione del tema e branding, e supporto dedicato.',
		Upload: as,
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Usa '#' nell'input del prompt per caricare e includere la tua conoscenza.",
		...
		'Use no proxy to fetch page contents.':
			'Usa nessun proxy per recuperare i contenuti della pagina.',
		'Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.':
			'Usa il proxy designato dalle variabili di ambiente http_proxy e https_proxy per recuperare i contenuti della pagina.',
		user: ls,
		User: cs,
		'User Activity': '',
		'User Groups': '',
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Utilizzando il modello di arena predefinito con tutti i modelli. Fai clic sul pulsante più per aggiungere modelli personalizzati.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Versione {{selectedVersion}} di {{totalVersions}}',
		'Version deleted': '',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Attenzione: abilitando questo, gli utenti potranno caricare codice arbitrario sul server.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			"Attenzione: l'esecuzione di Jupyter consente l'esecuzione di codice arbitrario, comportando gravi rischi per la sicurezza: procedere con estrema cautela.",
		We_day_of_week: Cs,
		Web: Is,
		'Web API': 'API Web',
		...
		'WebUI will make requests to "{{url}}/chat/completions"':
			'WebUI farà richieste a "{{url}}/chat/completions"',
		Week: ws,
		Weekly: Ps,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			"Quando abilitato, il modello risponderà a ciascun messaggio della chat in tempo reale, generando una risposta non appena l'utente invia un messaggio. Questa modalità è utile per le applicazioni di chat dal vivo, ma potrebbe influire sulle prestazioni su hardware più lento.",
		'wherever you are': 'Ovunque tu sia',
		'Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.':
			"Specifica se paginare l'output. Ogni pagina sarà separata da una riga orizzontale e dal numero di pagina. Predefinito è Falso.",
		...
		'Works together with top-k. A higher value (e.g., 0.95) will lead to more diverse text, while a lower value (e.g., 0.5) will generate more focused and conservative text.':
			'Lavora insieme a top-k. Un valore più alto (ad esempio, 0,95) porterà a un testo più vario, mentre un valore più basso (ad esempio, 0,5) genererà un testo più focalizzato e conservativo.',
		Workspace: Rs,
		'Workspace Permissions': 'Permessi dello spazio di lavoro',
		Write: ks,
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Scrivi un riassunto in 50 parole che riassume [argomento o parola chiave].',
...
ad es.: Sei Mario di Super Mario Bros e agisci come assistente.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'Stai attualmente utilizzando una licenza di prova. Contatta il supporto per aggiornare la tua licenza.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Puoi chattare solo con un massimo di {{maxCount}} file alla volta.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Puoi personalizzare le tue interazioni con LLM aggiungendo memorie tramite il pulsante 'Gestisci' qui sotto, rendendole più utili e su misura per te.",
		...
		'Your account status is currently pending activation.':
			'Lo stato del tuo account è attualmente in attesa di attivazione.',
		'Your browser does not support the audio tag.': '',
		'Your browser does not support the video tag.': '',
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			'Il tuo intero contributo andrà direttamente allo sviluppatore del plugin; Open WebUI non prende alcuna percentuale. Tuttavia, la piattaforma di finanziamento scelta potrebbe avere le proprie commissioni.',
...
//# sourceMappingURL=QwO1x1Kb.js.map
