const e = 'Honi buruz',
	...
	Vi = 'Tresnak',
	Yi = '',
	qi = 'Transformatzaileak',
	ji = '',
	Ji = 'Mota',
	Zi = 'Erabiltzaile interfazea',
	Qi = '',
	Xi = '',
	$i = 'Kendu aingura',
	er = 'Etiketatu gabea',
	...
	Nr = {
		...
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' edo '-1' iraungitzerik ez izateko.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(adib. `sh webui.sh --api --api-auth erabiltzaile_pasahitza`)',
		...
		'*Prompt node ID(s) are required for image generation':
			'Prompt nodoaren IDa(k) beharrezkoak dira irudiak sortzeko',
		'1 hour before': '',
		'1 Source': '',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Bertsio berri bat (v{{LATEST_VERSION}}) eskuragarri dago orain.',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Ataza eredua erabiltzen da txatentzako izenburuak eta web bilaketa kontsultak sortzeko bezalako atazak egitean',
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'"/{{COMMAND}}" idatziz aktibatu komando hau txataren sarreran.',
		Active: r,
		...
		'Add a short description about what this model does':
			'Gehitu eredu honek egiten duenaren deskribapen labur bat',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Ezarpen hauek aldatzeak aldaketak erabiltzaile guztiei aplikatuko dizkie.',
		admin: u,
		Admin: d,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Administratzaileek tresna guztietarako sarbidea dute beti; erabiltzaileek lan-eremuan eredu bakoitzeko esleituak behar dituzte tresnak.',
		Advanced: c,
		...
		'applies to all users with the "user" role':
			'"erabiltzaile" rola duten erabiltzaile guztiei aplikatzen zaie',
		April: y,
		Archive: A,
		'Archive All': '',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Ziur zaude artxibatutako txat guztiak desartxibatu nahi dituzula?',
		...
		'Call feature is not supported when using Web STT engine':
			'Dei funtzioa ez da onartzen Web STT motorra erabiltzean',
		Camera: J,
		Cancel: Z,
		...
		'Click here to download user import template file.':
			'Klikatu hemen erabiltzaileen inportazio txantiloia deskargatzeko.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Klikatu hemen faster-whisper-i buruz gehiago ikasteko eta eredu erabilgarriak ikusteko.',
		...
		'Click here to upload a workflow.json file.':
			'Klikatu hemen workflow.json fitxategia igotzeko.',
		'click here.': 'klikatu hemen.',
		"Click on the user role button to change a user's role.":
			'Klikatu erabiltzaile rolaren botoian erabiltzaile baten rola aldatzeko.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Arbelerako idazteko baimena ukatua. Mesedez, egiaztatu zure nabigatzailearen ezarpenak beharrezko sarbidea emateko.',
		Clone: le,
		'Clone Chat': '',
		'Clone of {{TITLE}}': '',
		Close: ue,
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Kontrolatu nola banatzen den mezuaren testua TTS eskaeretarako. 'Puntuazioa'-k esaldietan banatzen du, 'paragrafoak'-k paragrafoetan, eta 'bat ere ez'-ek mezua kate bakar gisa mantentzen du.",
		...
		'Discover, download, and explore custom functions':
			'Aurkitu, deskargatu eta esploratu funtzio pertsonalizatuak',
		'Discover, download, and explore custom prompts':
			'Aurkitu, deskargatu eta esploratu prompt pertsonalizatuak',
		'Discover, download, and explore custom tools':
			'Aurkitu, deskargatu eta esploratu tresna pertsonalizatuak',
		'Discover, download, and explore model presets':
			'Aurkitu, deskargatu eta esploratu ereduen aurrezarpenak',
		...
		'Display the username instead of You in the Chat':
			'Erakutsi erabiltzaile-izena Zu-ren ordez Txatean',
		...
		'Do not install functions from sources you do not fully trust.':
			'Ez instalatu guztiz fidagarriak ez diren iturrietatik datozen funtzioak.',
		'Do not install tools from sources you do not fully trust.':
			'Ez instalatu guztiz fidagarriak ez diren iturrietatik datozen tresnak.',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'ez du kanpo konexiorik egiten, eta zure datuak modu seguruan mantentzen dira zure zerbitzari lokalean.',
		'Domain Filter List': '',
		"don't fetch random pipelines from sources you don't trust.":
			'Ez eskuratu pipelines aleatorioak iturri ez fidagarrietatik.',
		"Don't have an account?": 'Ez duzu konturik?',
		"don't install random functions from sources you don't trust.":
			'ez instalatu fidagarriak ez diren iturrietatik datozen ausazko funtzioak.',
		"don't install random tools from sources you don't trust.":
			'ez instalatu fidagarriak ez diren iturrietatik datozen ausazko tresnak.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"adib. '30s','10m'. Denbora unitate baliodunak dira 's', 'm', 'h'.",
		"e.g. 'low', 'medium', 'high'": '',
		'e.g. "json" or a JSON schema': '',
		'e.g. 60': '',
		'e.g. A filter to remove profanity from text':
			'adib. Testutik lizunkeriak kentzeko iragazki bat',
		...
		"Enable Memory Locking (mlock) to prevent model data from being swapped out of RAM. This option locks the model's working set of pages into RAM, ensuring that they will not be swapped out to disk. This can help maintain performance by avoiding page faults and ensuring fast data access.":
			'Gaitu Memoria Blokeatzea (mlock) ereduaren datuak RAM memoriatik kanpo ez trukatzeko. Aukera honek ereduaren lan-orri multzoa RAMean blokatzen du, diskora ez direla trukatuko ziurtatuz. Honek errendimendua mantentzen lagun dezake, orri-hutsegiteak saihestuz eta datuen sarbide azkarra bermatuz.',
		'Enable Memory Mapping (mmap) to load model data. This option allows the system to use disk storage as an extension of RAM by treating disk files as if they were in RAM. This can improve model performance by allowing for faster data access. However, it may not work correctly with all systems and can consume a significant amount of disk space.':
			'Gaitu Memoria Mapaketa (mmap) ereduaren datuak kargatzeko. Aukera honek sistemari disko-biltegiratzea RAM memoriaren luzapen gisa erabiltzea ahalbidetzen dio, diskoko fitxategiak RAMean baleude bezala tratatuz. Honek ereduaren errendimendua hobe dezake, datuen sarbide azkarragoa ahalbidetuz. Hala ere, baliteke sistema guztietan behar bezala ez funtzionatzea eta disko-espazio handia kontsumitu dezake.',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Ziurtatu zure CSV fitxategiak 4 zutabe dituela ordena honetan: Izena, Posta elektronikoa, Pasahitza, Rola.',
		'Enter {{role}} message here': 'Sartu {{role}} mezua hemen',
		'Enter a detail about yourself for your LLMs to recall':
			'Sartu zure buruari buruzko xehetasun bat LLMek gogoratzeko',
		...
		'Enter api auth string (e.g. username:password)':
			'Sartu api autentifikazio katea (adib. erabiltzailea:pasahitza)',
		...
		'File size should not exceed {{maxSize}} MB.':
			'Fitxategiaren tamainak ez luke {{maxSize}} MB gainditu behar.',
		'File Upload': '',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Hatz-marka faltsutzea detektatu da: Ezin dira inizialak avatar gisa erabili. Profil irudi lehenetsia erabiliko da.',
		...
		'Functions allow arbitrary code execution.':
			'Funtzioek kode arbitrarioa exekutatzea ahalbidetzen dute.',
		...
		'Hex Color - Leave empty for default color':
			'Hex Kolorea - Utzi hutsik kolore lehenetsia erabiltzeko',
		Hidden: ot,
		Hide: nt,
		'Hide All': '',
		'Hide from Sidebar': '',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Onartzen dut irakurri dudala eta nire ekintzaren ondorioak ulertzen ditudala. Kode arbitrarioa exekutatzearekin lotutako arriskuez jabetzen naiz eta iturriaren fidagarritasuna egiaztatu dut.',
		ID: ct,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Sartu `--api-auth` bandera stable-diffusion-webui exekutatzean',
		'Include `--api` flag when running stable-diffusion-webui':
			'Sartu `--api` bandera stable-diffusion-webui exekutatzean',
		...
		'Instant Auto-Send After Voice Transcription':
			'Bidalketa Automatiko Berehalakoa Ahots Transkripzioaren Ondoren',
		Instructions: At,
		Integration: St,
		Integrations: wt,
		Interface: Et,
		...
		'Leave empty to include all models or select specific models':
			'Utzi hutsik eredu guztiak sartzeko edo hautatu eredu zehatzak',
		...
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Utzi hutsik prompt lehenetsia erabiltzeko, edo sartu prompt pertsonalizatu bat',
		...
		'LLMs can make mistakes. Verify important information.':
			'LLMek akatsak egin ditzakete. Egiaztatu informazio garrantzitsua.',
		Loader: Gt,
		'Loading Kokoro.js...': '',
		'Loading...': 'Kargatzen...',
		local: Wt,
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Ziurtatu workflow.json fitxategia API formatu gisa esportatzen duzula ComfyUI-tik.',
		Male: jt,
		Manage: Jt,
		'Manage Connections': '',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Gehienez 3 modelo deskarga daitezke aldi berean. Saiatu berriro geroago.',
		May: Xt,
		MBR: $t,
		MCP: eo,
		...
		'Memories accessible by LLMs will be shown here.':
			'LLMek atzitu ditzaketen memoriak hemen erakutsiko dira.',
		Memory: io,
		...
		'Message rating should be enabled to use this feature':
			'Mezuen balorazioa gaitu behar da funtzionalitate hau erabiltzeko',
		messages: so,
		Messages: lo,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Esteka sortu ondoren bidaltzen dituzun mezuak ez dira partekatuko. URLa duten erabiltzaileek partekatutako txata ikusi ahal izango dute.',
		'Microsoft OneDrive': '',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"'{{modelName}}' modeloa ongi deskargatu da.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"'{{modelTag}}' modeloa dagoeneko deskarga ilaran dago.",
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Modeloaren fitxategi sistemaren bidea detektatu da. Modeloaren izen laburra behar da eguneratzeko, ezin da jarraitu.',
		...
		'No HTML, CSS, or JavaScript content found.':
			'Ez da HTML, CSS, edo JavaScript edukirik aurkitu.',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Oharra: Gutxieneko puntuazio bat ezartzen baduzu, bilaketak gutxieneko puntuazioa baino handiagoa edo berdina duten dokumentuak soilik itzuliko ditu.',
		Notes: Po,
		...
		'Only alphanumeric characters and hyphens are allowed':
			'Karaktere alfanumerikoak eta marratxoak soilik onartzen dira',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Karaktere alfanumerikoak eta marratxoak soilik onartzen dira komando katean.',
		'Only can be triggered when the chat input is in focus.': '',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Bildumak soilik edita daitezke, sortu ezagutza-base berri bat dokumentuak editatzeko/gehitzeko.',
		'Only invited users can access': '',
		'Only markdown files are allowed': '',
		'Only select users and groups with permission can access':
			'Baimena duten erabiltzaile eta talde hautatuek soilik sar daitezke',
		'Only sync new/updated chats': '',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Ui! URLa ez da baliozkoa. Mesedez, egiaztatu eta saiatu berriro.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Ui! Oraindik fitxategiak kargatzen ari dira. Mesedez, itxaron karga amaitu arte.',
		'Oops! There was an error in the previous response.':
			'Ui! Errore bat egon da aurreko erantzunean.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Ui! Onartzen ez den metodo bat erabiltzen ari zara (frontend soilik). Mesedez, zerbitzatu WebUI-a backendetik.',
		...
		'Open WebUI uses faster-whisper internally.':
			'Open WebUI-k faster-whisper erabiltzen du barnean.',
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open WebUI-k SpeechT5 eta CMU Arctic hiztun txertaketak erabiltzen ditu.',
		'Open WebUI version': '',
		'Open WebUI version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})':
			'Open WebUI bertsioa (v{{OPEN_WEBUI_VERSION}}) beharrezko bertsioa (v{{REQUIRED_VERSION}}) baino baxuagoa da',
		OpenAI: No,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines pluginen sistema bat da, ausazko kode‑exekuzioarekin —',
		...
		'Please carefully review the following warnings:':
			'Mesedez, berrikusi arretaz hurrengo oharrak:',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'Aurrizki IDa erabiltzen da beste konexioekin gatazkak saihesteko modelo IDei aurrizki bat gehituz - utzi hutsik desgaitzeko',
		...
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Egin erreferentzia zure buruari "Erabiltzaile" gisa (adib., "Erabiltzailea gaztelania ikasten ari da")',
		'Reference Chats': '',
		Refresh: wn,
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Erantzunen jakinarazpenak ezin dira aktibatu webgunearen baimenak ukatu direlako. Mesedez, bisitatu zure nabigatzailearen ezarpenak beharrezko sarbidea emateko.',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Txat erregistroak zuzenean zure nabigatzailearen biltegian gordetzea ez da jadanik onartzen. Mesedez, hartu une bat zure txat erregistroak deskargatu eta ezabatzeko beheko botoia sakatuz. Ez kezkatu, zure txat erregistroak erraz inportatu ditzakezu berriro backendera honen bidez',
		Schedule: Jn,
		...
		'Selected model(s) do not support image inputs':
			'Hautatutako modelo(e)k ez dute irudi sarrerarik onartzen',
		'Selected Models': '',
		semantic: ei,
		Send: ai,
		...
		'Set the number of worker threads used for computation. This option controls how many threads are used to process incoming requests concurrently. Increasing this value can improve performance under high concurrency workloads but may also consume more CPU resources.':
			'Ezarri kalkulurako erabilitako langile harien kopurua. Aukera honek kontrolatzen du zenbat hari erabiltzen diren sarrerako eskaerak aldi berean prozesatzeko. Balio hau handitzeak errendimendua hobetu dezake konkurrentzia altuko lan-kargetan, baina CPU baliabide gehiago kontsumitu ditzake.',
		...
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			'Ezartzen ditu erabiliko diren gelditzeko sekuentziak. Patroi hau aurkitzen denean, LLMak testua sortzeari utziko dio eta itzuli egingo da. Gelditzeko patroi anitz ezar daitezke modelfile batean gelditzeko parametro anitz zehaztuz.',
		Setting: ni,
		Settings: ii,
		...
		'Show Admin Details in Account Pending Overlay':
			'Erakutsi administratzaile xehetasunak kontu zain geruzan',
		'Show All': '',
		...
		'The Application Account DN you bind with for search':
			'Bilaketarako lotzen duzun aplikazio kontuaren DN-a',
		...
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Plugin honen atzean dauden garatzaileak komunitateko boluntario sutsuak dira. Plugin hau baliagarria iruditzen bazaizu, mesedez kontuan hartu bere garapenean laguntzea.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Ebaluazio sailkapena Elo sailkapen sisteman oinarritzen da eta denbora errealean eguneratzen da.',
		...
		'The LDAP attribute that maps to the username that users use to sign in.':
			'Erabiltzaileek saioa hasteko erabiltzen duten erabiltzaile-izenarekin mapeatzen den LDAP atributua.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'Sailkapena beta fasean dago, eta balorazioen kalkuluak doitu ditzakegu algoritmoa fintzen dugun heinean.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'Fitxategiaren gehienezko tamaina MB-tan. Fitxategiaren tamainak muga hau gainditzen badu, fitxategia ez da kargatuko.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'Txatean aldi berean erabili daitezkeen fitxategien gehienezko kopurua. Fitxategi kopuruak muga hau gainditzen badu, fitxategiak ez dira kargatuko.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			'',
		"The passwords you entered don't quite match. Please double-check and try again.": '',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Puntuazioa 0.0 (0%) eta 1.0 (100%) arteko balio bat izan behar da.',
		...
		'This action cannot be undone. Do you wish to continue?':
			'Ekintza hau ezin da desegin. Jarraitu nahi duzu?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'',
		"This chat won't appear in history and your messages will not be saved.": '',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Honek zure elkarrizketa baliotsuak modu seguruan zure backend datu-basean gordeko direla ziurtatzen du. Eskerrik asko!',
		...
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Hau funtzionalitate esperimental bat da, baliteke espero bezala ez funtzionatzea eta edozein unetan aldaketak izatea.',
		...
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Aukera honek bilduman dauden fitxategi guztiak ezabatuko ditu eta berriki kargatutako fitxategiekin ordezkatuko ditu.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Honek <strong>{{NAME}}</strong> eta <strong>bere eduki guztiak</strong> ezabatuko ditu.',
		'This will delete all models including custom models':
			'Honek modelo guztiak ezabatuko ditu, modelo pertsonalizatuak barne',
		'This will delete all models including custom models and cannot be undone.':
			'Honek modelo guztiak ezabatuko ditu, modelo pertsonalizatuak barne, eta ezin da desegin.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Honek ezagutza-basea berrezarri eta fitxategi guztiak sinkronizatuko ditu. Jarraitu nahi duzu?',
		...
		'To access the available model names for downloading,':
			'Deskargatzeko eskuragarri dauden modelo izenak atzitzeko,',
		'To access the GGUF models available for downloading,':
			'Deskargatzeko eskuragarri dauden GGUF modeloak atzitzeko,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'WebUI-a atzitzeko, mesedez jarri harremanetan administratzailearekin. Administratzaileek erabiltzaileen egoerak kudeatu ditzakete Admin Paneletik.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Ezagutza-basea hemen eransteko, gehitu ezazu lehenik "Ezagutza" lan-eremura.',
		...
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Tresna-multzoak hemen hautatzeko, gehitu itzazu lehenik "Tresnak" lan-eremura.',
		...
		'Tools are a function calling system with arbitrary code execution':
			'Tresnak kode arbitrarioa exekutatzeko funtzio deitzeko sistema bat dira',
		'Tools Function Calling Prompt': '',
		'Tools have a function calling system that allows arbitrary code execution.':
			'Tresnek kode arbitrarioa exekutatzeko aukera ematen duen funtzio deitzeko sistema dute.',
		...
		'Update for the latest features and improvements.':
			'Eguneratu azken ezaugarri eta hobekuntzak izateko.',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Erabili '#' prompt sarreran zure ezagutza kargatu eta sartzeko.",
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Arena modelo lehenetsia erabiltzen modelo guztiekin. Egin klik plus botoian modelo pertsonalizatuak gehitzeko.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'{{totalVersions}}-tik {{selectedVersion}}. bertsioa',
		'Version deleted': '',
		'View Replies': '',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Abisua: Hau gaitzeak erabiltzaileei zerbitzarian kode arbitrarioa kargatzea ahalbidetuko die.',
		...
		'WebUI will make requests to "{{url}}/api/chat"':
			'WebUI-k eskaerak egingo ditu "{{url}}/api/chat"-era',
		'WebUI will make requests to "{{url}}/chat/completions"':
			'WebUI-k eskaerak egingo ditu "{{url}}/chat/completions"-era',
		Week: Er,
		Weekly: Ir,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			'Gaituta dagoenean, modeloak txat mezu bakoitzari denbora errealean erantzungo dio, erantzun bat sortuz erabiltzaileak mezua bidaltzen duen bezain laster. Modu hau erabilgarria da zuzeneko txat aplikazioetarako, baina errendimenduan eragina izan dezake hardware motelagoan.',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Idatzi 50 hitzeko laburpen bat [gaia edo gako-hitza] laburbiltzen duena.',
...
adib.: Super Mario Bros-eko Mario zara eta laguntzaile gisa jokatzen duzu.`,
		...
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Gehienez {{maxCount}} fitxategirekin txateatu dezakezu aldi berean.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"LLMekin dituzun interakzioak pertsonalizatu ditzakezu memoriak gehituz beheko 'Kudeatu' botoiaren bidez, lagungarriagoak eta zuretzat egokituagoak eginez.",
		...
		'Your account status is currently pending activation.':
			'Zure kontuaren egoera aktibazio zain dago.',
		'Your browser does not support the audio tag.': '',
		'Your browser does not support the video tag.': '',
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			'Zure ekarpen osoa zuzenean plugin garatzaileari joango zaio; Open WebUI-k ez du ehunekorik hartzen. Hala ere, aukeratutako finantzaketa plataformak bere komisioak izan ditzake.',
...
//# sourceMappingURL=SK73pusS.js.map
