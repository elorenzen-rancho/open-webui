const e = 'Σχετικά',
	...
	Fr = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 για απεριόριστο, ή έναν θετικό ακέραιο για ένα συγκεκριμένο όριο',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' ή '-1' για απεριόριστο.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(π.χ. `sh webui.sh --api --api-auth username_password`)',
		'(e.g. `sh webui.sh --api`)': '(π.χ. `sh webui.sh --api`)',
		'(latest)': '(τελευταία)',
		'(leave blank for to use commercial endpoint)':
			'(αφήστε κενό για να χρησιμοποιήσετε εμπορικό endpoint)',
		'[Last] dddd [at] h:mm A': '',
		'[Today at] h:mm A': '',
		'[Yesterday at] h:mm A': '',
		'{{ models }}': '{{ models }}',
		...
		'*Prompt node ID(s) are required for image generation':
			'*Τα αναγνωριστικά κόμβου Prompt απαιτούνται για τη δημιουργία εικόνων',
		'1 hour before': '',
		'1 Source': '',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Μια νέα έκδοση (v{{LATEST_VERSION}}) είναι τώρα διαθέσιμη.',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Ένα μοντέλο εργασίας χρησιμοποιείται κατά την εκτέλεση εργασιών όπως η δημιουργία τίτλων για συνομιλίες και αναζητήσεις στο διαδίκτυο',
		'a user': 'ένας χρήστης',
		About: e,
		...
		'Action Required for Chat Log Storage':
			'Απαιτείται ενέργεια για την αποθήκευση του αρχείου συνομιλίας',
		Actions: a,
		Activate: s,
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Ενεργοποιήστε αυτή την εντολή πληκτρολογώντας "/{{COMMAND}}" στο πεδίο συνομιλίας.',
		Active: r,
		...
		'Add a short description about what this model does':
			'Προσθήκη σύντομης περιγραφής για το τι κάνει αυτό το μοντέλο',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Η ρύθμιση αυτών των παραμέτρων θα εφαρμόσει τις αλλαγές καθολικά σε όλους τους χρήστες.',
		admin: c,
		Admin: d,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Οι διαχειριστές έχουν πρόσβαση σε όλα τα εργαλεία ανά πάσα στιγμή· οι χρήστες χρειάζονται εργαλεία ανά μοντέλο στον χώρο εργασίας.',
		Advanced: u,
		...
		'Allowed file extensions for upload. Separate multiple extensions with commas. Leave empty for all file types.':
			'Επιτρεπόμενες επεκτάσεις αρχείων για ανέβασμα. Διαχωρίστε πολλαπλές επεκτάσεις με κόμματα. Αφήστε κενό για όλους τους τύπους αρχείων.',
		...
		'applies to all users with the "user" role':
			'εφαρμόζεται σε όλους τους χρήστες με το ρόλο "user"',
		April: b,
		Archive: S,
		'Archive All': '',
		...
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Είστε σίγουροι ότι θέλετε να διαγράψετε όλες τις μνήμες; Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.',
		'Are you sure you want to delete "{{NAME}}"?': '',
		'Are you sure you want to delete **{{modelName}}**?': '',
		'Are you sure you want to delete all chats? This action cannot be undone.': '',
		'Are you sure you want to delete this channel?':
			'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτό το κανάλι;',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Είστε σίγουροι ότι θέλετε να απο-αρχειοθετήσετε όλες τις αρχειοθετημένες συνομιλίες;',
		...
		'Autocomplete Generation Input Max Length':
			'Μέγιστο Μήκος Εισόδου Δημιουργίας Αυτόματης Συμπλήρωσης',
		Automatic1111: M,
		...
		'Call feature is not supported when using Web STT engine':
			'Η λειτουργία κλήσης δεν υποστηρίζεται όταν χρησιμοποιείται η μηχανή Web STT',
		Camera: j,
		Cancel: Q,
		...
		'Character limit for autocomplete generation input':
			'Όριο χαρακτήρων για αυτόματη συμπλήρωση εισαγωγής',
		...
		'Click here to download user import template file.':
			'Κάντε κλικ εδώ για να κατεβάσετε το αρχείο προτύπου εισαγωγής χρήστη.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Κάντε κλικ εδώ για να μάθετε περισσότερα σχετικά με το faster-whisper και να δείτε τα διαθέσιμα μοντέλα.',
		...
		'Click here to upload a workflow.json file.':
			'Κάντε κλικ εδώ για να ανεβάσετε ένα αρχείο workflow.json.',
		'click here.': 'κλικ εδώ.',
		"Click on the user role button to change a user's role.":
			'Κάντε κλικ στο κουμπί ρόλου χρήστη για να αλλάξετε το ρόλο ενός χρήστη.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Άρνηση δικαιώματος εγγραφής στο πρόχειρο. Παρακαλώ ελέγξτε τις ρυθμίσεις του περιηγητή σας για να δώσετε την απαραίτητη πρόσβαση.',
		Clone: le,
		...
		'Connect to your own OpenAPI compatible external tool servers.':
			'Συνδεθείτε στους δικούς σας διακομιστές εξωτερικών εργαλείων συμβατών με OpenAPI.',
		'Connected ({{type}})': '',
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Έλεγχος πώς διαχωρίζεται το κείμενο του μηνύματος για αιτήματα TTS. Το 'Στίξη' διαχωρίζει σε προτάσεις, οι 'παραγράφοι' σε παραγράφους, και το 'κανένα' κρατά το μήνυμα ως μια αλυσίδα.",
		...
		'Copied shared chat URL to clipboard!':
			'Αντιγράφηκε το URL της κοινόχρηστης συνομιλίας στο πρόχειρο!',
		...
		'Default action buttons will be used.':
			'Θα χρησιμοποιηθούν οι προεπιλεγμένες ενέργειες των κουμπιών.',
		...
		'Default permissions updated successfully':
			'Τα προεπιλεγμένα δικαιώματα ενημερώθηκαν με επιτυχία',
		'Default Prompt Suggestions': 'Προεπιλεγμένες Προτεινόμενες Προτροπές',
		'Default to 389 or 636 if TLS is enabled':
			'Προεπιλογή στο 389 ή 636 εάν είναι ενεργοποιημένο το TLS',
		'Default to ALL': 'Προεπιλογή σε ΟΛΑ',
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			'Η προεπιλογή είναι η τμηματοποιημένη ανάκτηση για στοχευμένη και σχετική εξαγωγή περιεχομένου, κάτι που συνιστάται στις περισσότερες περιπτώσεις.',
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'Οι Άμεσες Συνδέσεις επιτρέπουν στους χρήστες να συνδέσουν τα δικά τους API endpoints συμβατά με OpenAI.',
		'Direct Message': '',
		'Direct Tool Servers': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			'Εξερευνήστε πως να χρησιμοποιήσετε το Open WebUI και αναζητήστε βοήθεια στην κοινότητα.',
		'Discover wonders': 'Ανακάλυψη θαυμάτων',
		'Discover, download, and explore custom functions':
			'Ανακαλύψτε, κατεβάστε και εξερευνήστε προσαρμοσμένες λειτουργίες',
		'Discover, download, and explore custom prompts':
			'Ανακαλύψτε, κατεβάστε και εξερευνήστε προσαρμοσμένες προτροπές',
		'Discover, download, and explore custom tools':
			'Ανακαλύψτε, κατεβάστε και εξερευνήστε προσαρμοσμένα εργαλεία',
		'Discover, download, and explore model presets':
			'Ανακαλύψτε, κατεβάστε και εξερευνήστε προκαθορισμένα μοντέλα',
		...
		'Display Multi-model Responses in Tabs':
			'Εμφάνιση Απαντήσεων Πολυτροπικών Μοντέλων στις Καρτέλες',
		'Display the username instead of You in the Chat':
			'Εμφάνιση του ονόματος χρήστη αντί του Εσάς στη Συνομιλία',
		...
		'Displays status updates (e.g., web search progress) in the response':
			'Εμφανίζει ενημερώσεις κατάστασης (π.χ. πρόοδο αναζήτησης στο διαδίκτυο) στην απάντηση',
		'Dive into knowledge': 'Βυθιστείτε στη γνώση',
		'Do not install functions from sources you do not fully trust.':
			'Μην εγκαθιστάτε λειτουργίες από πηγές που δεν εμπιστεύεστε πλήρως.',
		'Do not install tools from sources you do not fully trust.':
			'Μην εγκαθιστάτε εργαλεία από πηγές που δεν εμπιστεύεστε πλήρως.',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'δεν κάνει καμία εξωτερική σύνδεση, και τα δεδομένα σας παραμένουν ασφαλή στον τοπικά φιλοξενούμενο διακομιστή σας.',
		'Domain Filter List': 'Λίστα Φίλτρων Domain',
		"don't fetch random pipelines from sources you don't trust.":
			'Μην ανακτάτε τυχαία pipelines από μη αξιόπιστες πηγές.',
		"Don't have an account?": 'Δεν έχετε λογαριασμό;',
		"don't install random functions from sources you don't trust.":
			'μην εγκαθιστάτε τυχαίες λειτουργίες από πηγές που δεν εμπιστεύεστε.',
		"don't install random tools from sources you don't trust.":
			'μην εγκαθιστάτε τυχαία εργαλεία από πηγές που δεν εμπιστεύεστε.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"π.χ. '30s','10m'. Οι έγκυρες μονάδες χρόνου είναι 's', 'm', 'h'.",
		"e.g. 'low', 'medium', 'high'": '',
		'e.g. "json" or a JSON schema': 'π.χ. "json" ή ένα JSON σχήμα',
		'e.g. 60': 'π.χ. 60',
		'e.g. A filter to remove profanity from text':
			'π.χ. Ένα φίλτρο για να αφαιρέσετε βρισιές από το κείμενο',
		...
		'e.g. Tools for performing various operations':
			'π.χ. Εργαλεία για την εκτέλεση διάφορων λειτουργιών',
		...
		'e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)':
			'π.χ. audio/wav,audio/mpeg,video/* (αφήστε κενό για προεπιλογή)',
		'e.g., en-US,ja-JP (leave blank for auto-detect)':
			'π.χ. en-US,ja-JP (αφήστε κενό για αυτόματη ανίχνευση)',
		...
		'Enable autocomplete generation for chat messages':
			'Ενεργοποίηση αυτόματης συμπλήρωσης για συνομιλίες',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Βεβαιωθείτε ότι το αρχείο CSV σας περιλαμβάνει 4 στήλες με αυτή τη σειρά: Όνομα, Email, Κωδικός, Ρόλος.',
		'Enter {{role}} message here': 'Εισάγετε το μήνυμα {{role}} εδώ',
		'Enter a detail about yourself for your LLMs to recall':
			'Εισάγετε μια λεπτομέρεια για τον εαυτό σας ώστε τα LLMs να την ανακαλούν',
		...
		'Enter api auth string (e.g. username:password)':
			'Εισάγετε τη σειρά επαλήθευσης api (π.χ. username:password)',
		...
		'Enter External Document Loader API Key':
			'Εισάγετε το API κλειδί του εξωτερικού προγράμματος φόρτωσης εγγράφων',
		'Enter External Document Loader URL':
			'Εισάγετε το URL του εξωτερικού προγράμματος φόρτωσης εγγράφων',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Εισάγετε URL διακομιστή μεσολάβησης (π.χ. https://user:password@host:port)',
		...
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'Εισάγετε το δημόσιο URL του WebUI σας. Αυτό το URL θα χρησιμοποιηθεί για να παράξει συνδέσμους στις ειδοποιήσεις.',
		...
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			'Εισάγετε το URL του Yacy (π.χ. http://yacy.example.com:8090)',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Παράδειγμα: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Παράδειγμα: sAMAccountName ή uid ή userPrincipalName',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			'Υπερβαίνετε τον αριθμό των θέσεων στην άδειά σας. Επικοινωνήστε με την υποστήριξη για να αυξήσετε τον αριθμό των θέσεων.',
		Exclude: ft,
		'Execute code': '',
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'Αποτυχία σύνδεσης στο διακομιστή εργαλείων OpenAPI {{URL}}',
		...
		'Feel free to add specific details':
			'Νιώστε ελεύθεροι να προσθέσετε συγκεκριμένες λεπτομέρειες',
		Female: Ut,
		...
		'File size should not exceed {{maxSize}} MB.':
			'Το μέγεθος του αρχείου δεν πρέπει να υπερβαίνει τα {{maxSize}} MB.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Εντοπίστηκε spoofing δακτυλικού αποτυπώματος: Αδυναμία χρήσης αρχικών ως avatar. Χρήση της προεπιλεγμένης εικόνας προφίλ.',
		...
		'Functions allow arbitrary code execution.':
			'Οι λειτουργίες επιτρέπουν την εκτέλεση αυθαίρετου κώδικα.',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Αναγνωρίζω ότι έχω διαβάσει και κατανοώ τις συνέπειες της ενέργειάς μου. Γνωρίζω τους κινδύνους που σχετίζονται με την εκτέλεση αυθαίρετου κώδικα και έχω επαληθεύσει την αξιοπιστία της πηγής.',
		ID: mo,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Συμπεριλάβετε το flag `--api-auth` όταν τρέχετε το stable-diffusion-webui',
		'Include `--api` flag when running stable-diffusion-webui':
			'Συμπεριλάβετε το flag `--api` όταν τρέχετε το stable-diffusion-webui',
		...
		'Inject the entire content as context for comprehensive processing, this is recommended for complex queries.':
			'Εισάγετε ολόκληρο το περιεχόμενο ως συμφραζόμενο για ολοκληρωμένη επεξεργασία. Αυτό συνιστάται για σύνθετα ερωτήματα.',
		Input: bo,
		...
		'Instant Auto-Send After Voice Transcription':
			'Άμεση Αυτόματη Αποστολή μετά τη μεταγραφή φωνής',
		Instructions: vo,
		Integration: Io,
		Integrations: Co,
		Interface: Po,
		...
		'Learn more about OpenAPI tool servers.':
			'Μάθετε περισσότερα για τους διακομιστές εργαλείων OpenAPI.',
		...
		'Leave empty to include all models from "{{url}}" endpoint':
			'Αφήστε κενό για να χρησιμοποιήσετε όλα τα μοντέλα από το endpoint "{{url}}"',
		'Leave empty to include all models from "{{url}}/api/tags" endpoint':
			'Αφήστε κενό για να χρησιμοποιήσετε όλα τα μοντέλα από το endpoint "{{url}}/api/tags"',
		'Leave empty to include all models from "{{url}}/models" endpoint':
			'Αφήστε κενό για να χρησιμοποιήσετε όλα τα μοντέλα από το endpoint "{{url}}/models"',
		'Leave empty to include all models or select specific models':
			'Αφήστε κενό για να χρησιμοποιήσετε όλα τα μοντέλα ή επιλέξτε συγκεκριμένα μοντέλα',
		...
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Αφήστε κενό για να χρησιμοποιήσετε την προεπιλεγμένη προτροπή, ή εισάγετε μια προσαρμοσμένη προτροπή',
		...
		'LLMs can make mistakes. Verify important information.':
			'Τα LLM μπορούν να κάνουν λάθη. Επαληθεύστε σημαντικές πληροφορίες.',
		Loader: Go,
		'Loading Kokoro.js...': '',
		'Loading...': 'Φόρτωση...',
		local: Vo,
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Βεβαιωθείτε ότι εξάγετε ένα αρχείο workflow.json ως μορφή API από το ComfyUI.',
		Male: jo,
		Manage: Qo,
		'Manage Connections': '',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Μέγιστο των 3 μοντέλων μπορούν να κατεβούν ταυτόχρονα. Παρακαλώ δοκιμάστε ξανά αργότερα.',
		May: $o,
		MBR: en,
		MCP: tn,
		...
		'Memories accessible by LLMs will be shown here.':
			'Οι αναμνήσεις προσβάσιμες από τα LLMs θα εμφανιστούν εδώ.',
		Memory: rn,
		...
		'Message rating should be enabled to use this feature':
			'Η αξιολόγηση μηνυμάτων πρέπει να είναι ενεργοποιημένη για να χρησιμοποιήσετε αυτή τη λειτουργία',
		messages: cn,
		Messages: dn,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Τα μηνύματα που στέλνετε μετά τη δημιουργία του συνδέσμου σας δεν θα κοινοποιηθούν. Οι χρήστες με το URL θα μπορούν να δουν τη συνομιλία που μοιραστήκατε.',
		'Microsoft OneDrive': '',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Το μοντέλο '{{modelName}}' κατεβάστηκε με επιτυχία.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Το μοντέλο '{{modelTag}}' βρίσκεται ήδη στην ουρά για λήψη.",
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': '',
		'Model {{modelName}} is not vision capable':
			'Το μοντέλο {{modelName}} δεν έχει δυνατότητα όρασης',
		...
		'Model can execute code and perform calculations':
			'Το μοντέλο μπορεί να εκτελεί κώδικα και υπολογισμούς',
		'Model can generate images based on text prompts':
			'Το μοντέλο μπορεί να δημιουργήσει εικόνες βασισμένες σε προτροπές κειμένου',
		'Model can search the web for information':
			'Το μοντέλο μπορεί να αναζητήσει πληροφορίες στο διαδίκτυο',
		'Model Capabilities': '',
		'Model created successfully!': 'Το μοντέλο δημιουργήθηκε με επιτυχία!',
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Ανιχνεύθηκε διαδρομή αρχείου μοντέλου. Το σύντομο όνομα μοντέλου απαιτείται για ενημέρωση, δεν μπορεί να συνεχιστεί.',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Σημείωση: Αν ορίσετε ένα ελάχιστο score, η αναζήτηση θα επιστρέψει μόνο έγγραφα με score μεγαλύτερο ή ίσο με το ελάχιστο score.',
		Notes: Un,
		...
		'Only alphanumeric characters and hyphens are allowed':
			'Επιτρέπονται μόνο αλφαριθμητικοί χαρακτήρες και παύλες',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Επιτρέπονται μόνο αλφαριθμητικοί χαρακτήρες και παύλες στο string της εντολής.',
		'Only can be triggered when the chat input is in focus.': '',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Μόνο συλλογές μπορούν να επεξεργαστούν, δημιουργήστε μια νέα βάση γνώσης για επεξεργασία/προσθήκη εγγράφων.',
		'Only invited users can access': '',
		'Only markdown files are allowed': '',
		'Only select users and groups with permission can access':
			'Μόνο επιλεγμένοι χρήστες και ομάδες με άδεια μπορούν να έχουν πρόσβαση',
		'Only sync new/updated chats': '',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Ωχ! Φαίνεται ότι το URL είναι μη έγκυρο. Παρακαλώ ελέγξτε ξανά και δοκιμάστε.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Ωχ! Υπάρχουν αρχεία που εξακολουθούν να ανεβαίνουν. Παρακαλώ περιμένετε να ολοκληρωθεί η μεταφόρτωση.',
		'Oops! There was an error in the previous response.':
			'Ωχ! Υπήρξε σφάλμα στην προηγούμενη απάντηση.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Ωχ! Χρησιμοποιείτε μια μη υποστηριζόμενη μέθοδο (μόνο frontend). Παρακαλώ σερβίρετε το WebUI από το backend.',
		...
		'Open Modal To Manage Image Compression':
			'Άνοιγμα παραθύρου διαλόγου για διαχείριση συμπίεσης εικόνων',
		'Open Model Selector': '',
		'Open Settings': '',
		...
		'Open WebUI uses faster-whisper internally.':
			'Το Open WebUI χρησιμοποιεί το faster-whisper εσωτερικά.',
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Το Open WebUI χρησιμοποιεί τα SpeechT5 και CMU Arctic ενσωματώσεων ομιλητών.',
		'Open WebUI version': '',
		...
		'Permission denied when accessing media devices':
			'Άρνηση δικαιώματος κατά την πρόσβαση σε μέσα συσκευές',
		'Permission denied when accessing microphone':
			'Άρνηση δικαιώματος κατά την πρόσβαση σε μικρόφωνο',
		'Permission denied when accessing microphone: {{error}}':
			'Άρνηση δικαιώματος κατά την πρόσβαση σε μικρόφωνο: {{error}}',
		Permissions: ta,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Το Pipelines είναι ένα σύστημα προσθέτων με αυθαίρετη εκτέλεση κώδικα —',
		...
		'Please carefully review the following warnings:':
			'Παρακαλώ αναθεωρήστε προσεκτικά τις ακόλουθες προειδοποιήσεις:',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'Το ID Προθέματος χρησιμοποιείται για να αποφεύγονται συγκρούσεις με άλλες συνδέσεις προσθέτοντας ένα πρόθεμα στα IDs των μοντέλων - αφήστε κενό για απενεργοποίηση',
		...
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Αναφέρεστε στον εαυτό σας ως "User" (π.χ., "User μαθαίνει Ισπανικά")',
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Οι ειδοποιήσεις απάντησης δεν μπορούν να ενεργοποιηθούν καθώς οι άδειες του ιστότοπου έχουν αρνηθεί. Παρακαλώ επισκεφτείτε τις ρυθμίσεις του περιηγητή σας για να δώσετε την απαραίτητη πρόσβαση.',
		...
		'Selected model(s) do not support image inputs':
			'Τα επιλεγμένα μοντέλα δεν υποστηρίζουν είσοδο εικόνων',
		'Selected Models': '',
		semantic: es,
		Send: ts,
		...
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			'Ορίζει τις σειρές παύσης που θα χρησιμοποιηθούν. Όταν εντοπιστεί αυτό το μοτίβο, το LLM θα σταματήσει να δημιουργεί κείμενο και θα επιστρέψει. Πολλαπλά μοτίβα παύσης μπορούν να οριστούν καθορίζοντας πολλαπλές ξεχωριστές παραμέτρους παύσης σε ένα αρχείο μοντέλου.',
		Setting: as,
		Settings: ss,
		...
		'Share your background and interests':
			'Μοιραστείτε μερικά λόγια για εσάς, όπως τα ενδιαφέροντά σας',
		'Shared Chats': '',
		...
		'Show Admin Details in Account Pending Overlay':
			'Εμφάνιση Λεπτομερειών Διαχειριστή στο Υπέρθεση Εκκρεμής Λογαριασμού',
		'Show All': '',
		...
		'The Application Account DN you bind with for search':
			'Το DN του Λογαριασμού Εφαρμογής που συνδέετε για αναζήτηση',
		...
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Οι προγραμματιστές πίσω από αυτό το plugin είναι παθιασμένοι εθελοντές από την κοινότητα. Αν βρείτε αυτό το plugin χρήσιμο, παρακαλώ σκεφτείτε να συνεισφέρετε στην ανάπτυξή του.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Η κατάταξη αξιολόγησης βασίζεται στο σύστημα αξιολόγησης Elo και ενημερώνεται σε πραγματικό χρόνο.',
		'The format to return a response in. Format can be json or a JSON schema.': '',
		'The height in pixels to compress images to. Leave empty for no compression.':
			'Το ύψος σε pixel για συμπίεση εικόνων. Αφήστε κενό για να μην υπάρχει συμπίεση.',
		...
		'The LDAP attribute that maps to the username that users use to sign in.':
			'Το χαρακτηριστικό LDAP που αντιστοιχεί στο όνομα χρήστη που χρησιμοποιούν οι χρήστες για να συνδεθούν.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'Η κατάταξη είναι αυτή τη στιγμή σε δοκιμαστική φάση, και ενδέχεται να προσαρμόσουμε τους υπολογισμούς βαθμολογίας καθώς βελτιώνουμε τον αλγόριθμο.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'Το μέγιστο μέγεθος αρχείου σε MB. Αν το μέγεθος του αρχείου υπερβαίνει αυτό το όριο, το αρχείο δεν θα ανεβεί.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'Ο μέγιστος αριθμός αρχείων που μπορούν να χρησιμοποιηθούν ταυτόχρονα στη συνομιλία. Αν ο αριθμός των αρχείων υπερβαίνει αυτό το όριο, τα αρχεία δεν θα ανεβούν.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			'',
		"The passwords you entered don't quite match. Please double-check and try again.": '',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Η βαθμολογία θα πρέπει να είναι μια τιμή μεταξύ 0.0 (0%) και 1.0 (100%).',
		...
		'The width in pixels to compress images to. Leave empty for no compression.':
			'Το πλάτος σε πίξελ για συμπίεση εικόνων. Αφήστε κενό για να μην υπάρχει συμπίεση.',
		Theme: Ms,
		...
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Αυτό διασφαλίζει ότι οι πολύτιμες συνομιλίες σας αποθηκεύονται με ασφάλεια στη βάση δεδομένων backend σας. Ευχαριστούμε!',
		...
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Αυτή είναι μια πειραματική λειτουργία, μπορεί να μην λειτουργεί όπως αναμένεται και υπόκειται σε αλλαγές οποιαδήποτε στιγμή.',
		'This model is not publicly available. Please select another model.':
			'Αυτό το μοντέλο δεν είναι δημόσια διαθέσιμο. Επιλέξτε ένα άλλο μοντέλο.',
		...
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Αυτή η επιλογή θα διαγράψει όλα τα υπάρχοντα αρχεία στη συλλογή και θα τα αντικαταστήσει με νέα ανεβασμένα αρχεία.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Αυτό θα διαγράψει το <strong>{{NAME}}</strong> και <strong>όλο το περιεχόμενό του</strong>.',
		'This will delete all models including custom models':
			'Αυτό θα διαγράψει όλα τα μοντέλα, συμπεριλαμβανομένων των προσαρμοσμένων μοντέλων',
		'This will delete all models including custom models and cannot be undone.':
			'Αυτό θα διαγράψει όλα τα μοντέλα, συμπεριλαμβανομένων των προσαρμοσμένων μοντέλων και δεν μπορεί να αναιρεθεί.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Αυτό θα επαναφέρει τη βάση γνώσης και θα συγχρονίσει όλα τα αρχεία. Θέλετε να συνεχίσετε;',
		...
		'To access the available model names for downloading,':
			'Για να αποκτήσετε πρόσβαση στα διαθέσιμα ονόματα μοντέλων για λήψη,',
		'To access the GGUF models available for downloading,':
			'Για να αποκτήσετε πρόσβαση στα μοντέλα GGUF διαθέσιμα για λήψη,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'Για να αποκτήσετε πρόσβαση στο WebUI, παρακαλώ επικοινωνήστε με τον διαχειριστή. Οι διαχειριστές μπορούν να διαχειριστούν τις καταστάσεις των χρηστών από τον Πίνακα Διαχειριστή.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Για να επισυνάψετε τη βάση γνώσης εδώ, προσθέστε τα πρώτα στον χώρο εργασίας "Γνώση".',
		'To learn more about available endpoints, visit our documentation.':
			'Για να μάθετε περισσότερα για τα διαθέσιμα endpoints, δείτε την τεκμηρίωσή μας.',
		'To select skills here, add them to the "Skills" workspace first.': '',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Για να επιλέξετε toolkits εδώ, προσθέστε τα πρώτα στον χώρο εργασίας "Εργαλεία".',
		...
		'Tools are a function calling system with arbitrary code execution':
			'Τα εργαλεία είναι ένα σύστημα κλήσης λειτουργιών με αυθαίρετη εκτέλεση κώδικα',
		'Tools Function Calling Prompt': 'Προτροπή Κλήσης Εργαλείων Λειτουργιών',
		'Tools have a function calling system that allows arbitrary code execution.':
			'Τα εργαλεία διαθέτουν ένα σύστημα κλήσης λειτουργιών που επιτρέπει την αυθαίρετη εκτέλεση κώδικα.',
		...
		'Try adjusting your search or filter to find what you are looking for.':
			'Δοκιμάστε να προσαρμόσετε την αναζήτηση ή το φίλτρο για να βρείτε αυτό που ψάχνετε.',
		'Try Again': '',
		...
		'Uh-oh! There was an issue with the response.':
			'Ωχ! Παρουσιάστηκε κάποιο σφάλμα με την απάντηση.',
		UI: Qs,
		'UI Scale': '',
		...
		'Update for the latest features and improvements.':
			'Ενημερωθείτε για τις τελευταίες λειτουργίες και βελτιώσεις.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Αναβαθμίστε σε ένα πακέτο με άδεια χρήσης για βελτιωμένες λειτουργίες, συμπεριλαμβανομένων προσαρμοσμένων θεμάτων και branding, και ειδικής υποστήριξης.',
		Upload: ar,
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Χρησιμοποιήστε '#' στην είσοδο προτροπής για φόρτωση και συμπερίληψη της γνώσης σας.",
		...
		'Use no proxy to fetch page contents.':
			'Μη χρήση διακομιστή μεσολάβησης για λήψη περιεχομένου σελίδων.',
		'Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.':
			'Χρήση διακομιστή μεσολάβησης προορισμένο από τις http_proxy και https_proxy μεταβλητές περιβάλλοντος για λήψη περιεχομένου σελίδων.',
		user: lr,
		User: cr,
		'User Activity': '',
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Χρησιμοποιώντας το προεπιλεγμένο μοντέλο arena με όλα τα μοντέλα. Κάντε κλικ στο κουμπί συν για να προσθέσετε προσαρμοσμένα μοντέλα.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Έκδοση {{selectedVersion}} από {{totalVersions}}',
		'Version deleted': '',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Προειδοποίηση: Η ενεργοποίηση αυτού θα επιτρέψει στους χρήστες να ανεβάσουν αυθαίρετο κώδικα στον διακομιστή.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			'Προειδοποίηση: Η εκτέλεση του Jupyter επιτρέπει την εκτέλεση αυθαίρετου κώδικα, γεγονός που θέτει σοβαρούς κινδύνους ασφαλεία - προχωρήστε με εξαιρετική προσοχή.',
		We_day_of_week: Sr,
		Web: vr,
		'Web API': '',
		...
		'WebUI will make requests to "{{url}}/api/chat"':
			'Το WebUI θα κάνει αιτήματα στο "{{url}}/api/chat"',
		'WebUI will make requests to "{{url}}/chat/completions"':
			'Το WebUI θα κάνει αιτήματα στο "{{url}}/chat/completions"',
		Week: Cr,
		Weekly: Pr,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			'Όταν ενεργοποιηθεί, το μοντέλο θα ανταποκρίνεται σε κάθε μήνυμα συνομιλίας σε πραγματικό χρόνο, δημιουργώντας μια απάντηση μόλις ο χρήστης στείλει ένα μήνυμα. Αυτή η λειτουργία είναι χρήσιμη για εφαρμογές ζωντανής συνομιλίας, αλλά μπορεί να επηρεάσει την απόδοση σε πιο αργό υλικό.',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Γράψτε μια περίληψη σε 50 λέξεις που συνοψίζει [θέμα ή λέξη-κλειδί].',
...
π.χ.: Είστε ο Mario από το Super Mario Bros και ενεργείτε ως βοηθός.`,
		...
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Μπορείτε να συνομιλήσετε μόνο με μέγιστο αριθμό {{maxCount}} αρχείου(-ων) ταυτόχρονα.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Μπορείτε να προσωποποιήσετε τις αλληλεπιδράσεις σας με τα LLMs προσθέτοντας αναμνήσεις μέσω του κουμπιού 'Διαχείριση' παρακάτω, κάνοντάς τα πιο χρήσιμα και προσαρμοσμένα σε εσάς.",
		...
		'Your account status is currently pending activation.':
			'Η κατάσταση του λογαριασμού σας είναι αυτή τη στιγμή σε εκκρεμότητα ενεργοποίησης.',
...
//# sourceMappingURL=Y0WuXtgl.js.map
