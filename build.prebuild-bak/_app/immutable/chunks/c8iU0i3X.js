const a = 'Maidir',
	...
	xr = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 gan teorainn, nó slánuimhir dheimhneach le haghaidh teorann sonrach',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' nó '-1' gan aon éag.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(m.sh. `sh webui.sh --api --api-auth username_password `)',
		'(e.g. `sh webui.sh --api`)': '(m.sh. `sh webui.sh --api`)',
		'(latest)': '(is déanaí)',
		'(leave blank for to use commercial endpoint)':
			'(fág bán le haghaidh críochphointe tráchtála a úsáid)',
		...
		'*Prompt node ID(s) are required for image generation':
			'* Tá ID(anna) nód treorach ag teastáil chun íomhá a ghiniúint',
		'1 hour before': '',
		'1 Source': '1 Foinse',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A collaboration channel where people join as members':
			'Cainéal comhoibrithe ina mbíonn daoine ag glacadh páirte mar bhaill',
		'A discussion channel where access is controlled by groups and permissions':
			'Cainéal plé ina bhfuil rochtain rialaithe ag grúpaí agus ceadanna',
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Tá leagan nua (v {{LATEST_VERSION}}) ar fáil anois.',
		'A private conversation between you and selected users':
			'Comhrá príobháideach idir tú féin agus úsáideoirí roghnaithe',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Úsáidtear samhail tascanna agus tascanna á ndéanamh amhail teidil a ghiniúint le haghaidh comhráite agus fiosrúcháin chuardaigh ghréasáin',
		'a user': 'úsáideoir',
		About: a,
...
Léim go dtí Athróg na Treorach`,
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Gníomhachtaigh an t-ordú seo trí "/{{COMMAND}}" a chlóscríobh chun ionchur comhrá a dhéanamh.',
		Active: r,
		...
		'Add a short description about what this model does':
			'Cuir cur síos gairid leis faoi na rudaí a dhéanann an tsamhail seo',
		...
		'Add your Open Terminal URL and API key in Settings → Integrations.':
			'Cuir d’URL Teirminéal Oscailte agus d’eochair API leis i Socruithe → Comhtháthúcháin.',
		...
		'Adds filenames, titles, sections, and snippets into the BM25 text to improve lexical recall.':
			'Cuireann sé ainmneacha comhad, teidil, rannóga, agus sleachta isteach sa téacs BM25 chun athghairm léacsach a fheabhsú.',
		'Adjusting these settings will apply changes universally to all users.':
			'Cuirfear na socruithe seo ag coigeartú athruithe go huilíoch ar gach úsáideoir.',
		admin: l,
		Admin: c,
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Bíonn rochtain ag riarthóirí ar na huirlisí go léir i gcónaí; teastaíonn ó úsáideoirí uirlisí a shanntar de réir samhail sa spás oibre.',
		Advanced: d,
		...
		'Advanced parameters for MinerU parsing (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)':
			'Paraiméadair ardleibhéil le haghaidh parsáil MinerU (enable_ocr, enable_formula, enable_table, language, model_version, page_ranges)',
		...
		'After updating or changing the embedding model, you must reindex the knowledge base for the changes to take effect. You can do this using the "Reindex" button below.':
			'Tar éis duit an tsamhail leabaithe a nuashonrú nó a athrú, ní mór duit an bunachar eolais a athinnéacsú chun go dtiocfaidh na hathruithe i bhfeidhm. Is féidir leat é seo a dhéanamh trí úsáid a bhaint as an gcnaipe "Athinnéacsú" thíos.',
		AI: m,
		All: u,
		...
		'Allowed file extensions for upload. Separate multiple extensions with commas. Leave empty for all file types.':
			'Síneadh comhaid ceadaithe le haghaidh uaslódála. Deighil il-síneadh le camóga. Fág folamh do gach cineál comhaid.',
		...
		'API Base URL for Datalab Marker service. Defaults to: https://www.datalab.to/api/v1/marker':
			'URL Bunúsach API do sheirbhís Marcóra Datalab. Réamhshocraithe go: https://www.datalab.to/api/v1/marker',
		'API Key': 'Eochair API',
		...
		'applies to all users with the "user" role':
			'baineann sé le gach úsáideoir a bhfuil an ról "úsáideoir" aige',
		April: S,
		Archive: y,
		...
		'Are you sure you want to archive all chats? This action cannot be undone.':
			'An bhfuil tú cinnte gur mian leat na comhráite go léir a chartlannú? Ní féidir an gníomh seo a chealú.',
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'An bhfuil tú cinnte gur mhaith leat na cuimhní go léir a ghlanadh? Ní féidir an gníomh seo a chealú.',
		'Are you sure you want to delete "{{NAME}}"?':
			'An bhfuil tú cinnte gur mian leat "{{NAME}}" a scriosadh?',
		'Are you sure you want to delete **{{modelName}}**?':
			'An bhfuil tú cinnte gur mian leat **{{modelName}}** a scriosadh?',
		'Are you sure you want to delete all chats? This action cannot be undone.':
			'An bhfuil tú cinnte gur mian leat na comhráite go léir a scriosadh? Ní féidir an gníomh seo a chealú.',
		'Are you sure you want to delete this channel?':
			'An bhfuil tú cinnte gur mhaith leat an cainéal seo a scriosadh?',
		'Are you sure you want to delete this connection? This action cannot be undone.':
			'An bhfuil tú cinnte gur mian leat an nasc seo a scriosadh? Ní féidir an gníomh seo a chealú.',
		'Are you sure you want to delete this memory? This action cannot be undone.':
			'An bhfuil tú cinnte gur mian leat an chuimhne seo a scriosadh? Ní féidir an gníomh seo a chealú.',
		...
		"Are you sure you want to delete this version? Child versions will be relinked to this version's parent.":
			'An bhfuil tú cinnte gur mian leat an leagan seo a scriosadh? Déanfar leaganacha linbh a athnascadh le tuismitheoir an leagain seo.',
		...
		'Are you sure you want to unarchive all archived chats?':
			'An bhfuil tú cinnte gur mhaith leat gach comhrá cartlainne a dhíchartlannú?',
		...
		'Automatically inject system tools in native function calling mode (e.g., timestamps, memory, chat history, notes, etc.)':
			'Uirlisí córais a instealladh go huathoibríoch i mód glaonna feidhme dúchais (m.sh., stampaí ama, cuimhne, stair comhrá, nótaí, srl.)',
		Automation: M,
		...
		'Base Model List Cache speeds up access by fetching base models only at startup or on settings save—faster, but may not show recent base model changes.':
			"Luasaíonn Taisce an Liosta Bunsamhail de rochtain trí bhunmhúnlaí a fháil ach amháin ag am tosaithe nó ar shocruithe a shábháil-níos tapúla, ach b'fhéidir nach dtaispeánfar athruithe bonnsamhail le déanaí.",
		Bearer: B,
		before: W,
		...
		'Boosting or penalizing specific tokens for constrained responses. Bias values will be clamped between -100 and 100 (inclusive). (Default: none)':
			'Treisiú nó pionós a ghearradh ar chomharthaí sonracha as freagraí srianta. Déanfar luachanna laofachta a chlampáil idir -100 agus 100 (san áireamh). (Réamhshocrú: ceann ar bith)',
		Brave: H,
		'Brave Search API Key': 'Eochair API Cuardaigh Brave',
		'Break down complex requests into trackable steps':
			'Bris síos iarratais chasta i gcéimeanna inrianaithe',
		...
		'Call feature is not supported when using Web STT engine':
			'Ní thacaítear le gné glaonna agus inneall Web STT á úsáid',
		Camera: z,
		Cancel: Q,
		...
		'Channel name must be less than 128 characters':
			'Ní mór ainm an chainéil a bheith níos lú ná 128 carachtar',
		...
		'Character limit for autocomplete generation input':
			'Teorainn charachtair le haghaidh ionchur giniúna uathchríochnaithe',
		...
		'Chunks smaller than this threshold will be merged with neighboring chunks when possible. Set to 0 to disable merging.':
			'Déanfar píosaí níos lú ná an tairseach seo a chumasc le píosaí comharsanacha nuair is féidir. Socraigh go 0 chun cumasc a dhíchumasú.',
		Ciphers: ta,
		Citation: ra,
		Citations: ha,
		...
		'Click here to download user import template file.':
			'Cliceáil anseo chun an comhad iompórtála úsáideora a íoslódáil.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Cliceáil anseo chun tuilleadh eolais a fháil faoi faster-whisper agus na samhlacha atá ar fáil a fheiceáil.',
		'Click here to see available models.':
			'Cliceáil anseo chun na samhlacha atá ar fáil a fheiceáil.',
		...
		'Click here to upload a workflow.json file.':
			'Cliceáil anseo chun comhad workflow.json a uaslódáil.',
		'click here.': 'cliceáil anseo.',
		"Click on the user role button to change a user's role.":
			'Cliceáil ar an gcnaipe ról úsáideora chun ról úsáideora a athrú.',
		...
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Diúltaíodh cead scríofa an ghearrthaisce. Seiceáil socruithe do bhrabhsálaí chun an rochtain riachtanach a dheonú.',
		Clone: sa,
		...
		'Collaboration channel where people join as members':
			'Cainéal comhoibrithe ina mbíonn daoine páirteach mar bhaill',
		Collapse: da,
		Collection: ma,
		Collections: ua,
		Color: ga,
		...
		'Comma separated Node Ids (e.g. 1 or 1,2)':
			'Aitheantóirí Nóid scartha le camóga (m.sh. 1 nó 1,2)',
		command: fa,
		Command: Ca,
		Comment: ba,
		...
		'Connect to Open Terminal instances to browse files and use them as always-on tools. Only one can be active at a time.':
			'Ceangail le cásanna Open Terminal chun comhaid a bhrabhsáil agus iad a úsáid mar uirlisí atá ar siúl i gcónaí. Ní féidir ach ceann amháin a bheith gníomhach ag an am céanna.',
		'Connect to Open Terminal instances. All users will have access to file browsing and terminal tools through these servers.':
			'Ceangail le cásanna Open Terminal. Beidh rochtain ag gach úsáideoir ar bhrabhsáil comhad agus uirlisí críochfoirt trí na freastalaithe seo.',
		'Connect to your own OpenAI compatible API endpoints.':
			'Ceangail le do chríochphointí API atá comhoiriúnach le OpenAI.',
		'Connect to your own OpenAPI compatible external tool servers.':
			'Ceangail le do fhreastalaithe uirlisí seachtracha atá comhoiriúnach le OpenAPI.',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			'Srianann iarracht ar réasúnaíocht a dhéanamh ar shamhlacha réasúnaíochta. Ní bhaineann ach le samhlacha réasúnaíochta ó sholáthraithe sonracha a thacaíonn le hiarracht réasúnaíochta.',
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Rialú conas a roinntear téacs teachtaireachta d'iarratais TTS. Roinneann 'poncaíocht' ina abairtí, scoilteann 'míreanna' i míreanna, agus coinníonn 'aon' an teachtaireacht mar shreang amháin.",
		'Control the repetition of token sequences in the generated text. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 1.1) will be more lenient. At 1, it is disabled.':
			'Rialú a dhéanamh ar athrá seichimh chomharthaí sa téacs ginte. Cuirfidh luach níos airde (m.sh., 1.5) pionós níos láidre ar athrá, agus beidh luach níos ísle (m.sh., 1.1) níos boige. Ag 1, tá sé díchumasaithe. (Réamhshocrú: 1.1)',
		Controls: Ra,
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			'Rialaíonn sé an chothromaíocht idir comhleanúnachas agus éagsúlacht an aschuir. Beidh téacs níos dírithe agus níos soiléire mar thoradh ar luach níos ísle.',
		...
		'Copied shared chat URL to clipboard!':
			'Cóipeáladh URL an chomhrá roinnte chuig an ngearrthaisce!',
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'Ní mór don soláthraí CORS a chumrú i gceart chun iarratais ó Open WebUI a cheadú.',
		...
		'Create and manage scheduled automations':
			'Cruthaigh agus bainistigh uathoibrithe sceidealaithe',
		...
		'Create scheduled prompts that run automatically on a recurring basis.':
			'Cruthaigh leideanna sceidealaithe a ritheann go huathoibríoch ar bhonn athfhillteach.',
		'Create your first note by clicking on the plus button below.':
			'Cruthaigh do chéad nóta trí chliceáil ar an gcnaipe móide thíos.',
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			'Oibríonn an mód réamhshocraithe le raon níos leithne samhlacha trí uirlisí a ghlaoch uair amháin roimh an bhforghníomhú. Úsáideann an modh dúchasach cumais ionsuite glaoite uirlisí an samhail, ach éilíonn sé go dtacóidh an tsamhail leis an ngné seo go bunúsach.',
		...
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			"Réamhshocrú maidir le haisghabháil deighilte d'eastóscadh ábhar dírithe agus ábhartha, moltar é seo i bhformhór na gcásanna.",
		...
		'Deployment names are required for Azure OpenAI':
			'Tá ainmneacha imscartha ag teastáil le haghaidh Azure OpenAI',
		Desc: Ka,
		...
		'Describe your knowledge base and objectives':
			'Déan cur síos ar do bhunachar eolais agus do chuspóirí',
		Description: Ya,
		Deselect: Va,
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			"Ligeann Connections Direct d'úsáideoirí ceangal lena gcríochphointí API féin atá comhoiriúnach le OpenAI.",
		...
		'Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.':
			'Díchumasaigh eastóscadh íomhánna ón PDF. Má tá Úsáid LLM cumasaithe, cuirfear fotheidil leis na híomhánna go huathoibríoch. Is é Bréag an réamhshocrú.',
		Disabled: qa,
		'Disconnect OAuth': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			'Faigh amach conas Open WebUI a úsáid agus lorg tacaíocht ón bpobal.',
		'Discover wonders': 'Faigh amach iontais',
		'Discover, download, and explore custom functions':
			'Faigh amach, íoslódáil agus iniúchadh feidhmeanna saincheaptha',
		'Discover, download, and explore custom prompts':
			'Faigh amach, íoslódáil agus iniúch treoracha saincheaptha',
		'Discover, download, and explore custom tools':
			'Faigh amach, íoslódáil agus taiscéal uirlisí saincheaptha',
		'Discover, download, and explore model presets':
			'Faigh amach, íoslódáil agus réamhshocruithe samhail a iniúchadh',
		'Discussion channel where access is based on groups and permissions':
			'Cainéal plé ina bhfuil rochtain bunaithe ar ghrúpaí agus ceadanna',
		Display: ja,
		...
		'Display the username instead of You in the Chat':
			'Taispeáin an t-ainm úsáideora in ionad Tú sa Comhrá',
		...
		'Displays status updates (e.g., web search progress) in the response':
			'Taispeánann sé nuashonruithe stádais (m.sh., dul chun cinn cuardaigh gréasáin) sa fhreagra',
		'Dive into knowledge': 'Léim isteach eolas',
		'Do not install functions from sources you do not fully trust.':
			'Ná suiteáil feidhmeanna ó fhoinsí nach bhfuil muinín iomlán agat.',
		'Do not install tools from sources you do not fully trust.':
			'Ná suiteáil uirlisí ó fhoinsí nach bhfuil muinín iomlán agat.',
		'Do you want to sync your usage stats with Open WebUI Community?':
			'Ar mhaith leat do staitisticí úsáide a shioncronú le Pobal Open WebUI?',
		Docling: za,
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'ní dhéanann sé aon naisc sheachtracha, agus fanann do chuid sonraí go slán ar do fhreastalaí a óstáiltear go háitiúil.',
		'Domain Filter List': 'Liosta Scagairí Fearainn',
		"don't fetch random pipelines from sources you don't trust.":
			'ná faigh píblínte randamacha ó fhoinsí nach bhfuil muinín agat astu.',
		"Don't have an account?": 'Níl cuntas agat?',
		"don't install random functions from sources you don't trust.":
			'ná suiteáil feidhmeanna randamacha ó fhoinsí nach bhfuil muinín agat.',
		"don't install random tools from sources you don't trust.":
			'ná suiteáil uirlisí randamacha ó fhoinsí nach bhfuil muinín agat.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"m.sh. '30s', '10m'. Is iad aonaid ama bailí ná 's', 'm', 'h'.",
		...
		'e.g. A filter to remove profanity from text':
			'm.sh. Scagaire chun profanity a bhaint as téacs',
		...
		'e.g. Step-by-step instructions for code reviews':
			'm.sh. Treoracha céim ar chéim le haghaidh athbhreithnithe cóid',
		'e.g. Tell me a fun fact': 'm.sh. Inis dom fíric spraíúil',
		'e.g. Tell me a fun fact about the Roman Empire':
			'm.sh. Inis dom fíric spraíúil faoin Impireacht Rómhánach',
		'e.g. Tools for performing various operations':
			'm.sh. Uirlisí chun oibríochtaí éagsúla a dhéanamh',
		'e.g., 3, 4, 5 (leave blank for default)':
			'm.sh., 3, 4, 5 (fág bán le haghaidh réamhshocraithe)',
		'e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)':
			'm.sh., fuaim/wav, fuaim/mpeg, físeán/* (fág bán le haghaidh réamhshocruithe)',
		'e.g., en-US,ja-JP (leave blank for auto-detect)':
			'm.sh., en-US, ja-JP (fág bán le haghaidh uathbhraite)',
		...
		'Enable autocomplete generation for chat messages':
			'Cumasaigh giniúint uathchríochnaithe le haghaidh teachtaireachtaí comhrá',
		...
		'Enable, disable, or customize the reasoning tags used by the model. "Enabled" uses default tags, "Disabled" turns off reasoning tags, and "Custom" lets you specify your own start and end tags.':
			'Cumasaigh, díchumasaigh nó saincheap na clibeanna réasúnaíochta a úsáideann an tsamhail. Úsáideann "Cumasaithe" clibeanna réamhshocraithe, múchann "Díchumasaithe" clibeanna réasúnaíochta, agus ligeann "Saincheaptha" duit do chlibeanna tosaigh agus deiridh féin a shonrú.',
		Enabled: me,
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Déan cinnte go bhfuil 4 cholún san ord seo i do chomhad CSV: Ainm, Ríomhphost, Pasfhocal, Ról.',
		'Enter {{role}} message here': 'Cuir isteach teachtaireacht {{role}} anseo',
		'Enter a detail about yourself for your LLMs to recall':
			'Cuir isteach mionsonraí fút féin chun do LLManna a mheabhrú',
		'Enter a title for the pending user info overlay. Leave empty for default.':
			'Cuir isteach teideal don fhorleagan faisnéise úsáideora atá ar feitheamh. Fág folamh don réamhshocrú.',
		'Enter a watermark for the response. Leave empty for none.':
			'Cuir isteach comhartha uisce don fhreagra. Fág folamh mura bhfuil aon cheann ann.',
		'Enter additional headers in JSON format': 'Cuir ceanntásca breise isteach i bhformáid JSON',
		'Enter additional headers in JSON format (e.g. {"X-Custom-Header": "value"}':
			'Cuir isteach ceanntásca breise i bhformáid JSON (m.sh. {"X-Custom-Header": "value"}',
		'Enter additional parameters in JSON format':
			'Cuir isteach paraiméadair bhreise i bhformáid JSON',
		'Enter api auth string (e.g. username:password)':
			'Cuir isteach sreang auth api (m.sh. ainm úsáideora: pasfhocal)',
		...
		'Enter content for the pending user info overlay. Leave empty for default.':
			'Cuir isteach ábhar don fhorleagan faisnéise úsáideora atá ar feitheamh. Fág folamh don réamhshocrú.',
		...
		'Enter domains separated by commas (e.g., example.com,site.org,!excludedsite.com)':
			'Cuir isteach fearainn scartha le camóga (m.sh., example.com,site.org, !excludedsite.com)',
		'Enter Exa API Key': 'Cuir isteach Eochair Exa API',
		'Enter External Document Loader API Key':
			'Cuir isteach Eochair API Luchtaitheora Doiciméad Seachtrach',
		...
		'Enter function name filter list (e.g. func1, !func2)':
			'Cuir isteach ainm feidhme liosta scagaire (m.sh. func1, !func2)',
		...
		'Enter JSON config (e.g., {"disable_links": true})':
			'Cuir isteach cumraíocht JSON (m.sh., {"disable_links": true})',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Cuir isteach URL seachfhreastalaí (m.sh. https://user:password@host:port)',
		...
		'Enter the prompt instructions for this automation...':
			'Cuir isteach treoracha na treorach don uathoibriú seo...',
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'Cuir isteach URL poiblí do WebUI. Bainfear úsáid as an URL seo chun naisc a ghiniúint sna fógraí.',
		...
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			'Cuir isteach URL Yacy (m.sh. http://yacy.example.com:8090)',
		...
		'Error accessing Google Drive: {{error}}':
			'Earráid agus tú ag rochtain Google Drive: {{error}}',
		...
		"Error: A model with the ID '{{modelId}}' already exists. Please select a different ID to proceed.":
			"Earráid: Tá samhail leis an ID '{{modelId}}' ann cheana féin. Roghnaigh ID difriúil le dul ar aghaidh.",
		'Error: Model ID cannot be empty. Please enter a valid ID to proceed.':
			'Earráid: Ní féidir ID an tSamhail a fhágáil folamh. Cuir isteach ID bailí le dul ar aghaidh.',
		Evaluations: fe,
		'Event created': '',
		'Event deleted': '',
		'Event title': '',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Sampla: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Sampla: sAMAaccountName nó uid nó userPrincipalName',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			'Níos mó ná líon na suíochán i do cheadúnas. Déan teagmháil le do thoil le tacaíocht chun líon na suíochán a mhéadú.',
		Exclude: Ce,
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'Theip ar nascadh le {{URL}} freastalaí uirlisí OpenAPI',
		'Failed to connect to {{URL}} terminal server':
			'Theip ar cheangal le freastalaí críochfoirt {{URL}}',
		...
		'Failed to extract content from the file: {{error}}':
			'Theip ar an ábhar a bhaint as an gcomhad: {{error}}',
		...
		'Failed to load DOCX file. Please try downloading it instead.':
			'Theip ar an gcomhad DOCX a luchtú. Déan iarracht é a íoslódáil ina ionad.',
		'Failed to load Excel/CSV file. Please try downloading it instead.':
			'Theip ar an gcomhad Excel/CSV a lódáil. Déan iarracht é a íoslódáil ina ionad.',
		...
		'Failed to load PPTX file. Please try downloading it instead.':
			'Theip ar an gcomhad PPTX a luchtú. Déan iarracht é a íoslódáil ina ionad.',
		...
		'File size should not exceed {{maxSize}} MB.':
			'Níor chóir go mbeadh méid an chomhaid níos mó ná {{maxSize}} MB.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Braithíodh spoofing méarloirg: Ní féidir teachlitreacha a úsáid mar avatar. Réamhshocrú ar íomhá próifíle réamhshocraithe.',
		...
		'Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.':
			'Éirigh OCR a chur i bhfeidhm ar gach leathanach den PDF. Is féidir leis seo torthaí níos measa a bheith mar thoradh air má tá téacs maith i do PDFanna. Is é Bréag an rogha réamhshocraithe.',
		...
		'Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.':
			'Formáidigh na línte san aschur. Is é Bréag an réamhshocrú. Má shocraítear é go Fíor, déanfar na línte a fhormáidiú chun matamaitic agus stíleanna inlíne a bhrath.',
		'Formatting may be inconsistent from source.':
			'B’fhéidir nach bhfuil an fhormáidiú comhsheasmhach ón bhfoinse.',
		Forward: xe,
		'Forwards system user OAuth access token to authenticate':
			'Seolann sé comhartha rochtana OAuth úsáideora an chórais ar aghaidh chun fíordheimhniú a dhéanamh',
		'Forwards system user session credentials to authenticate':
			'Cuir dintiúir seisiúin úsáideora córais ar aghaidh lena bhfíordheimhniú',
		Fr_day_of_week: Ge,
		...
		'Get current time and perform date/time calculations':
			'Faigh an t-am reatha agus déan ríomhanna dáta/ama',
		...
		'Help the community discover great models':
			'Cabhraigh leis an bpobal samhlacha iontacha a aimsiú',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Admhaím gur léigh mé agus tuigim impleachtaí mo ghníomhaíochta. Táim ar an eolas faoi na rioscaí a bhaineann le cód treallach a fhorghníomhú agus tá iontaofacht na foinse fíoraithe agam.',
		ID: di,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Cuir bratach `--api-auth` san áireamh agus webui stable-diffusion-reatha á rith',
		'Include `--api` flag when running stable-diffusion-webui':
			'Cuir bratach `--api` san áireamh agus webui cobhsaí-scaipthe á rith',
		...
		'Influences how quickly the algorithm responds to feedback from the generated text. A lower learning rate will result in slower adjustments, while a higher learning rate will make the algorithm more responsive.':
			"Bíonn tionchar aige ar chomh tapa agus a fhreagraíonn an t-algartam d'aiseolas ón téacs ginte. Beidh coigeartuithe níos moille mar thoradh ar ráta foghlama níos ísle, agus déanfaidh ráta foghlama níos airde an t-algartam níos freagraí.",
		Info: Ci,
		Initials: bi,
		'Inject file content into conversation context':
			'Cuir ábhar an chomhaid isteach i gcomhthéacs an chomhrá',
		'Inject the entire content as context for comprehensive processing, this is recommended for complex queries.':
			'Instealladh an t-ábhar ar fad mar chomhthéacs do phróiseáil chuimsitheach, moltar é seo le haghaidh ceisteanna casta.',
		Input: Ai,
		'Input Key (e.g. text, unet_name, steps)':
			'Eochair Ionchuir (m.sh. téacs, unet_name, céimeanna)',
		...
		'Invalid JSON format for ComfyUI Edit Workflow.':
			'Formáid JSON neamhbhailí do Shreabhadh Oibre Eagarthóireachta ComfyUI.',
		'Invalid JSON format for ComfyUI Workflow.':
			'Formáid JSON neamhbhailí do Shreabhadh Oibre ComfyUI.',
		...
		'Learn more about OpenAPI tool servers.':
			'Foghlaim tuilleadh faoi fhreastalaithe uirlisí OpenAPI.',
		...
		'Leave empty to include all models from "{{url}}" endpoint':
			'Fág folamh chun gach samhail ó chríochphointe "{{url}}" a áireamh',
		'Leave empty to include all models from "{{url}}/api/tags" endpoint':
			'Fág folamh chun gach samhail ó chríochphointe "{{url}}/api/tags" a chur san áireamh',
		'Leave empty to include all models from "{{url}}/models" endpoint':
			'Fág folamh chun gach samhail ón gcríochphointe "{{url}}/models" a chur san áireamh',
		'Leave empty to include all models or select specific models':
			'Fág folamh chun gach samhail a chur san áireamh nó roghnaigh samhail sonracha',
		...
		'Leave empty to use the default config, or enter a valid json (see https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)':
			'Fág folamh chun an chumraíocht réamhshocraithe a úsáid, nó cuir isteach json bailí (féach https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)',
		'Leave empty to use the default model (voxtral-mini-latest).':
			'Fág folamh chun an tsamhail réamhshocraithe (voxtral-mini-latest) a úsáid.',
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Fág folamh chun an treoir réamhshocraithe a úsáid, nó cuir isteach treoir shaincheaptha',
		'Leave model field empty to use the default model.':
			'Fág an réimse samhail folamh chun an tsamhail réamhshocraithe a úsáid.',
		Legacy: ki,
		lexical: Oi,
		License: xi,
		...
		'Limit concurrent search queries. 0 = unlimited (default). Set to 1 for sequential execution (recommended for APIs with strict rate limits like Brave free tier).':
			'Teorainn a chur le fiosrúcháin chuardaigh chomhuaineacha. 0 = gan teorainn (réamhshocraithe). Socraigh go 1 le haghaidh forghníomhú seicheamhach (molta do APIanna le teorainneacha ráta dochta cosúil le sraith saor in aisce Brave).',
		'Limits the number of concurrent embedding requests. Set to 0 for unlimited.':
			'Cuireann sé teorainn le líon na n-iarratas leabaithe comhuaineach. Socraigh go 0 le haghaidh neamhtheoranta.',
		List: Bi,
		...
		'LLMs can make mistakes. Verify important information.':
			'Is féidir le LLManna botúin a dhéanamh. Fíoraigh faisnéis thábhachtach.',
		Loader: _i,
		...
		'Make password visible in the user interface':
			'Déan an focal faire le feiceáil sa chomhéadan úsáideora',
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Déan cinnte comhad workflow.json a onnmhairiú mar fhormáid API ó ComfyUI.',
		Male: ji,
		Manage: zi,
		...
		'Maximum characters to return from fetched URLs. Leave empty for no limit.':
			'Uasmhéid carachtair le tabhairt ar ais ó URLanna a fuarthas. Fág folamh le haghaidh gan teorainn.',
		'Maximum number of files allowed per folder.':
			'Uasmhéid na gcomhad a cheadaítear in aghaidh an fhillteáin.',
		'Maximum number of files per folder is {{max}}.':
			'Is é {{max}} an líon uasta comhad in aghaidh an fhillteáin.',
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Is féidir uasmhéid de 3 samhail a íoslódáil ag an am Bain triail as arís níos déanaí.',
		May: Xi,
		MBR: $i,
		MCP: an,
		'MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Open WebUI team, making it the more reliable option for compatibility.':
			'Is turgnamhach tacaíocht MCP agus athraítear a shonraíocht go minic, rud a d’fhéadfadh neamh-chomhoiriúnachtaí a bheith mar thoradh air. Déanann foireann Open WebUI cothabháil dhíreach ar thacaíocht sonraíochta OpenAPI, rud a fhágann gurb é an rogha is iontaofa é le haghaidh comhoiriúnachta.',
		Medium: en,
		...
		'Memories accessible by LLMs will be shown here.':
			'Taispeánfar cuimhní atá inrochtana ag LLManna anseo.',
		Memory: rn,
		...
		'Message counts and response timestamps':
			'Comhaireamh teachtaireachtaí agus stampaí ama freagartha',
		'Message counts are based on assistant responses.':
			'Tá comhaireamh teachtaireachtaí bunaithe ar fhreagraí an chúntóra.',
		'Message rating should be enabled to use this feature':
			'Ba cheart rátáil teachtaireachta a chumasú chun an ghné seo a úsáid',
		messages: sn,
		Messages: ln,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Ní roinnfear teachtaireachtaí a sheolann tú tar éis do nasc a chruthú. Beidh úsáideoirí leis an URL in ann féachaint ar an gcomhrá roinnte.',
		...
		'MinerU API Key required for Cloud API mode.':
			'Eochair API MinerU ag teastáil le haghaidh mód Cloud API.',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Rinneadh an tsamhail '{{modelName}}' a íoslódáil go rathúil.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Tá samhail '{{modelTag}}' sa scuaine cheana féin le híoslódáil.",
		...
		'Model can execute code and perform calculations':
			'Is féidir leis an tsamhail cód a fhorghníomhú agus ríomhaireachtaí a dhéanamh',
		'Model can generate images based on text prompts':
			'Is féidir leis an tsamhail íomhánna a ghiniúint bunaithe ar threoracha téacs',
		'Model can search the web for information':
			'Is féidir leis an tsamhail cuardach a dhéanamh ar an ngréasán le haghaidh faisnéise',
		'Model Capabilities': 'Cumais Samhail',
		'Model created successfully!': 'Cruthaíodh an tsamhail go rathúil!',
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Fuarthas cosán an samhail. Tá gearrainm an tsamhail ag teastáil le haghaidh nuashonraithe, ní féidir leanúint ar aghaidh.',
		...
		'Model name already exists, please choose a different one':
			'Tá ainm samhail ann cheana féin, roghnaigh ceann eile le do thoil',
		...
		'Name and ID are required, please fill them out':
			'Tá ainm agus aitheantas ag teastáil, líon isteach iad le do thoil',
		...
		'No expiration can pose security risks.':
			'Ní féidir le haon dáta éaga rioscaí slándála a chruthú.',
		...
		'No files yet. Upload files or run Python code to create them.':
			'Gan aon chomhaid fós. Uaslódáil comhaid nó rith cód Python chun iad a chruthú.',
		...
		'No HTML, CSS, or JavaScript content found.':
			'Níor aimsíodh aon ábhar HTML, CSS nó JavaScript.',
		'No inference engine with management support found':
			'Níor aimsíodh aon inneall tátail le tacaíocht bhainistíochta',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Nóta: Má shocraíonn tú íosscór, ní thabharfaidh an cuardach ach doiciméid a bhfuil scór níos mó ná nó cothrom leis an scór íosta ar ais.',
		Notes: En,
		...
		'Only active when "Paste Large Text as File" setting is toggled on.':
			'Gníomhach amháin nuair a bhíonn an socrú "Greamaigh Téacs Mór mar Chomhad" casta air.',
		'Only active when the chat input is in focus and an LLM is generating a response.':
			'Gníomhach ach amháin nuair a bhíonn an t-ionchur comhrá i bhfócas agus nuair a bhíonn LLM ag giniúint freagra.',
		'Only active when the chat input is in focus.':
			'Gníomhach ach amháin nuair a bhíonn an t-ionchur comhrá i bhfócas.',
		'Only alphanumeric characters and hyphens are allowed':
			'Ní cheadaítear ach carachtair alfa-uimhriúla agus fleiscíní',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Ní cheadaítear ach carachtair alfauméireacha agus braithíní sa sreangán ordaithe.',
		'Only can be triggered when the chat input is in focus.':
			'Ní féidir é a spreagadh ach amháin nuair a bhíonn an t-ionchur comhrá i bhfócas.',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Ní féidir ach bailiúcháin a chur in eagar, bonn eolais nua a chruthú chun doiciméid a chur in eagar/a chur leis.',
		...
		'Only select users and groups with permission can access':
			'Ní féidir ach le húsáideoirí roghnaithe agus le grúpaí a bhfuil cead acu rochtain a fháil',
		'Only sync new/updated chats': 'Sioncrónaigh comhráite nua/nuashonraithe amháin',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Ups! Is cosúil go bhfuil an URL neamhbhailí. Seiceáil faoi dhó le do thoil agus iarracht arís.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Úps! Tá comhaid fós á n-uaslódáil. Fan go mbeidh an uaslódáil críochnaithe.',
		'Oops! There was an error in the previous response.':
			'Úps! Bhí earráid sa fhreagra roimhe seo.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Ups! Tá modh gan tacaíocht á úsáid agat (tosaigh amháin). Freastal ar an WebUI ón gcúltaca le do thoil.',
		...
		'Open Modal To Manage Floating Quick Actions':
			'Oscail Modúl Chun Gníomhartha Tapa Snámhacha a Bhainistiú',
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			'Is féidir le WebUI Oscailte uirlisí a úsáid a sholáthraíonn aon fhreastalaí OpenAPI.',
		'Open WebUI uses faster-whisper internally.':
			'Úsáideann Open WebUI cogar níos tapúla go hinmheánach.',
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Úsáideann Open WebUI úsáidí SpeechT5 agus CMU leabaithe cainteoir Artach.',
		'Open WebUI version': 'Oscail leagan WebUI',
		'Open WebUI version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})':
			'Tá leagan WebUI oscailte (v{{OPEN_WEBUI_VERSION}}) níos ísle ná an leagan riachtanach (v{{REQUIRED_VERSION}})',
		OpenAI: xn,
		...
		'Page mode creates one document per page. Single mode combines all pages into one document for better chunking across page boundaries.':
			'Cruthaíonn mód leathanaigh doiciméad amháin in aghaidh an leathanaigh. Comhcheanglaíonn mód aonair na leathanaigh go léir in aon doiciméad amháin le haghaidh roinnt níos fearr trasna teorainneacha leathanaigh.',
		Paginate: jn,
		Parameters: zn,
		...
		'Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Open WebUI. Your privacy is paramount: no message content is ever shared.':
			'Glac páirt i gcláir cheannaireachta agus i meastóireachtaí pobail! Cuidíonn sioncrónú staitisticí úsáide comhiomlánaithe le taighde agus feabhsuithe a thiomáint ar Open WebUI. Tá do phríobháideacht ríthábhachtach: ní roinntear aon ábhar teachtaireachta riamh.',
		Password: Qn,
		...
		'Permission denied when accessing media devices':
			'Cead diúltaithe nuair a bhíonn rochtain agat',
		'Permission denied when accessing microphone': 'Cead diúltaithe agus tú ag rochtain ar',
		'Permission denied when accessing microphone: {{error}}':
			'Cead diúltaithe agus tú ag teacht ar mhicreafón: {{error}}',
		Permissions: ao,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Is córas breiseán é Pipelines a ligeann cód a rith go treallach —',
		...
		'Please carefully review the following warnings:':
			'Déan athbhreithniú cúramach ar na rabhaidh seo a leanas le do thoil:',
		'Please connect all required integrations before sending a message':
			'Ceangail na comhtháthúcháin riachtanacha go léir sula seoltar teachtaireacht',
		'Please do not close the settings page while loading the model.':
			'Ná dún leathanach na socruithe agus an tsamhail á luchtú.',
		'Please enter a message or attach a file.':
			'Cuir isteach teachtaireacht nó ceangail comhad le do thoil.',
		...
		'Please enter Client ID and Client Secret':
			'Cuir isteach ID Cliant agus Rún Cliant le do thoil',
		...
		'Please save the connection to persist the OAuth client information and do not change the ID':
			'Sábháil an nasc le go gcoimeádfar faisnéis an chliaint OAuth agus ná hathraigh an ID.',
		...
		'Please select at least one user for Direct Message channel.':
			'Roghnaigh úsáideoir amháin ar a laghad don chainéal Teachtaireachtaí Díreacha.',
		'Please wait until all files are uploaded.':
			'Fan go dtí go mbeidh na comhaid go léir uaslódáilte.',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'Úsáidtear Aitheantas Réimír chun coinbhleachtaí le naisc eile a sheachaint trí réimír a chur le haitheantas na samhla - fág folamh le díchumasú',
		...
		'Private conversation between selected users':
			'Comhrá príobháideach idir úsáideoirí roghnaithe',
		...
		'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative.':
			'Laghdaíonn sé an dóchúlacht go giniúint nonsense. Tabharfaidh luach níos airde (m.sh. 100) freagraí níos éagsúla, agus beidh luach níos ísle (m.sh. 10) níos coimeádaí.',
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Tagairt duit féin mar "Úsáideoir" (m.sh., "Tá an úsáideoir ag foghlaim Spáinnis")',
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Ní féidir fógraí freagartha a ghníomhachtú toisc gur diúltaíodh ceadanna an tsuímh Ghréasáin. Tabhair cuairt ar do shocruithe brabhsálaí chun an rochtain riachtanach a dheonú.',
		...
		'Runs embedding tasks concurrently to speed up processing. Turn off if rate limits become an issue.':
			'Ritheann sé tascanna leabaithe ag an am céanna chun luas a chur leis an bpróiseáil. Múch é má bhíonn teorainneacha ráta ina bhfadhb.',
		Sa_day_of_week: Jo,
		Save: qo,
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Ní thacaítear le logaí comhrá a shábháil go díreach chuig stóráil do bhrabhsálaí Tóg nóiméad chun do logaí comhrá a íoslódáil agus a scriosadh trí chliceáil an cnaipe thíos. Ná bíodh imní ort, is féidir leat do logaí comhrá a athiompórtáil go héasca chuig an gcúltaca trí',
		Schedule: zo,
		...
		'Searxng search language (all, en, es, de, fr, etc.)':
			'Teanga cuardaigh Searxng (gach, en, es, de, fr, etc.)',
		...
		'Select how to split message text for TTS requests':
			'Roghnaigh conas téacs teachtaireachta a roinnt le haghaidh iarratais TTS',
		...
		'Selected model(s) do not support image inputs':
			'Ní thacaíonn an/na samhlacha roghnaithe le hionchuir íomhá',
		...
		'Set the default models that are automatically selected for all users when a new chat is created.':
			'Socraigh na samhlacha réamhshocraithe a roghnaítear go huathoibríoch do gach úsáideoir nuair a chruthaítear comhrá nua.',
		'Set the models that are automatically pinned to the sidebar for all users.':
			'Socraigh na samhlacha a phionnáiltear go huathoibríoch leis an mbarra taoibh do gach úsáideoir.',
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			'Socraigh líon na sraitheanna a dhíluchtófar chuig an GPU. Má mhéadaítear an luach seo is féidir feabhas suntasach a chur ar fheidhmíocht samhlacha atá optamaithe le haghaidh luasghéarú GPU ach d’fhéadfadh go n-ídíonn siad níos mó cumhachta agus acmhainní GPU freisin.',
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Socraíonn sé claonadh cothrom i gcoinne comharthaí a tháinig chun solais uair amháin ar a laghad. Cuirfidh luach níos airde (m.sh., 1.5) pionós níos láidre ar athrá, agus beidh luach níos ísle (m.sh., 0.9) níos boige. Ag 0, tá sé díchumasaithe.',
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Socraíonn sé laofacht scálaithe i gcoinne comharthaí chun pionós a ghearradh ar athrá, bunaithe ar cé mhéad uair a tháinig siad chun solais. Cuirfidh luach níos airde (m.sh., 1.5) pionós níos láidre ar athrá, agus beidh luach níos ísle (m.sh., 0.9) níos boige. Ag 0, tá sé díchumasaithe.',
		'Sets how far back for the model to look back to prevent repetition.':
			'Socraíonn sé cé chomh fada siar is atá an tsamhail le breathnú siar chun athrá a chosc.',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			'Socraíonn sé an síol uimhir randamach a úsáid le haghaidh giniúna. Má shocraítear é seo ar uimhir shainiúil, ginfidh an tsamhail an téacs céanna don treoir céanna.',
		'Sets the size of the context window used to generate the next token.':
			'Socraíonn sé méid na fuinneoige comhthéacs a úsáidtear chun an chéad chomhartha eile a ghiniúint.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			'Socraíonn sé na stadanna le húsáid. Nuair a thagtar ar an bpatrún seo, stopfaidh an LLM ag giniúint téacs agus ag filleadh. Is féidir patrúin stad iolracha a shocrú trí pharaiméadair stadanna iolracha a shonrú i gcomhad samhail.',
		Setting: ot,
		Settings: tt,
		...
		'Show Admin Details in Account Pending Overlay':
			'Taispeáin Sonraí Riaracháin sa Chuntas ar Feitheamh Forleagan',
		...
		'Showing all messages (user + assistant) per user.':
			'Ag taispeáint gach teachtaireacht (úsáideoir + cúntóir) in aghaidh an úsáideora.',
		...
		'Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.':
			'Feabhsaíonn sé cruinneas go suntasach trí LLM a úsáid chun táblaí, foirmeacha, matamaitic inlíne, agus braiteadh leagan amach a fheabhsú. Méadóidh sé an mhoill. Réamhshocrú go Bréagach.',
		...
		'Skip the cache and re-run the inference. Defaults to False.':
			'Seachain an taisce agus athrith an tátal. Réamhshocrú Bréagach.',
		...
		'Split documents by markdown headers before applying character/token splitting.':
			'Scoilt doiciméid de réir ceanntásca lascaine sula gcuirtear scoilt carachtar/comhartha i bhfeidhm.',
		...
		'Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.':
			'Bain an téacs OCR atá ann cheana féin as an PDF agus athrith OCR. Déantar neamhaird de má tá OCR Fórsála cumasaithe. Is é Bréag an rogha réamhshocraithe.',
		...
		'Successfully imported {{userCount}} users.':
			'Iompórtáladh {{userCount}} úsáideoir go rathúil.',
		...
		'Syncs only chats with updates after your last sync timestamp. Disable to re-sync all chats.':
			'Ní shioncrónaíonn sé ach comhráite le nuashonruithe tar éis do stampa ama sioncrónaithe deireanach. Díchumasaigh chun gach comhrá a athshioncrónú.',
		System: Pt,
		...
		'Tail free sampling is used to reduce the impact of less probable tokens from the output. A higher value (e.g., 2.0) will reduce the impact more, while a value of 1.0 disables this setting.':
			'Úsáidtear sampláil saor ó eireabaill chun tionchar na n-chomharthaí ón aschur nach bhfuil chomh dóchúil céanna a laghdú. Laghdóidh luach níos airde (m.sh., 2.0) an tionchar níos mó, agus díchumasaíonn luach 1.0 an socrú seo. (réamhshocraithe: 1)',
		...
		'The Application Account DN you bind with for search':
			'An Cuntas Feidhmchláir DN a nascann tú leis le haghaidh cuardaigh',
		...
		'The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.':
			'Cinneann méid an bhaisc cé mhéad iarratas téacs a phróiseáiltear le chéile ag an am céanna. Is féidir le méid baisc níos airde feidhmíocht agus luas an tsamhail a mhéadú, ach éilíonn sé níos mó cuimhne freisin.',
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Is deonacha paiseanta ón bpobal iad na forbróirí taobh thiar den bhreiseán seo. Má aimsíonn an breiseán seo cabhrach leat, smaoinigh ar rannchuidiú lena fhorbairt.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Tá an clár ceannairí meastóireachta bunaithe ar chóras rátála Elo agus déantar é a nuashonrú i bhfíor-am.',
		'The format to return a response in. Format can be json or a JSON schema.':
			'An fhormáid le freagra a thabhairt ar ais inti. Is féidir leis an bhformáid a bheith ina json nó ina scéim JSON.',
		'The height in pixels to compress images to. Leave empty for no compression.':
			'An airde i bpicteilíní le híomhánna a chomhbhrú. Fág folamh mura bhfuil aon chomhbhrú ann.',
		'The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.':
			'Teanga an fhuaime ionchuir. Má sholáthraítear an teanga ionchuir i bhformáid ISO-639-1 (e.g. en), feabhsófar cruinneas agus moill. Fág bán é chun an teanga a bhrath go huathoibríoch.',
		'The LDAP attribute that maps to the mail that users use to sign in.':
			'An tréith LDAP a mhapálann don ríomhphost a úsáideann úsáideoirí chun síniú isteach.',
		'The LDAP attribute that maps to the username that users use to sign in.':
			'An tréith LDAP a mhapálann don ainm úsáideora a úsáideann úsáideoirí chun síniú isteach.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			"Tá an clár ceannairí i béite faoi láthair, agus d'fhéadfaimis na ríomhanna rátála a choigeartú de réir mar a dhéanfaimid an t-algartam a bheachtú.",
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'Uasmhéid an chomhaid i MB. Má sháraíonn méid an chomhaid an teorainn seo, ní uaslódófar an comhad.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'An líon uasta na gcomhaid is féidir a úsáid ag an am céanna i gcomhrá. Má sháraíonn líon na gcomhaid an teorainn seo, ní uaslódófar na comhaid.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			"An fhormáid aschuir don téacs. Is féidir é a úsáid mar 'json', 'markdown', nó 'html'. Is é 'markdown' an réamhshocrú.",
		"The passwords you entered don't quite match. Please double-check and try again.":
			'Ní hionann na pasfhocail a chuir tú isteach. Déan iarracht arís agus déan iarracht eile.',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Ba chóir go mbeadh an scór ina luach idir 0.0 (0%) agus 1.0 (100%).',
		'The stream delta chunk size for the model. Increasing the chunk size will make the model respond with larger pieces of text at once.':
			'Méid an bhloic delta srutha don tsamhail. Má mhéadaítear an smután, freagróidh an tsamhail le píosaí níos mó téacs ar an toirt.',
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'Teocht an tsamhail. Déanfaidh méadú ar an teocht an tsamhail a fhreagairt níos cruthaithí.',
		'The Weight of BM25 Hybrid Search. 0 more semantic, 1 more lexical. Default 0.5':
			'Meáchan Chuardaigh Hibrideach BM25. 0 níos séimeantacha, 1 níos leicseach. Réamhshocrú 0.5',
		'The width in pixels to compress images to. Leave empty for no compression.':
			'An leithead i bpicteilíní le híomhánna a chomhbhrú. Fág folamh mura bhfuil aon chomhbhrú ann.',
		Theme: Lt,
		'There was an error syncing your stats. Please try again.':
			'Tharla earráid agus do staitisticí á sioncrónú. Déan iarracht arís.',
		'Thinking...': 'Ag smaoineamh...',
		'This action cannot be undone. Do you wish to continue?':
			'Ní féidir an gníomh seo a chur ar ais. Ar mhaith leat leanúint ar aghaidh?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'Cruthaíodh an cainéal seo ar {{createdAt}}. Seo tús an chainéil {{channelName}}.',
		"This chat won't appear in history and your messages will not be saved.":
			'Ní bheidh an comhrá seo le feiceáil sa stair agus ní shábhálfar do theachtaireachtaí.',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Cinntíonn sé seo go sábhálfar do chomhráite luachmhara go daingean i do bhunachar sonraí cúltaca Go raibh maith agat!',
		'This feature is currently experimental and may not work as expected.':
			"Tá an ghné seo turgnamhach faoi láthair agus b'fhéidir nach n-oibreoidh sí mar a bhíothas ag súil leis.",
		'This feature is experimental and may be modified or discontinued without notice.':
			'Is gné turgnamhach í seo agus féadfar í a mhodhnú nó a scor gan fógra.',
		'This folder is empty': 'Tá an fillteán seo folamh',
		'This is a default user permission and will remain enabled.':
			'Is cead úsáideora réamhshocraithe é seo agus fanfaidh sé cumasaithe.',
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			"Is gné turgnamhach í seo, b'fhéidir nach bhfeidhmeoidh sé mar a bhíothas ag súil leis agus tá sé faoi réir athraithe ag am ar bith.",
		'This model is not publicly available. Please select another model.':
			'Níl an tsamhail seo ar fáil go poiblí. Roghnaigh samhail eile le do thoil.',
		'This option controls how long the model will stay loaded into memory following the request (default: 5m)':
			'Rialaíonn an rogha seo cé chomh fada a fhanfaidh an tsamhail luchtaithe sa chuimhne i ndiaidh an iarratais (réamhshocraithe: 5m)',
		...
		'This option enables or disables the use of the reasoning feature in Ollama, which allows the model to think before generating a response. When enabled, the model can take a moment to process the conversation context and generate a more thoughtful response.':
			'Cumasaíonn nó díchumasaíonn an rogha seo úsáid na gné réasúnaíochta in Ollama, rud a ligeann don tsamhail smaoineamh sula gineadh freagra. Nuair atá sé cumasaithe, féadann an tsamhail nóiméad a ghlacadh chun an comhthéacs comhrá a phróiseáil agus freagairt níos tuisceana a ghiniúint.',
		'This option sets the maximum number of tokens the model can generate in its response. Increasing this limit allows the model to provide longer answers, but it may also increase the likelihood of unhelpful or irrelevant content being generated.':
			"Socraíonn an rogha seo an t-uaslíon comharthaí is féidir leis an tsamhail a ghiniúint ina fhreagra. Tríd an teorainn seo a mhéadú is féidir leis an tsamhail freagraí níos faide a sholáthar, ach d'fhéadfadh go méadódh sé an dóchúlacht go nginfear ábhar neamhchabhrach nó nach mbaineann le hábhar.",
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Scriosfaidh an rogha seo gach comhad atá sa bhailiúchán agus cuirfear comhaid nua-uaslódála ina n-ionad.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Scriosfaidh sé seo <strong>{{NAME}}</strong> agus <strong>a bhfuil ann go léir</strong>.',
		'This will delete all models including custom models':
			'Scriosfaidh sé seo gach samhail lena n-áirítear samhlacha saincheaptha',
		'This will delete all models including custom models and cannot be undone.':
			'Scriosfaidh sé seo gach samhail, lena n-áirítear samhlacha saincheaptha, agus ní féidir é a chealú.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Déanfaidh sé seo an bonn eolais a athshocrú agus gach comhad a shioncronú. Ar mhaith leat leanúint ar aghaidh?',
		...
		'Thumbs up/down ratings from users on model responses':
			'Rátálacha ordóg suas/síos ó úsáideoirí ar fhreagraí samhail',
		Tika: kt,
		...
		'To access the available model names for downloading,':
			'Chun rochtain a fháil ar ainmneacha na samhlacha atá ar fáil lena n-íoslódáil,',
		'To access the GGUF models available for downloading,':
			'Chun rochtain a fháil ar na samhlacha GGUF atá ar fáil lena n-íoslódáil,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'Chun rochtain a fháil ar an WebUI, déan teagmháil leis an riarthóir le do thoil. Is féidir le riarthóirí stádas úsáideora a bhainistiú ón bPainéal Riaracháin.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Chun an bonn eolais a cheangal anseo, cuir leis an spás oibre "Eolas" iad ar dtús.',
		'To learn more about available endpoints, visit our documentation.':
			'Chun tuilleadh a fhoghlaim faoi na críochphointí atá ar fáil, tabhair cuairt ar ár gcáipéisíocht.',
		'To select skills here, add them to the "Skills" workspace first.':
			'Chun scileanna a roghnú anseo, cuir iad leis an spás oibre "Scileanna" ar dtús.',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Chun trealamh uirlisí a roghnú anseo, cuir iad leis an spás oibre "Uirlisí" ar dtús.',
		...
		'Token counts are estimates and may not reflect actual API usage':
			'Is meastacháin iad comhaireamh na gcomharthaí agus ní fhéadfaidh siad úsáid iarbhír API a léiriú.',
		tokens: Yt,
		Tokens: Vt,
		...
		'Tools have a function calling system that allows arbitrary code execution.':
			'Tá córas glaonna feidhme ag uirlisí a cheadaíonn forghníomhú cód treallach.',
		...
		'Try adjusting your search or filter to find what you are looking for.':
			'Bain triail as do chuardach nó do scagaire a choigeartú chun a bhfuil á lorg agat a fháil.',
		...
		'Update for the latest features and improvements.':
			'Nuashonrú le haghaidh na gnéithe agus na feabhsuithe is déanaí.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Uasghrádú go dtí plean ceadúnaithe le haghaidh cumais fheabhsaithe, lena n-áirítear téamaí saincheaptha agus brandáil, agus tacaíocht thiomanta.',
		Upload: or,
		...
		'Upload Progress: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)':
			'Dul Chun Cinn Uaslódála: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Úsáid '#' san ionchur treoir chun do chuid eolais a lódáil agus a chur san áireamh.",
		'Use /v1/chat/completions endpoint instead of /v1/audio/transcriptions for potentially better accuracy.':
			'Bain úsáid as an gcríochphointe /v1/chat/completions in ionad /v1/audio/transcriptions le haghaidh cruinneas níos fearr b’fhéidir.',
		'Use Chat Completions API': 'Úsáid API Comhlánuithe Comhrá',
		'Use groups to organize your users and assign permissions.':
			'Bain úsáid as grúpaí chun d’úsáideoirí a eagrú agus ceadanna a shannadh.',
		'Use LLM': 'Úsáid LLM',
		'Use no proxy to fetch page contents.':
			'Ná húsáid seachfhreastalaí chun inneachar an leathanaigh a fháil.',
		'Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.':
			'Úsáid seachfhreastalaí ainmnithe ag athróga timpeallachta http_proxy agus https_proxy chun inneachar an leathanaigh a fháil.',
		user: sr,
		User: lr,
		...
		'Uses DefaultAzureCredential to authenticate':
			'Úsáideann sé DefaultAzureCredential chun fíordheimhniú',
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Ag baint úsáide as an tsamhail réimse réamhshocraithe le gach samhail. Cliceáil an cnaipe móide chun samhlacha saincheaptha a chur leis.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Leagan {{selectedVersion}} de {{totalVersions}}',
		...
		'Voice Mode Custom Prompt': 'Treoir Saincheaptha Mód Gutha',
		...
		'Warning: Enabling this will allow users to run scheduled prompts automatically.':
			'Rabhadh: Trí seo a chumasú, beidh úsáideoirí in ann leideanna sceidealaithe a rith go huathoibríoch.',
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Rabhadh: Cuirfidh sé seo ar chumas úsáideoirí cód treallach a uaslódáil ar an bhfreastalaí.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			'Rabhadh: Trí fhorghníomhú Jupyter is féidir cód a fhorghníomhú go treallach, rud a chruthaíonn mór-rioscaí slándála - bí fíorchúramach.',
		We_day_of_week: yr,
		Web: Tr,
		...
		'WebUI will make requests to "{{url}}/api/chat"':
			'Déanfaidh WebUI iarratais ar "{{url}}/api/chat"',
		'WebUI will make requests to "{{url}}/chat/completions"':
			'Déanfaidh WebUI iarratais ar "{{url}}/chat/completions"',
		Week: wr,
		Weekly: Pr,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			"Nuair a bheidh sé cumasaithe, freagróidh an tsamhail gach teachtaireacht comhrá i bhfíor-am, ag giniúint freagra a luaithe a sheolann an t-úsáideoir teachtaireacht. Tá an mód seo úsáideach le haghaidh feidhmchláir chomhrá beo, ach d'fhéadfadh tionchar a bheith aige ar fheidhmíocht ar chrua-earraí níos moille.",
		...
		'Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.':
			'Cibé acu an ndéanfar an t-aschur a roinnt le leathanaigh nó nach ndéanfar. Beidh riail chothrománach agus uimhir leathanaigh ag scartha ó gach leathanach. Is é Bréag an rogha réamhshocraithe.',
		...
		'Works together with top-k. A higher value (e.g., 0.95) will lead to more diverse text, while a lower value (e.g., 0.5) will generate more focused and conservative text.':
			'Oibríonn sé le barr-k. Beidh téacs níos éagsúla mar thoradh ar luach níos airde (m.sh., 0.95), agus ginfidh luach níos ísle (m.sh., 0.5) téacs níos dírithe agus níos coimeádaí.',
		Workspace: Ur,
		'Workspace Permissions': 'Ceadanna Spás Oibre',
		Write: Nr,
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Scríobh achoimre i 50 focal a dhéanann achoimre ar [ábhar nó eochairfhocal].',
...
m.sh.: Is é Mario ó Super Mario Bros tú, ag gníomhú mar chúntóir.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'Tá ceadúnas trialach á úsáid agat faoi láthair. Déan teagmháil leis an bhfoireann tacaíochta chun do cheadúnas a uasghrádú.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Ní féidir leat comhrá a dhéanamh ach le comhad {{maxCount}} ar a mhéad ag an am.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Is féidir leat do chuid idirghníomhaíochtaí le LLManna a phearsantú ach cuimhní cinn a chur leis tríd an gcnaipe 'Bainistigh' thíos, rud a fhágann go mbeidh siad níos cabhrach agus níos oiriúnaí duit.",
		'You cannot upload an empty file.': 'Ní féidir leat comhad folamh a uaslódáil.',
		'You do not have permission to edit this model':
			'Níl cead agat an tsamhail seo a chur in eagar',
		'You do not have permission to edit this prompt.':
			'Níl cead agat an treoir seo a chur in eagar.',
		...
		'You do not have permission to make this public':
			'Níl cead agat é seo a chur ar fáil don phobal',
		'You do not have permission to send messages in this channel.':
			'Níl cead agat teachtaireachtaí a sheoladh sa chainéal seo.',
		'You do not have permission to send messages in this thread.':
			'Níl cead agat teachtaireachtaí a sheoladh sa snáithe seo.',
		'You do not have permission to upload files to this knowledge base.':
			'Níl cead agat comhaid a uaslódáil chuig an mbunachar eolais seo.',
		...
		'You do not have permission to upload web content.':
			'Níl cead agat ábhar gréasáin a uaslódáil.',
		...
		'Your account status is currently pending activation.':
			'Tá stádas do chuntais ar feitheamh faoi ghníomhachtú.',
		'Your browser does not support the audio tag.':
			'Ní thacaíonn do bhrabhsálaí leis an gclib fuaime.',
		'Your browser does not support the video tag.':
			'Ní thacaíonn do bhrabhsálaí leis an gclib físeáin.',
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			"Rachaidh do ranníocaíocht iomlán go díreach chuig an bhforbróir breiseán; Ní ghlacann Open WebUI aon chéatadán. Mar sin féin, d'fhéadfadh a tháillí féin a bheith ag an ardán maoinithe roghnaithe.",
		'Your message text or inputs': 'Téacs nó ionchur do theachtaireachta',
		'Your usage stats have been successfully synced.':
			'Tá do staitisticí úsáide sioncronaithe go rathúil.',
		YouTube: Or,
...
//# sourceMappingURL=c8iU0i3X.js.map
