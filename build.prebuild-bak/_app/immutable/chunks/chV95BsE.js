...
import { a as uu } from './BfA5TzUS.js';
import { b as Xo } from './B5BwDDu6.js';
import { i as du } from './BolXBFGq.js';
import { p as Jt } from './DbBXQmQ3.js';
import { _ as x } from './C1FmrZbK.js';
import { W as pu } from './DDjvPYNk.js';
import { b as ps } from './CHheSG1Y.js';
import { t as Qo } from './DtbOSK9Q.js';
import { u as mu } from './Bumd5cCN.js';
const dx = async (n, e) => {
		let t = null;
		const i = await fetch(`${ps}/utils/gravatar?email=${e}`, {
			method: 'GET',
			...
			.catch((s) => ((t = s.detail ?? s), null));
		if (t) throw t;
		return i;
	},
	px = async (n, e) => {
		let t = null;
		const i = await fetch(`${ps}/utils/code/execute`, {
			method: 'POST',
			headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${n}` },
			...
			.catch((s) => ((t = s), s.detail && (t = s.detail), null));
		if (t) throw t;
		return i;
	},
	gu = async (n, e) => {
		let t = null;
		const i = await fetch(`${ps}/utils/code/format`, {
			method: 'POST',
			headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${n}` },
			body: JSON.stringify({ code: e })
		})
	...
	mx = async (n) => {
		let e = null;
		if (
			(await fetch(`${ps}/utils/db/download`, {
				method: 'GET',
				headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${n}` }
			})
				.then(async (t) => {
...
class F {
	...
	add(e) {
		...
		return (
			typeof e != 'function' && (e = Ae.match(e)),
			(t) => {
				let i = e(t);
...
class Ae {
	...
	static define(e) {
		let t = e.props && e.props.length ? Object.create(null) : xu,
			i = (e.top ? 1 : 0) | (e.skipped ? 2 : 0) | (e.error ? 4 : 0) | (e.name == null ? 8 : 0),
			s = new Ae(e.name || '', t, e.id, i);
		if (e.props) {
...
Ae.none = new Ae('', Object.create(null), 0, 8);
class to {
	constructor(e) {
		this.types = e;
...
class ee {
	...
	resolve(e, t = 0) {
		let i = Ni(pn.get(this) || this.topNode, e, t, !1);
		return (pn.set(this, i), i);
	}
	resolveInner(e, t = 0) {
		let i = Ni(Zo.get(this) || this.topNode, e, t, !0);
		return (Zo.set(this, i), i);
	}
	resolveStack(e, t = 0) {
		return ku(this, e, t);
	}
	...
	balance(e = {}) {
		return this.children.length <= 8
			...
			: so(
					...
					0,
					this.length,
					(t, i, s) => new ee(this.type, t, i, s, this.propValues),
					e.makeTree || ((t, i, s) => new ee(Ae.none, t, i, s))
				);
	}
	static build(e) {
		return Su(e);
...
class Ct {
	...
	findChild(e, t, i, s, r) {
		let { buffer: o } = this,
			l = -1;
		for (let a = e; a != t && !(Ja(r, s, o[a + 1], o[a + 2]) && ((l = a), i > 0)); a = o[a + 3]);
		return l;
	}
	slice(e, t, i) {
		let s = this.buffer,
...
class we extends Ya {
			...
			for (let { children: l, positions: a } = o._tree, h = t > 0 ? l.length : -1; e != h; e += t) {
				...
				if (
					...
					if (c instanceof Ct) {
						...
						if (d > -1) return new it(new wu(o, c, e, f), null, d);
					} else if (r & Z.IncludeAnonymous || !c.type.isAnonymous || no(c)) {
						let d;
						if (!(r & Z.IgnoreMounts) && (d = ii.get(c)) && !d.overlay)
							return new we(d.tree, f, e, o);
						let p = new we(c, f, e, o);
						return r & Z.IncludeAnonymous || !p.type.isAnonymous
							? p
	...
	enter(e, t, i = 0) {
		let s;
		if (!(i & Z.IgnoreOverlays) && (s = ii.get(this._tree)) && s.overlay) {
			let r = e - this.from,
...
class it extends Ya {
	...
	get nextSibling() {
		...
		return t < (this._parent ? e.buffer[this._parent.index + 3] : e.buffer.length)
			? new it(this.context, this._parent, t)
	...
	get prevSibling() {
		...
		return this.index == t
			? this.externalSibling(-1)
			: new it(this.context, this._parent, e.findChild(t, this.index, -1, 0, 4));
	}
	get tree() {
		return null;
	}
...
function Xa(n) {
	...
	let i = t instanceof we && t.index < 0 ? null : t.parent,
		s = n.slice();
	return (i ? (s[e] = i) : s.splice(e, 1), new vu(s, t));
}
class vu {
	constructor(e, t) {
...
class $n {
		...
		for (; i; { index: t, _parent: i } = i)
			if (t > -1)
				for (let r = t + e, o = e < 0 ? -1 : i._tree.children.length; r != o; r += e) {
					...
					if (this.mode & Z.IncludeAnonymous || l instanceof Ct || !l.type.isAnonymous || no(l))
						return !1;
				}
		return !0;
	}
	...
	get node() {
		...
		for (let s = i; s < this.stack.length; s++) t = new it(this.buffer, t, this.stack[s]);
	...
	matchContext(e) {
		if (!this.buffer) return ar(this.node.parent, e);
		let { buffer: t } = this.buffer,
			{ types: i } = t.set;
		for (let s = e.length - 1, r = this.stack.length - 1; s >= 0; r--) {
			if (r < 0) return ar(this._tree, e, s);
...
function no(n) {
	return n.children.some((e) => e instanceof Ct || !e.type.isAnonymous || no(e));
}
function Su(n) {
	var e;
	let {
			buffer: t,
			nodeSet: i,
			maxBufferLength: s = yu,
			reused: r = [],
			minRepeatType: o = i.types.length
		} = n,
		l = Array.isArray(t) ? new io(t, t.length) : t,
		a = i.types,
		h = 0,
		c = 0;
	function f(A, M, T, B, H, K) {
		let { id: W, start: R, end: U, size: q } = l,
			Y = c,
			N = h;
		if (q < 0)
			if ((l.next(), q == -1)) {
				let ae = r[W];
				(T.push(ae), B.push(R - A));
				return;
			} else if (q == -3) {
				h = W;
				return;
		...
		let G = a[W],
			...
			J,
			ne = R - A;
		if (U - R <= s && (J = g(l.pos - M, H))) {
			let ae = new Uint16Array(J.size - J.skip),
				ke = l.pos - J.size,
				Le = ae.length;
			for (; l.pos > ke; ) Le = y(J.start, ae, Le);
			((V = new Ct(ae, U - J.start, i)), (ne = J.start - A));
		} else {
			let ae = l.pos - q;
			l.next();
			let ke = [],
				...
				ht = U;
			for (; l.pos > ae; )
				at >= 0 && l.id == at && l.size >= 0
					? (l.end <= ht - s &&
							(p(ke, Le, R, yt, l.end, ht, at, Y, N), (yt = ke.length), (ht = l.end)),
						l.next())
					: K > 2500
						? u(R, ae, ke, Le)
						: f(R, ae, ke, Le, at, K + 1);
			if (
				(at >= 0 && yt > 0 && yt < ke.length && p(ke, Le, R, yt, R, ht, at, Y, N),
				ke.reverse(),
				Le.reverse(),
				at > -1 && yt > 0)
			) {
				let Pt = d(G, N);
				V = so(G, ke, Le, 0, ke.length, 0, U - R, Pt, Pt);
			} else V = m(G, ke, Le, U - R, Y - U, N);
		}
		(T.push(V), B.push(ne));
	}
	function u(A, M, T, B) {
		let H = [],
			...
			W = -1;
		for (; l.pos > M; ) {
			let { id: R, start: U, end: q, size: Y } = l;
			if (Y > 4) l.next();
			else {
				if (W > -1 && U < W) break;
				(W < 0 && (W = q - s), H.push(R, U, q), K++, l.next());
			}
		}
		if (K) {
			let R = new Uint16Array(K * 4),
				U = H[H.length - 2];
			for (let q = H.length - 3, Y = 0; q >= 0; q -= 3)
				((R[Y++] = H[q]), (R[Y++] = H[q + 1] - U), (R[Y++] = H[q + 2] - U), (R[Y++] = Y));
			(T.push(new Ct(R, H[2] - U, i)), B.push(U - A));
		}
	}
	function d(A, M) {
		return (T, B, H) => {
			let K = 0,
				...
				R,
				U;
			if (W >= 0 && (R = T[W]) instanceof ee) {
				if (!W && R.type == A && R.length == H) return R;
				(U = R.prop(F.lookAhead)) && (K = B[W] + R.length + U);
			}
			return m(A, T, B, H, K, M);
		};
	}
	function p(A, M, T, B, H, K, W, R, U) {
		let q = [],
			Y = [];
		for (; A.length > B; ) (q.push(A.pop()), Y.push(M.pop() + T - H));
		(A.push(m(i.types[W], q, Y, K - H, R - K, U)), M.push(H - T));
	}
	function m(A, M, T, B, H, K, W) {
		if (K) {
			let R = [F.contextHash, K];
			W = W ? [R].concat(W) : [R];
		}
		if (H > 25) {
			let R = [F.lookAhead, H];
	...
	function g(A, M) {
		...
		e: for (let U = T.pos - A; T.pos > U; ) {
			let q = T.size;
			if (T.id == M && q >= 0) {
				((R.size = B), (R.start = H), (R.skip = K), (K += 4), (B += 4), T.next());
				continue;
			}
			let Y = T.pos - q;
			if (q < 0 || Y < U || T.start < W) break;
			let N = T.id >= o ? 4 : 0,
				G = T.start;
			for (T.next(); T.pos > Y; ) {
				if (T.size < 0)
					if (T.size == -3 || T.size == -4) N += 4;
					else break e;
				else T.id >= o && (N += 4);
				T.next();
			}
		...
		return (
			(M < 0 || B == A) && ((R.size = B), (R.start = H), (R.skip = K)),
			R.size > 4 ? R : void 0
		);
	}
	function y(A, M, T) {
		let { id: B, start: H, end: K, size: W } = l;
		if ((l.next(), W >= 0 && B < o)) {
			let R = T;
			if (W > 4) {
				let U = l.pos - (W - 4);
				for (; l.pos > U; ) T = y(A, M, T);
			}
			((M[--T] = R), (M[--T] = K - A), (M[--T] = H - A), (M[--T] = B));
		} else W == -3 ? (h = B) : W == -4 && (c = B);
		return T;
	}
	let S = [],
		C = [];
	for (; l.pos > 0; ) f(n.start || 0, n.bufferStart || 0, S, C, -1, 0);
	let L = (e = n.length) !== null && e !== void 0 ? e : S.length ? C[0] + S[0].length : 0;
	return new ee(a[n.topID], S.reverse(), C.reverse(), L);
}
...
function so(n, e, t, i, s, r, o, l, a) {
	let h = 0;
	for (let p = i; p < s; p++) h += Nn(n, e[p]);
	let c = Math.ceil((h * 1.5) / 8),
		f = [],
		u = [];
	function d(p, m, g, y, S) {
		for (let C = g; C < y; ) {
			let L = C,
				A = m[C],
				M = Nn(n, p[C]);
			...
			if (C == L + 1) {
				if (M > c) {
					let T = p[L];
					d(T.children, T.positions, 0, T.children.length, m[L] + S);
					continue;
				}
				f.push(p[L]);
			} else {
				let T = m[C - 1] + p[C - 1].length - A;
				f.push(so(n, p, m, L, C, A, T, null, a));
			}
			u.push(A + S - r);
		}
	}
...
class Qa {
	startParse(e, t, i) {
		return (
			typeof e == 'string' && (e = new Cu(e)),
			(i = i
				? i.length
					? i.map((s) => new Ne(s.from, s.to))
					: [new Ne(0, 0)]
				: [new Ne(0, e.length)]),
...
function bx(n) {
	return (e, t, i, s) => new Mu(e, n, t, i, s);
}
class il {
...
class Mu {
	...
	advance() {
			...
			return (
				this.stoppedAt != null &&
					(i = new ee(
						...
						i.positions,
						i.length,
						i.propValues.concat([[hr, this.stoppedAt]])
					)),
				i
			);
		}
		...
		if (t) {
			...
			((i[F.mounted.id] = new ii(t, e.overlay, e.parser, e.bracketed)), (e.target.props = i));
		}
		return null;
	}
	get parsedPos() {
	...
	startInner() {
		let e = new Eu(this.fragments),
			t = null,
			i = null,
			s = new $n(
				new we(this.baseTree, this.ranges[0].from, 0, null),
				Z.IncludeAnonymous | Z.IgnoreMounts
			);
		e: for (let r, o; ; ) {
			let l = !0,
				a;
			if (this.stoppedAt != null && s.from >= this.stoppedAt) l = !1;
				...
				l = !1;
			} else if (i && (o = Tu(i.ranges, s.from, s.to))) l = o != 2;
			else if (
				!s.type.isAnonymous &&
				(r = this.nest(s, this.input)) &&
				(s.from < s.to || !r.overlay)
			) {
				s.tree || (Du(s), t && t.depth++, i && i.depth++);
				let h = e.findMounts(s.from, r.parser);
				if (typeof r.overlay == 'function')
					t = new Au(r.parser, r.overlay, h, this.inner.length, s.from, !!r.bracketed, s.tree, t);
				else {
					let c = ol(this.ranges, r.overlay || (s.from < s.to ? [new Ne(s.from, s.to)] : []));
					(c.length && nl(c),
						(c.length || !r.overlay) &&
							this.inner.push(
								new il(
									r.parser,
									c.length ? r.parser.startParse(this.input, ll(h, c), c) : r.parser.startParse(''),
									r.overlay ? r.overlay.map((f) => new Ne(f.from - s.from, f.to - s.from)) : null,
									!!r.bracketed,
									s.tree,
									c.length ? c[0].from : s.from
								)
							),
						r.overlay ? c.length && (i = { ranges: c, depth: 0, prev: i }) : (l = !1));
				}
			} else if (
				t &&
				(a = t.predicate(s)) &&
				(a === !0 && (a = new Ne(s.from, s.to)), a.from < a.to)
			) {
					...
					if (t && !--t.depth) {
						...
						(h.length &&
							...
							this.inner.splice(
								...
								new il(
									t.parser,
									t.parser.startParse(this.input, ll(t.mounts, h), h),
									t.ranges.map((c) => new Ne(c.from - t.start, c.to - t.start)),
									t.bracketed,
									t.target,
									h[0].from
								)
...
function Du(n) {
	...
	function h(c, f, u, d, p, m) {
		...
		let C = l[g + 1],
			L = l[g + 2];
		a.push(y.length);
		let A = m ? h(g + 4, l[g + 3], o.set.types[l[g]], C, L - C, m - 1) : e.toTree();
		return (y.push(A), S.push(C - d), sl(o, l[g + 3], f, y, S, d), new ee(u, y, S, p));
	}
	s.children[r] = h(0, l.length, Ae.none, 0, o.length, t.length - 1);
	for (let c of a) {
...
class rl {
	constructor(e, t) {
		((this.offset = t),
			(this.done = !1),
			(this.cursor = e.cursor(Z.IncludeAnonymous | Z.IgnoreMounts)));
	}
	moveTo(e) {
		let { cursor: t } = this,
			i = e - this.offset;
		for (; !this.done && t.from < i; )
			(t.to >= e && t.enter(i, 1, Z.IgnoreOverlays | Z.ExcludeBuffers)) ||
				t.next(!1) ||
				(this.done = !0);
	}
	hasNode(e) {
		if (
			...
			for (let t = this.cursor.tree; ; ) {
				...
				if (t.children.length && t.positions[0] == 0 && t.children[0] instanceof ee)
					t = t.children[0];
				else break;
			}
		return !1;
...
class Eu {
	constructor(e) {
		...
		if (((this.fragments = e), (this.curTo = 0), (this.fragI = 0), e.length)) {
			...
			((this.curTo = (t = i.tree.prop(hr)) !== null && t !== void 0 ? t : i.to),
				(this.inner = new rl(i.tree, -i.offset)));
	...
	nextFrag() {
		...
		if ((this.fragI++, this.fragI == this.fragments.length)) this.curFrag = this.inner = null;
			...
			((this.curTo = (e = t.tree.prop(hr)) !== null && e !== void 0 ? e : t.to),
				(this.inner = new rl(t.tree, -t.offset)));
		}
	}
	findMounts(e, t) {
		var i;
		...
		if (this.inner) {
			...
			for (let r = this.inner.cursor.node; r; r = r.parent) {
				let o = (i = r.tree) === null || i === void 0 ? void 0 : i.prop(F.mounted);
				if (o && o.parser == t)
					for (let l = this.fragI; l < this.fragments.length; l++) {
						let a = this.fragments[l];
						if (a.from >= r.to) break;
						a.tree == this.curFrag.tree && s.push({ frag: a, pos: r.from - a.offset, mount: o });
					}
			}
		}
		return s;
	...
	for (let s = 1, r = 0; s < n.length; s++) {
		...
		for (; r < i.length; r++) {
			...
			a.to <= o ||
				(t || (i = t = e.slice()),
				a.from < o
					? ((t[r] = new Ne(a.from, o)), a.to > l && t.splice(r + 1, 0, new Ne(l, a.to)))
					: a.to > l
						? (t[r--] = new Ne(l, a.to))
						: t.splice(r--, 1));
		}
...
function ll(n, e) {
	...
	for (let { pos: i, mount: s, frag: r } of n) {
		let o = i + (s.overlay ? s.overlay[0].from : 0),
			...
			h = Math.min(r.to, l);
		if (s.overlay) {
			let c = s.overlay.map((u) => new Ne(u.from + i, u.to + i)),
				f = Ou(e, c, a, h);
			for (let u = 0, d = a; ; u++) {
				let p = u == f.length,
					m = p ? h : f[u].from;
				if (
					(m > d &&
						t.push(new ft(d, m, s.tree, -o, r.from >= d || r.openStart, r.to <= m || r.openEnd)),
					p)
				)
					break;
				d = f[u].to;
			}
		} else t.push(new ft(a, h, s.tree, -o, r.from >= o || r.openStart, r.to <= l || r.openEnd));
	}
	return t;
}
let cr = [],
...
(() => {
	...
	for (let e = 0, t = 0; e < n.length; e++) (e % 2 ? Za : cr).push((t = t + n[e]));
})();
function _u(n) {
	if (n < 768) return !1;
...
const hl = 8205;
function Lu(n, e, t = !0, i = !0) {
	return (t ? eh : Pu)(n, e, i);
}
function eh(n, e, t) {
	if (e == n.length) return e;
	e && th(n.charCodeAt(e)) && ih(n.charCodeAt(e - 1)) && e--;
	let i = Ps(n, e);
	for (e += cl(i); e < n.length; ) {
		let s = Ps(n, e);
		if (i == hl || s == hl || (t && _u(s))) ((e += cl(s)), (i = s));
		else if (al(s)) {
			let r = 0,
				o = e - 2;
			for (; o >= 0 && al(Ps(n, o)); ) (r++, (o -= 2));
			if (r % 2 == 0) break;
			e += 2;
		} else break;
	}
...
class j {
	...
	static of(e) {
		...
		return e.length == 1 && !e[0] ? j.empty : e.length <= 32 ? new le(e) : Ze.from(le.split(e, []));
	}
}
class le extends j {
	constructor(e, t = Ru(e)) {
	...
	lineInner(e, t, i, s) {
		for (let r = 0; ; r++) {
			let o = this.text[r],
				l = s + o.length;
			if ((t ? i : l) >= e) return new Iu(s, l, i, o);
			((s = l + 1), i++);
		}
	}
	decompose(e, t, i, s) {
		let r =
			e <= 0 && t >= this.length
				? this
				: new le(fl(this.text, e, t), Math.min(t, this.length) - Math.max(0, e));
		if (s & 1) {
			let o = i.pop(),
				l = Vn(r.text, o.text.slice(), 0, r.length);
			if (l.length <= 32) i.push(new le(l, o.length + r.length));
			else {
				let a = l.length >> 1;
	...
	replace(e, t, i) {
		if (!(i instanceof le)) return super.replace(e, t, i);
		[e, t] = hi(this, e, t);
		let s = Vn(this.text, Vn(i.text, fl(this.text, 0, e)), t),
			r = this.length + i.length - (t - e);
		return s.length <= 32 ? new le(s, r) : Ze.from(le.split(s, []), r);
	}
	sliceString(
		e,
		t = this.length,
...
`
	...
	static split(e, t) {
		...
		for (let r of e)
			(i.push(r),
				(s += r.length + 1),
				i.length == 32 && (t.push(new le(i, s)), (i = []), (s = -1)));
	...
	static from(e, t = e.reduce((i, s) => i + s.length + 1, -1)) {
		...
		function f(d) {
			...
			if (d.lines > r && d instanceof Ze) for (let m of d.children) f(m);
				...
				d.lines > o && (a > o || !a)
					? (u(), l.push(d))
					: d instanceof le && a && (p = c[c.length - 1]) instanceof le && d.lines + p.lines <= 32
						? ((a += d.lines),
							(h += d.length + 1),
							(c[c.length - 1] = new le(p.text.concat(d.text), p.length + 1 + d.length)))
...
class Oi {
	constructor(e, t = 1) {
		((this.dir = t),
			...
			(this.value = ''),
			(this.nodes = [e]),
			(this.offsets = [t > 0 ? 1 : (e instanceof le ? e.text.length : e.children.length) << 1]));
	}
	nextInner(e, t) {
		for (this.done = this.lineBreak = !1; ; ) {
			let i = this.nodes.length - 1,
				...
				r = this.offsets[i],
				o = r >> 1,
				l = s instanceof le ? s.text.length : s.children.length;
			if (o == (t > 0 ? l : 0)) {
...
`),
				...
				e > a.length
					...
					: (t < 0 && this.offsets[i]--,
						this.nodes.push(a),
						this.offsets.push(
							t > 0 ? 1 : (a instanceof le ? a.text.length : a.children.length) << 1
						));
			}
		}
	}
...
typeof Symbol < 'u' &&
	...
	(Oi.prototype[Symbol.iterator] =
		nh.prototype[Symbol.iterator] =
		sh.prototype[Symbol.iterator] =
			function () {
				return this;
			}));
class Iu {
		...
		for (let o = 0; o < this.sections.length; ) {
			...
			if (a < 0) {
				...
				if (
					i != me.Simple &&
					h >= e &&
					((i == me.TrackDel && s < e && h > e) ||
						(i == me.TrackBefore && s < e) ||
						(i == me.TrackAfter && h > e))
				)
					return null;
...
class ce extends ot {
	...
	filter(e) {
		...
		return { changes: new ce(t, i), filtered: ot.create(s) };
	}
	toJSON() {
		let e = [];
		for (let t = 0; t < this.sections.length; t += 2) {
	...
	static of(e, t, i) {
		...
		function h(c) {
			if (Array.isArray(c)) for (let f of c) h(f);
				...
				let p = d ? (typeof d == 'string' ? j.of(d.split(i || fr)) : d) : j.empty,
					m = p.length;
				if (f == u && m == 0) return;
				(f < o && a(), f > o && xe(s, f - o, -1), xe(s, u - f, m), kt(r, s, p), (o = u));
			}
		}
		return (h(e), a(!l), l);
	}
...
function dr(n, e, t, i = !1) {
	...
	for (let a = -1; ; ) {
		...
		if (o.ins == -1 && l.ins == -1) {
			...
			if (o.done && l.done) return r ? ce.createSet(s, r) : ot.create(s);
...
function rh(n, e, t = !1) {
	let i = [],
		...
		o = new Vi(e);
	for (let l = !1; ; ) {
		if (r.done && o.done) return s ? ce.createSet(i, s) : ot.create(i);
...
class Vt {
	...
	map(e, t = -1) {
		...
		return (
			...
			i == this.from && s == this.to ? this : new Vt(i, s, this.flags)
		);
	}
	extend(e, t = e, i = 0) {
		if (e <= this.anchor && t >= this.anchor) return v.range(e, t, void 0, void 0, i);
...
class v {
	...
	static range(e, t, i, s, r) {
		...
		return (
			!r && e != t && (r = t < e ? 1 : -1),
			t < e ? Vt.create(t, e, 48 | o) : Vt.create(e, t, (r ? (r < 0 ? 8 : 16) : 0) | o)
		);
	}
...
class _ {
	...
	static define(e = {}) {
		return new _(
			...
			e.compare || (e.combine ? (t, i) => t === i : lo),
			!!e.static,
			e.enables
		);
	}
	...
	dynamicSlot(e) {
		...
		for (let f of this.dependencies)
			f == 'doc'
				...
				: f == 'selection'
					? (h = !0)
					: ((t = e[f.id]) !== null && t !== void 0 ? t : 1) & 1 || c.push(e[f.id]);
		return {
			create(f) {
			...
			update(f, u) {
				if ((a && u.docChanged) || (h && (u.docChanged || u.selection)) || pr(f, c)) {
					let d = i(f);
					if (l ? !ul(d, f.values[o], s) : !s(d, f.values[o])) return ((f.values[o] = d), 1);
				}
				return 0;
			},
			reconfigure: (f, u) => {
	...
	return {
		...
		reconfigure(a, h) {
			let c = pr(a, i),
				...
				u = h.facet(e);
			if (f && !c && lo(t, f)) return ((a.values[o] = u), 0);
			let d = l(a);
			return e.compare(d, u) ? ((a.values[o] = u), 0) : ((a.values[o] = d), 1);
		}
	};
}
const mn = _.define({ static: !0 });
class be {
	constructor(e, t, i, s, r) {
		((this.id = e),
			(this.createF = t),
	...
	static define(e) {
		let t = new be(oo++, e.create, e.update, e.compare || ((i, s) => i === s), e);
...
const _t = {
	highest: ki(Bt.highest),
	high: ki(Bt.high),
	default: ki(Bt.default),
	low: ki(Bt.low),
	lowest: ki(Bt.lowest)
};
class lh {
	...
	static resolve(e, t, i) {
		...
		for (let u in r) {
			...
			if (d.every((g) => g.type == 0))
				if (((l[p.id] = (a.length << 1) | 1), lo(m, d))) a.push(i.facet(p));
				else {
				...
				((l[p.id] = h.length << 1), h.push((g) => Vu(g, p, d)));
			}
		}
		let f = h.map((u) => u(l));
...
function Wu(n, e, t) {
	...
	function r(o, l) {
		...
		} else if (o instanceof lh) r(o.inner, o.prec);
		else if (o instanceof be) (i[l].push(o), o.provides && r(o.provides, l));
	...
	return (r(n, Bt.default), i.reduce((o, l) => o.concat(l)));
}
function _i(n, e) {
	if (e & 1) return 2;
	let t = e >> 1,
...
const ah = _.define(),
	gr = _.define({ combine: (n) => n.some((e) => e), static: !0 }),
	hh = _.define({ combine: (n) => (n.length ? n[0] : void 0), static: !0 }),
	ch = _.define(),
	fh = _.define(),
	uh = _.define(),
	dh = _.define({ combine: (n) => (n.length ? n[0] : !1) });
class gt {
	constructor(e, t) {
...
class he {
	constructor(e, t, i, s, r, o) {
		((this.startState = e),
			...
			(this._state = null),
			i && oh(i, t.newLength),
			r.some((l) => l.type == he.time) || (this.annotations = r.concat(he.time.of(Date.now()))));
	}
	static create(e, t, i, s, r, o) {
		return new he(e, t, i, s, r, o);
	}
	get newDoc() {
...
he.time = gt.define();
he.userEvent = gt.define();
he.addToHistory = gt.define();
he.remote = gt.define();
function zu(n, e) {
	let t = [];
	for (let i = 0, s = 0; ; ) {
...
function ph(n, e, t) {
	...
	return (
		t
			? ((s = e.changes), (r = ce.empty(e.changes.length)), (o = n.changes.compose(e.changes)))
				...
				(o = n.changes.compose(s))),
		{
			...
			selection: e.selection
				...
				: (i = n.selection) === null || i === void 0
					? void 0
					: i.map(s),
			effects: I.mapEffects(n.effects, s).concat(I.mapEffects(e.effects, r)),
...
function yr(n, e, t) {
	let i = e.selection,
		s = ni(e.annotations);
	return (
		e.userEvent && (s = s.concat(he.userEvent.of(e.userEvent))),
		{
			changes: e.changes instanceof ce ? e.changes : ce.of(e.changes || [], t, n.facet(hh)),
			selection: i && (i instanceof v ? i : v.single(i.anchor, i.head)),
			effects: ni(e.effects),
			annotations: s,
...
function mh(n, e, t) {
	...
	for (let r = 1; r < e.length; r++) {
		...
		i = ph(i, yr(n, e[r], o ? i.changes.newLength : n.doc.length), o);
	}
	let s = he.create(n, i.changes, i.selection, i.effects, i.annotations, i.scrollIntoView);
	return ju(t ? qu(s) : s);
}
function qu(n) {
	let e = n.startState,
	...
	for (let s of e.facet(ch)) {
		...
		Array.isArray(r) && (t = t === !0 ? r : zu(t, r));
	}
	if (t !== !0) {
		let s, r;
		if (t === !1) ((r = n.changes.invertedDesc), (s = ce.empty(e.doc.length)));
		else {
	...
	for (let s = i.length - 1; s >= 0; s--) {
		...
		r instanceof he
			? (n = r)
			: Array.isArray(r) && r.length == 1 && r[0] instanceof he
				? (n = r[0])
				: (n = mh(e, ni(r), !1));
	}
	return n;
...
function ju(n) {
	...
	for (let s = t.length - 1; s >= 0; s--) {
		let r = t[s](n);
		r && Object.keys(r).length && (i = ph(i, yr(e, r, n.changes.newLength), !0));
	}
	return i == n
		? n
		: he.create(e, n.changes, n.selection, i.effects, i.annotations, i.scrollIntoView);
}
const $u = [];
function ni(n) {
	return n == null ? $u : Array.isArray(n) ? n : [n];
}
var se = (function (n) {
	return (
		(n[(n.Word = 0)] = 'Word'),
...
class $ {
	constructor(e, t, i, s, r, o) {
		((this.config = e),
			...
			(this.computeSlot = r),
			o && (o._state = this));
		for (let l = 0; l < this.config.dynamicSlots.length; l++) _i(this, l << 1);
	...
	applyTransaction(e) {
		...
		for (let l of e.effects)
			l.is(ci.reconfigure)
				...
				: l.is(I.reconfigure)
					? ((t = null), (i = l.value))
					: l.is(I.appendConfig) && ((t = null), (i = ni(i).concat(l.value)));
		let r;
		t
	...
	changeByRange(e) {
		...
		for (let l = 1; l < t.ranges.length; l++) {
			...
			(r.push(a.range.map(f)),
				(s = s.compose(c)),
				(o = I.mapEffects(o, c).concat(I.mapEffects(ni(a.effects), f))));
		}
		return { changes: s, selection: v.create(r, t.mainIndex), effects: o };
	}
	changes(e = []) {
		return e instanceof ce ? e : ce.of(e, this.doc.length, this.facet($.lineSeparator));
	}
	toText(e) {
		return j.of(e.split(this.facet($.lineSeparator) || fr));
	}
	...
	facet(e) {
		...
		return t == null ? e.default : (_i(this, t), Un(this, t));
	}
	toJSON(e) {
	...
	static create(e = {}) {
		let t = Kn.resolve(e.extensions || [], new Map()),
			i =
				e.doc instanceof j
					? e.doc
					: j.of((e.doc || '').split(t.staticFacet($.lineSeparator) || fr)),
			s = e.selection
...
$.allowMultipleSelections = gr;
$.tabSize = _.define({ combine: (n) => (n.length ? n[0] : 4) });
$.lineSeparator = hh;
$.readOnly = dh;
$.phrases = _.define({
	compare(n, e) {
...
$.languageData = ah;
$.changeFilter = ch;
$.transactionFilter = fh;
$.transactionExtender = uh;
ci.reconfigure = I.define();
function lt(n, e, t = {}) {
	let i = {};
	for (let s of n)
...
At.prototype.mapMode = me.TrackDel;
function ao(n, e) {
...
class ho {
	...
	map(e, t) {
		...
		return { mapped: i.length ? new ho(s, r, i, l) : null, pos: o };
	}
}
class z {
	constructor(e, t, i, s) {
	...
	update(e) {
		...
		if ((i && (t = t.slice().sort(xr)), this.isEmpty)) return t.length ? z.of(t) : this;
		let l = new gh(this, null, -1).goto(0),
			a = 0,
			h = [],
			c = new dt();
			...
			if (a < t.length && (l.from - t[a].from || l.startSide - t[a].value.startSide) >= 0) {
				...
				c.addChunk(this.chunkPos[l.chunkIndex], this.chunk[l.chunkIndex])
					...
					: ((!o || s > l.to || r < l.from || o(l.from, l.to, l.value)) &&
							(c.addInner(l.from, l.to, l.value) || h.push(Wi.create(l.from, l.to, l.value))),
						l.next());
	...
	static compare(e, t, i, s, r = -1) {
		let o = e.filter((f) => f.maxPoint > 0 || (!f.isEmpty && f.maxPoint >= r)),
			...
			h = new Si(o, a, r),
			c = new Si(l, a, r);
		(i.iterGaps((f, u, d) => pl(h, f, c, u, d, s)),
	...
	static eq(e, t, i = 0, s) {
		...
		let l = dl(r, o),
			a = new Si(r, l, 0).goto(i),
			h = new Si(o, l, 0).goto(i);
		for (;;) {
			if (
				a.to != h.to ||
				!wr(a.active, h.active) ||
				(a.point && (!h.point || !ao(a.point, h.point)))
			)
				return !1;
			if (a.to > s) return !0;
			(a.next(), h.next());
	...
	static of(e, t = !1) {
		let i = new dt();
		for (let s of e instanceof Wi ? [e] : t ? Ju(e) : e) i.add(s.from, s.to, s.value);
		return i.finish();
	}
	static join(e) {
...
function Ju(n) {
	if (n.length > 1)
		for (let e = n[0], t = 1; t < n.length; t++) {
			let i = n[t];
			if (xr(e, i) > 0) return n.slice().sort(xr);
			e = i;
		}
	return n;
}
...
class dt {
	finishChunk(e) {
		(this.chunks.push(new ho(this.from, this.to, this.value, this.maxPoint)),
	...
	add(e, t, i) {
		this.addInner(e, t, i) || (this.nextLayer || (this.nextLayer = new dt())).add(e, t, i);
	}
	addInner(e, t, i) {
...
class Fi {
	...
	static from(e, t = null, i = -1) {
		...
		for (let r = 0; r < e.length; r++)
			for (let o = e[r]; !o.isEmpty; o = o.nextLayer) o.maxPoint >= i && s.push(new gh(o, t, i, r));
		return s.length == 1 ? s[0] : new Fi(s);
	}
	get startSide() {
		return this.value ? this.value.startSide : 0;
	}
	goto(e, t = -1e9) {
		...
		for (let i = this.heap.length >> 1; i >= 0; i--) Rs(this.heap, i);
...
class Si {
	...
	addActive(e) {
		...
		for (; t < this.activeRank.length && (r - this.activeRank[t] || s - this.activeTo[t]) > 0; )
			t++;
		(yn(this.active, t, i),
			yn(this.activeTo, t, s),
			yn(this.activeRank, t, r),
		...
		if (
			(n.point || t.point
				? ((n.point &&
						t.point &&
						ao(n.point, t.point) &&
						wr(n.activeForPoint(n.to), t.activeForPoint(t.to))) ||
						r.comparePoint(l, p, n.point, t.point),
					(c = !1))
				: (c && r.boundChange(l),
					p > l && !wr(n.active, t.active) && r.compareRange(l, p, n.active, t.active),
...
function wr(n, e) {
	if (n.length != e.length) return !1;
	for (let t = 0; t < n.length; t++) if (n[t] != e[t] && !ao(n[t], e[t])) return !1;
	return !0;
}
function gn(n, e) {
...
function bi(n, e, t = n.length) {
	...
	for (let s = 0; s < t && s < n.length; )
		n.charCodeAt(s) == 9 ? ((i += e - (i % e)), s++) : (i++, (s = ue(n, s)));
	return i;
}
function vr(n, e, t, i) {
	for (let s = 0, r = 0; ; ) {
		if (r >= e) return s;
		if (s == n.length) break;
		((r += n.charCodeAt(s) == 9 ? t - (r % t) : 1), (s = ue(n, s)));
	}
	return i === !0 ? -1 : n.length;
}
const kr = 'ͼ',
	gl = typeof Symbol > 'u' ? '__' + kr : Symbol.for(kr),
	Sr = typeof Symbol > 'u' ? '__styleSet' + Math.floor(Math.random() * 1e8) : Symbol('styleSet'),
	yl = typeof globalThis < 'u' ? globalThis : typeof window < 'u' ? window : {};
class Mt {
	constructor(e, t) {
		this.rules = [];
		let { finish: i } = t || {};
...
`);
	...
	static newName() {
		let e = yl[gl] || 1;
		return ((yl[gl] = e + 1), kr + e.toString(36));
	}
	static mount(e, t, i) {
		let s = e[Sr],
			r = i && i.nonce;
		(s ? r && s.setNonce(r) : (s = new Yu(e, r)), s.mount(Array.isArray(t) ? t : [t], e));
	}
}
let bl = new Map();
class Yu {
...
var Tt = {
	...
	Xu = typeof navigator < 'u' && /Mac/.test(navigator.platform),
	Qu =
		typeof navigator < 'u' &&
...
for (var pe = 65; pe <= 90; pe++)
	((Tt[pe] = String.fromCharCode(pe + 32)), (Hi[pe] = String.fromCharCode(pe)));
for (var Is in Tt) Hi.hasOwnProperty(Is) || (Hi[Is] = Tt[Is]);
function Zu(n) {
	var e =
			(Xu && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey) ||
			(Qu && n.shiftKey && n.key && n.key.length == 1) ||
			n.key == 'Unidentified',
		t = (!e && n.key) || (n.shiftKey ? Hi : Tt)[n.keyCode] || n.key || 'Unidentified';
	return (
		t == 'Esc' && (t = 'Escape'),
		t == 'Del' && (t = 'Delete'),
		t == 'Left' && (t = 'ArrowLeft'),
...
function X() {
	...
	for (; e < arguments.length; e++) yh(n, arguments[e]);
	return n;
}
function yh(n, e) {
	if (typeof e == 'string') n.appendChild(document.createTextNode(e));
		...
		else if (Array.isArray(e)) for (var t = 0; t < e.length; t++) yh(n, e[t]);
		else throw new RangeError('Unsupported child node: ' + e);
}
let Se = typeof navigator < 'u' ? navigator : { userAgent: '', vendor: '', platform: '' },
	Cr = typeof document < 'u' ? document : { documentElement: { style: {} } };
const Ar = /Edge\/(\d+)/.exec(Se.userAgent),
	bh = /MSIE \d/.test(Se.userAgent),
	Mr = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Se.userAgent),
	ms = !!(bh || Mr || Ar),
	xl = !ms && /gecko\/(\d+)/i.test(Se.userAgent),
	Bs = !ms && /Chrome\/(\d+)/.exec(Se.userAgent),
	ed = 'webkitFontSmoothing' in Cr.documentElement.style,
	Tr = !ms && /Apple Computer/.test(Se.vendor),
	wl = Tr && (/Mobile\/\w+/.test(Se.userAgent) || Se.maxTouchPoints > 2);
var E = {
	mac: wl || /Mac/.test(Se.platform),
	windows: /Win/.test(Se.platform),
	linux: /Linux|X11/.test(Se.platform),
	ie: ms,
	ie_version: bh ? Cr.documentMode || 6 : Mr ? +Mr[1] : Ar ? +Ar[1] : 0,
	gecko: xl,
	gecko_version: xl ? +(/Firefox\/(\d+)/.exec(Se.userAgent) || [0, 0])[1] : 0,
	chrome: !!Bs,
	chrome_version: Bs ? +Bs[1] : 0,
	ios: wl,
	android: /Android\b/.test(Se.userAgent),
	webkit_version: ed ? +(/\bAppleWebKit\/(\d+)/.exec(Se.userAgent) || [0, 0])[1] : 0,
	safari: Tr,
	safari_version: Tr ? +(/\bVersion\/(\d+(\.\d+)?)/.exec(Se.userAgent) || [0, 0])[1] : 0,
...
class P extends At {
	...
	static replace(e) {
		...
		return new jt(e, i, s, t, e.widget || null, !0);
	}
	static line(e) {
		return new sn(e);
	}
		...
		(super(t ? -1 : 5e8, i ? 1 : -6e8, null, e),
			...
			(this.attrs =
				e.class && e.attributes
					? co(e.attributes, { class: e.class })
					: e.class
						? { class: e.class }
						: e.attributes || Gn));
	}
	eq(e) {
		return this == e || (e instanceof nn && this.tagName == e.tagName && fo(this.attrs, e.attrs));
	}
	range(e, t = e) {
...
class sn extends P {
	...
	eq(e) {
		return (
			...
			fo(this.spec.attributes, e.spec.attributes)
		);
	}
	range(e, t = e) {
...
class jt extends P {
	constructor(e, t, i, s, r, o) {
		(super(t, i, r, e),
			(this.block = s),
			(this.isReplace = o),
			(this.mapMode = s ? (t <= 0 ? me.TrackBefore : me.TrackAfter) : me.TrackDel));
	}
	get type() {
...
class zi extends At {
	...
	eq(e) {
		return (
			e == this ||
			(e instanceof zi && this.tagName == e.tagName && fo(this.attributes, e.attributes))
		);
	}
	static create(e) {
		return new zi(e.tagName, e.attributes || Gn);
	}
	static set(e, t = !1) {
		return z.of(e, t);
	}
...
function Pi(n) {
	return n.nodeType == 3
		? $i(n, 0, n.nodeValue.length).getClientRects()
		: n.nodeType == 1
			? n.getClientRects()
			: [];
}
		...
		if (c.nodeType == 1) {
			...
			if (
				...
				if (d) h.scrollBy(g, y);
					...
					if (y) {
						let L = c.scrollTop;
						((c.scrollTop += y / m), (C = (c.scrollTop - L) * m));
					}
					if (g) {
						let L = c.scrollLeft;
						((c.scrollLeft += g / p), (S = (c.scrollLeft - L) * p));
					}
					((e = { left: e.left - S, top: e.top - C, right: e.right - S, bottom: e.bottom - C }),
						S && Math.abs(S - g) < 1 && (i = 'nearest'),
						C && Math.abs(C - y) < 1 && (s = 'nearest'));
				}
			if (d) break;
...
let It = null;
E.safari && E.safari_version >= 26 && (It = !1);
function kh(n) {
...
function Ch(n, e) {
	for (let t = n, i = e; ; ) {
		...
		} else if (t.parentNode && !Jn(t)) ((i = Dt(t)), (t = t.parentNode));
		else return null;
	}
}
function Ah(n, e) {
	for (let t = n, i = e; ; ) {
		...
		} else if (t.parentNode && !Jn(t)) ((i = Dt(t) + 1), (t = t.parentNode));
		else return null;
	}
}
class je {
	...
	static before(e, t) {
		return new je(e.parentNode, Dt(e), t);
	}
	static after(e, t) {
		return new je(e.parentNode, Dt(e) + 1, t);
	}
}
var te = (function (n) {
...
function Dh(n, e) {
	...
	for (let t = 0; t < n.length; t++) {
		let i = n[t],
			s = e[t];
		if (i.from != s.from || i.to != s.to || i.direction != s.direction || !Dh(i.inner, s.inner))
			return !1;
	}
	return !0;
}
...
function ud(n, e, t, i, s) {
	for (let r = 0; r <= i.length; r++) {
		...
		for (let h = o, c = a, f = a; h < l; h++) {
			let u = Q[h];
			if (u == 128) h < l - 1 && c == Q[h + 1] && c & 24 ? (u = Q[h] = c) : (Q[h] = 256);
			else if (u == 64) {
				let d = h + 1;
				for (; d < l && Q[d] == 64; ) d++;
				let p = (h && c == 8) || (d < t && Q[d] == 8) ? (f == 1 ? 1 : 8) : 256;
				for (let m = h; m < d; m++) Q[m] = p;
				h = d - 1;
			} else u == 8 && f == 1 && (Q[h] = 1);
			((c = u), u & 7 && (f = u));
		}
		...
		for (let a = o; a < l; ) {
			...
			if (h == 256) {
				...
				for (let p = c, m = s, g = m ? t[m - 1].to : n; p > a; )
					(p == g && ((p = t[--m].from), (g = m ? t[m - 1].to : n)), (Q[--p] = d));
				a = c;
			} else ((r = h), a++);
		}
	}
			...
			e: for (;;)
				if (h < r.length && p == r[h].from) {
					...
					if ((h++, u)) u.push(m);
						...
						(_r(n, g ? i + 1 : i, s, m.inner, m.from, m.to, o), (a = m.to));
					}
					p = m.to;
				} else {
					if (p == t || (c ? Q[p] != l : Q[p] == l)) break;
					p++;
				}
			(u ? Or(n, a, p, i + 1, s, u, o) : a < p && o.push(new nt(a, p, d)), (a = p));
		}
	else
			...
			e: for (;;)
				if (h && p == r[h - 1].to) {
					...
					if (u) u.push(m);
						...
						let g = (m.direction == $t) != !(d % 2);
						(_r(n, g ? i + 1 : i, s, m.inner, m.from, m.to, o), (a = m.from));
					}
					p = m.from;
				} else {
					if (p == e || (c ? Q[p - 1] != l : Q[p - 1] == l)) break;
					p--;
				}
			(u ? Or(n, p, a, i + 1, s, u, o) : p < a && o.push(new nt(p, a, d)), (a = p));
		}
}
function _r(n, e, t, i, s, r, o) {
	let l = e % 2 ? 2 : 1;
	(ud(n, s, r, i, l), dd(n, s, r, i, l), pd(s, r, i, l), Or(n, s, r, e, t, i, o));
}
function md(n, e, t) {
	if (!n) return [new nt(0, 0, e == uo ? 1 : 0)];
	if (e == $t && !t.length && !fd.test(n)) return Eh(n.length);
	if (t.length) for (; n.length > Q.length; ) Q[Q.length] = 256;
	let i = [],
		s = e == $t ? 0 : 1;
	return (_r(n, s, s, t, 0, n.length, i), i);
}
function Eh(n) {
	return [new nt(0, n, 0)];
}
...
function gd(n, e, t, i, s) {
	...
	let c = ue(n.text, o, a.forward(s, t));
	...
	return f && c == h && f.level + (s ? 0 : 1) < a.level
		? v.cursor(f.side(!s, t) + n.from, f.forward(s, t) ? 1 : -1, f.level)
		: v.cursor(c + n.from, a.forward(s, t) ? -1 : 1, a.level);
}
function yd(n, e, t) {
	for (let i = e; i < t; i++) {
		let s = Th(n.charCodeAt(i));
		if (s == 1) return $t;
		if (s == 2 || s == 4) return uo;
	}
	return $t;
}
const _h = _.define(),
	...
	po = _.define(),
	mo = _.define(),
	Nh = _.define({ combine: (n) => n.some((e) => e) }),
	Vh = _.define({ combine: (n) => n.some((e) => e) }),
	Wh = _.define();
class oi {
	...
	map(e) {
		return e.empty
			? this
			: new oi(this.range.map(e), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
	}
	clip(e) {
		return this.range.to <= e.doc.length
			? this
			: new oi(v.cursor(e.doc.length), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
	}
}
const bn = I.define({ map: (n, e) => n.map(e) }),
	Fh = I.define();
function Ee(n, e, t) {
	let i = n.facet(Rh);
	i.length
		? i[0](e)
		: (window.onerror && window.onerror(String(e), t, void 0, void 0, e)) || (t && t + '');
}
const ct = _.define({ combine: (n) => (n.length ? n[0] : !0) });
let bd = 0;
const Zt = _.define({
	combine(n) {
		return n.filter((e, t) => {
...
class oe {
	constructor(e, t, i, s, r) {
		((this.id = e),
			...
			(this.extension = this.baseExtensions.concat(Zt.of({ plugin: this, arg: void 0 }))));
	}
	of(e) {
	...
	update(e) {
		if (this.value) {
			if (this.mustUpdate) {
				...
				if (((this.mustUpdate = null), this.value.update))
					try {
						...
						if ((Ee(t.state, i, 'CodeMirror plugin crashed'), this.value.destroy))
							try {
								this.value.destroy();
							} catch {}
						this.deactivate();
			...
			try {
				...
				(Ee(e.state, t, 'CodeMirror plugin crashed'), this.deactivate());
			}
		return this;
	}
	destroy(e) {
		...
		if (!((t = this.value) === null || t === void 0) && t.destroy)
			try {
				...
				Ee(e.state, i, 'CodeMirror plugin crashed');
			}
	}
	deactivate() {
...
class Yn {
	constructor(e, t, i) {
		((this.view = e),
			...
			(this.changes = ce.empty(this.startState.doc.length)));
		for (let r of i) this.changes = this.changes.compose(r.changes);
		let s = [];
		(this.changes.iterChangedRanges((r, o, l, a) => s.push(new Ve(r, o, l, a))),
...
class re {
	...
	get root() {
		for (let e = this; e; e = e.parent) if (e instanceof bs) return e;
		return null;
	}
	static get(e) {
		return e.cmTile;
	...
	sync(e) {
		...
		for (let l of this.children) {
			if (
				...
				for (; s && s != l.dom; ) s = Al(s);
			else t.insertBefore(l.dom, s);
			i = l.dom;
		}
		for (s = i ? i.nextSibling : t.firstChild, r && s && (r.written = !0); s; ) s = Al(s);
		this.length = o;
	}
}
function Al(n) {
	...
	blockTiles(e) {
		for (let t = [], i = this, s = 0, r = 0; ; )
			if (s == i.children.length) {
				...
				let o = i.children[s++];
				if (o instanceof ut) (t.push(s), (i = o), (s = 0));
				else {
					let l = r + o.length,
						a = e(o, r);
...
class fi extends ys {
	...
	static start(e, t, i) {
		let s = new fi(t || document.createElement('div'), e);
		...
		function a(c, f) {
			for (let u = 0, d = 0; u < c.children.length && d <= f; u++) {
				...
				(m >= f &&
					(p.isComposite()
						? a(p, f - d)
						: (!o || (o.isHidden && (t > 0 || (i && vd(o, p))))) && (m > f || p.flags & 32)
							? ((o = p), (l = f - d))
							: (d < f || (p.flags & 16 && !p.isHidden)) && ((s = p), (r = f - d))),
					(d = m));
			}
		}
		a(this, e);
	...
	coordsIn(e, t) {
		...
		return i ? i.tile.coordsIn(Math.max(0, i.offset), t) : wd(this);
	}
	domIn(e, t) {
		...
		if (i) {
			...
			if (this.dom.contains(s.dom))
				return s.isText()
					? new je(s.dom, Math.min(s.dom.nodeValue.length, r))
...
class Wt extends re {
	...
	coordsIn(e, t) {
		...
		let s = e,
			...
			o = 0;
		(e == 0 && t < 0) || (e == i && t >= 0)
			? E.chrome || E.gecko || (e ? (s--, (o = 1)) : r < i && (r++, (o = -1)))
			: t < 0
				? s--
				: r < i && r++;
		let l = $i(this.dom, s, r).getClientRects();
		if (!l.length) return null;
		let a = l[(o ? o < 0 : t >= 0) ? 0 : l.length - 1];
		return (
			E.safari && !o && a.width == 0 && (a = Array.prototype.find.call(l, (h) => h.width) || a),
			o ? ji(a, o < 0) : a || null
		);
	}
	static of(e, t) {
...
class Kt extends re {
	...
	coordsInWidget(e, t, i) {
		...
		if (s) return s;
		if (i) return ji(this.dom.getBoundingClientRect(), this.length ? e == 0 : t <= 0);
		{
...
class Cd {
	...
	addText(e, t, i, s) {
		...
		if (l && l.isText() && !(l.flags & 8) && l.length + e.length < 512) {
			...
			o.append(s || Wt.of(e, (r = this.cache.find(Wt)) === null || r === void 0 ? void 0 : r.dom));
		((this.pos += e.length), (this.afterWidget = null));
	}
	addComposition(e, t) {
		let i = this.curLine;
		i.dom != t.line.dom &&
			(i.setDOM(this.cache.reused.has(t.line) ? Vs(t.line.dom) : t.line.dom),
			this.cache.reused.set(t.line, 2));
		let s = i;
		for (let l = t.marks.length - 1; l >= 0; l--) {
			let a = t.marks[l],
				h = s.lastChild;
			if (h instanceof De && h.mark.eq(a.mark)) (h.dom != a.dom && h.setDOM(Vs(a.dom)), (s = h));
			else {
	...
	addLineStart(e, t) {
		...
		let s = fi.start(
			e,
			t || ((i = this.cache.find(fi)) === null || i === void 0 ? void 0 : i.dom),
			!!t
		);
	...
	ensureMarks(e, t) {
		...
		for (let r = e.length - 1; r >= 0; r--) {
			let o = e[r],
				l;
			if (t > 0 && (l = s.lastChild) && l instanceof De && l.mark.eq(o)) ((s = l), t--);
			else {
				let a = De.of(
					o,
					(i = this.cache.find(De, (h) => h.mark.eq(o))) === null || i === void 0 ? void 0 : i.dom
				);
				(s.append(a), (s = a), (t = 0));
			}
		}
	...
	endLine() {
		if (this.curLine) {
			...
			((!e ||
				!Ml(this.curLine, !1) ||
				(e.dom.nodeName != 'BR' && e.isWidget() && !(E.ios && Ml(this.curLine, !0)))) &&
				this.curLine.append(this.cache.findWidget(Ws, 0, 32) || new Kt(Ws.toDOM(), 0, Ws, 32)),
	...
	updateBlockWrappers() {
		...
		for (let e = this.blockWrappers; e.value && e.from <= this.pos; e.next())
			if (e.to >= this.pos) {
				let t = new Sd(e.from, e.to, e.value, e.rank),
	...
	getBlockPos() {
		...
		for (let i of this.wrappers) {
			let s = t.lastChild;
			if (i.from < this.pos && s instanceof ut && s.wrapper.eq(i.wrapper)) t = s;
			else {
				let r = ut.of(
					i.wrapper,
					(e = this.cache.find(ut, (o) => o.wrapper.eq(i.wrapper))) === null || e === void 0
						? void 0
						: e.dom
				);
				(t.append(r), (t = r));
	...
	getBuffer(e) {
		let t = 2 | (e < 0 ? 16 : 32),
			i = this.cache.find(Xn, void 0, 1);
		return (i && (i.flags = t), i || new Xn(t));
	}
	flushBuffer() {
		this.afterWidget &&
...
const Qn = [Kt, fi, Wt, De, Xn, ut, bs];
for (let n = 0; n < Qn.length; n++) Qn[n].bucket = n;
class Md {
	constructor(e) {
		((this.view = e),
			(this.buckets = Qn.map(() => [])),
				...
				if (
					...
					return (
						...
						l.widget == e && l.length == t && (l.flags & 497) == i
							...
							: (this.reused.set(l, 2), new Kt(l.dom, t, e, (l.flags & -498) | i))
					);
			}
	}
	reuse(e) {
...
class Td {
	constructor(e, t, i, s, r) {
		((this.view = e),
			...
			(this.openMarks = 0),
			(this.cache = new Md(e)),
			(this.text = new Ad(e.state.doc)),
			(this.builder = new Cd(this.cache, new bs(e, e.contentDOM), z.iter(i))),
		...
		(this.old.advance(e, i ? 1 : -1, {
			skip: (o, l, a) => {
				if (o.isWidget())
					if (this.openWidget) this.builder.continueWidget(a - l);
						...
						let h =
							a > 0 || l < o.length
								? Kt.of(o.widget, this.view, a - l, o.flags & 496, this.cache.maybeReuse(o))
								: this.cache.reuse(o);
						h.flags & 256
				...
				else if (o instanceof Xn) this.cache.add(o);
			...
			enter: (o) => {
				(o.isLine()
					...
					: (this.cache.add(o), o instanceof De && s.unshift(o.mark)),
					(this.openWidget = !1));
			},
			leave: (o) => {
				o.isLine()
					? s.length && (s.length = r = 0)
					: o instanceof De && (s.shift(), (r = Math.min(r, s.length)));
			},
			break: () => {
				...
				point: (l, a, h, c, f, u) => {
					if (h instanceof jt) {
						...
						if (((r = c.length), f > c.length)) s.continueWidget(a - l);
							...
							let d = h.widget || (h.block ? ui.block : ui.inline),
								p = Dd(h),
								m = this.cache.findWidget(d, a - l, p) || Kt.of(d, this.view, a - l, p);
							h.block
								? (h.startSide > 0 && s.addLineStartIfNotCovered(i), s.addBlockWidget(m))
				...
				: r != null && r.isLine()
					...
					: r instanceof ut ||
						(s.nodeName == 'DIV' && !i && s != this.view.contentDOM
							? (i = new fi(s, $h))
							: i ||
								t.push(De.of(new nn({ tagName: s.nodeName.toLowerCase(), attributes: id(s) }), s)));
		}
...
const $h = { class: 'cm-line' };
function Ed(n, e) {
	let t = e.spec.attributes,
		i = e.spec.class;
	return (
		(!t && !i) || (n || (n = { class: 'cm-line' }), t && co(t, n), i && (n.class += ' ' + i)),
		n
	);
}
function Od(n) {
...
class Tl {
	constructor(e) {
		((this.view = e),
			...
			(this.editContextFormatting = P.none),
			...
			this.updateDeco(),
			(this.tile = new bs(e, e.contentDOM)),
			this.updateInner([new Ve(0, 0, 0, e.state.doc.length)], null));
	}
	update(e) {
		var t;
		...
		this.view.inputState.composing >= 0 &&
			...
			(!((t = this.domChanged) === null || t === void 0) && t.newSel
				...
				: !Wd(e.changes, this.hasComposition) &&
					!e.selectionSet &&
					(s = e.state.selection.main.head));
		let r = s > -1 ? Ld(this.view, e.changes, s) : null;
		if (((this.domChanged = null), this.hasComposition)) {
			let { from: c, to: f } = this.hasComposition;
			i = new Ve(c, f, e.changes.mapPos(c, -1), e.changes.mapPos(f, 1)).addToSet(i.slice());
		}
	...
	updateInner(e, t) {
		...
		i.ignore(() => {
			if (t || e.length) {
				let o = this.tile,
					l = new Td(this.view, o, this.blockWrappers, this.decorations, this.dynamicDecorationMap);
				(t && re.get(t.text) && l.cache.reused.set(re.get(t.text), 2),
					(this.tile = l.run(e, t)),
					Pr(o, l.cache.reused));
			}
			...
			let r = E.chrome || E.ios ? { node: i.selectionRange.focusNode, written: !1 } : void 0;
			(this.tile.sync(r),
				r &&
		...
		if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length)
			for (let r of this.tile.children) r.isWidget() && r.widget instanceof Fs && s.push(r.dom);
		i.updateGaps(s);
	}
	updateEditContextFormatting(e) {
		this.editContextFormatting = this.editContextFormatting.map(e.changes);
		for (let t of e.transactions)
			for (let i of t.effects) i.is(Fh) && (this.editContextFormatting = i.value);
	}
	updateSelection(e = !1, t = !1) {
		...
		let { dom: i } = this.tile,
			...
			o =
				!r &&
				!(this.view.state.facet(ct) || i.tabIndex > -1) &&
				Li(i, this.view.observer.selectionRange) &&
				!(s && i.contains(s));
		if (!(r || t || o)) return;
		...
		if (
			...
			E.gecko && a.empty && !this.hasComposition && _d(h))
		) {
		...
		((l ||
			!f.focusNode ||
			((!Ri(h.node, h.offset, f.anchorNode, f.anchorOffset) ||
				!Ri(c.node, c.offset, f.focusNode, f.focusOffset)) &&
			...
			(this.view.observer.ignore(() => {
				...
				if (u)
					if (a.empty) {
						if (E.gecko) {
							let d = Pd(h.node, h.offset);
							if (d && d != 3) {
								let p = (d == 1 ? Ch : Ah)(h.node, h.offset);
			...
			(this.impreciseAnchor = h.precise ? null : new je(f.anchorNode, f.anchorOffset)),
			(this.impreciseHead = c.precise ? null : new je(f.focusNode, f.focusOffset)));
	}
	suppressWidgetCursorChange(e, t) {
		return (
			this.hasComposition &&
			t.empty &&
			Ri(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset) &&
	...
	posFromDOM(e, t) {
		...
		if (i.isComposite()) {
			...
			for (; r && !re.get(r); ) r = r.nextSibling;
	...
	measureVisibleLineHeights(e) {
		let t = [],
			...
			l = -1,
			a = this.view.textDirection == te.LTR,
			h = 0,
			c = (f, u, d) => {
				for (let p = 0; p < f.children.length && !(u > s); p++) {
					let m = f.children[p],
						g = u + m.length,
						y = m.dom.getBoundingClientRect(),
						{ height: S } = y;
					if ((d && !p && (h += y.top - d.top), m instanceof ut)) g > i && c(m, u, y);
					else if (u >= i && (h > 0 && t.push(-h), t.push(S + h), (h = 0), o)) {
						let C = m.dom.lastChild,
							L = C ? Pi(C) : [];
						if (L.length) {
							let A = L[L.length - 1],
								M = a ? A.right - y.left : y.right - A.left;
							M > l &&
								((l = M), (this.minWidth = r), (this.minWidthFrom = u), (this.minWidthTo = g));
						}
					}
	...
	computeBlockGapDeco() {
		...
		for (let i = 0, s = 0; ; s++) {
			...
			if (o > i) {
				...
				e.push(
					P.replace({ widget: new Fs(l), block: !0, inclusive: !0, isBlockGap: !0 }).range(i, o)
				);
			}
			if (!r) break;
			i = r.to + 1;
	...
	updateDeco() {
		let e = 1,
			...
			i = !1,
			s = this.view.state.facet(yo).map((r, o) => {
	...
	scrollIntoView(e) {
		...
		for (let c of this.view.state.facet(Wh))
			try {
				if (c(this.view, e.range, e)) return !0;
			} catch (f) {
				Ee(this.view.state, f, 'scroll handler');
			}
		let { range: i } = e,
			s = this.coordsAt(
				i.head,
		...
		if (
			(rd(
				...
				this.view.textDirection == te.LTR
			),
...
function Pr(n, e) {
	...
	if (t != 1) {
		t == null && n.destroy();
		for (let i of n.children) Pr(i, e);
	}
}
function _d(n) {
	return (
...
function Kh(n, e) {
	...
	let i = Ch(t.focusNode, t.focusOffset),
		s = Ah(t.focusNode, t.focusOffset),
		r = i || s;
...
function Fd(n, e, t = 1) {
	...
	let o = r,
		l = r;
	t < 0 ? (o = ue(s.text, r, !1)) : (l = ue(s.text, r));
	...
	if (Array.isArray(i.type)) {
		...
		for (let r of i.type) {
			...
			if (!(r.to < e)) {
				...
				(!s || (r.type == ge.Text && (s.type != r.type || (t < 0 ? r.from < e : r.to > e)))) &&
					(s = r);
			}
		}
		return s || i;
...
function zd(n, e, t, i) {
	let s = Rr(n, e.head, e.assoc || -1),
		r =
			!i || s.type != ge.Text || !(n.lineWrapping || s.widgetLineBreaks)
				? null
...
function jd(n, e, t, i) {
	...
	if (h) (o == null && (o = h.left - a.left), (l = r < 0 ? h.top : h.bottom));
		...
		(o == null && (o = Math.min(a.right - a.left, n.defaultCharacterWidth * (s - p.from))),
	...
	for (let p = 0; ; p += u) {
		let m = l + (d + p) * r,
			g = Ir(n, { x: f, y: m }, !1, r);
		if (t ? m > a.bottom : m < a.top) return v.cursor(g.pos, g.assoc);
		let y = n.coordsAtPos(g.pos, g.assoc),
			S = y ? (y.top + y.bottom) / 2 : 0;
		if (!y || (t ? S > l : S < l)) return v.cursor(g.pos, g.assoc, void 0, o);
	}
}
function Ii(n, e, t) {
	for (;;) {
...
function Ir(n, e, t, i) {
	...
	if (h.type != ge.Text) return a < (h.top + h.bottom) / 2 ? new tt(h.from, 1) : new tt(h.to, -1);
	let c = n.docView.lineAt(h.from, 2);
	return (
		(!c || c.length != h.length) && (c = n.docView.lineAt(h.from, -2)),
		new $d(n, o, l, n.textDirectionAt(h.from)).scanTile(c, h.from)
	);
}
class $d {
	constructor(e, t, i, s) {
			...
			if (m)
				for (let g = 0; g < m.length; g++) {
					...
					if (!(y.width == 0 && m.length > 1)) {
						if (y.bottom < this.y) ((!l || l.bottom < y.bottom) && (l = y), (S = 1));
						else if (y.top > this.y) ((!a || a.top > y.top) && (a = y), (S = -1));
						else {
							let C = y.left > this.x ? this.x - y.left : y.right < this.x ? this.x - y.right : 0,
								L = Math.abs(C);
							(L < c && ((h = p), (c = L), (f = y)),
								C && (S = C < 0 == (this.baseDir == te.LTR) ? -1 : 1));
						}
	...
	scanText(e, t) {
		let i = [];
		for (let r = 0; r < e.length; r = ue(e.text, r)) i.push(t + r);
		i.push(t + e.length);
		let s = this.scan(i, (r) => {
			let o = i[r] - t,
				l = i[r + 1] - t;
	...
	scanTile(e, t) {
		...
		let s = this.scan(i, (l) => {
				...
				return a.flags & 48
					? null
					: (a.dom.nodeType == 1 ? a.dom : $i(a.dom, 0, a.length)).getClientRects();
			}),
			r = e.children[s.i],
			o = i[s.i];
		return r.isText()
...
class Kd {
	constructor(e, t) {
		((this.points = e),
			(this.view = t),
			(this.text = ''),
			(this.lineSeparator = t.state.facet($.lineSeparator)));
	}
	append(e) {
		this.text += e;
	}
	...
	readRange(e, t) {
		...
		for (let s = e; ; ) {
			...
			((o && a
				? o.breakAfter
				: (o ? o.breakAfter : Jn(s)) ||
					(Jn(l) && (s.nodeName != 'BR' || (o != null && o.isWidget())) && this.text.length > r)) &&
				!Gd(l, t) &&
				this.lineBreak(),
				(s = l));
		}
	...
	findPointInside(e, t) {
		for (let i of this.points)
			(e.nodeType == 3 ? i.node == e : e.contains(i.node)) &&
				(i.pos = this.text.length + (Ud(e, i.node, i.offset) ? t : 0));
	}
}
function Ud(n, e, t) {
	for (;;) {
		if (!e || t < pt(e)) return !1;
		if (e == n) return !0;
		...
		if (e.state.readOnly && t > -1) this.newSel = null;
			...
			if (e.inputState.composing > -1 && l.ranges.length > 1)
				...
				(u && (d = e.inputState.lastTouchY <= u.bottom ? -1 : 1),
					(this.newSel = v.create([v.cursor(h, d)])));
			} else this.newSel = v.single(c, h);
		}
	}
}
function Gh(n, e, t, i) {
...
function Jh(n, e) {
	...
	if (e.bounds) {
		let { from: l, to: a } = e.bounds,
			h = r.from,
			c = null;
		(o === 8 || (E.android && e.text.length < a - l)) && ((h = r.to), (c = 'end'));
		let f = s.doc.sliceString(l, a, Yt),
			u,
			d;
		!r.empty &&
		r.from >= l &&
		...
		f.slice(r.to - l) == e.text.slice((u = e.text.length - (f.length - (r.to - l))))
			? (t = { from: r.from, to: r.to, insert: j.of(e.text.slice(r.from - l, u).split(Yt)) })
			: (d = Yh(f, e.text, h - l, c)) &&
				(E.chrome &&
					o == 13 &&
					d.toB == d.from + 2 &&
					e.text.slice(d.from, d.toB) == Yt + Yt &&
					d.toB--,
				(t = {
					from: l + d.from,
					to: l + d.toA,
					insert: j.of(e.text.slice(d.from, d.toB).split(Yt))
				}));
	} else i && ((!n.hasFocus && s.facet(ct)) || Zn(i, r)) && (i = null);
	if (!t && !i) return !1;
	if (
		((E.mac || E.android) &&
		t &&
		...
		n.contentDOM.getAttribute('autocorrect') == 'off'
			? (i && t.insert.length == 2 && (i = v.single(i.main.anchor - 1, i.main.head - 1)),
				(t = { from: t.from, to: t.to, insert: j.of([t.insert.toString().replace('.', ' ')]) }))
 ...
 ` &&
					n.lineWrapping &&
					(i && (i = v.single(i.main.anchor - 1, i.main.head - 1)),
...
function xo(n, e, t, i = -1) {
	if (E.ios && n.inputState.flushIOSKey(e)) return !0;
	...
	let o,
		l = () => o || (o = Yd(n, e, t));
	return (n.state.facet(Ih).some((a) => a(n, e.from, e.to, r, l)) || n.dispatch(l()), !0);
}
function Yd(n, e, t) {
	let i,
		s = n.state,
	...
	if ((e.from == e.to && e.from < r.from) || e.from > r.to) {
		let a = e.from < r.from ? -1 : 1,
			h = a < 0 ? r.from : r.to,
			c = Ii(
				s.facet(rn).map((f) => f(n)),
				h,
				a
			);
		e.from == c && (o = c);
	}
	if (o > -1) i = { changes: e, selection: v.cursor(e.from + e.insert.length, -1) };
	else if (
		e.from >= r.from &&
		e.to <= r.to &&
		...
		if (
			...
			i = s.changeByRange((p) => {
				...
				return {
					changes: y,
					range: h ? v.range(Math.max(0, h.anchor + S), Math.max(0, h.head + S)) : p.map(y)
				};
			});
...
class Zd {
	...
	constructor(e) {
		((this.view = e),
			...
			E.safari && e.contentDOM.addEventListener('input', () => null),
			E.gecko && pp(e.contentDOM.ownerDocument));
	}
	handleEvent(e) {
		!lp(this.view, e) ||
	...
	keydown(e) {
		...
		if (
			(this.tabFocusMode > 0 &&
				e.keyCode != 27 &&
				Qh.indexOf(e.keyCode) < 0 &&
				(this.tabFocusMode = -1),
			E.android && E.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8))
		)
		...
		return E.ios &&
			...
			!e.metaKey &&
			!e.shiftKey &&
			(((t = Xh.find((i) => i.keyCode == e.keyCode)) && !e.ctrlKey) ||
				(tp.indexOf(e.key) > -1 && e.ctrlKey))
...
function ep(n) {
	...
	for (let i of n) {
		...
		if (r)
			for (let l in r) {
				let a = r[l];
				a && t(l).handlers.push(Ol(i.value, a));
			}
		if (o)
			for (let l in o) {
				let a = o[l];
				a && t(l).observers.push(Ol(i.value, a));
			}
	}
	for (let i in $e) t(i).handlers.push($e[i]);
	for (let i in _e) t(i).observers.push(_e[i]);
	return e;
}
const Xh = [
...
class np {
	constructor(e, t, i, s) {
		((this.view = e),
			...
			(this.scrolling = -1),
			(this.lastEvent = t),
			(this.scrollParents = vh(e.contentDOM)),
			(this.atoms = e.state.facet(rn).map((o) => o(e))));
		...
		(r.addEventListener('mousemove', (this.move = this.move.bind(this))),
			...
			(this.multiple = e.state.facet($.allowMultipleSelections) && sp(e, t)),
			(this.dragging = op(e, t) && tc(t) == 1 ? null : !1));
	}
	start(e) {
	...
	move(e) {
		...
		if (this.dragging || (this.dragging == null && ip(this.startEvent, e) < 10)) return;
		...
		(e.clientX - a.left <= s + xn
			? (t = -wn(s - e.clientX))
			: e.clientX + a.right >= o - xn && (t = wn(e.clientX - o)),
			e.clientY - a.top <= r + xn
				? (i = -wn(r - e.clientY))
				: e.clientY + a.bottom >= l - xn && (i = wn(e.clientY - l)),
	...
	select(e) {
		let { view: t } = this,
			i = Uh(this.atoms, this.style.get(e, this.extend, this.multiple));
...
function lp(n, e) {
	...
	for (let t = e.target, i; t != n.contentDOM; t = t.parentNode)
		if (
			!t ||
			t.nodeType == 11 ||
			((i = re.get(t)) && i.isWidget() && !i.isHidden && i.widget.ignoreEvent(e))
		)
			return !1;
	return !0;
}
const $e = Object.create(null),
	...
	Zh = (E.ie && E.ie_version < 15) || (E.ios && E.webkit_version < 604);
function ap(n) {
...
function ec(n, e) {
	...
	if (Br != null && t.selection.ranges.every((a) => a.empty) && Br == r.toString()) {
		...
		i = t.changeByRange((h) => {
			...
			return { changes: { from: c.from, insert: f }, range: v.cursor(h.from + f.length) };
		});
	} else
		o
			? (i = t.changeByRange((a) => {
...
$e.mousedown = (n, e) => {
	...
	let t = null;
	for (let i of n.state.facet(Ph)) if (((t = i(n, e)), t)) break;
	if ((!t && e.button == 0 && (t = cp(n, e)), t)) {
		let i = !n.hasFocus;
		(n.inputState.startMouseSelection(new np(n, e, t, i)),
			i &&
				n.observer.ignore(() => {
					kh(n.contentDOM);
...
const hp = E.ie && E.ie_version <= 11;
let Ll = null,
	Pl = 0,
	Rl = 0;
function tc(n) {
	if (!hp) return n.detail;
	let e = Ll,
		t = Rl;
	return (
		(Ll = n),
	...
	return {
		...
		get(r, o, l) {
			let a = n.posAndSideAtCoords({ x: r.clientX, y: r.clientY }, !1),
				h,
				c = _l(n, a.pos, a.assoc, i);
			if (t.pos != a.pos && !o) {
				let f = _l(n, t.pos, t.assoc, i),
					u = Math.min(f.from, c.from),
					d = Math.max(f.to, c.to);
				c = u < c.from ? v.range(u, d, c.assoc) : v.range(d, u, c.assoc);
			}
			return o
				? s.replaceRange(s.main.extend(c.from, c.to, c.assoc))
				: l && i == 1 && s.ranges.length > 1 && (h = fp(s, a.pos))
					? h
					: l
						? s.addRange(c)
						: v.create([c]);
...
$e.dragstart = (n, e) => {
	...
	return (
		...
		(i.draggedContent = t),
		e.dataTransfer &&
			(e.dataTransfer.setData('Text', xs(n.state, mo, n.state.sliceDoc(t.from, t.to))),
...
$e.paste = (n, e) => {
	...
	return t ? (ec(n, t.getData('text/plain') || t.getData('text/uri-list')), !0) : (ap(n), !1);
};
function up(n, e) {
...
function dp(n) {
	...
	return { text: xs(n, mo, e.join(n.lineBreak)), ranges: t, linewise: i };
}
let Br = null;
$e.copy = $e.cut = (n, e) => {
	if (!Li(n.contentDOM, n.observer.selectionRange)) return !1;
	let { text: t, ranges: i, linewise: s } = dp(n.state);
	if (!t && !s) return !1;
	((Br = s ? t : null),
		e.type == 'cut' &&
			!n.state.readOnly &&
			n.dispatch({ changes: i, scrollIntoView: !0, userEvent: 'delete.cut' }));
	let r = Zh ? null : e.clipboardData;
	return r ? (r.clearData(), r.setData('text/plain', t), !0) : (up(n, t), !1);
};
const ic = gt.define();
function nc(n, e) {
	let t = [];
	...
	return t.length ? n.update({ effects: t, annotations: ic.of(!0) }) : null;
}
function sc(n) {
	setTimeout(() => {
		let e = n.hasFocus;
...
$e.beforeinput = (n, e) => {
	...
	if (
		...
		if (r && o.length) {
			...
			return (xo(n, { from: a, to: h, insert: n.state.toText(r) }, null), !0);
		}
	}
	let s;
	if (
		E.chrome &&
		E.android &&
		(s = Xh.find((r) => r.inputType == e.inputType)) &&
	...
	return (
		E.ios && e.inputType == 'deleteContentForward' && n.observer.flushSoon(),
		E.safari &&
			e.inputType == 'insertText' &&
			n.inputState.composing >= 0 &&
			setTimeout(() => _e.compositionend(n, e), 20),
		!1
	);
};
const Bl = new Set();
function pp(n) {
	Bl.has(n) ||
		(Bl.add(n), n.addEventListener('copy', () => {}), n.addEventListener('cut', () => {}));
}
...
class Ce {
	...
	setHeight(e) {
		this.height != e && (Math.abs(this.height - e) > Fn && (di = !0), (this.height = e));
	}
	replace(e, t, i) {
		return Ce.of(i);
	}
	...
	applyChanges(e, t, i, s) {
		...
		for (let l = s.length - 1; l >= 0; l--) {
			let { fromA: a, toA: h, fromB: c, toB: f } = s[l],
				u = r.lineAt(a, ie.ByPosNoHeight, i.setDoc(t), 0, 0),
				d = u.to >= h ? u : r.lineAt(h, ie.ByPosNoHeight, i, 0, 0);
			for (f += d.to - h, h = d.to; l > 0 && u.from <= s[l - 1].toA; )
				((a = s[l - 1].fromA),
					(c = s[l - 1].fromB),
					l--,
					a < u.from && (u = r.lineAt(a, ie.ByPosNoHeight, i, 0, 0)));
			((c += u.from - a), (a = u.from));
			let p = wo.build(i.setDoc(o), e, c, f);
			r = es(r, r.replace(a, h, p));
		}
	...
	static of(e) {
		...
		return (
			...
			new bp(Ce.of(e.slice(0, t)), o, Ce.of(e.slice(i)))
		);
	}
}
function es(n, e) {
...
class rc extends Ce {
	...
	blockAt(e, t, i, s) {
		return this.spaceAbove && e < i + this.spaceAbove
			? new qe(s, 0, i, this.spaceAbove, yp)
			: this.mainBlock(i, s);
	}
	lineAt(e, t, i, s, r) {
	...
	forEachLine(e, t, i, s, r, o) {
		e <= r + this.length && t >= r && o(this.lineAt(0, ie.ByPos, i, s, r));
	}
	setMeasuredHeight(e) {
...
class Re extends rc {
	...
	replace(e, t, i) {
		let s = i[0];
		return i.length == 1 &&
			(s instanceof Re || (s instanceof de && s.flags & 4)) &&
			Math.abs(this.length - s.length) < 10
			? (s instanceof de
					? (s = new Re(s.length, this.height, this.spaceAbove))
...
class de extends Ce {
	...
	lineAt(e, t, i, s, r) {
		if (t == ie.ByHeight) return this.blockAt(e, i, s, r);
		if (t == ie.ByPosNoHeight) {
			let { from: d, to: p } = i.doc.lineAt(e);
			return new qe(d, p - d, 0, 0, 0);
		}
		...
		return new qe(h.from, h.length, Math.max(s, Math.min(u, s + this.height - c)), c, 0);
	}
	forEachLine(e, t, i, s, r, o) {
	...
	updateHeight(e, t = 0, i = !1, s) {
		...
		if (s && s.from <= t + this.length && s.more) {
			...
			return (
				(a < 0 ||
					Math.abs(h.height - this.height) >= Fn ||
					Math.abs(a - this.heightMetrics(e, t).perLine) >= Fn) &&
					(di = !0),
				es(this, h)
			);
		} else
...
class bp extends Ce {
	...
	forEachLine(e, t, i, s, r, o) {
		...
		if (this.break)
			...
			let h = this.lineAt(a, ie.ByPos, i, s, r);
	...
	replace(e, t, i) {
		...
		if ((e > 0 && Wl(r, o - 1), t < this.length)) {
			let l = r.length;
			(this.decomposeRight(t, r), Wl(r, l));
		}
		return Ce.of(r);
	}
	decomposeLeft(e, t) {
	...
	balanced(e, t) {
		return e.size > 2 * t.size || t.size > 2 * e.size
			? Ce.of(this.break ? [e, null, t] : [e, t])
			: ((this.left = es(this.left, e)),
				(this.right = es(this.right, t)),
...
class wo {
	...
	span(e, t) {
		if (this.lineStart > -1) {
			...
			(s instanceof Re
				? (s.length += i - this.pos)
				: (i > this.pos || !this.isCovered) && this.nodes.push(new Re(i - this.pos, -1, 0)),
				(this.writtenTo = i),
	...
	point(e, t, i) {
		if (e < t || i.heightRelevant) {
			...
			let o = t - e;
			i.block ? this.addBlock(new rc(o, s, i)) : (o || r || s >= xp) && this.addLineDeco(s, r, o);
	...
	enterLine() {
		...
		((this.lineStart = e),
			...
			this.pos > e && this.nodes.push(new Re(this.pos - e, -1, 0)),
...
class vp {
	...
	comparePoint(e, t, i, s) {
		(e < t || (i && i.heightRelevant) || (s && s.heightRelevant)) && si(e, t, this.changes, 5);
	}
}
function kp(n, e) {
...
class zs {
	...
	draw(e, t) {
		return P.replace({ widget: new Ap(this.displaySize * (t ? e.scaleY : e.scaleX), t) }).range(
			this.from,
			this.to
		);
	}
...
class Fl {
	constructor(e, t) {
		...
		let i = t.facet(go).some((s) => typeof s != 'function' && s.class == 'cm-lineWrapping');
		((this.heightOracle = new mp(i)),
			(this.stateDeco = zl(t)),
			(this.heightMap = Ce.empty().applyChanges(
				this.stateDeco,
				j.empty,
		...
		(this.updateViewportLines(),
			...
			(this.lineGapDeco = P.set(this.lineGaps.map((s) => s.draw(this, !1)))),
		...
		return (
			(this.scaler =
				this.heightMap.height <= 7e6
					? Hl
					: new vo(this.heightOracle, this.heightMap, this.viewports)),
	...
	update(e, t = null) {
		...
		this.stateDeco = zl(this.state);
		let s = e.changedRanges,
			r = Ve.extendWithRanges(
				s,
				wp(i, this.stateDeco, e ? e.changes : ce.empty(this.state.doc.length))
			),
	...
	measure() {
		...
		let h = 0,
			c = 0;
		if (l.width && l.height) {
			let { scaleX: A, scaleY: M } = wh(t, l);
			((A > 0.005 && Math.abs(this.scaleX - A) > 0.005) ||
				(M > 0.005 && Math.abs(this.scaleY - M) > 0.005)) &&
				((this.scaleX = A), (this.scaleY = M), (h |= 16), (o = a = !0));
		}
		...
		let d = vh(this.view.contentDOM, !1).y;
		d != this.scrollParent &&
			((this.scrollParent = d), (this.scrollAnchorHeight = -1), (this.scrollOffset = 0));
		let p = this.getScrollOffset();
		(this.scrollOffset != p && ((this.scrollAnchorHeight = -1), (this.scrollOffset = p)),
			(this.scrolledToBottom = Sh(this.scrollParent || e.win)));
		let m = (this.printing ? Cp : kp)(t, this.paddingTop),
			g = m.top - this.pixelViewport.top,
			y = m.bottom - this.pixelViewport.bottom;
		...
		if (
			...
			!this.inView && !this.scrollTarget && !Sp(e.dom))
		)
			return 0;
		let C = l.width;
		if (
			((this.contentDOMWidth != C || this.editorHeight != e.scrollDOM.clientHeight) &&
			...
			if (
				(s.mustRefreshForHeights(A) && (o = !0),
				o || (s.lineWrapping && Math.abs(C - this.contentDOMWidth) > s.charWidth))
			) {
				let { lineHeight: M, charWidth: T, textHeight: B } = e.docView.measureTextSize();
				((o = M > 0 && s.refresh(r, M, T, B, Math.max(5, C / T), A)),
			...
			for (let M of this.viewports) {
				...
				this.heightMap = (
					o
						? Ce.empty().applyChanges(this.stateDeco, j.empty, this.heightOracle, [
								new Ve(0, 0, 0, e.state.doc.length)
							])
						: this.heightMap
				).updateHeight(s, 0, o, new gp(M.from, T));
			}
			di && (h |= 2);
		}
		let L =
		...
		return (
			...
			(h & 2 || L) && this.updateViewportLines(),
			(this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) &&
	...
	getViewport(e, t) {
		let i = 0.5 - Math.max(-0.5, Math.min(0.5, e / 1e3 / 2)),
			...
			a = new vn(
				s.lineAt(o - i * 1e3, ie.ByHeight, r, 0, 0).from,
				s.lineAt(l + (1 - i) * 1e3, ie.ByHeight, r, 0, 0).to
			);
		if (t) {
			let { head: h } = t.range;
			if (h < a.from || h > a.to) {
				let c = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top),
					f = s.lineAt(h, ie.ByPos, r, 0, 0),
					u;
				(t.y == 'center'
					...
					: t.y == 'start' || (t.y == 'nearest' && h < a.from)
						...
						: (u = f.bottom - c),
					(a = new vn(
						s.lineAt(u - 1e3 / 2, ie.ByHeight, r, 0, 0).from,
						s.lineAt(u + c + 1e3 / 2, ie.ByHeight, r, 0, 0).to
					)));
			}
		}
		return a;
	...
	mapViewport(e, t) {
		let i = t.mapPos(e.from, -1),
			s = t.mapPos(e.to, 1);
		return new vn(
			this.heightMap.lineAt(i, ie.ByPos, this.heightOracle, 0, 0).from,
			this.heightMap.lineAt(s, ie.ByPos, this.heightOracle, 0, 0).to
		);
	}
	viewportIsAppropriate({ from: e, to: t }, i = 0) {
		if (!this.inView) return !0;
		let { top: s } = this.heightMap.lineAt(e, ie.ByPos, this.heightOracle, 0, 0),
			{ bottom: r } = this.heightMap.lineAt(t, ie.ByPos, this.heightOracle, 0, 0),
			{ visibleTop: o, visibleBottom: l } = this;
		return (
	...
	mapLineGaps(e, t) {
		...
		for (let s of e)
			t.touchesRange(s.from, s.to) ||
				i.push(new zs(t.mapPos(s.from), t.mapPos(s.to), s.size, s.displaySize));
		return i;
	}
	ensureLineGaps(e, t) {
		...
		let l = [],
			a = (c, f, u, d) => {
				...
				let g = Tp(
					...
					(y) =>
						...
						Math.abs(y.from - c) < r &&
						Math.abs(y.to - f) < r &&
						!m.some((S) => y.from < S && y.to > S)
				);
				if (!g) {
					if (f < u.to && t && i && t.visibleRanges.some((C) => C.from <= f && C.to >= f)) {
						let C = t.moveToLineBoundary(v.cursor(f), !1, !0).head;
						C > c && (f = C);
					}
			...
			h = (c) => {
				...
				let f = Mp(c.from, c.to, this.stateDeco);
				if (f.total < o) return;
				...
				if (i) {
					...
					if (u != null) {
						let S = Sn(f, u),
							C = ((this.visibleBottom - this.visibleTop) / 2 + m) / c.height;
						((g = S - C), (y = S + C));
					} else
					...
					if (m > 2e6)
						for (let M of e)
							M.from >= c.from &&
								M.from < c.to &&
								M.size != M.displaySize &&
								M.from * this.heightOracle.charWidth + y < this.pixelViewport.left &&
								(y = M.size - M.displaySize);
					let S = this.pixelViewport.left + y,
						C = this.pixelViewport.right + y,
						L,
						A;
					if (u != null) {
						let M = Sn(f, u),
	...
	updateLineGaps(e) {
		zs.same(e, this.lineGaps) ||
			((this.lineGaps = e),
			(this.lineGapDeco = P.set(e.map((t) => t.draw(this, this.heightOracle.lineWrapping)))));
	}
	...
	lineBlockAt(e) {
		return (
			...
			Di(this.heightMap.lineAt(e, ie.ByPos, this.heightOracle, 0, 0), this.scaler)
		);
	}
	lineBlockAtHeight(e) {
		return (
			...
			Di(
				this.heightMap.lineAt(this.scaler.fromDOM(e), ie.ByHeight, this.heightOracle, 0, 0),
				this.scaler
			)
		);
	}
...
function zl(n) {
	let e = n.facet(gs).filter((i) => typeof i != 'function'),
		t = n.facet(yo).filter((i) => typeof i != 'function');
...
class vo {
	constructor(e, t, i) {
		...
		((this.viewports = i.map(({ from: l, to: a }) => {
			let h = t.lineAt(l, ie.ByPos, e, 0, 0).top,
				c = t.lineAt(a, ie.ByPos, e, 0, 0).bottom;
...
function Di(n, e) {
	...
	return new qe(
		...
		t,
		i - t,
		Array.isArray(n._content) ? n._content.map((s) => Di(s, e)) : n._content
	);
}
const Cn = _.define({ combine: (n) => n.join(' ') }),
	Nr = _.define({ combine: (n) => n.indexOf(!0) > -1 }),
	Vr = Mt.newName(),
	oc = Mt.newName(),
	lc = Mt.newName(),
	ac = { '&light': '.' + oc, '&dark': '.' + lc };
...
const Dp = Wr(
	...
	Ep = { childList: !0, characterData: !0, subtree: !0, attributes: !0, characterDataOldValue: !0 },
	qs = E.ie && E.ie_version <= 11;
class Op {
	constructor(e) {
		((this.view = e),
			(this.active = !1),
			(this.editContext = null),
			(this.selectionRange = new od()),
			...
			(this.observer = new MutationObserver((t) => {
				...
				((E.ie && E.ie_version <= 11) || (E.ios && e.composing)) &&
				t.some(
					(i) =>
			...
			window.EditContext &&
				...
				!(E.chrome && E.chrome_version < 126) &&
				((this.editContext = new Lp(e)),
				e.state.facet(ct) && (e.contentDOM.editContext = this.editContext.editContext)),
			qs &&
				(this.onCharData = (t) => {
	...
	onSelectionChange(e) {
		...
		if (i.state.facet(ct) ? i.root.activeElement != this.dom : !Li(this.dom, s)) return;
		let r = s.anchorNode && i.docView.tile.nearest(s.anchorNode);
		if (r && r.isWidget() && r.widget.ignoreEvent(e)) {
			t || (this.selectionChanged = !1);
			return;
		}
		((E.ie && E.ie_version <= 11) || (E.android && E.chrome)) &&
		!i.state.selection.main.empty &&
		s.focusNode &&
		Ri(s.focusNode, s.focusOffset, s.anchorNode, s.anchorOffset)
			? this.flushSoon()
			: this.flush(!1);
	}
	readSelectionRange() {
		...
		if (!t) return !1;
		let i =
			(E.safari && e.root.nodeType == 11 && e.root.activeElement == this.dom && _p(this.view, t)) ||
			t;
	...
	start() {
		this.active ||
			(this.observer.observe(this.dom, Ep),
			qs && this.dom.addEventListener('DOMCharacterDataModified', this.onCharData),
			(this.active = !0));
	}
	stop() {
		this.active &&
			...
			qs && this.dom.removeEventListener('DOMCharacterDataModified', this.onCharData));
	}
	clear() {
		...
		if (!this.delayedAndroidKey) {
			let s = () => {
				...
				r &&
					...
					!this.flush() && r.force && ri(this.dom, r.key, r.keyCode));
			};
	...
	readChange() {
		let { from: e, to: t, typeOver: i } = this.processRecords(),
			s = this.selectionChanged && Li(this.dom, this.selectionRange);
	...
	flush(e = !0) {
		...
		return (
			this.view.state == i &&
				(t.domChanged || (t.newSel && !Zn(this.view.state.selection, t.newSel.main))) &&
				this.view.update([]),
			s
		);
	}
	readMutation(e) {
		...
		if ((t.markDirty(e.type == 'attributes'), e.type == 'childList')) {
			let i = ql(t, e.previousSibling || e.target.previousSibling, -1),
				s = ql(t, e.nextSibling || e.target.nextSibling, 1);
			return {
	...
	update(e) {
		this.editContext &&
			...
			e.startState.facet(ct) != e.state.facet(ct) &&
				(e.view.contentDOM.editContext = e.state.facet(ct) ? this.editContext.editContext : null));
	}
	destroy() {
		var e, t, i;
		(this.stop(),
...
function jl(n, e) {
	...
	return (
		Ri(o.node, o.offset, s, r) && ([t, i, s, r] = [s, r, t, i]),
...
class Lp {
	constructor(e) {
		...
		((this.handlers.textupdate = (i) => {
			...
			let c = Yh(e.state.sliceDoc(l, a), i.text, (h ? s.from : s.to) - l, h ? 'end' : null);
			if (!c) {
				let u = v.single(this.toEditorPos(i.selectionStart), this.toEditorPos(i.selectionEnd));
				Zn(u, s) || e.dispatch({ selection: u, userEvent: 'select' });
				return;
			}
			let f = {
				from: c.from + l,
...
`)
			...
			if (
				((E.mac || E.android) &&
					...
					(f = { from: l, to: a, insert: j.of([i.text.replace('.', ' ')]) }),
				...
				xo(
					e,
					f,
					v.single(this.toEditorPos(i.selectionStart, u), this.toEditorPos(i.selectionEnd, u))
				);
			}
			...
			(this.handlers.textformatupdate = (i) => {
				...
				e.dispatch({ effects: Fh.of(P.set(s)) });
			}),
...
class O {
	...
	constructor(e = {}) {
		...
		((this.dispatchTransactions =
			...
			(this._root = e.root || ld(e.parent) || document),
			(this.viewState = new Fl(this, e.state || $.create(e))),
			e.scrollTo &&
				e.scrollTo.is(bn) &&
				(this.viewState.scrollTarget = e.scrollTo.value.clip(this.viewState.state)),
			(this.plugins = this.state.facet(Zt).map((s) => new Ns(s))));
		for (let s of this.plugins) s.update(this);
		((this.observer = new Op(this)),
			(this.inputState = new Zd(this)),
			this.inputState.ensureHandlers(this.plugins),
			(this.docView = new Tl(this)),
			this.mountStyles(),
			this.updateAttrs(),
			(this.updateState = 0),
			this.requestMeasure(),
	...
	update(e) {
		...
		if (
			(h
				...
				: this.observer.clear(),
			r.facet($.phrases) != this.state.facet($.phrases))
		)
			return this.setState(r);
		((s = Yn.create(this, r, e)), (s.flags |= l));
		...
		try {
			...
			for (let u of e) {
				if ((f && (f = f.map(u.changes)), u.scrollIntoView)) {
					...
					f = new oi(d.empty ? d : v.cursor(d.head, d.head > d.anchor ? -1 : 1));
				}
				for (let d of u.effects) d.is(bn) && (f = d.value.clip(this.state));
			}
			(this.viewState.update(s, f),
				(this.bidiCache = ts.update(this.bidiCache, s.changes)),
				s.empty || (this.updatePlugins(s), this.inputState.update(s)),
				(t = this.docView.update(s)),
				this.state.facet(Ti) != this.styleModules && this.mountStyles(),
				(i = this.updateAttrs()),
		...
		if (
			(s.startState.facet(Cn) != s.state.facet(Cn) && (this.viewState.mustMeasureContent = !0),
			(t || i || f || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) &&
				this.requestMeasure(),
			t && this.docViewUpdate(),
			!s.empty)
		)
			for (let u of this.state.facet(Lr))
				try {
					u(s);
				} catch (d) {
					Ee(this.state, d, 'update listener');
				}
		(a || c) &&
			Promise.resolve().then(() => {
				(a && this.state == a.startState && this.dispatch(a),
					c && !Jh(this, c) && h.force && ri(this.contentDOM, h.key, h.keyCode));
			});
	}
	setState(e) {
		if (this.updateState != 0)
		...
		try {
			...
			((this.viewState = new Fl(this, e)),
				(this.plugins = e.facet(Zt).map((i) => new Ns(i))),
		...
		for (let e of this.plugins) {
			...
			if (t && t.docViewUpdate)
				try {
					...
					Ee(this.state, i, 'doc view update listener');
				}
		}
	}
	measure(e = !0) {
		...
		try {
			for (let l = 0; ; l++) {
				if (o < 0)
					if (Sh(i || this.win)) ((r = -1), (o = this.viewState.heightMap.height));
					else {
				...
				let c = h.map((d) => {
						try {
							...
							return (Ee(this.state, p), $l);
						}
					}),
					f = Yn.create(this, this.state, []),
					u = !1;
				((f.flags |= a),
					t ? (t.flags |= a) : (t = f),
					(this.updateState = 2),
		...
		if (t && !t.empty) for (let l of this.state.facet(Lr)) l(t);
	}
	get themeClasses() {
		return Vr + ' ' + (this.state.facet(Nr) ? lc : oc) + ' ' + this.state.facet(Cn);
	}
	updateAttrs() {
		let e = Kl(this, Hh, {
			...
			t = {
				...
				translate: 'no',
				contenteditable: this.state.facet(ct) ? 'true' : 'false',
				class: 'cm-content',
				style: `${E.tabSize}: ${this.state.tabSize}`,
				role: 'textbox',
				'aria-multiline': 'true'
			};
		(this.state.readOnly && (t['aria-readonly'] = 'true'), Kl(this, go, t));
	...
	mountStyles() {
		...
		Mt.mount(this.root, this.styleModules.concat(Dp).reverse(), e ? { nonce: e } : void 0);
	}
	readMeasured() {
	...
	moveByChar(e, t, i) {
		return Hs(this, e, Dl(this, e, t, i));
	}
	moveByGroup(e, t) {
		return Hs(
			this,
			e,
			Dl(this, e, t, (i) => qd(this, e.head, i))
		);
	}
	visualLineSide(e, t) {
	...
	moveToLineBoundary(e, t, i = !0) {
		return zd(this, e, t, i);
	}
	moveVertically(e, t, i) {
		return Hs(this, e, jd(this, e, t, i));
	}
	domAtPos(e, t = 1) {
	...
	coordsAtPos(e, t = 1) {
		...
		let s = this.state.doc.lineAt(e),
			r = this.bidiSpans(s),
			o = r[nt.find(r, e - s.from, -1, t)];
		return ji(i, (o.dir == te.LTR) == t > 0);
	}
	coordsForChar(e) {
	...
	textDirectionAt(e) {
		return !this.state.facet(Nh) || e < this.viewport.from || e > this.viewport.to
			? this.textDirection
	...
	bidiSpans(e) {
		if (e.length > Pp) return Eh(e.length);
		let t = this.textDirectionAt(e.from),
			i;
		for (let r of this.bidiCache)
			if (r.from == e.from && r.dir == t && (r.fresh || Dh(r.isolates, (i = Cl(this, e)))))
				return r.order;
		i || (i = Cl(this, e));
		let s = md(e.text, t, i);
		return (this.bidiCache.push(new ts(e.from, e.to, t, i, !0, s)), s);
	}
	get hasFocus() {
		var e;
		return (
	...
	static scrollIntoView(e, t = {}) {
		return bn.of(new oi(typeof e == 'number' ? v.cursor(e) : e, t.y, t.x, t.yMargin, t.xMargin));
	}
	scrollSnapshot() {
		let { scrollTop: e, scrollLeft: t } = this.scrollDOM,
			i = this.viewState.scrollAnchorAt(e);
		return bn.of(new oi(v.cursor(i.from), 'start', 'start', i.top - e, t, !0));
	}
	setTabFocusMode(e) {
		e == null
	...
	static theme(e, t) {
		let i = Mt.newName(),
			s = [Cn.of(i), Ti.of(Wr(`.${i}`, e))];
		return (t && t.dark && s.push(Nr.of(!0)), s);
	}
	static baseTheme(e) {
		return _t.lowest(Ti.of(Wr('.' + Vr, e, ac)));
	}
	static findFromDOM(e) {
		var t;
		let i = e.querySelector('.cm-content'),
			s = (i && re.get(i)) || re.get(e);
		return ((t = s == null ? void 0 : s.root) === null || t === void 0 ? void 0 : t.view) || null;
	}
}
O.styleModule = Ti;
O.inputHandler = Ih;
O.clipboardInputFilter = po;
O.clipboardOutputFilter = mo;
O.scrollHandler = Wh;
O.focusChangeEffect = Bh;
O.perLineTextDirection = Nh;
O.exceptionSink = Rh;
O.updateListener = Lr;
O.editable = ct;
O.mouseSelectionStyle = Ph;
O.dragMovesSelection = Lh;
O.clickAddsSelectionRange = _h;
O.decorations = gs;
O.blockWrappers = zh;
O.outerDecorations = yo;
O.atomicRanges = rn;
O.bidiIsolatedRanges = qh;
O.scrollMargins = jh;
O.darkTheme = Nr;
O.cspNonce = _.define({ combine: (n) => (n.length ? n[0] : '') });
O.contentAttributes = go;
...
class ts {
	...
	static update(e, t) {
		...
		let i = [],
			s = e.length ? e[e.length - 1].dir : te.LTR;
		for (let r = Math.max(0, e.length - 10); r < e.length; r++) {
			let o = e[r];
			o.dir == s &&
				!t.touchesRange(o.from, o.to) &&
				i.push(new ts(t.mapPos(o.from, 1), t.mapPos(o.to, -1), o.dir, o.isolates, !1, o.order));
		}
		return i;
	}
}
...
const Rp = E.mac ? 'mac' : E.windows ? 'win' : E.linux ? 'linux' : 'key';
function Ip(n, e) {
	const t = n.split(/-(?!$)/);
	let i = t[t.length - 1];
	i == 'Space' && (i = ' ');
...
const Bp = _t.default(
		O.domEventHandlers({
			keydown(n, e) {
				return cc(hc(e.state), n, e, 'editor');
			}
		})
	),
	on = _.define({ enables: Bp }),
	Ul = new WeakMap();
function hc(n) {
	let e = n.facet(on),
		t = Ul.get(e);
	return (t || Ul.set(e, (t = Wp(e.reduce((i, s) => i.concat(s), [])))), t);
}
function Np(n, e, t) {
	return cc(hc(n.state), e, n, t);
}
let vt = null;
const Vp = 4e3;
function Wp(n, e = Rp) {
				...
				(s(S, !0),
					d[S] ||
						(d[S] = {
							...
							run: [
								(C) => {
									let L = (vt = { view: C, prefix: S, scope: o });
									return (
										setTimeout(() => {
											vt == L && (vt = null);
										}, Vp),
	...
	for (let o of n) {
		...
		if (o.any)
			for (let h of l) {
				...
				let { any: f } = o;
				for (let u in c) c[u].run.push((d) => f(d, Fr));
			}
		let a = o[e] || o.key;
		if (a)
			for (let h of l)
...
function cc(n, e, t, i) {
	...
	vt &&
		vt.view == t &&
		vt.scope == i &&
		((l = vt.prefix + ' '), Qh.indexOf(e.keyCode) < 0 && ((h = !0), (vt = null)));
	let f = new Set(),
		u = (g) => {
			if (g) {
				for (let y of g.run)
		...
		d &&
			(u(d[l + An(s, e, !o)])
				...
				: o &&
					  ...
					  !(E.windows && e.ctrlKey && e.altKey) &&
					  !(E.mac && e.altKey && !(e.ctrlKey || e.metaKey)) &&
					  (p = Tt[e.keyCode]) &&
					  p != s
					? (u(d[l + An(p, e, !0)]) ||
							(e.shiftKey && (m = Hi[e.keyCode]) != s && m != p && u(d[l + An(m, e, !1)]))) &&
						(a = !0)
					: o && e.shiftKey && u(d[l + An(s, e, !0)]) && (a = !0),
			!a && u(d._any) && (a = !0)),
		h && (a = !0),
...
class zt {
	...
	static forRange(e, t, i) {
		if (i.empty) {
			...
			if (!s) return [];
			let r = fc(e);
			return [new zt(t, s.left - r.left, s.top - r.top, null, s.bottom - s.top)];
		} else return Fp(e, t, i);
	}
}
function fc(n) {
	...
	return {
		left:
			(n.textDirection == te.LTR ? e.left : e.right - n.scrollDOM.clientWidth * n.scaleX) -
...
function Fp(n, e, t) {
	...
	let i = Math.max(t.from, n.viewport.from),
		...
		g = p.type == ge.Text ? p : null;
	if (
		(m && (n.lineWrapping || d.widgetLineBreaks) && (m = Gl(n, i, 1, m)),
		g && (n.lineWrapping || p.widgetLineBreaks) && (g = Gl(n, s, -1, g)),
		m && g && m.from == g.from && m.to == g.to)
	)
		return S(C(t.from, t.to, m));
	{
		let A = m ? C(t.from, null, m) : L(d, !1),
			M = g ? C(null, t.to, g) : L(p, !0),
			T = [];
		return (
			(m || d).to < (g || p).from - (m && g ? 1 : 0) ||
			(d.widgetLineBreaks > 1 && A.bottom + n.defaultLineHeight / 2 < M.top)
				? T.push(y(f, A.bottom, u, M.top))
				: A.bottom < M.top &&
					n.elementAtHeight((A.bottom + M.top) / 2).type == ge.Text &&
					(A.bottom = M.top = (A.bottom + M.top) / 2),
			S(A).concat(T).concat(S(M))
		);
	}
	function y(A, M, T, B) {
		return new zt(e, A - a.left, M - a.top, Math.max(0, T - A), B - M);
	}
	function S({ top: A, bottom: M, horizontal: T }) {
		let B = [];
		for (let H = 0; H < T.length; H += 2) B.push(y(T[H], A, T[H + 1], M));
		return B;
	}
	function C(A, M, T) {
		let B = 1e9,
			H = -1e9,
			K = [];
		function W(q, Y, N, G, V) {
			let J = n.coordsAtPos(q, q == T.to ? -2 : 2),
				ne = n.coordsAtPos(N, N == T.from ? 2 : -2);
			!J ||
				!ne ||
				((B = Math.min(J.top, ne.top, B)),
				(H = Math.max(J.bottom, ne.bottom, H)),
				V == te.LTR
					? K.push(r && Y ? f : J.left, r && G ? u : ne.right)
					: K.push(!r && G ? f : ne.left, !r && Y ? u : J.right));
		}
		let R = A ?? T.from,
			U = M ?? T.to;
		for (let q of n.visibleRanges)
			if (q.to > R && q.from < U)
				for (let Y = Math.max(q.from, R), N = Math.min(q.to, U); ; ) {
					let G = n.state.doc.lineAt(Y);
					for (let V of n.bidiSpans(G)) {
						let J = V.from + G.from,
							ne = V.to + G.from;
						if (J >= N) break;
						ne > Y &&
							W(Math.max(J, Y), A == null && J <= R, Math.min(ne, N), M == null && ne >= U, V.dir);
					}
					if (((Y = G.to + 1), Y >= N)) break;
				}
		return (
			K.length == 0 && W(R, A == null, U, M == null, n.textDirection),
			{ top: B, bottom: H, horizontal: K }
		);
	}
	function L(A, M) {
		let T = l.top + (M ? A.top : A.bottom);
...
class zp {
	...
	update(e) {
		(e.startState.facet(Hn) != e.state.facet(Hn) && this.setOrder(e.state),
...
const Hn = _.define();
function uc(n) {
	return [oe.define((e) => new zp(e, n)), Hn.of(n)];
}
const pi = _.define({
	combine(n) {
		return lt(
...
function qp(n = {}) {
	return [pi.of(n), jp, $p, Kp, Vh.of(!0)];
}
function dc(n) {
	return n.startState.facet(pi) != n.state.facet(pi);
}
const jp = uc({
	above: !0,
	markers(n) {
		...
		for (let s of e.selection.ranges) {
			...
			if (s.empty || (t.drawRangeCursor && !(r && E.ios && t.iosSelectionHandles))) {
				let o = r ? 'cm-cursor cm-cursor-primary' : 'cm-cursor cm-cursor-secondary',
					l = s.empty ? s : v.cursor(s.head, s.assoc);
				for (let a of zt.forRange(n, o, l)) i.push(a);
			}
		}
		return i;
	},
...
function Jl(n, e) {
	e.style.animationDuration = n.facet(pi).cursorBlinkRate + 'ms';
}
const $p = uc({
		above: !1,
		markers(n) {
			...
			for (let s of i)
				if (!s.empty) for (let r of zt.forRange(n, 'cm-selectionBackground', s)) e.push(r);
			if (E.ios && !t.empty && n.state.facet(pi).iosSelectionHandles) {
				for (let s of zt.forRange(
					n,
		...
		update(n, e) {
			return n.docChanged || n.selectionSet || n.viewportChanged || dc(n);
		},
	...
	Ei = be.define({
		...
		update(n, e) {
			return (
				...
				e.effects.reduce((t, i) => (i.is(pc) ? i.value : t), n)
			);
		}
	}),
	Up = oe.fromClass(
		class {
			...
			update(n) {
				...
				t == null
					...
					: (this.cursor ||
						...
						(n.startState.field(Ei) != t || n.docChanged || n.geometryChanged) &&
			...
			setDropPos(n) {
				this.view.state.field(Ei) != n && this.view.dispatch({ effects: pc.of(n) });
			}
		},
		{
			eventObservers: {
...
class Yp {
	...
	createDeco(e) {
		let t = new dt(),
			i = t.add.bind(t);
		for (let { from: s, to: r } of Jp(e, this.maxLength))
	...
	updateRange(e, t, i, s) {
		for (let r of e.visibleRanges) {
			...
			if (l >= o) {
				...
				else Yl(e.state.doc, this.regexp, c, f, (m, g) => this.addMatch(g, e, m, p));
...
function Zp() {
	...
	if (js == null && typeof document < 'u' && document.body) {
		...
		js = ((n = e.tabSize) !== null && n !== void 0 ? n : e.MozTabSize) != null;
	}
	return js || !1;
}
const zn = _.define({
	combine(n) {
		let e = lt(n, { render: null, specialChars: Xp, addSpecialChars: null });
		return (
			(e.replaceTabs = !Zp()) && (e.specialChars = new RegExp('	|' + e.specialChars.source, Hr)),
			e.addSpecialChars &&
				(e.specialChars = new RegExp(e.specialChars.source + '|' + e.addSpecialChars.source, Hr)),
			e
		);
	}
});
	...
	return (
		...
		(Xl = oe.fromClass(
			class {
				constructor(n) {
					((this.view = n),
						(this.decorations = P.none),
						(this.decorationCache = Object.create(null)),
						(this.decorator = this.makeDecorator(n.state.facet(zn))),
					...
					return new Yp({
						...
						decoration: (e, t, i) => {
							...
							return (
								...
								(this.decorationCache[r] = P.replace({ widget: new sm(n, r) }))
							);
						},
				...
				update(n) {
					let e = n.state.facet(zn);
					n.startState.facet(zn) != e
	...
	toDOM(e) {
		let t = nm(this.code),
			i =
				...
				' ' +
				(Qp[this.code] || '0x' + this.code.toString(16)),
...
const lm = P.line({ class: 'cm-activeLine' }),
	am = oe.fromClass(
		class {
			constructor(n) {
...
class hm extends Ke {
	...
	coordsAt(e) {
		let t = e.firstChild ? Pi(e.firstChild) : [];
		if (!t.length) return null;
		let i = window.getComputedStyle(e.parentNode),
			s = ji(t[0], i.direction != 'rtl'),
	...
	let e = oe.fromClass(
		class {
			constructor(t) {
				((this.view = t),
					(this.placeholder = n
						? P.set([P.widget({ widget: new hm(n), side: 1 }).range(0)])
						: P.none));
			}
			get decorations() {
...
function fm(n, e, t) {
	let i = Math.min(e.line, t.line),
		...
		r = [];
	if (e.off > zr || t.off > zr || e.col < 0 || t.col < 0) {
...
function Ql(n, e) {
	let t = n.posAtCoords({ x: e.clientX, y: e.clientY }, !1),
		...
		s = t - i.from,
		r = s > zr ? -1 : s == i.length ? um(n, e.clientX) : bi(i.text, n.state.tabSize, t - i.from);
...
function pm(n) {
	...
	return O.mouseSelectionStyle.of((t, i) => (e(i) ? dm(t, i) : null));
}
const mm = {
		Alt: [18, (n) => !!n.altKey],
...
function ym(n = {}) {
	...
	return [
		...
		O.contentAttributes.of((s) => {
			var r;
			return !((r = s.plugin(i)) === null || r === void 0) && r.isDown ? gm : null;
		})
	];
}
const Mn = '-10000px';
		...
		class {
			...
			writeMeasure(n) {
				...
				for (let l = 0; l < this.manager.tooltips.length; l++) {
					...
					let d = a.arrow ? h.dom.querySelector('.cm-tooltip-arrow') : null,
						p = d ? 7 : 0,
						m = u.right - u.left,
						g = (e = Zl.get(h)) !== null && e !== void 0 ? e : u.bottom - u.top,
						y = h.offset || wm,
						S = this.view.textDirection == te.LTR,
						C =
						...
						L = this.above[l];
					!a.strictSide &&
						(L ? f.top - g - p - y.y < i.top : f.bottom + g + p + y.y > i.bottom) &&
						L == i.bottom - f.bottom > f.top - i.top &&
						(L = this.above[l] = !L);
					let A = (L ? f.top - i.top : i.bottom - f.bottom) - p;
					if (A < g && h.resize !== !1) {
						if (A < this.view.defaultLineHeight) {
							c.style.top = Mn;
							continue;
						}
						(Zl.set(h, g), (c.style.height = (g = A) / r + 'px'));
					} else c.style.height && (c.style.height = '');
					let M = L ? f.top - g - p - y.y : f.bottom + p + y.y,
						T = C + m;
					if (h.overlap !== !0)
						for (let B of o)
							B.left < T &&
								...
								B.top < M + g &&
								B.bottom > M &&
								(M = L ? B.top - g - 2 - p : B.bottom + p + 2);
					if (
						(this.position == 'absolute'
							? ((c.style.top = (M - n.parent.top) / r + 'px'), ea(c, (C - n.parent.left) / s))
							: ((c.style.top = M / r + 'px'), ea(c, C / s)),
						d)
					) {
						let B = f.left + (S ? y.x : -y.x) - (C + 14 - 7);
						d.style.left = B / s + 'px';
					}
					(h.overlap !== !0 && o.push({ left: C, top: M, right: T, bottom: M + g }),
						c.classList.toggle('cm-tooltip-above', L),
						c.classList.toggle('cm-tooltip-below', !L),
			...
			maybeMeasure() {
				if (
					...
					for (let n of this.manager.tooltipViews) n.dom.style.top = Mn;
			}
		},
		{
			eventObservers: {
...
const xm = O.baseTheme({
	...
	wm = { x: 0, y: 0 },
	So = _.define({ enables: [ko, xm] }),
	is = _.define({ combine: (n) => n.reduce((e, t) => e.concat(t), []) });
class ws {
	static create(e) {
		return new ws(e);
	}
...
class km {
	...
	get tooltip() {
		let e = this.view.plugin(ko),
			t = e ? e.manager.tooltips.findIndex((i) => i.create == ws.create) : -1;
	...
	mousemove(e) {
		...
		if ((s.length && r && !Sm(r.dom, e)) || this.pending) {
			...
			(o == l
				...
				: !Cm(this.view, o, l, e.clientX, e.clientY)) &&
...
function Sm(n, e) {
	...
	return e.clientX >= t - Tn && e.clientX <= i + Tn && e.clientY >= s - Tn && e.clientY <= r + Tn;
}
...
function Am(n, e = {}) {
	let t = I.define(),
		i = be.define({
			...
			update(s, r) {
				...
				for (let o of r.effects) (o.is(t) && (s = o.value), o.is(Mm) && (s = []));
				return s;
			},
			provide: (s) => is.from(s)
		});
	return {
		active: i,
		extension: [i, oe.define((s) => new km(s, n, i, t, e.hoverTime || 300)), vm]
	};
}
function gc(n, e) {
	let t = n.plugin(ko);
	...
	class {
		...
		update(n) {
			...
			(this.top.container != e.topContainer &&
				(this.top.sync([]), (this.top = new Dn(n.view, !0, e.topContainer))),
...
const Ki = _.define({ enables: yc });
function Tm(n, e) {
	let t,
		i = new Promise((o) => (t = o)),
		s = (o) => Dm(o, e, t);
	n.state.field(Ks, !1)
		? n.dispatch({ effects: bc.of(s) })
		: n.dispatch({ effects: I.appendConfig.of(Ks.init(() => [s])) });
	let r = xc.of(s);
	return {
		close: r,
		result: i.then(
			(o) => (
				(n.win.queueMicrotask || ((a) => n.win.setTimeout(a, 10)))(() => {
					n.state.field(Ks).indexOf(s) > -1 && n.dispatch({ effects: r });
				}),
				o
			)
		)
...
const Ks = be.define({
		...
		update(n, e) {
			for (let t of e.effects)
				t.is(bc) ? (n = [t.value].concat(n)) : t.is(xc) && (n = n.filter((i) => i != t.value));
			return n;
		},
...
mt.prototype.mapMode = me.TrackBefore;
...
const qn = _.define(),
	...
	Bi = _.define();
function _m(n) {
	return [wc(), Bi.of({ ...Om, ...n })];
}
const na = _.define({ combine: (n) => n.some((e) => e) });
function wc(n) {
	return [Lm];
}
const Lm = oe.fromClass(
	class {
		constructor(n) {
			((this.view = n),
				(this.domAfter = null),
				...
				(this.gutters = n.state.facet(Bi).map((e) => new ra(n, e))),
				(this.fixed = !n.state.facet(na)));
		...
		update(n) {
			...
			(this.view.state.facet(na) != !this.fixed &&
		...
		syncGutters(n) {
			...
			let t = z.iter(this.view.state.facet(qn), this.view.viewport.from),
				i = [],
				s = this.gutters.map((r) => new Pm(r, this.view.viewport, -this.view.documentPadding.top));
...
class ra {
	constructor(e, t) {
		...
		((this.markers = sa(t.markers(e))),
			t.initialSpacer &&
				((this.spacer = new vc(e, 0, 0, [t.initialSpacer(e)])),
	...
	update(e) {
		let t = this.markers;
		if (
			((this.markers = sa(this.config.markers(e.view))), this.spacer && this.config.updateSpacer)
		) {
...
class vc {
	...
	update(e, t, i, s) {
		(this.height != t && ((this.height = t), (this.dom.style.height = t + 'px')),
			...
			Rm(this.markers, s) || this.setMarkers(e, s));
	}
	setMarkers(e, t) {
...
const Nm = Bi.compute([ei], (n) => ({
	...
	lineMarker(e, t, i) {
		return i.some((s) => s.toDOM) ? null : new Us(Gs(e, e.state.doc.lineAt(t.from).number));
	},
	widgetMarker: (e, t, i) => {
		for (let s of e.state.facet(Bm)) {
			let r = s(e, t, i);
			if (r) return r;
		}
		return null;
	...
	initialSpacer(e) {
		return new Us(Gs(e, oa(e.state.doc.lines)));
	},
	updateSpacer(e, t) {
		let i = Gs(t.view, oa(t.view.state.doc.lines));
...
const Wm = new (class extends mt {
		constructor() {
			(super(...arguments), (this.elementClass = 'cm-activeLineGutter'));
		}
	})(),
	Fm = qn.compute(['selection'], (n) => {
		let e = [],
			t = -1;
		for (let i of n.selection.ranges) {
			let s = n.doc.lineAt(i.head).from;
			s > t && ((t = s), e.push(Wm.range(s)));
		}
		return z.of(e);
	});
function Hm() {
...
class Be {
	...
	static define(e, t) {
		...
		if ((e instanceof Be && (t = e), t != null && t.base))
...
class ns {
	constructor(e) {
		((this.name = e), (this.instances = []), (this.id = qm++));
	}
	static get(e, t) {
		if (!t.length) return e;
		let i = t[0].instances.find((l) => l.base == e && jm(t, l.modified));
		if (i) return i;
		let s = [],
			r = new Be(e.name, s, e, t);
		for (let l of t) l.instances.push(r);
		let o = $m(t);
		for (let l of e.set) if (!l.modified.length) for (let a of o) s.push(ns.get(l, a));
		return r;
	}
}
function jm(n, e) {
...
function Gm(n, e, t, i = 0, s = n.length) {
	let r = new Jm(i, Array.isArray(e) ? e : [e], t);
			...
			for (let g = 0, y = l; ; g++) {
				...
				if (L < A && m)
					for (
						;
						e.from < A &&
						(this.highlightRange(e, L, A, s, r),
						this.startSpan(Math.min(A, e.to), h),
						!(e.to >= C || !e.nextSibling()));
					);
				if (!S || C > i) break;
				((y = S.to + l),
					y > t &&
						(this.highlightRange(d.cursor(), Math.max(t, S.from + l), Math.min(i, y), '', p),
...
const D = Be.define,
	...
	w = {
		...
		unit: D(Ye),
		modifier: D(Ye),
		operatorKeyword: D(Ye),
		controlKeyword: D(Ye),
		definitionKeyword: D(Ye),
		moduleKeyword: D(Ye),
		operator: Xe,
		derefOperator: D(Xe),
		arithmeticOperator: D(Xe),
		logicOperator: D(Xe),
		bitwiseOperator: D(Xe),
		compareOperator: D(Xe),
		updateOperator: D(Xe),
		definitionOperator: D(Xe),
		typeOperator: D(Xe),
		controlOperator: D(Xe),
		punctuation: jr,
		separator: D(jr),
		bracket: Ci,
		angleBracket: D(Ci),
		...
		documentMeta: D(_n),
		annotation: D(_n),
		processingInstruction: D(_n),
		definition: Be.defineModifier('definition'),
		constant: Be.defineModifier('constant'),
		function: Be.defineModifier('function'),
		standard: Be.defineModifier('standard'),
		local: Be.defineModifier('local'),
		special: Be.defineModifier('special')
	};
for (let n in w) {
	let e = w[n];
	e instanceof Be && (e.name = n);
}
Sc([
...
const Ft = new F();
function Cc(n) {
	return _.define({ combine: n ? (e) => e.concat(n) : void 0 });
}
const Xm = new F();
class We {
	constructor(e, t, i = [], s = '') {
	...
	isActiveAt(e, t, i = -1) {
		return ha(e, t, i).type.prop(Ft) == this.data;
	}
	findRegions(e) {
		let t = e.facet(Et);
		...
		let i = [],
			s = (r, o) => {
				if (r.prop(Ft) == this.data) {
					i.push({ from: o, to: o + r.length });
					return;
				}
				let l = r.prop(F.mounted);
				if (l) {
					if (l.tree.prop(Ft) == this.data) {
...
We.setState = I.define();
function ha(n, e, t) {
	let i = n.facet(Et),
		s = ye(n).topNode;
	if (!i || i.allowsNesting)
		for (let r = s; r; r = r.enter(e, t, Z.ExcludeBuffers | Z.EnterBracketed))
			r.type.isTop && (s = r);
	return s;
}
class $r extends We {
	...
	static define(e) {
		let t = Cc(e.languageData);
		return new $r(
			t,
			e.parser.configure({ props: [Ft.add((i) => (i.isTop ? t : void 0))] }),
			e.name
		);
	}
	configure(e, t) {
...
class mi {
	...
	static create(e, t, i) {
		return new mi(e, t, [], ee.empty, 0, i, [], null);
	}
	startParse() {
	...
	work(e, t) {
		return (
			...
			this.tree != ee.empty && this.isDone(t ?? this.state.doc.length)
				? (this.takeTree(), !0)
				: this.withContext(() => {
						var i;
						if (typeof e == 'number') {
	...
	takeTree() {
		...
		this.parse &&
			...
			(this.treeLen = e),
			(this.tree = t),
			(this.fragments = this.withoutTempSkipped(ft.addTree(this.tree, this.fragments, !0))),
			(this.parse = null));
	}
	withContext(e) {
		let t = Ai;
	...
	withoutTempSkipped(e) {
		for (let t; (t = this.tempSkipped.pop()); ) e = ca(e, t.from, t.to);
		return e;
	}
	changes(e, t) {
		...
		return new mi(this.parser, t, i, s, r, o, l, this.scheduleOn);
	}
	updateViewport(e) {
		...
		for (let i = 0; i < this.skipped.length; i++) {
			...
			s < e.to &&
				r > e.from &&
				((this.fragments = ca(this.fragments, s, r)), this.skipped.splice(i--, 1));
		}
			...
			createParse(t, i, s) {
				...
				return {
					...
					advance() {
						...
						return ((this.parsedPos = o), new ee(Ae.none, [], [], o - r));
					},
					stoppedAt: null,
					stopAt() {}
				};
...
class gi {
	...
	static init(e) {
		let t = Math.min(3e3, e.doc.length),
			i = mi.create(e.facet(Et).parser, e, { from: 0, to: t });
...
We.state = be.define({
	...
	update(n, e) {
		...
		return e.startState.facet(Et) != e.state.facet(Et) ? gi.init(e.state) : n.apply(e);
	}
});
let Ac = (n) => {
...
const Xs =
		typeof navigator < 'u' &&
		!((Ys = navigator.scheduling) === null || Ys === void 0) &&
		Ys.isInputPending
		...
		class {
			...
			work(e) {
				...
				let o =
					...
					a = r.context.work(() => (Xs && Xs()) || Date.now() > o, s + (l ? 0 : 1e5));
				((this.chunkBudget -= Date.now() - t),
					(a || this.chunkBudget <= 0) &&
						(r.context.takeTree(),
						this.view.dispatch({ effects: We.setState.of(new gi(r.context)) })),
...
function Ao(n, e) {
	n instanceof $ && (n = new vs(n));
	for (let i of n.state.facet(tg)) {
		let s = i(n, e);
		if (s !== void 0) return s;
	}
	let t = ye(n.state);
	return t.length >= e ? ig(n, t, e) : null;
}
class vs {
	constructor(e, t = {}) {
		((this.state = e), (this.options = t), (this.unit = Ut(e)));
	}
	lineAt(e, t = 1) {
...
function sg(n) {
	...
	if (t && (i = t.type.prop(F.closedBy))) {
		...
		return (o) => Dc(o, !0, 1, void 0, r && !ng(o) ? s.from : void 0);
	}
	return n.parent == null ? rg : null;
}
function rg() {
	return 0;
}
...
function vx({ closing: n, align: e = !0, units: t = 1 }) {
	return (i) => Dc(i, e, t, n);
}
...
const kx = (n) => n.baseIndent;
function Sx({ except: n, units: e = 1 } = {}) {
	return (t) => {
...
const Gt = be.define({
	...
	update(n, e) {
		(e.isUserEvent('delete') && e.changes.iterChangedRanges((t, i) => (n = fa(n, t, i))),
			(n = n.map(e.changes)));
		for (let t of e.effects)
			if (t.is(ks) && !pg(n, t.value.from, t.value.to)) {
				let { preparePlaceholder: i } = e.state.facet(Pc),
					s = i ? P.replace({ widget: new vg(i(e.state, t.value)) }) : ua;
		...
		return (e.selection && (n = fa(n, e.selection.main.head)), n);
	},
...
function _c(n, e) {
	return n.field(Gt, !1) ? e : e.concat(I.appendConfig.of(Rc()));
}
const mg = (n) => {
		for (let e of Oc(n)) {
			let t = ss(n.state, e.from, e.to);
			if (t) return (n.dispatch({ effects: _c(n.state, [ks.of(t), Lc(n, t)]) }), !0);
		}
		return !1;
	},
	gg = (n) => {
		if (!n.state.field(Gt, !1)) return !1;
		let e = [];
		for (let t of Oc(n)) {
			let i = rs(n.state, t.from, t.to);
			i && e.push(an.of(i), Lc(n, i, !1));
		}
...
const yg = (n) => {
		...
		for (let i = 0; i < e.doc.length; ) {
			let s = n.lineBlockAt(i),
				r = ss(e, s.from, s.to);
			(r && t.push(ks.of(r)), (i = (r ? n.lineBlockAt(r.to) : s).to + 1));
		}
	...
	wg = { placeholderDOM: null, preparePlaceholder: null, placeholderText: '…' },
	Pc = _.define({
		combine(n) {
			return lt(n, wg);
		}
...
function Sg(n = {}) {
		...
		s = oe.fromClass(
			class {
				...
				update(o) {
					(o.docChanged ||
						o.viewportChanged ||
						o.startState.facet(Et) != o.state.facet(Et) ||
						o.startState.field(Gt, !1) != o.state.field(Gt, !1) ||
						ye(o.startState) != ye(o.state) ||
						e.foldingChanged(o)) &&
				...
				buildMarkers(o) {
					...
					for (let a of o.viewportLineBlocks) {
						let h = rs(o.state, a.from, a.to) ? i : ss(o.state, a.from, a.to) ? t : null;
	...
	return [
		...
		_m({
			...
			markers(o) {
				var l;
				return ((l = o.plugin(s)) === null || l === void 0 ? void 0 : l.markers) || z.empty;
			},
			initialSpacer() {
				return new Qs(e, !1);
			},
			domEventHandlers: {
				...
				click: (o, l, a) => {
					...
					let h = rs(o.state, l.from, l.to);
					if (h) return (o.dispatch({ effects: an.of(h) }), !0);
					let c = ss(o.state, l.from, l.to);
					return c ? (o.dispatch({ effects: ks.of(c) }), !0) : !1;
				}
			}
		}),
		Rc()
...
class hn {
	constructor(e, t) {
		...
		const r = typeof t.all == 'string' ? t.all : t.all ? s(t.all) : void 0,
			o = t.scope;
		((this.scope = o instanceof We ? (l) => l.prop(Ft) == o.data : o ? (l) => l == o : void 0),
			(this.style = Sc(
...
function Zs(n) {
	let e = n.facet(Kr);
	return e.length ? e : n.facet(Bc);
}
function Nc(n, e) {
	let t = [Mg],
		i;
	return (
		n instanceof hn && (n.module && t.push(O.styleModule.of(n.module)), (i = n.themeType)),
		e != null && e.fallback
			? t.push(Bc.of(n))
			: i
				? t.push(
						Kr.computeN([O.darkTheme], (s) => (s.facet(O.darkTheme) == (i == 'dark') ? [n] : []))
					)
				: t.push(Kr.of(n)),
		t
	);
...
const Mg = _t.high(oe.fromClass(Ag, { decorations: (n) => n.decorations })),
	Tg = hn.define([
		...
		{ tag: [w.atom, w.bool, w.url, w.contentSeparator, w.labelName], color: '#219' },
	...
	Fc = _.define({
		combine(n) {
			return lt(n, { afterCursor: !0, brackets: Wc, maxScanDistance: Vc, renderMatch: _g });
		}
	}),
	Eg = P.mark({ class: 'cm-matchingBracket' }),
	Og = P.mark({ class: 'cm-nonmatchingBracket' });
function _g(n) {
	let e = [],
		t = n.matched ? Eg : Og;
	return (
...
function da(n) {
	...
	for (let i of n.selection.ranges) {
		...
		let s =
			...
			(t.afterCursor &&
				(st(n, i.head, 1, t) || (i.head < n.doc.length && st(n, i.head + 1, -1, t))));
		s && (e = e.concat(t.renderMatch(s, n)));
	}
	return P.set(e, !0);
}
const Lg = oe.fromClass(
		class {
			constructor(n) {
				((this.paused = !1), (this.decorations = da(n.state)));
			}
			update(n) {
				(n.docChanged || n.selectionSet || this.paused) &&
					(n.view.composing
						? ((this.decorations = this.decorations.map(n.changes)), (this.paused = !0))
						: ((this.decorations = da(n.state)), (this.paused = !1)));
			}
		},
		{ decorations: (n) => n.decorations }
	),
...
function Gr(n) {
	let e = n.type.prop(Ig);
	return e ? e(n.node) : n;
}
function st(n, e, t, i = {}) {
	let s = i.maxScanDistance || Vc,
		r = i.brackets || Wc,
		o = ye(n),
	...
	if (c && (t < 0 ? c.childBefore(i.from) : c.childAfter(i.to)))
		do
			if (t < 0 ? c.to <= i.from : c.from >= i.to) {
				...
				} else if (Ur(c.type, t, o)) h++;
				else if (Ur(c.type, -t, o)) {
					if (h == 0) {
						let f = Gr(c);
						return {
							start: a,
...
class Hc {
	...
	eat(e) {
		let t = this.string.charAt(this.pos),
			i;
		if (
			(typeof e == 'string' ? (i = t == e) : (i = t && (e instanceof RegExp ? e.test(t) : e(t))), i)
		)
			return (++this.pos, t);
	}
	eatWhile(e) {
	...
	indentation() {
		...
		return (e = this.overrideIndent) !== null && e !== void 0
			? e
			: pa(this.string, null, this.tabSize);
	}
	match(e, t, i) {
		if (typeof e == 'string') {
...
function Vg(n) {
	return {
		...
		copyState: n.copyState || Wg,
		indent: n.indent || (() => null),
		languageData: n.languageData || {},
		tokenTable: n.tokenTable || Eo,
...
class To extends We {
	constructor(e) {
		let t = Cc(e.languageData),
			i = Vg(e),
			s,
			r = new (class extends Qa {
				createParse(o, l, a) {
					return new Hg(s, o, l, a);
				}
			})();
		(super(t, r, [], e.name),
			(this.topNode = jg(t, this)),
			(s = this),
			(this.streamParser = i),
			(this.stateAfter = new F({ perNode: !0 })),
			(this.tokenTable = e.tokenTable ? new $c(i.tokenTable) : qg));
	}
	static define(e) {
		return new To(e);
	}
	getIndent(e) {
		...
		i && ((t = ma.get(e.state)), t != null && t < e.pos - 1e4 && (t = void 0));
		let s = Do(this, e.node.tree, e.node.from, e.node.from, t ?? e.pos),
			r,
			o;
		if (
			(s
		...
		for (; r < e.pos; ) {
			...
			if (a.length) {
				...
				for (; f.pos < h - a.from; ) qc(this.streamParser.token, f, o);
		...
		return (
			i && t == null && ma.set(e.state, l.from),
...
function zc(n, e, t, i, s) {
	...
	for (let r = e.children.length - 1; r >= 0; r--) {
		let o = e.positions[r],
			l = e.children[r],
			a;
		if (o < i && l instanceof ee) {
			if (!(a = zc(n, l, t - o, i - o, s))) break;
			return s
				? new ee(
						e.type,
...
function Fg(n, e, t, i, s) {
	for (let r of e) {
		let o = r.from + (r.openStart ? 25 : 0),
			l = r.to - (r.openEnd ? 25 : 0),
			a = o <= t && l > t && Do(n, r.tree, 0 - r.offset, t, l),
			h;
		if (a && a.pos <= i && (h = zc(n, r.tree, t + r.offset, a.pos + r.offset, !1)))
			return { state: a.state, tree: h };
	}
	return { state: n.streamParser.startState(s ? Ut(s) : 4), tree: ee.empty };
}
class Hg {
	constructor(e, t, i, s) {
		((this.lang = e),
		...
		let r = mi.get(),
			o = s[0].from,
			{ state: l, tree: a } = Fg(e, i, o, this.to, r == null ? void 0 : r.state);
		...
		(r &&
			...
			((this.state = this.lang.streamParser.startState(Ut(r.state))),
	...
	advance() {
		...
		for (e && (i = Math.min(i, e.viewport.to)); this.parsedPos < i; ) this.parseLine(e);
		return (
...
`);
	...
	nextLine() {
		...
		for (let s = this.rangeIndex; ; ) {
			...
			if (r >= i || ((t = t.slice(0, r - (i - t.length))), s++, s == this.ranges.length)) break;
	...
	parseLine(e) {
		let { line: t, end: i } = this.nextLine(),
			...
			o = new Hc(t, e ? e.state.tabSize : 4, e ? Ut(e.state) : 2);
		if (o.eol()) r.blankLine(this.state, o.indentUnit);
		else
			for (; !o.eol(); ) {
				let l = qc(r.token, o, this.state);
				if (
					(l &&
						(s = this.emitToken(
	...
	finishChunk() {
		...
		((e = new ee(e.type, e.children, e.positions, e.length, [
...
class $c {
	constructor(e) {
		((this.extra = e), (this.table = Object.assign(Object.create(null), jc)));
	}
	resolve(e) {
		return e ? this.table[e] || (this.table[e] = Kc(this.extra, e)) : 0;
	}
}
const qg = new $c(Eo);
function er(n, e) {
...
function Kc(n, e) {
		...
		for (let h of l.split('.')) {
			...
			c
				? typeof c == 'function'
					? a.length
						? (a = a.map(c))
						: er(h, `Modifier ${h} used at start of tag`)
					: a.length
						? er(h, `Tag ${h} used as modifier`)
						: (a = Array.isArray(c) ? c : [c])
				: er(h, `Unknown highlighting tag ${h}`);
		}
	...
	let i = e.replace(/ /g, '_'),
		...
		r = ya[s];
	if (r) return r.id;
	let o = (ya[s] = Ae.define({ id: Ji.length, name: i, props: [Km({ [i]: t })] }));
	return (Ji.push(o), o.id);
}
function jg(n, e) {
	let t = Ae.define({
		id: Ji.length,
		name: 'Document',
		props: [Ft.add(() => n), Mc.add(() => (i) => e.getIndent(i))],
		top: !0
	});
	return (Ji.push(t), t);
}
(te.RTL, te.LTR);
function k(n) {
	return new eg(To.define(n));
}
function bt(n) {
	return x(() => import('./CgbxCejC.js'), __vite__mapDeps([0, 1]), import.meta.url).then((e) =>
		e.sql({ dialect: e[n] })
	);
}
const Ss = [
		b.of({
			...
			extensions: ['c', 'h', 'ino'],
			load() {
				return x(() => import('./C3P7o97W.js'), __vite__mapDeps([2, 1]), import.meta.url).then(
					(n) => n.cpp()
				);
			}
		}),
		...
		b.of({
			...
			extensions: ['css'],
			load() {
				return x(() => import('./BZ6RuYIe.js'), __vite__mapDeps([3, 1]), import.meta.url).then(
					(n) => n.css()
				);
			}
		}),
		b.of({
			...
			extensions: ['go'],
			load() {
				return x(() => import('./TzVw0Tyr.js'), __vite__mapDeps([4, 1]), import.meta.url).then(
					(n) => n.go()
				);
			}
		}),
		...
		b.of({
			...
			extensions: ['java'],
			load() {
				return x(() => import('./DqgCnyg-.js'), __vite__mapDeps([7, 1]), import.meta.url).then(
					(n) => n.java()
				);
			}
		}),
		b.of({
			...
			load() {
				return x(() => import('./Cu4qgmQD.js'), __vite__mapDeps([6, 1]), import.meta.url).then(
					(n) => n.javascript()
				);
			}
		}),
		...
		b.of({
			...
			extensions: ['json', 'map'],
			load() {
				return x(() => import('./eExuMBuD.js'), __vite__mapDeps([9, 1]), import.meta.url).then(
					(n) => n.json()
				);
			}
		}),
		...
		b.of({
			...
			extensions: ['less'],
			load() {
				return x(() => import('./BBSR-QQD.js'), __vite__mapDeps([10, 3, 1]), import.meta.url).then(
					(n) => n.less()
				);
			}
		}),
		...
		b.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load() {
				return x(() => import('./DQhp0nnc.js'), __vite__mapDeps([14, 1]), import.meta.url).then(
					(n) => n.python()
				);
			}
		}),
		b.of({
			...
			extensions: ['rs'],
			load() {
				return x(() => import('./crR7AKFS.js'), __vite__mapDeps([15, 1]), import.meta.url).then(
					(n) => n.rust()
				);
			}
		}),
		b.of({
			...
			extensions: ['sass'],
			load() {
				return x(() => import('./B90_5mcW.js'), __vite__mapDeps([16, 1, 3]), import.meta.url).then(
					(n) => n.sass({ indented: !0 })
				);
			}
		}),
		...
		b.of({
			...
			load() {
				return x(() => import('./Cu4qgmQD.js'), __vite__mapDeps([6, 1]), import.meta.url).then(
					(n) => n.javascript({ jsx: !0, typescript: !0 })
				);
			}
		}),
		b.of({
		...
		b.of({
			...
			extensions: ['wat', 'wast'],
			load() {
				return x(() => import('./B4hZoNki.js'), __vite__mapDeps([17, 1]), import.meta.url).then(
					(n) => n.wast()
				);
			}
		}),
		b.of({
			...
			load() {
				return x(() => import('./CCagcWwd.js'), __vite__mapDeps([18, 1]), import.meta.url).then(
					(n) => n.xml()
				);
			}
		}),
		b.of({
			...
			extensions: ['yaml', 'yml'],
			load() {
				return x(() => import('./DhT1KESM.js'), __vite__mapDeps([19, 1]), import.meta.url).then(
					(n) => n.yaml()
				);
			}
		}),
		b.of({
			...
			load() {
				return x(() => import('./B4CMkyY2.js'), [], import.meta.url).then((n) => k(n.apl));
			}
		}),
		b.of({
			name: 'PGP',
			...
			load() {
				return x(() => import('./Df11BRmG.js'), [], import.meta.url).then((n) => k(n.asciiArmor));
			}
		}),
		b.of({
			name: 'ASN.1',
			extensions: ['asn', 'asn1'],
			load() {
				return x(() => import('./EdZsLKOL.js'), [], import.meta.url).then((n) => k(n.asn1({})));
			}
		}),
		b.of({
			name: 'Asterisk',
			...
			load() {
				return x(() => import('./B-8jnY81.js'), [], import.meta.url).then((n) => k(n.asterisk));
			}
		}),
		b.of({
			name: 'Brainfuck',
			extensions: ['b', 'bf'],
			load() {
				return x(() => import('./C4LP7Hcl.js'), [], import.meta.url).then((n) => k(n.brainfuck));
			}
		}),
		b.of({
			name: 'Cobol',
			extensions: ['cob', 'cpy'],
			load() {
				return x(() => import('./CWcv1MsR.js'), [], import.meta.url).then((n) => k(n.cobol));
			}
		}),
		b.of({
			name: 'C#',
			...
			extensions: ['cs'],
			load() {
				return x(() => import('./B9uivgTg.js'), [], import.meta.url).then((n) => k(n.csharp));
			}
		}),
		b.of({
			name: 'Clojure',
			...
			load() {
				return x(() => import('./BMjYHr_A.js'), [], import.meta.url).then((n) => k(n.clojure));
			}
		}),
		b.of({
			name: 'ClojureScript',
		...
		b.of({
			...
			extensions: ['gss'],
			load() {
				return x(() => import('./BnMrqG3P.js'), [], import.meta.url).then((n) => k(n.gss));
			}
		}),
		b.of({
			name: 'CMake',
			...
			load() {
				return x(() => import('./BQqOBYOt.js'), [], import.meta.url).then((n) => k(n.cmake));
			}
		}),
		b.of({
			name: 'CoffeeScript',
			...
			extensions: ['coffee'],
			load() {
				return x(() => import('./S37ZYGWr.js'), [], import.meta.url).then((n) => k(n.coffeeScript));
			}
		}),
		b.of({
			name: 'Common Lisp',
			...
			load() {
				return x(() => import('./DBKNyK5s.js'), [], import.meta.url).then((n) => k(n.commonLisp));
			}
		}),
		b.of({
			name: 'Cypher',
			...
			load() {
				return x(() => import('./C_CwsFkJ.js'), [], import.meta.url).then((n) => k(n.cypher));
			}
		}),
		b.of({
			name: 'Cython',
			...
			load() {
				return x(() => import('./BuPzkPfP.js'), [], import.meta.url).then((n) => k(n.cython));
			}
		}),
		b.of({
			name: 'Crystal',
			extensions: ['cr'],
			load() {
				return x(() => import('./SjHAIU92.js'), [], import.meta.url).then((n) => k(n.crystal));
			}
		}),
		b.of({
			name: 'D',
			extensions: ['d'],
			load() {
				return x(() => import('./pRatUO7H.js'), [], import.meta.url).then((n) => k(n.d));
			}
		}),
		b.of({
			name: 'Dart',
			extensions: ['dart'],
			load() {
				return x(() => import('./B9uivgTg.js'), [], import.meta.url).then((n) => k(n.dart));
			}
		}),
		b.of({
			name: 'diff',
			...
			load() {
				return x(() => import('./DbItnlRl.js'), [], import.meta.url).then((n) => k(n.diff));
			}
		}),
		b.of({
			name: 'Dockerfile',
			filename: /^Dockerfile$/,
			load() {
				return x(() => import('./fCUp34qd.js'), __vite__mapDeps([20, 21]), import.meta.url).then(
					(n) => k(n.dockerFile)
				);
			}
		}),
		b.of({
			...
			extensions: ['dtd'],
			load() {
				return x(() => import('./DF_7sFjM.js'), [], import.meta.url).then((n) => k(n.dtd));
			}
		}),
		b.of({
			name: 'Dylan',
			...
			load() {
				return x(() => import('./DwRh75JA.js'), [], import.meta.url).then((n) => k(n.dylan));
			}
		}),
		b.of({
			name: 'EBNF',
			load() {
				return x(() => import('./CDyGwa7X.js'), [], import.meta.url).then((n) => k(n.ebnf));
			}
		}),
		b.of({
			name: 'ECL',
			extensions: ['ecl'],
			load() {
				return x(() => import('./Cabwm37j.js'), [], import.meta.url).then((n) => k(n.ecl));
			}
		}),
		b.of({
			name: 'edn',
		...
		b.of({
			...
			extensions: ['e'],
			load() {
				return x(() => import('./CnydiIhH.js'), [], import.meta.url).then((n) => k(n.eiffel));
			}
		}),
		b.of({
			name: 'Elm',
			extensions: ['elm'],
			load() {
				return x(() => import('./vLlmbW-K.js'), [], import.meta.url).then((n) => k(n.elm));
			}
		}),
		b.of({
			name: 'Erlang',
			extensions: ['erl'],
			load() {
				return x(() => import('./BNw1qcRV.js'), [], import.meta.url).then((n) => k(n.erlang));
			}
		}),
		b.of({
			name: 'Esper',
			load() {
				return x(() => import('./D0XecflT.js'), [], import.meta.url).then((n) => k(n.esper));
			}
		}),
		b.of({
			name: 'Factor',
			extensions: ['factor'],
			load() {
				return x(() => import('./4D5F-n5U.js'), __vite__mapDeps([22, 21]), import.meta.url).then(
					(n) => k(n.factor)
				);
			}
		}),
		b.of({
			name: 'FCL',
			load() {
				return x(() => import('./Kvtd6kyn.js'), [], import.meta.url).then((n) => k(n.fcl));
			}
		}),
		b.of({
			name: 'Forth',
			...
			load() {
				return x(() => import('./Ffai-XNe.js'), [], import.meta.url).then((n) => k(n.forth));
			}
		}),
		b.of({
			name: 'Fortran',
			...
			load() {
				return x(() => import('./DYz_wnZ1.js'), [], import.meta.url).then((n) => k(n.fortran));
			}
		}),
		b.of({
			name: 'F#',
			...
			extensions: ['fs'],
			load() {
				return x(() => import('./CXdrOF99.js'), [], import.meta.url).then((n) => k(n.fSharp));
			}
		}),
		b.of({
			name: 'Gas',
			extensions: ['s'],
			load() {
				return x(() => import('./Bneqetm1.js'), [], import.meta.url).then((n) => k(n.gas));
			}
		}),
		b.of({
			name: 'Gherkin',
			extensions: ['feature'],
			load() {
				return x(() => import('./heZmZLOM.js'), [], import.meta.url).then((n) => k(n.gherkin));
			}
		}),
		b.of({
			name: 'Groovy',
			...
			load() {
				return x(() => import('./D9Dt4D0W.js'), [], import.meta.url).then((n) => k(n.groovy));
			}
		}),
		b.of({
			name: 'Haskell',
			extensions: ['hs'],
			load() {
				return x(() => import('./BWDZoCOh.js'), [], import.meta.url).then((n) => k(n.haskell));
			}
		}),
		b.of({
			name: 'Haxe',
			extensions: ['hx'],
			load() {
				return x(() => import('./H-WmDvRZ.js'), [], import.meta.url).then((n) => k(n.haxe));
			}
		}),
		b.of({
			name: 'HXML',
			extensions: ['hxml'],
			load() {
				return x(() => import('./H-WmDvRZ.js'), [], import.meta.url).then((n) => k(n.hxml));
			}
		}),
		b.of({
			name: 'HTTP',
			load() {
				return x(() => import('./DBlCnlav.js'), [], import.meta.url).then((n) => k(n.http));
			}
		}),
		b.of({
			name: 'IDL',
			extensions: ['pro'],
			load() {
				return x(() => import('./BEugSyMb.js'), [], import.meta.url).then((n) => k(n.idl));
			}
		}),
		b.of({
			name: 'JSON-LD',
			...
			extensions: ['jsonld'],
			load() {
				return x(() => import('./qCveANmP.js'), [], import.meta.url).then((n) => k(n.jsonld));
			}
		}),
		b.of({
			name: 'Julia',
			extensions: ['jl'],
			load() {
				return x(() => import('./DuME0IfC.js'), [], import.meta.url).then((n) => k(n.julia));
			}
		}),
		b.of({
			name: 'Kotlin',
			extensions: ['kt', 'kts'],
			load() {
				return x(() => import('./B9uivgTg.js'), [], import.meta.url).then((n) => k(n.kotlin));
			}
		}),
		b.of({
			name: 'LiveScript',
			...
			extensions: ['ls'],
			load() {
				return x(() => import('./BwQOo05w.js'), [], import.meta.url).then((n) => k(n.liveScript));
			}
		}),
		b.of({
			name: 'Lua',
			extensions: ['lua'],
			load() {
				return x(() => import('./BgMRiT3U.js'), [], import.meta.url).then((n) => k(n.lua));
			}
		}),
		b.of({
			name: 'mIRC',
			extensions: ['mrc'],
			load() {
				return x(() => import('./CjQqDB4T.js'), [], import.meta.url).then((n) => k(n.mirc));
			}
		}),
		b.of({
			name: 'Mathematica',
			...
			load() {
				return x(() => import('./DTrFuWx2.js'), [], import.meta.url).then((n) => k(n.mathematica));
			}
		}),
		b.of({
			name: 'Modelica',
			extensions: ['mo'],
			load() {
				return x(() => import('./Dc1JOy9r.js'), [], import.meta.url).then((n) => k(n.modelica));
			}
		}),
		b.of({
			name: 'MUMPS',
			extensions: ['mps'],
			load() {
				return x(() => import('./BT43cFF4.js'), [], import.meta.url).then((n) => k(n.mumps));
			}
		}),
		b.of({
			name: 'Mbox',
			extensions: ['mbox'],
			load() {
				return x(() => import('./CNhZ1qSd.js'), [], import.meta.url).then((n) => k(n.mbox));
			}
		}),
		b.of({
			name: 'Nginx',
			...
			load() {
				return x(() => import('./DdIZxoE0.js'), [], import.meta.url).then((n) => k(n.nginx));
			}
		}),
		b.of({
			name: 'NSIS',
			extensions: ['nsh', 'nsi'],
			load() {
				return x(() => import('./BEk9thJj.js'), __vite__mapDeps([23, 21]), import.meta.url).then(
					(n) => k(n.nsis)
				);
			}
		}),
		b.of({
			...
			extensions: ['nt', 'nq'],
			load() {
				return x(() => import('./BfvgReVJ.js'), [], import.meta.url).then((n) => k(n.ntriples));
			}
		}),
		b.of({
			name: 'Objective-C',
			...
			extensions: ['m'],
			load() {
				return x(() => import('./B9uivgTg.js'), [], import.meta.url).then((n) => k(n.objectiveC));
			}
		}),
		b.of({
			name: 'Objective-C++',
			...
			extensions: ['mm'],
			load() {
				return x(() => import('./B9uivgTg.js'), [], import.meta.url).then((n) => k(n.objectiveCpp));
			}
		}),
		b.of({
			name: 'OCaml',
			...
			load() {
				return x(() => import('./CXdrOF99.js'), [], import.meta.url).then((n) => k(n.oCaml));
			}
		}),
		b.of({
			name: 'Octave',
			extensions: ['m'],
			load() {
				return x(() => import('./Ck1zUtKM.js'), [], import.meta.url).then((n) => k(n.octave));
			}
		}),
		b.of({
			name: 'Oz',
			extensions: ['oz'],
			load() {
				return x(() => import('./BzwKVEFT.js'), [], import.meta.url).then((n) => k(n.oz));
			}
		}),
		b.of({
			name: 'Pascal',
			extensions: ['p', 'pas'],
			load() {
				return x(() => import('./-L3eBynH.js'), [], import.meta.url).then((n) => k(n.pascal));
			}
		}),
		b.of({
			name: 'Perl',
			extensions: ['pl', 'pm'],
			load() {
				return x(() => import('./CdXCOZ3F.js'), [], import.meta.url).then((n) => k(n.perl));
			}
		}),
		b.of({
			name: 'Pig',
			extensions: ['pig'],
			load() {
				return x(() => import('./CevX1Tat.js'), [], import.meta.url).then((n) => k(n.pig));
			}
		}),
		b.of({
			name: 'PowerShell',
			...
			load() {
				return x(() => import('./CFHJl5sT.js'), [], import.meta.url).then((n) => k(n.powerShell));
			}
		}),
		b.of({
			...
			load() {
				return x(() => import('./C78fOPTZ.js'), [], import.meta.url).then((n) => k(n.properties));
			}
		}),
		b.of({
			name: 'ProtoBuf',
			extensions: ['proto'],
			load() {
				return x(() => import('./ChK-085T.js'), [], import.meta.url).then((n) => k(n.protobuf));
			}
		}),
		b.of({
			name: 'Pug',
			...
			extensions: ['pug', 'jade'],
			load() {
				return x(() => import('./D9FQ33Zq.js'), __vite__mapDeps([24, 25]), import.meta.url).then(
					(n) => k(n.pug)
				);
			}
		}),
		b.of({
			...
			extensions: ['pp'],
			load() {
				return x(() => import('./DMA9R1ak.js'), [], import.meta.url).then((n) => k(n.puppet));
			}
		}),
		b.of({
			name: 'Q',
			extensions: ['q'],
			load() {
				return x(() => import('./pXgVlZs6.js'), [], import.meta.url).then((n) => k(n.q));
			}
		}),
		b.of({
			name: 'R',
			...
			extensions: ['r', 'R'],
			load() {
				return x(() => import('./DUYO_cvP.js'), [], import.meta.url).then((n) => k(n.r));
			}
		}),
		b.of({
			name: 'RPM Changes',
			load() {
				return x(() => import('./CTu-6PCP.js'), [], import.meta.url).then((n) => k(n.rpmChanges));
			}
		}),
		b.of({
			name: 'RPM Spec',
			extensions: ['spec'],
			load() {
				return x(() => import('./CTu-6PCP.js'), [], import.meta.url).then((n) => k(n.rpmSpec));
			}
		}),
		b.of({
			name: 'Ruby',
			...
			load() {
				return x(() => import('./B2Rjki9n.js'), [], import.meta.url).then((n) => k(n.ruby));
			}
		}),
		b.of({
			name: 'SAS',
			extensions: ['sas'],
			load() {
				return x(() => import('./B4kiWyti.js'), [], import.meta.url).then((n) => k(n.sas));
			}
		}),
		b.of({
			name: 'Scala',
			extensions: ['scala'],
			load() {
				return x(() => import('./B9uivgTg.js'), [], import.meta.url).then((n) => k(n.scala));
			}
		}),
		b.of({
			name: 'Scheme',
			extensions: ['scm', 'ss'],
			load() {
				return x(() => import('./C41bIUwD.js'), [], import.meta.url).then((n) => k(n.scheme));
			}
		}),
		b.of({
			name: 'Shell',
			...
			filename: /^PKGBUILD$/,
			load() {
				return x(() => import('./CjFT_Tl9.js'), [], import.meta.url).then((n) => k(n.shell));
			}
		}),
		b.of({
			name: 'Sieve',
			...
			load() {
				return x(() => import('./C3Gn_uJK.js'), [], import.meta.url).then((n) => k(n.sieve));
			}
		}),
		b.of({
			name: 'Smalltalk',
			extensions: ['st'],
			load() {
				return x(() => import('./CnHTOXQT.js'), [], import.meta.url).then((n) => k(n.smalltalk));
			}
		}),
		b.of({
			name: 'Solr',
			load() {
				return x(() => import('./DehyRSwq.js'), [], import.meta.url).then((n) => k(n.solr));
			}
		}),
		b.of({
			name: 'SML',
			...
			load() {
				return x(() => import('./CXdrOF99.js'), [], import.meta.url).then((n) => k(n.sml));
			}
		}),
		b.of({
			name: 'SPARQL',
			...
			load() {
				return x(() => import('./DkYu6x3z.js'), [], import.meta.url).then((n) => k(n.sparql));
			}
		}),
		b.of({
			name: 'Spreadsheet',
			alias: ['excel', 'formula'],
			load() {
				return x(() => import('./BCZA_wO0.js'), [], import.meta.url).then((n) => k(n.spreadsheet));
			}
		}),
		b.of({
			name: 'Squirrel',
			extensions: ['nut'],
			load() {
				return x(() => import('./B9uivgTg.js'), [], import.meta.url).then((n) => k(n.squirrel));
			}
		}),
		b.of({
			name: 'Stylus',
			extensions: ['styl'],
			load() {
				return x(() => import('./B533Al4x.js'), [], import.meta.url).then((n) => k(n.stylus));
			}
		}),
		b.of({
			name: 'Swift',
			extensions: ['swift'],
			load() {
				return x(() => import('./BzpIVaGY.js'), [], import.meta.url).then((n) => k(n.swift));
			}
		}),
		b.of({
			name: 'sTeX',
			load() {
				return x(() => import('./C3f8Ysf7.js'), [], import.meta.url).then((n) => k(n.stex));
			}
		}),
		b.of({
			name: 'LaTeX',
		...
		b.of({
			...
			extensions: ['v', 'sv', 'svh'],
			load() {
				return x(() => import('./C6RDOZhf.js'), [], import.meta.url).then((n) => k(n.verilog));
			}
		}),
		b.of({
			name: 'Tcl',
			extensions: ['tcl'],
			load() {
				return x(() => import('./DVfN8rqt.js'), [], import.meta.url).then((n) => k(n.tcl));
			}
		}),
		b.of({
			name: 'Textile',
			extensions: ['textile'],
			load() {
				return x(() => import('./CnDTJFAw.js'), [], import.meta.url).then((n) => k(n.textile));
			}
		}),
		b.of({
			name: 'TiddlyWiki',
			load() {
				return x(() => import('./DO-Gjzrf.js'), [], import.meta.url).then((n) => k(n.tiddlyWiki));
			}
		}),
		b.of({
			name: 'Tiki wiki',
			load() {
				return x(() => import('./DGYXhP31.js'), [], import.meta.url).then((n) => k(n.tiki));
			}
		}),
		b.of({
			name: 'TOML',
			extensions: ['toml'],
			load() {
				return x(() => import('./Bm5Em-hy.js'), [], import.meta.url).then((n) => k(n.toml));
			}
		}),
		b.of({
			name: 'Troff',
			...
			load() {
				return x(() => import('./wAsdV37c.js'), [], import.meta.url).then((n) => k(n.troff));
			}
		}),
		b.of({
			name: 'TTCN',
			...
			load() {
				return x(() => import('./CfJYG6tj.js'), [], import.meta.url).then((n) => k(n.ttcn));
			}
		}),
		b.of({
			name: 'TTCN_CFG',
			extensions: ['cfg'],
			load() {
				return x(() => import('./B9xdYoR4.js'), [], import.meta.url).then((n) => k(n.ttcnCfg));
			}
		}),
		b.of({
			name: 'Turtle',
			extensions: ['ttl'],
			load() {
				return x(() => import('./B1tBg_DP.js'), [], import.meta.url).then((n) => k(n.turtle));
			}
		}),
		b.of({
			name: 'Web IDL',
			extensions: ['webidl'],
			load() {
				return x(() => import('./ZXfAyPTL.js'), [], import.meta.url).then((n) => k(n.webIDL));
			}
		}),
		b.of({
			name: 'VB.NET',
			extensions: ['vb'],
			load() {
				return x(() => import('./CmGdzxic.js'), [], import.meta.url).then((n) => k(n.vb));
			}
		}),
		b.of({
			name: 'VBScript',
			extensions: ['vbs'],
			load() {
				return x(() => import('./BuJXcnF6.js'), [], import.meta.url).then((n) => k(n.vbScript));
			}
		}),
		b.of({
			name: 'Velocity',
			extensions: ['vtl'],
			load() {
				return x(() => import('./D8B20fx6.js'), [], import.meta.url).then((n) => k(n.velocity));
			}
		}),
		b.of({
			name: 'Verilog',
		...
		b.of({
			...
			extensions: ['vhd', 'vhdl'],
			load() {
				return x(() => import('./lSbBsy5d.js'), [], import.meta.url).then((n) => k(n.vhdl));
			}
		}),
		b.of({
			name: 'XQuery',
			...
			load() {
				return x(() => import('./CQfU5ijd.js'), [], import.meta.url).then((n) => k(n.xQuery));
			}
		}),
		b.of({
			name: 'Yacas',
			extensions: ['ys'],
			load() {
				return x(() => import('./BJ4BC0dw.js'), [], import.meta.url).then((n) => k(n.yacas));
			}
		}),
		b.of({
			name: 'Z80',
			extensions: ['z80'],
			load() {
				return x(() => import('./Hz9HOZM7.js'), [], import.meta.url).then((n) => k(n.z80));
			}
		}),
		b.of({
			name: 'MscGen',
			...
			load() {
				return x(() => import('./BA5vi2Kp.js'), [], import.meta.url).then((n) => k(n.mscgen));
			}
		}),
		b.of({
			name: 'Xù',
			extensions: ['xu'],
			load() {
				return x(() => import('./BA5vi2Kp.js'), [], import.meta.url).then((n) => k(n.xu));
			}
		}),
		b.of({
			name: 'MsGenny',
			extensions: ['msgenny'],
			load() {
				return x(() => import('./BA5vi2Kp.js'), [], import.meta.url).then((n) => k(n.msgenny));
			}
		}),
		b.of({
			name: 'Vue',
		...
		b.of({
			...
			load() {
				return x(
					() => import('./9sCU2rg6.js'),
					__vite__mapDeps([27, 5, 1, 3, 6]),
					import.meta.url
				).then((n) => n.angular());
			}
		})
	],
	ba = Ss.find((n) => n.name === 'Octave');
ba && ba.alias.push('matlab');
Ss.push(
	b.of({
		name: 'HCL',
		extensions: ['hcl', 'tf'],
		load() {
			return x(() => import('./BJeWbfiJ.js'), __vite__mapDeps([28, 1]), import.meta.url).then((n) =>
				n.hcl()
			);
		}
	})
...
Ss.push(
	b.of({
		...
		extensions: ['ex', 'exs'],
		load() {
			return x(() => import('./D4ZM1bsa.js'), __vite__mapDeps([29, 1]), import.meta.url).then((n) =>
				n.elixir()
			);
		}
	})
...
const $g = (n) => {
	let { state: e } = n,
		...
		i = _o(n.state, t.from);
	return i.line ? Kg(n) : i.block ? Gg(n) : !1;
};
function Oo(n, e) {
...
const Kg = Oo(Xg, 0),
	Ug = Oo(Uc, 0),
	Gg = Oo((n, e) => Uc(n, e, Yg(e)), 0);
function _o(n, e) {
	let t = n.languageDataAt('commentTokens', e, 1);
	return t.length ? t[0] : {};
}
const Mi = 50;
function Jg(n, { open: e, close: t }, i, s) {
	let r = n.sliceDoc(i - Mi, i),
		o = n.sliceDoc(s, s + Mi),
		l = /\s*$/.exec(r)[0].length,
		a = /^\s*/.exec(o)[0].length,
		h = r.length - l;
	...
	s - i <= 2 * Mi
		? (c = f = n.sliceDoc(i, s))
		: ((c = n.sliceDoc(i, i + Mi)), (f = n.sliceDoc(s - Mi, s)));
...
function Uc(n, e, t = e.selection.ranges) {
	let i = t.map((r) => _o(e, r.from).block);
	if (!i.every((r) => r)) return null;
	let s = t.map((r, o) => Jg(e, i[o], r.from, r.to));
	if (n != 2 && !s.every((r) => r))
		return {
			changes: e.changes(
				t.map((r, o) =>
...
function Xg(n, e, t = e.selection.ranges) {
	let i = [],
		s = -1;
	e: for (let { from: r, to: o } of t) {
		...
		for (let c = r; c <= o; ) {
			...
			if (h == null && ((h = _o(e, f.from).line), !h)) continue e;
	...
	Jc = be.define({
		...
		update(n, e) {
			...
			if (i) {
				...
				return (
					a ? (c = os(c, c.length, t.minDepth, a)) : (c = Qc(c, e.startState.selection)),
					new rt(h == 0 ? i.rest : c, h == 0 ? c : i.rest)
				);
			}
			let s = e.annotation(Qg);
			if (
				((s == 'full' || s == 'before') && (n = n.isolate()), e.annotation(he.addToHistory) === !1)
			)
				return e.changes.empty ? n : n.addMapping(e.changes.desc);
			let r = Oe.fromTransaction(e),
				o = e.annotation(he.time),
				l = e.annotation(he.userEvent);
			return (
				r
...
function e0(n = {}) {
	return [
		...
		O.domEventHandlers({
			beforeinput(e, t) {
				let i = e.inputType == 'historyUndo' ? Yc : e.inputType == 'historyRedo' ? Yr : null;
...
class Oe {
	...
	static fromJSON(e) {
		return new Oe(
			e.changes && ce.fromJSON(e.changes),
			[],
	...
	static fromTransaction(e, t) {
		let i = Fe;
		for (let s of e.startState.facet(Zg)) {
			let r = s(e);
			r.length && (i = i.concat(r));
		}
		return !i.length && e.changes.empty
			? null
			: new Oe(e.changes.invert(e.startState.doc), i, void 0, t || e.startState.selection, Fe);
	}
	static selection(e) {
		return new Oe(void 0, Fe, void 0, void 0, e);
	}
}
function os(n, e, t, i) {
...
function Qc(n, e) {
	if (n.length) {
		let t = n[n.length - 1],
			i = t.selectionsAfter.slice(Math.max(0, t.selectionsAfter.length - r0));
		return i.length && i[i.length - 1].eq(e)
			? n
			: (i.push(e), os(n, n.length - 1, 1e9, t.setSelAfter(i)));
...
function tr(n, e) {
	...
	return i.length ? [Oe.selection(i)] : Fe;
}
function l0(n, e, t) {
	let i = Xc(n.selectionsAfter.length ? n.selectionsAfter.map((l) => l.map(e)) : Fe, t);
	if (!n.changes) return Oe.selection(i);
	let s = n.changes.map(e),
		r = e.mapDesc(n.changes, !0),
		o = n.mapped ? n.mapped.composeDesc(r) : r;
	return new Oe(s, I.mapEffects(n.effects, e), o, n.startSelection.map(r), i);
}
const a0 = /^(input\.type|delete)($|\.)/;
class rt {
	...
	addChanges(e, t, i, s, r) {
		...
		return (
			...
			((!l.selectionsAfter.length &&
				...
				s.joinToEvent(r, n0(l.changes, e.changes))) ||
				...
				? (o = os(
						...
						new Oe(
							...
							Xc(I.mapEffects(e.effects, l.changes), l.effects),
							l.mapped,
							l.startSelection,
							Fe
						)
					))
				: (o = os(o, o.length, s.minDepth, e)),
			new rt(o, Fe, t, i)
		);
	}
	addSelection(e, t, i, s) {
		...
		return r.length > 0 &&
			...
			s0(r[r.length - 1], e)
			? this
			: new rt(Qc(this.done, e), this.undone, t, i);
	}
	addMapping(e) {
		return new rt(tr(this.done, e), tr(this.undone, e), this.prevTime, this.prevUserEvent);
	}
	pop(e, t, i) {
		...
		if (i && r.selectionsAfter.length)
			return t.update({
				...
				annotations: Jr.of({ side: e, rest: o0(s), selection: o }),
		...
		if (r.changes) {
			...
			return (
				r.mapped && (l = tr(l, r.mapped)),
				t.update({
					changes: r.changes,
					selection: r.startSelection,
					effects: r.effects,
					annotations: Jr.of({ side: e, rest: l, selection: o }),
					filter: !1,
...
rt.empty = new rt(Fe, Fe);
const h0 = [
	{ key: 'Mod-z', run: Yc, preventDefault: !0 },
	...
	{ key: 'Alt-u', mac: 'Mod-Shift-u', run: i0, preventDefault: !0 }
];
function xi(n, e) {
...
function Zc(n, e) {
	return Ge(n, (t) => (t.empty ? n.moveByChar(t, e) : As(t, e)));
}
function ve(n) {
	return n.textDirectionAt(n.state.selection.main.head) == te.LTR;
}
const ef = (n) => Zc(n, !ve(n)),
	tf = (n) => Zc(n, ve(n));
function nf(n, e) {
	return Ge(n, (t) => (t.empty ? n.moveByGroup(t, e) : As(t, e)));
}
const c0 = (n) => nf(n, !ve(n)),
	f0 = (n) => nf(n, ve(n));
function u0(n, e, t) {
...
const d0 = (n) => Ge(n, (e) => Ms(n.state, e, !ve(n))),
	p0 = (n) => Ge(n, (e) => Ms(n.state, e, ve(n)));
function sf(n, e) {
	return Ge(n, (t) => {
		if (!t.empty) return As(t, e);
...
function af(n, e) {
	let t = lf(n),
		{ state: i } = n,
		s = xi(i.selection, (o) => (o.empty ? n.moveVertically(o, e, t.height) : As(o, e)));
	...
	if (t.selfScroll) {
		...
		o &&
			o.top > a &&
			o.bottom < h &&
			(r = O.scrollIntoView(s.main.head, { y: 'start', yMargin: o.top - a }));
	}
...
const m0 = (n) => Ge(n, (e) => Lt(n, e, !0)),
	g0 = (n) => Ge(n, (e) => Lt(n, e, !1)),
	y0 = (n) => Ge(n, (e) => Lt(n, e, !ve(n))),
	b0 = (n) => Ge(n, (e) => Lt(n, e, ve(n))),
	x0 = (n) => Ge(n, (e) => v.cursor(n.lineBlockAt(e.head).from, 1)),
	w0 = (n) => Ge(n, (e) => v.cursor(n.lineBlockAt(e.head).to, -1));
function v0(n, e, t) {
	let i = !1,
		s = xi(n.selection, (r) => {
			let o =
...
const k0 = ({ state: n, dispatch: e }) => v0(n, e);
function ze(n, e) {
	let t = xi(n.state.selection, (i) => {
		let s = e(i);
		return v.range(i.anchor, s.head, s.goalColumn, s.bidiLevel || void 0, s.assoc);
	});
	return t.eq(n.state.selection) ? !1 : (n.dispatch(Ue(n.state, t)), !0);
}
function hf(n, e) {
	return ze(n, (t) => n.moveByChar(t, e));
}
const cf = (n) => hf(n, !ve(n)),
	ff = (n) => hf(n, ve(n));
function uf(n, e) {
	return ze(n, (t) => n.moveByGroup(t, e));
}
const S0 = (n) => uf(n, !ve(n)),
	C0 = (n) => uf(n, ve(n)),
	A0 = (n) => ze(n, (e) => Ms(n.state, e, !ve(n))),
	M0 = (n) => ze(n, (e) => Ms(n.state, e, ve(n)));
function df(n, e) {
...
const pf = (n) => df(n, !1),
	mf = (n) => df(n, !0);
function gf(n, e) {
	return ze(n, (t) => n.moveVertically(t, e, lf(n).height));
}
const wa = (n) => gf(n, !1),
	va = (n) => gf(n, !0),
	T0 = (n) => ze(n, (e) => Lt(n, e, !0)),
	D0 = (n) => ze(n, (e) => Lt(n, e, !1)),
	E0 = (n) => ze(n, (e) => Lt(n, e, !ve(n))),
	O0 = (n) => ze(n, (e) => Lt(n, e, ve(n))),
	_0 = (n) => ze(n, (e) => v.cursor(n.lineBlockAt(e.head).from)),
	L0 = (n) => ze(n, (e) => v.cursor(n.lineBlockAt(e.head).to)),
	ka = ({ state: n, dispatch: e }) => (e(Ue(n, { anchor: 0 })), !0),
	Sa = ({ state: n, dispatch: e }) => (e(Ue(n, { anchor: n.doc.length })), !0),
	...
	R0 = ({ state: n, dispatch: e }) => {
		let t = Ts(n).map(({ from: i, to: s }) => v.range(i, Math.min(s + 1, n.doc.length)));
		return (e(n.update({ selection: v.create(t), userEvent: 'select' })), !0);
	},
...
function yf(n, e) {
	...
	return s.length == i.ranges.length ? !1 : (n.dispatch(Ue(t, v.create(s, s.length - 1))), !0);
}
const B0 = (n) => yf(n, !1),
	N0 = (n) => yf(n, !0),
	V0 = ({ state: n, dispatch: e }) => {
		...
		return (
			t.ranges.length > 1
				? (i = v.create([t.main]))
				: t.main.empty || (i = v.create([v.cursor(t.main.head)])),
			i ? (e(Ue(n, i)), !0) : !1
		);
	};
function cn(n, e) {
	...
	let t = 'delete.selection',
		...
		s = i.changeByRange((r) => {
			...
			if (o == l) {
				let a = e(r);
				(a < o
					? ((t = 'delete.backward'), (a = Ln(n, a, !1)))
					: a > o && ((t = 'delete.forward'), (a = Ln(n, a, !0))),
					(o = Math.min(o, a)),
					(l = Math.max(l, a)));
			} else ((o = Ln(n, o, !1)), (l = Ln(n, l, !0)));
			return o == l
				? { range: r }
				: { changes: { from: o, to: l }, range: v.cursor(o, o < r.head ? -1 : 1) };
		});
...
const bf = (n, e, t) =>
	...
	wf = (n, e) =>
		cn(n, (t) => {
			...
			for (let l = null; ; ) {
				...
				let a = ue(r.text, i - r.from, e) + r.from,
	...
	j0 = ({ state: n, dispatch: e }) => {
		...
		let t = n.changeByRange((i) => {
			...
			let s = i.from,
				r = n.doc.lineAt(s),
				o = s == r.from ? s - 1 : ue(r.text, s - r.from, !1) + r.from,
				l = s == r.to ? s + 1 : ue(r.text, s - r.from, !0) + r.from;
			return {
	...
	for (let r of Ts(n)) {
		...
		if (t) {
			...
			for (let a of r.ranges)
				s.push(v.range(Math.min(n.doc.length, a.anchor + l), Math.min(n.doc.length, a.head + l)));
		} else {
...
const $0 = ({ state: n, dispatch: e }) => kf(n, e, !1),
	K0 = ({ state: n, dispatch: e }) => kf(n, e, !0);
function Sf(n, e, t) {
	if (n.readOnly) return !1;
	let i = [];
	for (let r of Ts(n))
...
const U0 = ({ state: n, dispatch: e }) => Sf(n, e, !1),
	G0 = ({ state: n, dispatch: e }) => Sf(n, e, !0),
	J0 = (n) => {
		if (n.state.readOnly) return !1;
		let { state: e } = n,
			t = e.changes(
...
function Cf(n) {
	return ({ state: e, dispatch: t }) => {
		...
		let i = e.changeByRange((s) => {
			...
			let h = new vs(e, { simulateBreak: r, simulateDoubleBreak: !!a }),
				c = Ao(h, r);
			for (
				c == null && (c = bi(/^\s*/.exec(e.doc.lineAt(r).text)[0], e.tabSize));
			...
			let f = ['', Gi(e, c)];
			return (
				a && f.push(Gi(e, h.lineIndent(l.from, -1))),
				{ changes: { from: r, to: o, insert: j.of(f) }, range: v.cursor(r + 1 + f[1].length) }
			);
		});
...
function Lo(n, e) {
	...
	return n.changeByRange((i) => {
		...
		let r = n.changes(s);
		return { changes: s, range: v.range(r.mapPos(i.anchor, 1), r.mapPos(i.head, 1)) };
	});
}
const Q0 = ({ state: n, dispatch: e }) => {
	...
	Af = ({ state: n, dispatch: e }) =>
		n.readOnly
			...
			: (e(
					n.update(
						Lo(n, (t, i) => {
							i.push({ from: t.from, insert: n.facet(ln) });
						}),
			...
			: (e(
					n.update(
						Lo(n, (t, i) => {
							...
							if (!s) return;
							let r = bi(s, n.tabSize),
								o = 0,
								l = Gi(n, Math.max(0, r - Ut(n)));
				...
				!0),
	Z0 = (n) => (n.setTabFocusMode(), !0),
	ey = [
		{ key: 'Ctrl-b', run: ef, shift: cf, preventDefault: !0 },
		{ key: 'Ctrl-f', run: tf, shift: ff },
		{ key: 'Ctrl-p', run: rf, shift: pf },
		{ key: 'Ctrl-n', run: of, shift: mf },
		{ key: 'Ctrl-a', run: x0, shift: _0 },
		{ key: 'Ctrl-e', run: w0, shift: L0 },
		{ key: 'Ctrl-d', run: xf },
		{ key: 'Ctrl-h', run: Qr },
		{ key: 'Ctrl-k', run: F0 },
	...
	ty = [
		{ key: 'ArrowLeft', run: ef, shift: cf, preventDefault: !0 },
		{ key: 'Mod-ArrowLeft', mac: 'Alt-ArrowLeft', run: c0, shift: S0, preventDefault: !0 },
		{ mac: 'Cmd-ArrowLeft', run: y0, shift: E0, preventDefault: !0 },
		{ key: 'ArrowRight', run: tf, shift: ff, preventDefault: !0 },
		{ key: 'Mod-ArrowRight', mac: 'Alt-ArrowRight', run: f0, shift: C0, preventDefault: !0 },
		{ mac: 'Cmd-ArrowRight', run: b0, shift: O0, preventDefault: !0 },
		{ key: 'ArrowUp', run: rf, shift: pf, preventDefault: !0 },
		{ mac: 'Cmd-ArrowUp', run: ka, shift: Ca },
		{ mac: 'Ctrl-ArrowUp', run: xa, shift: wa },
		{ key: 'ArrowDown', run: of, shift: mf, preventDefault: !0 },
		{ mac: 'Cmd-ArrowDown', run: Sa, shift: Aa },
		{ mac: 'Ctrl-ArrowDown', run: Xr, shift: va },
		{ key: 'PageUp', run: xa, shift: wa },
		{ key: 'PageDown', run: Xr, shift: va },
		{ key: 'Home', run: g0, shift: D0, preventDefault: !0 },
		{ key: 'Mod-Home', run: ka, shift: Ca },
		{ key: 'End', run: m0, shift: T0, preventDefault: !0 },
		{ key: 'Mod-End', run: Sa, shift: Aa },
		{ key: 'Enter', run: Ma, shift: Ma },
		{ key: 'Mod-a', run: P0 },
		{ key: 'Backspace', run: Qr, shift: Qr, preventDefault: !0 },
		{ key: 'Delete', run: xf, preventDefault: !0 },
		{ key: 'Mod-Backspace', mac: 'Alt-Backspace', run: vf, preventDefault: !0 },
		{ key: 'Mod-Delete', mac: 'Alt-Delete', run: W0, preventDefault: !0 },
		{ mac: 'Mod-Backspace', run: H0, preventDefault: !0 },
		{ mac: 'Mod-Delete', run: z0, preventDefault: !0 }
	].concat(ey.map((n) => ({ mac: n.key, run: n.run, shift: n.shift }))),
	iy = [
		{ key: 'Alt-ArrowLeft', mac: 'Ctrl-ArrowLeft', run: d0, shift: A0 },
		{ key: 'Alt-ArrowRight', mac: 'Ctrl-ArrowRight', run: p0, shift: M0 },
		{ key: 'Alt-ArrowUp', run: $0 },
		{ key: 'Shift-Alt-ArrowUp', run: U0 },
		{ key: 'Alt-ArrowDown', run: K0 },
		{ key: 'Shift-Alt-ArrowDown', run: G0 },
		{ key: 'Mod-Alt-ArrowUp', run: B0 },
		{ key: 'Mod-Alt-ArrowDown', run: N0 },
		{ key: 'Escape', run: V0 },
		{ key: 'Mod-Enter', run: X0 },
		{ key: 'Alt-l', mac: 'Ctrl-l', run: R0 },
		{ key: 'Mod-i', run: I0, preventDefault: !0 },
		{ key: 'Mod-[', run: Mf },
		{ key: 'Mod-]', run: Af },
		{ key: 'Mod-Alt-\\', run: Q0 },
		{ key: 'Shift-Mod-k', run: J0 },
		{ key: 'Shift-Mod-\\', run: k0 },
		{ key: 'Mod-/', run: $g },
		{ key: 'Alt-A', run: Ug },
		{ key: 'Ctrl-m', mac: 'Shift-Alt-m', run: Z0 }
	].concat(ty),
	ny = { key: 'Tab', run: Af, shift: Mf },
	Ta = typeof String.prototype.normalize == 'function' ? (n) => n.normalize('NFKD') : (n) => n;
class yi {
...
const Tf = { from: -1, to: -1, match: /.*/.exec('') },
...
class Df {
	constructor(e, t, i, s = 0, r = e.length) {
		if (
			...
			return new Ef(e, t, i, s, r);
		((this.re = new RegExp(t, Po + (i != null && i.ignoreCase ? 'i' : ''))),
		...
		for (let e = this.matchPos - this.curLineStart; ; ) {
			...
			if (t) {
				let i = this.curLineStart + t.index,
					s = i + t[0].length;
				if (
					((this.matchPos = ls(this.text, s + (i == s ? 1 : 0))),
...
class li {
	...
	static get(e, t, i) {
		...
		if (!s || s.from >= i || s.to <= t) {
			let l = new li(t, e.sliceString(t, i));
			return (ir.set(e, l), l);
		}
...
class Ef {
	constructor(e, t, i, s, r) {
		((this.text = e),
			...
			(this.done = !1),
			(this.value = Tf),
			(this.matchPos = ls(e, s)),
			(this.re = new RegExp(t, Po + (i != null && i.ignoreCase ? 'i' : ''))),
			(this.test = i == null ? void 0 : i.test),
			(this.flat = li.get(e, s, this.chunkEnd(s + 5e3))));
	}
	chunkEnd(e) {
...
typeof Symbol < 'u' &&
	(Df.prototype[Symbol.iterator] = Ef.prototype[Symbol.iterator] =
		function () {
			return this;
		});
function sy(n) {
		...
		return (
			s.then((r) => {
				...
				let p = e.doc.line(Math.max(1, Math.min(e.doc.lines, d))),
					m = v.cursor(p.from + Math.max(0, Math.min(u, p.length)));
				n.dispatch({ effects: [i, O.scrollIntoView(m.from, { y: 'center' })], selection: m });
			}),
			!0
		);
	},
	oy = { highlightWordAroundCursor: !1, minSelectionLength: 1, maxMatches: 100, wholeWords: !1 },
	ly = _.define({
		combine(n) {
			return lt(n, oy, {
...
const hy = P.mark({ class: 'cm-selectionMatch' }),
	cy = P.mark({ class: 'cm-selectionMatch cm-selectionMatch-main' });
function Da(n, e, t, i) {
	return (
		(t == 0 || n(e.sliceDoc(t - 1, t)) != se.Word) &&
		(i == e.doc.length || n(e.sliceDoc(i, i + 1)) != se.Word)
	);
}
function fy(n, e, t, i) {
	return n(e.sliceDoc(t, t + 1)) == se.Word && n(e.sliceDoc(i - 1, i)) == se.Word;
}
const uy = oe.fromClass(
		class {
			constructor(n) {
				this.decorations = this.getDeco(n);
			}
			...
			getDeco(n) {
				...
				if (s.empty) {
					...
					if (e.wholeWords) {
						if (
							...
							!(Da(o, t, s.from, s.to) && fy(o, t, s.from, s.to)))
						)
							return P.none;
				...
				for (let a of n.visibleRanges) {
					let h = new yi(t.doc, r, a.from, a.to);
					for (; !h.next().done; ) {
						...
						if (
							...
							(s.empty && c <= s.from && f >= s.to
								? l.push(cy.range(c, f))
								: (c >= s.to || f <= s.from) && l.push(hy.range(c, f)),
	...
	py = ({ state: n, dispatch: e }) => {
		let { selection: t } = n,
			i = v.create(
				t.ranges.map((s) => n.wordAt(s.head) || v.cursor(s.head)),
				t.mainIndex
			);
...
function my(n, e) {
	...
	for (let o = !1, l = new yi(n.doc, e, i[i.length - 1].to); ; )
		if ((l.next(), l.done)) {
			if (o) return null;
			((l = new yi(n.doc, e, 0, Math.max(0, i[i.length - 1].from - 1))), (o = !0));
		} else {
...
const gy = ({ state: n, dispatch: e }) => {
		let { ranges: t } = n.selection;
		if (t.some((r) => r.from === r.to)) return py({ state: n, dispatch: e });
		...
		return s
			? (e(
					n.update({
						selection: n.selection.addRange(v.range(s.from, s.to), !1),
...
class Of {
	constructor(e) {
		((this.search = e.search),
			...
			(this.valid = !!this.search && (!this.regexp || sy(this.search))),
...
`
	...
	create() {
		return this.regexp ? new ky(this) : new xy(this);
	}
	getCursor(e, t = 0, i) {
		let s = e.doc ? e : $.create({ doc: e });
		return (i == null && (i = s.doc.length), this.regexp ? Qt(this, s, t, i) : Xt(this, s, t, i));
	}
}
class _f {
	constructor(e) {
...
function Xt(n, e, t, i) {
	let s;
	return (
		n.wholeWord && (s = by(e.doc, e.charCategorizer(e.selection.main.head))),
		n.test && (s = yy(n.test, e, s)),
		new yi(e.doc, n.unquoted, t, i, n.caseSensitive ? void 0 : (r) => r.toLowerCase(), s)
	);
}
function by(n, e) {
	return (t, i, s, r) => (
		...
		(e(as(s, t - r)) != se.Word || e(hs(s, t - r)) != se.Word) &&
			(e(hs(s, i - r)) != se.Word || e(as(s, i - r)) != se.Word)
	);
}
class xy extends _f {
	constructor(e) {
	...
	nextMatch(e, t, i) {
		let s = Xt(this.spec, e, i, e.doc.length).nextOverlapping();
		if (s.done) {
			let r = Math.min(e.doc.length, t + this.spec.unquoted.length);
			s = Xt(this.spec, e, 0, r).nextOverlapping();
		}
	...
	matchAll(e, t) {
		let i = Xt(this.spec, e, 0, e.doc.length),
			s = [];
		for (; !i.next().done; ) {
...
function Qt(n, e, t, i) {
	let s;
	return (
		n.wholeWord && (s = vy(e.charCategorizer(e.selection.main.head))),
		n.test && (s = wy(n.test, e, s)),
		new Df(e.doc, n.search, { ignoreCase: !n.caseSensitive, test: s }, t, i)
	);
}
function as(n, e) {
...
function vy(n) {
	return (e, t, i) =>
		!i[0].length ||
		((n(as(i.input, i.index)) != se.Word || n(hs(i.input, i.index)) != se.Word) &&
			(n(hs(i.input, i.index + i[0].length)) != se.Word ||
				n(as(i.input, i.index + i[0].length)) != se.Word));
}
class ky extends _f {
	nextMatch(e, t, i) {
		let s = Qt(this.spec, e, i, e.doc.length).next();
		return (s.done && (s = Qt(this.spec, e, 0, t).next()), s.done ? null : s.value);
	}
	prevMatchInRange(e, t, i) {
		for (let s = 1; ; s++) {
			let r = Math.max(t, i - s * 1e4),
				o = Qt(this.spec, e, r, i),
				l = null;
	...
	matchAll(e, t) {
		let i = Qt(this.spec, e, 0, e.doc.length),
			s = [];
		for (; !i.next().done; ) {
			if (s.length >= t) return null;
			s.push(i.value);
	...
	highlight(e, t, i, s) {
		let r = Qt(this.spec, e, Math.max(0, t - 250), Math.min(i + 250, e.doc.length));
		for (; !r.next().done; ) s(r.value.from, r.value.to);
	}
}
const Yi = I.define(),
	...
	St = be.define({
		create(n) {
			return new nr(Zr(n).create(), null);
		},
		update(n, e) {
			for (let t of e.effects)
				t.is(Yi)
					? (n = new nr(t.value.create(), n.panel))
					: t.is(Ro) && (n = new nr(n.query, t.value ? Io : null));
			return n;
		},
...
const Sy = P.mark({ class: 'cm-searchMatch' }),
	Cy = P.mark({ class: 'cm-searchMatch cm-searchMatch-selected' }),
	Ay = oe.fromClass(
		class {
			constructor(n) {
			...
			update(n) {
				...
				(e != n.startState.field(St) || n.docChanged || n.selectionSet || n.viewportChanged) &&
...
function fn(n) {
	return (e) => {
		...
		return t && t.query.spec.valid ? n(e, t) : Rf(e);
	};
}
const cs = fn((n, { query: e }) => {
		let { to: t } = n.state.selection.main,
			i = e.nextMatch(n.state, t, t);
		if (!i) return !1;
		let s = v.single(i.from, i.to),
			r = n.state.facet(wi);
		return (
			n.dispatch({
				selection: s,
	...
	Ty = ({ state: n, dispatch: e }) => {
		...
		let { from: i, to: s } = t.main,
			r = [],
			o = 0;
		for (let l = new yi(n.doc, n.sliceDoc(i, s)); !l.next().done; ) {
			if (r.length > 1e3) return !1;
			(l.value.from == i && (o = r.length), r.push(v.range(l.value.from, l.value.to)));
		}
		return (e(n.update({ selection: v.create(r, o), userEvent: 'select.search.matches' })), !0);
	},
	Ea = fn((n, { query: e }) => {
		let { state: t } = n,
		...
		o.from == i &&
			...
			c.push(O.announce.of(t.phrase('replaced match on line $', t.doc.lineAt(i).number) + '.')));
		let f = n.state.changes(l);
		return (
			o &&
				((a = v.single(o.from, o.to).map(f)),
				c.push(Bo(n, o)),
				c.push(t.facet(wi).scrollToMatch(a.main, n))),
	...
	Dy = fn((n, { query: e }) => {
		...
		return (
			n.dispatch({ changes: t, effects: O.announce.of(i), userEvent: 'input.replace.all' }),
			!0
		);
	});
function Io(n) {
...
const Rf = (n) => {
		...
		if (e && e.panel) {
			...
			if (t && t != n.root.activeElement) {
				let i = Zr(n.state, e.query.spec);
				(i.valid && n.dispatch({ effects: Yi.of(i) }), t.focus(), t.select());
			}
		} else
			n.dispatch({
				effects: [Ro.of(!0), e ? Yi.of(Zr(n.state, e.query.spec)) : I.appendConfig.of(Ly)]
			});
		return !0;
	},
	If = (n) => {
		...
		return (
			...
			n.dispatch({ effects: Ro.of(!1) }),
			!0
		);
	},
	Ey = [
		{ key: 'Mod-f', run: Rf, scope: 'editor search-panel' },
		...
		{ key: 'Mod-Shift-l', run: Ty },
		{ key: 'Mod-Alt-g', run: ry },
		{ key: 'Mod-d', run: gy, preventDefault: !0 }
	];
class Oy {
	constructor(e) {
		this.view = e;
		...
		function i(s, r, o) {
			return X('button', { class: 'cm-button', name: s, onclick: r, type: 'button' }, o);
		}
		this.dom = X('div', { onkeydown: (s) => this.keydown(s), class: 'cm-search' }, [
			this.searchField,
			i('next', () => cs(e), [Pe(e, 'next')]),
			i('prev', () => fs(e), [Pe(e, 'previous')]),
			i('select', () => My(e), [Pe(e, 'all')]),
			X('label', null, [this.caseField, Pe(e, 'match case')]),
			X('label', null, [this.reField, Pe(e, 'regexp')]),
			X('label', null, [this.wordField, Pe(e, 'by word')]),
			...(e.state.readOnly
				? []
				: [
						X('br'),
						this.replaceField,
						i('replace', () => Ea(e), [Pe(e, 'replace')]),
						i('replaceAll', () => Dy(e), [Pe(e, 'replace all')])
					]),
			X(
				'button',
				{ name: 'close', onclick: () => If(e), 'aria-label': Pe(e, 'close'), type: 'button' },
				['×']
			)
		]);
	}
	...
	keydown(e) {
		Np(this.view, e, 'search-panel')
			? e.preventDefault()
			: e.keyCode == 13 && e.target == this.searchField
				? (e.preventDefault(), (e.shiftKey ? fs : cs)(this.view))
				: e.keyCode == 13 && e.target == this.replaceField && (e.preventDefault(), Ea(this.view));
	}
	update(e) {
		for (let t of e.transactions)
			for (let i of t.effects) i.is(Yi) && !i.value.eq(this.query) && this.setQuery(i.value);
	}
	setQuery(e) {
		((this.query = e),
...
function Ry(n) {
	let e = n.map((s) => (typeof s == 'string' ? { label: s } : s)),
		[t, i] = e.every((s) => /^\w+$/.test(s.label)) ? [/\w*$/, /\w+$/] : Py(e);
	return (s) => {
...
function Ax(n, e) {
	return (t) => {
		for (let i = ye(t.state).resolveInner(t.pos, -1); i; i = i.parent) {
...
class Ny {
	constructor(e) {
		...
		for (let t = 0; t < e.length; ) {
			...
			let r = e.slice(t, t + s),
				o = r.toUpperCase();
			(this.folded.push(Me(o == r ? r.toLowerCase() : o, 0)), (t += s));
		}
	...
	match(e) {
		...
		let a = t.length,
			h = 0;
		if (l < 0) {
			for (let S = 0, C = Math.min(e.length, 200); S < C && h < a; ) {
				let L = Me(e, S);
				((L == t[h] || L == i[h]) && (s[h++] = S), (S += et(L)));
			}
			if (h < a) return null;
		}
		let c = 0,
			...
			g = /[a-z]/.test(e),
			y = !0;
		for (let S = 0, C = Math.min(e.length, 200), L = 0; S < C && f < a; ) {
			let A = Me(e, S);
			l < 0 &&
				(c < a && A == t[c] && (r[c++] = S),
				d < a && (A == t[d] || A == i[d] ? (d == 0 && (p = S), (m = S + 1), d++) : (d = 0)));
			let M,
				T =
					A < 255
						? (A >= 48 && A <= 57) || (A >= 97 && A <= 122)
							...
							: A >= 65 && A <= 90
								? 1
								: 0
						: (M = ro(A)) != M.toLowerCase()
							? 1
							: M != M.toUpperCase()
								? 2
								: 0;
			((!S || (T == 1 && g) || (L == 0 && T != 0)) &&
				(t[f] == A || (i[f] == A && (u = !0)) ? (o[f++] = S) : o.length && (y = !1)),
				(L = T),
				(S += et(A)));
		}
		return f == a && o[0] == 0 && y
	...
	result(e, t, i) {
		let s = [],
			r = 0;
		for (let o of t) {
			let l = o + (this.astral ? et(Me(i, o)) : 1);
	...
	combine(n) {
		return lt(
			...
			},
			{
				...
				closeOnBlur: (e, t) => e && t,
				icons: (e, t) => e && t,
				tooltipClass: (e, t) => (i) => Pa(e(i), t(i)),
				optionClass: (e, t) => (i) => Pa(e(i), t(i)),
...
class Hy {
	constructor(e, t, i) {
		...
		let s = e.state.field(t),
			...
			l = e.state.facet(fe);
		((this.optionContent = Fy(l)),
			(this.optionClass = l.optionClass),
			(this.tooltipClass = l.tooltipClass),
			(this.range = sr(r.length, o, l.maxRenderedOptions)),
			(this.dom = document.createElement('div')),
					...
					let c =
						...
						a.clientY < this.list.firstChild.getBoundingClientRect().top
							...
							: this.list.classList.contains('cm-completionListIncompleteBottom') &&
								...
								? this.range.to
								: null;
					c != null && (e.dispatch({ effects: Vo.of(c) }), a.preventDefault());
				}
			}),
	...
	update(e) {
		...
		if ((this.updateTooltipClass(e.state), i != s)) {
			...
			((!s.open || s.open.options != r) &&
				((this.range = sr(r.length, o, e.state.facet(fe).maxRenderedOptions)),
		...
		if (i) {
			...
			'then' in o
				? o
						...
						.catch((l) => Ee(this.view.state, l, 'completion info'))
	...
	measureInfo() {
		...
		return s.top > Math.min(r.bottom, t.bottom) - 10 || s.bottom < Math.max(r.top, t.top) + 10
			? null
			: this.view.state.facet(fe).positionInfo(this.view, t, s, i, r, this.dom);
	}
	placeInfo(e) {
		this.info &&
			(e
...
function jy(n, e) {
	...
	if (i) {
		let c = Object.create(null),
			f = 0,
			u = (d, p) =>
				(d.rank === 'dynamic' && p.rank === 'dynamic' ? s[p.name] - s[d.name] : 0) ||
				(typeof d.rank == 'number' ? d.rank : 1e9) - (typeof p.rank == 'number' ? p.rank : 1e9) ||
				(d.name < p.name ? -1 : 1);
	...
	for (let c of t.sort((f, u) => u.score - f.score || h(f.completion, u.completion))) {
		...
		a.boost != f.boost
			? l.push(c)
			: Ra(c.completion) > Ra(a) && (l[l.length - 1] = c),
			(a = c.completion));
	}
	return l;
}
class ti {
	...
	setSelected(e, t) {
		return e == this.selected || e >= this.options.length
			? this
			: new ti(this.options, Ia(t, e), this.tooltip, this.timestamp, e, this.disabled);
	}
	static build(e, t, i, s, r, o) {
		...
		let a = t.facet(fe).selectOnOpen ? 0 : -1;
...
class ds {
	...
	static start() {
		return new ds(Gy, 'cm-ac-' + Math.floor(Math.random() * 2e6).toString(36), null);
	}
	update(e) {
		let { state: t } = e,
			i = t.facet(fe),
			r = (i.override || t.languageDataAt('autocomplete', qt(t)).map(By)).map((a) =>
				(
					this.active.find((c) => c.source == a) ||
					new He(a, this.active.some((c) => c.state != 0) ? 1 : 0)
				).update(e, i)
			);
		r.length == this.active.length && r.every((a, h) => a == this.active[h]) && (r = this.active);
		let o = this.open,
			l = e.effects.some((a) => a.is(Wo));
		(o && e.docChanged && (o = o.map(e.changes)),
			e.selection ||
			r.some((a) => a.hasResult() && e.changes.touchesRange(a.from, a.to)) ||
			!$y(r, this.active) ||
			l
				? (o = ti.build(r, t, this.id, o, i, l))
				: o && o.disabled && !r.some((a) => a.isPending) && (o = null),
			!o &&
				r.every((a) => !a.isPending) &&
				r.some((a) => a.hasResult()) &&
				(r = r.map((a) => (a.hasResult() ? new He(a.source, 0) : a))));
		for (let a of e.effects) a.is(Vo) && (o = o && o.setSelected(a.value, this.id));
	...
	get attrs() {
		return this.open ? this.open.attrs : this.active.length ? Ky : Uy;
	}
}
function $y(n, e) {
	if (n == e) return !0;
...
const Ky = { 'aria-autocomplete': 'list' },
	Uy = {};
function Ia(n, e) {
...
class He {
	...
	update(e, t) {
		let i = Vf(e, t),
			s = this;
		((i & 8 || (i & 16 && this.touches(e))) && (s = new He(s.source, 0)),
			i & 4 && s.state == 0 && (s = new He(this.source, 1)),
			(s = s.updateFor(e, i)));
		for (let r of e.effects)
			if (r.is(us)) s = new He(s.source, 1, r.value);
			else if (r.is(Xi)) s = new He(s.source, 0);
			else if (r.is(Wo)) for (let o of r.value) o.source == s.source && (s = o);
		return s;
	}
	updateFor(e, t) {
	...
	touches(e) {
		return e.changes.touchesRange(qt(e.state));
	}
}
class ai extends He {
	constructor(e, t, i, s, r, o) {
	...
	updateFor(e, t) {
		...
		let r = e.changes.mapPos(this.from),
			...
			l = qt(e.state);
		if (l > o || !s || (t & 2 && (qt(e.startState) == this.from || l < this.limit)))
			return new He(this.source, t & 4 ? 1 : 0);
		let a = e.changes.mapPos(this.limit);
		return Jy(s.validFor, e.state, r, o)
			? new ai(this.source, this.explicit, a, s, r, o)
			: s.update && (s = s.update(s, r, o, new Bf(e.state, l, !1)))
				? new ai(
						this.source,
						this.explicit,
						a,
						s,
						s.from,
						(i = s.to) !== null && i !== void 0 ? i : qt(e.state)
					)
				: new He(this.source, 1, this.explicit);
	}
	map(e) {
		return e.empty
			? this
...
const Wo = I.define({
	...
	Te = be.define({
		...
		provide: (n) => [So.from(n, (e) => e.tooltip), O.contentAttributes.from(n, (e) => e.attrs)]
	});
function Fo(n, e) {
	const t = e.completion.apply || e.completion.label;
	let i = n.state.field(Te).active.find((s) => s.source == e.source);
	return i instanceof ai
		? (typeof t == 'string'
				? n.dispatch({ ...Iy(n.state, t, i.from, i.to), annotations: No.of(e.completion) })
...
const Wf = (n) => {
		...
		return n.state.readOnly ||
			...
			? !1
			: Fo(n, e.open.options[e.open.selected]);
	},
	rr = (n) => (n.state.field(Te, !1) ? (n.dispatch({ effects: us.of(!0) }), !0) : !1),
	Xy = (n) => {
		let e = n.state.field(Te, !1);
		return !e || !e.active.some((t) => t.state != 0)
			? !1
			: (n.dispatch({ effects: Xi.of(null) }), !0);
	};
class Qy {
	constructor(e, t) {
		((this.active = e),
		...
		class {
			constructor(n) {
				((this.view = n),
					...
					(this.pendingStart = !1),
					(this.composing = 0));
				for (let e of n.state.field(Te).active) e.isPending && this.startQuery(e);
			}
			update(n) {
				let e = n.state.field(Te),
					t = n.state.facet(fe);
				if (!n.selectionSet && !n.docChanged && n.startState.field(Te) == e) return;
				...
				for (let r = 0; r < this.running.length; r++) {
					...
					if (
						...
						(o.updates.length + n.transactions.length > Zy && Date.now() - o.time > eb)
					) {
						for (let l of o.context.abortListeners)
							try {
								l();
							} catch (a) {
								Ee(this.view.state, a);
							}
				...
				(this.debounceUpdate > -1 && clearTimeout(this.debounceUpdate),
					n.transactions.some((r) => r.effects.some((o) => o.is(us))) && (this.pendingStart = !0));
			...
			startQuery(n) {
				let { state: e } = this.view,
					t = qt(e),
					i = new Bf(e, t, n.explicit, this.view),
					s = new Qy(n, i);
				(this.running.push(s),
					Promise.resolve(n.source(i)).then(
						...
						(r) => {
							(this.view.dispatch({ effects: Xi.of(null) }), Ee(this.view.state, r));
						}
					));
			}
			scheduleAccept() {
			...
			accept() {
				...
				let e = [],
					...
					i = this.view.state.field(Te);
				for (let s = 0; s < this.running.length; s++) {
					let r = this.running[s];
					if (r.done === void 0) continue;
					if ((this.running.splice(s--, 1), r.done)) {
						let l = qt(r.updates.length ? r.updates[0].startState : this.view.state),
					...
					if (o && o.isPending)
						if (r.done == null) {
							let l = new He(r.active.source, 0);
							for (let a of r.updates) l = l.update(a, t);
							l.isPending || e.push(l);
						} else this.startQuery(o);
				}
				(e.length || (i.open && i.open.disabled)) && this.view.dispatch({ effects: Wo.of(e) });
			}
		},
		{
			eventHandlers: {
				blur(n) {
					let e = this.view.state.field(Te, !1);
					if (e && e.tooltip && this.view.state.facet(fe).closeOnBlur) {
						let t = e.open && gc(this.view, e.open.tooltip);
						(!t || !t.dom.contains(n.relatedTarget)) &&
							setTimeout(() => this.view.dispatch({ effects: Xi.of(null) }), 10);
					}
				},
				compositionstart() {
					this.composing = 1;
				...
				compositionend() {
					(this.composing == 3 && setTimeout(() => this.view.dispatch({ effects: us.of(!1) }), 20),
						(this.composing = 0));
				}
			}
		}
	),
	ib = typeof navigator == 'object' && /Win/.test(navigator.platform),
	nb = _t.highest(
		O.domEventHandlers({
			keydown(n, e) {
				let t = e.state.field(Te, !1);
				if (
					!t ||
					!t.open ||
					t.open.disabled ||
				...
				return (r && r.indexOf(n.key) > -1 && Fo(e, i), !1);
			}
		})
	),
	Ff = O.baseTheme({
...
class Ho {
	...
	map(e) {
		let t = e.mapPos(this.from, -1, me.TrackDel),
			i = e.mapPos(this.to, 1, me.TrackDel);
	...
	instantiate(e, t) {
		...
		for (let a of this.lines) {
			if (i.length) {
				let h = o,
					c = /^\t*/.exec(a)[0].length;
				for (let f = 0; f < c; f++) h += e.facet(ln);
	...
	static parse(e) {
		...
		for (let o of e.split(/\r\n?|\n/)) {
			for (; (r = /[#$]\{(?:(\d+)(?::([^{}]*))?|((?:\\[{}]|[^{}])*))\}/.exec(o)); ) {
				...
				(s.push(new sb(h, i.length, r.index, r.index + c.length)),
...
let rb = P.widget({
	...
	ob = P.mark({ class: 'cm-snippetField' });
class vi {
	constructor(e, t) {
		((this.ranges = e),
			(this.active = t),
			(this.deco = P.set(
				e.map((i) => (i.from == i.to ? rb : ob).range(i.from, i.to)),
				!0
			)));
	}
	map(e) {
...
const un = I.define({
	...
	Qi = be.define({
		...
		update(n, e) {
			for (let t of e.effects) {
				if (t.is(un)) return t.value;
				if (t.is(lb) && n) return new vi(n.ranges, t.value);
			}
			return (
		...
		provide: (n) => O.decorations.from(n, (e) => (e ? e.deco : P.none))
	});
function qo(n, e) {
	return v.create(n.filter((t) => t.field == e).map((t) => v.range(t.from, t.to)));
}
function ab(n) {
	let e = zo.parse(n);
	return (t, i, s, r) => {
		let { text: o, ranges: l } = e.instantiate(t.state, s),
			...
			h = {
				...
				scrollIntoView: !0,
				annotations: i ? [No.of(i), he.userEvent.of('input.complete')] : void 0
			};
		if ((l.length && (h.selection = qo(l, 0)), l.some((c) => c.field > 0))) {
			let c = new vi(l, 0),
				f = (h.effects = [un.of(c)]);
			t.state.field(Qi, !1) === void 0 && f.push(I.appendConfig.of([Qi, db, pb, Ff]));
		}
		...
		return (
			t(
				e.update({
					...
					effects: un.of(r ? null : new vi(i.ranges, s)),
					scrollIntoView: !0
				})
			),
			!0
...
const hb = ({ state: n, dispatch: e }) =>
		n.field(Qi, !1) ? (e(n.update({ effects: un.of(null) })), !0) : !1,
	cb = Hf(1),
	fb = Hf(-1),
	ub = [
		{ key: 'Tab', run: cb, shift: fb },
		{ key: 'Escape', run: hb }
	],
	Ba = _.define({
		combine(n) {
			return n.length ? n[0] : ub;
		}
	}),
	db = _t.highest(on.compute([Ba], (n) => n.facet(Ba)));
function Mx(n, e) {
	return { ...e, apply: ab(n) };
}
const pb = O.domEventHandlers({
		mousedown(n, e) {
			let t = e.state.field(Qi, !1),
				i;
			...
			return !s || s.field == t.active
				...
				: (e.dispatch({
						...
						effects: un.of(
							t.ranges.some((r) => r.field > s.field) ? new vi(t.ranges, s.field) : null
						),
						scrollIntoView: !0
					}),
					!0);
...
const zf = be.define({
	...
	update(n, e) {
		...
		for (let t of e.effects) t.is(Ht) && (n = n.update({ add: [jo.range(t.value, t.value + 1)] }));
		return n;
	}
});
function mb() {
...
const or = '()[]{}<>«»»«［］｛｝';
function qf(n) {
	for (let e = 0; e < or.length; e += 2) if (or.charCodeAt(e) == n) return or.charAt(e + 1);
	return ro(n < 128 ? n : n + 1);
}
function jf(n, e) {
	return n.languageDataAt('closeBrackets', e)[0] || Zi;
}
const gb = typeof navigator == 'object' && /Android\b/.test(navigator.userAgent),
	yb = O.inputHandler.of((n, e, t, i) => {
		if ((gb ? n.composing : n.compositionStarted) || n.state.readOnly) return !1;
		let s = n.state.selection.main;
		if (i.length > 2 || (i.length == 2 && et(Me(i, 0)) == 1) || e != s.from || t != s.to) return !1;
		let r = wb(n.state, i);
		return r ? (n.dispatch(r), !0) : !1;
	}),
	bb = ({ state: n, dispatch: e }) => {
		if (n.readOnly) return !1;
		let i = jf(n, n.selection.main.head).brackets || Zi.brackets,
			s = null,
			r = n.changeByRange((o) => {
				if (o.empty) {
					let l = vb(n.doc, o.head);
					for (let a of i)
						if (a == l && Ds(n.doc, o.head) == qf(Me(a, 0)))
							return {
	...
	xb = [{ key: 'Backspace', run: bb }];
function wb(n, e) {
	let t = jf(n, n.selection.main.head),
		i = t.brackets || Zi.brackets;
	for (let s of i) {
		let r = qf(Me(s, 0));
		if (e == s)
			return r == s ? Cb(n, s, i.indexOf(s + s + s) > -1, t) : kb(n, s, r, t.before || Zi.before);
		if (e == r && $f(n, n.selection.main.from)) return Sb(n, s, r);
	}
	return null;
}
function $f(n, e) {
	let t = !1;
	return (
		n.field(zf).between(0, n.doc.length, (i) => {
			i == e && (t = !0);
		}),
		t
	);
...
function Ds(n, e) {
	...
	return t.slice(0, et(Me(t, 0)));
}
function vb(n, e) {
	let t = n.sliceString(e - 2, e);
	return et(Me(t, 0)) == t.length ? t : t.slice(1);
}
function kb(n, e, t, i) {
	let s = null,
		r = n.changeByRange((o) => {
	...
	let s = i.stringPrefixes || Zi.stringPrefixes,
		...
		o = n.changeByRange((l) => {
			...
			if (h == e) {
				...
				if (n.charCategorizer(a)(h) != se.Word && Va(n, a, s) > -1 && !Ab(n, a, e, s))
					return {
						changes: { insert: e + e, from: a },
						effects: Ht.of(a + e.length),
						range: v.cursor(a + e.length)
...
function Mb(n = {}) {
	return [nb, Te, fe.of(n), tb, Tb, Ff];
}
const Kf = [
		{ key: 'Ctrl-Space', run: rr },
		{ mac: 'Alt-`', run: rr },
		{ mac: 'Alt-i', run: rr },
		{ key: 'Escape', run: Xy },
		{ key: 'ArrowDown', run: In(!0) },
		{ key: 'ArrowUp', run: In(!1) },
		{ key: 'PageDown', run: In(!0, 'page') },
		{ key: 'PageUp', run: In(!1, 'page') },
		{ key: 'Enter', run: Wf }
	],
	Tb = _t.highest(on.computeN([fe], (n) => (n.facet(fe).defaultKeymap ? [Kf] : [])));
class Wa {
	constructor(e, t, i) {
...
class Nt {
	...
	static init(e, t, i) {
		...
		for (let d = 0; ; ) {
			...
			let m, g;
			if (l.length)
				((m = a), (g = l.reduce((C, L) => Math.min(C, L.to), p && p.from > m ? p.from : 1e8)));
			else {
			...
			for (; d < r.length; ) {
				let C = r[d];
				if (C.from == m && (C.to > C.from || C.to == m)) (l.push(C), d++, (g = Math.min(C.to, g)));
				else {
					g = Math.min(C.from, g);
					break;
				}
			...
			g = Math.min(g, f);
			let y = !1;
			if (l.some((C) => C.from == m && (C.to == g || g == f)) && ((y = m == g), !y && g - m < 10)) {
				let C = m - (c + h.value.length);
				C > 0 && (h.next(C), (c = m));
				for (let L = m; ; ) {
					if (L >= g) {
						y = !0;
					...
					if (!h.lineBreak && c + h.value.length > L) break;
					((L = c + h.value.length), (c += h.value.length), h.next());
				}
			}
			let S = Fb(l);
			if (y) o.add(m, m, P.widget({ widget: new Bb(S), diagnostics: l.slice() }));
			else {
				let C = l.reduce((L, A) => (A.markClass ? L + ' ' + A.markClass : L), '');
				o.add(
					m,
					g,
					P.mark({
						class: 'cm-lintRange cm-lintRange-' + S + C,
						diagnostics: l.slice(),
						inclusiveEnd: l.some((L) => L.to > g)
					})
				);
			}
			if (((a = g), a == f)) break;
			for (let C = 0; C < l.length; C++) l[C].to <= a && l.splice(C--, 1);
		}
		let u = o.finish();
		return new Nt(u, t, Ot(u));
	}
}
	...
	return (
		n.between(t, 1e9, (s, r, { spec: o }) => {
			if (!(e && o.diagnostics.indexOf(e) < 0))
				if (!i) i = new Wa(s, r, e || o.diagnostics[0]);
				else {
					if (o.diagnostics.indexOf(i.diagnostic) < 0) return !1;
					i = new Wa(i.from, r, i.diagnostic);
				}
		}),
		i
	);
...
function Db(n, e) {
	let t = e.pos,
		i = e.end || t,
		s = n.state.facet(en).hideOn(n, t, i);
	if (s != null) return s;
	let r = n.startState.doc.lineAt(e.pos);
	return !!(n.effects.some((o) => o.is(Uf)) || n.changes.touchesRange(r.from, Math.max(r.to, i)));
}
function Eb(n, e) {
	return n.field(Ie, !1) ? e : e.concat(I.appendConfig.of(Hb));
}
const Uf = I.define(),
	$o = I.define(),
	Gf = I.define(),
	Ie = be.define({
		create() {
			return new Nt(P.none, null, null);
		},
		update(n, e) {
			if (e.docChanged && n.diagnostics.size) {
				...
				if (n.selected) {
					...
					i = Ot(t, n.selected.diagnostic, r) || Ot(t, null, r);
				}
				(!t.size && s && e.state.facet(en).autoPanel && (s = null), (n = new Nt(t, s, i)));
			}
			for (let t of e.effects)
				if (t.is(Uf)) {
					let i = e.state.facet(en).autoPanel ? (t.value.length ? tn.open : null) : n.panel;
					n = Nt.init(t.value, i, e.state);
				} else
					t.is($o)
						? (n = new Nt(n.diagnostics, t.value ? tn.open : null, n.selected))
						: t.is(Gf) && (n = new Nt(n.diagnostics, n.panel, t.value));
			return n;
		},
		provide: (n) => [Ki.from(n, (e) => e.panel), O.decorations.from(n, (e) => e.diagnostics)]
	}),
	Ob = P.mark({ class: 'cm-lintRange cm-lintRange-active' });
function _b(n, e, t) {
	let { diagnostics: i } = n.state.field(Ie),
		s,
		r = -1,
		o = -1;
	...
	let l = n.state.facet(en).tooltipFilter;
	return (
		s && l && (s = l(s, n.state)),
		s
			? {
...
const Pb = (n) => {
		let e = n.state.field(Ie, !1);
		(!e || !e.panel) && n.dispatch({ effects: Eb(n.state, [$o.of(!0)]) });
		let t = Co(n, tn.open);
		return (t && t.dom.querySelector('.cm-panel-lint ul').focus(), !0);
	},
	Fa = (n) => {
		let e = n.state.field(Ie, !1);
		return !e || !e.panel ? !1 : (n.dispatch({ effects: $o.of(!1) }), !0);
	},
	Rb = (n) => {
		let e = n.state.field(Ie, !1);
		if (!e) return !1;
		let t = n.state.selection.main,
			i = Ot(e.diagnostics, null, t.to + 1);
		return !i && ((i = Ot(e.diagnostics, null, 0)), !i || (i.from == t.from && i.to == t.to))
			? !1
			: (n.dispatch({ selection: { anchor: i.from, head: i.to }, scrollIntoView: !0 }), !0);
	},
	Ib = [
		{ key: 'Mod-Shift-m', run: Pb, preventDefault: !0 },
		{ key: 'F8', run: Rb }
	],
	en = _.define({
		combine(n) {
...
function Yf(n, e, t) {
	...
	return X(
		...
		X('span', { class: 'cm-diagnosticText' }, e.renderMessage ? e.renderMessage(n) : e.message),
			...
			: i.map((r, o) => {
					let l = !1,
						a = (d) => {
							...
							l = !0;
							let p = Ot(n.state.field(Ie).diagnostics, e);
							p && r.apply(n, p.from, p.to);
						},
						{ name: h } = r,
						c = s[o] ? h.indexOf(s[o]) : -1,
						f = c < 0 ? h : [h.slice(0, c), X('u', h.slice(c, c + 1)), h.slice(c + 1)],
...
class tn {
	constructor(e) {
		...
		let t = (s) => {
				if (!(s.ctrlKey || s.altKey || s.metaKey)) {
					if (s.keyCode == 27) (Fa(this.view), this.view.focus());
						...
						for (let l = 0; l < o.length; l++)
							if (o[l].toUpperCase().charCodeAt(0) == s.keyCode) {
								let a = Ot(this.view.state.field(Ie).diagnostics, r);
	...
	get selectedIndex() {
		let e = this.view.state.field(Ie).selected;
		if (!e) return -1;
	...
	update() {
		let { diagnostics: e, selected: t } = this.view.state.field(Ie),
			i = 0,
			s = !1,
			r = null,
			o = new Set();
		for (
			e.between(0, this.view.state.doc.length, (l, a, { spec: h }) => {
				for (let c of h.diagnostics) {
					...
					(f < 0
						? ((u = new za(this.view, c)), this.items.splice(i, 0, u), (s = !0))
	...
	moveSelection(e) {
		...
		let t = this.view.state.field(Ie),
			i = Ot(t.diagnostics, this.items[e].diagnostic);
		i &&
			this.view.dispatch({
...
function Nb(n, e = 'viewBox="0 0 40 40"') {
...
const Vb = O.baseTheme({
	...
	'.cm-lintRange-error': { backgroundImage: Bn('#d11') },
	'.cm-lintRange-warning': { backgroundImage: Bn('orange') },
	'.cm-lintRange-info': { backgroundImage: Bn('#999') },
	'.cm-lintRange-hint': { backgroundImage: Bn('#66d') },
...
const Hb = [
		Ie,
		O.decorations.compute([Ie], (n) => {
			let { selected: e, panel: t } = n.field(Ie);
			return !e || !t || e.from == e.to ? P.none : P.set([Ob.range(e.from, e.to)]);
		}),
		Am(_b, { hideOn: Db }),
		Vb
	],
	...
	Xb = O.theme(
		{
			'&': { color: jn, backgroundColor: Ka },
			'.cm-content': { caretColor: Ua },
			'.cm-cursor, .cm-dropCursor': { borderLeftColor: Ua },
			'&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection':
				{ backgroundColor: Yb },
			'.cm-panels': { backgroundColor: Jb, color: jn },
			...
			'.cm-gutters': { backgroundColor: Ka, color: eo, border: 'none' },
			'.cm-activeLineGutter': { backgroundColor: $a },
			'.cm-foldPlaceholder': { backgroundColor: 'transparent', border: 'none', color: '#ddd' },
			'.cm-tooltip': { border: 'none', backgroundColor: lr },
			'.cm-tooltip .cm-tooltip-arrow:before': {
				borderTopColor: 'transparent',
				borderBottomColor: 'transparent'
			},
			'.cm-tooltip .cm-tooltip-arrow:after': { borderTopColor: lr, borderBottomColor: lr },
			'.cm-tooltip-autocomplete': {
				'& > ul > li[aria-selected]': { backgroundColor: $a, color: jn }
			}
		},
		{ dark: !0 }
	),
	Qb = hn.define([
		{ tag: w.keyword, color: Gb },
		{ tag: [w.name, w.deleted, w.character, w.propertyName, w.macroName], color: qa },
		{ tag: [w.function(w.variableName), w.labelName], color: Kb },
		{ tag: [w.color, w.constant(w.name), w.standard(w.name)], color: ja },
		{ tag: [w.definition(w.name), w.separator], color: jn },
		{
			tag: [
				w.typeName,
				w.className,
		...
		{
			tag: [w.operator, w.operatorKeyword, w.url, w.escape, w.regexp, w.link, w.special(w.string)],
			color: jb
		},
		{ tag: [w.meta, w.comment], color: eo },
		{ tag: w.strong, fontWeight: 'bold' },
		{ tag: w.emphasis, fontStyle: 'italic' },
		{ tag: w.strikethrough, textDecoration: 'line-through' },
		{ tag: w.link, color: eo, textDecoration: 'underline' },
		{ tag: w.heading, fontWeight: 'bold', color: qa },
		{ tag: [w.atom, w.bool, w.special(w.variableName)], color: ja },
		{ tag: [w.processingInstruction, w.string, w.inserted], color: Ub },
		{ tag: w.invalid, color: $b }
	]),
	Ga = [Xb, Nc(Qb)];
var Zb = fu('<div class="h-full w-full text-sm"></div>');
function Tx(n, e) {
	eu(e, !1);
	const t = () => Yo(mu, '$user', s),
		i = () => Yo(o, '$i18n', s),
		[s, r] = hu();
	tu();
	const o = iu('i18n');
	let l = Jt(e, 'boilerplate', 8, ''),
		a = Jt(e, 'value', 12, ''),
		h = Jt(e, 'onSave', 8, () => {}),
		c = Jt(e, 'onChange', 8, () => {}),
		f = '';
	const u = () => {
		if (f !== a()) {
			const N = d(f, a());
			((f = a()), g && N.length > 0 && g.dispatch({ changes: N }));
		}
	};
	function d(N, G) {
		let V = 0;
		for (; V < N.length && V < G.length && N[V] === G[V]; ) V++;
		if (N === G) return [];
		let J = N.length,
			ne = G.length;
		for (; J > V && ne > V && N[J - 1] === G[ne - 1]; ) (J--, ne--);
		return [{ from: V, to: J, insert: G.slice(V, ne) }];
	}
	let p = Jt(e, 'id', 8, ''),
		m = Jt(e, 'lang', 8, ''),
		g = null;
	...
	let S = !1,
		...
		L = new ci();
	const A = async () => {
		const N = Ss.find((G) => G.alias.includes(m()));
		return await (N == null ? void 0 : N.load());
	};
	let M = null;
	const T = () => (M || (M = new pu()), M);
	let B = 0;
	const H = (N) =>
			new Promise((G, V) => {
				const J = `format-${++B}`;
...
`,
					yt = ['black'];
				function ht(Es) {
					const { id: Xf, stdout: Os, stderr: Ko } = Es.data;
					if (Xf === J)
						if (
							(clearTimeout(ne),
							ae.removeEventListener('message', ht),
							ae.removeEventListener('error', Pt),
							Ko)
						)
							V(Ko);
						else {
							const Qf = (function (dn, _s, Zf) {
								const Ls = dn.indexOf(_s),
									Uo = dn.indexOf(Zf, Ls + _s.length);
								return Ls === -1 || Uo === -1 ? null : dn.slice(Ls + _s.length, Uo).trim();
							})(Os && typeof Os == 'string' ? Os : '', ke, Le);
							G({ code: Qf });
						}
				}
				function Pt(Es) {
					(clearTimeout(ne),
						ae.removeEventListener('message', ht),
						ae.removeEventListener('error', Pt),
						V(Es.message || 'Pyodide worker error'));
				}
				(ae.addEventListener('message', ht),
					ae.addEventListener('error', Pt),
					ae.postMessage({ id: J, code: at, packages: yt }),
					(ne = setTimeout(() => {
						(ae.removeEventListener('message', ht), ae.removeEventListener('error', Pt));
						try {
							ae.terminate();
						} catch {}
						((M = null), V('Execution Time Limit Exceeded'));
					}, 6e4)));
			}),
		K = async () => {
			var N;
			if (g) {
				const G = await (
					((N = t()) == null ? void 0 : N.role) === 'admin' ? gu(localStorage.token, f) : H(f)
				).catch((V) => (Qo.error(`${V}`), null));
				if (G && G.code) {
					const V = G.code;
					return (
						g.dispatch({ changes: [{ from: 0, to: g.state.doc.length, insert: V }] }),
						(f = V),
						c()(f),
						await cu(),
						Qo.success(i().t('Code formatted successfully')),
						!0
					);
				}
				return !1;
	...
	let W = [
		zb,
		on.of([{ key: 'Tab', run: Wf }, ny]),
		ln.of('    '),
		cm(i().t('Enter your code here...')),
		O.updateListener.of((N) => {
			N.docChanged && ((f = N.state.doc.toString()), c()(f));
		}),
		C.of([]),
		L.of([])
	];
	const R = async () => {
		const N = await A();
		N && g && g.dispatch({ effects: L.reconfigure(N) });
	};
	(nu(() => {
		(a() === '' && a(l()),
			(f = a()),
			...
			(g = new O({
				state: $.create({ doc: f, extensions: W }),
				parent: document.getElementById(`code-textarea-${p()}`)
			})),
			S && g.dispatch({ effects: C.reconfigure(Ga) }));
		const N = new MutationObserver((V) => {
			V.forEach((J) => {
				if (J.type === 'attributes' && J.attributeName === 'class') {
					const ne = document.documentElement.classList.contains('dark');
					ne !== S &&
						((S = ne),
						ne
							? g.dispatch({ effects: C.reconfigure(Ga) })
							: g.dispatch({ effects: C.reconfigure() }));
				}
			});
		});
		N.observe(document.documentElement, { attributes: !0, attributeFilter: ['class'] });
		const G = async (V) => {
			((V.ctrlKey || V.metaKey) && V.key === 's' && (V.preventDefault(), h()()),
				(V.ctrlKey || V.metaKey) && V.shiftKey && V.key === 'f' && (V.preventDefault(), await K()));
		};
		return (
		...
		ru());
	var U = { focus: y, formatPythonCodeHandler: K };
	du();
	var q = Zb();
	(ou(() => uu(q, 'id', `code-textarea-${p() ?? ''}`)),
		lu(n, q),
		Xo(e, 'focus', y),
		Xo(e, 'formatPythonCodeHandler', K));
	var Y = au(U);
	return (r(), Y);
}
export {
...
//# sourceMappingURL=chV95BsE.js.map
