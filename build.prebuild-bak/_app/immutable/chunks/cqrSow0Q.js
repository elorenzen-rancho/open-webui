const a = 'Haqida',
	...
	Wa = 'Tavsif',
	Ya = '',
	_a = 'Diktatsiya qilish',
	Ga = "To'g'ridan-to'g'ri",
	Ha = "O'chirilgan",
	Va = 'Displey',
	Ja = 'Dokling',
	Qa = 'Hujjat',
	...
	ao = 'Ruxsatlar',
	io = '',
	eo = 'Shaxsiylashtirish',
	no = 'Pin',
	oo = 'Qadalgan',
	to = '',
	so = '',
	ro = "O'yin maydonchasi",
	lo = 'Port',
	ho = '',
	uo = 'Ko‘rib chiqish',
	co = 'Shaxsiy',
	...
	Ls = {
		'-1 for no limit, or a positive integer for a specific limit':
			"Cheksiz uchun -1 yoki ma'lum chegara uchun musbat butun son",
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' yoki '-1' muddati tugamasligi uchun.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(masalan, `sh webui.sh --api --api-auth username_password`)',
		'(e.g. `sh webui.sh --api`)': '(masalan, `sh webui.sh --api`)',
		'(latest)': '(oxirgi)',
		'(leave blank for to use commercial endpoint)':
			"(tijoriy so'nggi nuqtadan foydalanish uchun bo'sh qoldiring)",
		'[Last] dddd [at] h:mm A': '',
		'[Today at] h:mm A': '',
		'[Yesterday at] h:mm A': '',
		'{{ models }}': '{{ models }}',
		...
		'*Prompt node ID(s) are required for image generation':
			'*Rasm yaratish uchun tezkor tugun identifikatorlari talab qilinadi',
		'1 hour before': '',
		'1 Source': '',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Endi yangi versiya (v{{LATEST_VERSION}}) mavjud.',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			"Vazifa modeli chatlar va veb-qidiruv so'rovlari uchun sarlavhalarni yaratish kabi vazifalarni bajarishda ishlatiladi",
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Chat kiritish uchun “/{{COMMAND}}” terib ushbu buyruqni faollashtiring.',
		Active: s,
		...
		'Add a short description about what this model does':
			"Ushbu model nima qilishi haqida qisqacha tavsif qo'shing",
		...
		'Adjusting these settings will apply changes universally to all users.':
			"Ushbu sozlamalarni o'zgartirish barcha foydalanuvchilarga universal tarzda qo'llaniladi.",
		admin: d,
		Admin: h,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			"Administratorlar har doim barcha vositalardan foydalanishlari mumkin; foydalanuvchilarga ish joyida har bir model uchun tayinlangan vositalar kerak bo'ladi.",
		Advanced: u,
		...
		'Allowed file extensions for upload. Separate multiple extensions with commas. Leave empty for all file types.':
			"Yuklash uchun ruxsat berilgan fayl kengaytmalari. Bir nechta kengaytmalarni vergul bilan ajrating. Barcha fayl turlari uchun bo'sh qoldiring.",
		'Already have an account?': 'Hisobingiz bormi?',
		'Alternative to the top_p, and aims to ensure a balance of quality and variety. The parameter p represents the minimum probability for a token to be considered, relative to the probability of the most likely token. For example, with p=0.05 and the most likely token having a probability of 0.9, logits with a value less than 0.045 are filtered out.':
			"Top_p ga muqobil va sifat va xilma-xillik muvozanatini ta'minlashga qaratilgan. p parametri tokenning ko'rib chiqilishining minimal ehtimolini ifodalaydi, bu tokenning ehtimoliy ehtimoliga nisbatan. Misol uchun, p=0,05 va eng ehtimolli token 0,9 ehtimolga ega bo'lsa, qiymati 0,045 dan kam bo'lgan logitlar filtrlanadi.",
		Always: g,
		...
		'applies to all users with the "user" role':
			'"foydalanuvchi" roliga ega barcha foydalanuvchilarga tegishli',
		April: v,
		Archive: q,
		'Archive All': '',
		...
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Haqiqatan ham barcha xotiralarni tozalamoqchimisiz? Bu amalni ortga qaytarib bo‘lmaydi.',
		'Are you sure you want to delete "{{NAME}}"?': '',
		'Are you sure you want to delete **{{modelName}}**?': '',
		'Are you sure you want to delete all chats? This action cannot be undone.': '',
		'Are you sure you want to delete this channel?':
			'Haqiqatan ham bu kanalni oʻchirib tashlamoqchimisiz?',
		'Are you sure you want to delete this connection? This action cannot be undone.': '',
		'Are you sure you want to delete this memory? This action cannot be undone.': '',
		'Are you sure you want to delete this message?':
			'Haqiqatan ham bu xabarni oʻchirib tashlamoqchimisiz?',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Haqiqatan ham barcha arxivlangan chatlarni arxivdan chiqarmoqchimisiz?',
		...
		'Autocomplete Generation Input Max Length':
			'Avtomatik toʻldirish ishlab chiqarish kiritish maksimal uzunligi',
		Automatic1111: z,
		...
		'Boosting or penalizing specific tokens for constrained responses. Bias values will be clamped between -100 and 100 (inclusive). (Default: none)':
			"Cheklangan javoblar uchun maxsus tokenlarni kuchaytirish yoki jazolash. Yo'naltirilgan qiymatlar -100 va 100 (shu jumladan) oralig'ida mahkamlanadi. (Birlamchi: yo‘q)",
		Brave: _,
		...
		'Call feature is not supported when using Web STT engine':
			"Web STT mexanizmidan foydalanilganda qo'ng'iroq funksiyasi qo'llab-quvvatlanmaydi",
		Camera: J,
		Cancel: Q,
		...
		'Character limit for autocomplete generation input':
			'Avtomatik toʻldirishni yaratish uchun belgilar chegarasi',
		...
		'Click here to download user import template file.':
			'Foydalanuvchi import shablon faylini yuklab olish uchun shu yerni bosing.',
		'Click here to learn more about faster-whisper and see the available models.':
			"Tezroq shivirlash haqida ko'proq ma'lumot olish va mavjud modellarni ko'rish uchun shu yerni bosing.",
		...
		'Click here to upload a workflow.json file.':
			'Workflow.json faylini yuklash uchun shu yerni bosing.',
		'click here.': 'bu yerni bosing.',
		"Click on the user role button to change a user's role.":
			"Foydalanuvchi rolini o'zgartirish uchun foydalanuvchi roli tugmasini bosing.",
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Buferga yozish ruxsati rad etildi. Kerakli ruxsat berish uchun brauzer sozlamalarini tekshiring.',
		Clone: la,
		...
		'Connect to your own OpenAI compatible API endpoints.':
			"O'zingizning OpenAI-ga mos keladigan API so'nggi nuqtalariga ulaning.",
		'Connect to your own OpenAPI compatible external tool servers.':
			"O'zingizning OpenAPI-ga mos keladigan tashqi asboblar serverlariga ulaning.",
		'Connected ({{type}})': '',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			"Fikrlash modellari uchun mulohaza yuritish bo'yicha harakatlarni cheklaydi. Faqat fikrlash harakatlarini qo'llab-quvvatlaydigan maxsus provayderlarning fikrlash modellari uchun qo'llaniladi.",
		...
		'Control the repetition of token sequences in the generated text. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 1.1) will be more lenient. At 1, it is disabled.':
			"Yaratilgan matndagi tokenlar ketma-ketligini takrorlashni nazorat qilish. Yuqori qiymat (masalan, 1,5) takrorlash uchun qattiqroq jazolanadi, pastroq qiymat (masalan, 1,1) esa yumshoqroq bo'ladi. 1-da, u o'chirilgan.",
		Controls: Ia,
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			"Chiqarishning izchilligi va xilma-xilligi o'rtasidagi muvozanatni nazorat qiladi. Pastroq qiymat ko'proq diqqat markazida va izchil matnga olib keladi.",
		'Conversation saved successfully': '',
		Copied: Pa,
		'Copied link to clipboard': 'Buferga havola nusxalandi',
		'Copied shared chat URL to clipboard!':
			'Umumiy chat URL manzili vaqtinchalik xotiraga nusxalandi!',
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'Open WebUI soʻrovlariga ruxsat berish uchun CORS provayder tomonidan toʻgʻri sozlangan boʻlishi kerak.',
		'Could not read file.': '',
		CPU: Ma,
		Create: xa,
		...
		'Create your first note by clicking on the plus button below.':
			'Quyidagi ortiqcha tugmasini bosish orqali birinchi qaydingizni yarating.',
		...
		'Default to 389 or 636 if TLS is enabled':
			"Agar TLS yoqilgan bo'lsa, sukut bo'yicha 389 yoki 636",
		'Default to ALL': 'ALL uchun birlamchi',
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			'Fokuslangan va tegishli kontentni ajratib olish uchun birlamchi segmentlangan qidirish, bu koʻp hollarda tavsiya etiladi.',
		...
		'Deployment names are required for Azure OpenAI':
			'Azure OpenAI uchun tarqatish nomlari talab qilinadi',
		Desc: Ka,
		'Describe the edit...': '',
		'Describe the image...': '',
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			"To'g'ridan-to'g'ri ulanishlar foydalanuvchilarga o'zlarining OpenAI-ga mos keluvchi API so'nggi nuqtalariga ulanish imkonini beradi.",
		'Direct Message': '',
		...
		'Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.':
			"PDF-dan tasvirni ajratib olishni o'chirib qo'ying. Agar LLM dan foydalanish yoqilgan boʻlsa, tasvirlarga avtomatik sarlavha qoʻyiladi. Birlamchi parametrlar False.",
		Disabled: Ha,
		'Disconnect OAuth': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			"Open WebUI-dan qanday foydalanishni bilib oling va hamjamiyatdan yordam so'rang.",
		'Discover wonders': "Mo''jizalarni kashf eting",
		'Discover, download, and explore custom functions':
			"Maxsus funktsiyalarni kashf eting, yuklab oling va o'rganing",
		'Discover, download, and explore custom prompts':
			'Maxsus takliflarni kashf qiling, yuklab oling va oʻrganing',
		'Discover, download, and explore custom tools':
			"Maxsus vositalarni kashf qiling, yuklab oling va o'rganing",
		'Discover, download, and explore model presets':
			"Model sozlamalarini kashf eting, yuklab oling va o'rganing",
		...
		'Display the username instead of You in the Chat':
			"Chatda Siz o'rniga foydalanuvchi nomini ko'rsating",
		...
		'Do not install functions from sources you do not fully trust.':
			'Toʻliq ishonmaydigan manbalardan funksiyalarni oʻrnatmang.',
		'Do not install tools from sources you do not fully trust.':
			"O'zingiz ishonmaydigan manbalardan asboblarni o'rnatmang.",
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			"hech qanday tashqi ulanishlarni amalga oshirmaydi va sizning ma'lumotlaringiz mahalliy serveringizda xavfsiz saqlanadi.",
		'Domain Filter List': "Domen filtrlari ro'yxati",
		"don't fetch random pipelines from sources you don't trust.":
			'Ishonchsiz manbalardan tasodifiy pipeline-larni olmang.',
		"Don't have an account?": "Hisobingiz yo'qmi?",
		"don't install random functions from sources you don't trust.":
			"o'zingiz ishonmaydigan manbalardan tasodifiy funksiyalarni o'rnatmang.",
		"don't install random tools from sources you don't trust.":
			"o'zingiz ishonmaydigan manbalardan tasodifiy vositalarni o'rnatmang.",
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"masalan. '30s', '10m'. Yaroqli vaqt birliklari 's', 'm', 'h'.",
		"e.g. 'low', 'medium', 'high'": '',
		'e.g. "json" or a JSON schema': 'masalan. "json" yoki JSON sxemasi',
		'e.g. 60': 'masalan. 60',
		'e.g. A filter to remove profanity from text':
			"masalan. Matndan haqoratli so'zlarni olib tashlash uchun filtr",
		...
		'e.g. Tools for performing various operations':
			'masalan. Har xil operatsiyalarni bajarish uchun asboblar',
		...
		'e.g., en-US,ja-JP (leave blank for auto-detect)':
			'masalan, en-US,ja-JP (avtomatik aniqlash uchun boʻsh qoldiring)',
		...
		'Enable autocomplete generation for chat messages':
			'Chat xabarlari uchun avtomatik to‘ldirishni yaratishni yoqing',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'CSV faylingiz quyidagi tartibda 4 ta ustundan iboratligiga ishonch hosil qiling: Ism, Elektron pochta, Parol, Rol.',
		'Enter {{role}} message here': 'Bu yerga {{role}} xabarini kiriting',
		'Enter a detail about yourself for your LLMs to recall':
			'LLMlar eslab qolishlari uchun oʻzingiz haqingizda maʼlumot kiriting',
		'Enter a title for the pending user info overlay. Leave empty for default.':
			"Kutilayotgan foydalanuvchi maʼlumotlari uchun sarlavha kiriting. Sukut bo'yicha bo'sh qoldiring.",
		'Enter a watermark for the response. Leave empty for none.':
			"Javob uchun moybo'yoqli belgini kiriting. Hech kim uchun bo'sh qoldiring.",
		...
		'Enter api auth string (e.g. username:password)':
			'api auth satrini kiriting (masalan, foydalanuvchi nomi: parol)',
		...
		'Enter comma-separated "token:bias_value" pairs (example: 5432:100, 413:-100)':
			'Vergul bilan ajratilgan "token:bias_value" juftlarini kiriting (misol: 5432:100, 413:-100)',
		'Enter content for the pending user info overlay. Leave empty for default.':
			"Kutilayotgan foydalanuvchi ma'lumotlari qoplamasi uchun tarkibni kiriting. Sukut bo'yicha bo'sh qoldiring.",
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Proksi-serverning URL manzilini kiriting (masalan, https://user:password@host:port)',
		...
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'WebUI ning umumiy URL manzilini kiriting. Bu URL bildirishnomalarda havolalar yaratish uchun ishlatiladi.',
		'Enter the URL of the function to import':
			'Import qilinadigan funksiyaning URL manzilini kiriting',
		...
		'Enter URL (e.g. http://127.0.0.1:7860/)':
			'URL manzilini kiriting (masalan, http://127.0.0.1:7860/)',
		'Enter URL (e.g. http://localhost:11434)':
			'URL manzilini kiriting (masalan, http://localhost:11434)',
		'Enter value': '',
		'Enter value (true/false)': '',
		'Enter Yacy Password': 'Yacy parolini kiriting',
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			'Yacy URL manzilini kiriting (masalan, http://yacy.example.com:8090)',
		...
		'Error accessing Google Drive: {{error}}':
			'Google Drive-ga kirishda xatolik yuz berdi: {{error}}',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Misol: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Misol: sAMAccountName yoki uid yoki userPrincipalName',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			"Litsenziyangizdagi oʻrinlar sonidan oshib ketdi. O'rindiqlar sonini ko'paytirish uchun qo'llab-quvvatlash xizmatiga murojaat qiling.",
		Exclude: bi,
		'Execute code': '',
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'{{URL}} OpenAPI asbob serveriga ulanib boʻlmadi',
		...
		'File size should not exceed {{maxSize}} MB.':
			'Fayl hajmi {{maxSize}} MB dan oshmasligi kerak.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Barmoq izi aldash aniqlandi: avatar sifatida bosh harflardan foydalanish imkonsiz. Standart profil rasmi.',
		...
		'Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.':
			"PDF-ning barcha sahifalarida OCRni majburlash. Agar PDF-fayllaringizda yaxshi matn bo'lsa, bu yomon natijalarga olib kelishi mumkin. Birlamchi parametrlar False.",
		...
		'Forwards system user session credentials to authenticate':
			"Autentifikatsiya qilish uchun tizim foydalanuvchisi seansi hisob ma'lumotlarini yo'naltiradi",
		Fr_day_of_week: Fi,
		...
		'Functions allow arbitrary code execution.':
			"Funktsiyalar o'zboshimchalik bilan kodni bajarishga imkon beradi.",
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			"Men o'qiganimni tan olaman va o'z harakatlarimning oqibatlarini tushunaman. Men o'zboshimchalik bilan kodni bajarish bilan bog'liq xavflardan xabardorman va manbaning ishonchliligini tasdiqladim.",
		ID: ue,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			"Stabil-diffusion-webui ishlayotganda `--api-auth` bayrog'ini qo'shing",
		'Include `--api` flag when running stable-diffusion-webui':
			"Stabil-diffusion-webui ishlatilayotganda `--api` bayrog'ini qo'shing",
		'Includes SharePoint': 'SharePoint o‘z ichiga oladi',
		'Increase UI Scale': '',
		'Influences how quickly the algorithm responds to feedback from the generated text. A lower learning rate will result in slower adjustments, while a higher learning rate will make the algorithm more responsive.':
			"Algoritm yaratilgan matndan olingan fikr-mulohazaga qanchalik tez javob berishiga ta'sir qiladi. Pastroq o'rganish tezligi sozlashning sekinlashishiga olib keladi, yuqori o'rganish tezligi esa algoritmni yanada sezgir qiladi.",
		Info: be,
		Initials: ke,
		'Inject file content into conversation context': '',
		'Inject the entire content as context for comprehensive processing, this is recommended for complex queries.':
			"Kompleks qayta ishlash uchun butun tarkibni kontekst sifatida kiriting, bu murakkab so'rovlar uchun tavsiya etiladi.",
		Input: fe,
		...
		'Instant Auto-Send After Voice Transcription':
			'Ovozli transkripsiyadan keyin darhol avtomatik yuborish',
		Instructions: qe,
		Integration: Ae,
		Integrations: Se,
		Interface: we,
		...
		'Learn more about OpenAPI tool servers.':
			"OpenAPI vositasi serverlari haqida ko'proq bilib oling.",
		...
		'Leave empty to include all models from "{{url}}" endpoint':
			'“{{url}}” soʻnggi nuqtasidagi barcha modellarni kiritish uchun boʻsh qoldiring',
		'Leave empty to include all models from "{{url}}/api/tags" endpoint':
			'“{{url}}/api/tags” soʻnggi nuqtasidagi barcha modellarni kiritish uchun boʻsh qoldiring',
		'Leave empty to include all models from "{{url}}/models" endpoint':
			'“{{url}}/models” soʻnggi nuqtasidagi barcha modellarni kiritish uchun boʻsh qoldiring',
		'Leave empty to include all models or select specific models':
			"Barcha modellarni kiritish yoki muayyan modellarni tanlash uchun bo'sh qoldiring",
		...
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Standart taklifdan foydalanish uchun boʻsh qoldiring yoki maxsus taklifni kiriting',
		'Leave model field empty to use the default model.':
			"Standart modeldan foydalanish uchun model maydonini bo'sh qoldiring.",
		Legacy: De,
		lexical: Oe,
		License: Le,
		'Lift List': '',
		...
		'LLMs can make mistakes. Verify important information.':
			"LLMlar xato qilishlari mumkin. Muhim ma'lumotlarni tasdiqlang.",
		Loader: Be,
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Workflow.json faylini ComfyUI’dan API formati sifatida eksport qilganingizga ishonch hosil qiling.',
		Male: Ve,
		Manage: Je,
		'Manage Connections': '',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			"Bir vaqtning o'zida maksimal 3 ta modelni yuklab olish mumkin. Keyinroq qayta urinib ko‘ring.",
		May: Ze,
		MBR: $e,
		MCP: an,
		...
		'Memories accessible by LLMs will be shown here.':
			"LLMlar kirishi mumkin bo'lgan xotiralar bu erda ko'rsatiladi.",
		Memory: sn,
		...
		'Message rating should be enabled to use this feature':
			'Bu funksiyadan foydalanish uchun xabarlar reytingi yoqilishi kerak',
		messages: ln,
		Messages: dn,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			"Havolani yaratganingizdan keyin yuborgan xabarlaringiz ulashilmaydi. URL manzili bo'lgan foydalanuvchilar umumiy chatni ko'rishlari mumkin bo'ladi.",
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			'“{{modelName}}” modeli yuklab olindi.',
		"Model '{{modelTag}}' is already in queue for downloading.":
			'“{{modelTag}}” modeli allaqachon yuklab olish uchun navbatda turibdi.',
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': '',
		'Model {{modelName}} is not vision capable':
			"{{modelName}} modeli ko'rish qobiliyatiga ega emas",
		...
		'Model can execute code and perform calculations':
			'Model kodni bajarishi va hisob-kitoblarni amalga oshirishi mumkin',
		'Model can generate images based on text prompts':
			'Model matn takliflari asosida tasvirlarni yaratishi mumkin',
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Model fayl tizimi yoʻli aniqlandi. Yangilash uchun model qisqa nomi talab qilinadi, davom ettirib bo‘lmaydi.',
		...
		'No inference engine with management support found':
			'Boshqaruv yordami bilan xulosa chiqarish mexanizmi topilmadi',
		'No kernel': '',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			"Eslatma: Agar siz minimal ball qo'ysangiz, qidiruv faqat minimal balldan kattaroq yoki unga teng ballga ega hujjatlarni qaytaradi.",
		Notes: Pn,
		...
		'Only alphanumeric characters and hyphens are allowed':
			'Faqat harf-raqamli belgilar va defislarga ruxsat beriladi',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Buyruqlar qatorida faqat harf-raqamli belgilar va defislarga ruxsat beriladi.',
		'Only can be triggered when the chat input is in focus.': '',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			"Faqat to'plamlarni tahrirlash mumkin, hujjatlarni tahrirlash/qo'shish uchun yangi bilimlar bazasini yarating.",
		...
		'Only select users and groups with permission can access':
			'Faqat ruxsati bor tanlangan foydalanuvchilar va guruhlarga kirish mumkin',
		'Only sync new/updated chats': '',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			"Voy! URL noto‘g‘ri ko‘rinadi. Iltimos, ikki marta tekshiring va qayta urinib ko'ring.",
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Voy! Hali ham fayllar yuklanmoqda. Iltimos, yuklash tugashini kuting.',
		'Oops! There was an error in the previous response.': 'Voy! Avvalgi javobda xatolik yuz berdi.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			"Voy! Siz qoʻllab-quvvatlanmaydigan usuldan foydalanmoqdasiz (faqat frontend). Iltimos, WebUI-ga backend orqali xizmat ko'rsating.",
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			'Open WebUI har qanday OpenAPI serveri tomonidan taqdim etilgan vositalardan foydalanishi mumkin.',
		...
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open WebUI SpeechT5 va CMU Arctic dinamik oʻrnatishlaridan foydalanadi.',
		'Open WebUI version': '',
		'Open WebUI version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})':
			'Ochiq WebUI versiyasi (v{{OPEN_WEBUI_VERSION}}) talab qilingan versiyadan (v{{REQUIRED_VERSION}}) pastroq',
		OpenAI: Ln,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines — ixtiyoriy kod bajarilishini qo‘llab‑quvvatlaydigan plagin tizimi —',
		...
		'Please carefully review the following warnings:':
			"Quyidagi ogohlantirishlarni diqqat bilan ko'rib chiqing:",
		...
		'Please do not close the settings page while loading the model.':
			'Modelni yuklashda sozlamalar sahifasini yopmang.',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			"Prefiks identifikatori model identifikatorlariga prefiks qo'shish orqali boshqa ulanishlar bilan ziddiyatlarni oldini olish uchun ishlatiladi - o'chirish uchun bo'sh qoldiring.",
		...
		'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative.':
			"Bema'ni narsalarni yaratish ehtimolini kamaytiradi. Yuqori qiymat (masalan, 100) turli xil javoblar beradi, pastroq qiymat (masalan, 10) esa konservativ bo'ladi.",
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Javob bildirishnomalarini faollashtirib bo‘lmaydi, chunki veb-sayt ruxsatnomalari rad etilgan. Kerakli ruxsat berish uchun brauzer sozlamalariga tashrif buyuring.',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Chat jurnallarini bevosita brauzeringiz xotirasiga saqlash endi qo‘llab-quvvatlanmaydi. Quyidagi tugmani bosish orqali suhbat jurnallaringizni yuklab oling va oʻchiring. Xavotir olmang, siz chat jurnallarini backend orqali osongina qayta import qilishingiz mumkin',
		Schedule: Jo,
		...
		'Searching Knowledge for "{{searchQuery}}"':
			'“{{searchQuery}}” boʻyicha maʼlumotlar qidirilmoqda',
		...
		'Selected model(s) do not support image inputs':
			'Tanlangan model(lar) tasvir kiritishni qo‘llab-quvvatlamaydi',
		'Selected Models': '',
		semantic: at,
		Send: it,
		...
		'Set reranking model (e.g. {{model}})':
			"Qayta tartiblash modelini o'rnatish (masalan, {{model}})",
		...
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			"GPU-ga yuklanadigan qatlamlar sonini belgilang. Ushbu qiymatni oshirish GPU tezlashtirish uchun optimallashtirilgan modellar uchun ish faoliyatini sezilarli darajada yaxshilashi mumkin, lekin ko'proq quvvat va GPU resurslarini iste'mol qilishi mumkin.",
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			"Hech bo'lmaganda bir marta paydo bo'lgan tokenlarga nisbatan tekis chiziq o'rnatadi. Yuqori qiymat (masalan, 1,5) takrorlash uchun qattiqroq jazolanadi, pastroq qiymat (masalan, 0,9) esa yumshoqroq bo'ladi. 0 bo'lsa, u o'chirilgan.",
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			"Qancha marta paydo bo'lganiga qarab, takrorlanishlarni jazolash uchun tokenlarga nisbatan masshtabni o'rnatadi. Yuqori qiymat (masalan, 1,5) takrorlash uchun qattiqroq jazolanadi, pastroq qiymat (masalan, 0,9) esa yumshoqroq bo'ladi. 0 bo'lsa, u o'chirilgan.",
		'Sets how far back for the model to look back to prevent repetition.':
			'Takrorlanishning oldini olish uchun modelning orqaga qarashini belgilaydi.',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			"Nasl qilish uchun tasodifiy sonlar urug'ini o'rnatadi. Buni ma'lum bir raqamga o'rnatish, modelni bir xil so'rov uchun bir xil matn yaratishga majbur qiladi.",
		'Sets the size of the context window used to generate the next token.':
			'Keyingi tokenni yaratish uchun foydalaniladigan kontekst oynasining hajmini belgilaydi.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			"Foydalanish uchun to'xtash ketma-ketliklarini o'rnatadi. Ushbu naqshga duch kelganda, LLM matn yaratishni to'xtatadi va qaytib keladi. Model faylida bir nechta alohida to'xtash parametrlarini belgilash orqali bir nechta to'xtash naqshlari o'rnatilishi mumkin.",
		Setting: ot,
		Settings: tt,
		...
		'Show Admin Details in Account Pending Overlay':
			'Hisob kutilayotgan qatlamda administrator ma’lumotlarini ko‘rsatish',
		'Show All': '',
		...
		'Skip the cache and re-run the inference. Defaults to False.':
			"Keshni o'tkazib yuboring va xulosani qayta ishga tushiring. Birlamchi parametrlar False.",
		...
		'Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.':
			"Mavjud OCR matnini PDF faylidan olib tashlang va OCRni qayta ishga tushiring. Majburiy OCR yoqilgan bo'lsa, e'tiborga olinmaydi. Birlamchi parametrlar False.",
		...
		'Tail free sampling is used to reduce the impact of less probable tokens from the output. A higher value (e.g., 2.0) will reduce the impact more, while a value of 1.0 disables this setting.':
			"Chiqishdan kamroq ehtimoliy tokenlarning ta'sirini kamaytirish uchun quyruqsiz namuna olish qo'llaniladi. Yuqori qiymat (masalan, 2.0) taʼsirni koʻproq kamaytiradi, 1.0 qiymati esa bu sozlamani oʻchirib qoʻyadi.",
		'Talk to Model': '',
		...
		'The Application Account DN you bind with for search':
			"Qidirish uchun siz bog'langan ilova hisobi DN",
		...
		'The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.':
			"To'plam hajmi bir vaqtning o'zida nechta matn so'rovlari birgalikda qayta ishlanishini aniqlaydi. Kattaroq partiya hajmi modelning ishlashi va tezligini oshirishi mumkin, lekin u ham ko'proq xotira talab qiladi.",
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			"Ushbu plagin ortidagi ishlab chiquvchilar jamiyatning ehtirosli ko'ngillilaridir. Agar siz ushbu plaginni foydali deb bilsangiz, uning rivojlanishiga hissa qo'shing.",
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Baholash peshqadami Elo reyting tizimiga asoslanadi va real vaqt rejimida yangilanadi.',
		...
		'The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.':
			"Kirish audiosining tili. Kirish tilini ISO-639-1 (masalan, en) formatida taqdim etish aniqlik va kechikishni yaxshilaydi. Tilni avtomatik aniqlash uchun bo'sh qoldiring.",
		'The LDAP attribute that maps to the mail that users use to sign in.':
			'LDAP atributi foydalanuvchilarning tizimga kirishda foydalanadigan pochta manziliga mos keladi.',
		'The LDAP attribute that maps to the username that users use to sign in.':
			'Foydalanuvchilar tizimga kirish uchun foydalanadigan foydalanuvchi nomiga mos keladigan LDAP atributi.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'Peshqadamlar jadvali hozirda beta-versiyada va biz algoritmni takomillashtirish jarayonida reyting hisob-kitoblarini sozlashimiz mumkin.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'Faylning maksimal hajmi MB. Agar fayl hajmi ushbu chegaradan oshsa, fayl yuklanmaydi.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			"Chatda bir vaqtning o'zida ishlatilishi mumkin bo'lgan maksimal fayllar soni. Agar fayllar soni ushbu chegaradan oshsa, fayllar yuklanmaydi.",
		...
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			"Bal 0,0 (0%) va 1,0 (100%) oralig'ida bo'lishi kerak.",
		...
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'Modeldagi harorat. Haroratni oshirish modelni yanada ijodiy javob berishga majbur qiladi.',
		...
		'This action cannot be undone. Do you wish to continue?':
			'Bu amalni ortga qaytarib bo‘lmaydi. Davom etishni xohlaysizmi?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'Bu kanal {{createdAt}} da yaratilgan. Bu {{channelName}} kanalining boshlanishi.',
		"This chat won't appear in history and your messages will not be saved.": '',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			"Bu sizning qimmatli suhbatlaringiz ma'lumotlar bazasiga xavfsiz tarzda saqlanishini ta'minlaydi. Rahmat!",
		...
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			"Bu eksperimental xususiyat bo'lib, u kutilganidek ishlamasligi va istalgan vaqtda o'zgarishi mumkin.",
		'This model is not publicly available. Please select another model.':
			'Ushbu model hamma uchun ochiq emas. Iltimos, boshqa modelni tanlang.',
		...
		'This option sets the maximum number of tokens the model can generate in its response. Increasing this limit allows the model to provide longer answers, but it may also increase the likelihood of unhelpful or irrelevant content being generated.':
			"Ushbu parametr model javobida yaratishi mumkin bo'lgan tokenlarning maksimal sonini belgilaydi. Ushbu chegarani oshirish modelga uzoqroq javoblarni taqdim etish imkonini beradi, biroq u foydasiz yoki ahamiyatsiz kontent yaratilish ehtimolini ham oshirishi mumkin.",
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			"Ushbu parametr to'plamdagi barcha mavjud fayllarni o'chiradi va ularni yangi yuklangan fayllar bilan almashtiradi.",
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Bu <strong>{{NAME}}</strong> va <strong>barcha mazmunini</strong> o‘chirib tashlaydi.',
		'This will delete all models including custom models':
			"Bu barcha modellarni, shu jumladan maxsus modellarni o'chirib tashlaydi",
		'This will delete all models including custom models and cannot be undone.':
			'Bu barcha modellarni, jumladan, maxsus modellarni ham o‘chirib tashlaydi va ularni ortga qaytarib bo‘lmaydi.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Bu bilimlar bazasini qayta tiklaydi va barcha fayllarni sinxronlashtiradi. Davom etishni xohlaysizmi?',
		...
		'To access the available model names for downloading,':
			'Yuklab olish uchun mavjud model nomlariga kirish uchun,',
		'To access the GGUF models available for downloading,':
			"Yuklab olish mumkin bo'lgan GGUF modellariga kirish uchun,",
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			"WebUI-ga kirish uchun administrator bilan bog'laning. Administratorlar foydalanuvchi holatini Administrator panelidan boshqarishi mumkin.",
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Bu yerda bilimlar bazasini biriktirish uchun avval ularni “Bilim” ish maydoniga qo‘shing.',
		'To learn more about available endpoints, visit our documentation.':
			"Mavjud so'nggi nuqtalar haqida ko'proq bilish uchun hujjatlarimizga tashrif buyuring.",
		'To select skills here, add them to the "Skills" workspace first.': '',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Bu yerda asboblar to‘plamini tanlash uchun avval ularni “Asboblar” ish maydoniga qo‘shing.',
		...
		'Tools are a function calling system with arbitrary code execution':
			"Asboblar - bu o'zboshimchalik bilan kod bajarilishi bilan funksiyalarni chaqirish tizimi",
		...
		'Type Hugging Face Resolve (Download) URL':
			'Hugging Face Resolve (Yuklab olish) URL manzilini kiriting',
		...
		'Update for the latest features and improvements.':
			'Eng yangi xususiyatlar va yaxshilanishlar uchun yangilang.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Kengaytirilgan imkoniyatlar, jumladan, maxsus mavzulashtirish va brendlash hamda maxsus yordam uchun litsenziyalangan rejaga yangilang.',
		Upload: os,
		...
		'Use no proxy to fetch page contents.':
			'Sahifa mazmunini olish uchun proksi-serverdan foydalanmang.',
		'Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.':
			'Sahifa mazmunini olish uchun http_proxy va https_proxy muhit oʻzgaruvchilari tomonidan belgilangan proksi-serverdan foydalaning.',
		user: ls,
		User: ds,
		'User Activity': '',
		'User Groups': '',
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			"Barcha modellar bilan standart arena modelidan foydalanish. Maxsus modellarni qo'shish uchun ortiqcha tugmasini bosing.",
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'{{totalVersions}} versiyasining {{selectedVersion}} versiyasi',
		'Version deleted': '',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Ogohlantirish: Buni yoqish foydalanuvchilarga serverga ixtiyoriy kodni yuklash imkonini beradi.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			"Ogohlantirish: Jupyter ijrosi o'zboshimchalik bilan kod bajarilishini ta'minlaydi, bu xavfsizlikka jiddiy xavf tug'diradi - juda ehtiyotkorlik bilan davom eting.",
		We_day_of_week: qs,
		Web: As,
		'Web API': 'Web API',
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			"Yoqilganda, model real vaqt rejimida har bir chat xabariga javob beradi va foydalanuvchi xabar yuborishi bilanoq javob hosil qiladi. Ushbu rejim jonli chat ilovalari uchun foydalidir, lekin sekinroq uskunaning ishlashiga ta'sir qilishi mumkin.",
		...
		'Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.':
			'Chiqishni sahifalash kerakmi. Har bir sahifa gorizontal qoida va sahifa raqami bilan ajratiladi. Birlamchi parametrlar False.',
		...
		'Works together with top-k. A higher value (e.g., 0.95) will lead to more diverse text, while a lower value (e.g., 0.5) will generate more focused and conservative text.':
			"Top-k bilan birga ishlaydi. Yuqori qiymat (masalan, 0,95) matnning xilma-xilligiga olib keladi, pastroq qiymat esa (masalan, 0,5) ko'proq diqqatli va konservativ matnni yaratadi.",
		Workspace: xs,
		'Workspace Permissions': 'Ish maydoni ruxsatnomalari',
		Write: Us,
		'Write a summary in 50 words that summarizes {{topic}}.':
			"[mavzu yoki kalit so'zni] umumlashtiruvchi 50 ta so'zdan iborat xulosa yozing.",
...
masalan: siz Super Mario Bros dagi Mario bo‘lib, assistent sifatida harakat qilyapsiz.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'Siz hozirda sinov litsenziyasidan foydalanmoqdasiz. Litsenziyangizni yangilash uchun qoʻllab-quvvatlash xizmatiga murojaat qiling.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			"Siz bir vaqtning o'zida ko'pi bilan {{maxCount}} ta fayl(lar) bilan suhbatlashishingiz mumkin.",
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			'Quyidagi “Boshqarish” tugmasi orqali xotiralar qo‘shish orqali LLMlar bilan o‘zaro aloqalaringizni shaxsiylashtirishingiz mumkin, bu ularni yanada foydaliroq va sizga moslashtiradi.',
		...
		'Your account status is currently pending activation.':
			'Hisobingiz holati hozirda faollashtirishni kutmoqda.',
		'Your browser does not support the audio tag.': '',
		'Your browser does not support the video tag.': '',
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			"Sizning barcha hissangiz to'g'ridan-to'g'ri plagin ishlab chiqaruvchisiga o'tadi; Open WebUI hech qanday foizni olmaydi. Biroq, tanlangan moliyalashtirish platformasi o'z to'lovlariga ega bo'lishi mumkin.",
...
//# sourceMappingURL=cqrSow0Q.js.map
