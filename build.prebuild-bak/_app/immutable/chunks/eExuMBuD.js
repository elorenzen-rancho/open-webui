import { L as s } from './COV9u0MG.js';
import { s as n, t as r, L as o, a as P, i as Q, g as a, f as i, b as c } from './chV95BsE.js';
const g = n({
		String: r.string,
		Number: r.number,
		'True False': r.bool,
...
const u = P.define({
	...
	parser: p.configure({
		props: [
			Q.add({ Object: a({ except: /^\s*\}/ }), Array: a({ except: /^\s*\]/ }) }),
			i.add({ 'Object Array': c })
		]
	}),
...
//# sourceMappingURL=eExuMBuD.js.map
