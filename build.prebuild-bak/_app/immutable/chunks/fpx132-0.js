...
import { html as h } from './DDyF20IL.js';
import { L as k, E as f, a as w } from './COV9u0MG.js';
const X = 1,
	T = 2,
	y = 3,
	U = 155,
	...
	return B.configure(
		{
			wrap: m((i) =>
				i.type.isTop
					? { parser: O.parser, overlay: (t) => t.name == 'Text' || t.name == 'RawText' }
					: null
			)
		},
		'jinja'
...
export { H as closePercentBrace, eO as jinja, I as jinjaCompletionSource, J as jinjaLanguage };
//# sourceMappingURL=fpx132-0.js.map
