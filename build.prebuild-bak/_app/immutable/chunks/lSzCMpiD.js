const e = 'À propos',
	...
	za = {
		...
		'*Prompt node ID(s) are required for image generation':
			"*Les ID de noeud du prompt sont nécessaires pour la génération d'images",
		'1 hour before': '',
		'1 Source': '',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Êtes-vous sûr de vouloir désarchiver toutes les conversations archivées?',
		...
		"don't fetch random pipelines from sources you don't trust.":
			'Ne récupérez pas des pipelines aléatoires à partir de sources non fiables.',
		...
		'Enter Document Intelligence Endpoint':
			"Entrez le point d'extension d'Intelligence documentaire",
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			"Entrez l'URL du proxy (par ex. https://use:password@host:port)",
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			"Inclure le drapeau `--api-auth` lors de l'exécution de stable-diffusion-webui",
		'Include `--api` flag when running stable-diffusion-webui':
			'Inclure le drapeau `--api` lorsque vous exécutez stable-diffusion-webui',
		...
		'Model {{modelName}} is not vision capable':
			"Le modèle {{modelName}} n'a pas de capacités visuelles",
		...
		'Model can execute code and perform calculations':
			'Le modèle peut executer du code et faire des calculs',
		'Model can generate images based on text prompts':
			'Le modèle peut générer des images à partir des prompts textuels',
		...
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Seules les collections peuvent être modifiées, créez une nouvelle base de connaissance pour modifier/ajouter des documents.',
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Applique un biais uniforme contre les jetons déjà apparus. Une valeur élevée (ex. : 1,5) pénalise fortement les répétitions, une valeur faible (ex. : 0,9) les tolère davantage. À 0, ce réglage est désactivé.',
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			"Applique un biais progressif contre les jetons en fonction de leur fréquence d'apparition. Une valeur plus élevée les pénalise davantage ; une valeur plus faible est plus indulgente. À 0, ce réglage est désactivé.",
		...
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			"Le classement d'évaluation est basé sur le système de notation Elo et est mis à jour en temps réel.",
		...
		'The LDAP attribute that maps to the mail that users use to sign in.':
			"L'attribut LDAP qui correspond au courriel que les utilisateurs utilisent pour se connecter.",
		...
		'This option sets the maximum number of tokens the model can generate in its response. Increasing this limit allows the model to provide longer answers, but it may also increase the likelihood of unhelpful or irrelevant content being generated.':
			'Cette option définit le nombre maximal de Token que le modèle peut générer dans sa réponse. Une valeur plus élevée permet des réponses plus longues, mais peut aussi générer du contenu moins pertinent.',
		...
		'User location successfully retrieved.':
			"L'emplacement de l'utilisateur a été récupéré avec succès.",
...
p. ex. : Vous êtes Mario de Super Mario Bros et vous agissez comme assistant.`,
		...
		'You do not have permission to upload files.':
			"Vous n'avez pas l'autorisation de téléverser des fichiers",
...
//# sourceMappingURL=lSzCMpiD.js.map
