function fr(x) {
	...
	function a() {
		var r = i.state;
		r.lexical.prev &&
			(r.lexical.type == ')' && (r.indented = r.lexical.indented), (r.lexical = r.lexical.prev));
	}
	a.lex = !0;
	function l(r) {
		function e(t) {
	...
	function ir(r, e) {
		return r == '{'
			? R(ir, '}')
			: (r == 'variable' && q(e), e == '*' && (i.marked = 'keyword'), n(ae));
	}
	function Ir(r) {
		if (r == ',') return n(ir, Ir);
	}
	...
	return {
		...
		token: function (r, e) {
			...
			return D == 'comment'
				? t
				: ((e.lastType = D == 'operator' && (G == '++' || G == '--') ? 'incdec' : D),
					Mr(e, t, D, G, r));
		},
		indent: function (r, e, t) {
			...
			for (
				...
				(f == '}' ||
					((c = r.cc[r.cc.length - 1]) && (c == I || c == B) && !/^[,\.=+\-*:?[\(]/.test(e)));
			)
				u = u.prev;
...
//# sourceMappingURL=qCveANmP.js.map
