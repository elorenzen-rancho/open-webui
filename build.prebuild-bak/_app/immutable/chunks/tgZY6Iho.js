const e = 'Hakkında',
	...
	Bl = {
		'-1 for no limit, or a positive integer for a specific limit':
			'Sınır yoksa -1, belirli bir sınır için pozitif bir tamsayı.',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' veya süresiz için '-1'.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(örn. `sh webui.sh --api --api-auth username_password`)',
		...
		'{{LOCALIZED_DATE}} at {{LOCALIZED_TIME}}':
			'{{LOCALIZED_DATE}} tarihinde saat {{LOCALIZED_TIME}}',
		...
		'*Prompt node ID(s) are required for image generation':
			"*Görüntü oluşturma için düğüm ID'leri gereklidir",
		'1 hour before': '',
		'1 Source': '1 Kaynak',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A collaboration channel where people join as members':
			'İnsanların üye olarak katıldığı bir iş birliği kanalı',
		'A discussion channel where access is controlled by groups and permissions':
			'Erişimin gruplar ve izinlerle kontrol edildiği bir tartışma kanalı',
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Yeni bir sürüm (v{{LATEST_VERSION}}) artık mevcut.',
		'A private conversation between you and selected users':
			'Sizinle seçili kullanıcılar arasında özel bir konuşma',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Bir görev modeli, sohbetler ve web arama sorguları için başlık oluşturma gibi görevleri yerine getirirken kullanılır',
...
Prompt Değişkenine Git`,
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Sohbet girişine "/{{COMMAND}}" yazarak bu komutu etkinleştirin.',
		Active: l,
		...
		'Add a short description about what this model does':
			'Bu modelin ne yaptığı hakkında kısa bir açıklama ekleyin',
		...
		'Add your Open Terminal URL and API key in Settings → Integrations.':
			"Open Terminal URL'nizi ve API anahtarınızı Ayarlar → Entegrasyonlar bölümünde girin.",
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Bu ayarların yapılması, değişiklikleri tüm kullanıcılara evrensel olarak uygulayacaktır.',
		admin: d,
		Admin: m,
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Yöneticiler her zaman tüm araçlara erişebilir; kullanıcıların çalışma alanındaki model başına atanmış araçlara ihtiyacı vardır.',
		Advanced: u,
		...
		'Allowed file extensions for upload. Separate multiple extensions with commas. Leave empty for all file types.':
			'Yükleme için izin verilen dosya uzantıları. Birden fazla uzantıyı virgülle ayırın. Tüm dosya türleri için boş bırakın.',
		...
		'API Base URL for Datalab Marker service. Defaults to: https://www.datalab.to/api/v1/marker':
			"Datalab Marker hizmeti için API temel URL'si. Varsayılan: https://www.datalab.to/api/v1/marker",
		...
		'applies to all users with the "user" role':
			'"kullanıcı" rolüne sahip tüm kullanıcılar için geçerlidir',
		April: f,
		Archive: S,
		...
		'Are you sure you want to archive all chats? This action cannot be undone.':
			'Tüm sohbetleri arşivlemek istediğinizden emin misiniz? Bu işlem geri alınamaz.',
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Tüm bellekleri temizlemek istediğinizden emin misiniz? Bu işlem geri alınamaz.',
		...
		"Are you sure you want to delete this version? Child versions will be relinked to this version's parent.":
			'Bu sürümü silmek istediğinizden emin misiniz? Alt sürümler bu sürümün üst sürümüne yeniden bağlanacaktır.',
		'Are you sure you want to delete this?': '',
		'Are you sure you want to unarchive all archived chats?':
			'Arşivlenmiş tüm sohbetlerin arşivini kaldırmak istediğinizden emin misiniz?',
		...
		'Autocomplete Generation Input Max Length':
			'Otomatik Tamamlama Üretimi Maksimum Uzunlukta Giriş',
		Automatic1111: U,
		...
		'Call feature is not supported when using Web STT engine':
			'Web STT motoru kullanılırken arama özelliği desteklenmiyor',
		Camera: q,
		Cancel: Z,
		...
		'Character limit for autocomplete generation input':
			'Otomatik tamamlama üretimi girişi için karakter sınırı',
		...
		'Chunks smaller than this threshold will be merged with neighboring chunks when possible. Set to 0 to disable merging.':
			'Bu eşiğin altındaki parçalar mümkün olduğunda komşu parçalarla birleştirilir. Birleştirmeyi devre dışı bırakmak için 0 yapın.',
		Ciphers: te,
		Citation: le,
		Citations: oe,
		...
		'Click here to download user import template file.':
			'Kullanıcı içe aktarma şablon dosyasını indirmek için buraya tıklayın.',
		'Click here to learn more about faster-whisper and see the available models.':
			'faster-whisper hakkında daha fazla bilgi edinmek ve mevcut modelleri görmek için buraya tıklayın.',
		...
		'Click here to upload a workflow.json file.':
			'Bir workflow.json dosyası yüklemek için buraya tıklayın.',
		'click here.': 'buraya tıklayın.',
		"Click on the user role button to change a user's role.":
			'Bir kullanıcının rolünü değiştirmek için kullanıcı rolü düğmesine tıklayın.',
		'Click to connect': '',
		'Click to copy ID': 'Kimliği kopyalamak için tıklayın',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Panoya yazma izni reddedildi. Tarayıcı ayarlarını kontrol ederek gerekli izinleri sağlayabilirsiniz.',
		Clone: se,
		...
		'Connect to an AI provider to start chatting':
			'Sohbete başlamak için bir AI sağlayıcısına bağlanın',
		'Connect to Open Terminal instances to browse files and use them as always-on tools. Only one can be active at a time.':
			'Dosyalara göz atmak ve bunları her zaman açık araçlar olarak kullanmak için Open Terminal örneklerine bağlanın. Aynı anda yalnızca biri etkin olabilir.',
		'Connect to Open Terminal instances. All users will have access to file browsing and terminal tools through these servers.':
			'Open Terminal örneklerine bağlanın. Tüm kullanıcılar bu sunucular üzerinden dosya gezintisine ve terminal araçlarına erişebilecek.',
		'Connect to your own OpenAI compatible API endpoints.':
			'Kendi OpenAI uyumlu API uç noktalarınıza bağlanın.',
		'Connect to your own OpenAPI compatible external tool servers.':
			'Kendi OpenAPI uyumlu harici araç sunucularınıza bağlanın.',
		'Connected ({{type}})': '',
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Mesaj metninin TTS istekleri için nasıl bölüneceğini kontrol edin. 'Noktalama' cümlelere, 'paragraflar' paragraflara böler ve 'hiçbiri' mesajı tek bir dize olarak tutar.",
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'Open WebUI’dan gelen isteklerin kabul edilebilmesi için sağlayıcının CORS yapılandırmasının doğru şekilde yapılmış olması gerekir.',
		...
		'Create your first note by clicking on the plus button below.':
			'İlk notunuzu aşağıdaki artı düğmesine basarak oluşturun.',
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			'Varsayılan mod, araçları yürütmeden önce bir kez çağırarak daha geniş bir model yelpazesiyle çalışır. Yerel mod, modelin yerleşik araç çağırma yeteneklerinden yararlanır, ancak modelin bu özelliği doğal olarak desteklemesini gerektirir.',
		...
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			'Odaklanmış ve ilgili içerik çıkarımı için varsayılan olarak bölümlenmiş alma kullanılır, çoğu durum için bu önerilir.',
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'Doğrudan Bağlantılar, kullanıcıların kendi OpenAI uyumlu API uç noktalarına bağlanmasına olanak tanır.',
		...
		'Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.':
			"PDF'den görsel çıkarmayı devre dışı bırakır. LLM Kullan etkinse görseller otomatik olarak altyazılanır. Varsayılan olarak False.",
		Disabled: je,
		'Disconnect OAuth': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			"Open WebUI'yi nasıl kullanacağınızı keşfedin ve topluluktan destek alın.",
		'Discover wonders': 'Harikaları keşfedin',
		'Discover, download, and explore custom functions':
			'Özel fonksiyonları keşfedin, indirin ve inceleyin',
		...
		'Discussion channel where access is based on groups and permissions':
			'Erişimin gruplar ve izinlere dayandığı bir tartışma kanalı',
		Display: Je,
		...
		'Displays status updates (e.g., web search progress) in the response':
			'Yanıtta durum güncellemelerini gösterir (ör. web arama ilerlemesi)',
		'Dive into knowledge': 'Bilgiye dalmak',
		'Do not install functions from sources you do not fully trust.':
			'Tamamen güvenmediğiniz kaynaklardan fonksiyonlar yüklemeyin.',
		'Do not install tools from sources you do not fully trust.':
			'Tamamen güvenmediğiniz kaynaklardan araçlar yüklemeyin.',
		'Do you want to sync your usage stats with Open WebUI Community?':
			'Kullanım istatistiklerinizi Open WebUI Community ile senkronize etmek istiyor musunuz?',
		Docling: qe,
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'herhangi bir harici bağlantı yapmaz ve verileriniz güvenli bir şekilde yerel olarak barındırılan sunucunuzda kalır.',
		'Domain Filter List': 'Alan Adı Filtre Listesi',
		"don't fetch random pipelines from sources you don't trust.":
			'Güvenmediğiniz kaynaklardan rastgele pipelines getirmeyin.',
		"Don't have an account?": 'Hesabınız yok mu?',
		"don't install random functions from sources you don't trust.":
			'Tanımadığınız kaynaklardan rastgele fonksiyonlar yüklemeyin.',
		"don't install random tools from sources you don't trust.":
			'Tanımadığınız kaynaklardan rastgele araçlar yüklemeyin.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"örn. '30s', '10m'. Geçerli zaman birimleri 's', 'm', 'h'.",
		...
		'e.g. A filter to remove profanity from text':
			'örn. Metinden küfürleri kaldırmak için bir filtre',
		...
		'e.g. Step-by-step instructions for code reviews':
			'örn. Kod incelemeleri için adım adım talimatlar',
		'e.g. Tell me a fun fact': 'örn. Bana eğlenceli bir bilgi söyle',
		'e.g. Tell me a fun fact about the Roman Empire':
			'örn. Bana Roma İmparatorluğu hakkında eğlenceli bir bilgi söyle',
		'e.g. Tools for performing various operations':
			'örn. Çeşitli işlemleri gerçekleştirmek için araçlar',
		...
		'e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)':
			'örn. audio/wav,audio/mpeg,video/* (varsayılan için boş bırakın)',
		'e.g., en-US,ja-JP (leave blank for auto-detect)':
			'örn. en-US, ja-JP (otomatik tanıma için boş bırakın)',
		...
		'Enable autocomplete generation for chat messages':
			'Sohbet mesajları için otomatik tamamlama üretimini etkinleştir',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'CSV dosyanızın şu sırayla 4 sütun içerdiğinden emin olun: İsim, E-posta, Şifre, Rol.',
		'Enter {{role}} message here': 'Buraya {{role}} mesajını girin',
		'Enter a detail about yourself for your LLMs to recall':
			"LLM'lerinizin hatırlaması için kendiniz hakkında bir bilgi girin",
		'Enter a title for the pending user info overlay. Leave empty for default.':
			'Bekleyen kullanıcı bilgi katmanı için bir başlık girin. Varsayılan için boş bırakın.',
		'Enter a watermark for the response. Leave empty for none.':
			'Yanıt için bir filigran girin. Yoksa boş bırakın.',
		'Enter additional headers in JSON format': 'JSON formatında ek başlıklar girin',
		'Enter additional headers in JSON format (e.g. {"X-Custom-Header": "value"}':
			'JSON formatında ek başlıklar girin (örn. {"X-Custom-Header": "value"})',
		...
		'Enter api auth string (e.g. username:password)':
			'Api auth dizesini girin (örn. kullanıcı adı:parola)',
		...
		'Enter comma-separated "token:bias_value" pairs (example: 5432:100, 413:-100)':
			'Virgülle ayrılmış "token:bias_value" çiftlerini girin (örnek: 5432:100, 413:-100)',
		'Enter content for the pending user info overlay. Leave empty for default.':
			'Bekleyen kullanıcı bilgi katmanı için içerik girin. Varsayılan için boş bırakın.',
		...
		'Enter domains separated by commas (e.g., example.com,site.org,!excludedsite.com)':
			'Virgülle ayrılmış alan adlarını girin (örn., example.com,site.org,!excludedsite.com)',
		...
		'Enter function name filter list (e.g. func1, !func2)':
			'Fonksiyon adı filtre listesini girin (örn. func1, !func2)',
		...
		'Enter JSON config (e.g., {"disable_links": true})':
			'JSON yapılandırması girin (örn., {"disable_links": true})',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			"Vekil sunucu URL'sini girin (örn. https://user:password@host:port)",
		...
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			"WebUI'nizin herkese açık URL'sini girin. Bu URL, bildirimlerdeki bağlantıları oluşturmak için kullanılacaktır.",
		...
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			"Yacy URL'sini Girin (örn. http://yacy.example.com:8090)",
		...
		"Error: A model with the ID '{{modelId}}' already exists. Please select a different ID to proceed.":
			"Hata: '{{modelId}}' ID'sine sahip bir model zaten mevcut. Devam etmek için lütfen farklı bir ID seçin.",
		'Error: Model ID cannot be empty. Please enter a valid ID to proceed.':
			"Hata: Model ID'si boş olamaz. Devam etmek için lütfen geçerli bir ID girin.",
		Evaluations: ha,
		'Event created': '',
		'Event deleted': '',
		'Event title': '',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Örnek: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Örnek: sAMAccountName or uid or userPrincipalName',
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'{{URL}} OpenAPI araç sunucusuna bağlanılamadı',
		...
		'Failed to load DOCX file. Please try downloading it instead.':
			'DOCX dosyası yüklenemedi. Lütfen bunun yerine indirmeyi deneyin.',
		'Failed to load Excel/CSV file. Please try downloading it instead.':
			'Excel/CSV dosyası yüklenemedi. Lütfen bunun yerine indirmeyi deneyin.',
		...
		'Failed to load PPTX file. Please try downloading it instead.':
			'PPTX dosyası yüklenemedi. Lütfen bunun yerine indirmeyi deneyin.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Parmak izi sahteciliği tespit edildi: Avatar olarak baş harfler kullanılamıyor. Varsayılan profil resmine dönülüyor.',
		...
		'Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.':
			"PDF'nin tüm sayfalarında OCR zorla. PDF'lerinizde iyi metin varsa bu daha kötü sonuçlara yol açabilir. Varsayılan olarak False.",
		...
		'Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.':
			'Çıktıdaki satırları biçimlendir. Varsayılan olarak False. True olarak ayarlanırsa, satırlar satır içi matematik ve stilleri algılamak için biçimlendirilecektir.',
		...
		'Forwards system user OAuth access token to authenticate':
			'Kimlik doğrulamak için sistem kullanıcı OAuth erişim belirtecini iletir',
		'Forwards system user session credentials to authenticate':
			'Kimlik doğrulamak için sistem kullanıcı oturum kimlik bilgilerini iletir',
		Fr_day_of_week: Na,
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Eylemimin sonuçlarını okuduğumu ve anladığımı kabul ediyorum. Rastgele kod çalıştırmayla ilgili risklerin farkındayım ve kaynağın güvenilirliğini doğruladım.',
		ID: cn,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'stable-diffusion-webui çalıştırılırken `--api-auth` bayrağını dahil edin',
		'Include `--api` flag when running stable-diffusion-webui':
			'stable-diffusion-webui çalıştırılırken `--api` bayrağını dahil edin',
		...
		'Instant Auto-Send After Voice Transcription':
			'Ses Transkripsiyonundan Sonra Anında Otomatik Gönder',
		Instructions: vn,
		Integration: Pn,
		Integrations: wn,
		Interface: Tn,
		...
		'Invalid JSON format for ComfyUI Edit Workflow.':
			'ComfyUI Düzenleme İş Akışı için geçersiz JSON formatı.',
		...
		'Learn more about OpenAPI tool servers.':
			'OpenAPI araç sunucuları hakkında daha fazla bilgi edinin.',
		'Learn more about Voxtral transcription.': '',
		'Leave a public review for {{modelName}}':
			'{{modelName}} için herkese açık değerlendirme yapın',
		...
		'Leave empty to include all models or select specific models':
			'Tüm modelleri dahil etmek için boş bırakın veya belirli modelleri seçin',
		...
		'Leave empty to use the default config, or enter a valid json (see https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)':
			'Varsayılan yapılandırmayı kullanmak için boş bırakın veya geçerli bir JSON girin (bkz. https://yandex.cloud/en/docs/search-api/api-ref/WebSearch/search#yandex.cloud.searchapi.v2.WebSearchRequest)',
		'Leave empty to use the default model (voxtral-mini-latest).':
			'Varsayılan modeli kullanmak için boş bırakın (voxtral-mini-latest).',
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Varsayılan promptu kullanmak için boş bırakın veya özel bir prompt girin',
		...
		'Limit concurrent search queries. 0 = unlimited (default). Set to 1 for sequential execution (recommended for APIs with strict rate limits like Brave free tier).':
			"Eşzamanlı arama sorgularını sınırla. 0 = sınırsız (varsayılan). Sıralı yürütme için 1 olarak ayarlayın (Brave ücretsiz katman gibi katı oran sınırlarına sahip API'ler için önerilir).",
		...
		'LLMs can make mistakes. Verify important information.':
			"LLM'ler hata yapabilir. Önemli bilgileri doğrulayın.",
		Loader: Yn,
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			"ComfyUI'dan API formatında bir workflow.json dosyası olarak dışa aktardığınızdan emin olun.",
		Male: qn,
		Manage: Zn,
		'Manage Connections': '',
		...
		'Maximum number of files per folder is {{max}}.':
			'Klasör başına maksimum dosya sayısı {{max}}.',
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Aynı anda en fazla 3 model indirilebilir. Lütfen daha sonra tekrar deneyin.',
		May: $n,
		MBR: ei,
		MCP: ai,
		...
		'Memories accessible by LLMs will be shown here.':
			"LLM'ler tarafından erişilebilen bellekler burada gösterilecektir.",
		Memory: li,
		...
		'Message rating should be enabled to use this feature':
			'Bu özelliği kullanmak için mesaj derecelendirmesi etkinleştirilmelidir',
		messages: si,
		Messages: di,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			"Bağlantınızı oluşturduktan sonra gönderdiğiniz mesajlar paylaşılmayacaktır. URL'ye sahip kullanıcılar paylaşılan sohbeti görüntüleyebilecektir.",
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"'{{modelName}}' başarıyla indirildi.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"'{{modelTag}}' zaten indirme sırasında.",
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': '',
		'Model {{modelName}} is not vision capable':
			'Model {{modelName}} görüntü yeteneğine sahip değil',
		...
		'Model can execute code and perform calculations':
			'Model kod çalıştırabilir ve hesaplamalar yapabilir',
		'Model can generate images based on text prompts':
			'Model, metin promptlarına göre görsel oluşturabilir',
		'Model can search the web for information':
			"Model bilgileri aramak için web'de arama yapabilir",
		'Model Capabilities': 'Model Yetenekleri',
		'Model created successfully!': 'Model başarıyla oluşturuldu!',
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Model dosya sistemi yolu algılandı. Güncelleme için model kısa adı gerekli, devam edilemiyor.',
		...
		'Model name already exists, please choose a different one':
			'Model adı zaten mevcut, lütfen farklı bir ad seçin',
		...
		'No expiration can pose security risks.':
			'Son kullanma tarihi olmaması güvenlik riskleri oluşturabilir.',
		...
		'No files yet. Upload files or run Python code to create them.':
			'Henüz dosya yok. Dosya yükleyin veya oluşturmak için Python kodu çalıştırın.',
		...
		'No inference engine with management support found':
			'Yönetim desteği olan çıkarım motoru bulunamadı',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Not: Minimum bir skor belirlerseniz, arama yalnızca minimum skora eşit veya daha yüksek bir skora sahip belgeleri getirecektir.',
		Notes: Di,
		...
		'Only alphanumeric characters and hyphens are allowed':
			'Yalnızca alfasayısal karakterler ve tireler kabul edilir',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Komut dizisinde yalnızca alfasayısal karakterler ve tireler kabul edilir.',
		'Only can be triggered when the chat input is in focus.': '',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Yalnızca koleksiyonlar düzenlenebilir, belgeleri düzenlemek/eklemek için yeni bir bilgi tabanı oluşturun.',
		...
		'Only select users and groups with permission can access':
			'İzinli kullanıcılar ve gruplar yalnızca erişebilir',
		'Only sync new/updated chats': '',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Hay aksi! URL geçersiz gibi görünüyor. Lütfen tekrar kontrol edin ve yeniden deneyin.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Hay aksi! Hala yüklenen dosyalar var. Yüklemenin tamamlanmasını bekleyin.',
		'Oops! There was an error in the previous response.':
			'Hay aksi! Önceki yanıtta bir hata oluştu.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			"Hay aksi! Desteklenmeyen bir yöntem kullanıyorsunuz (yalnızca önyüz). Lütfen WebUI'yi arka uçtan sunun.",
		...
		'Open Modal To Manage Floating Quick Actions':
			'Yüzen hızlı eylemleri yönetmek için pencereyi aç',
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			'Open WebUI OpenAPI tarafından sağlanan araçları kullanabilir',
		'Open WebUI uses faster-whisper internally.':
			'Open WebUI, dahili olarak faster-whisper kullanır.',
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open WebUI, SpeechT5 ve CMU Arctic konuşmacı gömme kullanır.',
		'Open WebUI version': '',
		'Open WebUI version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})':
			'Open-WebUI sürümü (v{{OPEN_WEBUI_VERSION}}) gerekli sürümden (v{{REQUIRED_VERSION}}) düşük',
		OpenAI: Gi,
		...
		'Permission denied when accessing microphone: {{error}}':
			'Mikrofona erişim izni reddedildi: {{error}}',
		Permissions: er,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines, keyfi kod çalıştırmaya izin veren bir eklenti sistemidir —',
		...
		'Please carefully review the following warnings:':
			'Lütfen aşağıdaki uyarıları dikkatlice inceleyin:',
		...
		'Please do not close the settings page while loading the model.':
			'Lütfen model yüklenirken ayarlar sayfasını kapatmayınız.',
		...
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Kendinizden "User" olarak bahsedin (örneğin, "User İspanyolca öğreniyor")',
		'Reference Chats': '',
		Refresh: vr,
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Web sitesi izinleri reddedildiğinden yanıt bildirimleri etkinleştirilemiyor. Gerekli erişimi sağlamak için lütfen tarayıcı ayarlarınızı ziyaret edin.',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Sohbet kayıtlarının doğrudan tarayıcınızın depolama alanına kaydedilmesi artık desteklenmemektedir. Lütfen aşağıdaki butona tıklayarak sohbet kayıtlarınızı indirmek ve silmek için bir dakikanızı ayırın. Endişelenmeyin, sohbet günlüklerinizi arkayüze kolayca yeniden aktarabilirsiniz:',
		Schedule: Jr,
		...
		'Searxng search language (all, en, es, de, fr, etc.)':
			'Searxng arama dili (all, en, es, de, fr, vb.)',
		...
		'Select how to split message text for TTS requests':
			'TTS istekleri için mesaj metninin nasıl bölüneceğini seçin',
		...
		'Selected model(s) do not support image inputs':
			'Seçilen model(ler) görüntü girişlerini desteklemiyor',
		...
		'Set the default models that are automatically selected for all users when a new chat is created.':
			'Yeni bir sohbet oluşturulduğunda tüm kullanıcılar için otomatik olarak seçilen varsayılan modelleri ayarlayın.',
		'Set the models that are automatically pinned to the sidebar for all users.':
			'Tüm kullanıcılar için kenar çubuğuna otomatik olarak sabitlenen modelleri ayarlayın.',
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			"GPU'ya boşaltılacak katman sayısını ayarlayın. Bu değerin artırılması, GPU hızlandırması için optimize edilmiş modeller için performansı önemli ölçüde iyileştirebilir, ancak aynı zamanda daha fazla güç ve GPU kaynağı tüketebilir.",
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'En az bir kez ortaya çıkan tokenlere karşı düz bir sapma ayarlar. Daha yüksek bir değer (örneğin, 1.5) tekrarları daha güçlü cezalandırırken, daha düşük bir değer (örneğin, 0.9) daha hoşgörülü olacaktır. 0 olduğunda devre dışıdır.',
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Tekrarları cezalandırmak için tokenlere karşı ölçeklenebilir bir sapma ayarlar, kaç kez ortaya çıktıklarına dayanarak. Daha yüksek bir değer (örneğin, 1.5) tekrarları daha güçlü cezalandırırken, daha düşük bir değer (örneğin, 0.9) daha hoşgörülü olacaktır. 0 olduğunda devre dışıdır.',
		'Sets how far back for the model to look back to prevent repetition.':
			'Modelin tekrarı önlemek için ne kadar geriye bakması gerektiğini ayarlar.',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			'Oluşturma için kullanılacak rastgele sayı tohumunu ayarlar. Bunun belirli bir sayıya ayarlanması, modelin aynı prompt için aynı metni oluşturmasını sağlar.',
		'Sets the size of the context window used to generate the next token.':
			'Sonraki tokeni oluşturmak için kullanılan bağlam penceresinin boyutunu ayarlar.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			"Kullanılacak durma dizilerini ayarlar. Bu desenle karşılaşıldığında, LLM metin oluşturmayı durduracak ve geri dönecektir. Birden çok durma deseni, bir modelfile'da birden çok ayrı durma parametresi belirterek ayarlanabilir.",
		Setting: it,
		Settings: rt,
		...
		'Show Admin Details in Account Pending Overlay':
			'Yönetici Ayrıntılarını Hesap Bekliyor Ekranında Göster',
		...
		'Showing all messages (user + assistant) per user.':
			'Kullanıcı başına tüm mesajları (kullanıcı + asistan) gösteriliyor.',
		'Sign in': 'Oturum aç',
		...
		'Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.':
			'LLM kullanarak tabloları, formları, satır içi matematiği ve düzen algılamasını iyileştirerek doğruluğu önemli ölçüde artırır. Gecikmeyi artırır. Varsayılan olarak False.',
		...
		'Skip the cache and re-run the inference. Defaults to False.':
			'Önbelleği atlayın ve çıkarımı yeniden çalıştırın. Varsayılan olarak False.',
		...
		'Split documents by markdown headers before applying character/token splitting.':
			'Karakter/token bölme işlemi uygulamadan önce belgeleri markdown başlıklarına göre bölün.',
		...
		'Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.':
			"PDF'den mevcut OCR metnini çıkarın ve OCR'ı yeniden çalıştırın. OCR Zorla etkinleştirilirse yok sayılır. Varsayılan olarak False.",
		...
		'Successfully imported {{userCount}} users.':
			'{{userCount}} kullanıcı başarıyla içe aktarıldı.',
		...
		'Syncs only chats with updates after your last sync timestamp. Disable to re-sync all chats.':
			'Sadece son eşitleme zaman damganızdan sonraki güncellemelere sahip sohbetleri eşitler. Tüm sohbetleri yeniden eşitlemek için devre dışı bırakın.',
		System: wt,
		...
		'The Application Account DN you bind with for search':
			"Arama için bağlandığınız Uygulama Hesap DN'si",
		...
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Bu eklentinin arkasındaki geliştiriciler topluluktan tutkulu gönüllülerdir. Bu eklentinin yararlı olduğunu düşünüyorsanız, gelişimine katkıda bulunmayı düşünün.',
		...
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'MB cinsinden maksimum dosya boyutu. Dosya boyutu bu sınırı aşarsa, dosya yüklenmeyecektir.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'Sohbette aynı anda kullanılabilecek maksimum dosya sayısı. Dosya sayısı bu sınırı aşarsa, dosyalar yüklenmeyecektir.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			'',
		"The passwords you entered don't quite match. Please double-check and try again.": '',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Puan 0.0 (%0) ile 1.0 (%100) arasında bir değer olmalıdır.',
		...
		'This action cannot be undone. Do you wish to continue?':
			'Bu eylem geri alınamaz. Devam etmek istiyor musunuz?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'Bu kanal {{createdAt}} tarihinde oluşturuldu. Bu, {{channelName}} kanalının en başıdır.',
		"This chat won't appear in history and your messages will not be saved.": '',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Bu, önemli konuşmalarınızın güvenli bir şekilde arkayüz veritabanınıza kaydedildiğini garantiler. Teşekkür ederiz!',
		...
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Bu deneysel bir özelliktir, beklendiği gibi çalışmayabilir ve her an değişiklik yapılabilir.',
		...
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Bu seçenek, koleksiyondaki tüm mevcut dosyaları silecek ve bunları yeni yüklenen dosyalarla değiştirecek.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'<strong>{{NAME}}</strong> ve <strong>tüm içeriği</strong> silinecek.',
		'This will delete all models including custom models':
			'Bu, özel modeller dahil olmak üzere tüm modelleri silecek',
		'This will delete all models including custom models and cannot be undone.':
			'Bu, özel modeller dahil olmak üzere tüm modelleri silecek ve geri alınamaz.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Bu, bilgi tabanını sıfırlayacak ve tüm dosyaları senkronize edecek. Devam etmek istiyor musunuz?',
		...
		'To access the available model names for downloading,':
			'İndirilebilir mevcut model adlarına erişmek için,',
		'To access the GGUF models available for downloading,':
			'İndirilebilir mevcut GGUF modellerine erişmek için,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			"WebUI'ye erişmek için lütfen yöneticiyle iletişime geçin. Yöneticiler kullanıcı durumlarını Yönetici Panelinden yönetebilir.",
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'Bilgi tabanını buraya eklemek için önce bunları "Bilgi" çalışma alanına ekleyin.',
		'To learn more about available endpoints, visit our documentation.':
			'Mevcut uç noktalar hakkında daha fazla bilgi edinmek için belgelerimize göz atın.',
		'To select skills here, add them to the "Skills" workspace first.':
			'Burada yetenek seçmek için önce bunları "Yetenekler" çalışma alanına ekleyin.',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Araçları burada seçmek için öncelikle bunları "Araçlar" çalışma alanına ekleyin.',
		...
		'Tools are a function calling system with arbitrary code execution':
			'Araçlar, keyfi kod yürütme ile bir fonksiyon çağırma sistemine sahiptir',
		'Tools Function Calling Prompt': '',
		'Tools have a function calling system that allows arbitrary code execution.':
			'Araçlar, keyfi kod yürütme izni veren bir fonksiyon çağırma sistemine sahiptir.',
		...
		'Try adjusting your search or filter to find what you are looking for.':
			'Aradığınızı bulmak için aramanızı veya filtrenizi ayarlamayı deneyin.',
		...
		'Update for the latest features and improvements.':
			'En son özellikler ve iyileştirmeler için güncelleyin.',
		...
		'Upload Progress: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)':
			'Yükleme İlerlemesi: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Bilginizi yüklemek ve dahil etmek için prompt girişinde '#' kullanın.",
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Tüm modellerle varsayılan arena modelini kullanıyor. Özel modeller eklemek için artı düğmesine tıklayın.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Sürüm {{selectedVersion}} / {{totalVersions}}',
		'Version deleted': '',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Uyarı: Bu etkinleştirildiğinde, kullanıcıların sunucuya rastgele kod yüklemesine izin verilecektir.',
		...
		'WebUI will make requests to "{{url}}/api/chat"':
			'WebUI, "{{url}}/api/chat" adresine istek yapacak',
		'WebUI will make requests to "{{url}}/chat/completions"':
			'WebUI, "{{url}}/chat/completions" adresine istek yapacak',
		Week: Pl,
		Weekly: wl,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			'Etkinleştirildiğinde, model her sohbet mesajına gerçek zamanlı olarak yanıt verecek ve kullanıcı bir mesaj gönderdiği anda bir yanıt üretecektir. Bu mod canlı sohbet uygulamaları için yararlıdır, ancak daha yavaş donanımlarda performansı etkileyebilir.',
		...
		'Write a summary in 50 words that summarizes {{topic}}.':
			'{{topic}} konusunu özetleyen 50 kelimelik bir özet yazın.',
...
örn.: Super Mario Bros’tan Mario’sunuz ve bir asistan olarak hareket ediyorsunuz.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'Şu anda deneme lisansı kullanıyorsunuz. Lisansınızı yükseltmek için lütfen destek ile iletişime geçin.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Aynı anda en fazla {{maxCount}} dosya ile sohbet edebilirsiniz.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Aşağıdaki 'Yönet' düğmesi aracılığıyla bellekler ekleyerek LLM'lerle etkileşimlerinizi kişiselleştirebilir, onları daha yararlı ve size özel hale getirebilirsiniz.",
		...
		'You do not have permission to send messages in this thread.':
			'Bu konuda mesaj gönderme izniniz yok.',
		'You do not have permission to upload files to this knowledge base.':
			'Bu bilgi tabanına dosya yükleme izniniz yok.',
		...
		'Your account status is currently pending activation.':
			'Hesap durumunuz şu anda etkinleştirilmeyi bekliyor.',
		...
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			'Tüm katkınız doğrudan eklenti geliştiricisine gidecektir; Open WebUI herhangi bir yüzde almaz. Ancak seçilen finansman platformunun kendi ücretleri olabilir.',
		'Your message text or inputs': 'Mesaj metniniz veya girdileriniz',
		'Your usage stats have been successfully synced.':
			'Kullanım istatistikleriniz başarıyla eşitlendi.',
		YouTube: Ll,
...
//# sourceMappingURL=tgZY6Iho.js.map
