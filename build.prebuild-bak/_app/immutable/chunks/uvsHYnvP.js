...
import { s as H } from './BX5WB7ra.js';
import { o as Mt } from './D9kC5om8.js';
import { c as Nt } from './Cc3OSVma.js';
const It = Nt('4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab');
function ct(t, n) {
	let s;
	if (n === void 0) for (const a of t) a != null && (s < a || (s === void 0 && a >= a)) && (s = a);
	else {
		let a = -1;
		for (let h of t) (h = n(h, ++a, t)) != null && (s < h || (s === void 0 && h >= h)) && (s = h);
	}
	return s;
}
function pt(t, n) {
...
function nt(t, n) {
	let s = 0;
	if (n === void 0) for (let a of t) (a = +a) && (s += a);
	else {
		let a = -1;
		for (let h of t) (h = +n(h, ++a, t)) && (s += h);
	}
	return s;
}
function Pt(t) {
...
function yt({ nodes: t }) {
	for (const n of t) {
		let s = n.y0,
			a = s;
		for (const h of n.sourceLinks) ((h.y0 = s + h.width / 2), (s += h.width));
...
function Bt() {
	...
	((b.update = function (e) {
		...
		(b.nodeId = function (e) {
			return arguments.length ? ((_ = typeof e == 'function' ? e : X(e)), b) : _;
		}),
		(b.nodeAlign = function (e) {
			return arguments.length ? ((i = typeof e == 'function' ? e : X(e)), b) : i;
		}),
		...
		(b.nodes = function (e) {
			return arguments.length ? ((x = typeof e == 'function' ? e : X(e)), b) : x;
		}),
		(b.links = function (e) {
			return arguments.length ? ((v = typeof e == 'function' ? e : X(e)), b) : v;
		}),
		...
		(b.extent = function (e) {
			return arguments.length
				? ((t = +e[0][0]), (s = +e[1][0]), (n = +e[0][1]), (a = +e[1][1]), b)
				: [
						[t, n],
						[s, a]
					];
	...
	function M({ nodes: e, links: f }) {
		...
		for (const [c, r] of f.entries()) {
			...
			(typeof k != 'object' && (k = r.source = ft(u, k)),
				typeof S != 'object' && (S = r.target = ft(u, S)),
				k.sourceLinks.push(r),
				S.targetLinks.push(r));
		}
	...
	function N({ nodes: e }) {
		...
		for (; u.size; ) {
			for (const k of u) {
				k.depth = r;
				for (const { target: S } of k.sourceLinks) c.add(S);
			}
	...
	function C({ nodes: e }) {
		...
		for (; u.size; ) {
			for (const k of u) {
				k.height = r;
				for (const { source: S } of k.targetLinks) c.add(S);
			}
			if (++r > f) throw new Error('circular link');
			((u = c), (c = new Set()));
		}
	...
	function O(e, f) {
		const u = e.length >> 1,
			c = e[u];
		(g(e, c.y0 - m, u - 1, f), z(e, c.y1 + m, u + 1, f), g(e, a, e.length - 1, f), z(e, n, 0, f));
	}
	function z(e, f, u, c) {
		for (; u < e.length; ++u) {
			const r = e[u],
	...
	function A(e) {
		if (l === void 0) for (const { sourceLinks: f, targetLinks: u } of e) (f.sort(ht), u.sort(ut));
	}
	function $(e, f) {
...
ot.prototype = kt.prototype = {
	...
	bezierCurveTo: function (t, n, s, a, h, d) {
		this._ +=
			'C' + +t + ',' + +n + ',' + +s + ',' + +a + ',' + (this._x1 = +h) + ',' + (this._y1 = +d);
	},
		...
		if (this._x1 === null) this._ += 'M' + (this._x1 = t) + ',' + (this._y1 = n);
			...
			if (!(Math.abs(l * _ - i * o) > V) || !h)
				...
				var v = s - d,
					...
					D = C / N,
					R = C / T;
				(Math.abs(D - 1) > V && (this._ += 'L' + (t + D * o) + ',' + (n + D * l)),
					(this._ +=
						'A' +
						h +
						',' +
	...
	arc: function (t, n, s, a, h, d) {
		...
		(this._x1 === null
			? (this._ += 'M' + i + ',' + o)
			: (Math.abs(this._x1 - i) > V || Math.abs(this._y1 - o) > V) && (this._ += 'L' + i + ',' + o),
			s &&
				(x < 0 && (x = (x % rt) + rt),
				x > Rt
					? (this._ +=
					...
					: x > V &&
						(this._ +=
							...
							l +
							',' +
							(this._x1 = t + s * Math.cos(h)) +
							',' +
							(this._y1 = n + s * Math.sin(h)))));
	},
...
function Yt(t) {
	...
	function m() {
		...
		if (
			...
			t(
				d,
				+a.apply(this, ((i[0] = o), i)),
				+h.apply(this, i),
				+a.apply(this, ((i[0] = l), i)),
				+h.apply(this, i)
			),
			_)
		)
...
var at = (function () {
	var t = p(function (_, i, o, l) {
		...
		h = {
			...
			performAction: p(function (i, o, l, x, v, y, b) {
				var M = y.length - 1;
				switch (v) {
					case 7:
			...
			table: [
				...
				{ 1: [3] },
				{ 5: [1, 3] },
				{ 6: 4, 8: 5, 15: 6, 16: 7, 17: 8, 18: n, 20: s },
				{ 1: [2, 6], 7: 11, 10: [1, 12] },
				t(s, [2, 4], { 9: 13, 5: [1, 14] }),
				{ 12: [1, 15] },
				t(a, [2, 8]),
				...
				{ 1: [2, 5] },
				t(s, [2, 2]),
				{ 6: 17, 8: 5, 15: 6, 16: 7, 17: 8, 18: n, 20: s },
				{ 15: 18, 16: 7, 17: 8, 18: n, 20: s },
				{ 18: [1, 19] },
				t(s, [2, 3]),
				{ 12: [1, 20] },
				t(a, [2, 10]),
				{ 15: 21, 16: 7, 17: 8, 18: n, 20: s },
				t([1, 5, 10], [2, 7])
			],
			defaultActions: { 11: [2, 1], 12: [2, 5] },
			parseError: p(function (i, o) {
			...
			parse: p(function (i) {
				...
				function E() {
					...
					return (
						(L = x.pop() || w.lex() || D),
						typeof L != 'number' &&
							(L instanceof Array && ((x = L), (L = x.pop())), (L = o.symbols_[L] || L)),
						L
					);
				}
				p(E, 'lex');
				for (var A, $, I, e, f = {}, u, c, r, k; ; ) {
					if (
						(($ = l[l.length - 1]),
						this.defaultActions[$]
					...
					switch (I[0]) {
						...
						case 2:
							if (
								...
								(e = this.performAction.apply(f, [M, N, T, P.yy, I[1], v, y].concat(R))),
								typeof e < 'u')
							)
								return e;
							(c &&
								((l = l.slice(0, -1 * c * 2)), (v = v.slice(0, -1 * c)), (y = y.slice(0, -1 * c))),
...
` +
				...
				next: p(function () {
					...
					for (var v = this._currentRules(), y = 0; y < v.length; y++)
						if (
							((l = this._input.match(this.rules[v[y]])), l && (!o || l[0].length > o[0].length))
						) {
							if (((o = l), (x = y), this.options.backtrack_lexer)) {
								if (((i = this.test_match(l, v[y])), i !== !1)) return i;
								if (this._backtrack) {
									o = !1;
									continue;
								} else return !1;
					...
					return o
						? ((i = this.test_match(o, v[x])), i !== !1 ? i : !1)
						: this._input === ''
							? this.EOF
							: this.parseError(
									'Lexical error on line ' +
...
var K = at,
	...
	le = p(function (t, n, s, a) {
		const { securityLevel: h, sankey: d } = lt(),
			m = Lt.sankey;
		let _;
		h === 'sandbox' && (_ = H('#i' + n));
		const i = h === 'sandbox' ? H(_.nodes()[0].contentDocument.body) : H('body'),
			o = h === 'sandbox' ? i.select(`[id="${n}"]`) : H(`[id="${n}"]`),
...
${b}${Math.round(E * 100) / 100}${M}`
		...
		if (O === 'gradient') {
			...
			(g
				.append('stop')
				.attr('offset', '0%')
				.attr('stop-color', (E) => w(E.source.id)),
				g
					.append('stop')
					.attr('offset', '100%')
					.attr('stop-color', (E) => w(E.target.id)));
		}
		let z;
		switch (O) {
			case 'gradient':
				...
				break;
			case 'source':
				z = p((g) => w(g.source.id), 'coloring');
				break;
			case 'target':
				z = p((g) => w(g.target.id), 'coloring');
				break;
			default:
				z = O;
		}
...
//# sourceMappingURL=uvsHYnvP.js.map
