const e = 'O aplikaci',
	...
	Or = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 pro žádný limit, nebo kladné celé číslo pro specifický limit',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' nebo '-1' pro žádné vypršení.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(např. `sh webui.sh --api --api-auth username_password`)',
		'(e.g. `sh webui.sh --api`)': '(např. `sh webui.sh --api`)',
		'(latest)': '(nejnovější)',
		'(leave blank for to use commercial endpoint)':
			'(ponechte prázdné pro použití komerčního koncového bodu)',
		...
		'*Prompt node ID(s) are required for image generation':
			'*Pro generování obrázků jsou vyžadována ID uzlů instrukce',
		'1 hour before': '',
		'1 Source': '',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Nová verze (v{{LATEST_VERSION}}) je nyní k dispozici.',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'Model pro úkoly se používá při provádění úkolů, jako je generování názvů pro konverzace a vyhledávací dotazy na webu.',
		'a user': 'uživatel',
		About: e,
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Aktivujte tento příkaz napsáním "/{{COMMAND}}" do vstupního pole konverzace.',
		Active: r,
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Úprava těchto nastavení se projeví u všech uživatelů.',
		admin: d,
		Admin: c,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Administrátoři mají kdykoli přístup ke všem nástrojům; uživatelé potřebují mít nástroje přiřazené k jednotlivým modelům v pracovním prostoru.',
		Advanced: u,
		...
		'API Base URL for Datalab Marker service. Defaults to: https://www.datalab.to/api/v1/marker':
			'Základní URL adresa API pro službu Datalab Marker. Výchozí hodnota: https://www.datalab.to/api/v1/marker',
		'API Key': 'Klíč API',
		...
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Opravdu si přejete vymazat všechny vzpomínky? Tuto akci nelze vrátit zpět.',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Opravdu chcete zrušit archivaci všech archivovaných konverzací?',
		...
		'Autocomplete Generation Input Max Length':
			'Maximální délka vstupu pro generování automatického dokončování',
		Automatic1111: N,
		...
		'Base Model List Cache speeds up access by fetching base models only at startup or on settings save—faster, but may not show recent base model changes.':
			'Mezipaměť seznamu základních modelů zrychluje přístup načítáním základních modelů pouze při spuštění nebo při uložení nastavení – je to rychlejší, ale nemusí zobrazovat nedávné změny základních modelů.',
		Bearer: F,
		before: V,
		'Being lazy': 'Být líný',
		Beta: Z,
		...
		'Boosting or penalizing specific tokens for constrained responses. Bias values will be clamped between -100 and 100 (inclusive). (Default: none)':
			'Zvýhodňování nebo penalizace specifických tokenů pro omezené odpovědi. Hodnoty odchylky budou omezeny v rozmezí -100 až 100 (včetně). (Výchozí: žádné)',
		Brave: G,
		...
		'Call feature is not supported when using Web STT engine':
			'Funkce volání není podporována při použití webového STT jádra.',
		Camera: Y,
		Cancel: q,
		...
		'Character limit for autocomplete generation input':
			'Limit znaků pro vstup generování automatického dokončování',
		...
		'Click here to download user import template file.':
			'Klikněte zde pro stažení šablony souboru pro import uživatelů.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Klikněte zde, abyste se dozvěděli více o faster-whisper a prohlédli si dostupné modely.',
		...
		"Click on the user role button to change a user's role.":
			'Klikněte na tlačítko role uživatele pro změnu role uživatele.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Přístup k zápisu do schránky byl zamítnut. Prosím, zkontrolujte nastavení svého prohlížeče a udělte potřebný přístup.',
		Clone: le,
		...
		'Connect to your own OpenAI compatible API endpoints.':
			'Připojte se k vlastním koncovým bodům API kompatibilním s OpenAI.',
		'Connect to your own OpenAPI compatible external tool servers.':
			'Připojte se k vlastním externím serverům nástrojů kompatibilním s OpenAPI.',
		'Connected ({{type}})': '',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			'Omezuje úsilí při uvažování u modelů pro uvažování. Platí pouze pro modely pro uvažování od specifických poskytovatelů, kteří podporují úsilí při uvažování.',
		'Contact Admin for WebUI Access': 'Pro přístup k webovému rozhraní kontaktujte administrátora.',
		Content: we,
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Určuje, jak se text zprávy dělí pro požadavky TTS. 'Punctuation' (interpunkce) dělí na věty, 'paragraphs' (odstavce) na odstavce a 'none' (žádné) ponechá zprávu jako jeden řetězec.",
		'Control the repetition of token sequences in the generated text. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 1.1) will be more lenient. At 1, it is disabled.':
			'Řídí opakování sekvencí tokenů v generovaném textu. Vyšší hodnota (např. 1,5) bude opakování penalizovat silněji, zatímco nižší hodnota (např. 1,1) bude mírnější. Při hodnotě 1 je funkce vypnuta.',
		Controls: je,
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			'Řídí rovnováhu mezi soudržností a rozmanitostí výstupu. Nižší hodnota povede k soustředěnějšímu a soudržnějšímu textu.',
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'CORS musí být správně nakonfigurován poskytovatelem, aby povolil požadavky z Open WebUI.',
		'Could not read file.': '',
		CPU: Te,
		Create: Ue,
		...
		'Create your first note by clicking on the plus button below.':
			'Vytvořte svou první poznámku kliknutím na tlačítko plus níže.',
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			'Výchozí režim funguje s širší škálou modelů voláním nástrojů jednou před spuštěním. Nativní režim využívá vestavěné schopnosti modelu pro volání nástrojů, ale vyžaduje, aby model tuto funkci nativně podporoval.',
		...
		'Default to 389 or 636 if TLS is enabled':
			'Výchozí hodnota 389, nebo 636, pokud je povoleno TLS',
		'Default to ALL': 'Výchozí hodnota VŠE',
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			'Výchozí je segmentované vyhledávání pro cílenou a relevantní extrakci obsahu, což se doporučuje ve většině případů.',
		...
		'Deployment names are required for Azure OpenAI':
			'Pro Azure OpenAI jsou vyžadovány názvy nasazení',
		Desc: Ke,
		'Describe the edit...': '',
		'Describe the image...': '',
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'Přímá připojení umožňují uživatelům připojit se k vlastním koncovým bodům API kompatibilním s OpenAI.',
		'Direct Message': '',
		...
		'Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.':
			'Zakázat extrakci obrázků z PDF. Pokud je povoleno Použít LLM, obrázky budou automaticky opatřeny popisky. Výchozí hodnota je False.',
		Disabled: Je,
		'Disconnect OAuth': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			'Zjistěte, jak používat Open WebUI, a vyhledejte podporu od komunity.',
		'Discover wonders': 'Objevujte zázraky',
		'Discover, download, and explore custom functions':
			'Objevujte, stahujte a zkoumejte vlastní funkce',
		'Discover, download, and explore custom prompts':
			'Objevujte, stahujte a prozkoumávejte vlastní instrukce',
		'Discover, download, and explore custom tools':
			'Objevujte, stahujte a prozkoumávejte vlastní nástroje',
		'Discover, download, and explore model presets':
			'Objevujte, stahujte a prozkoumávejte přednastavení modelů',
		...
		'Display the username instead of You in the Chat':
			'Zobrazit v konverzaci uživatelské jméno místo „Vy“',
		...
		'Displays status updates (e.g., web search progress) in the response':
			'Zobrazuje aktualizace stavu (např. průběh vyhledávání na webu) v odpovědi',
		'Dive into knowledge': 'Ponořte se do znalostí',
		'Do not install functions from sources you do not fully trust.':
			'Neinstalujte funkce ze zdrojů, kterým plně nedůvěřujete.',
		'Do not install tools from sources you do not fully trust.':
			'Neinstalujte nástroje ze zdrojů, kterým plně nedůvěřujete.',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'nevytváří žádná externí připojení a vaše data zůstávají bezpečně na vašem lokálně hostovaném serveru.',
		'Domain Filter List': 'Seznam pro filtrování domén',
		"don't fetch random pipelines from sources you don't trust.":
			'Nestahujte náhodné pipelines ze zdrojů, kterým nedůvěřujete.',
		"Don't have an account?": 'Nemáte účet?',
		"don't install random functions from sources you don't trust.":
			'neinstalujte náhodné funkce ze zdrojů, kterým nedůvěřujete.',
		"don't install random tools from sources you don't trust.":
			'neinstalujte náhodné nástroje ze zdrojů, kterým nedůvěřujete.',
		...
		"e.g. '30s','10m'. Valid time units are 's', 'm', 'h'.":
			"např. '30s','10m'. Platné časové jednotky jsou 's', 'm', 'h'.",
		"e.g. 'low', 'medium', 'high'": '',
		...
		'e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)':
			'např. audio/wav,audio/mpeg,video/* (pro výchozí ponechte prázdné)',
		'e.g., en-US,ja-JP (leave blank for auto-detect)':
			'např. cs-CZ,en-US (pro automatickou detekci ponechte prázdné)',
		...
		'Enable autocomplete generation for chat messages':
			'Povolit generování automatického dokončování pro zprávy v konverzaci',
		...
		"Enable Memory Locking (mlock) to prevent model data from being swapped out of RAM. This option locks the model's working set of pages into RAM, ensuring that they will not be swapped out to disk. This can help maintain performance by avoiding page faults and ensuring fast data access.":
			'Povolit uzamčení paměti (mlock), aby se zabránilo odkládání dat modelu z RAM. Tato možnost uzamkne pracovní sadu stránek modelu v RAM, čímž zajistí, že nebudou odloženy na disk. To může pomoci udržet výkon tím, že se zabrání výpadkům stránek a zajistí rychlý přístup k datům.',
		'Enable Memory Mapping (mmap) to load model data. This option allows the system to use disk storage as an extension of RAM by treating disk files as if they were in RAM. This can improve model performance by allowing for faster data access. However, it may not work correctly with all systems and can consume a significant amount of disk space.':
			'Povolit mapování paměti (mmap) pro načítání dat modelu. Tato možnost umožňuje systému používat diskové úložiště jako rozšíření RAM tím, že se se soubory na disku zachází, jako by byly v RAM. To může zlepšit výkon modelu tím, že umožní rychlejší přístup k datům. nemusí však správně fungovat se všemi systémy a může spotřebovat značné množství místa na disku.',
		'Enable Message Queue': '',
		'Enable Message Rating': 'Povolit hodnocení zpráv',
		'Enable Mirostat sampling for controlling perplexity.':
			'Povolit vzorkování Mirostat pro řízení perplexity.',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Ujistěte se, že váš CSV soubor obsahuje 4 sloupce v tomto pořadí: Jméno, E-mail, Heslo, Role.',
		'Enter {{role}} message here': 'Zde zadejte zprávu {{role}}',
		'Enter a detail about yourself for your LLMs to recall':
			'Zadejte podrobnost o sobě, kterou si vaše LLM mají pamatovat.',
		'Enter a title for the pending user info overlay. Leave empty for default.':
			'Zadejte název pro překryvnou vrstvu s informacemi o čekajícím uživateli. Pro výchozí ponechte prázdné.',
		'Enter a watermark for the response. Leave empty for none.':
			'Zadejte vodoznak pro odpověď. Pro žádný vodoznak ponechte prázdné.',
		...
		'Enter api auth string (e.g. username:password)':
			'Zadejte ověřovací řetězec API (např. uzivatelske_jmeno:heslo)',
		...
		'Enter content for the pending user info overlay. Leave empty for default.':
			'Zadejte obsah pro překryvnou vrstvu s informacemi o čekajícím uživateli. Pro výchozí ponechte prázdné.',
		...
		'Enter JSON config (e.g., {"disable_links": true})':
			'Zadejte JSON konfiguraci (např. {"disable_links": true})',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Zadejte URL proxy (např. https://uzivatel:heslo@hostitel:port)',
		...
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'Zadejte veřejnou URL adresu vašeho WebUI. Tato URL bude použita k generování odkazů v oznámeních.',
		...
		'Enter Yacy URL (e.g. http://yacy.example.com:8090)':
			'Zadejte URL pro Yacy (např. http://yacy.priklad.com:8090)',
		...
		"Error: A model with the ID '{{modelId}}' already exists. Please select a different ID to proceed.":
			"Chyba: Model s ID '{{modelId}}' již existuje. Pro pokračování prosím zvolte jiné ID.",
		'Error: Model ID cannot be empty. Please enter a valid ID to proceed.':
			'Chyba: ID modelu nemůže být prázdné. Pro pokračování prosím zadejte platné ID.',
		Evaluations: yo,
		'Event created': '',
		'Event deleted': '',
		'Event title': '',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Příklad: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Příklad: sAMAccountName nebo uid nebo userPrincipalName',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			'Překročili jste počet míst ve vaší licenci. Pro navýšení počtu míst prosím kontaktujte podporu.',
		Exclude: bo,
		'Execute code': '',
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'Nepodařilo se připojit k serveru nástrojů OpenAPI {{URL}}',
		...
		'Failed to extract content from the file: {{error}}':
			'Nepodařilo se extrahovat obsah ze souboru: {{error}}',
		...
		'File size should not exceed {{maxSize}} MB.':
			'Velikost souboru by neměla překročit {{maxSize}} MB.',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Detekován spoofing otisku prstu: Nelze použít iniciály jako avatar. Používá se výchozí profilový obrázek.',
		...
		'Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.':
			'Vynutit OCR na všech stránkách PDF. To může vést k horším výsledkům, pokud máte v PDF kvalitní text. Výchozí hodnota je False.',
		...
		'Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.':
			'Formátovat řádky ve výstupu. Výchozí hodnota je False. Pokud je nastaveno na True, řádky budou formátovány pro detekci vložené matematiky a stylů.',
		'Formatting may be inconsistent from source.': '',
		Forward: Lo,
		'Forwards system user OAuth access token to authenticate': '',
		'Forwards system user session credentials to authenticate':
			'Přeposílá přihlašovací údaje relace systémového uživatele pro ověření',
		Fr_day_of_week: Fo,
		...
		'Get started': 'Začít',
		'Get started with {{WEBUI_NAME}}': 'Začněte s {{WEBUI_NAME}}',
		Global: Go,
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Potvrzuji, že jsem si přečetl/a a rozumím důsledkům svého jednání. Jsem si vědom/a rizik spojených se spouštěním libovolného kódu a ověřil/a jsem si důvěryhodnost zdroje.',
		ID: pt,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Při spouštění stable-diffusion-webui použijte přepínač `--api-auth`.',
		'Include `--api` flag when running stable-diffusion-webui':
			'Při spouštění stable-diffusion-webui použijte přepínač `--api`.',
		'Includes SharePoint': 'Zahrnuje SharePoint',
		'Increase UI Scale': '',
		'Influences how quickly the algorithm responds to feedback from the generated text. A lower learning rate will result in slower adjustments, while a higher learning rate will make the algorithm more responsive.':
			'Ovlivňuje, jak rychle algoritmus reaguje na zpětnou vazbu z generovaného textu. Nižší míra učení povede k pomalejším úpravám, zatímco vyšší míra učení učiní algoritmus citlivějším.',
		Info: bt,
		Initials: gt,
		'Inject file content into conversation context': '',
		'Inject the entire content as context for comprehensive processing, this is recommended for complex queries.':
			'Vložit celý obsah jako kontext pro komplexní zpracování, doporučeno pro složité dotazy.',
		Input: ft,
		...
		'Invalid JSON format for ComfyUI Workflow.':
			'Neplatný formát JSON pro pracovní postup ComfyUI.',
		...
		'Leave empty to include all models from "{{url}}" endpoint':
			'Ponechte prázdné pro zahrnutí všech modelů z koncového bodu "{{url}}"',
		'Leave empty to include all models from "{{url}}/api/tags" endpoint':
			'Ponechte prázdné pro zahrnutí všech modelů z koncového bodu "{{url}}/api/tags"',
		'Leave empty to include all models from "{{url}}/models" endpoint':
			'Ponechte prázdné pro zahrnutí všech modelů z koncového bodu "{{url}}/models"',
		'Leave empty to include all models or select specific models':
			'Ponechte prázdné pro zahrnutí všech modelů nebo vyberte konkrétní modely.',
		...
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Ponechte prázdné pro použití výchozích instrukcí, nebo zadejte vlastní instrukce.',
		'Leave model field empty to use the default model.':
			'Ponechte pole modelu prázdné pro použití výchozího modelu.',
		Legacy: xt,
		lexical: Ot,
		License: Lt,
		...
		'LLMs can make mistakes. Verify important information.':
			'LLM mohou dělat chyby. Ověřte si důležité informace.',
		Loader: Kt,
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Ujistěte se, že exportujete soubor workflow.json ve formátu API z ComfyUI.',
		Male: Yt,
		Manage: qt,
		'Manage Connections': '',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Současně lze stahovat maximálně 3 modely. Zkuste to prosím později.',
		May: $t,
		MBR: en,
		MCP: on,
		...
		'Memories accessible by LLMs will be shown here.':
			'Zde se zobrazí vzpomínky přístupné pro LLM.',
		Memory: rn,
		...
		'Message rating should be enabled to use this feature':
			'Pro použití této funkce musí být povoleno hodnocení zpráv.',
		messages: dn,
		Messages: cn,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'Zprávy, které odešlete po vytvoření odkazu, nebudou sdíleny. Uživatelé s URL adresou budou moci zobrazit sdílenou konverzaci.',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"Model '{{modelName}}' byl úspěšně stažen.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"Model '{{modelTag}}' je již ve frontě na stažení.",
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': '',
		'Model {{modelName}} is not vision capable':
			'Model {{modelName}} nemá schopnost zpracování obrazu.',
		...
		'Model can generate images based on text prompts':
			'Model umí generovat obrázky na základě textových instrukcí',
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Byla detekována cesta k souborovému systému modelu. Pro aktualizaci je vyžadován krátký název modelu, nelze pokračovat.',
		...
		'Model name already exists, please choose a different one':
			'Název modelu již existuje, zvolte prosím jiný',
		...
		'No HTML, CSS, or JavaScript content found.':
			'Nebyl nalezen žádný obsah HTML, CSS ani JavaScriptu.',
		'No inference engine with management support found':
			'Nebyl nalezeno žádné inferenční jádro s podporou správy',
		'No kernel': '',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Poznámka: Pokud nastavíte minimální skóre, vyhledávání vrátí pouze dokumenty se skóre vyšším nebo rovným minimálnímu skóre.',
		Notes: Cn,
		...
		'Only alphanumeric characters and hyphens are allowed':
			'Jsou povoleny pouze alfanumerické znaky a pomlčky',
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'V řetězci příkazu jsou povoleny pouze alfanumerické znaky a pomlčky.',
		'Only can be triggered when the chat input is in focus.': '',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Lze upravovat pouze kolekce, pro úpravu/přidání dokumentů vytvořte novou znalostní bázi.',
		...
		'Only select users and groups with permission can access':
			'Přístup mají pouze vybraní uživatelé a skupiny s oprávněním',
		'Only sync new/updated chats': '',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Jejda! Zdá se, že URL adresa je neplatná. Zkontrolujte ji prosím a zkuste to znovu.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Jejda! Některé soubory se stále nahrávají. Počkejte prosím na dokončení nahrávání.',
		'Oops! There was an error in the previous response.':
			'Jejda! V předchozí odpovědi došlo k chybě.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Jejda! Používáte nepodporovanou metodu (pouze frontend). Spusťte prosím WebUI z backendu.',
		...
		'Open Modal To Manage Floating Quick Actions':
			'Otevřít modální okno pro správu plovoucích rychlých akcí',
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			'Open WebUI může používat nástroje poskytované jakýmkoli serverem OpenAPI.',
		...
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Open WebUI používá SpeechT5 a vektorizaci mluvčích CMU Arctic.',
		'Open WebUI version': '',
		...
		'Permission denied when accessing microphone: {{error}}':
			'Přístup k mikrofonu byl odepřen: {{error}}',
		Permissions: oa,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'Pipelines je zásuvný systém s možností libovolného spouštění kódu —',
		...
		'Please carefully review the following warnings:':
			'Prosím, pečlivě si přečtěte následující varování:',
		...
		'Please do not close the settings page while loading the model.':
			'Během načítání modelu prosím nezavírejte stránku s nastavením.',
		...
		'Please wait until all files are uploaded.':
			'Prosím počkejte dokud nebudou všechny soubory nahrány.',
		'Policy ID': '',
		Port: da,
		Ports: ca,
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'Prefix ID se používá k zamezení konfliktů s jinými připojeními přidáním prefixu k ID modelů - pro vypnutí ponechte prázdné',
		...
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Odkazujte na sebe jako na "Uživatele" (např. "Uživatel se učí španělsky").',
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'Oznámení o odpovědích nelze aktivovat, protože oprávnění webu byla zamítnuta. Navštivte nastavení svého prohlížeče a udělte potřebný přístup.',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'Ukládání záznamů konverzací přímo do úložiště vašeho prohlížeče již není podporováno. Věnujte prosím chvíli stažení a smazání svých záznamů konverzací kliknutím na tlačítko níže. Nemějte obavy, své záznamy konverzací můžete snadno znovu importovat do backendu prostřednictvím',
		Schedule: Ya,
		...
		'Select how to split message text for TTS requests':
			'Vyberte, jak dělit text zprávy pro požadavky TTS',
		...
		'Selected model(s) do not support image inputs':
			'Vybraný model (modely) nepodporuje obrazové vstupy.',
		'Selected Models': '',
		semantic: es,
		Send: os,
		...
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			'Nastavte počet vrstev, které budou přesunuty na GPU. Zvýšení této hodnoty může výrazně zlepšit výkon u modelů optimalizovaných pro akceleraci na GPU, ale může také spotřebovat více energie a prostředků GPU.',
		'Set the number of worker threads used for computation. This option controls how many threads are used to process incoming requests concurrently. Increasing this value can improve performance under high concurrency workloads but may also consume more CPU resources.':
			'Nastavte počet pracovních vláken použitých pro výpočty. Tato možnost řídí, kolik vláken se používá ke souběžnému zpracování příchozích požadavků. Zvýšení této hodnoty může zlepšit výkon při vysokém souběžném zatížení, ale může také spotřebovat více prostředků CPU.',
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Nastaví plošnou penalizaci proti tokenům, které se objevily alespoň jednou. Vyšší hodnota (např. 1,5) bude opakování penalizovat silněji, zatímco nižší hodnota (např. 0,9) bude mírnější. Při hodnotě 0 je funkce vypnuta.',
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Nastaví škálovací penalizaci proti tokenům pro penalizaci opakování na základě toho, kolikrát se objevily. Vyšší hodnota (např. 1,5) bude opakování penalizovat silněji, zatímco nižší hodnota (např. 0,9) bude mírnější. Při hodnotě 0 je funkce vypnuta.',
		'Sets how far back for the model to look back to prevent repetition.':
			'Nastavuje, jak daleko zpět se má model dívat, aby se zabránilo opakování.',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			'Nastavuje semínko náhodných čísel pro generování. Nastavení na konkrétní číslo způsobí, že model bude generovat stejný text pro stejné instrukce.',
		'Sets the size of the context window used to generate the next token.':
			'Nastavuje velikost kontextového okna použitého k vygenerování dalšího tokenu.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			'Nastavuje ukončovací sekvence. Když je tento vzor nalezen, LLM přestane generovat text a vrátí výsledek. Lze nastavit více ukončovacích vzorů zadáním více samostatných parametrů stop v souboru modelfile.',
		Setting: as,
		Settings: ss,
		...
		'Show Admin Details in Account Pending Overlay':
			'Zobrazit podrobnosti administrátora v překryvné vrstvě čekajícího účtu',
		'Show All': '',
		...
		'Sign up to {{WEBUI_NAME}}': 'Zaregistrovat se do {{WEBUI_NAME}}',
		'Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.':
			'Výrazně zlepšuje přesnost použitím LLM k vylepšení tabulek, formulářů, vložené matematiky a detekce rozvržení. Zvýší latenci. Výchozí hodnota je False.',
		...
		'Skip the cache and re-run the inference. Defaults to False.':
			'Přeskočit mezipaměť a znovu spustit inferenci. Výchozí hodnota je False.',
		...
		'Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.':
			'Odstranit existující text OCR z PDF a znovu spustit OCR. Ignorováno, pokud je povoleno Vynutit OCR. Výchozí hodnota je False.',
		'STT Model': 'Model STT',
		...
		'Tail free sampling is used to reduce the impact of less probable tokens from the output. A higher value (e.g., 2.0) will reduce the impact more, while a value of 1.0 disables this setting.':
			'Vzorkování bez konce (tail free sampling) se používá ke snížení vlivu méně pravděpodobných tokenů na výstup. Vyšší hodnota (např. 2.0) sníží vliv více, zatímco hodnota 1.0 toto nastavení vypne.',
		'Talk to Model': '',
		...
		'The Application Account DN you bind with for search':
			'DN aplikačního účtu, se kterým se vážete pro vyhledávání',
		...
		'The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.':
			'Velikost dávky určuje, kolik textových požadavků se zpracovává najednou. Větší velikost dávky může zvýšit výkon a rychlost modelu, ale také vyžaduje více paměti.',
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'Vývojáři za tímto pluginem jsou nadšení dobrovolníci z komunity. Pokud vám tento plugin přijde užitečný, zvažte prosím příspěvek na jeho vývoj.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Hodnotící žebříček je založen na systému hodnocení Elo a je aktualizován v reálném čase.',
		'The format to return a response in. Format can be json or a JSON schema.':
			'Formát, ve kterém se má vrátit odpověď. Formát může být json nebo JSON schéma.',
		'The height in pixels to compress images to. Leave empty for no compression.':
			'Výška v pixelech, na kterou se mají obrázky komprimovat. Pro žádnou kompresi ponechte prázdné.',
		'The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.':
			'Jazyk vstupního zvuku. Zadání vstupního jazyka ve formátu ISO-639-1 (např. cs) zlepší přesnost a latenci. Ponechte prázdné pro automatickou detekci jazyka.',
		'The LDAP attribute that maps to the mail that users use to sign in.':
			'Atribut LDAP, který se mapuje na e-mail, který uživatelé používají k přihlášení.',
		'The LDAP attribute that maps to the username that users use to sign in.':
			'Atribut LDAP, který se mapuje na uživatelské jméno, které uživatelé používají k přihlášení.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'Žebříček je v současné době v beta verzi a můžeme upravit výpočty hodnocení, jak budeme zdokonalovat algoritmus.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'Maximální velikost souboru v MB. Pokud velikost souboru překročí tento limit, soubor nebude nahrán.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'Maximální počet souborů, které lze použít najednou v konverzaci. Pokud počet souborů překročí tento limit, soubory nebudou nahrány.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			"Výstupní formát textu. Může být 'json', 'markdown' nebo 'html'. Výchozí je 'markdown'.",
		"The passwords you entered don't quite match. Please double-check and try again.":
			'Zadaná hesla se úplně neshodují. Zkontrolujte je prosím a zkuste to znovu.',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'Skóre by mělo být hodnota mezi 0,0 (0 %) a 1,0 (100 %).',
		'The stream delta chunk size for the model. Increasing the chunk size will make the model respond with larger pieces of text at once.':
			'Velikost bloku delta streamu pro model. Zvětšení velikosti bloku způsobí, že model bude odpovídat většími kusy textu najednou.',
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'Teplota modelu. Zvýšení teploty způsobí, že model bude odpovídat kreativněji.',
		...
		'The width in pixels to compress images to. Leave empty for no compression.':
			'Šířka v pixelech, na kterou se mají obrázky komprimovat. Pro žádnou kompresi ponechte prázdné.',
		Theme: Ns,
		'There was an error syncing your stats. Please try again.': '',
		'Thinking...': 'Přemýšlím...',
		'This action cannot be undone. Do you wish to continue?':
			'Tuto akci nelze vrátit zpět. Přejete si pokračovat?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'Tento kanál byl vytvořen {{createdAt}}. Toto je úplný začátek kanálu {{channelName}}.',
		"This chat won't appear in history and your messages will not be saved.":
			'Tato konverzace se neobjeví v historii a vaše zprávy nebudou uloženy.',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Tím je zajištěno, že vaše cenné konverzace jsou bezpečně uloženy ve vaší backendové databázi. Děkujeme!',
		...
		'This feature is experimental and may be modified or discontinued without notice.':
			'Tato funkce je experimentální a může být upravena nebo zrušena bez předchozího upozornění.',
		'This folder is empty': '',
		'This is a default user permission and will remain enabled.': '',
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Toto je experimentální funkce, nemusí fungovat podle očekávání a může být kdykoli změněna.',
		'This model is not publicly available. Please select another model.':
			'Tento model není veřejně dostupný. Vyberte prosím jiný model.',
		'This option controls how long the model will stay loaded into memory following the request (default: 5m)':
			'Tato možnost řídí, jak dlouho zůstane model po požadavku načten v paměti (výchozí: 5m)',
		'This option controls how many tokens are preserved when refreshing the context. For example, if set to 2, the last 2 tokens of the conversation context will be retained. Preserving context can help maintain the continuity of a conversation, but it may reduce the ability to respond to new topics.':
			'Tato možnost řídí, kolik tokenů se zachová při obnovování kontextu. Například, pokud je nastavena na 2, poslední 2 tokeny kontextu konverzace budou zachovány. Zachování kontextu může pomoci udržet kontinuitu konverzace, ale může snížit schopnost reagovat na nová témata.',
		'This option enables or disables the use of the reasoning feature in Ollama, which allows the model to think before generating a response. When enabled, the model can take a moment to process the conversation context and generate a more thoughtful response.':
			'Tato možnost povoluje nebo zakazuje použití funkce uvažování v Ollama, která umožňuje modelu přemýšlet před generováním odpovědi. Když je povolena, model si může vzít chvíli na zpracování kontextu konverzace a vygenerovat promyšlenější odpověď.',
		'This option sets the maximum number of tokens the model can generate in its response. Increasing this limit allows the model to provide longer answers, but it may also increase the likelihood of unhelpful or irrelevant content being generated.':
			'Tato možnost nastavuje maximální počet tokenů, které může model vygenerovat ve své odpovědi. Zvýšení tohoto limitu umožňuje modelu poskytovat delší odpovědi, ale může také zvýšit pravděpodobnost generování neužitečného nebo irelevantního obsahu.',
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Tato volba smaže všechny existující soubory v kolekci a nahradí je nově nahranými soubory.',
		'This response was generated by "{{model}}"':
			'Tato odpověď byla vygenerována modelem "{{model}}"',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Tím se smaže <strong>{{NAME}}</strong> a <strong>veškerý jeho obsah</strong>.',
		'This will delete all models including custom models':
			'Tím se smažou všechny modely včetně vlastních modelů',
		'This will delete all models including custom models and cannot be undone.':
			'Tím se smažou všechny modely včetně vlastních a tuto akci nelze vrátit zpět.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Tím se resetuje znalostní báze a synchronizují se všechny soubory. Přejete si pokračovat?',
		...
		'To access the available model names for downloading,':
			'Pro přístup k dostupným názvům modelů ke stažení,',
		'To access the GGUF models available for downloading,':
			'Pro přístup k modelům GGUF dostupným ke stažení,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'Pro přístup k WebUI se prosím obraťte na administrátora. Administrátoři mohou spravovat stavy uživatelů v panelu administrátora.',
		...
		'To learn more about available endpoints, visit our documentation.':
			'Pro více informací o dostupných koncových bodech navštivte naši dokumentaci.',
		...
		'Tools are a function calling system with arbitrary code execution':
			'Nástroje jsou systémem pro volání funkcí se spouštěním libovolného kódu',
		...
		'Try adjusting your search or filter to find what you are looking for.':
			'Zkuste upravit vyhledávání nebo filtr, abyste našli to, co hledáte.',
		...
		'Update for the latest features and improvements.':
			'Aktualizujte pro nejnovější funkce a vylepšení.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Upgradujte na licencovaný plán pro rozšířené možnosti, včetně vlastních motivů a brandingu, a dedikované podpory.',
		Upload: ar,
		...
		'Upload Progress: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)':
			'Průběh nahrávání: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)',
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Použijte '#' ve vstupu promptu pro načtení a zahrnutí vašich znalostí.",
		...
		'Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.':
			'Použít proxy určenou proměnnými prostředí http_proxy a https_proxy pro načítání obsahu stránky.',
		user: lr,
		User: dr,
		'User Activity': '',
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Používá se výchozí model arény se všemi modely. Kliknutím na tlačítko plus přidáte vlastní modely.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'Verze {{selectedVersion}} z {{totalVersions}}',
		'Version deleted': '',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Varování: Povolení této volby umožní uživatelům nahrávat na server libovolný kód.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			'Varování: Spouštění Jupyteru umožňuje provádění libovolného kódu, což představuje vážná bezpečnostní rizika – postupujte s maximální opatrností.',
		We_day_of_week: zr,
		Web: Pr,
		'Web API': 'Webové API',
		...
		'WebUI will make requests to "{{url}}/api/chat"':
			'WebUI bude odesílat požadavky na "{{url}}/api/chat"',
		'WebUI will make requests to "{{url}}/chat/completions"':
			'WebUI bude odesílat požadavky na "{{url}}/chat/completions"',
		Week: Sr,
		Weekly: wr,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			'Když je povoleno, model bude odpovídat na každou zprávu v konverzaci v reálném čase a generovat odpověď, jakmile uživatel odešle zprávu. Tento režim je užitečný pro aplikace s živou konverzací, ale může ovlivnit výkon na pomalejším hardwaru.',
		...
		'Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.':
			'Zda stránkovat výstup. Každá stránka bude oddělena vodorovnou čarou a číslem stránky. Výchozí hodnota je False.',
		...
		'Works together with top-k. A higher value (e.g., 0.95) will lead to more diverse text, while a lower value (e.g., 0.5) will generate more focused and conservative text.':
			'Funguje společně s top-k. Vyšší hodnota (např. 0,95) povede k rozmanitějšímu textu, zatímco nižší hodnota (např. 0,5) vygeneruje soustředěnější a konzervativnější text.',
		Workspace: Ur,
		'Workspace Permissions': 'Oprávnění pracovního prostoru',
		Write: Er,
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Napište shrnutí na 50 slov, které shrnuje [téma nebo klíčové slovo].',
...
např.: Jste Mario ze Super Mario Bros a vystupujete jako asistent.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'V současné době používáte zkušební licenci. Pro upgrade licence prosím kontaktujte podporu.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Můžete konverzovat s maximálně {{maxCount}} souborem (soubory) najednou.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Své interakce s LLM si můžete přizpůsobit přidáním vzpomínek pomocí tlačítka 'Spravovat' níže, čímž se stanou užitečnějšími a přizpůsobenými vám.",
		...
		'Your account status is currently pending activation.':
			'Stav vašeho účtu aktuálně čeká na aktivaci.',
		'Your browser does not support the audio tag.': '',
		'Your browser does not support the video tag.': '',
		'Your entire contribution will go directly to the plugin developer; Open WebUI does not take any percentage. However, the chosen funding platform might have its own fees.':
			'Celý váš příspěvek půjde přímo vývojáři pluginu; Open WebUI si nebere žádné procento. Zvolená platforma pro financování však může mít vlastní poplatky.',
...
//# sourceMappingURL=v7aoJAnL.js.map
