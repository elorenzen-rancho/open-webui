const e = 'Névjegy',
	...
	Yn = '',
	qn = 'Típus',
	Qn = 'Felhasználói felület',
	Zn = '',
	Xn = '',
	$n = 'Rögzítés feloldása',
	el = 'Címkézetlen',
	tl = '',
	sl = 'Frissítés',
	al = 'Frissítve',
	...
	Fl = {
		'-1 for no limit, or a positive integer for a specific limit':
			'-1 a korlátlanhoz, vagy pozitív egész szám egy konkrét limithoz',
		"'s', 'm', 'h', 'd', 'w' or '-1' for no expiration.":
			"'s', 'm', 'h', 'd', 'w' vagy '-1' ha nincs lejárat.",
		'(e.g. `sh webui.sh --api --api-auth username_password`)':
			'(pl. `sh webui.sh --api --api-auth username_password`)',
		...
		'*Prompt node ID(s) are required for image generation':
			'*Prompt node ID(k) szükségesek a képgeneráláshoz',
		'1 hour before': '',
		'1 Source': '',
		'10 minutes before': '',
		'15 minutes before': '',
		...
		'A new version (v{{LATEST_VERSION}}) is now available.':
			'Új verzió (v{{LATEST_VERSION}}) érhető el.',
		'A private conversation between you and selected users': '',
		'A task model is used when performing tasks such as generating titles for chats and web search queries':
			'A feladat modell olyan feladatokhoz használatos, mint a beszélgetések címeinek generálása és webes keresési lekérdezések',
		...
		'Activate this command by typing "/{{COMMAND}}" to chat input.':
			'Aktiváld ezt a parancsot a "/{{COMMAND}}" beírásával a csevegőmezőbe.',
		Active: l,
		...
		'Add a short description about what this model does':
			'Adj hozzá egy rövid leírást arról, hogy mit csinál ez a modell',
		...
		'Adjusting these settings will apply changes universally to all users.':
			'Ezen beállítások módosítása minden felhasználóra érvényes lesz.',
		admin: d,
		Admin: c,
		'Admin Contact Email': '',
		...
		'Admins have access to all tools at all times; users need tools assigned per model in the workspace.':
			'Az adminok mindig hozzáférnek minden eszközhöz; a felhasználóknak modellenként kell eszközöket hozzárendelni a munkaterületen.',
		Advanced: m,
		...
		'applies to all users with the "user" role':
			'minden "felhasználó" szerepkörű felhasználóra vonatkozik',
		April: v,
		Archive: b,
		'Archive All': '',
		...
		'Are you sure you want to clear all memories? This action cannot be undone.':
			'Biztosan törölni szeretnéd az összes memóriát? Ez a művelet nem vonható vissza.',
		...
		'Are you sure you want to unarchive all archived chats?':
			'Biztosan vissza szeretnéd állítani az összes archivált csevegést?',
		...
		'Boosting or penalizing specific tokens for constrained responses. Bias values will be clamped between -100 and 100 (inclusive). (Default: none)':
			'Specifikus tokenek növelése vagy büntetése korlátozott válaszokhoz. Az elfogultság értékei -100 és 100 között lesznek rögzítve (beleértve). (Alapértelmezett: nincs)',
		Brave: V,
		...
		'Call feature is not supported when using Web STT engine':
			'A hívás funkció nem támogatott Web STT motor használatakor',
		Camera: q,
		Cancel: Q,
		...
		'Character limit for autocomplete generation input':
			'Karakterlimit az automatikus kiegészítés bemenetéhez',
		...
		'Click here to download user import template file.':
			'Kattints ide a felhasználó importálási sablon letöltéséhez.',
		'Click here to learn more about faster-whisper and see the available models.':
			'Kattints ide, hogy többet tudj meg a faster-whisperről és lásd az elérhető modelleket.',
		...
		'Click here to upload a workflow.json file.':
			'Kattints ide egy workflow.json fájl feltöltéséhez.',
		'click here.': 'kattints ide.',
		"Click on the user role button to change a user's role.":
			'Kattints a felhasználói szerep gombra a felhasználó szerepének módosításához.',
		'Click to connect': '',
		'Click to copy ID': '',
		'Client ID': '',
		'Client Secret': '',
		'Clipboard write permission denied. Please check your browser settings to grant the necessary access.':
			'Vágólap írási engedély megtagadva. Kérjük, ellenőrizd a böngésző beállításait a szükséges hozzáférés megadásához.',
		Clone: ie,
		...
		'Connect to your own OpenAI compatible API endpoints.':
			'Csatlakozz saját OpenAI kompatibilis API végpontjaidhoz.',
		'Connect to your own OpenAPI compatible external tool servers.':
			'Csatlakozz saját OpenAPI kompatibilis külső eszköszervereidhez.',
		'Connected ({{type}})': '',
		...
		'Constrains effort on reasoning for reasoning models. Only applicable to reasoning models from specific providers that support reasoning effort.':
			'Korlátozza az érvelési erőfeszítést az érvelési modellek esetében. Csak bizonyos szolgáltatóktól származó, érvelési erőfeszítést támogató modellekre alkalmazható.',
		...
		"Control how message text is split for TTS requests. 'Punctuation' splits into sentences, 'paragraphs' splits into paragraphs, and 'none' keeps the message as a single string.":
			"Szabályozd, hogyan legyen felosztva az üzenet szövege a TTS kérésekhez. A 'Központozás' mondatokra bontja, a 'Bekezdések' bekezdésekre bontja, a 'Nincs' pedig egyetlen szövegként kezeli az üzenetet.",
		'Control the repetition of token sequences in the generated text. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 1.1) will be more lenient. At 1, it is disabled.':
			'Szabályozza a generált szövegben lévő token sorozatok ismétlődését. Magasabb érték (pl. 1,5) erősebben bünteti az ismétléseket, alacsonyabb érték (pl. 1,1) engedékenyebb. 1-nél kikapcsolva.',
		Controls: Ee,
		'Controls the balance between coherence and diversity of the output. A lower value will result in more focused and coherent text.':
			'Szabályozza a kimenet koherenciája és változatossága közötti egyensúlyt. Alacsonyabb érték fókuszáltabb és koherensebb szöveget eredményez.',
		...
		'CORS must be properly configured by the provider to allow requests from Open WebUI.':
			'A CORS-t megfelelően kell konfigurálnia a szolgáltatónak, hogy engedélyezze az Open WebUI-ból érkező kéréseket.',
		'Could not read file.': '',
		CPU: Te,
		Create: Me,
		...
		"Default mode works with a wider range of models by calling tools once before execution. Native mode leverages the model's built-in tool-calling capabilities, but requires the model to inherently support this feature.":
			'Az alapértelmezett mód szélesebb modellválasztékkal működik az eszközök egyszeri meghívásával a végrehajtás előtt. A natív mód a modell beépített eszközhívási képességeit használja ki, de ehhez a modellnek eredendően támogatnia kell ezt a funkciót.',
		...
		'Default to 389 or 636 if TLS is enabled':
			'Alapértelmezés szerint 389 vagy 636, ha a TLS engedélyezve van',
		'Default to ALL': 'Alapértelmezés szerint MIND',
		'Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.':
			'Alapértelmezés szerint szegmentált visszakeresés a fókuszált és releváns tartalom kinyeréséhez, ez a legtöbb esetben ajánlott.',
		...
		'Direct Connections allow users to connect to their own OpenAI compatible API endpoints.':
			'A közvetlen kapcsolatok lehetővé teszik a felhasználók számára, hogy saját OpenAI kompatibilis API végpontjaikhoz csatlakozzanak.',
		'Direct Message': '',
		...
		'Discover how to use Open WebUI and seek support from the community.':
			'Fedezd fel, hogyan használd az Open WebUI-t és kérj támogatást a közösségtől.',
		'Discover wonders': 'Csodák felfedezése',
		'Discover, download, and explore custom functions':
			'Fedezz fel, tölts le és fedezz fel egyéni funkciókat',
		'Discover, download, and explore custom prompts':
			'Fedezz fel, tölts le és fedezz fel egyéni promptokat',
		'Discover, download, and explore custom tools':
			'Fedezz fel, tölts le és fedezz fel egyéni eszközöket',
		'Discover, download, and explore model presets':
			'Fedezz fel, tölts le és fedezz fel modell beállításokat',
		...
		'Display the username instead of You in the Chat':
			"Felhasználónév megjelenítése a 'Te' helyett a beszélgetésben",
		...
		'Do not install functions from sources you do not fully trust.':
			'Ne telepíts funkciókat olyan forrásokból, amelyekben nem bízol teljesen.',
		'Do not install tools from sources you do not fully trust.':
			'Ne telepíts eszközöket olyan forrásokból, amelyekben nem bízol teljesen.',
		...
		'does not make any external connections, and your data stays securely on your locally hosted server.':
			'nem létesít külső kapcsolatokat, és az adataid biztonságban maradnak a helyileg hosztolt szervereden.',
		'Domain Filter List': 'Domain szűrőlista',
		"don't fetch random pipelines from sources you don't trust.":
			'Ne tölts le véletlenszerű pipeline-okat megbízhatatlan forrásokból.',
		"Don't have an account?": 'Nincs még fiókod?',
		"don't install random functions from sources you don't trust.":
			'ne telepíts véletlenszerű funkciókat olyan forrásokból, amelyekben nem bízol.',
		"don't install random tools from sources you don't trust.":
			'ne telepíts véletlenszerű eszközöket olyan forrásokból, amelyekben nem bízol.',
		...
		'Enable autocomplete generation for chat messages':
			'Automatikus kiegészítés engedélyezése csevegőüzenetekhez',
		...
		"Enable Memory Locking (mlock) to prevent model data from being swapped out of RAM. This option locks the model's working set of pages into RAM, ensuring that they will not be swapped out to disk. This can help maintain performance by avoiding page faults and ensuring fast data access.":
			'Engedélyezd a memória zárolást (mlock), hogy a modell adatai ne kerüljenek ki a RAM-ból. Ez az opció a modell munkakészletének oldalait a RAM-ban rögzíti, így nem kerülnek a lemezre. Ez segíthet a teljesítmény fenntartásában az oldalhibák elkerülésével és a gyors adathozzáférés biztosításával.',
		'Enable Memory Mapping (mmap) to load model data. This option allows the system to use disk storage as an extension of RAM by treating disk files as if they were in RAM. This can improve model performance by allowing for faster data access. However, it may not work correctly with all systems and can consume a significant amount of disk space.':
			'Engedélyezd a memória leképezést (mmap) a modell adatainak betöltéséhez. Ez az opció lehetővé teszi a rendszer számára, hogy a lemeztárolót a RAM kiterjesztéseként használja, a lemezfájlokat RAM-ban lévőként kezelve. Ez javíthatja a modell teljesítményét a gyorsabb adathozzáférés révén. Azonban nem minden rendszerrel működik megfelelően és jelentős lemezterületet foglalhat.',
		'Enable Message Queue': '',
		'Enable Message Rating': 'Üzenet értékelés engedélyezése',
		'Enable Mirostat sampling for controlling perplexity.':
			'Engedélyezd a Mirostat mintavételezést a perplexitás szabályozásához.',
		...
		'Ensure your CSV file includes 4 columns in this order: Name, Email, Password, Role.':
			'Győződj meg róla, hogy a CSV fájl tartalmazza ezt a 4 oszlopot ebben a sorrendben: Név, Email, Jelszó, Szerep.',
		'Enter {{role}} message here': 'Írd ide a {{role}} üzenetet',
		'Enter a detail about yourself for your LLMs to recall':
			'Adj meg egy részletet magadról, amit az LLM-ek megjegyezhetnek',
		...
		'Enter api auth string (e.g. username:password)':
			'Add meg az API hitelesítési karakterláncot (pl. felhasználónév:jelszó)',
		...
		'Enter comma-separated "token:bias_value" pairs (example: 5432:100, 413:-100)':
			'Add meg vesszővel elválasztott "token:bias_érték" párokat (példa: 5432:100, 413:-100)',
		...
		'Enter proxy URL (e.g. https://user:password@host:port)':
			'Add meg a proxy URL-t (pl. https://user:password@host:port)',
		...
		'Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.':
			'Add meg a WebUI nyilvános URL-jét. Ez az URL lesz használva az értesítésekben lévő linkek generálásához.',
		...
		'Example: (&(objectClass=inetOrgPerson)(uid=%s))':
			'Példa: (&(objectClass=inetOrgPerson)(uid=%s))',
		...
		'Example: sAMAccountName or uid or userPrincipalName':
			'Példa: sAMAccountName vagy uid vagy userPrincipalName',
		'Exceeded the number of seats in your license. Please contact support to increase the number of seats.':
			'Túllépted a licencben lévő helyek számát. Kérjük, vedd fel a kapcsolatot a támogatással a helyek számának növeléséhez.',
		Exclude: zt,
		'Execute code': '',
		...
		'Failed to connect to {{URL}} OpenAPI tool server':
			'Nem sikerült csatlakozni a {{URL}} OpenAPI eszköszerverhez',
		...
		'File size should not exceed {{maxSize}} MB.':
			'A fájl mérete nem haladhatja meg a {{maxSize}} MB-ot.',
		'File Upload': '',
		...
		'Fingerprint spoofing detected: Unable to use initials as avatar. Defaulting to default profile image.':
			'Ujjlenyomat hamisítás észlelve: Nem lehet a kezdőbetűket avatárként használni. Alapértelmezett profilkép használata.',
		...
		'Forwards system user session credentials to authenticate':
			'Továbbítja a rendszer felhasználói munkamenet hitelesítő adatait a hitelesítéshez',
		Fr_day_of_week: xt,
		...
		'Functions allow arbitrary code execution.':
			'A funkciók tetszőleges kód végrehajtását teszik lehetővé.',
		...
		'Hex Color - Leave empty for default color':
			'Hexa szín - Hagyd üresen az alapértelmezett színhez',
		Hidden: as,
		Hide: os,
		'Hide All': '',
		'Hide from Sidebar': '',
		...
		'I acknowledge that I have read and I understand the implications of my action. I am aware of the risks associated with executing arbitrary code and I have verified the trustworthiness of the source.':
			'Elismerem, hogy elolvastam és megértem a cselekedetem következményeit. Tisztában vagyok a tetszőleges kód végrehajtásával járó kockázatokkal, és ellenőriztem a forrás megbízhatóságát.',
		ID: ms,
		...
		'Include `--api-auth` flag when running stable-diffusion-webui':
			'Add hozzá a `--api-auth` kapcsolót a stable-diffusion-webui futtatásakor',
		'Include `--api` flag when running stable-diffusion-webui':
			'Add hozzá a `--api` kapcsolót a stable-diffusion-webui futtatásakor',
		'Includes SharePoint': 'Tartalmazza a SharePointot',
		'Increase UI Scale': '',
		'Influences how quickly the algorithm responds to feedback from the generated text. A lower learning rate will result in slower adjustments, while a higher learning rate will make the algorithm more responsive.':
			'Befolyásolja, hogy az algoritmus milyen gyorsan reagál a generált szöveg visszajelzéseire. Alacsonyabb tanulási ráta lassabb调整okat eredményez, míg magasabb ráta gyorsabb reagálást biztosít.',
		Info: zs,
		Initials: ys,
		'Inject file content into conversation context': '',
		'Inject the entire content as context for comprehensive processing, this is recommended for complex queries.':
			'Az összes tartalom kontextusként való befecskendezése átfogó feldolgozáshoz, ez összetett lekérdezésekhez ajánlott.',
		Input: fs,
		...
		'Instant Auto-Send After Voice Transcription':
			'Azonnali automatikus küldés hangfelismerés után',
		Instructions: bs,
		Integration: As,
		Integrations: ws,
		Interface: Ss,
		...
		'Leave empty to include all models from "{{url}}/api/tags" endpoint':
			'Hagyja üresen, hogy az összes modellt tartalmazza a "{{url}}/api/tags" végpontból',
		'Leave empty to include all models from "{{url}}/models" endpoint':
			'Hagyja üresen, hogy az összes modellt tartalmazza a "{{url}}/models" végpontból',
		'Leave empty to include all models or select specific models':
			'Hagyja üresen az összes modell használatához, vagy válasszon ki konkrét modelleket',
		...
		'Leave empty to use the default prompt, or enter a custom prompt':
			'Hagyja üresen az alapértelmezett prompt használatához, vagy adjon meg egyéni promptot',
		'Leave model field empty to use the default model.':
			'Hagyja üresen a modell mezőt az alapértelmezett modell használatához.',
		Legacy: Ls,
		lexical: Ns,
		License: Fs,
		'Lift List': '',
		...
		'LLMs can make mistakes. Verify important information.':
			'Az LLM-ek hibázhatnak. Ellenőrizze a fontos információkat.',
		Loader: Ws,
		...
		'Make sure to export a workflow.json file as API format from ComfyUI.':
			'Győződjön meg róla, hogy exportál egy workflow.json fájlt API formátumban a ComfyUI-ból.',
		Male: Ys,
		Manage: qs,
		'Manage Connections': '',
		...
		'Maximum of 3 models can be downloaded simultaneously. Please try again later.':
			'Maximum 3 modell tölthető le egyszerre. Kérjük, próbálja újra később.',
		May: Xs,
		MBR: $s,
		MCP: ea,
		...
		'Memories accessible by LLMs will be shown here.':
			'Az LLM-ek által elérhető emlékek itt jelennek meg.',
		Memory: na,
		...
		'Message rating should be enabled to use this feature':
			'Az üzenetértékelésnek engedélyezve kell lennie ehhez a funkcióhoz',
		messages: ra,
		Messages: ia,
		"Messages you send after creating your link won't be shared. Users with the URL will be able to view the shared chat.":
			'A link létrehozása után küldött üzenetei nem lesznek megosztva. A URL-lel rendelkező felhasználók megtekinthetik a megosztott beszélgetést.',
		'Microsoft OneDrive': '',
		...
		"Model '{{modelName}}' has been successfully downloaded.":
			"A '{{modelName}}' modell sikeresen letöltve.",
		"Model '{{modelTag}}' is already in queue for downloading.":
			"A '{{modelTag}}' modell már a letöltési sorban van.",
		'Model {{modelId}} not found': '',
		'Model {{modelName}} deleted successfully': '',
		'Model {{modelName}} is not vision capable':
			'A {{modelName}} modell nem képes képfeldolgozásra',
		...
		'Model filesystem path detected. Model shortname is required for update, cannot continue.':
			'Modell fájlrendszer útvonal észlelve. A modell rövid neve szükséges a frissítéshez, nem folytatható.',
		...
		'No HTML, CSS, or JavaScript content found.':
			'Nem található HTML, CSS vagy JavaScript tartalom.',
		'No inference engine with management support found':
			'Nem található kezelést támogató következtetési motor',
		'No kernel': '',
		...
		'Note: If you set a minimum score, the search will only return documents with a score greater than or equal to the minimum score.':
			'Megjegyzés: Ha minimum pontszámot állít be, a keresés csak olyan dokumentumokat ad vissza, amelyek pontszáma nagyobb vagy egyenlő a minimum pontszámmal.',
		Notes: Ea,
		...
		'Only alphanumeric characters and hyphens are allowed in the command string.':
			'Csak alfanumerikus karakterek és kötőjelek engedélyezettek a parancssorban.',
		'Only can be triggered when the chat input is in focus.': '',
		'Only collections can be edited, create a new knowledge base to edit/add documents.':
			'Csak gyűjtemények szerkeszthetők, hozzon létre új tudásbázist dokumentumok szerkesztéséhez/hozzáadásához.',
		'Only invited users can access': '',
		'Only markdown files are allowed': '',
		'Only select users and groups with permission can access':
			'Csak a kiválasztott, engedéllyel rendelkező felhasználók és csoportok férhetnek hozzá',
		'Only sync new/updated chats': '',
		'Oops! Looks like the URL is invalid. Please double-check and try again.':
			'Hoppá! Úgy tűnik, az URL érvénytelen. Kérjük, ellenőrizze és próbálja újra.',
		'Oops! There are files still uploading. Please wait for the upload to complete.':
			'Hoppá! Még vannak feltöltés alatt álló fájlok. Kérjük, várja meg a feltöltés befejezését.',
		'Oops! There was an error in the previous response.': 'Hoppá! Hiba történt az előző válaszban.',
		"Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.":
			'Hoppá! Nem támogatott módszert használ (csak frontend). Kérjük, szolgálja ki a WebUI-t a backend-ről.',
		...
		'Open WebUI can use tools provided by any OpenAPI server.':
			'Az Open WebUI bármely OpenAPI szerver által biztosított eszközöket használhat.',
		'Open WebUI uses faster-whisper internally.':
			'Az Open WebUI belsőleg a faster-whispert használja.',
		'Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.':
			'Az Open WebUI a SpeechT5-öt és a CMU Arctic hangszóró beágyazásokat használja.',
		'Open WebUI version': '',
		...
		'Permission denied when accessing microphone: {{error}}':
			'Hozzáférés megtagadva a mikrofonhoz: {{error}}',
		Permissions: $a,
		...
		'Pipelines are a plugin system with arbitrary code execution —':
			'A Pipelines egy bővítményrendszer tetszőleges kódvégrehajtással —',
		...
		'Please carefully review the following warnings:':
			'Kérjük, gondosan tekintse át a következő figyelmeztetéseket:',
		...
		'Please do not close the settings page while loading the model.':
			'Kérjük, ne zárja be a beállítások oldalt a modell betöltése közben.',
		...
		'Prefix ID is used to avoid conflicts with other connections by adding a prefix to the model IDs - leave empty to disable':
			'Az előtag azonosító a modell azonosítókhoz hozzáadott előtag segítségével elkerüli az egyéb kapcsolatokkal való ütközéseket - hagyja üresen a letiltáshoz',
		...
		'Reduces the probability of generating nonsense. A higher value (e.g. 100) will give more diverse answers, while a lower value (e.g. 10) will be more conservative.':
			'Csökkenti a ostobaság generálásának valószínűségét. Magasabb érték (pl. 100) változatosabb válaszokat ad, míg alacsonyabb érték (pl. 10) konzervatívabb lesz.',
		'Refer to yourself as "User" (e.g., "User is learning Spanish")':
			'Hivatkozzon magára "Felhasználó"-ként (pl. "A Felhasználó spanyolul tanul")',
		'Reference Chats': '',
		Refresh: Ao,
		...
		'Response notifications cannot be activated as the website permissions have been denied. Please visit your browser settings to grant the necessary access.':
			'A válasz értesítések nem aktiválhatók, mert a weboldal engedélyei meg lettek tagadva. Kérjük, látogasson el a böngésző beállításaihoz a szükséges hozzáférés megadásához.',
		...
		"Saving chat logs directly to your browser's storage is no longer supported. Please take a moment to download and delete your chat logs by clicking the button below. Don't worry, you can easily re-import your chat logs to the backend through":
			'A csevegési naplók közvetlen mentése a böngésző tárolójába már nem támogatott. Kérjük, szánjon egy percet a csevegési naplók letöltésére és törlésére az alábbi gomb megnyomásával. Ne aggódjon, könnyen újra importálhatja a csevegési naplókat a backend-be',
		Schedule: Yo,
		...
		'Selected model(s) do not support image inputs':
			'A kiválasztott modell(ek) nem támogatják a képbemenetet',
		'Selected Models': '',
		semantic: $o,
		Send: en,
		...
		'Set the number of layers, which will be off-loaded to GPU. Increasing this value can significantly improve performance for models that are optimized for GPU acceleration but may also consume more power and GPU resources.':
			'Állítsd be a GPU-ra áthelyezett rétegek számát. Ezen érték növelése jelentősen javíthatja a GPU-ra optimalizált modellek teljesítményét, de több energiát és GPU erőforrást is fogyaszthat.',
		'Set the number of worker threads used for computation. This option controls how many threads are used to process incoming requests concurrently. Increasing this value can improve performance under high concurrency workloads but may also consume more CPU resources.':
			'Állítsd be a számítási feladatokhoz használt munkaszálak számát. Ez az opció szabályozza, hány szál dolgozik párhuzamosan a bejövő kérések feldolgozásán. Az érték növelése javíthatja a teljesítményt nagy párhuzamosságú munkaterhelés esetén, de több CPU-erőforrást is fogyaszthat.',
		...
		'Sets a flat bias against tokens that have appeared at least once. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Egységes elfogultságot állít be az egyszer már megjelent tokenek ellen. Magasabb érték (pl. 1,5) erősebben bünteti az ismétléseket, alacsonyabb érték (pl. 0,9) engedékenyebb. 0-nál kikapcsolva.',
		'Sets a scaling bias against tokens to penalize repetitions, based on how many times they have appeared. A higher value (e.g., 1.5) will penalize repetitions more strongly, while a lower value (e.g., 0.9) will be more lenient. At 0, it is disabled.':
			'Skálázott elfogultságot állít be az ismétlések büntetésére a tokenek megjelenési száma alapján. Magasabb érték (pl. 1,5) erősebben bünteti az ismétléseket, alacsonyabb érték (pl. 0,9) engedékenyebb. 0-nál kikapcsolva.',
		'Sets how far back for the model to look back to prevent repetition.':
			'Beállítja, hogy a modell mennyire nézzen vissza az ismétlések elkerülése érdekében.',
		'Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.':
			'Beállítja a generáláshoz használt véletlenszám seed-et. Egy adott szám megadása esetén a modell ugyanazt a szöveget generálja ugyanarra a prompt-ra.',
		'Sets the size of the context window used to generate the next token.':
			'Beállítja a következő token generálásához használt kontextusablak méretét.',
		'Sets the stop sequences to use. When this pattern is encountered, the LLM will stop generating text and return. Multiple stop patterns may be set by specifying multiple separate stop parameters in a modelfile.':
			'Beállítja a használandó leállítási szekvenciákat. Ha ezt a mintát észleli, az LLM leállítja a szöveg generálását és visszatér. Több leállítási minta is megadható különálló stop paraméterek megadásával egy modellfájlban.',
		Setting: an,
		Settings: on,
		...
		'Show Admin Details in Account Pending Overlay':
			'Admin részletek megjelenítése a függő fiók átfedésben',
		'Show All': '',
		...
		'Tail free sampling is used to reduce the impact of less probable tokens from the output. A higher value (e.g., 2.0) will reduce the impact more, while a value of 1.0 disables this setting.':
			'A farok nélküli mintavétel csökkenti a kevésbé valószínű tokenek hatását a kimeneten. Magasabb érték (pl. 2,0) jobban csökkenti a hatást, míg az 1,0 érték kikapcsolja ezt a beállítást.',
		'Talk to Model': '',
		...
		'The Application Account DN you bind with for search':
			'Az alkalmazás fiók DN, amellyel kereséshez kötsz',
		...
		'The batch size determines how many text requests are processed together at once. A higher batch size can increase the performance and speed of the model, but it also requires more memory.':
			'A köteg méret meghatározza, hány szöveges kérést dolgoz fel egyszerre. Magasabb köteg méret növelheti a modell teljesítményét és sebességét, de több memóriát is igényel.',
		'The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.':
			'A bővítmény fejlesztői lelkes önkéntesek a közösségből. Ha hasznosnak találja ezt a bővítményt, kérjük, fontolja meg a fejlesztéséhez való hozzájárulást.',
		'The evaluation leaderboard is based on the Elo rating system and is updated in real-time.':
			'Az értékelési ranglista az Elo értékelési rendszeren alapul és valós időben frissül.',
		...
		'The LDAP attribute that maps to the mail that users use to sign in.':
			'Az LDAP attribútum, amely a felhasználók bejelentkezéshez használt emailjéhez kapcsolódik.',
		'The LDAP attribute that maps to the username that users use to sign in.':
			'Az LDAP attribútum, amely a felhasználók bejelentkezéshez használt felhasználónevéhez kapcsolódik.',
		'The leaderboard is currently in beta, and we may adjust the rating calculations as we refine the algorithm.':
			'A ranglista jelenleg béta verzióban van, és az algoritmus finomítása során módosíthatjuk az értékelési számításokat.',
		'The maximum file size in MB. If the file size exceeds this limit, the file will not be uploaded.':
			'A maximális fájlméret MB-ban. Ha a fájlméret meghaladja ezt a limitet, a fájl nem lesz feltöltve.',
		'The maximum number of files that can be used at once in chat. If the number of files exceeds this limit, the files will not be uploaded.':
			'A csevegésben egyszerre használható fájlok maximális száma. Ha a fájlok száma meghaladja ezt a limitet, a fájlok nem lesznek feltöltve.',
		"The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.":
			'',
		"The passwords you entered don't quite match. Please double-check and try again.": '',
		'The score should be a value between 0.0 (0%) and 1.0 (100%).':
			'A pontszámnak 0,0 (0%) és 1,0 (100%) közötti értéknek kell lennie.',
		...
		'The temperature of the model. Increasing the temperature will make the model answer more creatively.':
			'A modell hőmérséklete. A hőmérséklet növelése kreatívabb válaszokat eredményez a modelltől.',
		...
		'This action cannot be undone. Do you wish to continue?':
			'Ez a művelet nem vonható vissza. Szeretné folytatni?',
		'This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.':
			'Ez a csatorna {{createdAt}} időpontban jött létre. Ez a {{channelName}} csatorna legeslegeleje.',
		"This chat won't appear in history and your messages will not be saved.":
			'Ez a csevegés nem jelenik meg az előzményekben, és az üzeneteid nem kerülnek mentésre.',
		'This ensures that your valuable conversations are securely saved to your backend database. Thank you!':
			'Ez biztosítja, hogy értékes beszélgetései biztonságosan mentésre kerüljenek a backend adatbázisban. Köszönjük!',
		...
		'This is an experimental feature, it may not function as expected and is subject to change at any time.':
			'Ez egy kísérleti funkció, lehet, hogy nem a várt módon működik és bármikor változhat.',
		...
		'This option controls how many tokens are preserved when refreshing the context. For example, if set to 2, the last 2 tokens of the conversation context will be retained. Preserving context can help maintain the continuity of a conversation, but it may reduce the ability to respond to new topics.':
			'Ez az opció szabályozza, hány token marad meg a kontextus frissítésekor. Például, ha 2-re van állítva, a beszélgetés kontextusának utolsó 2 tokenje megmarad. A kontextus megőrzése segíthet a beszélgetés folytonosságának fenntartásában, de csökkentheti az új témákra való reagálás képességét.',
		...
		'This option sets the maximum number of tokens the model can generate in its response. Increasing this limit allows the model to provide longer answers, but it may also increase the likelihood of unhelpful or irrelevant content being generated.':
			'Ez az opció beállítja a modell által generálható tokenek maximális számát a válaszban. Ezen limit növelése hosszabb válaszokat tesz lehetővé, de növelheti a nem hasznos vagy irreleváns tartalom generálásának valószínűségét.',
		'This option will delete all existing files in the collection and replace them with newly uploaded files.':
			'Ez az opció törli az összes meglévő fájlt a gyűjteményben és lecseréli őket az újonnan feltöltött fájlokkal.',
		...
		'This will delete <strong>{{NAME}}</strong> and <strong>all its contents</strong>.':
			'Ez törölni fogja a <strong>{{NAME}}</strong>-t és <strong>minden tartalmát</strong>.',
		'This will delete all models including custom models':
			'Ez törölni fogja az összes modellt, beleértve az egyéni modelleket is',
		'This will delete all models including custom models and cannot be undone.':
			'Ez törölni fogja az összes modellt, beleértve az egyéni modelleket is, és nem vonható vissza.',
		'This will permanently delete the calendar "{{name}}" and all its events. This action cannot be undone.':
			'',
		'This will reset the knowledge base and sync all files. Do you wish to continue?':
			'Ez visszaállítja a tudásbázist és szinkronizálja az összes fájlt. Szeretné folytatni?',
		...
		'To access the available model names for downloading,':
			'A letölthető modellek nevének eléréséhez,',
		'To access the GGUF models available for downloading,':
			'A letölthető GGUF modellek eléréséhez,',
		'To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.':
			'A WebUI eléréséhez kérjük, forduljon az adminisztrátorhoz. Az adminisztrátorok az Admin Panelen keresztül kezelhetik a felhasználói státuszokat.',
		'To attach knowledge base here, add them to the "Knowledge" workspace first.':
			'A tudásbázis csatolásához először adja hozzá őket a "Knowledge" munkaterülethez.',
		'To learn more about available endpoints, visit our documentation.':
			'Az elérhető végpontokról további információért látogassa meg dokumentációnkat.',
		'To select skills here, add them to the "Skills" workspace first.': '',
		'To select toolkits here, add them to the "Tools" workspace first.':
			'Az eszközkészletek kiválasztásához először adja hozzá őket a "Tools" munkaterülethez.',
		...
		'Update for the latest features and improvements.':
			'Frissítsen a legújabb funkciókért és fejlesztésekért.',
		...
		'Upgrade to a licensed plan for enhanced capabilities, including custom theming and branding, and dedicated support.':
			'Frissítsen licencelt csomagra a bővített képességekért, beleértve az egyéni témázást és márkázást, valamint dedikált támogatást.',
		Upload: ol,
		...
		"Use '#' in the prompt input to load and include your knowledge.":
			"Használja a '#' karaktert a prompt bevitelénél a tudásbázis betöltéséhez és felhasználásához.",
		...
		'Using the default arena model with all models. Click the plus button to add custom models.':
			'Az alapértelmezett aréna modell használata az összes modellel. Kattintson a plusz gombra egyéni modellek hozzáadásához.',
		...
		'Version {{selectedVersion}} of {{totalVersions}}':
			'{{selectedVersion}}. verzió a {{totalVersions}}-ból',
		'Version deleted': '',
		...
		'Warning: Enabling this will allow users to upload arbitrary code on the server.':
			'Figyelmeztetés: Ennek engedélyezése lehetővé teszi a felhasználók számára, hogy tetszőleges kódot töltsenek fel a szerverre.',
		'Warning: Jupyter execution enables arbitrary code execution, posing severe security risks—proceed with extreme caution.':
			'Figyelmeztetés: A Jupyter végrehajtás lehetővé teszi a tetszőleges kód végrehajtását, ami súlyos biztonsági kockázatot jelent – óvatosan folytassa.',
		We_day_of_week: bl,
		Web: Al,
		'Web API': 'Web API',
		'Web Loader Engine': '',
		...
		'WebUI will make requests to "{{url}}/api/chat"':
			'A WebUI kéréseket küld a "{{url}}/api/chat" címre',
		'WebUI will make requests to "{{url}}/chat/completions"':
			'A WebUI kéréseket küld a "{{url}}/chat/completions" címre',
		Week: Sl,
		Weekly: Cl,
		...
		'When enabled, the model will respond to each chat message in real-time, generating a response as soon as the user sends a message. This mode is useful for live chat applications, but may impact performance on slower hardware.':
			'Ha engedélyezve van, a modell valós időben válaszol minden csevegőüzenetre, amint a felhasználó elküldi az üzenetet. Ez a mód hasznos élő csevegőalkalmazásokhoz, de lassabb hardveren befolyásolhatja a teljesítményt.',
		...
		'Works together with top-k. A higher value (e.g., 0.95) will lead to more diverse text, while a lower value (e.g., 0.5) will generate more focused and conservative text.':
			'A top-k-val együtt működik. Magasabb érték (pl. 0,95) változatosabb szöveget eredményez, alacsonyabb érték (pl. 0,5) fókuszáltabb és konzervatívabb szöveget generál.',
		Workspace: Ml,
		'Workspace Permissions': 'Munkaterület engedélyek',
		Write: Ul,
		'Write a summary in 50 words that summarizes {{topic}}.':
			'Írjon egy 50 szavas összefoglalót a [téma vagy kulcsszó]-ról.',
...
pl.: Ön Mario a Super Mario Brosból, és asszisztensként működik.`,
		...
		'You are currently using a trial license. Please contact support to upgrade your license.':
			'Jelenleg próbaverziós licencet használ. Kérjük, lépjen kapcsolatba a támogatással a licenc frissítéséhez.',
		'You can only chat with a maximum of {{maxCount}} file(s) at a time.':
			'Egyszerre maximum {{maxCount}} fájllal tud csevegni.',
		"You can personalize your interactions with LLMs by adding memories through the 'Manage' button below, making them more helpful and tailored to you.":
			"Az LLM-ekkel való interakcióit személyre szabhatja emlékek hozzáadásával a lenti 'Kezelés' gomb segítségével, így azok még hasznosabbak és személyre szabottabbak lesznek.",
...
//# sourceMappingURL=z5xlFdOC.js.map
